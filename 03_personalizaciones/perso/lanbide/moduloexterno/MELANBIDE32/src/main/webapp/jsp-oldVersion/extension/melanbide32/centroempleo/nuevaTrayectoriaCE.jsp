...
<html>
    <head> 
        ...
        <script type="text/javascript">
            ...
            {
                var resultado = 0; 
                if(texto == '<%=ConstantesMeLanbide32.TRAYECTORIA_PRECARGA_1%>')
                {
                ...
                if(texto == '<%=ConstantesMeLanbide32.TRAYECTORIA_PRECARGA_2%>' || texto == '<%=ConstantesMeLanbide32.TRAYECTORIA_PRECARGA_3%>' || texto == '<%=ConstantesMeLanbide32.TRAYECTORIA_PRECARGA_4%>')
                {
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <textarea rows="4" cols="61" id="descripcion" name="descripcion" maxlength="500"><%=trayModif != null && trayModif.getOriCetraDescripcion() != null ? trayModif.getOriCetraDescripcion() : ""%></textarea>
                        </div>
                    </div>
                </div>
