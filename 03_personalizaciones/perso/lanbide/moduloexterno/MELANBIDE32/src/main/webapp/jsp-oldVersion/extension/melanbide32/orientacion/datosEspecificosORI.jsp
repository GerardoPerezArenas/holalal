...
<script type="text/javascript">
        ...
        function pulsarAltaUbicacionORI(){
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaSolicitudORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),250,820,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaSolicitudORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),270,850,'no','no');
            }
            if (result != undefined){
                if(result[0] == '0'){
        ...
        function pulsarModificarUbicacionORI(){
            if(tabUbicacionesOri.selectedIndex != -1) {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifSolicitudORI&tipo=0&numero=<%=numExpediente%>&idUbic='+listaUbicacionesOri[tabUbicacionesOri.selectedIndex][0]+'&control='+control.getTime(),250,820,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifSolicitudORI&tipo=0&numero=<%=numExpediente%>&idUbic='+listaUbicacionesOri[tabUbicacionesOri.selectedIndex][0]+'&control='+control.getTime(),270,850,'no','no');
                }
                if (result != undefined){
                    if(result[0] == '0'){
                        recargarTablaUbicaciones(result);
        ...
        function pulsarValorarUbicacionORI(){
            if(tabUbicacionesOri.selectedIndex != -1) {
                var control = new Date();
                var result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarValorarSolicitudORI&tipo=0&numero=<%=numExpediente%>&idUbic='+listaUbicacionesOri[tabUbicacionesOri.selectedIndex][0]+'&control='+control.getTime(),550,475,'no','no');
                if (result != undefined){
                    if(result[0] == '0'){
                        recargarTablaUbicaciones(result);
                    }
        ...
        function pulsarAltaTrayectoriaORI(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),210,720,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),230,750,'no','no');
            }
            if (result != undefined){
                if(result[0] == '0'){
        ...
        function pulsarModificarTrayectoriaORI(){
            if(tabTrayectoriaOri.selectedIndex != -1) {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&idTray='+listaTrayectoriaOri[tabTrayectoriaOri.selectedIndex][0]+'&control='+control.getTime(),210,720,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&idTray='+listaTrayectoriaOri[tabTrayectoriaOri.selectedIndex][0]+'&control='+control.getTime(),230,750,'no','no');
                }
                if (result != undefined){
                    if(result[0] == '0'){
                        recargarTablaTrayectoria(result);
        ...
        function recargarTablaUbicaciones(result){
            ...
            tabUbicacionesOri = new Tabla(document.getElementById('listaUbicacionesOri'), 874);
        ...
        function recargarTablaTrayectoria(result){
            ...
            tabTrayectoriaOri = new Tabla(document.getElementById('listaTrayectoriaOri'), 874);
    ...
    <div class="tab-page" id="tabPage321" style="height:520px; width: 100%;">
        ...
        <div style="clear: both;">
            <fieldset style="width: 97.5%;">
                ...
                <div id="listaUbicacionesOri" class="tablaPers" style="padding: 5px; width:900px; height: 190px; text-align: center; overflow-x: auto; overflow-y: auto;margin:0px;margin-top:0px;" align="center"></div>
                <div class="botonera">
                ...
                <div id="listaTrayectoriaOri" style="padding: 5px; width:900px; height: 125px; text-align: center; overflow-x: auto; overflow-y: auto;margin:0px;margin-top:0px;" align="center"></div>
                <div class="botonera">
