...
<script type="text/javascript">
    ...
    function solicitarAno(){
        ...
        var result = null;
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide32/procesos/solicitarAno.jsp?idioma=<%=idiomaUsuario%>&control='+control.getTime(),120,200,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide32/procesos/solicitarAno.jsp?idioma=<%=idiomaUsuario%>&control='+control.getTime(),120,250,'no','no');
        }
        return result;
    }
    
    
    var enlacesPaginaE  = 8;
    var lineasPaginaE   = 8;
    var paginaActualE   = 1;
                            ...
                            <tr>
                                <td>
                                    <table class="bordeInteriorPantalla" cellspacing="1px">
                                        <tr>
                                            <td style="width:100%;  height:30px; padding-left: 15px" class="txttitblanco"><%=meLanbide32I18n.getMensaje(idiomaUsuario, "tit_procesos")%></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="contenidoPantalla" valign="top" style="padding-top: 5px; padding-bottom: 10px;">
                                                <div id="contenidoProc" class="cuadroFondoBlanco" style="width:970px; height: 550px; overflow-x: auto; overflow-y: auto; padding: 10px;margin:0px;margin-top:0px;" align="center">
                                                    ...
                                                    <fieldset id="fieldsetResolucionCentros" style="width: 47%; float: right; padding-left: 10px; padding-right: 10px;">
                                                                ...
                                                                <table style="width: 100%; font-size: 12px;">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <a id="anchorProceso" name="anchorProceso" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonProceso" name="botonProceso" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide32I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide32I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
