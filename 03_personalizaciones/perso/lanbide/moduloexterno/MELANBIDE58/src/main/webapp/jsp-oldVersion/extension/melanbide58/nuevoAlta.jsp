...
<html>
   ...
   <%
		...
		css = usuario.getCss();
            ...
            /*if(request.getAttribute("listaCausasAlta") != null){
                    listaEspSol  = (List<CausaAltaBajaVO>)request.getAttribute("listaCausasAlta");
                }*/
        }
        catch(Exception ex)
        {
        ...
        <form><!--    action="/PeticionModuloIntegracion.do" method="POST" -->
            <div style="width: 100%; padding: 10px; text-align: left;">
                <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                    <span>
                        <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.nuevoAlta")%>
                    </span>
                </div>                        
                <br><br>   
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            ...
                            <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaAlta(event);return false;" style="text-decoration:none;">   <!-- onblur="javascript:return comprobarFecha(this);" onkeyup="return SoloCaracteresFecha(this);" -->
                                <IMG style="border: 0px solid none" height="17" id="calFechaAlta" name="calFechaAlta" border="0" 
