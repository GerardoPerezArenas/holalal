        ...
        <script type="text/javascript">
            ...
            function rellenardatModificar() {
                if ('<%=datModif%>' != null) {
                 ...
                 //   buscaCodigoPeriodo('<%=datModif.getPeriodo() != null ? datModif.getPeriodo() : ""%>');
                } else
                            ...
                            for (j = 0; hijos != null && j < hijos.length; j++) {
                                if (hijos[j].nodeName == "CODIGO_OPERACION") {
                                    ...
                                    for (var cont = 0; cont < hijosFila.length; cont++) {
                                        ...
                                        } /*else if (hijosFila[cont].nodeName == "PERIODO") {
                                            if (hijosFila[cont].childNodes[0].nodeValue != "null") {
                                                fila[15] = hijosFila[cont].childNodes[0].nodeValue;
                                            } else {
                                                fila[15] = '-';
                                            }
                                        } else if (hijosFila[cont].nodeName == "FECHAPERIODO") {
                                            if (hijosFila[cont].childNodes[0].nodeValue != "null") {
            ...
            <form><!--    action="/PeticionModuloIntegracion.do" method="POST" -->
                ...
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="width: 94%; clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.nuevoSMI")%>
                        </span>
                    </div>                     
                    ...
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        ...
                        <div style="width: 70%; float: left;">
                            <input id="numDiasIncidencia" name="numDiasIncidencia" type="text" class="inputTexto" size="10" maxlength="5" 
                    ...
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        ...
                        <div style="width: 70%; float: left;">
                            <input type="text" name="codListaCausaIncidencia" id="codListaCausaIncidencia" size="10" class="inputTexto" value="" onkeyup="xAMayusculas(this);" />
                    ...
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        ...
                        <div style="width: 70%; float: left;">
                            <input id="importeSubvencion" name="importeSubvencion" type="text" class="inputTexto" size="10" maxlength="9" 
                                   value="<%=datModif != null && datModif.getImporteSubvencion() != null ? datModif.getImporteSubvencion().toString().replaceAll("\\.", ","): ""%>" disabled="true"/>
                        </div>
                    </div>
                    ...
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        ...
                        <div style="width: 70%; float: left;">
                            <div style="width: 15%; float: left;">
                                <input id="importeSubvencionCalculo" name="importeSubvencionCalculo" type="text" class="inputTexto" size="10" maxlength="15" 
                                       value="<%=datModif != null && datModif.getImporteRecalculo() != null ? datModif.getImporteRecalculo().toString().replaceAll("\\.", ","): ""%>" disabled="true"/>
                            </div>
                            <%--div class="botonera" style="width: 15%; float: left;"-->
                            <input type="button" id="btnRecalculo" name="btnRecalculo" class="botonGeneral" value="<%=meLanbide58I18n.getMensaje(idiomaUsuario, "btn.btnRecalculo")%>" onclick="recalcularImporteSubvencionado();"/--%>
                        </div>
                    </div>
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        <div style="width: 30%; float: left;" class="etiqueta">
                            <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.importeSubvencionLanbide")%>
                        </div>
                        <div style="width: 70%; float: left;">
                            <div style="width: 15%; float: left;">
                                <input id="importeSubvencionLanbide" name="importeSubvencionLanbide" type="text" class="inputTexto" size="10" maxlength="15" 
                                       value="<%=datModif != null && datModif.getImporteLanbide() != null ? datModif.getImporteLanbide().toString().replaceAll("\\.", ","): ""%>"/>
                            </div>
                            <%--div class="botonera" style="width: 15%; float: left;"-->
                            <input type="button" id="btnRecalculo" name="btnRecalculo" class="botonGeneral" value="<%=meLanbide58I18n.getMensaje(idiomaUsuario, "btn.btnRecalculo")%>" onclick="recalcularImporteSubvencionado();"/--%>
                        </div>
