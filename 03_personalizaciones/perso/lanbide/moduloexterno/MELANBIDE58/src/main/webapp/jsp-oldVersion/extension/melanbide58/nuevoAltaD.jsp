...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function deshabilitaGrado() {
                document.getElementById("gradoD").disabled = true;

            }

            function habilitaGrado() {

                document.getElementById("gradoD").disabled = false;
            ...
            <form>
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.nuevoAltaD")%>
                        </span>
                    </div>
                    <br><br>
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha"
                                       ...
                                       onblur = "javascript:return comprobarFechaLanbide(this);"
                                       onfocus="javascript:this.select();"/>
                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaInssD(event);return false;"  style="text-decoration:none;">  <!-- onblur="javascript:return comprobarFechonkeyup="habilitaGrado()" a(this);" onkeyup="return SoloCaracteresFecha(this);" -->
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="gradoD" name="gradoD" type="text" class="inputTexto" size="5" maxlength="5"
                                       value="<%=datModif != null && datModif.getGradoDisc() != null ? datModif.getGradoDisc().toString().replaceAll("\\.", ","): ""%>" onchange="reemplazarPuntos(this);"disable="true"/>
                            </div>
                        </div>
                    </div>
                    <br><br/>
