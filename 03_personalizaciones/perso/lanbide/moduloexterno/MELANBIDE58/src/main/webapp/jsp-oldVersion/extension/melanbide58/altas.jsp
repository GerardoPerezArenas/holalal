...
<script type="text/javascript">
    ...
    function crearTablaAltas() {
        ...
        tabaAltas.addColumna('350', 'center', "<%=meLanbide58I18n.getMensaje(idiomaUsuario,"altas.tablaAltas.col2")%>");
    ...
    function recargarTablaAltas(result) {
        ...
        for (var i = 1; i < result.length; i++) {
            fila = result[i];
            //listaAltas[i - 1] = fila;//NO FUNCIONA ie9
        ...
        //document.getElementById('listaAltas').children[0].children[1].children[0].children[0].ondblclick = function(event){
        //        pulsarModificarAlta(event);
