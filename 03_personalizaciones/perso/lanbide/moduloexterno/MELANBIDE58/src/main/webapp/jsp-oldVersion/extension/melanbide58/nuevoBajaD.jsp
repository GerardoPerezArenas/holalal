<%-- 
    Document   : nuevoBajaD
    Created on : 05-sep-2019, 9:53:59
    Author     : Kepa
--%>
            ...
            <form>
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.nuevoBajaD")%>
                        </span>
                    </div>
                    <br><br>
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha"
                                       ...
                                       onblur = "javascript:return comprobarFechaLanbide(this);"
                                       onfocus="javascript:this.select();"/>
                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaFinD(event);return false;" style="text-decoration:none;">   <!-- onblur="javascript:return comprobarFecha(this);" onkeyup="return SoloCaracteresFecha(this);" -->
