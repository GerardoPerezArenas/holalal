...
<html>
    ...
    <script type="text/javascript">
            ...
            var comboListaSubtipoMan;
            var listaCodigosSubtipoMan = new Array();
            var listaDescripcionesSubtipoMan = new Array();
            ...
            function cargarDatosTipoDiscapacidadMan() {
                ...
                comprobarTipoDiscMan(codTipoDiscapacidadSeleccionadoMan);
                buscaCodigoTipoDiscapacidadMan(codTipoDiscapacidadSeleccionadoMan);
            }

            function buscaCodigoSubtipoMan(codSubtipoMan) {
                comboListaSubtipoMan.buscaCodigo(codSubtipoMan);
            }

            function cargarDatosSubtipoMan() {
                var codSubtipoSeleccionadoMan = document.getElementById("codListaSubtipoMan").value;
                buscaCodigoSubtipoMan(codSubtipoSeleccionadoMan);
            }
            ...
            function comprobarTipoDiscMan(codigo) {
                var estado = 'off';
                if (codigo == "PS" || codigo == "PSF" || codigo == "PSS" || codigo == "PSFS" || codigo == "FS") {
                    estado = 'on';
                } else {
                    buscaCodigoSubtipoMan("");
                }
                elementoVisible(estado, 'mantenimientoSubipo');
            }
                        ...
                        for (j = 0; hijos != null && j < hijos.length; j++) {
                            if (hijos[j].nodeName == "CODIGO_OPERACION") {
                                ...
                                for (var cont = 0; cont < hijosFila.length; cont++) {
                                    ...
                                    } else if (hijosFila[cont].nodeName == "DESCSUBTIPO") {
                                        if (hijosFila[cont].childNodes[0].nodeValue != "null") {
            ...
            function crearTabla() {
                ...
                tablaResultados.addColumna('80', 'center', "<%=meLanbide58I18n.getMensaje(idiomaUsuario,"consPersDiscp.tablaResultados.col2")%>"); // nombre
                tablaResultados.addColumna('80', 'center', "<%=meLanbide58I18n.getMensaje(idiomaUsuario,"consPersDiscp.tablaResultados.col3")%>"); // apellidos
                tablaResultados.addColumna('45', 'center', "<%=meLanbide58I18n.getMensaje(idiomaUsuario,"consPersDiscp.tablaResultados.col4")%>"); // tipoD
                tablaResultados.addColumna('60', 'center', "<%=meLanbide58I18n.getMensaje(idiomaUsuario,"consPersDiscp.tablaResultados.col15")%>"); // subtipo
            ...
            function recargarTablaBusqueda(result) {
                ...
                for (var i = 1; i < result.length; i++) {
                    fila = result[i];
                    listaResultados[i - 1] = [fila[0], fila[1], fila[2], fila[3], fila[4], fila[5], fila[18], fila[19], fila[6], fila[7], fila[8], fila[9], fila[10], fila[11], fila[12], fila[13], fila[14], fila[15], fila[16], fila[17], fila[20], fila[21], fila[22]];
                    listaResultadosTabla[i - 1] = [fila[0], fila[1], fila[2], fila[3], fila[4], fila[18], fila[6], fila[7], fila[8], fila[9], fila[11], fila[13], fila[14], fila[15], fila[16], fila[17], fila[20], fila[21]];
                }
                crearTabla();
            ...
            function rellenarMantenimiento() {
                ...
                if (codigo == "PS" || codigo == "PSF" || codigo == "PSS" || codigo == "PSFS" || codigo == "FS") {
                    buscaCodigoSubtipoMan(listaResultados[tablaResultados.selectedIndex][6])
                }
                document.getElementById('txtGradoMan').value = listaResultados[tablaResultados.selectedIndex][8];
                codigo = listaResultados[tablaResultados.selectedIndex][14];
                buscaCodigoEsSeveraMan(codigo);
                if (listaResultados[tablaResultados.selectedIndex][9] != "-") {
                    document.getElementById('fechaEmision').value = listaResultados[tablaResultados.selectedIndex][9];
                }
                if (listaResultados[tablaResultados.selectedIndex][10] != "-") {
                    document.getElementById('fechaResolucion').value = listaResultados[tablaResultados.selectedIndex][10];
                }
                codigo = listaResultados[tablaResultados.selectedIndex][11];
                buscaCodigoValidezMan(codigo);
                if (listaResultados[tablaResultados.selectedIndex][13] != "-") {
                    document.getElementById('fechaCaducidad').value = listaResultados[tablaResultados.selectedIndex][13];
                }
                if (listaResultados[tablaResultados.selectedIndex][16] != "-") {
                    document.getElementById('fechaValidacion').value = listaResultados[tablaResultados.selectedIndex][16];
                }
                if (listaResultados[tablaResultados.selectedIndex][17] != "-") {
                    document.getElementById('fechaBaja').value = listaResultados[tablaResultados.selectedIndex][17];
                }
                if (listaResultados[tablaResultados.selectedIndex][18] != "-") {
                    document.getElementById('oidCertificado').value = listaResultados[tablaResultados.selectedIndex][18];
                }
                if (listaResultados[tablaResultados.selectedIndex][19] != "-") {
                    document.getElementById('nombreCertificado').value = listaResultados[tablaResultados.selectedIndex][19];
                }
                comprobarOid();
            }
            ...
            function validarCamposBusqueda() {
                ...
                if (document.getElementById('txtGradoMan').value) {
                    if (!validarNumericoDecimalPrecision(document.getElementById('txtGradoMan').value, 5, 2)) {
                        ...
                        if (!validarNumericoPorcentajeCien(document.getElementById('txtGradoMan').value)) {
            ...
            function validarCamposMantenimiento() {
                ...
                if (!document.getElementById('codListaTipoDiscapacidadMan').value || document.getElementById('codListaTipoDiscapacidadMan').value == '') {
                    ...
                    var tipo = document.getElementById('codListaTipoDiscapacidadMan').value;
                    if (tipo == "PS" || tipo == "PSF" || tipo == "PSS" || tipo == "PSFS" || tipo == "FS") {
                        if (document.getElementById('codListaSubtipoMan').value == null || document.getElementById('codListaSubtipoMan').value == '') {
                ...
                if (!document.getElementById('codListaValidezMan').value || document.getElementById('codListaValidezMan').value == '') {
                    ...
                    if (document.getElementById('codListaValidezMan').value == 'T') {
...
<body>
    <div class="contenidoPantalla">
        <form>
            <div id="barraProgresoPersDiscp" style="position: absolute; z-index:10; visibility: hidden; top: 30%; left: 30%;">
                                ...
                                <tr>
                                    <td>
                                        <table width="349px" height="100%">
                                            <tr>
                                                <td colspan="3" style="height:70%;text-align:center;valign:middle;text-height: max-size">
                                                    <span id="msgBuscando">
                                            ...
                                            <tr>
                                                ...
                                                <td class="imagenHide"><span class="fa fa-spinner fa-spin" aria-hidden="true"/></td>
                                                <td style="width:5%;height:20%;"></td>
                                            </tr>
                                            <tr>
            ...
            <fieldset id="fieldsetMantenimiento" name="fieldsetMantenimiento" style="width: 98%;">
                ...
                <fieldset id="fieldsetMantenimientoPersona" name="fieldsetMantenimientoPersona" style="width: 98%">
                    ...
                    <div class="lineaFormulario" style="text-align: right;">
                        ...
                        <div id="mantenimientoSubipo" name="mantenimientoSubipo" style="visibility: hidden;">
                            <div style="float: left; width: 140px; margin-left: 20px; text-align: left;">
                                <%=meLanbide58I18n.getMensaje(idiomaUsuario,"label.consPersDiscp.mantenimiento.subtipo")%>
                            </div> 
                            <div style="width: auto; margin-left: 10px; float: left;">
                                <input type="text" name="codListaSubtipoMan" id="codListaSubtipoMan" size="3" class="inputTexto" value="" onkeyup="xAMayusculas(this);" />
                                <input type="text" name="descListaSubtipoMan"  id="descListaSubtipoMan" size="30" class="inputTexto" readonly="true" value="" />
                                <a href="" id="anchorListaSubtipoMan" name="anchorListaSubtipoMan">
                                    <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonAplicacion" name="botonAplicacion" style="cursor:hand;"></span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div style="width: 200px; float: left;">
                                <div style="float: left;">
                                    ...
                                    <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaCaducidad()(event);
                                            return false;" style="text-decoration:none;"> 
                                        <IMG style="border: 0px solid none" height="17" id="calFechaCaducidad" name="calFechaCaducidad" border="0" 
                                             src="<c:url value='/images/calendario/icono.gif'/>" > <!--width="25"-->
                                    </A>
                                </div>
                            </div>
                    ...
                    <div style="width: 200px; float: left;">
                        <div style="float: left;">
                            ...
                            <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaValidacion()(event);
                                    return false;" style="text-decoration:none;"> 
                                <IMG style="border: 0px solid none" height="17" id="calFechaValidacion" name="calFechaValidacion" border="0" 
                                     src="<c:url value='/images/calendario/icono.gif'/>" > <!--width="25"-->
                            </A>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            /*desplegable SUBTIPO*/
            listaCodigosSubtipoMan[0] = "";
            listaDescripcionesSubtipoMan[0] = "";
            contador = 0;
            <logic:iterate id="subtipoMan" name="listaSubtipo" scope="request">
            listaCodigosSubtipoMan[contador] = ['<bean:write name="subtipoMan" property="des_val_cod" />'];
            listaDescripcionesSubtipoMan[contador] = ['<bean:write name="subtipoMan" property="des_nom" />'];
            contador++;
            </logic:iterate>

            var comboListaSubtipoMan = new Combo("ListaSubtipoMan");
            comboListaSubtipoMan.addItems(listaCodigosSubtipoMan, listaDescripcionesSubtipoMan);
            comboListaSubtipoMan.change = cargarDatosSubtipoMan;
                    ...
                    if (List!= null && List.size() >0){ 
                        for (int indice=0;indice<List.size();indice++) {
                          ...
                          //      String barraSeparadoraDobleIdiomaDesple = ConfigurationParameter.getParameter(ConstantesMeLanbide58.BARRA_SEPARADORA_IDIOMA_DESPLEGABLES, ConstantesMeLanbide58.FICHERO_PROPIEDADES);
                            ...
                            String Subtipo="";
                            if(objectVO.getSubtipo()!=null) {
                                
                               Subtipo=objectVO.getSubtipo();
                            }
                            String DescSubtipo="";
                            if(objectVO.getDescSubtipo()!=null) {
                                String descripcion = objectVO.getDescSubtipo();                  
                               // String barraSeparadoraDobleIdiomaDesple = ConfigurationParameter.getParameter(ConstantesMeLanbide58.BARRA_SEPARADORA_IDIOMA_DESPLEGABLES, ConstantesMeLanbide58.FICHERO_PROPIEDADES);
                                String[] descripcionDobleIdioma =  (descripcion!=null?descripcion.split(barraSeparadoraDobleIdiomaDesple):null);
                                if(descripcionDobleIdioma!=null && descripcionDobleIdioma.length>1){
                                    if(idiomaUsuario==4){
            ...
            listaResultados[<%=indice%>] = ['<%=objectVO.getId()%>', '<%=Dni%>', '<%=Apellidos%>', '<%=Nombre%>', '<%=TipoD%>',
                '<%=DescTipoD%>', '<%=Subtipo%>', '<%=DescSubtipo%>', '<%=Grado%>', '<%=FechEmis%>', '<%=FechReso%>', '<%=Validez%>', '<%=DescValidez%>',
                '<%=FechCadu%>', '<%=EsSevera%>', '<%=DescEsSevera%>',
                '<%=FechVali%>', '<%=FechBaja%>', '<%=Oid%>', '<%=NomCert%>', '<%=Centro%>', '<%=Territorio%>', '<%=DescTerritorio%>'];
            listaResultadosTabla[<%=indice%>] = ['<%=objectVO.getId()%>', '<%=Dni%>', '<%=Nombre%>', '<%=Apellidos%>',
                '<%=TipoD%>', '<%=Subtipo%>', '<%=Grado%>', '<%=FechEmis%>', '<%=FechReso%>', '<%=Validez%>',
                '<%=FechCadu%>', '<%=DescEsSevera%>',
                '<%=FechVali%>', '<%=FechBaja%>', '<%=Oid%>', '<%=NomCert%>', '<%=Centro%>', '<%=Territorio%>'];
            <%                                               
                        }
                    } 
            %>
