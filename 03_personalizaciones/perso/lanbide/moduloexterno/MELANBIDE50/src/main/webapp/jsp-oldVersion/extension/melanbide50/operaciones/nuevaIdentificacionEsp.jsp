...
<div>
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
            ...
            function guardarDatos(){
                ...
                if(validarDatos()){
                    ...
                    if(nuevo != null && nuevo == "1"){
                        parametros = "tarea=preparar&modulo=MELANBIDE50&operacion=crearIdentificacionEsp&tipo=0&numero=<%=numExpediente%>"
                                +"&nuevo="+nuevo
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            jsp_alerta('A','<%=meLanbide50I18n.getMensaje(idiomaUsuario,"msg.datosGuardados")%>');
                            //window.returnValue =  listaIdentificacionEsp;
                            //cerrarVentana();
            ...
            function convertirSINOnumero(sino){
                try{
                    for(var i=0; i<sino.length;i++){
                        if(sino[i].value=='<%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.no")%>' && sino[i].checked == true)
                            return 1;
                        if(sino[i].value=='<%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.si")%>' && sino[i].checked == true)
                            return 0;
                    }
                }catch(err){
                    return null;
            ...
            function volver(){
                var resultado = 1; //jsp_alerta('','<%=meLanbide50I18n.getMensaje(idiomaUsuario, "msg.preguntaVolver")%>');
                if (resultado == 1){
                    cerrarVentana();
                }
            }
            ...
            function validarDatos(){
                ...
                if(horas != null && horas != ''){
                    if(!validarNumericoDecimalPrecision(horas,8,2)){
                        mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "identificacionesp.msg.horas.errDecimal")%>';
                        return false;
                    }
                }
                ...
                if(alumnos != null && alumnos.value != ''){
                    if(!validarNumerico(alumnos)){
                        mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "msg.errorCampNumerico")%>';
                        return false;
                    }
                }
               return correcto;
        ...
        <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
            <div style="width: 100%; padding: 10px; text-align: left;">
                <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                    <span>
                        <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.nuevaIdentificacionEsp")%>
                    </span>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.cpespecialidad")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input id="codcp" name="codcp" type="text" class="inputTexto" size="15" maxlength="7" readonly="true"
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.denomespecialidad")%>
                    </div>
                    <div style="width: 450px; float: left;">
                         <input id="denomesp" name="denomesp" type="text" class="inputTexto" size="90" maxlength="100" readonly="true"
                ...
                <div class="lineaFormulario">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.horas")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                ...
                <div class="lineaFormulario">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.alumnos")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                ...
                <div class="lineaFormulario">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.certpro")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.si")%>
                                <input id="certprosi" name="certpro" type="radio" class="inputTexto"   
                                       value="<%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.si")%>" />
                                <br>
                            </div>
                            <div style="float: left;">
                                <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.no")%>
                                <input id="certprono" name="certpro" type="radio" class="inputTexto" 
                                       value="<%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.no")%>" />
                                <br>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.realdecreg")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                 ...
                 <div class="lineaFormulario">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.boefecpub")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                ...
                <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px; display: none;">
                    <span>
                        <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.tituloadaptabilidaddiscapacitados")%>
                    </span>
                </div>
                <br>    
                <div class="lineaFormulario" style="display: none;">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.descripcionadaptabilidad")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                ...
                <div class="lineaFormulario" style="display: none;">
                    <div>
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.identificacionesp.observacionesadaptabilidad")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                ...
                <br><br>
                <div class="botonera" style="position: center">
                    <input type="button" id="btnGuardar" name="btnGuardar" class="botonGeneral" value="<%=meLanbide50I18n.getMensaje(idiomaUsuario, "btn.guardar")%>" onclick="guardarDatos()">
                    <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" style="display: none;" value="<%=meLanbide50I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();">
                    <input type="button" id="btnVolver" name="btnVolver" class="botonGeneral" value="<%=meLanbide50I18n.getMensaje(idiomaUsuario, "btn.volver")%>" onclick="volver();">
                </div>
            </div>
        </form>
    </div>
