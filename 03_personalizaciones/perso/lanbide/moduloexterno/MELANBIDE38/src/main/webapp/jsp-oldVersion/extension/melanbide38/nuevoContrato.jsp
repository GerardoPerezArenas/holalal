...
<html>
    <head> 
        ...
        <script type="text/javascript">
            ...
            function mostrarBusqueda(){
                ...
                var result = null;
                if(navigator.appName.indexOf('Internet Explorer')!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide38/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),500,600,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide38/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),550,600,'no','no');
                }
                if (result != undefined){
    ...
    <body id="cuerpoNuevoContrato" style="margin: 10px; text-align: left;" class="contenidoPantalla">
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    ...
                    <div style="float: left; width: 322px;">
                        ...
                        <input id="descEstudios"	name="descEstudios" type="text" class="inputTexto" size="28" readonly >
                         <a id="anchorEstudios" name="anchorEstudios" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonEstudios" name="botonEstudios" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 330px;">
                        ...
                        <input id="descTipoContrato" name="descTipoContrato" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipoContrato" name="anchorTipoContrato" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoContrato" name="botonTipoContrato" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 300px;">
                        <div style="float: left; width: 90px;">
                        ...
                        <input id="descTipoJornada" name="descTipoJornada" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipoJornada" name="anchorTipoJornada" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoJornada" name="botonTipoJornada" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 630px;">
                        ...
                        <input id="descTipConDur" name="descTipConDur" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipConDur" name="anchorTipConDur" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipConDur" name="botonTipConDur" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 630px;">
                        ...
                        <input id="descCNOE" name="descCNOE" type="text" class="inputTexto" size="70" readonly >
                         <a id="anchorCNOE" name="anchorCNOE" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCNOE" name="botonCNOE" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 630px;">
                        ...
                        <input id="descColectivo" name="descColectivo" type="text" class="inputTexto" size="70" readonly >
                         <a id="anchorColectivo" name="anchorColectivo" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonColectivo" name="botonColectivo" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 630px;">
                        ...
                        <input id="descCProf" name="descCProf" type="text" class="inputTexto" size="70" readonly >
                         <a id="anchorCProf" name="anchorCProf" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCProf" name="botonCProf" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide38I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
