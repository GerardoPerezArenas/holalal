...
//                                }                                
                                ...
                                alert("Error al almacenar la subvención total en el campo suplementario : " + err.description)
                            }
                                                    ...
                                                    <table border="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="left" style="width:40px">
                                                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaDesde(event);return false;" onblur="ocultarCalendarioOnBlur(event); return false;" style="text-decoration:none;">
                                                                    <IMG style="border: 0px solid none" height="17" id="meLanbide01CalFechaDesde" name="meLanbide01CalFechaDesde" border="0" src="<%=request.getContextPath()%>/images/calendario/icono.gif" width="25">
                                                                </A>
                                                            ...
                                                            <td align="left" style="width:40px">
                                                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaHasta(event);return false;" onblur="ocultarCalendarioOnBlur(event); return false;" style="text-decoration:none;">
                                                                    <IMG style="border: 0px solid none" height="17" id="meLanbide01CalFechaHasta" name="meLanbide01CalFechaHasta" border="0" src="<%=request.getContextPath()%>/images/calendario/icono.gif" width="25">
                                                                </A>
                                                            </td>
                                                            ...
                                                            <td align="left" style="width: 120px">
                                                                <input type="text" class="inputTextoLanbide" name="porcJornRealizada" 
                                                                       ...
                                                                       onkeypress="return permiteSoloNumeroY2Decimales(event);" onfocusout="formatInputAsNumero(this);"/>
                                                            </td>
                                                            <td align="left" style="width: 120px">
                                                                <input type="text" class="inputTextoLanbide" name="porcJornSustitucion" 
                                                                       id="porcJornSustitucion" value="" size="15" onkeyup="return SoloDigitosNumericosDecimalesLanbide(this);" 
                                                                       onkeypress="return permiteSoloNumeroY2Decimales(event);" onfocusout="formatInputAsNumero(this);"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td colspan="7">
                                                    <table border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  width="126px;" align="left">
                                                                <input type="text" name="descuento" id="descuento" size="6" class="inputTextoLanbideBlanco" value="<%=porcentaje%>" onkeyup="recalcularTotalConDescuento();return SoloDigitosNumericos(this);"/>                                                                                                               
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" colspan="3" style="width:320px;">
...
<script type="text/javascript">
        ...
        //Primero comprobamos que el codigo de error indique que esta todo correcto
            ...
            <%for(int x=0;x<periodos.size();x++){
                DatosPeriodoVO dato = periodos.get(x);%>
                    ...
                    '<%=dato.getNumDias()%>','<%=dato.getBaseCotizacion()%>','<%=dato.getBonificacion()%>','<%=dato.getGasto()%>','<%=dato.getPorcJornRealizada()%>','<%=dato.getPorcJornSustitucion()%>'];
                    indice++;
            <%}%>//for
    ...
    function copiarRegistrosMostrarEnTabla(lista){ 
        ...
        for(j=0;lista!=null && j<lista.length;j++){
            ...
            var porcSubven= formatNumeroDecimal(lista[j][2]);            
