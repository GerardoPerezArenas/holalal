...
<script type="text/javascript">
    ...
    // FUNCIONES QUE PROCESAN RESPUESTA O ERROR DE LA PETICIÓN AJAX
    ...
    // FUNCIONES DE VALIDACIÓN Y OTRAS
    ...
    function crearTablaCAPV(){
        TablaTrabajadores = new Tabla(document.getElementById('listaCAPV'), 465);
