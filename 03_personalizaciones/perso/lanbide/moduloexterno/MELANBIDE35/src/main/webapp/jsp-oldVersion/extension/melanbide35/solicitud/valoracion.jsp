...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide35.vo.solicitud.EcaSolValoracionVO" %>
...
<script type="text/javascript">        
    ...
    function guardarValoracionSolicitudEca(){
        if(validarValoracionSolicitudEca()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=guardarDatosValoracionSolicitud&tipo=0&numero=<%=numExpediente%>'
        ...
        if(document.getElementById('numProyectosExp').value != ''){
            if(!validarNumericoEca(document.getElementById('numProyectosExp'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.valoracion.numProyectosExpIncorrecto")%>';
                correcto = false;
            }
            else{
                try{
    ...
    function validarPorcentajeInsMujeres(){
        ...
        if(document.getElementById('porInsMujeres').value != ''){
            if(!validarNumericoDecimalEca(document.getElementById('porInsMujeres'), 8, 2)){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.valoracion.porInsMujeresIncorrecto")%>';
                correcto = false;
            }
            else{
                try{
    ...
    function validarNumProyectosSensEmpresarial(){
        ...
        if(document.getElementById('numProyectosSensEmpresarial').value != ''){
            if(!validarNumericoEca(document.getElementById('numProyectosSensEmpresarial'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.valoracion.numProyectosSensEmpresarial")%>';
                correcto = false;
            }
            else{
                try{
...
<body>
    ...
    <div style="width: 920px; float: left; text-align: left; clear: both; height: 414px; overflow-x: hidden; overflow-y: auto; border: 1px solid #999999">
        <table style="width: 910px; font-size: 12px;text-align: center;">
            <tr class="negrita">
                <td style="text-align: left;" class="textoAzul"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.experiencia")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.numProyectos")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.puntuacion")%></td>
            </tr>
            <tr>
                <td style="text-align: left; padding-left: 40px;"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.experiencia.descripcion")%></td>
            ...
            <tr class="negrita">
                <td style="text-align: left;" class="textoAzul"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.insMujeres")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.porcentaje")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.puntuacion")%></td>
            </tr>
            <tr>
                <td style="text-align: left; padding-left: 40px;"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.insMujeres.descripcion")%></td>
            ...
            <tr class="negrita">
                <td style="text-align: left;" class="textoAzul"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.sensEmpresarial")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.numProyectos")%></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.puntuacion")%></td>
            </tr>
            <tr>
                <td style="text-align: left; padding-left: 40px;"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.sensEmpresarial.descripcion")%></td>
            ...
            <tr class="negrita">
                <td></td>
                <td><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.valoracion.total").toUpperCase()%></td>
    ...
    <div class="botonera" style="height: 50px; padding-top: 20px;">
        <input type="button" id="btnGuardarValoracionSolic" name="btnGuardarValoracionSolic" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.guardar")%>" onclick="guardarValoracionSolicitudEca();">
    </div> 
</body>
