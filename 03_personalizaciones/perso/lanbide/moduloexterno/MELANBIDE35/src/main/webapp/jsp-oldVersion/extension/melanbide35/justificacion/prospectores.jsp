...
<script type="text/javascript">
    ...
    function cargarFicheroVisitasProsEca(){
        ...
        if(hayFicheroSeleccionado){       
            ...
            if (resultado == 1){             
                ...
                var parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=procesarExcelVisitasPros&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
    ...
    function getListaProspectoresJustificacionEca(){
        ...
        parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=getListaProspectoresJustificacion&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
        try{
    ...
    function recargarTablaProspectoresJustificacionEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            ...
            if(fila[13] != undefined && fila[13].length > 0){
                ...
                for(var j = 0; j < camposErroresProspectores_jus.length; j++){
                    if(camposErroresProspectores_jus[j] == '<%=ConstantesMeLanbide35.CIERTO%>'){
            ...
            listaProspectores_jus[i-1] = fila;
           
            listaProspectores_jusTabla[i-1] = [fila[13] != undefined && fila[13].length > 0 ? '<img src="<%=request.getContextPath()%>/images/extension/melanbide35/alert.png"/>' : '', fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10], 
        ...
        tabProspectores_jus.addColumna('30','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col0")%>');
        if(haySustitutos == true){
            tabProspectores_jus.addColumna('140','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col1")%>');
        }else{
            tabProspectores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col1")%>');
        }
        tabProspectores_jus.addColumna('150','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col2")%>');
        tabProspectores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col3")%>');
        tabProspectores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col4")%>');
        tabProspectores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col5")%>');
        tabProspectores_jus.addColumna('70','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col6")%>');
        tabProspectores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col7")%>');
        tabProspectores_jus.addColumna('130','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col8")%>');
        tabProspectores_jus.addColumna('130','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col9")%>');
        tabProspectores_jus.addColumna('150','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col10")%>');
        tabProspectores_jus.addColumna('130','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col11")%>');
        tabProspectores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.prospectores.tabla.col12")%>');
    ...
    function pulsarNuevoProspectorJustificacionEca(){
        if(tabProspectores_jus.selectedIndex != -1) {  
            ...
            {  
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&idProsOrigen='+listaProspectores_jus[tabProspectores_jus.selectedIndex][0]+'&control='+control.getTime(),300,820,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&idProsOrigen='+listaProspectores_jus[tabProspectores_jus.selectedIndex][0]+'&control='+control.getTime(),320,850,'no','no');
                }
                if (result != undefined){
    ...
    function pulsarModifProspectorJustificacionEca(){
        if(tabProspectores_jus.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_jus[tabProspectores_jus.selectedIndex][0]+'&control='+control.getTime(),300,820,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_jus[tabProspectores_jus.selectedIndex][0]+'&control='+control.getTime(),320,850,'no','no');
            }
            if (result != undefined){
    ...
    function pulsarEliminarProspectorJustificacionEca(){
        if(tabProspectores_jus.selectedIndex != -1) {
            ...
            if(prospectorTieneVisitas(tabProspectores_jus.selectedIndex)){
                resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarProsVis")%>');
            }else{
                resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarPros")%>');
            }
            if (resultado == 1){
                ...
                var control = new Date();
                var listaProspectores = new Array();
                parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=eliminarProspectorJustificacion&tipo=0&numero=<%=numExpediente%>&idPros='+listaProspectores_jus[tabProspectores_jus.selectedIndex][0]+'&control='+control.getTime();
                try{
                    ajax.open("POST",url,false);
                    ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                    ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
    ...
    <%--function mostrarBotonCargarFicheroProspectores(){
        ...
        function inicializarErroresCamposProsJus(){
            ...
            for(var i = 0; i < <%=FilaProspectorJustificacionVO.NUM_CAMPOS_FILA%>; i++){
                camposErroresProspectores_jus[i] = '<%=ConstantesMeLanbide35.FALSO%>';
            }
        }
        ...
        function cargarTodasVisitasJus(){        
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarVisitas&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarVisitas&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
            }
        ...
        function cargarVisitasProspector(idProspector){
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarVisitas&tipo=0&numero=<%=numExpediente%>&idProspector='+idProspector+'&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarVisitas&tipo=0&numero=<%=numExpediente%>&idProspector='+idProspector+'&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
            }
            if(result != undefined && result == true){
                var lista = getListaProspectoresJustificacionEca();
                recargarTablaProspectoresJustificacionEca(lista, true)
        ...
        function prospectorTieneVisitas(selectedIndex){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=getNumeroVisitasProspector&tipo=0&numero=<%=numExpediente%>&idPros='+listaProspectores_jus[selectedIndex][0]+'&control='+control.getTime();
            try{
                ajax.open("POST",url,false);
                ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
        ...
        function pulsarCopiarProspectores(){
            var resultado = 0;
            resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaCopiarProspectores")%>');
            ...
            if (resultado == 1){    
                ...
                var control = new Date();
                var listaProspectores = new Array();
                parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=copiarProspectores&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
                try{
                    ajax.open("POST",url,false);
                    ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                    ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
                    ...
                    if(codigoOperacion=="0"){
                        ...
                        jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"msg.noProspectoresCopiar")%>');
                    }else{
                        jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.errorCopiarGen")%>');
                    }//if(
                }
...
<body>
    <div style="width: 100%; float: left; text-align: left; clear: both; height: 100%; overflow-x: hidden; overflow-y: auto;">
                                        ...
                                        <tr>
                                            <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                <span id="msgCopiandoProspectores">
                                                    <%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.copiandoDatos")%>
                                                </span>
        ...
        <div style="clear: both;">
            <input type="button" id="btnCopiarProspectores" name="btnCopiarProspectores" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.CopiarProspectores")%>" style="margin:2px" onClick="pulsarCopiarProspectores();"/>

            <div id="listaProspectores_jus" style="padding: 5px; width:876px; height: 340px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
                             
            <div class="botonera">
                <input type="button" id="btnNuevoProspectorJus" name="btnNuevoProspectorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.sustituir")%>" onclick="pulsarNuevoProspectorJustificacionEca();">
                <input type="button" id="btnModificarProspectorJus" name="btnModificarProspectorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.modificar")%>" onclick="pulsarModifProspectorJustificacionEca();">
                <input type="button" id="btnEliminarProspectorJus" name="btnEliminarProspectorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.eliminar")%>" onclick="pulsarEliminarProspectorJustificacionEca();">
            </div>
            
            <div style="width: 20%; float: left; padding-top: 10px;" onmouseover="habilitarBotonesListados();">
                <input type="button" id="btnCargarVisitasJus" name="btnCargarVisitasJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.cargaVisitas")%>" onclick="mostrarOpcionesCargaVisita();" style="margin:2px">
                <input type="button" id="btnListaVisitasJus" name="btnListaVisitasJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.listadoVisitas")%>" onclick="cargarTodasVisitasJus();" style="margin:2px">
            </div>
            ...
            <div style="width: 78%; text-align: right; height: 110px; float: right; padding-top: 10px;">
                <fieldset id="opcionescargavis" style="display: none; width: 100%; height: 100px; padding-top: 24px;">
                    <div style="text-align: right; clear: both; margin-bottom: 10px;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.cargarFicheroVisitas")%>:&nbsp;
                        <input type="file"  name="fichero_visitas_jus" id="fichero_visitas_jus" class="inputTexto" size="57" accept=".xls">
                        <a href="#" onclick="descargarPlantillaEca('plantilla_justificacion_vis.xls');"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.descargarPlantilla")%></a>
                    </div>
                    <div class="botonera">
                        <input type="button" id="btnCargarFicheroVisitasJus" name="btnCargarFicheroVisitasJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cargar")%>" onclick="cargarFicheroVisitasProsEca();">
                        <input type="button" id="btnCancelarFicheroVisitasJus" name="btnCancelarFicheroVisitasJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cancelar")%>" onclick="mostrarOpcionesCargaVisita();" >
                    </div>      
...
<script type="text/javascript">
    ...
    %>
        ...
        for(var cont = 0; cont < camposErroresProspectores_jus.length; cont++){
            if(camposErroresProspectores_jus[cont] == '<%=ConstantesMeLanbide35.CIERTO%>'){
    ...
    %>    
        ...
        listaProspectores_jusTabla[<%=i%>] = ['<%=act.getErrores() != null && act.getErrores().size() > 0 ? "<img src=\""+request.getContextPath()+"/images/extension/melanbide35/alert.png\" />" : ""%>',
