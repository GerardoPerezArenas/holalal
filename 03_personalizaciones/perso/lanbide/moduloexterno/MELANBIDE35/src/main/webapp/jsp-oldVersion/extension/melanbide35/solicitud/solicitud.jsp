   ...
   function ajustarDecimalesImportesSolicitud(){
    ...
    function getDatosAnexosSolicitud(){
      ...
      function recargarDatosAnexosSolicitud(result, resultprep, resultpros, actualizarOtrasPestanas){
        ...
        document.getElementById('nActuacionesConc').value = result[12];
        document.getElementById('prospectoresConcNum').value = result[13];
        document.getElementById('prospectoresConcSol').value = result[14];       
        document.getElementById('preparadoresConcNum').value = result[15];
        document.getElementById('preparadoresConcSol').value = result[16];        
        document.getElementById('gastosGeneralesConc').value = result[17];       
        ...
        document.getElementById('col1AnexCargaH').value = result[19];
        document.getElementById('col1AnexCargaM').value = result[20];
        document.getElementById('col1AnexCargaT').value = result[21];        
        
        document.getElementById('col2AnexCargaH').value = result[22];
        document.getElementById('col2AnexCargaM').value = result[23];
        document.getElementById('col2AnexCargaT').value = result[24];        
        
        document.getElementById('col3AnexCargaH').value = result[25];
        document.getElementById('col3AnexCargaM').value = result[26];
        document.getElementById('col3AnexCargaT').value = result[27];        
        
        document.getElementById('col4AnexCargaH').value = result[28];
        document.getElementById('col4AnexCargaM').value = result[29];
        document.getElementById('col4AnexCargaT').value = result[30];
        ...
        document.getElementById('nActuacionesAnexCarga').value = result[31];
...
<body>
    ...
    <div style="width: 920px; float: left; text-align: left; clear: both; height: 414px; overflow-x: hidden; overflow-y: auto; border: 1px solid #999999" onscroll="deshabilitarRadiosSolicitudEca();">
        <table style="width: 910px; font-size: 12px; text-align: center; border-collapse: collapse;" cellpadding="1px">
            ...
            <tr>
                <td style="text-align: left;"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.solicitud.inserciones.colectivo4")%></td>
                ...
                <td><input id="col4ConcH" name="col4ConcH" type="text" size="8" class="inputTexto textoNumerico" onkeyup="calcularTotalSolicitud('col4ConcH', 'col4ConcM', 'col4ConcT');FormatNumber(this.value, 8, 2, this.id);"></td>
