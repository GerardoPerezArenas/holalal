...
<script type="text/javascript">         
    ...
    function cargarDetalleProspectoresResumen(){
        var control = new Date();   
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarDetalleProspectoresResumen&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),480,992,'no','no');
        }else{
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarDetalleProspectoresResumen&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),500,1022,'no','no');
        }
    ...
    function cargarDetallePreparadoresResumen(){
        var control = new Date();   
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarDetallePreparadoresResumen&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),480,1100,'no','no');
        }else{
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarDetallePreparadoresResumen&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),500,1130,'no','no');
        }
                        ...
                        <td colspan="3" style="text-align: left; border-right: 1px solid #1766A7;">
                            <table style="width: 100%; font-size: 12px;text-align: center;">
                                <tr>
                                    ...
                                    <input type="radio" name="radioOtrasAyudasNResumen" id="radioOtrasAyudasNResumen" class="readOnly" style="background-color: white;" readOnly="readonly" value="N"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.general.no").toUpperCase()%>
                                </tr>
                            </table>
                        </td>
