...
<script type="text/javascript">
    ...
    function cargarFicheroSeguimientosPrepEca(){
        ...
        if(hayFicheroSeleccionado){    
            var resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaImportarJustificacion")%>');
            if (resultado == 1){        
                ...
                var parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=procesarExcelSeguimientosPrep&tipo=0&numero=<%=numExpediente%>&tiposeg=0&control='+control.getTime();
    ...
    function cargarFicheroInsercionesPrepEca(){
        ...
        if(hayFicheroSeleccionado){      
            ...
            if (resultado == 1){      
                ...
                var url = CONTEXT_PATH + '/PeticionModuloIntegracion.do';
                var control = new Date();
                var parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=procesarExcelSeguimientosPrep&tipo=0&numero=<%=numExpediente%>&tiposeg=1&control='+control.getTime();
                document.forms[0].action = url+'?'+parametros;
                document.forms[0].enctype = 'multipart/form-data';
                document.forms[0].encoding = 'multipart/form-data';
                document.forms[0].method = 'POST';
    ...
    function getListaPreparadoresJustificacionEca(){        
        ...
        parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=getListaPreparadoresJustificacion&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
        try{
    ...
    function recargarTablaPreparadoresJustificacionEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            fila = result[i];
            listaPreparadores_jus[i-1] = fila;            
            listaPreparadores_jusTabla_titulos[i-1] = [getListAsText(fila[29]), fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10], 
                fila[11], 
            ...
            if(fila[31] != undefined && fila[31] == '1'){
                haySustitutos = true;
            ...
            listaPreparadores_jusTabla[i-1] = [fila[29] != undefined && fila[29].length > 0 ? '<img src="<%=request.getContextPath()%>/images/extension/melanbide35/alert.png"/>' : '', fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10],
                fila[11],
    ...
    tabPreparadores_jus.addColumna('30','center','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0.title")%>');
    if(haySustitutos == true){
        tabPreparadores_jus.addColumna('140','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col1")%>');
    }else{
        tabPreparadores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col1")%>');
    }
    tabPreparadores_jus.addColumna('150','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>');
    tabPreparadores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4")%>');
    tabPreparadores_jus.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5")%>');
    tabPreparadores_jus.addColumna('100','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.justificacion.preparadores.tabla.coltipoCont")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col6")%>');
    tabPreparadores_jus.addColumna('70','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col7")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col8")%>');
    tabPreparadores_jus.addColumna('130','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9")%>');
    tabPreparadores_jus.addColumna('130','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col10")%>');
    tabPreparadores_jus.addColumna('150','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11")%>');
    tabPreparadores_jus.addColumna('130','right','<%=String.format(meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col12"), anoExpediente)%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col13")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col14")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col15")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col16")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col17")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col18")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col19")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col20")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col21")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col22")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col23")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col24")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col25")%>');
    tabPreparadores_jus.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col26")%>');
    tabPreparadores_jus.addColumna('120','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col27")%>');
    tabPreparadores_jus.addColumna('150','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col28")%>');
    ...
    function pulsarNuevoPreparadorJustificacionEca(){
        if(tabPreparadores_jus.selectedIndex != -1) {
            if(listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] == undefined || listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] == null || listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] != '1')
            {
                var control = new Date();
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&idPrepSustituir='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),330,840,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&idPrepSustituir='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),400,870,'no','no');
                }
                if (result != undefined){
    ...
    function pulsarModifPreparadorJustificacionEca(){                
        if(tabPreparadores_jus.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModificar='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),320,840,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModificar='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),390,870,'no','no');
            }
            if (result != undefined){
    ...
    function pulsarEliminarPreparadorJustificacionEca(){
            ...
            if(tabPreparadores_jus.selectedIndex != -1) {
                ...
                if(preparadorTieneSeguimientosInserciones(tabPreparadores_jus.selectedIndex)){
                    resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarPrepSegIns")%>');
                }else{
                    resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarPrep")%>');
                }
                ...
                if (resultado == 1){
                    ...
                    var control = new Date();
                    var listaPreparadores = new Array();
                    parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=eliminarPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&idPrep='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime();
                    try{
                        ajax.open("POST",url,false);
                        ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                        ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
    ...
    function cargarSeguimientosPrepEca(preparador){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
    ...
    if (sexo==null) sexo="";
        ...
        var result = null;       
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&colectivo='+colectivo+'&sexo='+sexo+'&tiposeg=1&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&colectivo='+colectivo+'&sexo='+sexo+'&tiposeg=1&control='+control.getTime(),450,850,'no','no');
        }
    ...
    function cargarTodosSeguimientosPrep(){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
    ...
    function cargarTodasInsercionesPrep(){   
       var control = new Date();
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=1&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=1&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
    ...
    function preparadorTieneSeguimientosInserciones(selectedIndex){
        ...
        var control = new Date();
        var listaPreparadores = new Array();
        parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=getNumeroSeguimientosInsercionesPreparador&tipo=0&numero=<%=numExpediente%>&idPrep='+listaPreparadores_jus[selectedIndex][0]+'&control='+control.getTime();
        try{
            ajax.open("POST",url,false);
            ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
            ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
    ...
    function pulsarCopiarPreparadores(){
        var resultado = 0;
        resultado = jsp_alerta('', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.preguntaCopiarPreparadores")%>');
        ...
        if (resultado == 1){    
            ...
            var control = new Date();
            var listaPreparadores = new Array();
            parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=copiarPreparadores&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
                    try{
                        ajax.open("POST",url,false);
                        ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                        ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
                        ...
                        var codigoOperacion = listaPreparadores[0];
                        if(codigoOperacion=="0"){
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"msg.registrosCopiadosOK")%>');
                        }else if(codigoOperacion=="1"){
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.errorCopiarBD")%>');
                        }else if(codigoOperacion=="2"){
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.errorCopiarGen")%>');
                        }else if(codigoOperacion=="-1"){
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"msg.noPreparadoresCopiar")%>');
                        }else{
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.errorCopiarGen")%>');
                        }//if(
                    }
...
<body>
    <div style="width: 100%; float: left; text-align: left; clear: both; height: 100%; overflow-x: hidden; overflow-y: auto;">
                                        ...
                                        <tr>
                                            <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                ...
                                                <span id="msgCopiandoPreparadores">
                                                    <%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.copiandoDatosPrep")%>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <div style="clear: both;">
            <input type="button" id="btnCopiarPreparadores" name="btnCopiarPreparadores" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.CopiarPreparadores")%>" style="margin:2px" onClick="pulsarCopiarPreparadores();">
            
            <div id="listaPreparadores_jus" style="padding: 5px; width:876px; height: 340px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
            
                  
            <div class="botonera">
                <input type="button" id="btnNuevoPreparadorJus" name="btnNuevoPreparadorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.sustituir")%>" onclick="pulsarNuevoPreparadorJustificacionEca();">
                <input type="button" id="btnModificarPreparadorJus" name="btnModificarPreparadorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.modificar")%>" onclick="pulsarModifPreparadorJustificacionEca();" >
                <input type="button" id="btnEliminarPreparadorJus" name="btnEliminarPreparadorJus" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.eliminar")%>" onclick="pulsarEliminarPreparadorJustificacionEca();">
            </div>
            <div style="width: 20%; float: left; padding-top: 10px;" onmouseover="habilitarBotonesListados();">
                <input type="button" id="btnCargarSegumientosPrep" name="btnCargarSegumientosPrep" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.cargaSeguimientos")%>" onclick="mostrarOpcionesCargaSeguimiento();" style="margin: 2px;">
                <input type="button" id="btnCargarInsercionesPrep" name="btnCargarInsercionesPrep" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.cargainserciones")%>" onclick="mostrarOpcionesCargaInsercion();" style="margin: 2px;">
                <input type="button" id="btnListadoSegumientosPrep" name="btnListadoSegumientosPrep" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.listadoSeguimientos")%>" onclick="cargarTodosSeguimientosPrep();" style="margin: 2px;">
                <input type="button" id="btnListadoInsercionesPrep" name="btnListadoInsercionesPrep" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.justificacion.listadoInserciones")%>" onclick="cargarTodasInsercionesPrep();" style="margin: 2px;">
            </div>
            <div style="width: 78%; text-align: right; height: 110px; float: right; padding-top: 10px;">
                <fieldset id="opcionescargaseg" style="display: none; width: 100%; height: 100px; padding-top: 24px;">
                    <div style="text-align: right; clear: both; margin-bottom: 10px;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.cargarFicheroSeguimientos")%>:&nbsp;
                        <input type="file"  name="fichero_seguimientos_jus" id="fichero_seguimientos_jus" class="inputTexto" size="57" accept=".xls">
                        <a href="#" onclick="descargarPlantillaEca('plantilla_justificacion_seg.xls');"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.descargarPlantilla")%></a>
                    </div>
                    <div class="botonera">
                        <input type="button" id="btnCargarFicheroSeguimientosJus" name="btnCargarFicheroSeguimientosJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cargar")%>" onclick="cargarFicheroSeguimientosPrepEca();">
                        <input type="button" id="btnCancelarFicheroSeguimientosJus" name="btnCancelarFicheroSeguimientosJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cancelar")%>" onclick="mostrarOpcionesCargaSeguimiento();" >
                    </div>
                </fieldset>
                <fieldset id="opcionescargains" style="display: none; width: 100%; height: 100px; padding-top: 24px;">
                    <div style="text-align: right; clear: both; margin-bottom: 10px;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.cargarFicheroInserciones")%>:&nbsp;
                        <input type="file"  name="fichero_inserciones_jus" id="fichero_inserciones_jus" class="inputTexto" size="57" accept=".xls">
                        <a href="#" onclick="descargarPlantillaEca('plantilla_justificacion_ins.xls');"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.descargarPlantilla")%></a>
                    </div>
                    <div class="botonera"> 
                        <input type="button" id="btnCargarFicheroInsercionesJus" name="btnCargarFicheroInsercionesJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cargar")%>" onclick="cargarFicheroInsercionesPrepEca();">
                        <input type="button" id="btnCancelarFicheroInsercionesJus" name="btnCancelarFicheroInsercionesJus" class="botonMasLargo" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"btn.general.cancelar")%>" onclick="mostrarOpcionesCargaInsercion();">
                    </div>
...
<script type="text/javascript">
    ...
    %>
        listaPreparadores_jus[<%=i%>] = ['<%=act.getId()%>', '<%=act.getNif()%>', '<%=act.getNombreApel()%>', '<%=act.getFechaInicio()%>', 
            ...
            '<%=act.getC4h()%>', '<%=act.getC4m()%>', '<%=act.getC4Total()%>', '<%=act.getInserciones()%>', '<%=act.getSeguimientosInserciones()%>', '<%=act.getCostesSalarialesSS()%>'];
         
        listaPreparadores_jus[<%=i%>][31] = '<%=act.esSustituto() ? "1" : "0"%>';
        ...
        listaPreparadores_jusTabla[<%=i%>] = ['<%=act.getErrores() != null && act.getErrores().size() > 0 ? "<img src=\""+request.getContextPath()+"/images/extension/melanbide35/alert.png\" />" : ""%>','<%=act.getNif()%>', '<%=act.getNombreApel()%>', '<%=act.getFechaInicio()%>', 
            '<%=act.getFechaFin()%>',  '<%=act.getTipoContrato()%>', '<%=act.getHorasAnuales()%>', '<%=act.getHorasContrato()%>', '<%=act.getHorasDedicacionECA()%>', '<%=act.getCostesSalarialesSSJor()%>', '<%=act.getCostesSalarialesSSPorJor()%>', 
