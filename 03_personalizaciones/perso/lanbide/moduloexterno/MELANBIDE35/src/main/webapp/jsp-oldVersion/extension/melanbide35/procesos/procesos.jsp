...
<script type="text/javascript">
    ...
    function solicitarAno(){
        ...
        var result = null;
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide35/procesos/solicitarAno.jsp?idioma=<%=idiomaUsuario%>&control='+control.getTime(),120,200,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide35/procesos/solicitarAno.jsp?idioma=<%=idiomaUsuario%>&control='+control.getTime(),120,250,'no','no');
        }
        return result;
    }
                                            ...
                                            <table style="width: 100%; font-size: 12px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a id="anchorProceso" name="anchorProceso" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonProceso" name="botonProceso" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
