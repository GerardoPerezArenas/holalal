...
<script type="text/javascript">
    ...
    function recargarTablaProspectoresSolicitudEca(result, actualizarOtrasPestanas){
        ...
        tabProspectores_sol.addColumna('143','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col2")%>', '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col2.title")%>');
    ...
    function pulsarNuevoProspectorSolicitudEca(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),330,930,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),350,950,'no','no');
            }
            if (result != undefined){
    ...
    function pulsarSustituirProspectorSolicitudEca(){
        if(tabProspectores_sol.selectedIndex != -1) {
            if(listaProspectores_sol[tabProspectores_sol.selectedIndex][16] == undefined || listaProspectores_sol[tabProspectores_sol.selectedIndex][16] == null || listaProspectores_sol[tabProspectores_sol.selectedIndex][16] != '1')
            {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSustituirProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&idProsSustituir='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),390,850,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSustituirProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&idProsSustituir='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),410,870,'no','no');
                }
                if (result != undefined){
                    if(result[0] == '0'){
    ...
    function pulsarModifProspectorSolicitudEca(){
        if(tabProspectores_sol.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),400,930,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),420,950,'no','no');
            }
            if (result != undefined){
                recargarTablaProspectoresSolicitudEca(result,true);
            }
