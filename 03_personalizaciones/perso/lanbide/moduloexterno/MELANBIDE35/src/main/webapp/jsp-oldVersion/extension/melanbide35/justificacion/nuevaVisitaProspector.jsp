                    ...
                    <div style="width: 130px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descSector" name="descSector" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorSector" name="anchorSector" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonSector" name="botonSector" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </div>
                <div class="lineaFormulario">
                    ...
                    <div style="width: 100px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descProvincia" name="descProvincia" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorProvincia" name="anchorProvincia" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonProvincia" name="botonProvincia" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>                
                </div>
               <div class="lineaFormulario">
                    ...
                    <div style="width: 240px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descLismi" name="descLismi" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorLismi" name="anchorLismi" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonLismi" name="botonLismi" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div> 
                    <div style="width: 100px; float: left;">
                    ...
                    <div style="width: 240px; float: left;">                      
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descResultado" name="descResultado" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorResultado" name="anchorResultado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonResultado" name="botonResultado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                       </div> 
                </div>
