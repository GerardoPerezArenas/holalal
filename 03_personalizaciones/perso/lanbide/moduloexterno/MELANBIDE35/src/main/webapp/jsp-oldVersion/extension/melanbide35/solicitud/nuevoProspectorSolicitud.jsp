...
<script type="text/javascript">
    ...
    function verComparacionProspector(){        
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=compararDatosProsSol&tipo=0&numero=<%=numExpediente%>&idPros=<%=prospectorModif != null && prospectorModif.getSolProspectoresCod() != null ? prospectorModif.getSolProspectoresCod() : ""%>&control='+control.getTime(),450,850,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=compararDatosProsSol&tipo=0&numero=<%=numExpediente%>&idPros=<%=prospectorModif != null && prospectorModif.getSolProspectoresCod() != null ? prospectorModif.getSolProspectoresCod() : ""%>&control='+control.getTime(),470,870,'no','no');
            }                   
    }
