                ...
                if(validarDatos()){
                    ...
                    if(nuevo != null && nuevo == "1"){
                        parametros = "tarea=preparar&modulo=MELANBIDE54&operacion=crearCentro&tipo=0&numero=<%=numExpediente%>"
                                ...
                                +"&codMun="+ escape(document.getElementById('codListaMuni').value)
                                +"&desCodMun="+ escape(document.getElementById('descListaMuni').value)
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            /*if(provinciaCambiada == true){
                                document.getElementById('codListaMuni').value = '';
                                document.getElementById('descListaMuni').value = '';
                            }*/
    ...
    <div class="contenidoPantalla">
        <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
            <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                <span>
                    <%=meLanbide54I18n.getMensaje(idiomaUsuario,"label.especialidades.nuevaEspecialidadSol")%>
                </span>
            </div>
            <br><br>
