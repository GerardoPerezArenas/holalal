...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/listaComboBoxScroll.js"></script>
...
//Nueva Funcion para cargar datos de oficina segun cp de cliente
    cargarCodiOficinaAsignada();
   /* function cargarCodiOficinaAsignada(){
    ...
    $( document ).ajaxComplete(function() {
      //  if(estanCargadosCamposSuplementarios()){
            //Lla mamos al ajax para la funcion de l java y devuelve  el codigo postal luego 
       // alert("Cargando codigo postal del tramite "+ numExpLicitacion+"en modulo"+ nombreModuloLicitacion);
        ...
        //Numero expedente guardad oen variable js -> numExpLicitacion
    //procesar  
                  
    parametros = "tarea=preparar&modulo=MELANBIDE03&operacion=cargarCodigoUsuario&tipo=0&numero=<%=numExpediente%>&control="+control.getTime();
        //Comparamos parametros con el modulo 50        
        ...
        try{
                ...
                //alert("Enviamos parametros ajax")
                ...
                for(j=0;hijos!=null && j<hijos.length;j++){  
                    if(hijos[j].nodeName=="CODIGO_POSTAL"){ 
                       // alert("Codigo_Postal dentro");
                        codigoPostal = hijos[j].childNodes[0].nodeValue; 
                        
                        listaNueva[j] = codigoPostal;
                    }
                    if(hijos[j].nodeName=="CODIGO_USUARIO"){ 
                       // alert("Codigo_Postal dentro");
                 ...
                 if(document.getElementById("TIPOACREDITACION").value=="CP"){
                    if( document.getElementById("VIASOLIC").value=="INTE"){
                        alert("dentro inte seleccionad odesplegable sacamos "+ codigoOperacion);
                            document.getElementById("OFICASIG").value=codigoOperacion;
                                if(codigoPostal==""){
                                    document.getElementById("OFICASIG").value="cp vacio";
                                }
                                if(codigoPostal.substr(0,2)!="01" && codigoPostal.substr(0,2)!="20" && codigoPostal.substr(0,2)!="48"){
                                     document.getElementById("OFICASIG").value="FUERA DE LA CCAA";
                                }
                                
                    }else if(document.getElementById("VIASOLIC").value=="CEFO"){    
                          document.getElementById("OFICASIG").value=document.getElementById("CENTRO").value;
                    }else if(document.getElementById("VIASOLIC").value=="OFIC"){
                          document.getElementById("OFICASIG").value="EDUCACIÓN";
                    }
                }          

                if(document.getElementById("TIPOACREDITACION").value=="APA"){
                       document.getElementById("OFICASIG").value="";     
                } 
            }catch(Err){
...
*/
    ...
    function cargarDatosCertificado(){ 
        ...
        if(ajax!=null && codCertificadoSeleccionado!=null && codCertificadoSeleccionado!=""){
                ...
                if(codigoOperacion=="70"){
                    ...
                    for(j=0;hijos!=null && j<hijos.length;j++){
                        if(hijos[j].nodeName=="AREA"){
                            var descArea = "";
                            if(hijos[j].childNodes[0]!=null) descArea = hijos[j].childNodes[0].nodeValue;
                            if(document.getElementById("descArea") != null){
                                document.getElementById("descArea").value = descArea;
                            }//if(document.getElementById("descArea") != null)                    
                        }else if(hijos[j].nodeName=="FAMILIA"){ 
                            var descFamilia = "";                            
                            if(hijos[j].childNodes[0]!=null) descFamilia = hijos[j].childNodes[0].nodeValue;                                                            
                            ...
                            var descDecreto = "";
                            if(hijos[j].childNodes[0]!=null) descDecreto = hijos[j].childNodes[0].nodeValue;                                                                                                                        
                            ...
                            var descNivel = "";
                            if(hijos[j].childNodes[0]!=null) descNivel = hijos[j].childNodes[0].nodeValue;                                                                                                                        
                            ...
                            var tipoCP = "";
                            if(hijos[j].childNodes[0]!=null) tipoCP = hijos[j].childNodes[0].nodeValue;
                            ...
                            var rdModif = "";
                            if(hijos[j].childNodes[0]!=null) rdModif = hijos[j].childNodes[0].nodeValue;
                            ...
                            var rdDeroga = "";
                            if(hijos[j].childNodes[0]!=null) rdDeroga = hijos[j].childNodes[0].nodeValue;
                            ...
                            var fechaRD = "";
                            if(hijos[j].childNodes[0]!=null) fechaRD = hijos[j].childNodes[0].nodeValue;
                            ...
                            var fechaRDModif = "";
                            if(hijos[j].childNodes[0]!=null) fechaRDModif = hijos[j].childNodes[0].nodeValue;
                            ...
                            var fechaRDDeroga = "";
                            if(hijos[j].childNodes[0]!=null) fechaRDDeroga = hijos[j].childNodes[0].nodeValue;
                                ...
                                if(hijosUnidades[x].nodeName == "UNIDAD_COMPETENCIAL"){
                                    ...
                                    for(x=0;listaUnidades!=null && x<listaUnidades.length;x++){
                                        ...
                                        for(y=0;unidad!=null && y<unidad.length;y++){
                                            ...
                                            }else if(unidad[y].nodeName=="ORIGEN_ACREDITACION"){                                                if(bloqueoPantalla == "S"){
                                                    if(unidad[y].childNodes[0].nodeValue != null){
                                        ...
                                        listaUnidadesTabla[x] = [codigoUnidad,descripcionUnidad,nivel,comboCentro(codigoUnidad),comboAcreditado(codigoUnidad),comboMotivoNoAcreditado(codigoUnidad),comboOrigenAcreditacion(codigoUnidad),textClaveRegistral(codigoUnidad)];
            ...
            // si no se ha seleccionado ningún certificado y hay datos:            
    ...
    function actualizarTabla(){ 
        ...
        if(ajax!=null && codCertificadoSeleccionado!=null && codCertificadoSeleccionado!=""){
            var url = CONTEXT_PATH + "/PeticionModuloIntegracion.do";
            var parametros = "&tarea=procesar&operacion=actualizarTabla" + "&modulo=" + escape(nombreModuloLicitacion) + "&codOrganizacion=" + escape(codOrganizacion)
                               + "&numero=" + escape(numExpLicitacion) + "&tipo=0&codCertificado=" + escape(codCertificadoSeleccionado);
            ...
            try{
                ...
                if(codigoOperacion=="70"){
                    for(j=0;hijos!=null && j<hijos.length;j++){
                        if(hijos[j].nodeName=="UNIDADES_COMPETENCIALES"){
                            var listaUnidades = xmlDoc.getElementsByTagName("UNIDADES_COMPETENCIALES");
                            var nodosUnidades = listaUnidades[0];
                            var hijosUnidades = nodosUnidades.childNodes;
                            for(x=0;hijosUnidades!=null && x<hijosUnidades.length;x++){                            
    ...
    function comboCentro(codUnidadCompetencial){
        ...
        fila += '&nbsp;';
        fila += '<input type="text" name="desc' + codUnidadCompetencial + '" id="desc' + codUnidadCompetencial + '" size="32" class="inputTextoCombos03" readonly="true" value=""/>';
        fila += '&nbsp;';
    ...
    function comboOrigenAcreditacion(codUnidadCompetencial){
        ...
        fila += '&nbsp;';
        fila += '<input type="text" name="descOrigenAcreditacion' + codUnidadCompetencial + '" id="descOrigenAcreditacion' + codUnidadCompetencial + '" size="14" class="inputTextoCombos03" readonly="true" value=""/>';
        fila += '&nbsp;';
    ...
    function comboMotivoNoAcreditado(codUnidadCompetencial){
        ...
        fila += '&nbsp;';
        fila += '<input type="text" name="descMotivoNoAcreditado' + codUnidadCompetencial + '" id="descMotivoNoAcreditado' + codUnidadCompetencial + '" size="14" class="inputTextoCombos03" disabled="true" readonly="true" value=""/>';
        fila += '&nbsp;';
    ...
    function textClaveRegistral(codUnidadCompetencial){
        var fila = '';
        fila += '<input type="text" name="claveRegistral' + codUnidadCompetencial + '" id="claveRegistral' + codUnidadCompetencial + '" size="28" maxlength="26" class="inputTextoCombos03" value="" onkeyup="xAMayusculas(this);"/>';
        return fila;
    }//textClaveRegistral
    ...
    function guardarPantalla(){
        if(comprobarDatos()){
            ...
            if(ajax!=null){
                var url = CONTEXT_PATH + "/PeticionModuloIntegracion.do";
                var parametros = "&tarea=procesar&operacion=insertarCertificadoCentroExpediente" + "&modulo=" + escape(nombreModuloLicitacion) + "&codOrganizacion=" + escape(codOrganizacion)
                                + "&numero=" + escape(numExpLicitacion) + "&tipo=0&codCertificado=" + escape(codCertificadoSeleccionado);
                    ...
                    for(c=0; codigosUnidadesDocumentales != null && c<codigosUnidadesDocumentales.length; c++){
                        if(unidadCompetencialBloqueada[c] != "S"){
                           ...
                           if(document.getElementById("codAcreditado"+codigoUnidad).value != ''){
                                ...
                                if(claveRegistral=="") claveRegistral="-";
                                string += codigoUnidad + "#@#" + codigoCentro + "#@#" + codigoAcreditacion + "#@#" + codMotNoAcreditado 
                                    + "#@#" +  codOrigenAcred + "#@#" + claveRegistral;
                                parametros += string;
                               
                                
                            }/*if(document.getElementById("cod"+codigoUnidad).value != null &&
                                document.getElementById("codAcreditado"+codigoUnidad).value != null)*/
                        }//if(unidadCompetencialBloqueada[c] != "S")
                    }//for(c=0; codigosUnidadesDocumentales != null && c<codigosUnidadesDocumentales.length; c++)
                }//if(codigosUnidadesDocumentales.length > 0)
    ...
    function comprobarDatos(){
        ...
        if(codCertificadoSeleccionado == null || codCertificadoSeleccionado == ""){
            ...
            //Comprobamos que si alguna unidad competencial tiene seleccionado un centro este tenga un valor en el campo acreditación
            ...
            //Comprobamos que si para el módulo formativo se selecciona un valor para el combo acreditado se seleccione un valor
    ...
    function borrarPantalla(){ 
        ...
        if(ajax!=null){
            var url = CONTEXT_PATH + "/PeticionModuloIntegracion.do";
            var parametros = "&tarea=procesar&operacion=borrarCertificadoExpediente" + "&modulo=" + escape(nombreModuloLicitacion) + "&codOrganizacion=" + escape(codOrganizacion)
                               + "&numero=" + escape(numExpLicitacion) + "&tipo=0&codCertificado=" + escape(codCertificadoSeleccionado);
    ...
    function avanzarToExperaExpedicion(){
        if(comprobarDatosAvanzar()){
            ...
            if(ajax!=null){
                var url = CONTEXT_PATH + "/PeticionModuloIntegracion.do";
                var parametros = "&tarea=procesar&operacion=avanzarExpedienteToEsperaExpedicion" + "&modulo=" + escape(nombreModuloLicitacion) + "&codOrganizacion=" + escape(esquemaBBDD)
                               + "&numero=" + escape(numExpLicitacion) + "&tipo=0";
                ajax.open("POST",url,false);
                ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=ISO-8859-1");
                ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");                
                ajax.send(parametros);
    ...
    function comprobarDatosAvanzar(){
        ...
        if(validado){
            ...
            if(ajax!=null){
                var url = CONTEXT_PATH + "/PeticionModuloIntegracion.do";
                var parametros = "&tarea=procesar&operacion=comprobarDatosAvanzarToEsperaExped" + "&modulo=" + escape(nombreModuloLicitacion) + "&codOrganizacion=" + escape(esquemaBBDD)
                               + "&numero=" + escape(numExpLicitacion) + "&tipo=0";
                ajax.open("POST",url,false);
                ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=ISO-8859-1");
                ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");                
...
<div class="tab-page" id="tabPage100" style="height:520px; width: auto; overflow: auto;">
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        ...
                                        <td class="columnP"  width="350px">
                                            <%--<input type="text" name="descArea"  id="descArea" size="50" class="inputTexto" readonly="true" value=""/>--%>
                                        ...
                                        <td class="columnP">
                                            <%--<input type="text" name="descFamilia"  id="descFamilia" size="50" class="inputTexto" readonly="true" value=""/>--%>
...
<script type="text/javascript">        
    ...
    <% } %> 
        ...
        if(document.all){
            //tablaUnidadesCompetenciales = new Tabla(document.all.tablaUnidadesCompetenciales,900);
            tablaUnidadesCompetenciales = new Tabla(document.all.tablaUnidadesCompetenciales,910);
        }else{
            //tablaUnidadesCompetenciales = new Tabla(document.getElementById("tablaUnidadesCompetenciales"),900);
            tablaUnidadesCompetenciales = new Tabla(document.getElementById("tablaUnidadesCompetenciales"),910);
        }//if(document.all)

        tablaUnidadesCompetenciales.addColumna('58','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.codigoUnidad")%>');
        tablaUnidadesCompetenciales.addColumna('135','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.descripcion")%>');
        tablaUnidadesCompetenciales.addColumna('30','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.nivel")%>');
        tablaUnidadesCompetenciales.addColumna('260','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.centro")%>');
        tablaUnidadesCompetenciales.addColumna('80','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.acreditado")%>');
        tablaUnidadesCompetenciales.addColumna('138','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.motivoNoAcreditado")%>');
        tablaUnidadesCompetenciales.addColumna('140','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.origenAcreditacion")%>');
        tablaUnidadesCompetenciales.addColumna('165','left','<%=meLanbide03I18n.getMensaje(idiomaUsuario,"label.claveRegistral")%>');
