...
public class InteropJobsAKSSGAConstantes {
    ...
    // Días que lleva un fichero para ser borrado
    public static final String DIAS_TRANSCURRIDOS_BORRAR_FICHEROS_SERVIDOR = "DIAS_TRANSCURRIDOS_BORRAR_FICHEROS_SERVIDOR";    
}
