...
public class InteropJobsAKSSGAConfig {
    ...
    public InteropJobsAKSSGAConfig(String codigoProcedimiento, int meses, int nivel, int cuadro, int productor, String formaDeIngreso, String formaDeIngresoE, String archivero, String deposito, int tipoUI, String idUI, String responsable, Integer procesarProcedEnBatch, Integer limiteExpedientesProceso) {
    ...
    public String toString() {
        return "InteropJobsAKSSGAConfig{codigoProcedimiento=" + codigoProcedimiento + ", meses=" + meses + ", nivel=" + nivel + ", cuadro=" + cuadro + ", productor=" + productor + ", formaDeIngreso=" + formaDeIngreso + ", formaDeIngresoE=" + formaDeIngresoE + ", archivero=" + archivero + ", deposito=" + deposito + ", tipoUI=" + tipoUI + ", idUI=" + idUI + ", responsable=" + responsable + ", procesarProcedEnBatch=" + procesarProcedEnBatch + ", limiteExpedientesProceso=" + limiteExpedientesProceso + '}';
    }
