...
public class FiltrosNisaeLogVO {
    ...
    public FiltrosNisaeLogVO(int start, int finish, int numEntries, int draw, String ejercicioHHFF, String procedimientoHHFF, 
            String estadoExpediente, String numeroExpedienteDesde, 
            String numeroExpedienteHasta, String fechaEnvioPeticion,
            String estado, String resultado,String documentoInteresado){
        this.start = start;
        this.finish = finish;
        ...
        public FiltrosNisaeLogVO(String ejercicioHHFF, String procedimientoHHFF, 
            String estadoExpediente, String numeroExpedienteDesde, 
            String numeroExpedienteHasta, String fechaEnvioPeticion,
            String estado, String resultado,String documentoInteresado){
        this.ejercicioHHFF = ejercicioHHFF;
