...
public class MailHelper {
    ...
    public MailHelper() {
        ...
        configMail = ResourceBundle.getBundle("mail");
    }
        ...
        try {
            ...
            if (from == null) from = configMail.getString("mail.from");
              ...
              if(!SESION_MAIL_DEFINIDO){
                    ...
                    m_Log.debug("Host:\t" + configMail.getString("mail.smtp.host"));
                    if (!"".equals(puerto)&&puerto!=null) m_Log.debug("Port:\t" + Integer.parseInt(configMail.getString("mail.smtp.port")));
                    m_Log.debug("Auth:\t" + configMail.getString("mail.smtp.auth"));
                    m_Log.debug("User:\t" + configMail.getString("mail.user"));
                    m_Log.debug("Pass:\t" + configMail.getString("mail.password"));
            ...
            ***/
            ...
            transporte = session.getTransport();
             ...
             m_Log.debug("email dstino "+email);
