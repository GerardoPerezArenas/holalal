...
function FixedColumnTableCC(par,anchoTabla,pWidth,nomT){
  this.id = 'tbl_'+nomT;
  ...
  this.addColumna = function(ancho, align, nombre, titulo, tipoDato){
    ...
    this.displayTabla = function(){
            ...
            var str = '';
            str += '<table border="0" id="tbl_'+this.nombreTabla+'" cellpadding="0" cellspacing="0" class="main" height="'+this.height+'" width="'+this.anchoTabla+'" onmousewheel="forwardEventCC(event, \''+this.nombreTabla+'\');"  onselectstart="return false;" onclick="fctb_selectRowCC(event, \''+this.nombreTabla+'\');" '+(this.dblClkFunctionCC != '' ? 'ondblclick="fctb_selectRowCC(event, \''+this.nombreTabla+'\'); '+this.dblClkFunctionCC+'();"' : 'fctb_selectRowCC(event, \''+this.nombreTabla+'\');')+'>';
            //str += '<table border="0" id="tbl_'+this.nombreTabla+'" cellpadding="0" cellspacing="0" class="main" height="'+this.height+'" width="100%" onmousewheel="forwardEvent(event, \''+this.nombreTabla+'\');"  onselectstart="return false;" onclick="fctb_selectRow(event, \''+this.nombreTabla+'\');" '+(this.dblClkFunction != '' ? 'ondblclick="fctb_selectRow(event, \''+this.nombreTabla+'\'); '+this.dblClkFunction+'();"' : 'fctb_selectRow(event, \''+this.nombreTabla+'\');')+'>';
            ...
            /*str += '<td class="tableverticalscroll" rowspan="2">';
                str += '<div id="vScroll_'+this.nombreTabla+'" class="vertical-scroll" style="height: '+(parseInt(this.height)+2)+'px; width: '+(this.parentWidth + 20)+';" onscroll="reposVerticalCC(this, \''+this.nombreTabla+'\');">';
            ...
            if(navigator.appName.indexOf("Internet Explorer") != -1){
                str += '<div id="vScroll_'+this.nombreTabla+'" class="vertical-scroll" style="height: '+(parseInt(this.height)+2)+'px; width: '+(this.parentWidth + 20)+'; display: inline-block; position: relative;" onscroll="reposVerticalCC(this, \''+this.nombreTabla+'\');">';
            }else{
                str += '<div id="vScroll_'+this.nombreTabla+'" class="vertical-scroll" style="height: '+(parseInt(this.height)+2)+'px; width: '+(this.parentWidth + 20)+';" onscroll="reposVerticalCC(this, \''+this.nombreTabla+'\');">';
            }
                    str += '<div style="height: '+this.scrollHeight+'px;">';
            ...
            if(this.numColumnasFijas > 0){
                anchoColumnasFijas = calcularAnchoColumnasCC(this.columnas, 0, this.numColumnasFijas);
                str += '<td class="tablefrozencolumn" width="'+anchoColumnasFijas+'" style="vertical-align: top;">';
                        ...
                        str += '<table border="0" cellpadding="0" cellspacing="0" width="auto" class="root">';
                            ...
                            for(var i = 0; i < this.numColumnasFijas; i++){
                                ...
                                if(i == this.numColumnasFijas - 1){
                                    str += '<td  id="cabeceraCC'+i+'" class="inner frozencol toprow xCabecera" width="'+this.columnas[i][0]+'" style="height: '+this.altoCabecera+'px; white-space: normal; border-right: 0px; border-left: 1px solid #ffffff;" title="'+this.columnas[i][5]+'">';
                                }else{
                                    str += '<td id="cabeceraCC'+i+'" class="inner frozencol toprow xCabecera" width="'+this.columnas[i][0]+'" style="height: '+this.altoCabecera+'px; white-space: normal; border-right: 0px; border-left: 1px solid #ffffff;" title="'+this.columnas[i][5]+'">';
                                }
                    ...
                    str += '<div id="divfrozen_'+this.nombreTabla+'" class="frozen" style="height: '+(this.height - this.altoCabecera)+'px;" onscroll="reposHeadCC(this, \''+this.nombreTabla+'\');">';
                        ...
                        //str += '<table id="frozencontent_'+this.nombreTabla+'" border="0" cellpadding="0" cellspacing="0" class="frozen xTabla" width="100%" style="white-space: nowrap;">';
                            var estiloAct = '';
                            var titleAct = '';
                            for(var i = 0; i < this.lineas.length; i++){
                                altoFila = calcularAltoFilaCC(i, this.lineas);
                                str += '<tr   style="height: '+altoFila+'px;" onmouseout="mouseOutCC(this, \'frozencontent_'+this.nombreTabla+'\', \'innercontent_'+this.nombreTabla+'\', \''+this.id+'\');" onmouseover="mouseOverCC(this, \'frozencontent_'+this.nombreTabla+'\', \'innercontent_'+this.nombreTabla+'\');">';
                                for(var j = 0; j < this.numColumnasFijas; j++){
                                    ...
                                    if(i == 0){
                                        if(j == this.numColumnasFijas-1){
                                            str += '<td  id="filaCC'+j+'"  class="inner toprow rightcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-right: 0px solid #666;'+estiloAct+'">';
                                        }else if(j == 0){
                                            str += '<td  id="filaCC'+j+'" class="inner frozencol toprow" width="'+(parseFloat(this.columnas[j][0])+2)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }
                                        else{
                                            str += '<td  id="filaCC'+j+'" class="inner frozencol toprow" width="'+(parseFloat(this.columnas[j][0])+1)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }
                                    }else if(i == this.lineas.length - 1){
                                        if(j == this.numColumnasFijas-1){
                                            str += '<td  id="filaCC'+j+'" class="inner bottomcol rightcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-right: 0px solid #666;'+estiloAct+'">';
                                        }else if(j == 0){
                                            str += '<td  id="filaCC'+j+'" class="inner frozencol bottomcol" width="'+(parseFloat(this.columnas[j][0])+2)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }else{
                                            str += '<td  id="filaCC'+j+'" class="inner frozencol bottomcol" width="'+(parseFloat(this.columnas[j][0])+1)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }
                                    }else{
                                        if(j == this.numColumnasFijas-1){
                                            str += '<td id="filaCC'+j+'" class="inner rightcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-right: 0px solid #666;'+estiloAct+'">';
                                        }else if(i == 0){
                                            str += '<td id="filaCC'+j+'" class="inner frozencol" width="'+(parseFloat(this.columnas[j][0])+2)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }else{
                                            str += '<td id="filaCC'+j+'" class="inner frozencol" width="'+(parseFloat(this.columnas[j][0])+1)+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="border-left: 0px solid #666;'+estiloAct+'">';
                                        }
                                    }
                                            str += this.lineas[i][j];
                                        str += '</td>';
                ...
                str += '<div id="divfrozen_'+this.nombreTabla+'" class="frozen" style="height: 0px;" onscroll="reposHeadCC(this, \''+this.nombreTabla+'\');"></div>';
            }
                var anchoColumnasScroll = calcularAnchoColumnasCC(this.columnas, this.numColumnasFijas, this.columnas.length);     
                ...
                //str += '<td class="tablecontent" width="100%" style="vertical-align: top;">';
                    str += '<div id="headscroll_'+this.nombreTabla+'" class="divhead" style="width: 100%; height:'+this.altoCabecera+'px;">';
                        ...
                        str += '</table>';
                    str += '</div>';
                    str += '<div id="contentscroll_'+this.nombreTabla+'" class="content" onscroll="reposHeadCC(this, \''+this.nombreTabla+'\');" style="height: '+(this.height - this.altoCabecera)+'px; width: 100%;">';
                                ...
                                for(var j = this.numColumnasFijas; j < this.columnas.length; j++){
                                    ...
                                    if(i == 0){
                                        if(j == this.numColumnasFijas){
                                            str += '<td id="col'+j+'" class="inner scrollCol toprow" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }else if(j == this.columnas.length - 1){
                                            str += '<td id="col'+j+'" class="inner scrollCol rightcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }else{
                                            str += '<td id="col'+j+'" class="inner scrollCol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }
                                    }else if(i == this.lineas.length - 1){
                                        if(j == this.numColumnasFijas){
                                            str += '<td id="col_'+j+'" class="inner scrollCol bottomcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }else if(j == this.columnas.length - 1){
                                            str += '<td id="col_'+j+'" class="inner bottomcol rightcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }else{
                                            str += '<td id="col_'+j+'" class="inner bottomcol" width="'+this.columnas[j][0]+'" title="'+titleAct+'" align="'+this.columnas[j][2]+'" style="'+estiloAct+'">';
                                        }
                                    }else{
                                        if(j == this.numColumnasFijas){
                ...
                /*str += '<td class="tableverticalscroll" rowspan="2" style="vertical-align: top;">';
                    str += '<div class="vertical-scroll" style="height: '+this.height+'px;" onscroll="reposVerticalCC(this, \''+this.nombreTabla+'\');">';
                        var altoScroll = (this.lineas.length*36)+30;
            ...
            /*str += '<tr class="horizontal-scroll">';
                str += '<td colspan="2" width="'+anchoTotal+'" valign="top" height="22">';
                    str += '<div id="hScroll_'+this.nombreTabla+'" class="horizontal-scroll" onscroll="reposHorizontalCC(this, \''+this.nombreTabla+'\');">';
            ...
            str += '<tr class="horizontal-scroll">';
                str += '<td colspan="2" width="'+anchoTotal+'" valign="top" height="22">';
                if(navigator.appName.indexOf("Internet Explorer") != -1){
                    str += '<div id="hScroll_'+this.nombreTabla+'" class="horizontal-scroll" style="display: inline-flex; position: relative; width: '+anchoTabla+'; margin-top: -10px;" onscroll="reposHorizontalCC(this, \''+this.nombreTabla+'\');">';
                }else{
                    str += '<div id="hScroll_'+this.nombreTabla+'" class="horizontal-scroll" onscroll="reposHorizontalCC(this, \''+this.nombreTabla+'\');">';
                }
                        str += '<div style="width: '+this.scrollWidth+'px;">';
            ...
            try{
				...
				//tabla.addEventListener('mousewheel', forwardEventCC(event, this.nombreTabla), false);
				
				var mousewheelevt=(/Firefox/i.test(navigator.userAgent))? "DOMMouseScroll" : "mousewheel" //FF doesn't recognize mousewheel as of FF3.x
				if (document.attachEvent){ //if IE (and Opera depending on user setting)
                                        tabla.attachEvent("on"+mousewheelevt, function () {forwardEventCC(event, this.nombreTabla)})
                                }
				else if (document.addEventListener){ //WC3 browsers
                                        tabla.addEventListener(mousewheelevt, function () {forwardEventCC(event, this.nombreTabla)}, false)
                                }	
...
function reposHeadCC(e, nombreTabla) {
...
function reposHorizontalCC(e, nombreTabla) {
    var h = document.getElementById('headscroll_'+nombreTabla);
...
function reposVerticalCC(e, nombreTabla) {
...
function calcularAnchoColumnasCC(columnas, from, to){
    var ancho = 0;
    var offset = 7 * to;
...
function forwardEventCC(ev, nombreTabla) {
	try{
...
function fctb_selectRowCC(event, tableName){
    if(window.event)  {
        ...
        return seleccionarFilaCC(rowID, tableName);
    }else{
...
function fctb_callFromTableToCC(event, tableName){
    if(window.event) { //IE
        if(window.event.srcElement.tagName!='TD') 
            return false;
        rowID = window.event.srcElement.parentElement.rowIndex;
...
function seleccionarFilaCC(rowID,tableName){
  var tabla = top["_tbl_" + tableName + "_"];
  var indiceAnt = tabla.selectedIndexCC;
  if(indiceAnt != rowID){
    tabla.selectedIndexCC = rowID;
    if (document.all){
  ...
  }else{//deseleccionar fila, puesto que el indice es el mismo
    tabla.selectedIndexCC = -1;
    if (document.all){
      with(eval('document.all.tbl_'+tableName+'.parentElement.parentElement.parentElement')){
        if(document.getElementById('frozencontent_'+tableName)){
            if(document.getElementById('frozencontent_'+tableName).children[0]){
                if(document.getElementById('frozencontent_'+tableName).children[0].children[rowID]){
                    document.getElementById('frozencontent_'+tableName).children[0].children[rowID].className = '';
                    if(document.getElementById('frozencontent_'+tableName).children[0].children[indiceAnt]){
                        document.getElementById('frozencontent_'+tableName).children[0].children[indiceAnt].className = '';
                    }
                }
            }
        }
        ...
        if(document.getElementById('innercontent_'+tableName)){
            if(document.getElementById('innercontent_'+tableName).children[0]){
                if(document.getElementById('innercontent_'+tableName).children[0].children[rowID]){
                    document.getElementById('innercontent_'+tableName).children[0].children[rowID].className = '';
                    if(document.getElementById('innercontent_'+tableName).children[0].children[indiceAnt]){
                        document.getElementById('innercontent_'+tableName).children[0].children[indiceAnt].className = '';
                    }
                }
            }
        }
...
function mouseOutCC(row, fixedTableName, scrollableTableName, idTab){
    if(document.getElementById(scrollableTableName)){
        var tabla = top["_" + idTab + "_"];
        if (tabla.selectedIndexCC != row.rowIndex) {
...
function mouseOverCC(row, fixedTableName, scrollableTableName){
    if(document.getElementById(fixedTableName)){
...
function calcularAltoFilaCC(numFila, lineas){
...
function callFromTableToCC(rowID,tableName){}	//Se ejecuta en el evento onDbClick.
