            ...
            <form  id="formBusqueda">
                ...
                <div style="clear: both;">
                    ...
                    <div style="text-align: left; margin-left: 50px" class="etiqueta">
                        <input type= "button" id="botonDatosIntermediacion" name="botonDatosIntermediacion" value="<%=meLanbide67I18n.getMensaje(idiomaUsuario,"label.extension.boton.datosIntermediacion")%>" onclick="pulsarDatosIntermediacion();" >
                        </input>
                    </div>
                </div>        
                <div style="clear: both;">
