 ...
 * @author santiagoc
 */
public class SelectItemPuestos implements Comparable
{
    private Object id;
    private String label;
    private Integer codPrv;
    
    public SelectItemPuestos()
    {
    ...
    {
        if(o instanceof SelectItemPuestos)
        {
            SelectItemPuestos aux = (SelectItemPuestos)o;
