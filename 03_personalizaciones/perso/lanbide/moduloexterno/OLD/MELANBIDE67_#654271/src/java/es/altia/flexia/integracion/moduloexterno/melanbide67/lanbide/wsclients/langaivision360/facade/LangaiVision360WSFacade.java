...
public class LangaiVision360WSFacade {
    ...
    public SearchCVResponseDTO generateApplicantCV(String documentType, String documentNum, String locale) throws RemoteServiceException {
        String cvUrl = "";
