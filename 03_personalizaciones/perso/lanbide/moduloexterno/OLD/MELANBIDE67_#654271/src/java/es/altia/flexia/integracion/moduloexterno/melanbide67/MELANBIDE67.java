...
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.clientws.ClientWSVidaLaboral;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.request.Persona;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.Cabecera;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.Identidad;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.ListaSituaciones;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.Response;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.Resumen;
import es.altia.flexia.integracion.moduloexterno.melanbide67.ws.client.vidalaboralws.response.Situacion;
...
public class MELANBIDE67 extends ModuloIntegracionExterno {
    ...
    //Logger
    private static final Logger log = Logger.getLogger(MELANBIDE67.class);
        ...
        try
        {
            if(validarDatosCpe(request))
            {
                ...
                if(ejercicio != null)
                {
                    ...
                    String SubSolicSolic = request.getParameter("SubSolicSolic");
                    String SubSolicConce = request.getParameter("SubSolicConce");
                    ...
                    try
                    {
                        ...
                        BigDecimal SubSolicSolicNum = null;
                        BigDecimal SubSolicConceNum = null;
                        ...
                        try
                        {
                            ...
                            SubSolicSolicNum = SubSolicSolic != null && !SubSolicSolic.equals("") ? new BigDecimal(SubSolicSolic.replaceAll(",", "\\.")) : null;
                            SubSolicConceNum = SubSolicConce != null && !SubSolicConce.equals("") ? new BigDecimal(SubSolicConce.replaceAll(",", "\\.")) : null;
                        ...
                        {
                            int res = 0;
                            res = MeLanbide67Manager.getInstance().guardarDatosCpe(codOrganizacion, ejeStr, numExpediente, gestor, empresa, impPagadoNum, impPagadoNum2, otrasAyudasSolicNum, otrasAyudasConceNum, SubSolicSolicNum, SubSolicConceNum, importeConcedidoNum, importeRenunciaRes,impReiNum, adaptador);
                            if(res > 0)
                            {
                                codigoOperacion = "0";
                            }
...
//                pagado2 = "0";
    ...
    public void recuperarDatosCVIntermediacion(int codOrganizacion, int codTramite, int ocurrenciaTramite,
        ...
        try {
            ...
            if (nifPersonaContratada != null && nifPersonaContratada.charAt(0) >= 'A'
                    && nifPersonaContratada.charAt(0) <= 'Z') {
            ...
            llamadaServicioCV.setDocumento(ConfigurationParameter.getParameter(ConstantesMeLanbide67.DOCUMENTO_CV, ConstantesMeLanbide67.FICHERO_PROPIEDADES));
            ...
            log.info("recuperarDatosCVIntermediacion parametrosRecibidos: tipoDoc=" + llamadaServicioCV.getTipoDoc()
                    ...
                    + ConfigurationParameter.
                            getParameter(ConstantesMeLanbide67.URL_CV_WS, ConstantesMeLanbide67.FICHERO_PROPIEDADES));
            LangaiVision360WSFacade langaiVision360WSFacade = new LangaiVision360WSFacade(ConfigurationParameter.
                    getParameter(ConstantesMeLanbide67.URL_CV_WS, ConstantesMeLanbide67.FICHERO_PROPIEDADES));

            final Date fechaCVInter = new Date();
            responseDTO = langaiVision360WSFacade.generateApplicantCV(llamadaServicioCV.getTipoDoc(),
                    llamadaServicioCV.getNumDoc(), llamadaServicioCV.getIdioma());
            ...
            try {
                ...
                log.error("recuperarDatosCVIntermediacion error preparando respuesta " + e.getMessage(), e);
            }
        }
...
//            log.info("getFileCV - bytesRead = " + bytesRead);
    ...
    public String cargarVidaLaboral(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String nifPersona = MeLanbide67Manager.getInstance().getDatosSuplementariosNIFPersonaContratada(numExpediente, adapt);
            listaRegistros = MeLanbide67Manager.getInstance().getDatosVidaLaboralIntermediacion(nifPersona, adapt);
            final String nombreProvincia = MeLanbide67Manager.getInstance().getNombreProvincia("15", adapt);
            listaRegistros = MeLanbide67Manager.getInstance().getDatosVidaLaboralIntermediacion(nifPersona, adapt);
            // Inicio pruebas
            final java.sql.Date f_nac = new java.sql.Date(70, 11, 1);
            final java.sql.Date d_inicio1 = new java.sql.Date(119, 5, 20);
            final java.sql.Date d_fin1 = new java.sql.Date(120, 5, 20);
            final RegistroVidaLaboralVO reg1 = new RegistroVidaLaboralVO(null, "DNI",
                    "12899480B", d_inicio1, d_fin1, 1,
                    "numeroAfiliacionL1", f_nac, "transfDerechosCEE",
                    5000, 2000, 4, 60,
                    5002, 5003, 5004, 61, 5001,
                    "numAfiliacion", "regimen", "empresa", "codCuentaCot",
                    nombreProvincia,
                    d_inicio1, d_fin1, d_fin1, "contrado trabajo",
                    "desc contrato trabajo", "contratoTParcial", "grupoCotizacion",
                    1, 0.2f, 1);
            listaRegistros.add(reg1);
            final java.sql.Date d_inicio2 = new java.sql.Date(121, 4, 2);
            final java.sql.Date d_fin2 = new java.sql.Date(122, 4, 2);
            final RegistroVidaLaboralVO reg2 = new RegistroVidaLaboralVO(null, "DNI",
                    "12899480B", d_inicio2, d_fin2, 1,
                    "numeroAfiliacionL2", f_nac, "transfDerechoCEE",
                    5003, 2001, 4, 62,
                    5003, 5004, 14, 60, 4001,
                    "numAfiliacion", "regimen", "empresa", "codCuentaCot",
                    nombreProvincia,
                    d_inicio2, d_fin2, d_fin2, "contrado fijo discontinuo",
                    "desc contrato trabajo", "contratoTParcial", "grupoCotizacion",
                    1, 0.3f, 6);
            listaRegistros.add(reg2);
            // Fin pruebas

        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(MELANBIDE67.class.getName()).log(Level.SEVERE, null, ex);
        }

        request.setAttribute("listaRegistrosBD", listaRegistros);
        log.info("=========== End en cargarVidaLaboral");
        return "/jsp/extension/melanbide67/pestanaVidaLaboral.jsp";
    }

    public String consultaVidaLaboralCVLBatch(int codOrganizacion, int codTramite, int ocurrenciaTramite,
            String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        log.info("Entramos en consultaVidaLaboralCVLBatch de " + this.getClass().getName());
        final AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));

        String numOferta = null;
        String numDocumento = null;
        try {
            numOferta = MeLanbide67Manager.getInstance().getDatosSuplementariosNumeroOferta(numExpediente, adapt);
            numDocumento = MeLanbide67Manager.getInstance().getDatosSuplementariosNIFPersonaContratada(numExpediente, adapt);
        ...
        if (numDocumento != null && numDocumento.length() >= 1
            ...
            tipoDocumento = ConfigurationParameter.getParameter(ConstantesMeLanbide67.TIPO_NIE_VIDA_LABORAL, ConstantesMeLanbide67.FICHERO_PROPIEDADES);
        } else {
            tipoDocumento = ConfigurationParameter.getParameter(ConstantesMeLanbide67.TIPO_DNI_VIDA_LABORAL, ConstantesMeLanbide67.FICHERO_PROPIEDADES);
        }
        PersonaContratadaVO personaContratada = null;
        try {
            personaContratada = MeLanbide67Manager.getInstance().getDatosPersonaContratada(tipoDocumento, numOferta, adapt);
        } catch (final Exception ex) {
        }

        List<RegistroVidaLaboralVO> listaRegistros = new ArrayList<RegistroVidaLaboralVO>();
        final Persona persona = new Persona(personaContratada.getNombre(),
                personaContratada.getApellido1(), personaContratada.getApellido2(),
                tipoDocumento, numDocumento);
        log.info("MELANBIDE67 consultaVidaLaboralCVLBatch numOferta = " + numOferta + ", numDocumento = "
                + numDocumento + ", tipoDocumento = " + tipoDocumento + ", personaContratada = " + personaContratada
                + ", fechaDesde = " + request.getParameter("fechaDesdeCVL")
                + ", fechaHasta = " + request.getParameter("fechaHastaCVL")
                + ", numExpediente = " + numExpediente);

        final Response responseWS = ClientWSVidaLaboral.getVidaLaboral(persona,
                request.getParameter("fechaDesdeCVL"),
                request.getParameter("fechaHastaCVL"));
        log.info("MELANBIDE67 consultaVidaLaboralCVLBatch respuesta WSVidaLaboral = " + responseWS);

        String codRespuesta = null;
        if (responseWS != null) {
            codRespuesta = responseWS.getCodRespuesta();
            listaRegistros = getRegistrosVidaLaboral(responseWS, tipoDocumento, numDocumento, request, personaContratada, adapt);
        } else {
            codRespuesta = "-2";
        }
        final GsonBuilder gsonBuilder = new GsonBuilder();
        gsonBuilder.serializeNulls();
        final Gson gson = gsonBuilder.create();
        String resultadoJsonString = gson.toJson(codRespuesta);
        try {
            PrintWriter out = response.getWriter();
            response.setContentType("application/json");
            response.setCharacterEncoding("UTF-8");
        ...
        // Problema principal
        request.setAttribute("listaRegistrosWS", listaRegistros);
        // 
        log.info("consultaVidaLaboralCVLBatch - End() " + new Date().toString());
        return "/jsp/extension/melanbide67/pestanaVidaLaboral.jsp";
    }

    private long extractDateFromString(final String date) {
        long result;

        final SimpleDateFormat format = new SimpleDateFormat(ConfigurationParameter.getParameter(
                ConstantesMeLanbide67.FORMATO_FECHA_WS_VIDA_LABORAL, ConstantesMeLanbide67.FICHERO_PROPIEDADES));
        try {
    ...
    private List<RegistroVidaLaboralVO> getRegistrosVidaLaboral(final Response responseWS,
            final String tipoDocumento, final String numDocumento, final HttpServletRequest request,
            final PersonaContratadaVO personaContratada, final AdaptadorSQLBD adapt) {
        final List<RegistroVidaLaboralVO> listaRegistros = new ArrayList<RegistroVidaLaboralVO>();

        final Identidad identidad = responseWS.getIdentidad();
        final Resumen resumen = identidad.getResumen();
        final ListaSituaciones listaSituaciones = identidad.getListaSituaciones();
        String nombreProvincia = null;

        if (listaSituaciones != null && listaSituaciones.getSituacion() != null) {
            final List<Situacion> situaciones = listaSituaciones.getSituacion();
            for (final Situacion situacion : situaciones) {
                try {
                    nombreProvincia = MeLanbide67Manager.getInstance().getNombreProvincia(situacion.getProvincia(), adapt);
                } catch (final Exception ex) {
                    nombreProvincia = "";
                }
                listaRegistros.add(
                        new RegistroVidaLaboralVO(null, tipoDocumento,
                                numDocumento, new java.sql.Date(extractDateFromString(request.getParameter("fechaDesdeCVL"))),
                                new java.sql.Date(extractDateFromString(request.getParameter("fechaHastaCVL"))),
                                identidad.getNumeroSituaciones(),
                                situacion.getNumeroAfiliacion(),
                                new java.sql.Date(personaContratada.getFechaNacimiento().getTime()),
                                identidad.getCabecera().getTransferenciaDerechosCEE(),
                                resumen.getTotales().getTotalDiasAlta(),
                                resumen.getPluriempleo().getTotalDiasAlta(),
                                resumen.getTotales().getAniosAlta(),
                                resumen.getTotales().getMesesAlta(),
                                resumen.getTotales().getDiasAlta(),
                                resumen.getTotales().getTotalDiasAlta() - resumen.getPluriempleo().getTotalDiasAlta(),
                                resumen.getTotales().getAniosAlta() - resumen.getPluriempleo().getAniosAlta(),
                                ...
                                situacion.getNumeroAfiliacion(),
                                situacion.getRegimen(), situacion.getEmpresa(),
                                situacion.getCodigoCuentaCotizacion(),
                                nombreProvincia,
                                new java.sql.Date(extractDateFromString(situacion.getFechaAlta())),
                                new java.sql.Date(extractDateFromString(situacion.getFechaEfectos())),
                                new java.sql.Date(extractDateFromString(situacion.getFechaBaja())),
                                situacion.getContratoTrabajo(), null,
                                situacion.getContratoTiempoParcial(),
                                situacion.getGrupoCotizacion(),
                                situacion.getDiasAlta(),
                                situacion.getDiasAlta(), 0)
                );
            }
        }
