...
public class AppAportacionesPendientes_Ibermatica {
	/**
	 * Create the test case  extends TestCase
	 *
	 * @param testName
	 *            name of the test case
	 */
//	public AppAportacionesPendientes_Ibermatica(String testName) {
//		super(testName);
//	}
...
//		return new TestSuite(AppAportacionesPendientes.class);
//	}
