...
<body onload="inicio();">
    <div class="tab-page" id="tabPage341" style="height:520px; width: 100%;">
        ...
        <div style="clear: both;">
            <div id="divGeneral" style="overflow-y: auto; overflow-x: hidden; height: 450px; padding: 20px;">
                ...
                <div class="lineaFormulario">
                    ...
                    <fieldset style="margin-right:1.5em">
                        ...
                        <div style="width: 30px; float: left;display:none;">
                            <div style="float: left;">
                   ...
                   <div style="width: 130px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descResulSubvET" name="descResulSubvET" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorResulSubvET" name="anchorResulSubvET" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonSector" name="botonSector" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide34I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide34I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"
                        ...
                        <div style="width: 130px; float: left;">                    
                             <div style="width: 220px; float: left;">
                                 ...
                                 <input id="descMotivoDen1ET" name="descMotivoDen1ET" type="text" class="inputTexto" size="22" readonly >
                                  <a id="anchorMotivoDen1ET" name="anchorMotivoDen1ET" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonSector" name="botonSector" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide34I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide34I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"
                                                                                                    style="<%=deshabilitado ? "display:none" : ""%>"></a>
                             </div>
                         </div>                                             
                    </div>
