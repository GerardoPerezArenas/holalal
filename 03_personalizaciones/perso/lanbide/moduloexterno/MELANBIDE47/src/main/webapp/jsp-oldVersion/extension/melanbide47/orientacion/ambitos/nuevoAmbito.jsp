        ...
        <script type="text/javascript">
            ...
            function guardarDatos(){
                if(validarDatos()){
                    ...
                    parametros = "tarea=preparar&modulo=MELANBIDE47&operacion=guardarAmbitoORI&tipo=0&numero=<%=numExpediente%>"
                            ...
                            +"&despachos="+document.getElementById('checkDespachos').value
            ...
            function validarDatos(){
                ...
                if(codPostal == null || codPostal == ''){
                    ...
                    var codAmbito = document.getElementById('codAmbito').value;
                    var codMun = document.getElementById('codMunCE').value;
                    if(codAmbito != '26' || (codMun != '34' && codMun != '58'))
                    {
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            ...
                            <a id="anchorProvincia" name="anchorProvincia" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonProvincia" name="botonProvincia" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </div>
                <div class="lineaFormulario">
                    ...
                    <div style="width: 247px; float: left;">
                        <div style="float: left;">
                            ...
                            <a id="anchorAmbito" name="anchorAmbito" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonAmbito" name="botonAmbito" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    ...
                    <div style="width: 200px; float: left;">
                        <div style="float: left;">
                            ...
                            <a id="anchorMunCE" name="anchorMunCE" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonMunCE" name="botonMunCE" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </div>
                <div class="lineaFormulario">
