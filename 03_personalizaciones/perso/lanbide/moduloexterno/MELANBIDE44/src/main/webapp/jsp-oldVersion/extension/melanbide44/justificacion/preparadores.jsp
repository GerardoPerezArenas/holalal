...
<script type="text/javascript">
    ...
    function recargarTablaPreparadoresJustificacionEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            ...
            listaPreparadores_jusTabla[i-1] = [fila[29] != undefined && fila[29].length > 0 ? '<img src="<%=request.getContextPath()%>/images/extension/melanbide44/alert.png"/>' : '', fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10],
                fila[11],
    ...
    tabPreparadores_jus.addColumna('150','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>');
    ...
    function cargarSeguimientosPrepEca(preparador){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
    ...
    if (sexo==null) sexo="";
        ...
        var result = null;       
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&colectivo='+colectivo+'&sexo='+sexo+'&tiposeg=1&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&colectivo='+colectivo+'&sexo='+sexo+'&tiposeg=1&control='+control.getTime(),450,850,'no','no');
        }
    ...
    function cargarTodosSeguimientosPrep(){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
    ...
    function cargarTodasInsercionesPrep(){   
       var control = new Date();
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=1&opcion='+opcion+'&control='+control.getTime(),430,820,'no','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=1&opcion='+opcion+'&control='+control.getTime(),450,850,'no','no');
        }
