...
<script type="text/javascript">
    ...
    function cargarFicheroProspectoresEca(){
        ...
        if(hayFicheroSeleccionado){
            ...
            if(listaProspectores_sol != undefined && listaProspectores_sol.length > 0){
                var resultado = jsp_alerta('', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.preguntaImportarSolicitud")%>');
            }
            if (resultado == 1){
                ...
                var parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=procesarExcelProspectores&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
    ...
    function getListaProspectoresSolicitudEca(){
        ...
        parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=getListaProspectoresSolicitud&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
        try{
    ...
    function recargarTablaProspectoresSolicitudEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            fila = result[i];
            listaProspectores_sol[i-1] = fila;
            listaProspectores_solTabla[i-1] = [fila[15] != undefined && fila[15].length > 0 ? '<img src="<%=request.getContextPath()%>/images/extension/melanbide44/alert.png"/>' : '', fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10], fila[11], fila[12], fila[13], fila[14]];
            ...
            if(fila[15] != undefined && fila[15].length > 0){
                ...
                for(var j = 0; j < camposErroresProspectores_sol.length; j++){
                    if(camposErroresProspectores_sol[j] == '<%=ConstantesMeLanbide44.CIERTO%>'){
        ...
        tabProspectores_sol.addColumna('30','center','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col0")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col0.title")%>');
        if(haySustitutos){
            tabProspectores_sol.addColumna('140','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col1")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col1.title")%>');
        }else{
            tabProspectores_sol.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col1")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col1.title")%>');
        }
        tabProspectores_sol.addColumna('143','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col2")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col2.title")%>');
        tabProspectores_sol.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col3")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col3.title")%>');
        tabProspectores_sol.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col4")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col4.title")%>');
        tabProspectores_sol.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col5")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col5.title")%>');
        tabProspectores_sol.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col6")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col6.title")%>');
        tabProspectores_sol.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col7")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col7.title")%>');
        tabProspectores_sol.addColumna('100','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col8")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col8.title")%>');
        tabProspectores_sol.addColumna('100','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col9")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col9.title")%>');
        tabProspectores_sol.addColumna('100','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col10")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col10.title")%>');
        tabProspectores_sol.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col11")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col11.title")%>');
        tabProspectores_sol.addColumna('80','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col12")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col12.title")%>');
        tabProspectores_sol.addColumna('80','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col13")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col13.title")%>');
        tabProspectores_sol.addColumna('80','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col14")%>', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.prospectores.tabla.col14.title")%>');
    ...
    function pulsarNuevoProspectorSolicitudEca(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),330,930,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),350,950,'no','no');
            }
            if (result != undefined){
    ...
    function pulsarSustituirProspectorSolicitudEca(){
        if(tabProspectores_sol.selectedIndex != -1) {
            if(listaProspectores_sol[tabProspectores_sol.selectedIndex][16] == undefined || listaProspectores_sol[tabProspectores_sol.selectedIndex][16] == null || listaProspectores_sol[tabProspectores_sol.selectedIndex][16] != '1')
            {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSustituirProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&idProsSustituir='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),390,850,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSustituirProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&idProsSustituir='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),410,870,'no','no');
                }
                if (result != undefined){
                    if(result[0] == '0'){
    ...
    function pulsarModifProspectorSolicitudEca(){
        if(tabProspectores_sol.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),400,930,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idProsModif='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime(),420,950,'no','no');
            }
            if (result != undefined){
                recargarTablaProspectoresSolicitudEca(result,true);
            }
    ...
    function pulsarEliminarProspectorSolicitudEca(){
            ...
            if(tabProspectores_sol.selectedIndex != -1) {
                ...
                if (resultado == 1){
                    ...
                    var control = new Date();
                    var listaProspectores = new Array();
                    parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=eliminarProspectorSolicitud&tipo=0&numero=<%=numExpediente%>&idPros='+listaProspectores_sol[tabProspectores_sol.selectedIndex][0]+'&control='+control.getTime();
                    try{
                        ajax.open("POST",url,false);
                        ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                        ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
    ...
    function inicializarErroresCamposProspectoresSol_Eca(){
        ...
        for(var i = 0; i < <%=FilaProspectorSolicitudVO.NUM_CAMPOS_FILA%>; i++){
            camposErroresProspectores_sol[i] = '<%=ConstantesMeLanbide44.FALSO%>';
        }
    }
</script>
<body>
    <div style="width: 100%; float: left; text-align: left; clear: both; height: 100%; overflow-x: hidden; overflow-y: auto;">
        ...
        <div style="clear: both;">
            <div id="listaProspectores_sol" style="padding: 5px; width:876px; height: 340px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
            ...
            <div style="width: 900px; text-align: right; height: 70px;">
                <div style="float: left; text-align: right; width: 765px;">
                    ...
                    <input type="button" id="btnCargarFicheroProspectoresSol" name="btnCargarFicheroProspectoresSol" class="botonMasLargo" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario,"btn.general.cargar")%>" onclick="cargarFicheroProspectoresEca();">
                </div>
                <div style="float: left; text-align: right; width: 135px;">
                    <a href="#" onclick="descargarPlantillaEca('plantilla_prospectores_solicitud.xls');"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"btn.general.descargarPlantilla")%></a>
                </div>
                </div>

            <div class="botonera">
                <input type="button" id="btnNuevoProspectorSol" name="btnNuevoProspectorSol" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.nuevo")%>" onclick="pulsarNuevoProspectorSolicitudEca();">
                <input type="button" id="btnSustituirProspectorSol" name="btnSustituirProspectorSol" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.sustituir")%>" onclick="pulsarSustituirProspectorSolicitudEca();">
                <input type="button" id="btnModificarProspectorSol" name="btnModificarProspectorSol" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.modificar")%>" onclick="pulsarModifProspectorSolicitudEca();">
                <input type="button" id="btnEliminarProspectorSol" name="btnEliminarProspectorSol" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.eliminar")%>" onclick="pulsarEliminarProspectorSolicitudEca();">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    %>
        ...
        listaProspectores_solTabla[<%=i%>] = ['<%=act.getErrores() != null && act.getErrores().size() > 0 ? "<img src=\""+request.getContextPath()+"/images/extension/melanbide44/alert.png\"/>" : ""%>', '<%=act.getNif()%>', '<%=act.getNombreApel()%>', '<%=act.getFechaInicio()%>', 
            '<%=act.getFechaFin()%>', '<%=act.getHorasAnuales()%>', '<%=act.getHorasContrato()%>', '<%=act.getHorasDedicacionECA()%>', '<%=act.getCostesSalarialesSSJor()%>', '<%=act.getCostesSalarialesSSPorJor()%>', 
            '<%=act.getCostesSalarialesSSEca()%>', '<%=act.getVisitas()%>', '<%=act.getVisitasImp()%>', '<%=act.getCoste()%>','<%=act.getImporteConcedido()%>'];
        ...
        %>
            ...
            for(var cont = 0; cont < camposErroresProspectores_sol.length; cont++){
                if(camposErroresProspectores_sol[cont] == '<%=ConstantesMeLanbide44.CIERTO%>'){
