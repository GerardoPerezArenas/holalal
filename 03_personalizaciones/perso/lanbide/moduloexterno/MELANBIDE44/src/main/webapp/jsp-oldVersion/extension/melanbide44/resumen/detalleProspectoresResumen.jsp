...
<html>
            ...
            <div style="width: 95%; padding: 10px; text-align: left;">
                ...
                <div class="lineaFormulario">
                    <div style="clear: both;">
                        <div id="listaDetalle_pros" style="padding: 5px; width:780px; height: 340px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        tabDetalle_pros = new FixedColumnTable(document.getElementById('listaDetalle_pros'), 828, 853, 'listaDEtalle_pros');
        ...
        +   '</tr>'
        +'</table>';
        tabDetalle_pros.addColumna('210','right',col3,'<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.title")%>');
        tabDetalle_pros.addColumna('75','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col4")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col4.title")%>');
