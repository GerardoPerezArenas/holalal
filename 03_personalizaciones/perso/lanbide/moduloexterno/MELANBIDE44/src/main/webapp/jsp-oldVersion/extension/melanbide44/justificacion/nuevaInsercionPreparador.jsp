                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 130px; float: left;">   
                        ...
                        <input id="descTipoDisc" name="descTipoDisc" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorTipoDisc" name="anchorTipoDisc" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoDisc" name="botonTipoDisc" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                     <div style="width: 130px; float: left;">
                    ...
                    <div style="width: 130px; float: left;">
                        ...
                        <input id="descGravedad" name="descGravedad" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorGravedad" name="anchorGravedad" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGravedad" name="botonGravedad" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                    ...
                    <div style="width: 130px; float: left;">
                        ...
                        <input id="descTipoContrato" name="descTipoContrato" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorTipoContrato" name="anchorTipoContrato" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoContrato" name="botonTipoContrato" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="width: 130px; float: left;">
