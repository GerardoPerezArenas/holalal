...
<script type="text/javascript">
    ...
    function recargarTablaPreparadoresSolicitudEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            ...
            listaPreparadores_solTabla[i-1] = [fila[29] != undefined && fila[29].length > 0 ? '<img src="<%=request.getContextPath()%>/images/extension/melanbide44/alert.png"/>' : '', fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10], fila[11], fila[12], fila[13], fila[14], fila[15], fila[16], fila[17], fila[18], fila[19], fila[20], fila[21], fila[22], fila[23], fila[24], fila[25], fila[26], fila[27], fila[28]];
        ...
        tabPreparadores_sol.addColumna('143','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2.title")%>');
        tabPreparadores_sol.addColumna('70','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4.title")%>');
        tabPreparadores_sol.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5.title")%>');
        ...
        tabPreparadores_sol.addColumna('90','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9.title")%>');
        tabPreparadores_sol.addColumna('90','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col10")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0.title")%>');
        tabPreparadores_sol.addColumna('90','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11.title")%>');
        ...
        tabPreparadores_sol.addColumna('80','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col28")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col28.title")%>');
    ...
    function pulsarNuevoPreparadorSolicitudEca(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),450,850,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),470,870,'no','no');
            }
            if (result != undefined){
    ...
    function pulsarSustituirPreparadorSolicitudEca(){
        if(tabPreparadores_sol.selectedIndex != -1) {
            if(listaPreparadores_sol[tabPreparadores_sol.selectedIndex][30] == undefined || listaPreparadores_sol[tabPreparadores_sol.selectedIndex][30] == null || listaPreparadores_sol[tabPreparadores_sol.selectedIndex][30] != '1')
            {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSustituirPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&idPrepSustituir='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),510,850,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarSustituirPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&idPrepSustituir='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),530,870,'no','no');
                }
                if (result != undefined){
                    if(result[0] == '0'){
                        recargarTablaPreparadoresSolicitudEca(result, true);
    ...
    function pulsarModifPreparadorSolicitudEca(){
        if(tabPreparadores_sol.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModif='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),510,850,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModif='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),530,870,'no','no');
            }
            if (result != undefined){
                recargarTablaPreparadoresSolicitudEca(result, true);
            }
