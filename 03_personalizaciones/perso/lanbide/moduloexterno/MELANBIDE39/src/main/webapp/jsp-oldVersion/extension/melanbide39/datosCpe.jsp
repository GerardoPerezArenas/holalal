...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide39.util.ConfigurationParameter"%>
...
<script type="text/javascript">   
    ...
    function guardarDatosCpe(){
        if(validarDatosCpe()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=guardarDatosCpe&tipo=0&numero=<%=numExpediente%>'
    ...
    function validarDatosCpe(){
        ...
        if(!comprobarCaracteresEspecialesCpe(empresa)){
            ...
            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.empresaCaracteresNoPermitidos")%>';
            return false;
        }else{
        ...
        if(document.getElementById('impSolicitado').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impSolicitado'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impSolicitadoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impConvocatoria').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impConvocatoria'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConvocatoriaIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impConcedido').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impConcedido'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConcedidoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impPrevistoConcesion').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impPrevistoConcesion'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPrevistoConcesionIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impJustificado').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impJustificado'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impJustificadoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impRenunciado').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impRenunciado'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impRenunciadoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impPagado').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impPagado'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPagadoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impPagado2').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impPagado2'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPagado2Incorrecto")%>';
                }else{
                    if(comprobarImportePagado()){
        ...
        if(document.getElementById('impReintegrar').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impReintegrar'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impReintegrarIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('otrasAyudasSolic').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('otrasAyudasSolic'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.otrasAyudasSolicIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('otrasAyudasConce').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('otrasAyudasConce'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.otrasAyudasConceIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('minimisSolic').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('minimisSolic'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.minimisSolicIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('minimisConce').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('minimisConce'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.minimisConceIncorrecto")%>';
                }else{
        ...
        <%--if(document.getElementById('impDespido').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impDespido'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impDespidosIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impBaja').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impBaja'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impBajasIncorrecto")%>';
                }else{
   ...
   /*     var impSubvFinalCorrecto = true;
        if(document.getElementById('impSubvFinal').value != ''){
            try{
                if(!validarNumericoDecimalCpe(document.getElementById('impSubvFinal'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impSubvFinalIncorrecto")%>';
                }else{
        ...
        //Si todos los datos tienen el formato válido pero el campo Imp. Subv. Final 
        //no es la suma de los otros dos, se pregunta si quiere guardar.
        if(correcto && !impSubvFinalCorrecto){
            var resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.preguntaimpSubvFinalIncorrecto")%>');
            if (resultado != 1){
                correcto = false;
                mensajeValidacion = '';
            }
    ...
    function mostrarImpConCalculado(event){
        ...
        if(document.forms[0].modoConsulta.value == "si"){
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta('A','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen);
            }else{
                resultado = jsp_alerta('A','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen);
            }
        }else{
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen+'<br/><br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.preguntaAceptarImporte")%>');
            }else{
                resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen+'<br/><br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.preguntaAceptarImporte")%>');
            }
        }
        if (resultado == 1){
    ...
    function mostrarImpPagCalculado(event){
        var resultado;
        if(document.forms[0].modoConsulta.value == "si"){    
            resultado = jsp_alerta('A','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPagCalculadoEs")%>: <br/>'+document.getElementById('pagadoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>');
        }else{
            resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPagCalculadoEs")%>: <br/>'+document.getElementById('pagadoReal').value+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.preguntaAceptarImporte")%>');
        }
        if (resultado == 1){
    ...
    function mostrarImpPag2Calculado(event){
        ...
        if(document.forms[0].modoConsulta.value == "si"){    
            resultado = jsp_alerta('A','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPag2CalculadoEs")%>: <br/>'+valor+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>');
        }else{
            resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.impPag2CalculadoEs")%>: <br/>'+valor+' '+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.datosCpe.preguntaAceptarImporte")%>');
        }
        if (resultado == 1){
    ...
    function actualizarPestanaDatosSuplementarios(){
        try{
            if(estanCargadosCamposSuplementarios()){
                ...
                var parametros = '';
                var control = new Date();
                parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=getTodosCamposSuplementarios&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
                try{
                    ajax.open("POST",url,false);
                    ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=iso-8859-15");
                    ajax.setRequestHeader("Accept", "text/xml, application/xml, text/plain");     
                ...
                if(importes){
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[3];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[6];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[10];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[0];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[1];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[2];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[22];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[5];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[7];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[8];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[9];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[11];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[12];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_NO_JUS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[19];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[20];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = importes[21];
                    }catch(err){
                    }
                }
                ...
                if(puestos){
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_SOLICITADOS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[0];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DENEGADOS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[1];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[2];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_CONTRATADAS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[3];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DESPIDO, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[4];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_DESPIDO, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[5];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_BAJA, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[6];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_BAJA, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[7];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_RENUNCIADOS, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = puestos[8];
                    }catch(err){
                    }
                }
                ...
                if(otros){
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = otros[0];
                    }catch(err){
                    }
                    try{
                        document.getElementById('<%=ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide39.FICHERO_PROPIEDADES)%>').value = otros[1];
                    }catch(err){
                    }
                }
            }
     ...
     function consultarImportesResolucion(res){
        try{
            if(res != undefined && res != ''){
                var control = new Date();
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarImportesResolucion&res='+res+'&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),380,395,'yes','no');
                }else{
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarImportesResolucion&res='+res+'&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),400,440,'yes','no');
                }
            }else{
                //No se pueden cargar los datos
                jsp_alerta("A",'<%=meLanbide39I18n.getMensaje(idiomaUsuario,"error.cargarDatosResolucion")%>');
            }
        }catch(err){
     ...
     function consultarHistoricos(res){
        try{
            var control = new Date();
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),380,950,'yes','no');
            }else{            
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),400,950,'yes','no');
            }
        }catch(err){
...
<body>
    ...
    <div class="tab-page" id="tabPage391" style="height:480px; width: 100%;">
        <h2 class="tab" id="pestana391"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.tituloPestana")%></h2>
                ...
                <div style="clear: both; width: 100%; text-align: left; padding-left: 12px;" class="textoAzul">
                    <div class="lineaFormulario">
                        <div style="width: 97px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.gestorTramitador")%>
                        </div>
                        <div style="width: 259px; float: left;">
                            ...
                            <a id="anchorGestorTramitador" name="anchorGestorTramitador" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGestorTramitador" name="botonGestorTramitador" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="width: 51px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.empresa")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impSolicitado")%>
                        </div>
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impPrevistoConcesion")%>
                        </div>
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impConcedido")%>
                        </div>
                        ...
                        <div style="width: 30px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpConCalculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpCon" name="calcularImpCon" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.calcularImporteConcedido")%>" src="<c:url value='/images/extension/melanbide39/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impRenunciadoSol")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.primerPago")%>
                        </div>
                        <div style="width: 80px; float: left;">
                        ...
                        <div style="width: 23px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpPagCalculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpPag" name="calcularImpPag" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.calcularImportePagado")%>" src="<c:url value='/images/extension/melanbide39/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.segundoPago")%>
                        </div>
                        <div style="width: 80px; float: left;">
                        ...
                        <div style="width: 30px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpPag2Calculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpPag2" name="calcularImpPag2" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.calcularImportePagado2")%>" src="<c:url value='/images/extension/melanbide39/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impJustificado")%>
                        </div>
                        <div style="width: 110px; float: left;">
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impRenunciadoRes")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 100px; float: left; margin-right: 5px; margin-left: 423px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impNoJustif")%>
                        </div>
                        <div style="width: 110px; float: left;">
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impReintegrar")%>
                        </div>
                        <div style="width: 110px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 208px; float: left; padding-bottom: 10px;">
                            <input type="checkBox" id="checkOtrasAyudas" name="checkOtrasAyudas" onclick="mostrarOtrasAyudas();"/><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.mostrarOtrasAyudas")%>
                        </div>
                        <div style="float: right; width: 492px;">
                            <div style="width: 105px; float: left;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.minimisSolic")%>
                            </div>
                            <div style="width: 110px; float: left;">
                            ...
                            <div style="width: 105px; float: left;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.minimisConce")%>
                            </div>
                            <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario" style="height: 42px;">
                        <div id="divLabelOtrasAyudasSolic" style="width: 105px; float: rigth;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.otrasAyudasSolic")%>
                        </div>
                        ...
                        <div id="divLabelOtrasAyudasConce" style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.otrasAyudasConce")%>
                        </div>
                        ...
                        <div style="float: right; width: 80%; text-align: right; margin-right: 5%">
                            <a href="#" id="linkImpRes" name="linkImpRes" onclick="consultarImportesResolucion('I');"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.consulImpRes")%></a>
                            &nbsp;&nbsp;
                            <a href="#" id="linkImpResModif" name="linkImpResModif" onclick="consultarImportesResolucion('M');"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.consulImpResModif")%></a>
<BR />
                            <a href="#" id="linkImpHist" name="linkImpHist" onclick="consultarHistoricos('3');"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.consultaHist")%></a>                        
&nbsp;&nbsp;&nbsp;
                            <a href="#" id="linkImpHist2" name="linkImpHist" onclick="consultarHistoricos('44');"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.consultaHist2")%></a>                        
                        </div>
                    </div>
                    <!--<div class="lineaFormulario">-->
                        <!--<div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impDespido")%>
                        </div>
                        <div style="width: 103px; float: left;">
                        ...
                        <!--<div style="width: 105px; float: left;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impBaja")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 520px; float: left; text-align: right;">
                            <input type="button" id="btnGuardarDatosCpe" name="btnGuardarDatosCpe" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.guardar")%>" onclick="guardarDatosCpe();">
                        </div>
                        <div style="width: 390px; text-align: right; float: left;">
                            <span style="width: 110px; text-align: left; color: red;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.datosCpe.impConvocatoria")%>
                            </span>
                ...
                <div style="clear: both; width: 100%; text-align: left; padding-top: 10px;">
                    ...
                    <div class="tab-page" id="tabPage3911" style="height: 194px;">
                        <h2 class="tab" id="pestana3911" style="<%=margenIzqPestanasDatosCpe%>"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.solicitud.tituloPestana")%></h2>
                    ...
                    <div class="tab-page" id="tabPage3912" style="height: 194px;">
                        <h2 class="tab" id="pestana3912"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.tituloPestana")%></h2>
                    ...
                    <div class="tab-page" id="tabPage3913" style="height: 194px;">
                        <h2 class="tab" id="pestana3913"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justif.tituloPestana")%></h2>
                    ...
                    <div class="tab-page" id="tabPage3914" style="height: 194px;">
                        <h2 class="tab" id="pestana3914"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.resumen.tituloPestana")%></h2>
