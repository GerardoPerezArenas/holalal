...
<html>
    <head> 
        <%
            ...
            if(consulta)
            {
                tituloPagina = meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.titulo.consultaOferta");
            }
            else
            {
                if(ofertaModif != null)
                {
                    tituloPagina = meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.titulo.modifOferta");
                }
                else
                {
                    tituloPagina = meLanbide39I18n.getMensaje(idiomaUsuario, "label.oferta.titulo.nuevaOferta");
                }
            }
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    if(puestoConsulta.getCodResult() != null && puestoConsulta.getCodResult().equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_RENUNCIA))
                    {
                    %>    
                ...
                %>
                        ...
                        <%
                        if(ofertaConDatos.getPrec() != null && ofertaConDatos.getPrec().equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                        {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getDifusion() != null && ofertaConDatos.getDifusion().equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                        {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide39.FALSO))
                        {
                        %>
                        ...
                        {
                            if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                            {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getContratacionPresOferta() != null && ofertaConDatos.getContratacionPresOferta().equalsIgnoreCase(ConstantesMeLanbide39.FALSO))
                        {
                        %>
                        ...
                        {
                            if(ofertaConDatos.getContratacionPresOferta() != null && ofertaConDatos.getContratacionPresOferta().equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                            {
                        %>
                        ...
                        <%
                        if(ofertaModif.getFlSustituto() != null && ofertaModif.getFlSustituto().equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                        {
                        %>
                            document.getElementById('radioSustituyeS').checked = 'true';                                
                        <%
                        }
                        else if(ofertaModif.getFlSustituto() != null && ofertaModif.getFlSustituto().equalsIgnoreCase(ConstantesMeLanbide39.FALSO))
                        {
                        %>
            ...
            function guardar(){
                ...
                document.getElementById('msgGuardandoDatos').style.display="inline";
                    ...
                    var parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=guardarOferta&tipo=0&numero=<%=numExpediente%>'
                        ...
                        +'&radioCont='+(document.getElementById('radioContS').checked ? '<%=ConstantesMeLanbide39.CIERTO%>' : document.getElementById('radioContN').checked ? '<%=ConstantesMeLanbide39.FALSO%>' : '')
                        +'&radioPresOferta='+(document.getElementById('radioPresOfertaS').checked ? '<%=ConstantesMeLanbide39.CIERTO%>' : document.getElementById('radioPresOfertaN').checked ? '<%=ConstantesMeLanbide39.FALSO%>' : '')
                        +'&radioSustituye='+(document.getElementById('radioSustituyeS').checked ? '<%=ConstantesMeLanbide39.CIERTO%>' : document.getElementById('radioSustituyeN').checked ? '<%=ConstantesMeLanbide39.FALSO%>' : '')
                        +'&alta='+alta
                        +'&copiar='+copiar
                        +'&control='+control.getTime();
                    /*parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=guardarOferta&tipo=0&numero=<%=numExpediente%>'
                        +'&idOferta=<%=ofertaModif != null && ofertaModif.getIdOferta() != null ? ofertaModif.getIdOferta() : ""%>'
                        +'&idPuesto=<%=ofertaModif != null && ofertaModif.getCodPuesto() != null ? ofertaModif.getCodPuesto() : ""%>'
            ...
            function validarDatosOferta(){
                ...
                if(numOferta != null && numOferta != ''){
                    if(!comprobarCaracteresEspecialesCpe(numOferta)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.numeroOfertaCaracteresNoValidos")%>';
                        }
                ...
                if(!existeCodigoCombo(ofi, codOfiGestion)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.ofiGestNoExiste")%>';
                    }
                }else{
                ...
                if(nomPrec != null && nomPrec != ''){
                    if(nomPrec.length <= 200){
                        if(!comprobarCaracteresEspecialesCpe(nomPrec)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.precandidatosCaracteresNoValidos")%>';
                            }
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.precandidatosDemasiadoLargo")%>';
                        }
                        document.getElementById('txtNomPrecandidatos').style.border = '1px solid red';
                        correcto = false;
                    }
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaDifusionOferta'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.fechaDifusionIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaEnvioCandidatosOferta'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.fechaEnvioCandidatosIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                try{
                    if(!validarNumericoCpe(document.getElementById('txtNumCandidatosEnv'), 3)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.numCandidatosIncorrecto")%>';
                        }
                    }else{
                ...
                if(document.getElementById('radioContN').checked){
                    ...
                    if(motivo != null && motivo != ''){
                        if(!comprobarCaracteresEspecialesCpe(motivo)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.motivoContCaracteresNoValidos")%>';
                            }
                            ...
                            if(motivo.length > 1000){
                                if(mensajeValidacion == ''){
                                    mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.motivoContDemasiadoLargo")%>';
                                }
                                document.getElementById('motivoNoCont').style.border = '1px solid red';
                                correcto = false;
                            }else{
            ...
            function validarDatosContratado(){
                ...
                if(!existeCodigoCombo(tipoDoc, codNif)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nifNoExiste")%>';
                    }
                }else{
                ...
                if(nif != null && nif != ''){
                    if(!comprobarCaracteresEspecialesCpe(nif)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nifCaracteresNoValidos")%>';
                        }
                        ...
                        if(!tratarDatosDocumento(tipoDoc, nif)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.documentoIncorrecto")%>';
                            }
                            document.getElementById('txtNifOferta').style.border = '1px solid red';
                            correcto = false;   
                        }else{
                ...
                if(nombre != null && nombre != ''){
                    if(!comprobarCaracteresEspecialesCpe(nombre)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nombreCaracteresNoValidos")%>';
                        }
                ...
                if(ape1 != null && ape1 != ''){
                    if(!comprobarCaracteresEspecialesCpe(ape1)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.ape1CaracteresNoValidos")%>';
                        }
                ...
                if(ape2 != null && ape2 != ''){
                    if(!comprobarCaracteresEspecialesCpe(ape2)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.ape2CaracteresNoValidos")%>';
                        }
                ...
                if(email != null && email != ''){
                    if(!comprobarCaracteresEspecialesCpe(email)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.emailCaracteresNoValidos")%>';
                        }
                ...
                try{
                    if(!validarNumericoCpe(document.getElementById('txtTfno'), 15)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.tfnoIncorrecto")%>';
                        }
                    }else{
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaNacContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaNacIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                try{
                    if(!validarNumericoCpe(document.getElementById('anoTitulacion'), 15)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.anoTitulacionIncorrecto")%>';
                        }
                    }else{
                        ...
                        if(ano_act < ano_ini){
                            ...
                            document.getElementById('anoTitulacion').style.border = '1px solid red';
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.anoTitulacionPosteriorAnoAct")%>';
                            }
                        }else{
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaIniContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaIniIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaFinContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaFinIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(hayFechaIni && hayFechaFin){
                    ...
                    var result = n2 - n1;
                    if(result < 0){
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaFinAnteriorFechaIni")%>';
                        correcto = false;
                        document.getElementById('fechaIniContratado').style.border = '1px solid red';
                        document.getElementById('fechaFinContratado').style.border = '1px solid red';
                    }else{
                ...
                if(!existeCodigoCombo(grCot, codGrupoCot)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.codigoGrCotNoExiste")%>';
                    }
                }else{
                ...
                if(document.getElementById('txtSalarioContratado').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioContratado'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.salarioBrutoIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasConv').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtDietasConv'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.dietasConvenioIncorrecto")%>';
                        }else{
                ...
                if(sexo != null && sexo != ''){
                    if(sexo != '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.sexoH")%>' && sexo != '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.sexoM")%>'){
                        correcto = false;
                        document.getElementById('txtSexo').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.sexoIncorrecto")%>';
                    }
                    else{
            ...
            function validarDatosBaja(){
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaBaja'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosBaja.fechaBajaIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(obs != null && obs != ''){
                    if(!comprobarCaracteresEspecialesCpe(obs)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.puesto.datosBaja.observacionesCaracteresNoValidos")%>';
                        }
                        ...
                        if(obs.length > 1000){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.puesto.datosBaja.observacionesDemasiadoLargo")%>';
                            }
                            document.getElementById('observacionesBaja').style.border = '1px solid red';
                            correcto = false;
                        }else{
           ...
           function cambioPais2(){
            ...
            function altaSustituto(){
                ...
                var resultado = jsp_alerta('','<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.preguntaCopiarOferta")%>');
                if (resultado == 1){
                    copiar = 1;
                }else{
                    copiar = 0;
            ...
            function copiarDatos(){               
                  ...
                  var ajax = getXMLHttpRequest();
                    ...
                    var parametros = '';
                    var control = new Date();
                    parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=copiarDatosPuesto&numero=<%=numExpediente%>'
                        +'&idOferta=<%=ofertaModif != null && ofertaModif.getIdOferta() != null ? ofertaModif.getIdOferta() : ""%>'
                  ...
                  <%--  var CONTEXT_PATH = '<%=request.getContextPath()%>'
                    ...
                    var parametros = "";
                    var control = new Date();
                    var parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=copiarDatosPuesto&tipo=0&numero=<%=numExpediente%>'
                        +'&idOferta=<%=ofertaModif != null && ofertaModif.getIdOferta() != null ? ofertaModif.getIdOferta() : ""%>'
                        +'&idPuesto=<%=ofertaModif != null && ofertaModif.getCodPuesto() != null ? ofertaModif.getCodPuesto() : ""%>'    
                        +'&checkPrecandidatosOferta='+document.getElementById('checkPrecandidatosOferta').value
                        +'&checkDifusionOferta='+document.getElementById('checkDifusionOferta').value
            ...
            function buscarTercero(){
                if(tipoDoc != '' && numDoc != ''){
                    ...
                    var control = new Date();
                    parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=busquedaTercero&tipo=0&numero=<%=numExpediente%>'
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            ...
                            jsp_alerta("A",'<%=meLanbide39I18n.getMensaje(idiomaUsuario,"error.errorBusqTercero")%>');
                        }
                    }
                    catch(err){
                        jsp_alerta("A",'<%=meLanbide39I18n.getMensaje(idiomaUsuario,"error.errorProcesarRespuestaGen")%>');
                    }//try-catch
                }else{
                    //Limpiamos el resto
                    document.getElementById('txtNombre').value = '';
            ...
            function buscarTitulacion(id){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide39/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),360,980,'yes','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide39/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),420,980,'yes','no');
                }
            ...
            function load(){
             if(document.getElementById('radioPresOfertaS').checked)
             {
                ...
                if(radioN.checked){
                   document.getElementById('fieldsetDatosPersonaContratada').style.display = 'none';
                   document.getElementById('fieldsetDatosBaja').style.display = 'none';
                   document.getElementById('motivoNoCont').style.display = 'inline';
                   document.getElementById('divRenuncia').style.display = 'inline';
                }*/
        ...
        <div id="divCuerpo" style="overflow-y: auto; padding: 10px;">
            <form  id="formNuevaOferta" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                        ...
                                                        <span id="msgBuscandoDatosTercero">
                                                            <%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.buscandoDatosTercero")%>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 11px;">
                            ...
                            <input type="button" id="btnCopiarDatosSoli" name="btnCopiarDatosSoli" class="botonGeneral"  value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.oferta.copiarDatosSol")%>" onclick="copiarDatos();">
                        </div>
                    </div>
                    <div class="lineaFormulario">    
                        <div style="float: left; width: 42px;">
                    ...
                    <div class="lineaFormulario">        
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input type="button" id="btnBuscarTitulacionPuesto1" name="btnBuscarTitulacionPuesto1" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="buscarTitulacion('TitulacionPuesto1');">
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input type="button" id="btnBuscarTitulacionPuesto2" name="btnBuscarTitulacionPuesto2" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="buscarTitulacion('TitulacionPuesto2');">
                        </div>  
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input type="button" id="btnBuscarTitulacionPuesto3" name="btnBuscarTitulacionPuesto3" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="buscarTitulacion('TitulacionPuesto3');">
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 78px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.presentaOferta")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioPresOferta" id="radioPresOfertaS" value="S" onclick="cambioRadioPresOferta(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioPresOferta" id="radioPresOfertaN" value="N" onclick="cambioRadioPresOferta(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div style="float: left;" id="divTxtCausaRenunciaPresOferta" name="divTxtCausaRenunciaPresOferta">    
                            <div style="float: left; width: 110px;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.causaRenuncia")%>
                            </div>
                            <div style="float: left;">
                                ...
                                <input id="descCausaRenunciaPresOferta" name="descCausaRenunciaPresOferta" type="text" class="inputTexto" size="20" readonly >
                                 <a id="anchorCausaRenunciaPresOferta" name="anchorCausaRenunciaPresOferta" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenunciaPresOferta" name="botonCausaRenunciaPresOferta" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                            </div>
                        </div>
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosOferta" name="fieldsetDatosOferta">
                    <legend class="legendAzul"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"legend.oferta.datosOferta")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.numOferta")%>
                        </div>
                        ...
                        <div style="float: left; width: 120px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.ofiGestion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descOfiGestionOferta" name="descOfiGestionOferta" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorOfiGestionOferta" name="anchorOfiGestionOferta" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonOfiGestionOferta" name="botonOfiGestionOferta" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.difuOferta")%>
                        </div>
                        ...
                        <div id="divFechaDifusion" name="divFechaDifusion">
                            <div style="float: left; width: 90px;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fechaDifuOferta")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                                <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaDifusionOferta" name="fechaDifusionOferta" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                                <A href="javascript:calClick(event);" onclick="mostrarCalFechaDifusionOferta(event);return false;" style="text-decoration:none;" >
                                    <IMG style="border: 0" height="17" id="calfechaDifusionOferta" name="calfechaDifusionOferta" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.difuOferta")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                                </A>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 224px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fecEnvioCandidatos")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 12px; margin-right: 20px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaEnvioCandidatosOferta" name="fechaEnvioCandidatosOferta" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaEnvioCandidatosOferta(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaEnvioCandidatosOferta" name="calfechaEnvioCandidatosOferta" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fecEnvioCandidatos")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 200px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.numTotCandidatosEnv")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 765px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.docGetionOferta")%>:&nbsp;
                            <input type="file"  name="docGestionOferta" id="docGestionOferta" class="inputTexto" size="57">
                            <input type="button" id="btnVerDocGestionOferta" name="btnVerDocGestionOferta" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.ver")%>" onclick="verDocumento('gestionOferta');">
                            <input type="button" id="btnModifDocGestionOferta" name="btnModifDocGestionOferta" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.modificar")%>" onclick="mostrarModificarDocumentoGestion();">
                            <input type="button" id="btnCancelarModifDocGestionOferta" name="btnCancelarModifDocGestionOferta" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelarModificarDocumentoGestion();">
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.precandidatos")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 15px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.contratacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioCont" id="radioContS" value="S" onclick="cambioRadioContratacion(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioCont" id="radioContN" value="N" onclick="cambioRadioContratacion(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div id="divMotNoContratacion" name="divMotNoContratacion">
                            <div style="float: left; width: 35px; margin-left: 20px;">
                                <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.motNoContratacion")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 6px;">
                                <textarea rows="4" cols="105" id="motivoNoCont" name="motivoNoCont" maxlength="1000" class="inputTexto"><%if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide39.FALSO)){%><%=ofertaConDatos.getMotContratacion() != null ? ofertaConDatos.getMotContratacion().toUpperCase() : "" %><%}%></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario" id="divRenuncia" name="divRenuncia">
                        <div style="float: left; width: 90px;" id="divTxtFechaRenuncia" name="divTxtFechaRenuncia">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fechaRenuncia")%>
                        </div>
                        ...
                        <div style="float: left;">
                            ...
                            <input id="descCausaRenuncia" name="descCausaRenuncia" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorCausaRenuncia" name="anchorCausaRenuncia" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenuncia" name="botonCausaRenuncia" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </fieldset>
                </div>
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosPersonaContratada" name="fieldsetDatosPersonaContratada">
                    ...
                    <div class="lineaFormulario">     
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descNifContratado" name="descNifContratado" type="text" class="inputTexto" size="19" readonly >
                             <a id="anchorNifContratado" name="anchorNifContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNifContratado" name="botonNifContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaNacContratado" name="fechaNacContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaNacContratado" name="calfechaNacContratado" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.fechaNac")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input type="button" id="btnBuscarTitulacionContratado" name="btnBuscarTitulacionContratado" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="buscarTitulacion('TitulacionContratado');">
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 765px;">
                            ...
                            <input type="button" id="btnModifDocContratacion" name="btnDocContratacion" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.modificar")%>" onclick="mostrarModificarDocumentoContratacion();">
                            <input type="button" id="btnCancelarModifDocContratacion" name="btnCancelarModifDocContratacion" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelarModificarDocumentoContratacion();">
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaIniContratado" name="fechaIniContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaIniContratado" name="calfechaIniContratado" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feIni")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaFinContratado" name="fechaFinContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaFinContratado" name="calfechaFinContratado" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feFin")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                            ...
                            <input id="descGrupoCotContratado" name="descGrupoCotContratado" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoCotContratado" name="anchorGrupoCotContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoCotContratado" name="botonGrupoCotContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosBaja" name="fieldsetDatosBaja">
                    <legend class="legendAzul"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"legend.oferta.datosBaja")%></legend> 
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.fecha")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaBaja" name="fechaBaja" onkeyup="checkSustituto();return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" onchange="checkSustituto();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaBaja(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaBaja" name="calfechaBaja" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.fecha")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.causa")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descCausaBaja" name="descCausaBaja" type="text" class="inputTexto" size="20" readonly onchange="checkDescSustituto();" >
                             <a id="anchorCausaBaja" name="anchorCausaBaja" href="" ><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaBaja" name="botonCausaBaja" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" ></a>
                        </div>
                    </div>
                    <div class="lineaFormulario" id="divSustitucion">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.sustituye")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioSustituye" id="radioSustituyeS" value="S" onclick="cambioRadioSustituye(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioSustituye" id="radioSustituyeN" value="N" onclick="cambioRadioSustituye(this);"><%=meLanbide39I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;" id="divAltaSustituto" name="divAltaSustituto">
                            <input type="button" id="btnAltaSustituto" name="btnAltaSustituto" class="botonMasLargo" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.oferta.datosBaja.altaSustituto")%>" onclick="altaSustituto();">
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.puesto.datosBaja.observaciones")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
