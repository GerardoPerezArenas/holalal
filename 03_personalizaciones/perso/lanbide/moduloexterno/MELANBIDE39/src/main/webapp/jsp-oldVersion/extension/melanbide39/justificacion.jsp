...
<script type="text/javascript">   
    function pulsarModificarJustifCpe(){
        ...
        if(tabJustifCpe.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarModificarJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idJustif='+listaJustifCpe[fila][0]+'&idPuesto='+listaJustifCpe[fila][1]+'&control='+control.getTime(),740,980,'yes','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE39&operacion=cargarModificarJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idJustif='+listaJustifCpe[fila][0]+'&idPuesto='+listaJustifCpe[fila][1]+'&control='+control.getTime(),800,980,'yes','no');
            }
            if (result != undefined){
    ...
    function getListaJustificacionesCpe(){
        ...
        var parametros = '';
        var control = new Date();
        parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=getListaJustificacionesNoDenegadasPorExpediente&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
        try{
...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
            <!--<input type="button" id="btnNuevaJustificacionCpe" name="btnNuevaJustificacionCpe" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "btn.alta")%>" onclick="pulsarAltaJustifCpe();">-->
            <input type="button" id="btnModificarJustifCpe" name="btnModificarJustifCpe" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarJustifCpe();">
            <!--<input type="button" id="btnEliminaJustifCpe" name="btnEliminaJustifCpe" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarJustifCpe();">-->
        </div>
    </div>
</body>
<script type="text/javascript">
