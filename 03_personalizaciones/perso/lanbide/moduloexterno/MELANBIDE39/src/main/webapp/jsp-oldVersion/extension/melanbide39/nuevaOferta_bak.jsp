        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    document.getElementById('botonTitulacionPuesto1').style.display = 'none';
                    document.getElementById('botonTitulacionPuesto2').style.display = 'none';
                    document.getElementById('botonTitulacionPuesto3').style.display = 'none';
                    ...
                    document.getElementById('botonTitulacionContratado').style.display = 'none';
                ...
                %>
                    ...
                    comboTitulacionContratado = new Combo('TitulacionContratado');
            ...
            function cargarCombos(){    
                ...
                comboTitulacionContratado.addItems(codTitulacion, descTitulacion);
            ...
            function cargarDescripcionTitulacion(codigo, campo){
                desc = '';
                encontrado = false;
                i = 0; 
                if(codigo != null && codigo != '')
            ...
            function cargarDescripcionesCombos(){
                ...
                //Titulacion 1
                codigo = '<%=ofertaModif != null && ofertaModif.getCodTit1() != null ? ofertaModif.getCodTit1() : ""%>';
                cargarDescripcionTitulacion(codigo, 'descTitulacionPuesto1');

                //Titulacion 2
                codigo = '<%=ofertaModif != null && ofertaModif.getCodTit2() != null ? ofertaModif.getCodTit2() : ""%>';
                cargarDescripcionTitulacion(codigo, 'descTitulacionPuesto2');
                
                //Titulacion 3
                codigo = '<%=ofertaModif != null && ofertaModif.getCodTit3() != null ? ofertaModif.getCodTit3() : ""%>';
                cargarDescripcionTitulacion(codigo, 'descTitulacionPuesto3');                
                ...
                codigo = '<%=ofertaModif != null && ofertaModif.getCodTitulacion() != null ? ofertaModif.getCodTitulacion() : ""%>';
                desc = '';
                encontrado = false;
                i = 0; 
                if(codigo != null && codigo != '')
            ...
            function validarDatosContratado(){
                ...
                //Titulacion
                var titulacion = document.getElementById('codTitulacionContratado').value;
                if(!existeCodigoCombo(titulacion, codTitulacion)){
                    correcto = false;
                    document.getElementById('codTitulacionContratado').style.border = '1px solid red';
                    document.getElementById('descTitulacionContratado').style.border = '1px solid red';
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.titulacionNoExiste")%>';
                    }
                }else{
                    document.getElementById('codTitulacionContratado').removeAttribute("style");
                    document.getElementById('descTitulacionContratado').removeAttribute("style");
                }
                    ...
                    try{
                        ...
                        for(j=0;hijos!=null && j<hijos.length;j++){
                            ...
                            if(hijos[j].nodeName=="CODTITU1") {                           
                               ...
                               cargarDescripcionTitulacion(titu1, 'descTitulacionPuesto1');
                            }                            
                            ...
                            cargarDescripcionTitulacion(titu2, 'descTitulacionPuesto2');
                            ...
                            cargarDescripcionTitulacion(titu3, 'descTitulacionPuesto3');
            ...
            <form  id="formNuevaOferta" enctype="multipart/form-data">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">      
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <textarea rows="4" cols="131" id="funcionesPuesto" name="funcionesPuesto" maxlength="1000" class="inputTexto " ><%=ofertaModif != null && ofertaModif.getFunciones() != null ? ofertaModif.getFunciones().toUpperCase() : "" %></textarea>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input id="codTitulacionContratado" name="codTitulacionContratado" type="text" class="inputTexto" size="2" maxlength="8" 
                                   onkeypress="javascript:return SoloDigitosConsulta(event);" value="">
                            <input id="descTitulacionContratado" name="descTitulacionContratado" type="text" class="inputTexto" size="70" readonly >
                             <a id="anchorTitulacionContratado" name="anchorTitulacionContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTitulacionContratado" name="botonTitulacionContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide39I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaBaja" name="fechaBaja" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCpe(this, '<%=meLanbide39I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
