...
<html>
    ...
    <body>
            <div class="tab-page" style="height:420px; width: 90%;">
            ...
            <script type="text/javascript">
                ...
                function pulsarAltaEspecialidad(){
                    ...
                    var result = null;
                    if(navigator.appName.indexOf("Internet Explorer")!=-1){
                        result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarNuevaEspecialidad&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),300,780,'no','no');
                    }else{
                        result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarNuevaEspecialidad&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),300,780,'no','no');
                    }
                    if (result != undefined){
                ...
                function pulsarModificarEspecialidad(){
                    if(tabEspecialidades.selectedIndex != -1) {
                        ...
                        var result = null;
                        if(navigator.appName.indexOf("Internet Explorer")!=-1){
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarModifEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[tabEspecialidades.selectedIndex][0]+'&control='+control.getTime(),300,780,'no','no');
                        }else{
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarModifEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[tabEspecialidades.selectedIndex][0]+'&control='+control.getTime(),300,780,'no','no');
                        }
                        if (result != undefined){
                ...
                function recargarTablaEspecialidades(result){
                    ...
                    if(navigator.appName.indexOf("Internet Explorer")!=-1){
                        try{
                            ...
                            //div.children[0].children[0].children[0].children[0].children[0].children[1].style.width = '100%';
                            //div.children[0].children[1].children[0].children[1].style.width = '100%'; 
                            div.children[0].children[0].children[2].style.width = '100%';
                            div.children[1].style.width = '100%'; 
                        }
                        catch(err){
                ...
                /*function pulsarListasxEspecialidad1{
                    if(tabEspecialidades.selectedIndex != -1) {
                        ...
                        if(navigator.appName.indexOf("Internet Explorer")!=-1){
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarListasxEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[tabEspecialidades.selectedIndex][0]+'&control='+control.getTime(),700,1200,'no','no');
                        }else{
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarListasxEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[tabEspecialidades.selectedIndex][0]+'&control='+control.getTime(),700,1200,'no','no');
                        }
                        if (result != undefined){
                 ...
                 function pulsarListasxEspecialidad(event){
                    ...
                    if(fila >= 0 && fila < listaEspecialidades.length) {
                        ...
                        var result = null;
                        if(navigator.appName.indexOf("Internet Explorer")!=-1){
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarListasxEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[fila][0]+'&control='+control.getTime(),520,1100,'no','no');
                        }else{
                            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE41&operacion=cargarListasxEspecialidad&tipo=0&numero=<%=numExpediente%>&id='+listaEspecialidades[fila][0]+'&control='+control.getTime(),520,1100,'no','no');
                        }
                        if (result != undefined){
