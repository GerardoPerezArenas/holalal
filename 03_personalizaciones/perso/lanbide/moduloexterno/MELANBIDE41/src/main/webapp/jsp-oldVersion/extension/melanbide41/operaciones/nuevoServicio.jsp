         ...
         <script type="text/javascript">
            ...
            function guardarDatos(){
                ...
                if(validarDatos()){
                    ...
                    if(nuevo != null && nuevo == "1"){
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=crearServicio&tipo=0&numero=<%=numExpediente%>"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=modificarServicio&tipo=0&numero=<%=numExpediente%>"
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            ...
                            window.returnValue =  listaServicios;
                            cerrarVentana();
            ...
            function validarDatos(){
                ...
                if(descripcion == null || descripcion == ''){
                    mensajeValidacion = '<%=meLanbide41I18n.getMensaje(idiomaUsuario, "servicios.msg.todosCamposOblig")%>';
                    return false;
                }
                else{
                ...
                if(ubicacion == null || ubicacion == ''){
                    mensajeValidacion = '<%=meLanbide41I18n.getMensaje(idiomaUsuario, "servicios.msg.ubicacion")%>';
                    return false;
                }
                else{
                ...
                if(superficie == null || superficie == ''){
                    mensajeValidacion = '<%=meLanbide41I18n.getMensaje(idiomaUsuario, "servicios.msg.superficie")%>';
                    return false;
                }
                else
                {
                    if(!validarNumericoDecimalPrecision(document.getElementById('superficie'),6,2)){
                        mensajeValidacion = '<%=meLanbide41I18n.getMensaje(idiomaUsuario, "servicios.msg.superficie.errDecimal")%>';
                    return false;
                    }
                }
               return correcto;
        ...
        <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
            <div style="width: 100%; padding: 10px; text-align: left;">
                <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                    <span>
                        <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.servicios.nuevoAseoServicio")%>
                    </span>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.servicios.descripcion")%>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.servicios.ubicacionPlano")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.servicios.superficie")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
