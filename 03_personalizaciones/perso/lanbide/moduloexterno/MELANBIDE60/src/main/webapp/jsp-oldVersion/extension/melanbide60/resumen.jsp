...
<script type="text/javascript">  
    ...
    tabResumenCpe.addColumna('130','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col12")%>");     
    ...
    tabResumenCpe.addColumna('130','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col18")%>");     
    ...
    tabResumenCpe.addColumna('130','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col21")%>");     
    ...
    tabResumenCpe.addColumna('130','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col24")%>");    
    ...
    tabResumenCpe.addColumna('140','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col34")%>");   
