...
<html>
    <head> 
        <%
            ...
            if(consulta)
            {
                tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.titulo.consultaPuesto");
            }
            else
            {
                if(puestoModif != null)
                {
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.titulo.modifPuesto");
                }
                else
                {
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario, "label.puesto.titulo.nuevoPuesto");
                }
            }
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    document.getElementById('txtDietasSolicitables').value = '<%=puestoModif.getGastosSeguro() != null ? puestoModif.getGastosSeguro().toPlainString() : "" %>';
                    document.getElementById('txtMesesSolicitables').value = '<%=puestoModif.getMesesManut() != null ? puestoModif.getMesesManut().toString() : "" %>';
                    document.getElementById('txtSegurosSolicitables').value = '<%=puestoModif.getGastosVisado() != null ? puestoModif.getGastosVisado().toPlainString() : "" %>';
                    ...
                    document.getElementById('txtDietasSolicitud').value = '<%=puestoModif.getGastosSeguroSol() != null ? puestoModif.getGastosSeguroSol().toPlainString() : "" %>';
                    document.getElementById('txtTramitacionSolicitud').value = '<%=puestoModif.getGastosVisadoSol() != null ? puestoModif.getGastosVisadoSol().toPlainString() : "" %>';
                ...
                {
                %>
                    //document.getElementById('codResultadoResumen').value = '<%=ConstantesMeLanbide60.CODIGO_RESULTADO_NO_EVALUADO%>';
            ...
            function cargarDescripcionesCombos(){
                ...
                //Resultado
                codigo = '<%=puestoModif != null ? puestoModif.getCodResult() != null ? puestoModif.getCodResult() : "" : /*ConstantesMeLanbide60.CODIGO_RESULTADO_NO_EVALUADO*/""%>';
                desc = '';
                encontrado = false;
                i = 0; 
                if(codigo != null && codigo != '')
            ...
            function guardar(){
                ...
                if(document.getElementById('codResultadoResumen').value=='002' || document.getElementById('codResultadoResumen').value=='003'){
                     resultado= jsp_alerta('', '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarCambioRenuncia")%>');  
                }
                if (resultado == 1 || resultado==9){
                    if(validarDatos()){
                        ...
                        parametros = 'tarea=preparar&modulo=MELANBIDE60&operacion=guardarPuesto&tipo=0&numero=<%=numExpediente%>'
                            ...
                            +'&gastosSeguro='+document.getElementById('txtDietasSolicitables').value
                            +'&mesesManutencion='+document.getElementById('txtMesesSolicitables').value
                            +'&gastosVisado='+document.getElementById('txtSegurosSolicitables').value
                            ...
                            +'&gastosSeguroSolic='+document.getElementById('txtDietasSolicitud').value
                            +'&gastosVisadoSolic='+document.getElementById('txtTramitacionSolicitud').value
                        ...
                        for(j=0;hijos!=null && j<hijos.length;j++){
                            ...
                            if(codigoOperacion=="0"){
                                ...
                                jsp_alerta("A",'<%=meLanbide60I18n.getMensaje(idiomaUsuario,"msg.puestoGuardadoOK")%>');
                                cerrarVentana();
                ...
                if(document.getElementById('txtTotSalarioSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtTotSalarioSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.salarioAnexoTotIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtDietasSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.dietasManutIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtMesesSolicitables').value != ''){
                    try{
                        ...
                        if(!validarNumericoCme(document.getElementById('txtMesesSolicitables'), 4)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.mesesManutIncorrecto2")%>';
                        }else{
                            ...
                            if(estado != 1 && meses < 6)
                            {
                                ...
                                document.getElementById('txtMesesSolicitables').style.border = '1px solid red';
                                if(mensajeValidacion == ''){
                                    mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.mesesManutIncorrecto3")%>';
                ...
                if(document.getElementById('txtSegurosSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtSegurosSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.tramSegurosIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtImporteSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtImporteSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.impSolicIncorrecto")%>';
                        }else{
            ...
            function validarDatosContrato(){
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaIniContrato'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaIniIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaFinContrato'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaFinIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(correcto){
                    ...
                    if(array_fecha_ini.length == 3 && array_fecha_fin.length == 3)
                    {
                        ...
                        if(result < 0){
                            ...
                            document.getElementById('fechaFinContrato').style.border = '1px solid red';
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaIniPosteriorFechaFin")%>';
                            }
                        }else{
                            document.getElementById('fechaIniContrato').removeAttribute('style');
                            document.getElementById('fechaFinContrato').removeAttribute('style');
                ...
                if(!existeCodigoCombo(gCot, codGrupoCot)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.grupoCotIncorrecto")%>';
                    }
                }else{
                ...
                if(!comprobarCaracteresEspecialesCme(convenio)){
                    ...
                    mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.convenioCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(convenio.length > 500){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.convenioColDemasiadoLargo")%>';
                        }
                        document.getElementById('txtConvenioContrato').style.border = '1px solid red';
                        correcto = false;
                    }else{
                ...
                if(document.getElementById('txtSalarioContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtSalarioContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.salarioContratoIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtDietasContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.dietasConvenioIncorrecto")%>';
                        }else{
                ...
                //gastos visado
                if(document.getElementById('txtTramitacionContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtTramitacionContrato'), 10, 2)){
                            correcto = false;
                            document.getElementById('txtTramitacionContrato').style.border = '1px solid red';
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.dietasConvenioIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtCosteContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtCosteContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.costeContratacionIncorrecto")%>';
                        }else{
                ...
                if(!comprobarCaracteresEspecialesCme(benef)){
                    ...
                    mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.otrosBenefCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(benef.length > 1000){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.otrosBenefDemasiadoLargo")%>';
                        }
                        document.getElementById('otrosBeneficiosContrato').style.border = '1px solid red';
                        correcto = false;
                    }else{
            ...
            function validarDatosResumen() {
                ...
                if(!existeCodigoCombo(gCot, codResultado)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.resultadoNoExiste")%>';
                    }
                    ...
                    document.getElementById('descResultadoResumen').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.estado")%>';
                }else{
                ...
                if(!existeCodigoCombo(gCot, codMotivo)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.motivoNoExiste")%>';
                    }
                }else{
                ...
                if(!comprobarCaracteresEspecialesCme(obs)){
                    ...
                    mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.observacionesCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(obs.length > 1000){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.observacionesDemasiadoLargo")%>';
                        }
                        document.getElementById('observacionesResumen').style.border = '1px solid red';
                        correcto = false;
                    }else{
                ...
                if(document.getElementById('txtSalarioSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtSalarioSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.salarioIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtDietasSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.dietasIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtTramitacionSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtTramitacionSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.tramitacionIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtImpTotalSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtImpTotalSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.impTotIncorrecto")%>';
                        }else{
            ...
            function cambioResultado(){
                ...
                if(codigo != null && codigo != '')
                {
                    if(codigo == '<%=ConstantesMeLanbide60.CODIGO_RESULTADO_RENUNCIA%>' || codigo == '<%=ConstantesMeLanbide60.CODIGO_RESULTADO_DENEGADO%>'){
            ...
            function calcularCosteContratacion(campo){
                ...
                if(dStr != '' || sStr != '' || tStr != ''){
                    ...
                    if(correcto){
                        ...
                        if(tStr != ''){
                            visado = parseFloat(tStr);
                        }

                        var coste = dietas + salario + visado;
            ...
            function calcularImporteMaxSubv(){                
                ...
                var visado = 0.0;
                var seguro = 0.0;
                var salarioSolicitado = reemplazarTextoCme(document.getElementById('txtSalarioSolicitud').value, /,/g, '.');
                var gastosVisSoli = reemplazarTextoCme(document.getElementById('txtTramitacionSolicitud').value, /,/g, '.');
                var gastosSegSoli = reemplazarTextoCme(document.getElementById('txtDietasSolicitud').value, /,/g, '.');
                ...
                //SI IMPORTE SOLICITADO < IMPORTE SUBVENCIONABLE --> PONER IMPTE SOLICITADO
                if ( parseFloat(salarioSolicitado) < parseFloat(salario))
                        salario=salarioSolicitado;
                
                
                document.getElementById('txtTotSalarioSolicitables').value = salario;
                reemplazarPuntosCme(document.getElementById('txtTotSalarioSolicitables'));
                
                visado = salario * 0.02;
                seguro = salario * 0.02;
                
                if (parseFloat(gastosVisSoli)<visado)
                {
                        visado=reemplazarTextoCme(document.getElementById('txtTramitacionSolicitud').value, /,/g, '.');
                }
                
                if (parseFloat(gastosSegSoli)<seguro)
                {
                        seguro=reemplazarTextoCme(document.getElementById('txtDietasSolicitud').value, /,/g, '.');
                }
                
                document.getElementById('txtDietasSolicitables').value = seguro;
                document.getElementById('txtSegurosSolicitables').value = visado;
                
                //máximo subvencionable
                salario = parseFloat(salario) + parseFloat(visado) + parseFloat(seguro);
                                
                reemplazarPuntosCme(document.getElementById('txtDietasSolicitables'));
                reemplazarPuntosCme(document.getElementById('txtSegurosSolicitables'));
                
                document.getElementById('txtImporteSolicitables').value = salario;
                reemplazarPuntosCme(document.getElementById('txtImporteSolicitables'));
            }
            ...
            function ajustarDecimalesImportes(){
                ...
                if(!isNaN(f)){
                    ...
                    reemplazarPuntosCme(document.getElementById('txtTramitacionContrato'));
                    document.getElementById('txtTramitacionContrato').removeAttribute("style");
                }
            ...
            function buscarTitulacion(id){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide60/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),360,980,'yes','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide60/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),420,980,'yes','no');
                }
    ...
    <body id="cuerpoNuevaSolicitud" style="text-align: left;" class="contenidoPantalla">
        ...
        <form  id="formNuevoPuesto">
                    ...
                    <div class="lineaFormulario">    
                        ...
                        <div style="width: auto; float: left; margin-left: 12px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto1" name="descPaisPuesto1" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto1" name="anchorPaisPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto1" name="botonPaisPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto2" name="descPaisPuesto2" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto2" name="anchorPaisPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto2" name="botonPaisPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descPaisPuesto3" name="descPaisPuesto3" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto3" name="anchorPaisPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto3" name="botonPaisPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px;">
                    ...
                    <div class="lineaFormulario">        
                        ...
                        <div style="width: auto; float: left; margin-left: 2px; display: none;">
                            ...
                            <input id="descNivelFormativo" name="descNivelFormativo" type="text" class="inputTexto" size="1" readonly >
                             <a id="anchorNivelFormativo" name="anchorNivelFormativo" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelFormativo" name="botonNivelFormativo" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div> 
                    </div>
                    <div class="lineaFormulario">   
                        <div style="float: left; width: 78px;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto1" name="descIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto1" name="anchorIdiomaPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto1" name="botonIdiomaPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto1" name="descNivelIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto1" name="anchorNivelIdiomaPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto1" name="botonNivelIdiomaPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto2" name="descIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto2" name="anchorIdiomaPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto2" name="botonIdiomaPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto2" name="descNivelIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto2" name="anchorNivelIdiomaPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto2" name="botonNivelIdiomaPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto3" name="descIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto3" name="anchorIdiomaPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto3" name="botonIdiomaPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto3" name="descNivelIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto3" name="anchorNivelIdiomaPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto3" name="botonNivelIdiomaPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </fieldset>
                <fieldset id="fieldsetDatosContrato" name="fieldsetDatosContrato" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"legend.puesto.datosContrato")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecIni")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 107px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaIniContrato" name="fechaIniContrato" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCme(this, '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaIniContrato" name="calfechaIniContrato" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecIni")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecFin")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaFinContrato" name="fechaFinContrato" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCme(this, '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaFinContrato" name="calfechaFinContrato" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecFin")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.grupoCot")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 20px;">
                            ...
                            <input id="descGrupoContrato" name="descGrupoContrato" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoContrato" name="anchorGrupoContrato" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoContrato" name="botonGrupoContrato" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 128px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.convenio")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 128px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.salario")%>
                        </div>
                        ...
                        <div style="float: left; width: 100px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.dietas")%>
                        </div>
                        ...
                        <div style="float: left; width: 130px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.tramitacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtTramitacionContrato" name="txtTramitacionContrato" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();" />
                        </div>
                        <!--div style="width: auto; float: left; margin-left: 10px; margin-right: 20px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px; margin-right: 2px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.coste")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.otrosBeneficios")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <fieldset id="fieldsetDatosSolicitud" name="fieldsetDatosSolicitud" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"legend.puesto.datosSolicitud")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.salario")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtSalarioSolicitud" name="txtSalarioSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);calcularImporteMaxSubv();" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 100px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasSolicitud" name="txtDietasSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);calcularImporteMaxSubv();" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 130px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.tramitacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtTramitacionSolicitud" name="txtTramitacionSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);calcularImporteMaxSubv();" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();" />
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.impTotal")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                ...
                <fieldset id="fieldsetDatosSolicitables" name="fieldsetDatosSolicitables" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"legend.puesto.datosSubvencionables")%></legend>
<%--
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.nivelFormativo")%>
                        </div>
                        ...
                        <div style="float: left; width: 42px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais1")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                        ...
                        <div style="float: left; width: 150px; margin-right: 2px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.salario")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px; margin-left: 312px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais2")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px; margin-left: 312px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais3")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 150px; margin-right: 2px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.totSalario")%>
                        </div>
...
--%>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.rangoEdadPrevisto")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 35px; margin-right: 45px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.rangoEdadPrevisto35")%>
                        ...
                        <div style="float: left; width: 182px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.rangoEdadPrevisto45")%>
                        ...
                        <div style="float: left; width: 204px; text-align: right;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.impBrutoSegSocial")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.meses")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                        ...
                        <div style="float: left; width: 182px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.dietas")%>
                        </div>
                        ...
                        <div style="float: left; width: 152px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.tramSeguros")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="15" size="8" id="txtSegurosSolicitables" name="txtSegurosSolicitables" value="" class="inputTexto textoNumerico" disabled="true"/>
                        </div>
                    </div>
                    <div class="lineaFormulario" style="text-align: right;">
                        <div style="float: left; width: 180px; text-align: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.impMaxSubv")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <fieldset id="fieldsetResumenPuesto" name="fieldsetResumenPuesto" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"legend.puesto.datosResumenPuesto")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.resultado")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px; margin-right: 20px;">
                            ...
                            <input id="descResultadoResumen" name="descResultadoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorResultadoResumen" name="anchorResultadoResumen" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonResultadoResumen" name="botonResultadoResumen" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div id="divLabelMotivoResumen" style="float: left; width: 40px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.motivo")%>
                        </div>
                        <div id="divComboMotivoResumen" style="width: auto; float: left; margin-left: 10px; margin-right: 65px;">
                            ...
                            <input id="descMotivoResumen" name="descMotivoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorMotivoResumen" name="anchorMotivoResumen" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonMotivoResumen" name="botonMotivoResumen" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.observaciones")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
