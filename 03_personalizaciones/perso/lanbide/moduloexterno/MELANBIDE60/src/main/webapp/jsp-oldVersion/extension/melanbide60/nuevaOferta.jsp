                        ...
                        <div style="float: left;" id="divTxtCausaRenunciaPresOferta" name="divTxtCausaRenunciaPresOferta">    
                            ...
                            <div style="float: left;">
                                ...
                                <input id="descCausaRenunciaPresOferta" name="descCausaRenunciaPresOferta" type="text" class="inputTexto" size="20" readonly >
                                 <a id="anchorCausaRenunciaPresOferta" name="anchorCausaRenunciaPresOferta" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenunciaPresOferta" name="botonCausaRenunciaPresOferta" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                            </div>
                        </div>
                    ...
                    <div class="lineaFormulario" id="divRenuncia" name="divRenuncia">
                        ...
                        <div style="float: left;">
                            ...
                            <input id="descCausaRenuncia" name="descCausaRenuncia" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorCausaRenuncia" name="anchorCausaRenuncia" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenuncia" name="botonCausaRenuncia" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </fieldset>
                </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                            ...
                            <input id="descGrupoCotContratado" name="descGrupoCotContratado" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoCotContratado" name="anchorGrupoCotContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoCotContratado" name="botonGrupoCotContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
