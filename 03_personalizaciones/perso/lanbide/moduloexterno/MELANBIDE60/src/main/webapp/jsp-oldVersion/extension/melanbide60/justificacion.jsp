    ...
    function pulsarModificarJustifCme(){
        ...
        if(tabJustifCme.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarModificarJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idJustif='+listaJustifCme[fila][0]+'&idPuesto='+listaJustifCme[fila][1]+'&control='+control.getTime(),740,980,'yes','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarModificarJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idJustif='+listaJustifCme[fila][0]+'&idPuesto='+listaJustifCme[fila][1]+'&control='+control.getTime(),800,980,'yes','no');
            }
            if (result != undefined){
