...
<script type="text/javascript">   
    function pulsarAltaPuestoCme(){
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){ 
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarNuevoPuesto&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),560,980,'yes','no');
            //window.open('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarNuevoPuesto&tipo=0&numero=<%=numExpediente%>&control='+control.getTime());
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarNuevoPuesto&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),620,980,'yes','no');
        }
        if (result != undefined){
            if(result[0] == '0'){
    ...
    function pulsarModificarPuestoCme(){
        ...
        if(tabPuestosCme.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarModificarPuesto&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPuesto='+listaPuestosCme[fila][0]+'&control='+control.getTime(),560,980,'yes','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarModificarPuesto&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPuesto='+listaPuestosCme[fila][0]+'&control='+control.getTime(),620,980,'yes','no');
            }
            if (result != undefined){
                if(result[0] == '0'){
                    recargarTablaPuestosCme(result);
    ...
    function pulsarEliminarPuestoCme(){
        if(tabPuestosCme.selectedIndex != -1) {
            ...
            if (resultado == 1){
                ...
                parametros = 'tarea=preparar&modulo=MELANBIDE60&operacion=eliminarPuesto&tipo=0&numero=<%=numExpediente%>&idPuesto='+listaPuestosCme[tabPuestosCme.selectedIndex][0]+'&control='+control.getTime();
                try{
    ...
    function recargarTablaPuestosCme(result){
        ...
        tabPuestosCme.addColumna('0','left',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4")%>", "<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4.title")%>");   
    ...
    <div style="clear: both;">
        <div>
            ...
            <div class="botonera" style="text-align: center">
                <center>
                <input type="button" id="btnNuevoPuestoCme" name="btnNuevoPuestoCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.alta")%>" onclick="pulsarAltaPuestoCme();">
                <input type="button" id="btnModificarPuestoCme" name="btnModificarPuestoCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarPuestoCme();">
                <input type="button" id="btnEliminaPuestoCme" name="btnEliminaPuestoCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarPuestoCme();">
                </center>
            </div>
        </div>
    </div>
