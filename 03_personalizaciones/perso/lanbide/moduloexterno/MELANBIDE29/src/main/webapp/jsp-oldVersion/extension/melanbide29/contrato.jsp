...
<html>
    <head> 
        ...
        function mostrarBusqueda(tipo){
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide29/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),500,600,'no','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide29/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),550,600,'no','no');
            }
            if (result != undefined){
                if(tipo == 'PC'){
    ...
    <body onload="inicio();" id="cuerpoNuevoContratoRenovacion" style="margin: 10px; text-align: left; width: 98%;" class="contenidoPantalla">
        <div class="tab-page" id="tabPage100" style="height:520px; width: 100%;">
            <h2 class="tab" id="pestana291">Renovación Plantilla</h2>
                            ...
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                ...
                                <div style="float: left; width: 282px;">
                                    ...
                                    <input id="descEstudiosPC"	name="descEstudiosPC" type="text" class="inputTexto" size="20" readonly >
                                     <a id="anchorEstudiosPC" name="anchorEstudiosPC" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonEstudiosPC" name="botonEstudiosPC" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 260px;">
                                    ...
                                    <input id="codColectivoPC" name="codColectivoPC" type="text" class="inputTexto" size="2" maxlength="2"
                                     ...
                                     <a id="anchorColectivosPC" name="anchorColectivoPC" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonColectivoPC" name="botonColectivoPC" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                                ...
                                <div style="float: left; width: 290px;">
                                    ...
                                    <input id="codTipConDurPC" name="codTipConDurPC" type="text" class="inputTexto" size="2" maxlength="3"
                                     ...
                                     <a id="anchorTipConDurPC" name="anchorTipConDurPC" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipConDurPC" name="botonTipConDurPC" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 170px;">
                                ...
                                <div style="float: left; width: 340px;">
                                    ...
                                    <input id="codTipoJornadaPC" name="codTipoJornadaPC" type="text" class="inputTexto" size="2" maxlength="5"
                                     ...
                                     <a id="anchorTipoJornadaPC" name="anchorTipoJornadaPC" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoJornadaPC" name="botonTipoJornadaPC" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            ...
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 510px;">
                                    ...
                                    <input id="codCNOEPC" name="codCNOEPC" type="text" class="inputTexto" size="2" maxlength="4"
                                     ...
                                     <a id="anchorCNOEPC" name="anchorCNOEPC" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCNOEPC" name="botonCNOEPC" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                                <div style="float: left; width: 200px;">
                            ...
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                ...
                                <div style="float: left; width: 282px;">
                                    ...
                                    <input id="codEstudiosPA" name="codEstudiosPA" type="text" class="inputTexto" size="2" maxlength="3"
                                     ...
                                     <a id="anchorEstudiosPA" name="anchorEstudiosPA" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonEstudiosPA" name="botonEstudiosPA" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 260px;">
                                    ...
                                    <input id="codColectivoPA" name="codColectivoPA" type="text" class="inputTexto" size="2" maxlength="2"
                                     ...
                                     <a id="anchorColectivosPA" name="anchorColectivoPA" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonColectivoPA" name="botonColectivoPA" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                                ...
                                <div style="float: left; width: 290px;">
                                    ...
                                    <input id="codTipConDurPA" name="codTipConDurPA" type="text" class="inputTexto" size="2" maxlength="3"
                                     ...
                                     <a id="anchorTipConDurPA" name="anchorTipConDurPA" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipConDurPA" name="botonTipConDurPA" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 170px;">
                                ...
                                <div style="float: left; width: 340px;">
                                    ...
                                    <input id="codTipoJornadaPA" name="codTipoJornadaPA" type="text" class="inputTexto" size="2" maxlength="5"
                                     ...
                                     <a id="anchorTipoJornadaPA" name="anchorTipoJornadaPA" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoJornadaPA" name="botonTipoJornadaPA" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            ...
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 510px;">
                                    ...
                                    <input id="codCNOEPA" name="codCNOEPA" type="text" class="inputTexto" size="2" maxlength="4"
                                     ...
                                     <a id="anchorCNOEPA" name="anchorCNOEPA" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCNOEPA" name="botonCNOEPA" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            ...
                            <div style="width: 100%; clear: both; padding-top: 5px;">
                                <div style="float: left; width: 510px;">
                                    ...
                                    <input id="codCNOEPS" name="codCNOEPS" type="text" class="inputTexto" size="2" maxlength="4"
                                     ...
                                     <a id="anchorCNOEPS" name="anchorCNOEPS" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCNOEPS" name="botonCNOEPS" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide29I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                                </div>
                            </div>
                        </fieldset>
                    </div>    
