...
<div>
        <%
            MaterialConsuVO datModif = new MaterialConsuVO();
            ...
            try
            {
                ...
                {
                    datModif = (MaterialConsuVO)request.getAttribute("datModif");
                }
            }
            catch(Exception ex)
            {
            ...
            function guardarDatos(){
                ...
                if(validarDatos()){
                    ...
                    if(nuevo != null && nuevo == "1"){
                        parametros = "tarea=preparar&modulo=MELANBIDE45&operacion=crearMaterial&tipo=0&numero=<%=numExpediente%>"
                                +"&descripcion="+escape(document.getElementById('descripcion').value)
                                +"&cantidad="+ document.getElementById('cantidad').value;
                        
                    }
                    else{
                        parametros = "tarea=preparar&modulo=MELANBIDE45&operacion=modificarMaterial&tipo=0&numero=<%=numExpediente%>"
            ...
            function validarDatos(){
                ...
                else
                {
                    if(!compruebaTamanoCampo(document.getElementById('descripcion'),500)){
                        mensajeValidacion = '<%=meLanbide45I18n.getMensaje(idiomaUsuario, "msg.moduloformativo.duracion.errDecimal")%>';
                    return false;
                    }
                }
               return correcto;
        ...
        <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
            <div style="width: 100%; padding: 10px; text-align: left;">
                <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                    <span>
                        <%=meLanbide45I18n.getMensaje(idiomaUsuario,"label.materialConsu.nuevoMaterial")%>
                    </span>
                </div>
                <br><br>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide45I18n.getMensaje(idiomaUsuario,"label.materialConsu.cantidad")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input id="cantidad" name="cantidad" type="text" class="inputTexto" size="25" maxlength="9" 
                            value="<%=datModif != null && datModif.getCantidad() != null ? datModif.getCantidad()  : ""%>"/>
                        </div>
                    </div>
                </div>
                <br><br>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide45I18n.getMensaje(idiomaUsuario,"label.materialConsu.descripcion")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input id="descripcion" name="descripcion" type="text" class="inputTexto" size="100" maxlength="500" 
