...
<html>
    ...
    <body>
                ...
                <div style="clear: both;">
                    <label class="legendAzul" style="text-align: center; position: relative; left: 5px;"><%=meLanbide45I18n.getMensaje(idiomaUsuario, "legend.moduloformativo.titulo")%></label>
                        <div id="divGeneral"  style="overflow-y: auto; overflow-x: hidden; height: 440px;">     <!--onscroll="deshabilitarRadios();"-->
                            <div id="listaModuloForm" style="padding: 5px; width:850px; height: 300px; text-align: center; overflow-x: auto; overflow-y: auto;margin:0px;margin-top:0px;" align="center"></div>
                            <div class="botonera">
            ...
            <script type="text/javascript">
                ...
                tabModuloForm = new Tabla(document.getElementById('listaModuloForm'), 818);
