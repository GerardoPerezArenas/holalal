...
<script type="text/javascript">   
    ...
    var COD_SUBV15 = '<%=ConstantesMeLanbide69.getPropVal_CS_SUBV15(codOrganizacion,ConstantesMeLanbide69.getCOD_PROCEDIMIENTO())%>';
    ...
    function procesarRespuestaCopiarTextoAPortapapeles(result){
        ...
        if(result){
            ...
            datos = datos.tabla;
            if(datos.error=="0"){
                mostrarVentana(datos.texto,'<%=meLanbide69I18n.getMensaje(idiomaUsuario,"label.etiqFactASubsanar")%>');
            } else mostrarMensajeError(datos.error);
        } else mostrarMensajeError();
    }
