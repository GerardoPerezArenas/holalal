                    ...
                    if(datos.codProcedimiento!=""){
                        ...
                        if(datosTram.length>0){
                            ...
                            for(index=0; index<datosTram.length; index++){
                                ...
                                if(datoTram.fDesdePago==null || datoTram.fHastaPago==null) diasSolicitud = "-";
...
<body>
    <div class="tab-page" id="tabPage621" style="height:520px; width: 100%;">
        ...
        <div style="clear: both;">
            <div id="listaPagos" style="padding: 5px; width:930px; height: 300px; text-align: center; margin:0px;margin-top:0px;" align="center">
            </div>
...
<script type="text/javascript">
    ...
    tabListaPagos = new Tabla(document.getElementById('listaPagos'));
