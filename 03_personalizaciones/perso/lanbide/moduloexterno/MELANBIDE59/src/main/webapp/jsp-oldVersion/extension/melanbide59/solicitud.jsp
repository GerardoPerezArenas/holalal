...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide59.vo.FilaPuestoVO" %>
...
<script type="text/javascript">   
    function pulsarAltaPuestoCpe(){
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarNuevoPuesto&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),560,980,'yes','no');
        }else{
            result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarNuevoPuesto&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),620,980,'yes','no');
        }
        if (result != undefined){
            if(result[0] == '0'){
    ...
    function pulsarModificarPuestoCpe(){
       ...
       /* var idTabla = document.getElementById('puestosCpe').children[0].children[1].children[0].children[0].id;
        ...
        if(tabPuestosCpe.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarModificarPuesto&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPuesto='+listaPuestosCpe[fila][0]+'&control='+control.getTime(),560,980,'yes','no');
            }else{
                result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarModificarPuesto&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPuesto='+listaPuestosCpe[fila][0]+'&control='+control.getTime(),620,980,'yes','no');
            }
            if (result != undefined){
                if(result[0] == '0'){
                    recargarTablaPuestosCpe(result);
    ...
    function pulsarEliminarPuestoCpe(){
            ...
            if(tabPuestosCpe.selectedIndex != -1) {
                var resultado = jsp_alerta('', '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminar")%>');
                if (resultado == 1){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE59&operacion=eliminarPuesto&tipo=0&numero=<%=numExpediente%>&idPuesto='+listaPuestosCpe[tabPuestosCpe.selectedIndex][0]+'&control='+control.getTime();
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"msg.registroEliminadoOK")%>');
                        }else if(codigoOperacion=="1"){
                            jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"error.errorEliminarBD")%>');
                        }else if(codigoOperacion=="2"){
                            jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"error.errorEliminarGen")%>');
                        }else if(codigoOperacion=="3"){
                            jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"error.pasoParametrosEliminar")%>');
                        }else{
                            jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"error.errorEliminarGen")%>');
                        }//if(
                    }
    ...
    function recargarTablaPuestosCpe(result){
        ...
        tabPuestosCpe.addColumna('180','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col1")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col1.title")%>");
        tabPuestosCpe.addColumna('130','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col2")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col2.title")%>");    
        tabPuestosCpe.addColumna('80','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col3")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col3.title")%>");   
        tabPuestosCpe.addColumna('140','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4.title")%>");   
        tabPuestosCpe.addColumna('80','right',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col5")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col5.title")%>");   
        tabPuestosCpe.addColumna('100','right',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col6")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col6.title")%>");  
        tabPuestosCpe.addColumna('130','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col7")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col7.title")%>");   
        tabPuestosCpe.addColumna('130','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col8")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col8.title")%>");     
        tabPuestosCpe.addColumna('200','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col9")%>", "<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col9.title")%>");     
...
<body>
    ...
    <div style="clear: both;">
        <div>
            ...
            <div class="botonera">
                <input type="button" id="btnNuevoPuestoCpe" name="btnNuevoPuestoCpe" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "btn.alta")%>" onclick="pulsarAltaPuestoCpe();">
                <input type="button" id="btnModificarPuestoCpe" name="btnModificarPuestoCpe" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarPuestoCpe();">
                <input type="button" id="btnEliminaPuestoCpe" name="btnEliminaPuestoCpe" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarPuestoCpe();">
            </div>
        </div>
    </div>
</body>
