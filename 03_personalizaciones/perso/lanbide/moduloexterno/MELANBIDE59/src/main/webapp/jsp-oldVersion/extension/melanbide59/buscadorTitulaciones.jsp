...
<html>
    <head> 
        <%
            ...
            String tituloPagina = meLanbide59I18n.getMensaje(idiomaUsuario,"label.busqTitulaciones.tituloPagina");
        %>
        ...
        <script type="text/javascript">
            ...
            function buscar(){
                ...
                parametros = 'tarea=preparar&modulo=MELANBIDE59&operacion=buscarTitulaciones&tipo=0'
        ...
        function recargarTablaTitulaciones(result){
            ...
            tabTitulacionesBusq.addColumna('150','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"busqTitulaciones.tablaResultados.col1")%>");
            tabTitulacionesBusq.addColumna('774','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"busqTitulaciones.tablaResultados.col2")%>");
            ...
            document.getElementById('lblNumResultados').innerText = '<%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.busqTitulaciones.lblResultados1")%> '+(result.length - 1)+' <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.busqTitulaciones.lblResultados2")%>';
        }
    ...
    <body id="cuerpoBusqTitulaciones" style="text-align: left;" class="contenidoPantalla">
        ...
        <form  id="formBusqTitulaciones">
                                            ...
                                            <table width="349px" height="100%">
                                                <tr>
                                                    <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                        <span id="msgBuscando">
                                                            <%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.buscando")%>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <fieldset id="fieldsetCriterios" name="fieldsetCriterios" style="width: 100%; margin-left: 20px;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.busqTitulaciones.criterios")%></legend>
                    <div class="lineaFormulario" style="text-align: right;">
                        <div style="float: left; width: 42px; text-align: left;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.busqTitulaciones.criterios.codigo")%>
                        </div>
                        ...
                        <div style="float: left; width: 70px; text-align: left; margin-left: 20px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.busqTitulaciones.criterios.descripcion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="botonera" style="padding-top: 15px;">
                        <input type="button" id="btnBuscar" name="btnBuscar" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"btn.buscar")%>" onclick="buscar();">
                        <input type="button" id="btnLimpiar" name="btnLimpiar" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"btn.limpiar")%>" onclick="limpiar();">
                    </div>
                </fieldset>
                <fieldset id="fieldsetResultados" name="fieldsetResultados" style="width: 100%; margin-left: 20px;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.busqTitulaciones.resultados")%></legend>
                    <div class="lineaFormulario" style="text-align: right;">
                ...
                <div class="botonera">
                    <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="aceptar();">
                    <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cerrarVentana();">
                </div>
        </form>
        </div>
        <script type="text/javascript">
