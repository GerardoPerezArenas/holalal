...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide46.vo.FilaPersonaContratadaVO" %>
...
<html>
    <head> 
        <%
            ...
            tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario,"label.justif.titulo.datosJustif");
        ...
        <script type="text/javascript">
            ...
            function recargarTablaContratacionesCme(result){
                ...
                tabPersonasJustifCme.addColumna('80','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.nuevaJustificacion.tabla.personas.col1")%>");
                tabPersonasJustifCme.addColumna('490','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.nuevaJustificacion.tabla.personas.col2")%>");    
                tabPersonasJustifCme.addColumna('90','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.nuevaJustificacion.tabla.personas.col3")%>");   
                tabPersonasJustifCme.addColumna('90','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.nuevaJustificacion.tabla.personas.col4")%>");     
                tabPersonasJustifCme.addColumna('97','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.nuevaJustificacion.tabla.personas.col5")%>");     
        ...
        <div id="divCuerpo" style="overflow-y: auto; padding: 10px;">
            <form  id="formNuevaOferta">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <fieldset  style="width: 100%;">
                        <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.justificacion.personasContratadas")%></legend>
                        ...
                        <div class="lineaFormulario">
                            <div style="float: right; padding-right: 50px;">
                                <div style="float: left; width: 125px;">
                                    <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.personasContratadas.totalJustificado")%>
                                </div>
                                <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div class="lineaFormulario">
                            <div style="float: right; padding-right: 50px;">
                                <div style="float: left; width: 125px;">
                                    <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.personasContratadas.totalConcedido")%>
                                </div>
                                <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div class="botonera" id="botoneraJustificaciones">
                            <input type="button" id="btnModifJustif" name="btnModifJustif" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarConsultarPersonaContratada();">
                            <input type="button" id="btnConsultarJustif" name="btnConsultarJustif" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.consultar")%>" onclick="pulsarConsultarPersonaContratada();">
                        </div>
                    </fieldset>
                    <div class="botonera">
