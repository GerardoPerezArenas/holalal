...
<html>
    <head> 
        <%
            ...
            if(consulta)
            {
                tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.titulo.consultaOferta");
            }
            else
            {
                if(ofertaModif != null)
                {
                    tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.titulo.modifOferta");
                }
                else
                {
                    tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario, "label.oferta.titulo.nuevaOferta");
                }
            }
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    if(puestoConsulta.getCodResult() != null && puestoConsulta.getCodResult().equalsIgnoreCase(ConstantesMeLanbide46.CODIGO_RESULTADO_RENUNCIA))
                    {
                    %>    
                ...
                %>
                        ...
                        <%
                        if(ofertaConDatos.getPrec() != null && ofertaConDatos.getPrec().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                        {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getDifusion() != null && ofertaConDatos.getDifusion().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                        {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide46.FALSO))
                        {
                        %>
                        ...
                        {
                            if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                            {
                        %>
                        ...
                        <%
                        if(ofertaConDatos.getContratacionPresOferta() != null && ofertaConDatos.getContratacionPresOferta().equalsIgnoreCase(ConstantesMeLanbide46.FALSO))
                        {
                        %>
                        ...
                        {
                            if(ofertaConDatos.getContratacionPresOferta() != null && ofertaConDatos.getContratacionPresOferta().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                            {
                        %>
                        ...
                        <%
                        if(ofertaModif.getFlSustituto() != null && ofertaModif.getFlSustituto().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                        {
                        %>
                            document.getElementById('radioSustituyeS').checked = 'true';                                
                        <%
                        }
                        else if(ofertaModif.getFlSustituto() != null && ofertaModif.getFlSustituto().equalsIgnoreCase(ConstantesMeLanbide46.FALSO))
                        {
                        %>
            ...
            function guardar(){
                ...
                document.getElementById('msgGuardandoDatos').style.display="inline";
                    ...
                    var parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=guardarOferta&tipo=0&numero=<%=numExpediente%>'
                        ...
                        +'&radioCont='+(document.getElementById('radioContS').checked ? '<%=ConstantesMeLanbide46.CIERTO%>' : document.getElementById('radioContN').checked ? '<%=ConstantesMeLanbide46.FALSO%>' : '')
                        +'&radioPresOferta='+(document.getElementById('radioPresOfertaS').checked ? '<%=ConstantesMeLanbide46.CIERTO%>' : document.getElementById('radioPresOfertaN').checked ? '<%=ConstantesMeLanbide46.FALSO%>' : '')
                        +'&radioSustituye='+(document.getElementById('radioSustituyeS').checked ? '<%=ConstantesMeLanbide46.CIERTO%>' : document.getElementById('radioSustituyeN').checked ? '<%=ConstantesMeLanbide46.FALSO%>' : '')
                        +'&alta='+alta
                        +'&copiar='+copiar
            ...
            function validarDatosOferta(){
                ...
                if(numOferta != null && numOferta != ''){
                    if(!comprobarCaracteresEspecialesCme(numOferta)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.numeroOfertaCaracteresNoValidos")%>';
                        }
                ...
                if(!existeCodigoCombo(ofi, codOfiGestion)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.ofiGestNoExiste")%>';
                    }
                }else{
                ...
                if(nomPrec != null && nomPrec != ''){
                    if(nomPrec.length <= 200){
                        if(!comprobarCaracteresEspecialesCme(nomPrec)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.precandidatosCaracteresNoValidos")%>';
                            }
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.precandidatosDemasiadoLargo")%>';
                        }
                        document.getElementById('txtNomPrecandidatos').style.border = '1px solid red';
                        correcto = false;
                    }
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaDifusionOferta'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.fechaDifusionIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaEnvioCandidatosOferta'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.fechaEnvioCandidatosIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                try{
                    if(!validarNumericoCme(document.getElementById('txtNumCandidatosEnv'), 3)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.numCandidatosIncorrecto")%>';
                        }
                    }else{
                ...
                if(document.getElementById('radioContN').checked){
                    ...
                    if(motivo != null && motivo != ''){
                        if(!comprobarCaracteresEspecialesCme(motivo)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.motivoContCaracteresNoValidos")%>';
                            }
                            ...
                            if(motivo.length > 1000){
                                if(mensajeValidacion == ''){
                                    mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosOferta.motivoContDemasiadoLargo")%>';
                                }
                                document.getElementById('motivoNoCont').style.border = '1px solid red';
                                correcto = false;
                            }else{
            ...
            function validarDatosContratado(){
                ...
                if(!existeCodigoCombo(tipoDoc, codNif)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nifNoExiste")%>';
                    }
                }else{
                ...
                if(nif != null && nif != ''){
                    if(!comprobarCaracteresEspecialesCme(nif)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nifCaracteresNoValidos")%>';
                        }
                        ...
                        if(!tratarDatosDocumento(tipoDoc, nif)){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.documentoIncorrecto")%>';
                            }
                            document.getElementById('txtNifOferta').style.border = '1px solid red';
                            correcto = false;   
                        }else{
                ...
                if(nombre != null && nombre != ''){
                    if(!comprobarCaracteresEspecialesCme(nombre)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.nombreCaracteresNoValidos")%>';
                        }
                ...
                if(ape1 != null && ape1 != ''){
                    if(!comprobarCaracteresEspecialesCme(ape1)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.ape1CaracteresNoValidos")%>';
                        }
                ...
                if(ape2 != null && ape2 != ''){
                    if(!comprobarCaracteresEspecialesCme(ape2)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.ape2CaracteresNoValidos")%>';
                        }
                ...
                if(email != null && email != ''){
                    if(!comprobarCaracteresEspecialesCme(email)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.emailCaracteresNoValidos")%>';
                        }
                ...
                try{
                    if(!validarNumericoCme(document.getElementById('txtTfno'), 15)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.tfnoIncorrecto")%>';
                        }
                    }else{
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaNacContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaNacIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                try{
                    if(!validarNumericoCme(document.getElementById('anoTitulacion'), 15)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.anoTitulacionIncorrecto")%>';
                        }
                    }else{
                        ...
                        if(ano_act < ano_ini){
                            ...
                            document.getElementById('anoTitulacion').style.border = '1px solid red';
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.anoTitulacionPosteriorAnoAct")%>';
                            }
                        }else{
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaIniContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaIniIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaFinContratado'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaFinIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(hayFechaIni && hayFechaFin){
                    ...
                    var result = n2 - n1;
                    if(result < 0){
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.fechaFinAnteriorFechaIni")%>';
                        correcto = false;
                        document.getElementById('fechaIniContratado').style.border = '1px solid red';
                        document.getElementById('fechaFinContratado').style.border = '1px solid red';
                    }else{
                ...
                if(!existeCodigoCombo(grCot, codGrupoCot)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.codigoGrCotNoExiste")%>';
                    }
                }else{
                ...
                if(document.getElementById('txtSalarioContratado').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtSalarioContratado'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.salarioBrutoIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasConv').value != ''){
                    try{
                        if(!validarNumericoDecimalCme(document.getElementById('txtDietasConv'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.dietasConvenioIncorrecto")%>';
                        }else{
                ...
                if(sexo != null && sexo != ''){
                    if(sexo != '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.sexoH")%>' && sexo != '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.sexoM")%>'){
                        correcto = false;
                        document.getElementById('txtSexo').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosContratado.sexoIncorrecto")%>';
                    }
                    else{
            ...
            function validarDatosBaja(){
                ...
                if(!validarFechaCme(document.forms[0], document.getElementById('fechaBaja'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosBaja.fechaBajaIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!existeCodigoCombo(grCot, codCausaBaja)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.datosBaja.codigoCausaBajaNoExiste")%>';
                    }
                }else{
                ...
                if(obs != null && obs != ''){
                    if(!comprobarCaracteresEspecialesCme(obs)){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.puesto.datosBaja.observacionesCaracteresNoValidos")%>';
                        }
                        ...
                        if(obs.length > 1000){
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.puesto.datosBaja.observacionesDemasiadoLargo")%>';
                            }
                            document.getElementById('observacionesBaja').style.border = '1px solid red';
                            correcto = false;
                        }else{
           ...
           function cambioPais2(){
            ...
            function getListaOfertasCme(){
                ...
                var parametros = '';
                var control = new Date();
                parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=getListaOfertasNoDenegadasPorExpediente&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
                try{
            ...
            function altaSustituto(){
                ...
                var resultado = jsp_alerta('','<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.oferta.preguntaCopiarOferta")%>');
                if (resultado == 1){
                    copiar = 1;
                }else{
                    copiar = 0;
            ...
            function copiarDatos(){               
                  ...
                  var ajax = getXMLHttpRequest();
                    ...
                    var parametros = '';
                    var control = new Date();
                    parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=copiarDatosPuesto&numero=<%=numExpediente%>'
                        +'&idOferta=<%=ofertaModif != null && ofertaModif.getIdOferta() != null ? ofertaModif.getIdOferta() : ""%>'
                  ...
                  <%--  var CONTEXT_PATH = '<%=request.getContextPath()%>'
                    ...
                    var parametros = "";
                    var control = new Date();
                    var parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=copiarDatosPuesto&tipo=0&numero=<%=numExpediente%>'
                        +'&idOferta=<%=ofertaModif != null && ofertaModif.getIdOferta() != null ? ofertaModif.getIdOferta() : ""%>'
                        +'&idPuesto=<%=ofertaModif != null && ofertaModif.getCodPuesto() != null ? ofertaModif.getCodPuesto() : ""%>'    
                        +'&checkPrecandidatosOferta='+document.getElementById('checkPrecandidatosOferta').value
                        +'&checkDifusionOferta='+document.getElementById('checkDifusionOferta').value
            ...
            function buscarTercero(){
                if(tipoDoc != '' && numDoc != ''){
                    ...
                    var control = new Date();
                    parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=busquedaTercero&tipo=0&numero=<%=numExpediente%>'
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            ...
                            jsp_alerta("A",'<%=meLanbide46I18n.getMensaje(idiomaUsuario,"error.errorBusqTercero")%>');
                        }
                    }
                    catch(err){
                        jsp_alerta("A",'<%=meLanbide46I18n.getMensaje(idiomaUsuario,"error.errorProcesarRespuestaGen")%>');
                    }//try-catch
                }else{
                    //Limpiamos el resto
                    document.getElementById('txtNombre').value = '';
            ...
            function buscarTitulacion(id){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide46/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),360,980,'yes','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide46/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),420,980,'yes','no');
                }
        ...
        <div id="divCuerpo" style="overflow-y: auto; padding: 10px;">
            <form  id="formNuevaOferta" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                        ...
                                                        <span id="msgBuscandoDatosTercero">
                                                            <%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.buscandoDatosTercero")%>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 11px;">
                            ...
                            <input type="button" id="btnCopiarDatosSoli" name="btnCopiarDatosSoli" class="botonGeneral"  value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.oferta.copiarDatosSol")%>" onclick="copiarDatos();">
                        </div>
                    </div>
                    <div class="lineaFormulario">    
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 12px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto1" name="descPaisPuesto1" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto1" name="anchorPaisPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto1" name="botonPaisPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto2" name="descPaisPuesto2" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto2" name="anchorPaisPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto2" name="botonPaisPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descPaisPuesto3" name="descPaisPuesto3" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto3" name="anchorPaisPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto3" name="botonPaisPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px;">
                    ...
                    <div class="lineaFormulario">        
                        ...
                        <div style="width: auto; float: left; margin-left: 2px;">
                            ...
                            <input id="descNivelFormativo" name="descNivelFormativo" type="text" class="inputTexto" size="1" readonly >
                             <a id="anchorNivelFormativo" name="anchorNivelFormativo" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelFormativo" name="botonNivelFormativo" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto1" name="descIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto1" name="anchorIdiomaPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto1" name="botonIdiomaPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto1" name="descNivelIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto1" name="anchorNivelIdiomaPuesto1" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto1" name="botonNivelIdiomaPuesto1" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto2" name="descIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto2" name="anchorIdiomaPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto2" name="botonIdiomaPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto2" name="descNivelIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto2" name="anchorNivelIdiomaPuesto2" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto2" name="botonNivelIdiomaPuesto2" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto3" name="descIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto3" name="anchorIdiomaPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonIdiomaPuesto3" name="botonIdiomaPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                           <input id="codNivelIdiomaPuesto3" name="codNivelIdiomaPuesto3" type="text" class="inputTexto" size="2" maxlength="8" 
                            ...
                            <input id="descNivelIdiomaPuesto3" name="descNivelIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto3" name="anchorNivelIdiomaPuesto3" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNivelIdiomaPuesto3" name="botonNivelIdiomaPuesto3" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.presentaOferta")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioPresOferta" id="radioPresOfertaS" value="S" onclick="cambioRadioPresOferta(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioPresOferta" id="radioPresOfertaN" value="N" onclick="cambioRadioPresOferta(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div style="float: left;" id="divTxtCausaRenunciaPresOferta" name="divTxtCausaRenunciaPresOferta">    
                            <div style="float: left; width: 110px;">
                                <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.causaRenuncia")%>
                            </div>
                            <div style="float: left;">
                                ...
                                <input id="descCausaRenunciaPresOferta" name="descCausaRenunciaPresOferta" type="text" class="inputTexto" size="20" readonly >
                                 <a id="anchorCausaRenunciaPresOferta" name="anchorCausaRenunciaPresOferta" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenunciaPresOferta" name="botonCausaRenunciaPresOferta" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                            </div>
                        </div>
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosOferta" name="fieldsetDatosOferta">
                    <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.oferta.datosOferta")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.numOferta")%>
                        </div>
                        ...
                        <div style="float: left; width: 120px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.ofiGestion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descOfiGestionOferta" name="descOfiGestionOferta" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorOfiGestionOferta" name="anchorOfiGestionOferta" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonOfiGestionOferta" name="botonOfiGestionOferta" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.difuOferta")%>
                        </div>
                        ...
                        <div id="divFechaDifusion" name="divFechaDifusion">
                            <div style="float: left; width: 90px;">
                                <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fechaDifuOferta")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                                <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaDifusionOferta" name="fechaDifusionOferta" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onblur="javascript:return comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                                <A href="javascript:calClick(event);" onclick="mostrarCalFechaDifusionOferta(event);return false;" style="text-decoration:none;" >
                                    <IMG style="border: 0" height="17" id="calfechaDifusionOferta" name="calfechaDifusionOferta" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.difuOferta")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                                </A>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 224px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fecEnvioCandidatos")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 12px; margin-right: 20px;">
                            
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaEnvioCandidatosOferta" name="fechaEnvioCandidatosOferta" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaEnvioCandidatosOferta(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaEnvioCandidatosOferta" name="calfechaEnvioCandidatosOferta" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fecEnvioCandidatos")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 200px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.numTotCandidatosEnv")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 765px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.docGetionOferta")%>:&nbsp;
                            <input type="file"  name="docGestionOferta" id="docGestionOferta" class="inputTexto" size="57">
                            <input type="button" id="btnVerDocGestionOferta" name="btnVerDocGestionOferta" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.ver")%>" onclick="verDocumento('gestionOferta');">
                            <input type="button" id="btnModifDocGestionOferta" name="btnModifDocGestionOferta" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.modificar")%>" onclick="mostrarModificarDocumentoGestion();">
                            <input type="button" id="btnCancelarModifDocGestionOferta" name="btnCancelarModifDocGestionOferta" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelarModificarDocumentoGestion();">
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.precandidatos")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 15px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.contratacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioCont" id="radioContS" value="S" onclick="cambioRadioContratacion(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioCont" id="radioContN" value="N" onclick="cambioRadioContratacion(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div id="divMotNoContratacion" name="divMotNoContratacion">
                            <div style="float: left; width: 35px; margin-left: 20px;">
                                <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.motNoContratacion")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 6px;">
                                <textarea rows="4" cols="105" id="motivoNoCont" name="motivoNoCont" maxlength="1000" class="inputTexto"><%if(ofertaConDatos.getContratacion() != null && ofertaConDatos.getContratacion().equalsIgnoreCase(ConstantesMeLanbide46.FALSO)){%><%=ofertaConDatos.getMotContratacion() != null ? ofertaConDatos.getMotContratacion().toUpperCase() : "" %><%}%></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario" id="divRenuncia" name="divRenuncia">
                        <div style="float: left; width: 90px;" id="divTxtFechaRenuncia" name="divTxtFechaRenuncia">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosOferta.fechaRenuncia")%>
                        </div>
                        ...
                        <div style="float: left;">
                            ...
                            <input id="descCausaRenuncia" name="descCausaRenuncia" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorCausaRenuncia" name="anchorCausaRenuncia" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaRenuncia" name="botonCausaRenuncia" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </fieldset>
                </div>
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosPersonaContratada" name="fieldsetDatosPersonaContratada">
                    <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.oferta.datosContratado")%></legend>
                    
                    <div class="lineaFormulario">     
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.nif")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descNifContratado" name="descNifContratado" type="text" class="inputTexto" size="19" readonly >
                             <a id="anchorNifContratado" name="anchorNifContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonNifContratado" name="botonNifContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    ...
                    <div class="lineaFormulario"> 
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.nombre")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 80px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.ape1")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTexto" maxlength="200" size="30" id="txtApe1" name="txtApe1" value=""/>
                        </div>
                        <div style="float: left; width: 80px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.ape2")%>
                        </div>
                    ...
                    <div class="lineaFormulario"> 
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.email")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTexto" maxlength="200" size="30" id="txtEmail" name="txtEmail" value=""/>
                        </div>
                        <div style="float: left; width: 80px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.tfno")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.fechaNac")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaNacContratado" name="fechaNacContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaNacContratado" name="calfechaNacContratado" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.fechaNac")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 80px; margin-left: 111px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.sexo")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.titulacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input id="descTitulacionContratado" name="descTitulacionContratado" type="text" class="inputTexto" size="70" readonly >
                            <input type="button" id="btnBuscarTitulacionContratado" name="btnBuscarTitulacionContratado" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="buscarTitulacion('TitulacionContratado');">
                        </div>
                        <div style="float: left; width: 40px; margin-left: 26px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.anoTitulacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; ">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 765px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.docContratacion")%>:&nbsp;
                            <input type="file"  name="docContratacion" id="docContratacion" class="inputTexto" size="57">
                            <input type="button" id="btnVerDocContratacion" name="btnDocContratacion" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.ver")%>" onclick="verDocumento('contratacionOferta');">
                            <input type="button" id="btnModifDocContratacion" name="btnDocContratacion" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.modificar")%>" onclick="mostrarModificarDocumentoContratacion();">
                            <input type="button" id="btnCancelarModifDocContratacion" name="btnCancelarModifDocContratacion" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelarModificarDocumentoContratacion();">
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feIni")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaIniContratado" name="fechaIniContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaIniContratado" name="calfechaIniContratado" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feIni")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 80px; margin-left: 110px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feFin")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaFinContratado" name="fechaFinContratado" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContratado(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaFinContratado" name="calfechaFinContratado" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.feFin")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.grCot")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                            ...
                            <input id="descGrupoCotContratado" name="descGrupoCotContratado" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoCotContratado" name="anchorGrupoCotContratado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoCotContratado" name="botonGrupoCotContratado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 125px; margin-right: 2px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.salarioB")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 150px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.dietasConv")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 150px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.dietasConvoc")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <fieldset  style="width: 100%;" id="fieldsetDatosBaja" name="fieldsetDatosBaja">
                    <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.oferta.datosBaja")%></legend> 
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.fecha")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaBaja" name="fechaBaja" onkeyup="checkSustituto();return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaCme(this, '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();" onchange="checkSustituto();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaBaja(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calFechaBaja" name="calFechaBaja" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.fecha")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.causa")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descCausaBaja" name="descCausaBaja" type="text" class="inputTexto" size="20" readonly onchange="checkDescSustituto();" >
                             <a id="anchorCausaBaja" name="anchorCausaBaja" href="" ><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCausaBaja" name="botonCausaBaja" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" ></a>
                        </div>
                    </div>
                    <div class="lineaFormulario" id="divSustitucion">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosBaja.sustituye")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioSustituye" id="radioSustituyeS" value="S" onclick="cambioRadioSustituye(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioSustituye" id="radioSustituyeN" value="N" onclick="cambioRadioSustituye(this);"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;" id="divAltaSustituto" name="divAltaSustituto">
                            <input type="button" id="btnAltaSustituto" name="btnAltaSustituto" class="botonMasLargo" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.oferta.datosBaja.altaSustituto")%>" onclick="altaSustituto();">
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.puesto.datosBaja.observaciones")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
