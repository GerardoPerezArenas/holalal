...
<html>
    <head> 
        <%
            ...
            String tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario, "label.solicitud.titulo.nuevaSolicitud");
        %>
    ...
    <body id="cuerpoNuevaSolicitud" style="margin: 10px; text-align: left;" class="contenidoPantalla">
        <form  id="formNuevaSolicitud">
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosPuesto")%></legend>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.puesto")%>
                    </div>
                    ...
                    <div style="float: left;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.pais")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <input id="descPaisPuesto" name="descPaisPuesto" type="text" class="inputTexto" size="25" readonly >
                         <a id="anchorPaisPuesto" name="anchorPaisPuesto" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisPuesto" name="botonPaisPuesto" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.ciudad")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        <input type="text" maxlength="200" size="58" id="txtCiudadPuesto" name="txtCiudadPuesto" value=""/>
                    </div>
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.departamento")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <div class="lineaFormulario">        
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.titulacion")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descTitulacionPuesto" name="descTitulacionPuesto" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTitulacionPuesto" name="anchorTitulacionPuesto" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTitulacionPuesto" name="botonTitulacionPuesto" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div class="lineaFormulario">      
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.funciones")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.idioma")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                    ...
                    <div style="float: left;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosPuesto.nivelIdioma")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
            ...
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosSolicitables")%></legend>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.pais")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descPaisSolicitables" name="descPaisSolicitables" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorPaisSolicitables" name="anchorPaisSolicitables" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonPaisSolicitables" name="botonPaisSolicitables" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 100px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.grupoCot")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descGrupoSolicitables" name="descGrupoSolicitables" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorGrupoSolicitables" name="anchorGrupoSolicitables" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoSolicitables" name="botonGrupoSolicitables" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 150px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.salario")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.dietas")%>
                    </div>
                    ...
                    <div style="float: left; width: 100px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.meses")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        <input type="text" maxlength="15" size="6" id="txtMesesSolicitables" name="txtMesesSolicitables" value=""/>
                    </div>
                    <div style="float: left; width: 150px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.tramSeguros")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <div class="lineaFormulario" style="text-align: right;">
                    <div style="float: right; padding-right: 31px; width: 273px;">
                        <div style="float: left; width: 150px; text-align: left; padding-left: 40px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSolicitables.impSolic")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
            ...
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosSubvencion")%></legend>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSubvencion.otrasAyudas")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        <input type="text" maxlength="15" size="6" id="txtOtrasAyudasSubvencion" name="txtOtrasAyudasSubvencion" value=""/>
                    </div>
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosSubvencion.impSubvencion")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
            ...
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosOferta")%></legend>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.numOferta")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        <input type="text" maxlength="15" size="3" id="txtNumOferta" name="txtNumOferta" value=""/>
                    </div>
                    <div style="float: left; width: 120px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.ofiGestion")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.precandidatos")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        <input type="text" maxlength="15" size="3" id="txtPrecandidatosOferta" name="txtPrecandidatosOferta" value=""/>
                    </div>
                    <div style="float: left; width: 120px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.fecEnvioCandidatos")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        ...
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaEnvioCandidatosOferta(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calfechaEnvioCandidatosOferta" name="calfechaEnvioCandidatosOferta" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.fecEnvioCandidatos")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                        </A>
                    </div>
                </div>
                <div class="lineaFormulario">
                    ...
                    <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.difuOferta")%>
                    ...
                    <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.contratacion")%>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosOferta.listaCandidatos")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                        <textarea rows="10" cols="40" id="listaCandidatosOferta" name="listaCandidatosOferta" maxlength="5000"></textarea>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                        <input type="button" id="btnExaminarCandidatosOferta" name="btnExaminarCandidatosOferta" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.examinar")%>...">
                    </div>
                </div>
            </fieldset>
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosContratado")%></legend>
                <div class="lineaFormulario">     
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContratado.nif")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                ...
                <div class="lineaFormulario"> 
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContratado.nomApel")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                ...
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContratado.fechaNac")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                        ...
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacContratado(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calfechaNacContratado" name="calfechaNacContratado" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContratado.fechaNac")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                        </A>
                    </div>
                    <div style="width: 200px; float: left;">
                        <div style="float: left;">
                            <input type="radio" name="radioIniSust" id="radioInicial" value="I"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.solicitud.datosContratado.inicial")%>
                            <input type="radio" name="radioIniSust" id="radioSustituto" value="S"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.solicitud.datosContratado.sustituto")%>
                        </div>
                    </div>
                </div>
            </fieldset>
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosContrato")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.fecIni")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 75px;">
                            ...
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaIniContrato" name="calfechaIniContrato" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.fecIni")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.fecFin")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaFinContrato" name="calfechaFinContrato" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.fecFin")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.grupoCot")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 65px;">
                            ...
                            <input id="descGrupoContrato" name="descGrupoContrato" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoContrato" name="anchorGrupoContrato" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGrupoContrato" name="botonGrupoContrato" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        ...
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.convenio")%>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.salario")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            <input type="text" maxlength="11" size="15" id="txtSalarioContrato" name="txtSalarioContrato" value=""/>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            <input type="text" maxlength="11" size="15" id="txtDietasContrato" name="txtDietasContrato" value=""/>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosContrato.coste")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
            ...
            <fieldset  style="width: 95.5%;">
                <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.solicitud.datosBaja")%></legend> 
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosBaja.causa")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                    ...
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosBaja.fecha")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descFechaBaja" name="descFechaBaja" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorFechaBaja" name="anchorFechaBaja" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonFechaBaja" name="botonFechaBaja" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                        <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.datosBaja.listaCandidatos")%>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px;">
                        <div style="width: auto; float: left; clear: both;">
                            <input type="button" id="btnExaminarCandidatosBaja" name="btnExaminarCandidatosBaja" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.examinar")%>...">
                        </div>
                        <div style="width: auto; float: left; clear: both; margin-top: 10px;">
                            <input type="button" id="btnAltaCandidatosBaja" name="btnAltaCandidatosBaja" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.altaSustituto")%>">
                        </div>
                    </div>
                </div>
            </fieldset>
            <div class="botonera">
                <input type="button" id="btnGuardarContrato" name="btnGuardarContrato" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="crearContrato();">
