        ...
        <script type="text/javascript">
            ...
            function suma(){
                ...
                try{
                    ...
                    if(a5.value != '' && validarNumericoDecimalCme(a5, 50, 25)){
                    ...
                    //alert(document.getElementById('txtImpJustificado').value);
                    reemplazarPuntosCme(document.getElementById('txtImpJustificado'));
                    //alert(document.getElementById('txtImpJustificado').value);
                }catch(err){
...
<div style="clear:both;"><br /></div>
                    ...
                    <div class="lineaFormulario" style="display: none;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <a id="anchorEstado" name="anchorEstado" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonEstado" name="botonEstado" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                    </div>
                </fieldset>
                <div class="botonera">
