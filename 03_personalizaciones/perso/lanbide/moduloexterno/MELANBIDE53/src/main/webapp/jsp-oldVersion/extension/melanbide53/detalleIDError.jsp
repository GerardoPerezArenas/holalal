        ...
        function nuevoError() {
            if (validarDatos()) {
                ...
                parametros = "tarea=preparar&modulo=MELANBIDE53&operacion=nuevoIdError&tipo=0"
                            ...
                            + "&descC=" + document.getElementById('descCortaDetaErr').value
                            + "&descripcion=" + document.getElementById('descriptDetaErr').value
            ...
            <div style="width: 100%; padding: 10px; text-align: left;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div>
                        ...
                        <!--div style="float: left;">
                            <input readonly id="tipoDetaErr" name="tipoDetaErr" type="text" class="inputTextoM53" size="30" maxlength="25" 
                            value="<%=datDetaError != null && datDetaError.getTipo() != null ? datDetaError.getTipo() : ""%>"/>
                        </div-->
                    </div>
                </div>
                <br><br>
                ...
                <div class="lineaFormulario">
                    ...
                    <!--div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input readonly id="criticDetaErr" name="criticDetaErr" type="text" class="inputTextoM53" size="30" maxlength="25" 
                            value="<%=datDetaError != null && datDetaError.getCritico() != null ? datDetaError.getCritico() : ""%>"/>
                        </div>
                    </div-->
                </div>
                <br><br>
