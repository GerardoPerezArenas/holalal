...
/**
  ...
  *
  **/
public class OracleSQLDAOBlobRetrieveCmd implements SQLDAOBlobRetrieveCommand {
    private static final Logger _log =
            LogManager.getLogger(OracleSQLDAOBlobRetrieveCmd.class.getName());
	...
	OracleSQLDAOBlobRetrieveCmd( SQLDAOBlobCommandAdapter concreteAdapter ) {
