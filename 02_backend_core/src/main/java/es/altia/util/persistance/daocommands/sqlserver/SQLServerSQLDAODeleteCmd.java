...
/**
  ...
  *
  **/
public class SQLServerSQLDAODeleteCmd implements SQLDAODeleteCommand {
    private static final String CLSNAME= "SQLServerSQLDAODeleteCmd";
    private static final int[] INTEGRITY_VIOLATION_ERROR_CODES = {1,1400,1722,2291};

    /*_______Atributes______________________________________________*/
    private static final Logger _log =
            LogManager.getLogger(SQLServerSQLDAODeleteCmd.class.getName());
    
    private SQLDAOPKCommandAdapter pkAdapter = null;
	private String sqlQuery = null;

    /*_______Operations_____________________________________________*/
	public SQLServerSQLDAODeleteCmd( SQLDAOPKCommandAdapter concreteAdapter) {
