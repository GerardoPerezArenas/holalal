...
/**
  ...
  *
  **/
public class SQLServerRawSQLDAOBlobStoreCmd implements SQLDAOBlobStoreCommand {
    private static final Logger _log =
            LogManager.getLogger(SQLServerRawSQLDAOBlobStoreCmd.class.getName());
    private static final String CLSNAME = "SQLServerRawSQLDAOBlobStoreCmd";
    ...
    SQLServerRawSQLDAOBlobStoreCmd( SQLDAOBlobCommandAdapter concreteAdapter ) {
