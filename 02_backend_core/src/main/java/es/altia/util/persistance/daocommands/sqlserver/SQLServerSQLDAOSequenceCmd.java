 ...
 */
public class SQLServerSQLDAOSequenceCmd implements SQLDAOSequenceCommand {
    /*_______Constants______________________________________________*/
    private static final Logger _log =
            LogManager.getLogger(SQLServerSQLDAOSequenceCmd.class.getName());

    private static final String CLSNAME = "SQLServerSQLDAOSequenceCmd";
