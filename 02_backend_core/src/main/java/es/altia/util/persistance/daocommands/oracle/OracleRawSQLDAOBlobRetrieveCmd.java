...
/**
  ...
  *
  **/
public class OracleRawSQLDAOBlobRetrieveCmd implements SQLDAOBlobRetrieveCommand {
    private static final Logger _log =
            LogManager.getLogger(OracleRawSQLDAOBlobRetrieveCmd.class.getName());
    private static final String CLSNAME = "OracleRawSQLDAOBlobRetrieveCmd";

	private SQLDAOBlobCommandAdapter retrieveAdapter = null;
	private String sqlQuery = null;


	OracleRawSQLDAOBlobRetrieveCmd( SQLDAOBlobCommandAdapter concreteAdapter ) {
