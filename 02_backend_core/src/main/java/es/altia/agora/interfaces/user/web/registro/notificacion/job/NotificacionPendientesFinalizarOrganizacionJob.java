...
public class NotificacionPendientesFinalizarOrganizacionJob implements Job{
    private static Logger m_Log = LogManager.getLogger(NotificacionPendientesFinalizarOrganizacionJob .class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try{
            ...
            if(NotificacionJobLanbideUtils.getServer().equals(System.getProperty("weblogic.Name"))){
                m_Log.info("-------- lanzo el proceso NotificacionPendientesFinalizarOrganizacionJob::Weblogic.Name: " + System.getProperty("weblogic.Name") + " ------");
                ...
                while(tokens.hasMoreTokens()){
                    ...
                    NotificacionPendientesFinalizarManager.getInstance().notificarPendientesFinalizarOrganizacion(params);
                }
            }
        } catch (Exception e){
            e.printStackTrace();
