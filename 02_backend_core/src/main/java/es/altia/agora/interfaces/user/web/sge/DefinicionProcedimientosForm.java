...
public class DefinicionProcedimientosForm extends ActionForm {
   //Queremos usar el fichero de configuración technical
    ...
    protected static Logger m_Log =
            LogManager.getLogger(DefinicionProcedimientosForm.class.getName());
...
public void setTramites(Vector v) {
 ...
 /*public Vector getListaCodigosDoc() {
  ...
  public void setRestringido(String param) {  defProcVO.setRestringido(param);}
    ...
    public String getAutomatico() {  return defProcVO.getAutomatico(); }
    public void setAutomatico(String param) {  defProcVO.setAutomatico(param);}
