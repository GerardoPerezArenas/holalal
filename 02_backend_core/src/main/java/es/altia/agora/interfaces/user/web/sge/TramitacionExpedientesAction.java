...
//                m_Log.info("VALORES TIPOS FICHEROS ..... "+tramExpForm.getListaTiposFicheros());
    ...
    private Vector<TramitacionExpedientesValueObject> listaTramitesIniciar(
        ...
        if (listaCodTramites != null) {
            ...
            codigos = new StringTokenizer(listaCodTramites, ConstantesDatos.SEPARADOR, false);
            modos = new StringTokenizer(listaModoTramites, ConstantesDatos.SEPARADOR, false);
            utrs = new StringTokenizer(listaUtrTramites, ConstantesDatos.SEPARADOR, false);


            condiciones = new StringTokenizer(listaCumpleCondicion, ConstantesDatos.SEPARADOR, false);
