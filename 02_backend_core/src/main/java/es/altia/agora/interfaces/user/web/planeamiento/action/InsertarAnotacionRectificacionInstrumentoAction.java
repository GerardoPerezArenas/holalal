...
public final class InsertarAnotacionRectificacionInstrumentoAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(InsertarAnotacionRectificacionInstrumentoAction.class.getName());

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("InsertarAnotacionRectificacionInstrumentoAction.perform");
        ...
        Collection rectificaciones = instrumentoForm.getRectificaciones();
