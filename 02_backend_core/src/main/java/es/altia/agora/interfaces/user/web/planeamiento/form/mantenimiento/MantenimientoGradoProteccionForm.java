...
public class MantenimientoGradoProteccionForm extends ActionForm {

    //Necesitamos el servicio de log
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoGradoProteccionForm.class.getName());

    private String codigo;
    private String descripcion;

    public MantenimientoGradoProteccionForm() {
        reset();
    }
