...
public final class CargarSelectAction extends Action {
    protected static Logger m_Log = LogManager.getLogger(CargarSelectAction.class.getName());
        ...
        throws IOException, ServletException {
            ...
            try{
                ...
                if ("listaJoin".equals(tipo_select)){
					...
					{
						StringTokenizer condiciones = new StringTokenizer(column_valor_where,ConstantesDatos.SEPARADOR+",",false);
