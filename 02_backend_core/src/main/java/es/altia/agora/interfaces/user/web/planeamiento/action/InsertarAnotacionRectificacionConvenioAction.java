...
public final class InsertarAnotacionRectificacionConvenioAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(InsertarAnotacionRectificacionConvenioAction.class.getName());

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("InsertarAnotacionRectificacionConvenioAction.perform");
        HttpSession session = request.getSession();

        ConvenioUrbanisticoForm convenioForm = (ConvenioUrbanisticoForm)
                session.getAttribute("ConvenioUrbanisticoForm");
        Collection rectificaciones = convenioForm.getRectificaciones();
