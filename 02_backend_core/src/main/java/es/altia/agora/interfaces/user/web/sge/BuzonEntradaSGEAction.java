...
public final class BuzonEntradaSGEAction extends ActionSession {
	protected static Logger m_Log =
            LogManager.getLogger(BuzonEntradaSGEAction.class.getName());
	...
	private Vector obtenerVector(String listaDepartamentoRes, String listaUnidadOrgRes, String listaEjercicioRes, String listaNumeroRes, String listaTipoRes, String estado) {
		...
		if (listaDepartamentoRes!= null) {
			departamentoRes = new StringTokenizer(listaDepartamentoRes, ConstantesDatos.SEPARADOR+",",false);
			unidadOrgRes = new StringTokenizer(listaUnidadOrgRes,ConstantesDatos.SEPARADOR+",",false);
			ejercicioRes = new StringTokenizer(listaEjercicioRes,ConstantesDatos.SEPARADOR+",",false);
			numeroRes = new StringTokenizer(listaNumeroRes,ConstantesDatos.SEPARADOR+",",false);
			tipoRes = new StringTokenizer(listaTipoRes,ConstantesDatos.SEPARADOR+",",false);
