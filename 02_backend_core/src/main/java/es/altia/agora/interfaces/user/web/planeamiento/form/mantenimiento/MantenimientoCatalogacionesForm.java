...
public class MantenimientoCatalogacionesForm extends ActionForm {
    ...
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoCatalogacionesForm.class.getName());
    ...
    public MantenimientoCatalogacionesForm() {
        reset();
    }
