...
import org.apache.struts.action.ActionMapping;
    ...
    public final class FormulTramitacionExpedientesAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(FormulTramitacionExpedientesAction.class.getName());
      ...
      if ((session.getAttribute("usuario") != null)) {
        ...
        FormulTramitacionExpedientesForm formulTramExpForm = null;

        if (form == null) {
          m_Log.debug("Rellenamos el form de Tramitacion de Expedientes");
          form = new FormulTramitacionExpedientesForm();
        ...
        formulTramExpForm = (FormulTramitacionExpedientesForm)form;
      ...
      if (opcion.equals("inicio")){
        ...
        formulTramExpForm.setFormulTramitacionExpedientes(formulTramExpVO);
