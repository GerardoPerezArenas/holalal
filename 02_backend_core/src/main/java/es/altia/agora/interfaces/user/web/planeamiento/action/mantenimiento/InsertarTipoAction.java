...
public final class InsertarTipoAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(InsertarTipoAction.class.getName());

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("InsertarTipoAction.perform");
        String[] params = null;
        ...
        MantTipoManager.getInstance().create(tipoVO, params);

        Collection tipos = ((MantenimientoTiposForm) session.getAttribute("MantenimientoTiposForm")).getTipos();
        MantenimientoTipoForm tipoForm = new MantenimientoTipoForm();
        tipoForm.setTipoRegistro(tiposForm.getTipoRegistro());
        tipoForm.setCodigoSubseccion(tiposForm.getCodigoSubseccion());
        tipoForm.setSubseccion(tiposForm.getSubseccion());
        tipoForm.setCodigo(tiposForm.getCodigo());
