...
import org.apache.struts.action.ActionMapping;
    ...
    public final class MantDocumentoAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(MantDocumentoAction.class.getName());
      ...
      if (opcion.equals("cargar")){
        ...
        lista = MantDocumentoManager.getInstance().buscaTemas(params);
        temaForm.setCodigos(lista);
        m_Log.debug("**********     codigos : " + temaForm.toString());
        Vector util= new Vector();
        util = MantDocumentoManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
        Vector utilizadosCerrados = new Vector();
        utilizadosCerrados = MantDocumentoManager.getInstance().buscaTemasUtilizadosCerrados(fechaCerradoE,fechaCerradoS,params);
        ...
        Vector lista = new Vector();
        lista = MantDocumentoManager.getInstance().eliminarTema(temasVO,params);
        temaForm.setCodigos(lista);
        Vector util= new Vector();
        util = MantDocumentoManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
        ...
        if(m_Log.isInfoEnabled()) m_Log.info("el identificador es : " + temasVO.getIde());

        

        Vector lista = new Vector();

        lista = MantDocumentoManager.getInstance().recuperarTema(temasVO,params);
        ...
        // String activo=null;
         ...
         MantDocumentoManager.getInstance().modificarTemaActivo(idModificar,params);
        temasVO.setCodigo(codigo);
        temasVO.setTxtNomeDescripcion(descripcion);
        temasVO.setActivo(activo);
        Vector lista = new Vector();
        lista = MantDocumentoManager.getInstance().modificarTema(temasVO,params);
        temaForm.setCodigos(lista);
        Vector util= new Vector();
        util = MantDocumentoManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
       ...
       // String activo=null;
        ...
        //continuo con el alta
        temasVO.setCodigo(codigo);
        temasVO.setTxtNomeDescripcion(descripcion);
        temasVO.setActivo(activo);
        Vector lista = new Vector();
        lista = MantDocumentoManager.getInstance().altaTema(temasVO,params);
