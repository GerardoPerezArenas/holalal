...
public class ManejadorInformesExcel {
     protected static Logger m_Log = LogManager.getLogger(ManejadorInformesExcel.class.getName());
    ...
    public String generarInformeExcel(Vector columnasInforme, Vector datosInforme, ServletContext servletContext, String host, String context, UsuarioValueObject usuario, int formato, Vector listaTiposCamposInforme, InformeValueObject informeVO, InformeTableModel informeTableModel, String accion, String protocolo) throws Exception{
       ...
       Map parametros = new HashMap();
        ...
        plantillaJasper.append(servletContext.getRealPath(""))
