 ...
 * @author Tiffany
 */
public class PrepareRechazoDocumentoProcedimientoPortafirmasAction extends DefaultAction{
    ...
    private static final Logger _log =
            LogManager.getLogger(PrepareRechazoDocumentoPortafirmasAction.class.getName());
...
//    private String pDataSourceKey = null;
    ...
    protected ActionForward doPerform(ActionMapping mapping, ActionForm form, HttpServletRequest request, 
        ...
        _log.info(form.getClass().getCanonicalName());
        return result;
    }//doPerform
