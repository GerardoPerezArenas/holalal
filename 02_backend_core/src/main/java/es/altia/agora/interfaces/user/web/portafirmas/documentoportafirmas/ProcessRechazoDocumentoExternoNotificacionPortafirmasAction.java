...
public class ProcessRechazoDocumentoExternoNotificacionPortafirmasAction extends DefaultAction{
    ...
    private static final Logger _log =
            LogManager.getLogger(ProcessRechazoDocumentoPortafirmasAction.class.getName());
    ...
    protected ActionForward doPerform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, InternalErrorException, ModelException {
        ...
        documentoRechazado = AdjuntoNotificacionManager.getInstance().actualizarEstadoFirmaAdjuntoExternoNotificacion(numeroDocumento,usuarioVO.getIdUsuario(),"R", observaciones,usuarioVO.getParamsCon());
