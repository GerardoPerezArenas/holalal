 ...
 * <p>Descripción: Clase TiposViasAction</p>
...
public class TiposViasAction extends ActionSession  {
  protected static Logger m_Log =
          LogManager.getLogger(TiposViasAction.class.getName());
  ...
  public ActionForward performSession(ActionMapping mapping, ActionForm form, 
    ...
    TiposViasManager mantManager = TiposViasManager.getInstance(); 
    GeneralValueObject gVO = recogerParametros(request);
    if ("cargar".equalsIgnoreCase(opcion)){
      Vector lista = mantManager.getListaTiposVias(params);
      mantForm.setListaTipoVias(lista);
    }else if("eliminar".equalsIgnoreCase(opcion)){
      String identificador = request.getParameter("identificador");
      Vector lista = new Vector();
      lista = mantManager.eliminarTipoVia(identificador,params);
      ...
      Vector lista = mantManager.modificarTipoVia(gVO,params);
      mantForm.setListaTipoVias(lista);
      opcion = "vuelveCargar";
    }else if("alta".equals(opcion)){
      Vector lista = mantManager.altaTipoVia(gVO,params);
      mantForm.setListaTipoVias(lista);
      opcion = "vuelveCargar";
  ...
  private GeneralValueObject recogerParametros(HttpServletRequest request){
    ...
    gVO.setAtributo("descTipoVia",request.getParameter("descTipoVia"));
    gVO.setAtributo("abreviatura",request.getParameter("abreviatura"));
    gVO.setAtributo("codTipoViaAntiguo",request.getParameter("codTipoViaAntiguo"));
    return gVO;
  }
}