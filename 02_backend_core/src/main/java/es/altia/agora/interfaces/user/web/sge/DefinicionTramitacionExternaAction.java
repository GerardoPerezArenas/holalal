...
import org.apache.struts.action.ActionMapping;
    ...
    public final class DefinicionTramitacionExternaAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(DefinicionTramitacionExternaAction.class.getName());
      ...
      if ((session.getAttribute("usuario") != null)) {
        ...
        DefinicionTramitacionExternaForm defTramExtForm = null;

        if (form == null) {
          m_Log.debug("Rellenamos el form de Definición de Tramitación Externa");
          form = new DefinicionTramitacionExternaForm();
        ...
        defTramExtForm = (DefinicionTramitacionExternaForm)form;
      ...
      if (opcion.equals("inicio")){
        ...
        // Cargar listas.
        defTramExtVO.setListaDepartamentos(DefinicionProcedimientosManager.getInstance().getListaTiposDepartamentos(params));

        defTramExtForm.setDefinicionTramitacionExterna(defTramExtVO);
