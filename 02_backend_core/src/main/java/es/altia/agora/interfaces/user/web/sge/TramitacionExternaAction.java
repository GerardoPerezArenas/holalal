...
import org.apache.struts.action.ActionMapping;
    ...
    public final class TramitacionExternaAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(TramitacionExternaAction.class.getName());
      ...
      if ((session.getAttribute("usuario") != null)) {
        ...
        TramitacionExternaForm tramExtForm = null;

        if (form == null) {
          m_Log.debug("Rellenamos el form de Tramitacion Externa");
          form = new TramitacionExternaForm();
        ...
        tramExtForm = (TramitacionExternaForm)form;
      ...
      if (opcion.equals("inicio")){
        ...
        // Cargar listas.
        tramExtVO.setListaDepartamentos(DefinicionProcedimientosManager.getInstance().getListaTiposDepartamentos(params));

        tramExtForm.setTramitacionExterna(tramExtVO);
