...
public final class LogonUserAction extends Action {

    protected static Logger mlog =
            LogManager.getLogger(EntradaAction.class.getName());
       ...
       try {
        ...
        if("SI".equals(insensitivo)){
           ...
           //Tenemos que ir a BD a comprobar si existen dos logins que sean iguales en maiusculas y minusculas Y si sí lanzar error
            ...
            hayDos=UsuarioManager.getInstance().comprobarSiHayDos(login);
            ...
            if (hayDos){
                ...
                username=UsuarioManager.getInstance().dameElCorrecto(login);
            }
       } 
        ...
        if (usuarioEscritorioVO.getIdUsuario() != -1) {
            ...
            if(!passwordCaducidad.equals("no")){
                ...
                Calendar fechaAltaPasswordReciente =  UsuarioManager.getInstance().getFechaAltaPasswordReciente(usuarioEscritorioVO);
            ...
            if(UsuarioDAO.getInstance().esNecesarioRenovarPasswordUsuario(username)){
                ...
                return mapping.findForward("cambiaPass");                
                    ...
                    Cookie cookie= new Cookie("flexia", "autenticado");
