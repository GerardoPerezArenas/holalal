...
public final class SalirDepuracionViasAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(SalirDepuracionViasAction.class.getName());
    protected static Config m_ConfigTechnical = ConfigServiceHelper.getConfig("techserver");

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("SalirDepuracionViasAction.perform");
        HttpSession session = request.getSession();

        if (session.getAttribute("DepuracionVias.vias")!=null) {
            session.removeAttribute("DepuracionVias.vias");
        }
        if (session.getAttribute("DepuracionVias.viasRepetidas")!=null) {
