...
import es.altia.agora.interfaces.user.web.registro.notificacion.batch.NotificacionPendientesFinalizarManager;
...
public class NotificacionPendientesFinalizarRegistradorJob implements Job{
    
    private static Logger m_Log = LogManager.getLogger(NotificacionPendientesFinalizarRegistradorJob.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException{
         try{
             ...
             if(NotificacionJobLanbideUtils.getServer().equals(System.getProperty("weblogic.Name"))){
                m_Log.info("--------- se lanza el proceso NotificacionPendientesFinalizarRegistradorJob::Weblogic.Name: " + System.getProperty("weblogic.Name") + " -----");
                ...
                while(tokens.hasMoreTokens()){
                    ...
                    NotificacionPendientesFinalizarManager.getInstance().notificarPendientesFinalizarRegistrador(params);
                }
            }
        } catch (Exception e){
            e.printStackTrace();
          ...
          m_Log.debug("--------- finaliza el proceso NotificacionPendientesFinalizarRegistradorJob  -----");
    }
}
