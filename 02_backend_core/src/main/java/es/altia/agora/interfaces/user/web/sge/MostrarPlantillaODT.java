...
public class MostrarPlantillaODT extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (session == null) {
          m_log.error("SESION NULA EN VerDocumentoServlet.defaultAction");
          return;
      }
      m_log.debug("ID de la sesion : " + session.getId());
      try{
         ...
         byte[] fichero = null;
          if (gVO1 != null) {
              ...
              try {
                  ...
                  m_log.error("No se puede acceder a la ruta de descarga del documento");
              }
              ...
              m_log.error("NO SE HA PODIDO RECUPERAR EL CONTENIDO DEL DOCUMENTO");
