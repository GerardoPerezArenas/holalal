...
public class MantenimientoOrganoAprobacionForm extends ActionForm {

    //Necesitamos el servicio de log
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoOrganoAprobacionForm.class.getName());

    private String codigo;
    private String descripcion;

    public MantenimientoOrganoAprobacionForm() {
        reset();
    }
