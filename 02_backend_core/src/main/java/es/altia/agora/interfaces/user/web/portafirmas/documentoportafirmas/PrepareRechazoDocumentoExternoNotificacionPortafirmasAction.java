...
public class PrepareRechazoDocumentoExternoNotificacionPortafirmasAction extends DefaultAction{
    
     private static final String CLSNAME = "PrepareRechazoDocumentoExternoNotificacionPortafirmasAction";
    private static final String MAPPING_SUCCESS = "RechazoDocumentoPortafirmasForm";
    private static final Logger _log =
            LogManager.getLogger(PrepareRechazoDocumentoExternoNotificacionPortafirmasAction.class.getName());
