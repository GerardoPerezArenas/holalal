...
public class MantAnotacionRegistroForm extends ActionForm {
    ...
    protected static Logger m_Log
            = LogManager.getLogger(AperturaCierreRegistroForm.class.getName());
...
*/
    ...
    private void construirListaRelaciones() {
        ...
        if (!txtTiposRelaciones.equals("")) {
            String[] listaTipos = txtTiposRelaciones.split(ConstantesDatos.SEPARADOR);
            String[] listaEjercicios = txtEjerciciosRelaciones.split(ConstantesDatos.SEPARADOR);
            String[] listaNumeros = txtNumerosRelaciones.split(ConstantesDatos.SEPARADOR);
