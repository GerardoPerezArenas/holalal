      ...
      if (opcion.equals("inicioDesdeFichaExpediente")) {
       ...
       // String estadoEstilo = (String)session.getAttribute("estadoEstilo");
        ...
        opcion = "iniciarExpediente";
          ...
          // devolvemos los datos como String en formato json
          GeneralValueObject respuesta = new GeneralValueObject();
          String listaProcedimientosStr = "";

          for (int i = 0 ; i < listaProcedimientos.size(); i++) {
              if (i < listaProcedimientos.size() - 1) {
                  listaProcedimientosStr += listaProcedimientos.get(i) + ", ";
              }
              else {
                  listaProcedimientosStr += listaProcedimientos.get(i);
              }
          }
          respuesta.setAtributo("listaProcedimientos", listaProcedimientosStr);
          session.setAttribute("listaProcedimientos", listaProcedimientosStr);
