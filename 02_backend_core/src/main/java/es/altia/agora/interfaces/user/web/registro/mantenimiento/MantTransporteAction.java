...
import es.altia.agora.business.registro.mantenimiento.persistence.MantTransporteManager;
...
import org.apache.struts.action.ActionMapping;
    ...
    public final class MantTransporteAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(MantTransporteAction.class.getName());
      ...
      if (opcion.equals("cargar")){
        ...
        if (form == null) {
          m_Log.debug("Rellenamos el form de Mantenimiento De Tipos de Transporte");
        ...
        lista = MantTransporteManager.getInstance().buscaTemas(params);
        temaForm.setCodigos(lista);
        Vector util= new Vector();
        util = MantTransporteManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
        Vector utilizadosCerrados = new Vector();
        utilizadosCerrados = MantTransporteManager.getInstance().buscaTemasUtilizadosCerrados(fechaCerradoE,fechaCerradoS,params);
        ...
        Vector lista = new Vector();
        lista = MantTransporteManager.getInstance().eliminarTema(temasVO,params);
        temaForm.setCodigos(lista);
        Vector util= new Vector();
        util = MantTransporteManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
        ...
        MantTransporteManager.getInstance().modificarTemaActivo(idModificar,params);
        
        temasVO.setCodigo(codigo);
        temasVO.setTxtNomeDescripcion(descripcion);
        temasVO.setActivo(activo);
        Vector lista = new Vector();
        lista = MantTransporteManager.getInstance().modificarTema(temasVO,params);
        temaForm.setCodigos(lista);
        Vector util= new Vector();
        util = MantTransporteManager.getInstance().buscaTemasUtilizados(params);
        temaForm.setUtilizados(util);
        ...
        temasVO.setActivo(activo);
        Vector lista = new Vector();
        lista = MantTransporteManager.getInstance().altaTema(temasVO,params);
