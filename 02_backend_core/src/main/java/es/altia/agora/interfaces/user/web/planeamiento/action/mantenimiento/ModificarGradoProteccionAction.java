...
public final class ModificarGradoProteccionAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(ModificarGradoProteccionAction.class.getName());

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("ModificarGradoProteccionAction.perform");
        String[] params = null;
        ...
        MantGradoProteccionManager.getInstance().modify(gradoProteccionVO, params);
        ...
        while (gradosProteccionIt.hasNext()) {
            gradoProteccionForm = (MantenimientoGradoProteccionForm) gradosProteccionIt.next();
            if (gradoProteccionForm.getCodigo().equals(gradosProteccionForm.getCodigo())) {
