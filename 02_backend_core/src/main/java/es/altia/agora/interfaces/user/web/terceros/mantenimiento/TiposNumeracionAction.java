 ...
 * <p>Descripción: Clase TiposNumeracionAction</p>
...
public class TiposNumeracionAction extends ActionSession  {
  protected static Logger m_Log =
          LogManager.getLogger(TiposNumeracionAction.class.getName());
  ...
  public ActionForward performSession(ActionMapping mapping, ActionForm form, 
    ...
    TiposNumeracionManager mantManager = TiposNumeracionManager.getInstance(); 
    if ("cargar".equalsIgnoreCase(opcion)){
      Vector lista = mantManager.getListaTiposNumeraciones(params);
      mantForm.setListaNumeraciones(lista);
    }else if("eliminar".equalsIgnoreCase(opcion)){
      String identificador = request.getParameter("identificador");
      Vector lista = new Vector();
      lista = mantManager.eliminarTipoNumeracion(identificador,params);
      ...
      Vector lista = mantManager.modificarTipoNumeracion(gVO,params);
      mantForm.setListaNumeraciones(lista);
      opcion = "vuelveCargar";
      ...
      gVO.setAtributo("codigo",request.getParameter("txtCodigo"));
      gVO.setAtributo("descripcion",request.getParameter("txtDescripcion"));
      Vector lista = mantManager.altaTipoNumeracion(gVO,params);
      mantForm.setListaNumeraciones(lista);
      opcion = "vuelveCargar";
