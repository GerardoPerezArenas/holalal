...
public class PrepareFirmaDocumentoExternoNotificacionPortafirmas extends DefaultAction{
    
    /*_______Constants______________________________________________*/
    private static final String CLSNAME = "PrepareFirmaDocumentoExternoNotificacionPortafirmas";
    private static final String MAPPING_SUCCESS = "FirmaDocumentoPortafirmasForm";
    private static final Logger _log =
            LogManager.getLogger(PrepareFirmaDocumentoPortafirmasAction.class.getName());
