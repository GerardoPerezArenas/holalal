...
public class MantenimientoCatalogacionForm extends ActionForm {

    //Necesitamos el servicio de log
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoCatalogacionForm.class.getName());

    private String codigo;
    private String descripcion;

    public MantenimientoCatalogacionForm() {
        reset();
    }
