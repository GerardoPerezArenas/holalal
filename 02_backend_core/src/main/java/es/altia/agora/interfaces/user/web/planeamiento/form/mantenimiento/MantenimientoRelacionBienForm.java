...
public class MantenimientoRelacionBienForm extends ActionForm {

    //Necesitamos el servicio de log
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoRelacionBienForm.class.getName());

    private String codigo;
    private String descripcion;

    public MantenimientoRelacionBienForm() {
        reset();
    }
