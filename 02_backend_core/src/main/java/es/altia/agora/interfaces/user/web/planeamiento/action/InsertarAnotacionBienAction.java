...
public final class InsertarAnotacionBienAction extends ActionSession {

    protected static Logger m_Log =
            LogManager.getLogger(InsertarAnotacionBienAction.class.getName());

    public ActionForward performSession(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                                        HttpServletResponse response) throws IOException, ServletException {

        m_Log.info("InsertarAnotacionBienAction.perform");
        ...
        Collection anotaciones = bienForm.getAnotaciones();
