...
public class MantenimientoSubseccionForm extends ActionForm {

    //Necesitamos el servicio de log
    protected static Logger m_Log =
            LogManager.getLogger(MantenimientoSubseccionForm.class.getName());

    private String tipoRegistro;
    private String codigo;
    private String descripcion;

    public MantenimientoSubseccionForm() {
        reset();
    }
