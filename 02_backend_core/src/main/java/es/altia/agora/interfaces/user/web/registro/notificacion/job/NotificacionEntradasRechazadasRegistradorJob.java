 ...
 * notificaciones de entradas rechazadas
 */
public class NotificacionEntradasRechazadasRegistradorJob implements Job{
    
    private static Logger m_Log = LogManager.getLogger(NotificacionEntradasRechazadasRegistradorJob.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        try{
            ...
            if(NotificacionJobLanbideUtils.getServer().equals(System.getProperty("weblogic.Name"))){
                m_Log.info("-------- lanzo el proceso NotificacionEntradasRechazadasJob::Weblogic.Name: " + System.getProperty("weblogic.Name") + " ------");
                ...
                while(tokens.hasMoreTokens()){
                    ...
                    NotificacionEntradasRechazadasManager.getInstance().notificarRechazadasRegistrador(params);
                }
            }
        } catch (Exception e){
            e.printStackTrace();
