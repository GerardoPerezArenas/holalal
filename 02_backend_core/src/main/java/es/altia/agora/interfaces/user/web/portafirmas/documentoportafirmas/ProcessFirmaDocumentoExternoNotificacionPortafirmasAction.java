...
public class ProcessFirmaDocumentoExternoNotificacionPortafirmasAction extends DefaultAction {
    ...
    private static final Logger log = LogManager.getLogger(ProcessFirmaDocumentoPortafirmasAction.class.getName());
        ...
        if (!firma.getValido()) {
            ...
            if (concreteForm.getFirma() != null) {
                ...
                try {
                    ...
                    LogManager.getLogger(ProcessFirmaDocumentoProcedimientoPortafirmasAction.class.getName()).log(Level.SEVERE, null, ex);
                }*/
