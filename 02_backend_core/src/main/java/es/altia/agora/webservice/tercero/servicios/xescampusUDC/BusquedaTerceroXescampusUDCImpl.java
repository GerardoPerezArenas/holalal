package es.altia.agora.webservice.tercero.servicios.xescampusUDC;
...
import es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosDomicilioVO;
import es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosTerceroVO;
import es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.WSBusquedaTerceroPort;
import es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.WSBusquedaTerceroServiceLocator;
 ...
 * @author Tiffany
 */
public class BusquedaTerceroXescampusUDCImpl  implements FachadaBusquedaTercero {

     private String nombreServicio;
    private String prefijoPropiedad;
    private String[] paramsConexionBD;
    protected static Logger m_Log = LogManager.getLogger(BusquedaTerceroXescampusUDCImpl.class.getName());
        ...
        try {
            if (domicilioSW.getCodPais() != null && !"".equals(domicilioSW.getCodPais())) {
                ...
                if (!codPais.equals("108")) {
                    ...
                    GeneralValueObject infoProvincia = fachadaSGE.getProvinciaByPaisAndCodigo(Integer.parseInt(domicilioSGE.getIdPais()),
                    ...
                    int municipioRecibido = Integer.parseInt(domicilioSW.getCodMunicipio().substring(0, 3));

                    MunicipioVO infoMunicipio = fachadaSGE.getMunicipioByPaisAndProvAndCodigo(Integer.parseInt(domicilioSGE.getIdPais()),
                            Integer.parseInt(domicilioSGE.getIdProvincia()), municipioRecibido, paramsConexionBD);
