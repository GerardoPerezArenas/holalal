package es.altia.agora.webservice.tercero.servicios.uxxiec;
...
import es.altia.agora.webservice.tercero.servicios.uxxiec.cliente.WSBusquedaTerceroServiceLocator;
import es.altia.agora.webservice.tercero.servicios.uxxiec.cliente.WSBusquedaTerceroPort;
import es.altia.agora.webservice.tercero.servicios.uxxiec.cliente.DatosTerceroVO;
import es.altia.agora.webservice.tercero.servicios.uxxiec.cliente.DatosDomicilioVO;
...
public class BusquedaTerceroUxxiecImpl implements FachadaBusquedaTercero {

    private String nombreServicio;
    private String prefijoPropiedad;
    private String[] paramsConexionBD;
    protected static Logger m_Log = LogManager.getLogger(BusquedaTerceroUxxiecImpl.class.getName());
    ...
    private DomicilioSimpleValueObject transformarDomicilioSW(DatosDomicilioVO domicilioSW) {
        ...
        try {
            String descTipoViaUxxiec = domicilioSW.getVia().getDescTipoVia();
            datosTipoVia = fachadaSGE.getTipoViaByDescripcion(descTipoViaUxxiec, paramsConexionBD);
        } catch (Exception e) {
