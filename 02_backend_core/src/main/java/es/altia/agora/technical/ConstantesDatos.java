...
public interface ConstantesDatos { 
   ...
   public static final String SEPARADORSUBLISTAS ="¬¬";
  ...
  /***************/
   ...
   public static final String SUFIJO_TERCERO                                       = "TERCERO";
 ...
 //Constantes para la nueva funcionalidad de campos de Consulta de módulos externos
   ...
   public static final String ORIGEN_LLAMADA_BATCH_KONTU = "BK";
