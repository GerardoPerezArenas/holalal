...
public class InteresadosDAO  {
  ...
  protected static Logger m_Log =
          LogManager.getLogger(InteresadosDAO.class.getName());
   ...
   public boolean altaInteresado(GeneralValueObject gVO,Connection con){
       ...
       try{        
          ...
          String notifElectronica = (String) gVO.getAtributo("notifElectronica");
           ...
           String mostrar = (String) gVO.getAtributo("mostrarInt");
           if(mostrar == null){
              mostrar = "0";
          }

          sql = "INSERT INTO E_EXT("+
            ext_mun + ", " + ext_eje + ", " + ext_num + ", " + ext_ter + ", " + ext_nvr + ", " + ext_dot + ", " + ext_rol + ","
                  + ext_pro + "," +  ext_notificacion_electronica + ",MOSTRAR" +
            ") VALUES (" + codMunicipio + ", " + ejercicio + ", '" + numero + "', " + codigoTercero + ", " + versionTercero + ", " + 
            domicilio + ", " + rol + ",'" + codProcedimiento + "','" + notifElectronica + "', '" + mostrar + "')";
