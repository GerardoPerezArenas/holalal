...
public class FirmasDocumentoProcedimientoManager {
    ...
    private Logger log = LogManager.getLogger(CamposListadoPendientesProcedimientoManager.class);
    ...
    public ArrayList<FirmasDocumentoProcedimientoVO> getFirmasDocumento(String codDocumento, String municipio,
        ...
        try {
            ...
            ex.printStackTrace();
            LogManager.getLogger(FirmasDocumentoProcedimientoManager.class.getName()).error( ex);
        } finally {
