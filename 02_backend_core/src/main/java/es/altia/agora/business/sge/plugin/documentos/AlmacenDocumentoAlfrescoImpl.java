...
public class AlmacenDocumentoAlfrescoImpl implements AlmacenDocumento,Serializable{
    private Logger log = LogManager.getLogger(AlmacenDocumentoAlfrescoImpl.class);
   ...
   /**
    ...
    public boolean setFirmaDocumentoExpediente(Documento doc) throws AlmacenDocumentoTramitacionException {     
        ...
        try{                                    
            ...
            e.printStackTrace();
            log.error("Error al instanciar la clase fachada de comunicación con Alfresco: " + e.getMessage());
     ...
     public boolean setFirmaDocumentoExternoNotificacion(Documento doc) throws AlmacenDocumentoTramitacionException{  
        ...
        try{
            ...
            e.printStackTrace();
            throw new AlmacenDocumentoTramitacionException(1,"Error al almacenar la firma de un documento externo de una notificación en Alfresco: " + e.getMessage());                   
        }finally{
            try{
                if(exito){
                    adapt.finTransaccion(con);
    ...
    public Documento getDocumentoExternoNotificacion(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{
        ...
        try{
            ...
            throw new AlmacenDocumentoTramitacionException(2,"Error al recuperar un documento externo de una notificación electrónica de Alfresco: " + e.getMessage());
        }
    ...
    public boolean setDocumentoDatoSuplementarioTramite(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{
        ...
        try{            
            ...
            // En primer lugar se comprueba si en el campo suplementario ya había anteriormente un fichero.
            ...
            // Se graba el registro correspondiente en la tabla E_TFI con al información del documento pero 
            // sin el contenido, que se enviará al gestor documental pertinente
     ...
     public void setDocumentosRegistro(ArrayList<Documento> documentos,Connection con) throws AlmacenDocumentoTramitacionException{
         ...
         try{
             ...
             // Si ocurre un error, se lanza la excepción para realizar un rollback
             throw new AlmacenDocumentoTramitacionException(0,"Error al dar de alta la información de los documentos de registro en base de datos: " + e.getMessage());             
         }
     ...
     /**
      * Recupera un documento determinado asociado a una anotación de registro
    ...
    public boolean eliminarDocumentoDatosSuplementariosTramite(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{
     boolean exito = false;        
        ...
        try{            
            docGestor = (DocumentoGestor)doc;
            // Se elimina el registro asociado al documento del campo suplementario de trámite de la base de datos            
      ...
      * @param doc: Objeto de tipo DocumentoGestor que contiene la información necesaria del documento para poder eliminarlo
     ...
     public boolean eliminarDocumentoRegistro(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{
         ...
         try{
             ...
             log.error("Se ha producido un error al eliminar el documento " + doc.getNombreDocumento() + " asociado a la anotación de registro " + doc.getEjercicioAnotacion() + "-" + doc.getNumeroRegistro() + " de tipo " + doc.getTipoRegistro() + " : " + e.getMessage());
             throw new AlmacenDocumentoTramitacionException(4,"Se ha producido un error al eliminar el documento " + doc.getNombreDocumento() + " asociado a la anotación de registro " + doc.getEjercicioAnotacion() + "-" + doc.getNumeroRegistro() + " de tipo " + doc.getTipoRegistro() + " : " + e.getMessage());
         }         
    ...
    public boolean eliminarTodosDocumentosDatosSuplementariosTramite(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{
        ...
        try{                   
            // Se recuperan los datos de los campos suplementarios de tipo fichero del trámite y expediente para 
            ...
            throw new AlmacenDocumentoTramitacionException(5,"Error al eliminar todos los archivos almacenados en campos suplementarios de tipo fichero de un determinado trámite, debido a que no se han recuperado los códigos de los campos de BBDD: " + e.getMessage());
        }
         ...
         try{
            ...
            docGestor.setUsuarioGestor(cache.getUsuarioGestor());
             ...
             for(int i=0;campos!=null && i<campos.size();i++){
                ...
                // Se procede a invocar la operación de eliminarDocumento en Alfresco, para cada campo
                // recuperado
     ...
     * al finalizar un trámite de un determinado expediente. El binario se da de alta en Alfresco
    ...
    public boolean eliminarDocumentoExternoNotificacion(Documento doc) throws AlmacenDocumentoTramitacionException{
        ...
        try{
            ...
            e.printStackTrace();
            throw new AlmacenDocumentoTramitacionException(3,"Error al eliminar un documento externo asociado a una notificación almacenado en Alfresco: " + e.getMessage());
        }        
    ...
    /**
     * Permite recuperar la firma de un documento externo asociado a una notificación
    ...
    public String getFirmaDocumentoExternoNotificacion(Documento doc,Connection con) throws AlmacenDocumentoTramitacionException{         
         ...
         try{
            ...
            firma = new String(contenido);
             ...
             e.printStackTrace();
             throw new AlmacenDocumentoTramitacionException(2,"Error al recupera la firma de un documento externo asociado a una notificación: " + e.getMessage());             
         }
