...
public class MantProcedimientoDAO {

    //Para el fichero de configuracion tecnico.
    private static Config m_ConfigTechnical;
    //Para informacion de logs.
    private static Logger m_Log = LogManager.getLogger(MantProcedimientoDAO.class.getName());


    private static MantProcedimientoDAO instance = null;
    ...
    protected MantProcedimientoDAO() {
        //Queremos usar el fichero de configuracion techserver
        m_ConfigTechnical = ConfigServiceHelper.getConfig("techserver");
        //Queremos tener acceso a los mensajes de error localizados

        nombreTabla = m_ConfigTechnical.getString("SQL.U_PRO.Tabla");
        codigo = m_ConfigTechnical.getString("SQL.U_PRO.Codigo");
        descripcion = m_ConfigTechnical.getString("SQL.U_PRO.Descripcion");

    }

    public static MantProcedimientoDAO getInstance() {
        //si no hay ninguna instancia de esta clase tenemos que crear una.
        if (instance == null) {
            // Necesitamos sincronizacion para serializar (no multithread) las invocaciones de este metodo.
            synchronized(MantProcedimientoDAO.class){
                if (instance == null)
                    instance = new MantProcedimientoDAO();
            }
        }
        return instance;
    }
    ...
    public void create(MantProcedimientoValueObject mantProcedimientoVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantProcedimientoDAO.create");
...
//            ps.setString(i++, (new Integer(valor + 1)).toString());
            ps.setString(i++, mantProcedimientoVO.getCodigo());
            ps.setString(i++, mantProcedimientoVO.getDescripcion());
    ...
    public void delete(MantProcedimientoValueObject mantProcedimientoVO, String[] params)
        ...
        try{
            m_Log.info("MantProcedimientoDAO.delete");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
    ...
    public void modify(MantProcedimientoValueObject mantProcedimientoVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantProcedimientoDAO.modify");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
            //m_Log.info("A por la conexion");
            conexion = abd.getConnection();
    ...
    public Vector findAll(String[] params) throws TechnicalException {
        ...
        try{
            ...
            while(rs.next()){
                ...
                procedimientos.add(new MantProcedimientoValueObject(cod, desc));
            }
