...
public class MantAsuntosDAO {
  ...
  //Para informacion de logs.
    protected static Logger m_Log =
          LogManager.getLogger(MantRolesDAO.class.getName());
  //La instancia de esta clase
     ...
     * @param regVO: Contiene información necesaria para recuperar loa asuntos
     * @param recuperarTodosAsuntos: Si está a true inidica que se recuperan todos los asuntos de registro, incluso los que han sido
     * dados de baja. Si está a false, se recuperan sólo los que no han sido eliminados.
        ...
        try {       
          ...
          */
          ...
          if(!recuperarTodosAsuntos){
              // Sólo se recupera los asuntos que no han sido eliminados
    ...
    /**
     * Se recupera una colección con los asuntos codificados sobre los que el usuario tiene permiso sobre la unidad de registro
     ...
     * @return Colección de objetos MantAsuntosValueObject con la información del asunto
     */
   ...
   /**
     * Marca un asunto codificado de registro como de baja en lugar de eliminarlo físicamente de la base de datos
    ...
    /**
     * Comprueba si un determinado asunto codificado está dado de baja. Si está dado de baja devuelve la fecha
     * de baja del mismo en formato dd/MM/yyyy
     * @param codAsunto: Código del asunto
