...
public class VisorRegistroManager {
    ...
    protected static Logger log = LogManager.getLogger(GestorAccesoRegistro.class.getName());
    private final static String ID_SERVICIO_POR_DEFECTO = "SGE";
    private Logger m_Log = LogManager.getLogger(VisorRegistroManager.class);
