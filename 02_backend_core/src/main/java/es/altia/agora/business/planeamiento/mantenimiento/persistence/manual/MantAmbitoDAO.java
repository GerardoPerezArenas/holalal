...
public class MantAmbitoDAO {

    //Para el fichero de configuracion tecnico.
    private static Config m_ConfigTechnical;
    //Para informacion de logs.
    private static Logger m_Log = LogManager.getLogger(MantAmbitoDAO.class.getName());


    private static MantAmbitoDAO instance = null;
    ...
    protected MantAmbitoDAO() {
        //Queremos usar el fichero de configuracion techserver
        m_ConfigTechnical = ConfigServiceHelper.getConfig("techserver");
        //Queremos tener acceso a los mensajes de error localizados

        nombreTabla = m_ConfigTechnical.getString("SQL.U_AMB.Tabla");
        codigo = m_ConfigTechnical.getString("SQL.U_AMB.Codigo");
        descripcion = m_ConfigTechnical.getString("SQL.U_AMB.Descripcion");
    }

    public static MantAmbitoDAO getInstance() {
        //si no hay ninguna instancia de esta clase tenemos que crear una.
        if (instance == null) {
            // Necesitamos sincronizacion para serializar (no multithread) las invocaciones de este metodo.
            synchronized(MantAmbitoDAO.class){
                if (instance == null)
                    instance = new MantAmbitoDAO();
            }
        }
        return instance;
    }
    ...
    public void create(MantAmbitoValueObject mantAmbitoVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantAmbitoDAO.create");
...
//            ps.setString(i++, (new Integer(valor + 1)).toString());
            ps.setString(i++, mantAmbitoVO.getCodigo());
            ps.setString(i++, mantAmbitoVO.getDescripcion());
    ...
    public void delete(MantAmbitoValueObject mantAmbitoVO, String[] params)
        ...
        try{
            m_Log.info("MantAmbitoDAO.delete");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
    ...
    public void modify(MantAmbitoValueObject mantAmbitoVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantAmbitoDAO.modify");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
            //m_Log.info("A por la conexion");
            conexion = abd.getConnection();
    ...
    public Vector findAll(String[] params) throws TechnicalException {
        ...
        try{
            ...
            while(rs.next()){
                ...
                ambitos.add(new MantAmbitoValueObject(cod, desc));
            }
