...
public class RegistroValueObject implements Serializable, ValueObject {
    ...
    protected static Logger m_Log
            = LogManager.getLogger(RegistroValueObject.class.getName());
    ...
    //Alternativa: guardamos cada interesado como objeto
    List<InteresadoAnotacionVO> listaInteresados = new ArrayList<InteresadoAnotacionVO>();
...
* Enlace con expedientes */
    ...
    public List<InteresadoAnotacionVO> getListaInteresados() {
        return listaInteresados;
    }

    public void setListaInteresados(List<InteresadoAnotacionVO> listaInteresados) {
