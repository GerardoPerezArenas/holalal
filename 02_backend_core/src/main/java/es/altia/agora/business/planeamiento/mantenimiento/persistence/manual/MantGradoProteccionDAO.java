...
public class MantGradoProteccionDAO {

    //Para el fichero de configuracion tecnico.
    private static Config m_ConfigTechnical;
    //Para informacion de logs.
    private static Logger m_Log = LogManager.getLogger(MantGradoProteccionDAO.class.getName());


    private static MantGradoProteccionDAO instance = null;
    ...
    protected MantGradoProteccionDAO() {
        //Queremos usar el fichero de configuracion techserver
        m_ConfigTechnical = ConfigServiceHelper.getConfig("techserver");
        //Queremos tener acceso a los mensajes de error localizados

        nombreTabla = m_ConfigTechnical.getString("SQL.U_GRA.Tabla");
        codigo = m_ConfigTechnical.getString("SQL.U_GRA.Codigo");
        descripcion = m_ConfigTechnical.getString("SQL.U_GRA.Descripcion");
    }

    public static MantGradoProteccionDAO getInstance() {
        //si no hay ninguna instancia de esta clase tenemos que crear una.
        if (instance == null) {
            // Necesitamos sincronizacion para serializar (no multithread) las invocaciones de este metodo.
            synchronized(MantGradoProteccionDAO.class){
                if (instance == null)
                    instance = new MantGradoProteccionDAO();
            }
        }
        return instance;
    }
    ...
    public void create(MantGradoProteccionValueObject mantGradoProteccionVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantGradoProteccionDAO.create");
...
//            ps.setString(i++, (new Integer(valor + 1)).toString());
            ps.setString(i++, mantGradoProteccionVO.getCodigo());
            ps.setString(i++, mantGradoProteccionVO.getDescripcion());
    ...
    public void delete(MantGradoProteccionValueObject mantGradoProteccionVO, String[] params)
        ...
        try{
            m_Log.info("MantGradoProteccionDAO.delete");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
    ...
    public void modify(MantGradoProteccionValueObject mantGradoProteccionVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantGradoProteccionDAO.modify");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
            //m_Log.info("A por la conexion");
            conexion = abd.getConnection();
    ...
    public Vector findAll(String[] params) throws TechnicalException {
        ...
        try{
            ...
            while(rs.next()){
                ...
                grados.add(new MantGradoProteccionValueObject(cod, desc));
            }
