...
public class MantCatalogacionDAO {

    //Para el fichero de configuracion tecnico.
    private static Config m_ConfigTechnical;
    //Para informacion de logs.
    private static Logger m_Log = LogManager.getLogger(MantCatalogacionDAO.class.getName());


    private static MantCatalogacionDAO instance = null;
    ...
    protected MantCatalogacionDAO() {
        //Queremos usar el fichero de configuracion techserver
        m_ConfigTechnical = ConfigServiceHelper.getConfig("techserver");
        //Queremos tener acceso a los mensajes de error localizados

        nombreTabla = m_ConfigTechnical.getString("SQL.U_CAT.Tabla");
        codigo = m_ConfigTechnical.getString("SQL.U_CAT.Codigo");
        descripcion = m_ConfigTechnical.getString("SQL.U_CAT.Descripcion");
    }

    public static MantCatalogacionDAO getInstance() {
        //si no hay ninguna instancia de esta clase tenemos que crear una.
        if (instance == null) {
            // Necesitamos sincronizacion para serializar (no multithread) las invocaciones de este metodo.
            synchronized(MantCatalogacionDAO.class){
                if (instance == null)
                    instance = new MantCatalogacionDAO();
            }
        }
        return instance;
    }
    ...
    public void create(MantCatalogacionValueObject mantCatalogacionVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantCatalogacionDAO.create");
...
//            ps.setString(i++, (new Integer(valor + 1)).toString());
            ps.setString(i++, mantCatalogacionVO.getCodigo());
            ps.setString(i++, mantCatalogacionVO.getDescripcion());
    ...
    public void delete(MantCatalogacionValueObject mantCatalogacionVO, String[] params)
        ...
        try{
            m_Log.info("MantCatalogacionDAO.delete");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
    ...
    public void modify(MantCatalogacionValueObject mantCatalogacionVO, String[] params)
        ...
        try{
            ...
            m_Log.info("MantCatalogacionDAO.modify");
            //m_Log.info("A por el OAD");
            abd = new AdaptadorSQLBD(params);
            //m_Log.info("A por la conexion");
            conexion = abd.getConnection();
    ...
    public Vector findAll(String[] params) throws TechnicalException {
        ...
        Vector catalogaciones = new Vector();
        Connection con = null;
        Statement st = null;
        ResultSet rs = null;
        String sql = "";
        ...
        try{
            ...
            while(rs.next()){
                ...
                catalogaciones.add(new MantCatalogacionValueObject(cod, desc));
            }
