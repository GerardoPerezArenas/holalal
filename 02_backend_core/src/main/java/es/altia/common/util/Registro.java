...

{
    ...
    protected static Logger m_Log =
            LogManager.getLogger(Registro.class.getName());
...
// --------------- PUBLIC -----------------------   
...

	{
	  ...
	  //	  m_Log.error("Registro:setString FIELD||value null: " + FIELD + " " + value );

		

      if (FIELD==null)

	        m_Log.debug("Registro:setString FIELD||value null: " + FIELD + " " + value );
...

	{
	  ...
	  if ( FIELD==null )
		  ...
		  m_Log.debug("Registro:setInt FIELD:" + FIELD + " " + value );
...

	{
	  ...
	  if ( FIELD==null )
		  ...
		  m_Log.debug("Registro:setShort FIELD:" + FIELD + " " + value );
...

	{
	  ...
	  if ( FIELD==null )
		  ...
		  m_Log.debug("Registro:setDouble FIELD: " + FIELD + " " + value );
