...
public class WSClientModifyServiceImplMock implements WSClientModifyService {

    private static final Logger log = LogManager.getLogger(WSClientModifyServiceImplMock.class.getName());
    ...
    public CreateRequestResponse createRequest(CreateRequestParams params)
        ...
        CreateRequestResponse wsResponse = new CreateRequestResponse();
        wsResponse.setRequestId(RandomStringUtils.randomAlphanumeric(8));
    ...
    public DeleteRequestResponse deleteRequest(DeleteRequestParams params)
        ...
        // Llamada al servicio web
        log.debug("Realizando llamada al servicio web...");
        DeleteRequestResponse wsResponse = new DeleteRequestResponse();
        wsResponse.setRequestId(params.getIdRequest());
    ...
    public InsertDocumentResponse insertDocument(InsertDocumentParams params)
        ...
        // Llamada al servicio web
        log.debug("Realizando llamada al servicio web...");
        InsertDocumentResponse wsResponse = new InsertDocumentResponse();
        wsResponse.setDocumentId(RandomStringUtils.randomAlphanumeric(6));
    ...
    public InsertSignersResponse insertSigners(InsertSignersParams params)
        ...
        // Llamada al servicio web
        log.debug("Realizando llamada al servicio web...");
        InsertSignersResponse wsResponse = new InsertSignersResponse();
        wsResponse.setRequestId(params.getIdRequest());
    ...
    public SendRequestResponse sendRequest(SendRequestParams params)
        ...
        // Llamada al servicio web
        log.debug("Realizando llamada al servicio web...");
        SendRequestResponse wsResponse = new SendRequestResponse();
        wsResponse.setRequestId(params.getIdRequest());
