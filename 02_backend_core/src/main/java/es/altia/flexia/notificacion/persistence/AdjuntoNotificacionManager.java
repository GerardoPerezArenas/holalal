...
public class AdjuntoNotificacionManager {
    ...
    protected static Logger m_Log =
            LogManager.getLogger(NotificacionManager.class.getName());
...
/**
  ...
  public ArrayList<AdjuntoNotificacionVO> getListaAdjuntosExterno(int codNotificacion,String[] params) throws TechnicalException {
    ...
    */  
    ...
    public ArrayList<AdjuntoNotificacionVO> getDocumentosSupExpediente(String numExpediente, String[] params) {
        m_Log.debug("getDocumentosSupExpediente");
        ArrayList<AdjuntoNotificacionVO> res = new ArrayList<AdjuntoNotificacionVO>();
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try{
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            res = AdjuntoNotificacionDAO.getInstance().getDocumentosSupExpediente(numExpediente, con);
    ...
    public ArrayList<AdjuntoNotificacionVO> getDocumentosSupTramite(String numExpediente, String[] params) {
        m_Log.debug("getDocumentosSuplementariosTram");
        ArrayList<AdjuntoNotificacionVO> res = new ArrayList<AdjuntoNotificacionVO>();
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try{
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            res = AdjuntoNotificacionDAO.getInstance().getDocumentosSuplementariosTram(numExpediente, con);
    ...
    public ArrayList<AdjuntoNotificacionVO> getDocumentosExternos(String numExpediente, String[] params) {
        m_Log.debug("getDocumentosSuplementarios");
        ArrayList<AdjuntoNotificacionVO> res = new ArrayList<AdjuntoNotificacionVO>();
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try {
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            res = AdjuntoNotificacionDAO.getInstance().getDocumentosExternos(numExpediente, con);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    public AdjuntoNotificacionVO getDocumentoExpedienteOid(String numExpediente, String oid,  String[] params){
        AdjuntoNotificacionVO adjunto = null;
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try {
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            adjunto = AdjuntoNotificacionDAO.getInstance().getDocumentoExpedienteOid(numExpediente, oid, con);
        } catch(Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    public AdjuntoNotificacionVO getDocumentoTramiteOid(String numExpediente, String oid,  String[] params){
        AdjuntoNotificacionVO adjunto = null;
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try {
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            adjunto = AdjuntoNotificacionDAO.getInstance().getDocumentoTramiteOid(numExpediente, oid, con);
        } catch(Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    public AdjuntoNotificacionVO getDocumentoExternoOid(String numExpediente, String oid,  String[] params){
        AdjuntoNotificacionVO adjunto = null;
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        try {
            adapt = new AdaptadorSQLBD(params);
            con = adapt.getConnection();
            adjunto = AdjuntoNotificacionDAO.getInstance().getDocumentoExternoOid(numExpediente, oid, con);
        } catch(Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    public boolean insertarDocumentosSeleccionados(ArrayList<AdjuntoNotificacionVO> arrayIdDocSelecc, String[] params){
        m_Log.info("insertarDocumentosSeleccionados");
        Connection con = null;
        AdaptadorSQLBD adapt = null;
        boolean exito= false;
        try {
            ...
            for (AdjuntoNotificacionVO documento: arrayIdDocSelecc) {
                exito = AdjuntoNotificacionDAO.getInstance().insertarAdjuntoExternoDokusi(documento, con);
