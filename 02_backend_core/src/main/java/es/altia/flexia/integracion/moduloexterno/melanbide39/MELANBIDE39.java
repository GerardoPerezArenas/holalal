 ...
 */
//prueba
package es.altia.flexia.integracion.moduloexterno.melanbide39;
...
import es.altia.flexia.integracion.moduloexterno.melanbide39.i18n.MeLanbide39I18n;
import es.altia.flexia.integracion.moduloexterno.melanbide39.manager.MeLanbide39Manager;
...
import es.altia.flexia.integracion.moduloexterno.melanbide39.util.MeLanbide39Validator;
...
import es.altia.flexia.integracion.moduloexterno.melanbide59.MELANBIDE59;
 ...
 * @author santiagoc
 */
public class MELANBIDE39 extends ModuloIntegracionExterno 
{
    //Logger
    private static Logger log = LogManager.getLogger(MELANBIDE39.class);
        ...
        try{           
            if(numExpediente!=null && !"".equals(numExpediente)){
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                 ...
                 MeLanbide39Manager.getInstance().guardaHistorico(numExpediente, String.valueOf(codTramite), adapt);
            }
        }
        catch(Exception ex)
        {
    ...
    public String borrarHistorico (int codOrganizacion,int codTramite,int ocurrenciaTramite, String numExpediente)
   {
        ...
        try{           
            if(numExpediente!=null && !"".equals(numExpediente)){
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                 ...
                 MeLanbide39Manager.getInstance().borraHistorico(numExpediente, String.valueOf(codTramite), adapt);
            }
        }
        catch(Exception ex)
        {
    ...
    public String cargarPantallaDatosCpe(int codOrganizacion,  int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            int ano = MeLanbide39Utils.getEjercicioDeExpediente(numExpediente);
            MELANBIDE59 meLanbide59 = new MELANBIDE59();
            if(ano > 2015)
            {                
                return meLanbide59.cargarPantallaDatosCpe(codOrganizacion, codTramite, ocurrenciaTramite, numExpediente, request, response);
            }
            //Cargo los datos CPE
        ...
        {
            log.error("Error en cargarPantallaDatosCpe", ex);            
        }
        return "/jsp/extension/melanbide39/datosCpe.jsp";
    }
    ...
    public void guardarDatosCpe(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            if(validarDatosCpe(request))
            {
                ...
                try
                {
                    ejercicio = MeLanbide39Utils.getEjercicioDeExpediente(numExpediente);
                }
                catch(Exception ex)
                {
                ...
                if(ejercicio != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            int res = 0;
                            res = MeLanbide39Manager.getInstance().guardarDatosCpe(codOrganizacion, ejeStr, numExpediente, gestor, empresa, impPagadoNum, impPagadoNum2, otrasAyudasSolicNum, otrasAyudasConceNum, minimisSolicNum, minimisConceNum, importeConcedidoNum, importeRenunciaRes,impReiNum, adaptador);
                            if(res > 0)
                            {
                                codigoOperacion = "0";
                            }
                    ...
                    calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
                }
                else
                {
                    codigoOperacion = "3";
...
//        }//try-catch
    ...
    public String cargarNuevoPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide39/nuevoPuesto.jsp?codOrganizacionModulo="+codOrganizacion;
    }
    ...
    public String cargarModificarPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            ...
            if(opcion != null)
            {
                ...
                {
                    Integer ejercicio = MeLanbide39Utils.getEjercicioDeExpediente(numExpediente);
                    ...
                    puesto = MeLanbide39Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                    if(puesto != null)
                    {
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit1(), adapt);
                            if(desc != null)
                            {
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit2(), adapt);
                            if(desc != null)
                            {
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit3(), adapt);
                            if(desc != null)
                            {
    ...
    public void cargarSalarioAnexo1(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        if(codGrCot != null && !codGrCot.equals("") && codPaisStr != null && !codPaisStr.equals(""))
        {
            try
            {
                ...
                salario = MeLanbide39Manager.getInstance().getSalarioAnexo1PorPaisGrupoCot(codPais, codGrCot, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                if(codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    puesto.setNumExp(numExpediente);
                    puesto.setEjercicio(ejercicio);
                    puesto = MeLanbide39Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, adaptador);
                }
                else
                {
                    puesto = new CpePuestoVO();
                ...
                else
                {
                    ...
                    if(resultado != null && (resultado.equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_DENEGADO) || resultado.equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_RENUNCIA)))
                    {
                    ...
                    MeLanbide39Manager.getInstance().guardarCpePuestoVO(codOrganizacion, puesto, impAnterior, estadoAnterior, adaptador);
                }
                calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
                puestos = MeLanbide39Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adaptador);
            }
            else
            {
                codigoOperacion = "3";
    ...
    public void eliminarPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                {
                    MeLanbide39Manager.getInstance().eliminarCpePuestoVO(codOrganizacion, puesto, adaptador);
                }
                calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
                puestos = MeLanbide39Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adaptador);
            }
    ...
    public String cargarNuevaOferta(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide39/nuevaOferta.jsp?codOrganizacionModulo="+codOrganizacion;
    }
        ...
        try
        {
            ...
            if(opcion != null)
            {
                ...
                if(codOferta != null && !codOferta.equals(""))
                {
                    ...
                    oferta = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                    if(oferta != null)
                    {
                         //pruebas copiardatos
                       /* String copiardatos = (String)request.getParameter("copiardatos");
                        ...
                        origenpuesto = MeLanbide39Manager.getInstance().getPuestoPorCodigoYExpediente(origenpuesto, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                                              
                        if (copiardatos!=null)       
                                oferta = MeLanbide39Manager.getInstance().copiarDatosPuesto(codOrganizacion, origenpuesto, oferta, this.getAdaptSQLBD(String.valueOf(codOrganizacion))); 
                        //fin copiardatos
                        */
                        ...
                        if(oferta.getIdOfertaOrigen() != null)
                        {
                            ...
                            ofertaOrigen = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaOrigen, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit1(), adapt);                            
                            if(desc != null)
                            {
                                request.setAttribute("descTit1", desc);
                            }
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit2(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit2", desc);
                            }
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit3(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit3", desc);
                            }
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTitulacion(), adapt);
                            if(desc != null)
                            {
    ...
    public void getListaOfertasNoDenegadasPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                ofertas = MeLanbide39Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
    ...
    public void getListaJustificacionesNoDenegadasPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                justificaciones = MeLanbide39Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adapt);
                calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adapt);
            }
        }
        catch(Exception ex)
        ...
        try
        {
            String coste="";
            AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
            List<FilaResumenVO> filasResumen = MeLanbide39Manager.getInstance().getListaResumenPorExpediente(numExpediente, adapt);
        ...
        calculos.put(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS2, justificado);
    ...
    public void getListaResumenPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                filasResumen = MeLanbide39Manager.getInstance().getListaResumenPorExpediente(numExpediente, adapt);
                //calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adapt);
            }
        }
        catch(Exception ex)
    ...
    public String cargarNuevaJustificacion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide39/nuevaJustificacion.jsp?codOrganizacionModulo="+codOrganizacion;
    }
...
//            if(opcion != null)
//            {
//                String codJustif = (String)request.getParameter("idJustif");
//                String codPuesto = (String)request.getParameter("idPuesto");
//                cargarCombosNuevaOferta(codOrganizacion, request);
//
...
//                    justif.setIdJustificacion(Integer.parseInt(codJustif));
//                    justif.setCodPuesto(codPuesto);
//                    justif.setEjercicio(ejercicio);
//                    justif.setNumExpediente(numExpediente);
//                    justif = MeLanbide39Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justif, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
//                    if(justif != null)
//                    {
//                        request.setAttribute("justifModif", justif);
//                        CpePuestoVO puesto = null;
//                        if(justif.getCodPuesto() != null && !justif.getCodPuesto().equals(""))
//                        {
//                            puesto = new CpePuestoVO();
//                            puesto.setCodPuesto(justif.getCodPuesto());
//                            puesto.setEjercicio(ejercicio);
//                            puesto.setNumExp(numExpediente);
//                            puesto = MeLanbide39Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, adapt);
//                            if(puesto != null)
//                            {
//                                request.setAttribute("puestoConsulta", puesto);
//                            }
//                            if(justif.getIdOferta() != null)
//                            {
//                                CpeOfertaVO ofertaConsulta = new CpeOfertaVO();
//                                ofertaConsulta.setIdOferta(justif.getIdOferta());
//                                ofertaConsulta.setExpEje(ejercicio);
//                                ofertaConsulta.setCodPuesto(justif.getCodPuesto());
//                                ofertaConsulta.setNumExp(numExpediente);
//                                ofertaConsulta = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaConsulta, adapt);
...
//    }
            ...
            if(opcion != null)
            {
                ...
                if(codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    if(puesto != null)
                    {
                        ...
                        List<FilaPersonaContratadaVO> contrataciones = MeLanbide39Manager.getInstance().getListaContratacionesPuesto(puesto, adapt);
                        //int resultado = MeLanbide39Manager.getInstance().guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, "IMPJUS", calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS), adaptador);
                    ...
                    ofertaConsulta.setNumExp(numExpediente);
                    ofertaConsulta = MeLanbide39Manager.getInstance().getUltimaOfertaPorPuestoYExpediente(ofertaConsulta, adapt);
                    if(ofertaConsulta != null)
                    {
                        request.setAttribute("ofertaConsulta", ofertaConsulta);
                        ...
                        {
                             desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(ofertaConsulta.getCodTit1(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit1", desc);
                            }
                        ...
                        {
                             desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(ofertaConsulta.getCodTit2(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit2", desc);
                            }
                        ...
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(ofertaConsulta.getCodTit3(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit3", desc);
                            }
    ...
    public void generarInformeDatosPuestos(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                MeLanbide39Manager manager = MeLanbide39Manager.getInstance();
                SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide39.FORMATO_FECHA);
    ...
    private void crearEstiloInformeDatosPuestos(HSSFWorkbook libro, HSSFRow fila, HSSFCell celda, HSSFCellStyle estiloCelda, int idioma)
    {
        try
        {
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col1").toUpperCase());
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col2").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col3").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col4").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col5").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col6").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col7").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col8").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col9").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col10").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col11").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col12").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col13").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col14").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col15").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col16").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col17").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col18").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col19").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col20").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col21").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col22").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col23").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col24").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col25").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col26").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col27").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col28").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos.col29").toUpperCase());
            celda.setCellStyle(estiloCelda);
        }catch(Exception ex){
...
//            celda.setCellStyle(estiloCelda);
            ...
            //celda.setCellValue(filaI.getContratoBonif() != null ? filaI.getContratoBonif() : "");
            ...
            /*Double salarioSSBonifD=Double.parseDouble(filaI.getMaxSubvencion())-Double.parseDouble(filaI.getContratoBonif());
            String salarioSSBonif =Double.toString(salarioSSBonifD);
            celda.setCellValue(salarioSSBonif!= null ? salarioSSBonif : "");*/
            celda.setCellStyle(estiloCelda);
           ...
           // celda.setCellValue(filaI.getDietasJus()!= null ? filaI.getDietasJus() : "");
            ...
            celda.setCellStyle(estiloCelda);
            /*
            celda.setCellValue(filaI.getContratoBonif() != null ? filaI.getContratoBonif().toUpperCase() : "");
            if(filaI.getContratoBonif()!="-"){
                //celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
            }*/
    ...
    private void crearEstiloInformeDatosPuestosHoja2(HSSFWorkbook libro, HSSFRow fila, HSSFCell celda, HSSFCellStyle estiloCelda, int idioma)
    {
        try
        {
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(0);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col1").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(1);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col2").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(2);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col3").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(3);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col4").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(4);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col5").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(5);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col6").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(6);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col7").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(7);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col8").toUpperCase());
            celda.setCellStyle(estiloCelda);
        }catch(Exception ex){
        ...
        try
        {
            ...
            {*/
                ...
                try 
                {
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(0);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col1").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(1);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col2").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(2);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col31").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(3);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col3").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(4);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col4").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(5);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col5").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(6);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col6").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(7);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col7").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(8);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col8").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(9);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col9").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(10);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col10").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(11);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col11").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(12);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col12").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(13);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col13").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(14);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col14").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(15);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col15").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(16);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col16").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(17);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col29").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(18);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col30").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(19);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col17").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(20);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col18").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(21);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col19").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(22);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col20").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(23);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col21").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(24);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col22").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(25);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col23").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(26);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col24").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(27);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col25").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(28);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col26").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.col27").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    for(FilaInformeResumenPuestosContratadosVO filaI : listaPuestos)
                    {
                        if(filaI.getNumExpediente() != null && !filaI.getNumExpediente().equals(numExp))
                        {
                            if(numExp != null && !numExp.equals(""))
                            {
                               ...
                               // fila2 = hoja2.createRow(numFila2);
                                ...
                                anadirSumatoriosParcialesResumenPuestos(idioma, libro, fila, negrita, totalPuestosSolic, totalContRealizados, totalPuestosDenegados, totalPuestosRenAntesRes, totalPersCandidatas, totalPuestosRenAntesPag1);
                            ...
                            //se añaden los merged region
                            if (numFila >1){
                                //CAMBIARRRRRRRRR POR POI3.10
                                //unimos las tres últimas celdas creadas en la fila actual
                                //ejemplo:hoja.addMergedRegion(new CellRangeAddress(numFila-1, numFila-1, contCelda-numColumnasMerge, contCelda-1));
                      ...
                      //  fila2 = hoja2.createRow(numFila2);
                        ...
                        {
                            datosTercero = MeLanbide39Manager.getInstance().getDatosTercero(codOrganizacion, numExp, String.valueOf(ano), ConstantesMeLanbide39.CODIGO_ROL_ENTIDAD_SOLICITANTE, adapt);
                        ...
                        //COLUMNA: EDAD
                        Integer edad = MeLanbide39Utils.calcularEdadFormulaLanb(filaI.getFecNac() != null ? format.parse(filaI.getFecNac()) : null, filaI.getFecIni()!= null ? format.parse(filaI.getFecIni()) : null);
                        celda = fila.createCell(21);    
                        if(nuevo)
                        {
                            celda.setCellStyle(estiloCeldaNumericoFilaPrimera);
                    ...
                    log.debug("directorioTemp: " + directorioTemp);
    ...
    {   
        //Estilos celdas datos
            //celdas primera columna ultima fila-> 1 Estilos                        
        ...
        estiloCeldaColumnaPrimeraFilaUltima.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);                        
            ...
            //celdas segunda columna ultima fila-> 1 Estilos
        HSSFCellStyle estiloCeldaColumnasDosFilaUltima = libro.createCellStyle();
        estiloCeldaColumnasDosFilaUltima.setWrapText(true);
        estiloCeldaColumnasDosFilaUltima.setBorderLeft(HSSFCellStyle.BORDER_THIN);
        estiloCeldaColumnasDosFilaUltima.setBorderBottom(HSSFCellStyle.BORDER_THICK);
        estiloCeldaColumnasDosFilaUltima.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);

            //celdas siguientes Texto ultima fila-> 1 Estilos                
        ...
        estiloCeldaTextoFilaUltima.setFont(fuente);
        estiloCeldaTextoFilaUltima.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);

         //celdas siguientes Numericos ultima fila-> 1 Estilos
        ...
        estiloCeldaNumericoFilaUltima.setFont(fuente);
        ...
        //celdas ultima columna ultima fila-> 1 Estilos                        
        ...
        estiloCeldaColumnaUltimaFilaUltima.setFont(fuente);
        ...
        //COLUMNA: EMPRESA
        celda = fila.createCell(1);
        celda.setCellStyle(estiloCeldaColumnasDosFilaUltima);

        //COLUMNA: TERRITORIO HISTORICO
        celda = fila.createCell(2);
        celda.setCellType(HSSFCell.CELL_TYPE_STRING);
        celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informePuestosContratados.total").toUpperCase());
    ...
    {
        log.error("ENTRA EN generarInformeResumenEconomico");
        String rutaArchivoSalida = null;
        int i = 0;
        try
        {
            ...
            if(ano > 2015)
                ...
                try 
                {
                    ...
                    //File informe = File.createTempFile("resumenEconomico_"+fechaAct, ".xls", directorioTemp);
                     File informe= new File("resumenEconomico_"+fechaAct+".xls");

                    //boolean correcto = informe.renameTo(informe2);
                    FileOutputStream archivoSalida = new FileOutputStream(informe);
                   ...
                   // HSSFCell celda2 = null;
                    ...
                    hoja.setColumnWidth(10, 5000);//nivel formativo
                    ...
                    hoja2.setColumnWidth(10, 5000);//nivel formativo
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(0);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col1").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(1);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col2").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(2);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col30").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(3);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col3").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(4);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col4").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(5);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col5").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(6);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col6").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(7);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col7").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(8);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col8").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(9);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col9").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(10);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col10").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(11);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col11").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(12);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col12").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(13);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col13").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(14);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col14").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(15);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col15").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(16);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col16").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(17);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col17").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(18);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col18").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(19);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col19").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(20);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col20").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(21);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col21").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(22);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col22").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(23);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col23").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(24);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col24").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(25);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col25").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(26);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col26").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(27);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col27").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(28);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col28").toUpperCase());
                    celda.setCellStyle(estiloCelda);
                    ...
                    estiloCelda.setFont(negritaTitulo);
                    celda = fila.createCell(29);
                    celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.col29").toUpperCase());
                    celda.setCellStyle(estiloCelda);

                    crearEstiloHoja2Economico(libro, fila2, estilocelda2, idioma);
                    ...
                    log.error("tamaño lista:"+listaPuestos.size());
                    ...
                    for(FilaInformeResumenEconomicoVO filaI : listaPuestos)
                    {
                        i++;
                        if(filaI.getNumExpediente() != null && !filaI.getNumExpediente().equals(numExp))
                        {log.error("numexp tratar:"+filaI.getNumExpediente());
                            if(p != 0)
                            {
                                //cambiar a poi 3.10
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        if(!valor.equals(""))
                            valor = valor.replaceAll("TOTAL", meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.total").toUpperCase());
                        if(valor.equals(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.total").toUpperCase()) || nuevo)
                        {
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getCostesContSalarioSS() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getCostesContSalarioSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getCostesContDietasConve() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getCostesContDietasConve(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        celda.setCellValue(filaI.getCostesCont() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getCostesCont(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getSolSalarioSS() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolSalarioSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getSolDietasConvSS() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolDietasConvSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        dietasMan=filaI.getSolDietasConvSS() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolDietasConvSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue();
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getSolGastosTra() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolGastosTra(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        gastosTra=filaI.getSolGastosTra() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolGastosTra(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue();
                        ...
                        //celda.setCellValue(filaI.getSolicitado() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolicitado(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        //celda.setCellValue(filaI.getSolicitado() != null ? solicitadoTotal : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getDotacionAnualMaxima() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getDotacionAnualMaxima(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getDietasSubv() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getDietasSubv(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        if (filaI.getOrden()!=2) {
                            celda.setCellValue(filaI.getGastosTram() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getGastosTram(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                            celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        }
                        ...
                        if(nuevo) {
                            totalMinimis = filaI.getMinimisConcedidos() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getMinimisConcedidos(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue();
                        ...
                        celda.setCellValue(filaI.getImpMaxSubvencionable() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getImpMaxSubvencionable(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        ...
                        celda.setCellValue(filaI.getImporteConcedido() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getImporteConcedido(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        ...
                        celda.setCellValue(filaI.getImporteRenuncia() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getImporteRenuncia(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                        ...
                        {
                            valor = valor.replaceAll("-OBSERVACIONES:", " - "+meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico.observaciones").toUpperCase()+":");
                        }
                        celda.setCellValue(valor);
                        ...
                        celda.setCellValue(filaI.getImpConcedidoTrasResol() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getImpConcedidoTrasResol(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    if(p != 0)
                    {
                        ...
                        **/
                        ...
                        log.debug("paso2");
                        //hoja.getRow(numFila-p).getCell(0).setCellStyle(estilocelda2);
                        ...
                        //hoja.getRow(numFila-p).getCell(1).setCellStyle(estilocelda2);
                        log.debug("paso3");*/
        ...
        log.error("SALE DE generarInformeResumenEconomico");
    }
    ...
    private String cargarSubpestanaSolicitud_DatosCpe(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaPuestoVO> puestos = MeLanbide39Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide39/solicitud.jsp";
    }
    ...
    private String cargarSubpestanaOferta_DatosCpe(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaOfertaVO> ofertas = MeLanbide39Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide39/oferta.jsp";
    }
    ...
    private String cargarSubpestanaJustificacion_DatosCpe(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaJustificacionVO> justificaciones = MeLanbide39Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide39/justificacion.jsp";
    }
    ...
    private String cargarSubpestanaResumen_DatosCpe(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        ...
        return "/jsp/extension/melanbide39/resumen.jsp";
    }
    ...
    private String cargarSubpestanaSolicitudHist_DatosCpe(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaPuestoVO> puestos = MeLanbide39Manager.getInstance().getListaPuestosHistPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("puestos", puestos);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide39/solicitudHist.jsp";
    }
    ...
    private String cargarSubpestanaOfertaHist_DatosCpe(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaOfertaVO> ofertas = MeLanbide39Manager.getInstance().getListaOfertasHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("ofertas", ofertas);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide39/ofertaHist.jsp";
    }
    ...
    private String cargarSubpestanaJustificacionHist_DatosCpe(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaJustificacionVO> justificaciones = MeLanbide39Manager.getInstance().getListaJustificacionesHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("justificaciones", justificaciones);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide39/justificacionHist.jsp";
    }
    ...
    private void cargarDatosCpe(int codOrganizacion, String numExpediente, HttpServletRequest request)
    {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
            ...
            listaGestores = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        if(ejercicio != null)
        {
            ...
            try
            {
                String gestor = MeLanbide39Manager.getInstance().getValorCampoDesplegable(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide39.FICHERO_PROPIEDADES), adaptador);
            ...
            try
            {
                String empresa = MeLanbide39Manager.getInstance().getValorCampoTexto(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide39.FICHERO_PROPIEDADES), adaptador);
                ...
                else
                {
                    ...
                    HashMap<String, String> datosTercero = MeLanbide39Manager.getInstance().getDatosTercero(codOrganizacion, numExpediente, String.valueOf(ejercicio), ConstantesMeLanbide39.CODIGO_ROL_ENTIDAD_SOLICITANTE, adaptador);
            ...
            if(calculos != null)
            {
                ...
                try
                {
                    impSolicitado = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO);
                    ...
                    {
                        request.setAttribute("solicitado", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impConv = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA);
                    if(impConv != null)
                    {
                    ...
                    {
                        request.setAttribute("convocatoria", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPrevCon = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON);
                    if(impPrevCon != null)
                    {
                    ...
                    {
                        request.setAttribute("previsto", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    concedido = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON);
                    if(concedido != null)
                    {
                    ...
                    {
                        request.setAttribute("concedido", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                {
                    String coste="";
                    List<FilaResumenVO> filasResumen = MeLanbide39Manager.getInstance().getListaResumenPorExpediente(numExpediente, adaptador);
                    for(FilaResumenVO fila : filasResumen)
                    {
                        coste = fila.getCosteSubvecionable();
                        coste = coste.replace(",", ".");
                    ...
                    //justificado = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS);
                    if(justificado != null)
                    {
                    ...
                    {
                        request.setAttribute("justificado", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    noJustificado = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_NO_JUS);
                    ...
                    {
                        request.setAttribute("noJustificado", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    renunciado = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN);
                    if(renunciado != null)
                    {
                    ...
                    {
                        request.setAttribute("renunciado", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    renunciadoRes = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES);
                    ...
                    {
                        request.setAttribute("renunciadoRes", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPag = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG);
                    if(impPag != null)
                    {
                    ...
                    {
                        request.setAttribute("pagado", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPagRes = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_RES);
                    if(impPagRes != null)
                    {
                    ...
                    {
                        request.setAttribute("pagadoRes", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPag2 = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2);
                    if(impPag2 != null)
                    {
                    ...
                    {
                        request.setAttribute("pagado2", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    reint = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI);
                    if(reint != null)
                    {
                    ...
                    {
                        request.setAttribute("reintegrar", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    oayuS = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                    if(oayuS != null)
                    {
                    ...
                    {
                        request.setAttribute("otrasAyudasSolic", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    oayuC = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                    if(oayuC != null)
                    {
                    ...
                    {
                        request.setAttribute("otrasAyudasConce", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    minS = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC);
                    if(minS != null)
                    {
                    ...
                    {
                        request.setAttribute("minimisSolic", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    minC = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE);
                    if(minC != null)
                    {
                    ...
                    {
                        request.setAttribute("minimisConce", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impDesp = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_DESP);
                    if(impDesp != null)
                    {
                    ...
                    {
                        request.setAttribute("importeDespido", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impBaj = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA);
                    if(impBaj != null)
                    {
                    ...
                    {
                        request.setAttribute("importeBajas", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("concedidoReal", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("pagadoReal", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("pagadoReal2", new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
        ...
        try
        {
            ...
            Long codTramRes = MeLanbide39Manager.getInstance().obtenerCodigoInternoTramite(codOrganizacion, ConstantesMeLanbide39.CODIGO_TRAMITE_RESOLUCION, adapt);
            if(codTramRes != null)
            {
                if(MeLanbide39Manager.getInstance().tieneTramiteFinalizado(codOrganizacion, ejercicio, numExpediente, codTramRes, this.getAdaptSQLBD(String.valueOf(codOrganizacion))))
                {
            ...
            {
                //Miro a ver si tiene iniciado el tramite de "Resolucion de concesion o denegacion"
                Long codTramResModif = MeLanbide39Manager.getInstance().obtenerCodigoInternoTramite(codOrganizacion, ConstantesMeLanbide39.CODIGO_TRAMITE_RESOLUCION_MODIF, adapt);
                if(codTramResModif != null)
                {
                    if(MeLanbide39Manager.getInstance().tieneTramiteFinalizado(codOrganizacion, ejercicio, numExpediente, codTramResModif, this.getAdaptSQLBD(String.valueOf(codOrganizacion))))
                    {
    ...
    {
        log.debug("guardarOferta - inicio");      
        String codigoOperacion = "0";
...
//                String obs = (String)request.getParameter("observaciones");
                ...
                if(codOferta != null && !codOferta.equals("") && codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    oferta.setExpEje(ejercicio);
                    oferta.setCodPuesto(codPuesto);
                    oferta = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, adaptador);
                }
                else
                {
                    oferta = new CpeOfertaVO();
                ...
                else
                {
                    ...
                    if(difu != null && difu.equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                    {
                    ...
                    if(contratacion != null && contratacion.equalsIgnoreCase(ConstantesMeLanbide39.FALSO))
                    {
                    ...
                    if(contratacionPresOferta != null && contratacionPresOferta.equalsIgnoreCase(ConstantesMeLanbide39.FALSO))
                    {
                    ...
                    if(prec != null && prec.equalsIgnoreCase(ConstantesMeLanbide39.CIERTO))
                    {
                    ...
                    MeLanbide39Manager.getInstance().guardarCpeOfertaVO(codOrganizacion, oferta, alta, copiar, adaptador);
                    ...
                    if ( oferta.getNif()!=null && !oferta.getNif().isEmpty() && oferta.getFecIni()!=null && oferta.getFecFin()!=null){
                        ...
                        justifModif = MeLanbide39Manager.getInstance().getJustificacionPorCodigoPuestoOfertaYExpediente(justifModif, adaptador);                    
                        int dias=0;
                        //String rdo = MeLanbide39Manager.getInstance().obtenerDiasTrabajados(numExpediente, oferta.getNif(), adaptador); 
                         String rdo = MeLanbide39Manager.getInstance().obtenerDiasTrabajados(numExpediente, oferta.getCodPuesto(),oferta.getIdOferta(), adaptador);
                        ...
                        log.debug("dias justificicación calculados: "+dias);      
                        //guardar dias justificacion
                        MeLanbide39Manager.getInstance().guardarCpeJustificacionVO(codOrganizacion,justifModif, adaptador) ;
                        log.debug("guarda días justificación");      
                    }
                }
            }
            else
        ...
        log.debug("guardarOferta - fin");      
        return "/jsp/extension/melanbide39/recargarListaOfertas.jsp?numExp="+numExpediente;
    }
    ...
    public void descargarDocumentoOferta(int codOrganizacion,  int codTramite, int ocurrenciaTramite,String numExpediente,HttpServletRequest request,HttpServletResponse response)
    {
        try
        {
            ...
            if(idOferta != null && !idOferta.equals(""))
            {
                ...
                oferta.setCodPuesto(codPuesto);
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                oferta = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, adapt);
                if(oferta != null)
                {
    ...
    public void eliminarOferta(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                {
                    MeLanbide39Manager.getInstance().eliminarCpeOfertaVO(codOrganizacion, oferta, adaptador);
                }
                ofertas = MeLanbide39Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adaptador);
                calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
            }
            else
            {
    ...
    public void altaSustituto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(codigoOperacion.equals("0"))
            {
                ...
                ofertaOrigen = MeLanbide39Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaOrigen, adapt);
                if(ofertaOrigen != null)
                {
                    ...
                    MeLanbide39Manager.getInstance().guardarCpeOfertaVO(codOrganizacion, ofertaNueva, "1", copiar, adapt);
                    ofertas = MeLanbide39Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
                    calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adapt);
                }
                else
...
//    public void guardarJustificacion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
//    {
//        String codigoOperacion = "0";
//        List<FilaJustificacionVO> justificaciones = new ArrayList<FilaJustificacionVO>();
//        Map<String, BigDecimal> calculos = new HashMap<String, BigDecimal>();
...
//                    justif.setNumExpediente(numExpediente);
//                    justif.setEjercicio(ejercicio);
//                    justif = MeLanbide39Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justif, adaptador);
//                }
//                else
//                {
//                    justif = new CpeJustificacionVO();
...
//                    try
//                    {
//                        bd = new BigDecimal(impJustificado);
//                    }
//                    catch(Exception ex)
//                    {
//                        
...
//                    MeLanbide39Manager.getInstance().guardarCpeJustificacionVO(codOrganizacion, justif, adaptador);
//                }
//                calculos = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
//                
//                CpePuestoVO puesto = new CpePuestoVO();
...
//                if(puesto != null)
//                {
//                    justificaciones = MeLanbide39Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adaptador);
//                }
//            }
//            else
//            {
...
//    }
            ...
            if(ejercicio != null)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        MeLanbide39Manager.getInstance().actualizaImporteJusti(codOrganizacion, numExpediente, pepe[0], justificado, adaptador);
                ...
                if(puesto != null)
                {
                    personasContratadas = MeLanbide39Manager.getInstance().getListaContratacionesPuesto(puesto, adaptador);
                }
            }
            else
            {
    ...
    private boolean validarDatosCpe(HttpServletRequest request)
    {
        try
        {
            ...
            if(!MeLanbide39Validator.validarTexto(empresa, 500))
            {
                return false;
            }
            if(!MeLanbide39Validator.validarNumericoDecimal(impSubvAprobadaExp, 10, 2))
            {
                return false;
            }
            if(!MeLanbide39Validator.validarNumericoDecimal(impSubvAprobadaConv, 10, 2))
            {
                return false;
            }
            if(!MeLanbide39Validator.validarNumericoDecimal(otrasAyudas, 10, 2))
            {
                return false;
            }
            if(!MeLanbide39Validator.validarNumericoDecimal(impSubvFinal, 10, 2))
            {
                return false;
            }
            return true;
    ...
    private void cargarCombosNuevoPuesto(int codOrganizacion, HttpServletRequest request)
    {
        ...
        try
        {
            listaPaises = MeLanbide39Manager.getInstance().getListaPaises(this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IDIOMA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaIdiomas = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_NIVEL_IDIOMA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaNivelIdiomas = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_NIVEL_FORMATIVO, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaNivelFormativo = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GRUPO_COTIZACION, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaGrupoCotizacion = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list, SelectItem.ORDENAR_POR_CODIGO);
        }
        catch(Exception ex)
        {
        ...
        try 
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RESULTADO, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaResultado = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_MOTIVO, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaMotivos = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
    ...
    private void cargarCombosNuevaOferta(int codOrganizacion, HttpServletRequest request)
    {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_OFICINAS_LANBIDE, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaOficinasLanbide = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            ...
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaGrupoCot = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list, SelectItem.ORDENAR_POR_CODIGO);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_CAUSA_BAJA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaBaja = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            listaTipoDoc = MeLanbide39Manager.getInstance().getTiposDocumento(this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_CAUSA_RENUNCIA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaRenuncia = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegablePresOferta = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_CAUSA_RENUNCIA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegablePresOferta);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaRenunciaPresOferta = MeLanbide39MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
    ...
    private void cargarImportesJustificacion(String numExpediente, int codOrganizacion, CpePuestoVO puesto, HttpServletRequest request)
    {
            ...
            try
            {
                ...
                /*concedido = MeLanbide39Manager.getInstance().getValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, codigoCampo, adapt);
                if(concedido != null)
                {
                    request.setAttribute("concedido", concedido.toPlainString());
                }
                ...
                if(puesto != null)
                {
                    if(puesto.getCodResult() != null && puesto.getCodResult().equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_CONCEDIDO))
                    {
                        concedido = puesto.getImpMaxSuv() != null ? puesto.getImpMaxSuv().add(new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES)) : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
                    }
                }
                if(concedido == null)
                {
            ...
            try
            {
                codigoCampo = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
                renunciado = MeLanbide39Manager.getInstance().getValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, codigoCampo, adapt);
                if(renunciado != null)
                {
                    request.setAttribute("renunciado", renunciado.toPlainString());
                }
    ...
    private void escribirListaPuestosRequest(String codigoOperacion, List<FilaPuestoVO> puestos, Map<String, BigDecimal> calculos, HttpServletResponse response)
    {
        ...
        if(calculos != null && !calculos.isEmpty())
        {
            ...
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_SOL>");
            
            xmlSalida.append("<IMP_CONV>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_CONV>");
            
            xmlSalida.append("<IMP_PREV_CON>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PREV_CON>");
            
            xmlSalida.append("<IMP_CON>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_CON>");
            
            xmlSalida.append("<IMP_JUS>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_JUS>");
            
            xmlSalida.append("<IMP_REN>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_REN>");
            
            xmlSalida.append("<IMP_PAG>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG>");
            
            xmlSalida.append("<IMP_PAG_2>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG_2>");
            
            xmlSalida.append("<IMP_REI>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_REI>");
            
            xmlSalida.append("<OTRAS_AYUDAS_SOLIC>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</OTRAS_AYUDAS_SOLIC>");
            
            xmlSalida.append("<OTRAS_AYUDAS_CONCE>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</OTRAS_AYUDAS_CONCE>");
            
            xmlSalida.append("<MINIMIS_SOLIC>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</MINIMIS_SOLIC>");
            
            xmlSalida.append("<MINIMIS_CONCE>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</MINIMIS_CONCE>");
            ...
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_DESP);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_DESP>");
            
            xmlSalida.append("<IMP_BAJA>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_BAJA>");
            ...
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_NO_JUS))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_NO_JUS);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_NO_JUS>");
            
            xmlSalida.append("<IMP_REN_RES>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_REN_RES>");
            
            xmlSalida.append("<IMP_PAG_RES>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_RES))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_RES);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG_RES>");
            
            xmlSalida.append("<IMP_JUS2>");
            if(calculos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS2))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS2);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_JUS2>");
     ...
     public void calcularMeses(int codOrganizacion, int codTramite, int ocurrenciaTramite,   String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            meses = MeLanbide39Manager.getInstance().getNumMeses(fini, ffin, adaptador);
        }catch(Exception e){
                e.printStackTrace();
        }
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                CpePuestoVO puesto = new CpePuestoVO();
                    ...
                    oferta = MeLanbide39Manager.getInstance().copiarDatosPuesto(codOrganizacion, puesto, oferta, adaptador);
                    StringBuffer xmlSalida = new StringBuffer();
                    xmlSalida.append("<RESPUESTA>");
                        ...
                        xmlSalida.append("<DESCTITU1>");                            
                             desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit1(), adaptador);
                             xmlSalida.append(oferta.getCodTit1()!=null?desc:"");
                        xmlSalida.append("</DESCTITU1>");
                        xmlSalida.append("<DESCTITU2>");
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit2(), adaptador);
                            xmlSalida.append(oferta.getCodTit2()!=null?desc:"");
                        xmlSalida.append("</DESCTITU2>");
                        xmlSalida.append("<DESCTITU3>");
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit3(), adaptador);
    ...
    public String cargarDatosPersonaContratada(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
            ...
            if(opcion != null)
            {
                ...
                if(idOferta != null && !idOferta.equals("") && idPuesto != null && !idPuesto.equals(""))
                {
                    ...
                    if(oferta != null)
                    {
                        ...
                        if(oferta.getCodTitulacion() != null && !oferta.getCodTitulacion().equals(""))
                        {
                            desc = MeLanbide39Manager.getInstance().getDescripcionTitulacion(oferta.getCodTitulacion(), adaptador);
                            if(desc != null)
                            {
                                request.setAttribute("descTitContratado", desc);
                            }
                    ...
                    justifModif.setNumExpediente(numExpediente);
                    justifModif = MeLanbide39Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justifModif, adaptador);
                    
                    int dias=0;
                    //Leire, cálculo de días#241414
                    //String rdo = MeLanbide39Manager.getInstance().obtenerDiasTrabajados(numExpediente, oferta.getNif(), adaptador);
                     String rdo = MeLanbide39Manager.getInstance().obtenerDiasTrabajados(numExpediente, idPuesto, Integer.parseInt(idOferta), adaptador);
                    if(rdo != null && !rdo.equals(""))
                        dias = Integer.parseInt(rdo);
                    else
                        dias = 0;
        ...
        return "/jsp/extension/melanbide39/datosPersonaContratada.jsp";
    }
    ...
    public void buscarTitulaciones(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
            listaTitulaciones = MeLanbide39Manager.getInstance().buscarTitulaciones(codigo, desc, adapt);
        }
        catch(Exception ex)
        {
            codigoOperacion = "2";
    ...
    public void getTodosCamposSuplementarios(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            importes = MeLanbide39Manager.getInstance().cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, adaptador);
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        ...
        try
        {
            puestos = MeLanbide39Manager.getInstance().cargarCalculosPuestos(codOrganizacion, ejercicio, numExpediente, adaptador);
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        ...
        try
        {
            gestor = MeLanbide39Manager.getInstance().getValorCampoDesplegable(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide39.FICHERO_PROPIEDADES), adaptador);
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        ...
        try
        {
            empresa = MeLanbide39Manager.getInstance().getValorCampoTexto(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide39.FICHERO_PROPIEDADES), adaptador);
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
        ...
        if(importes != null && !importes.isEmpty())
        {
            xmlSalida.append("<IMPORTES>");
                ...
                xmlSalida.append("<IMP_SOL>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_SOL>");

                xmlSalida.append("<IMP_CONV>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_CONV>");

                xmlSalida.append("<IMP_PREV_CON>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PREV_CON>");

                xmlSalida.append("<IMP_CON>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_CON>");

                xmlSalida.append("<IMP_JUS>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_JUS>");
                
                xmlSalida.append("<IMP_REN_RES>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_REN_RES>");
                ...
                xmlSalida.append("<IMP_REN>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_REN>");

                xmlSalida.append("<IMP_PAG>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PAG>");

                xmlSalida.append("<IMP_PAG_2>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PAG_2>");

                xmlSalida.append("<IMP_REI>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_REI>");

                xmlSalida.append("<OTRAS_AYUDAS_SOLIC>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</OTRAS_AYUDAS_SOLIC>");

                xmlSalida.append("<OTRAS_AYUDAS_CONCE>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</OTRAS_AYUDAS_CONCE>");

                xmlSalida.append("<MINIMIS_SOLIC>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</MINIMIS_SOLIC>");

                xmlSalida.append("<MINIMIS_CONCE>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</MINIMIS_CONCE>");
                ...
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_DESP);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_DESP>");

                xmlSalida.append("<IMP_BAJA>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_BAJA>");

                xmlSalida.append("<IMP_BONIF>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BONIF))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_BONIF);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_BONIF>");
                xmlSalida.append("<IMP_JUS2>");
                if(importes.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS2))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS2);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_JUS2>");
            xmlSalida.append("</IMPORTES>");
            ...
            xmlSalida.append("<PUESTOS>");
                ...
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_SOLICITADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_SOLICITADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_SOLICITADOS>");
            
                xmlSalida.append("<PUESTOS_DENEGADOS>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DENEGADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DENEGADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_DENEGADOS>");
            
                xmlSalida.append("<PUESTOS_CONTRATADOS>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_CONTRATADOS>");
            
                xmlSalida.append("<PERSONAS_CONTRATADAS>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_CONTRATADAS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_CONTRATADAS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_CONTRATADAS>");
            
                xmlSalida.append("<PUESTOS_DESPIDO>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DESPIDO))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DESPIDO);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_DESPIDO>");
            
                xmlSalida.append("<PERSONAS_DESPIDO>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_DESPIDO))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_DESPIDO);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_DESPIDO>");
            
                xmlSalida.append("<PUESTOS_BAJA>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_BAJA))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_BAJA);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_BAJA>");
            
                xmlSalida.append("<PERSONAS_BAJA>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_BAJA))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_BAJA);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_BAJA>");
            
                xmlSalida.append("<PUESTOS_RENUNCIADOS>");
                if(puestos.containsKey(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_RENUNCIADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_RENUNCIADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_RENUNCIADOS>");
     ...
     {
        Integer ejercicio = MeLanbide39Utils.getEjercicioDeExpediente(numExpediente);
        MeLanbide39Manager.getInstance().grabarImportesResolucion(codOrganizacion, ejercicio, numExpediente, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
     }
     ...
     {
        Integer ejercicio = MeLanbide39Utils.getEjercicioDeExpediente(numExpediente);
        MeLanbide39Manager.getInstance().grabarImportesResolucionModif(codOrganizacion, ejercicio, numExpediente, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
     }
     ...
     public String cargarImportesResolucion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
     {
         ...
         try
         {
            ...
            if(ejercicio != null)
            {
                if(res != null && !res.equals(""))
                {
                    ...
                    AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                    HashMap<String, Object> valores = MeLanbide39Manager.getInstance().cargarImportesResolucion(codOrganizacion, ejercicio, numExpediente, res, adapt);
                    ...
                    while(it.hasNext())
                    {
                        ...
                        {
                            str = MeLanbide39Utils.redondearDecimalesString((BigDecimal)valor, 2);
                        }
                ...
                {
                    request.setAttribute("error", MeLanbide39I18n.getInstance().getMensaje(codIdioma, "error.datosRes.resNoDeterminada"));
                }
            }
            else
            {
                request.setAttribute("error", MeLanbide39I18n.getInstance().getMensaje(codIdioma, "error.datosRes.ejercicioNoDeterminado"));
            }
         }
         catch(Exception ex)
         {
         ...
         return "/jsp/extension/melanbide39/datosResolucion.jsp";
     }
     ...
     public String cargarHistorico(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
     {
        ...
        return "/jsp/extension/melanbide39/datosCepHist.jsp";
     }
    ...
    {
        log.error("ENTRA EN generarInformeResumenEconomico2016");
        String rutaArchivoSalida = null;
        int i = 0;
        try
        {
            ...
            try 
            {
                ...
                hoja.setColumnWidth(8, 5000);//fecha fin
                hoja.setColumnWidth(9, 4000);//periodo meses
                hoja.setColumnWidth(10, 5000);//nivel titulacion
                hoja.setColumnWidth(11, 8000);//pais
                hoja.setColumnWidth(12, 5000);//costes contrato salario + ss
                //hoja.setColumnWidth(13, 5000);//dietas convenio
                hoja.setColumnWidth(13, 5000);//coste de la contratacion
                hoja.setColumnWidth(14, 5000);//salario anual bruto
                hoja.setColumnWidth(15, 5000);//Gastos seguro
                hoja.setColumnWidth(16, 5000);//Gastos visado
                hoja.setColumnWidth(17, 5000);//importe total solicitado
                hoja.setColumnWidth(18, 5000);//dotacion anual
                hoja.setColumnWidth(19, 5000);//meses subvencionables
                hoja.setColumnWidth(20, 5000);//gastos seguro subvencionables
                hoja.setColumnWidth(21, 5000);//gastos visado subvencionables
                hoja.setColumnWidth(22, 2700);//minimis
                hoja.setColumnWidth(23, 4000);//importe maximo subvencionable
                hoja.setColumnWidth(24, 3500);//importe concedido
                hoja.setColumnWidth(25, 4500);//num renuncias
                hoja.setColumnWidth(26, 3000);//importe renuncia
                hoja.setColumnWidth(27, 5000);//motivo renuncia
                hoja.setColumnWidth(28, 5000);//importe concedido tras res modif                
                ...
                hoja2.setColumnWidth(8, 5000);//fecha fin
                hoja2.setColumnWidth(9, 4000);//periodo meses
                hoja2.setColumnWidth(10, 5000);//nivel titulacion
                hoja2.setColumnWidth(11, 8000);//pais
                hoja2.setColumnWidth(12, 5000);//costes contrato salario + ss
                //hoja.setColumnWidth(13, 5000);//dietas convenio
                hoja2.setColumnWidth(13, 5000);//coste de la contratacion
                hoja2.setColumnWidth(14, 5000);//salario anual bruto
                hoja2.setColumnWidth(15, 5000);//Gastos seguro
                hoja2.setColumnWidth(16, 5000);//Gastos visado
                hoja2.setColumnWidth(17, 5000);//importe total solicitado
                hoja2.setColumnWidth(18, 5000);//dotacion anual
                hoja2.setColumnWidth(19, 5000);//meses subvencionables
                hoja2.setColumnWidth(20, 5000);//gastos seguro subvencionables
                hoja2.setColumnWidth(21, 5000);//gastos visado subv
                hoja2.setColumnWidth(22, 2700);//minimis
                hoja2.setColumnWidth(23, 4000);//importe maximo subvencionable
                hoja2.setColumnWidth(24, 3500);//importe concedido
                hoja2.setColumnWidth(25, 4500);//num renuncias
                hoja2.setColumnWidth(26, 3000);//importe renuncia
                hoja2.setColumnWidth(27, 5000);//motivo renuncia
                hoja2.setColumnWidth(28, 5000);//importe concedido tras res modif
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(0);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col1").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(1);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col2").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(2);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col30").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(3);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col3").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(4);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col4").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(5);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col5").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(6);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col6").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(7);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col7").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(8);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col8").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(9);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col9").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(10);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col10").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(11);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col11").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(12);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col12").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(13);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col15").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(14);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col16").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(15);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col17").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(16);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col18").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(17);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col19").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(18);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col20").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(19);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col21").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(20);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col22").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(21);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col23").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(22);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col24").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(23);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col25").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(24);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col26").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(25);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col27").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(26);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col28").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(27);
                celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeEconomico2016.col29").toUpperCase());
                celda.setCellStyle(estiloCelda);
...
//                celda.setCellStyle(estiloCelda);
                ...
                Double subTot=0.00;
                Double solicitadoTotal=0.00;
                Double gastosVisSol=0.00;
                Double salarioAnualBruto=0.00;
                Double gastosSegSol=0.00;
                    ...
                    if(filaI.getNumExpediente() != null && !filaI.getNumExpediente().equals(numExp))
                    {
                        if(p != 0)
                        {
                            ...
                            */                            
                            ...
                            hoja.addMergedRegion(new CellRangeAddress(numFila-p,  numFila, 2, 2));
                            hoja.addMergedRegion(new CellRangeAddress(numFila-p,  numFila-1, 3, 3));
                            hoja.addMergedRegion(new CellRangeAddress(numFila-p,  numFila-1, 21, 21));
                        }
                        numExp = filaI.getNumExpediente();
                        nuevo = true;
                        p = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    gastosVisSol=filaI.getSolGastosTra() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getSolGastosTra(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue();
                    if (filaI.getOrden()!=2) {
                        celda.setCellValue(gastosVisSol);
                        celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    }

                    //COLUMNA: IMPORTE SOLICITADO
                    solicitadoTotal=gastosVisSol+salarioAnualBruto+gastosSegSol;
                    celda = fila.createCell(16);
                    if(nuevo) {
                        celda.setCellStyle(estiloCeldaNumericoFilaPrimera);
                        subTot = solicitadoTotal;
                    ...
                    celda.setCellValue(filaI.getGastosSeguroPto() != null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getGastosSeguroPto(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);

                    //COLUMNA: GASTOS VISADO SUBVENCIONABLES
                    celda = fila.createCell(20);
                    if(nuevo) {
                        celda.setCellStyle(estiloCeldaNumericoFilaPrimera);
                    } else if(filaI.getOrden() != null && filaI.getOrden() == 2){
                    ...
                    celda.setCellValue(filaI.getGastosVisadoPto()!= null ? MeLanbide39Utils.redondearDecimalesBigDecimal(filaI.getGastosVisadoPto(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                ...
                if(p != 0)
                {
                    ...
                    hoja.getRow(numFila-p).getCell(21).setCellStyle(estiloCelda); 
        ...
        log.error("SALE DE generarInformeResumenEconomico2016");
    }
    ...
    public void generarInformeDatosPuestos2016(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            try 
            {
                ...
                log.debug("generarInformeDatosPuestos2016: ");
                ...
                hoja.addMergedRegion(new CellRangeAddress(numFila,  numFila, 18,23));
                hoja.addMergedRegion(new CellRangeAddress(numFila,  numFila, 24, 28));
                crearEstiloCabeceraInformeDatosPuestos2016(libro, fila, celda, estiloCelda, idioma);
                numFila ++;
                ...
                String numExp = null;
                listaPuestos = manager.getDatosInformePuestos2016(ano, adapt);
...
//                    hoja.addMergedRegion(new Region(numFila-p-1, 2, numFila-1, 2));
                ...
                /*File directorioTemp = new File(m_Conf.getString("PDF.base_dir"));
                File informe = File.createTempFile("resumenJustificacionFinal", ".xls", directorioTemp);
                
                log.debug("directorioTemp2: " + directorioTemp);
    ...
    private void crearEstiloInformeDatosPuestos2016(HSSFWorkbook libro, HSSFRow fila, HSSFCell celda, HSSFCellStyle estiloCelda, int idioma)
    {
        try
        {
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(0);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col1").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(1);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col2").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(2);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col3").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(3);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col4").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(4);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col5").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(5);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col6").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(6);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col7").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(7);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col8").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(8);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col9").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(9);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col10").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(10);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col11").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(11);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col12").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(12);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col13").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(13);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col14").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(14);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col15").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(15);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col16").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(16);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col17").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(17);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col18").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(18);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col19").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(19);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col20").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(20);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col21").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(21);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col22").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(22);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col23").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(23);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col24").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(24);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col25").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(25);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col26").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(26);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col27").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(27);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col28").toUpperCase());
            celda.setCellStyle(estiloCelda);
            ...
            estiloCelda.setFont(negritaTitulo);
            celda = fila.createCell(28);
            celda.setCellValue(meLanbide39I18n.getMensaje(idioma, "doc.informeDatosPuestos2016.col29").toUpperCase());
            celda.setCellStyle(estiloCelda);
        }catch(Exception ex){
    ...
    HSSFFont normal, int codOrganizacion, int ano, AdaptadorSQLBD adapt, SimpleDateFormat format)
    {
        try
        {
           ...
           // celda.setCellValue(filaI.getSalarioAnualBruto() != null ? filaI.getSalarioAnualBruto().toUpperCase() : "");
            ...
            //celda.setCellValue(filaI.getImporteConce() != null ? filaI.getImporteConce() : "");
            celda.setCellStyle(estiloCelda);
            if (filaI.getImporteConce()!= null){
                if (filaI.getImporteConce()!= "-"){
                    Double aux=Double.parseDouble(filaI.getImporteConce().replace(",","."));
                    celda.setCellValue(aux);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                }else{
                    celda.setCellValue(filaI.getImporteConce());
                }
            }
            //celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
...
//            celda.setCellStyle(estiloCelda);
            ...
            celda = fila.createCell(19);
            //celda.setCellValue(filaI.getImporteJus() != null ? filaI.getImporteJus().replaceAll("\\.", ",") : "");
            celda.setCellStyle(estiloCelda);
    ...
    public String cargarCriteriosFiltroListadoCompCP(int codOrganizacion,  int codTramite, int ocurrenciaTramite,String numExpediente,HttpServletRequest request,HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide39/procesos/solicitarAno.jsp";
    }
}
