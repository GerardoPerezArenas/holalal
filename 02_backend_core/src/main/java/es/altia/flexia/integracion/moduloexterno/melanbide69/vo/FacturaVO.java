...
public class FacturaVO {
    ...
    public void setFechaStr() {
        if(fecha!=null) this.fechaStr = MeLanbide69Util.dateToFormattedString(fecha);
        else fechaStr = "-";
    }
    ...
    public void setImporteStr() {
        this.importeStr = MeLanbide69Util.doubleToFormattedString(importe);
    }
    ...
    public String factToString(boolean conObs){
        StringBuilder sb = new StringBuilder("");
         ...
         sb.append("IDENTIFICACI�N: ").append(identFactura).append("\n");
