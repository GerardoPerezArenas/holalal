...
public class FilaPreparadorSolicitudVO 
{
    ...
    public static int POS_CAMPO_C4TOTAL = 24;
       public static int POS_CAMPO_C5H = 25;
    public static int POS_CAMPO_C5M = 26;
    public static int POS_CAMPO_C5TOTAL = 27;
       public static int POS_CAMPO_C6H = 28;
    public static int POS_CAMPO_C6M = 29;
    public static int POS_CAMPO_C6TOTAL = 30;
    public static int POS_CAMPO_INSERCIONES = 31;
    public static int POS_CAMPO_SEGUIMIENTOS_INSERCIONES = 32;
    public static int POS_CAMPO_COSTES_SALARIALES_SS = 33;
    public static int POS_CAMPO_IMPORTE_CONCEDIDO = 34;
    
    public static int NUM_CAMPOS_FILA = 35;
