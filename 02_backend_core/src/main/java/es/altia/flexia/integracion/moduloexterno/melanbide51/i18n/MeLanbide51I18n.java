 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide51.i18n;
 ...
 * @author davidg
 */
public class MeLanbide51I18n {
    
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide51.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide51I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide51I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide51I18n.class){
                if(instance == null){
                    instance = new MeLanbide51I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide51I18n.class)
        }//if(instance == null)
        return instance;
