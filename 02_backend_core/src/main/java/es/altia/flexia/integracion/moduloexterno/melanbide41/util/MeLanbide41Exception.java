 ...
 * @author mikel
 */
public class MeLanbide41Exception extends Exception{
     ...
     */
    public MeLanbide41Exception(String message) {
        super(message);
    }
     ...
     */
    public MeLanbide41Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
