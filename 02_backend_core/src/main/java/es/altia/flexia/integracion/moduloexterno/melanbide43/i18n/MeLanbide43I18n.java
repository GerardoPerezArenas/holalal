package es.altia.flexia.integracion.moduloexterno.melanbide43.i18n;
 ...
 * </ol> 
 */
public class MeLanbide43I18n {
   
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide43.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide43I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide43I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide43I18n.class){
                if(instance == null){
                    instance = new MeLanbide43I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide43I18n.class)
        }//if(instance == null)
        return instance;
