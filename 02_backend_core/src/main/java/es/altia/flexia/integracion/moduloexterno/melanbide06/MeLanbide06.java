...
import es.altia.flexia.integracion.moduloexterno.melanbide06.i18n.MeLanbide06I18n;
...
public class MeLanbide06 extends ModuloIntegracionExterno {
    ...
    //Logger
    private static Logger log = LogManager.getLogger(MeLanbide06.class);
	...
	try {
		...
		log.info("Error al obtener la Lista de procedimientos", ex);
	}
	...
	try {
		...
		log.info("Error al obtener la Lista de uors", ex);
	}
	...
	try {
		...
		log.info("Error al obtener la Lista de asuntos", ex);
	}
	...
	try {
		...
		log.info("Error al obtener la Lista de eventos", ex);
	}
	...
	try {
		...
		log.info("Error al obtener la Lista de entidades", ex);
	}
	...
	try {
		...
		log.info("Error al obtener la Lista de organizaciones", ex);
	}
    ...
    public void cargarEtiquetas(HttpServletRequest request){
        ...
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.interesado"));
        listaEtiquetas.add(item);
       
        item = new SelectItem();
        item.setCodigo("@ejercicio@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.ejercicio"));
        listaEtiquetas.add(item);
        
        item = new SelectItem();
        item.setCodigo("@asunto@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.asunto"));
        listaEtiquetas.add(item);
                
        item = new SelectItem();
        item.setCodigo("@uor@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.uor"));
        listaEtiquetas.add(item);
      
        item = new SelectItem();
        item.setCodigo("@fecha_presentacion@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.fecha_presentacion"));
        listaEtiquetas.add(item);
         
        item = new SelectItem();
        item.setCodigo("@numeroAnotacion@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.numeroAnotacion"));
        listaEtiquetas.add(item);
        
        item = new SelectItem();
        item.setCodigo("@extracto@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.extracto"));
        listaEtiquetas.add(item);

        item = new SelectItem();
        item.setCodigo("@numeroExpediente@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.numeroExpediente"));
        listaEtiquetas.add(item);
        
        item = new SelectItem();
        item.setCodigo("@nombreDocumento@");
        item.setDescripcion(meLanbide06I18n.getMensaje(idioma, "tabla.gestionavisos.etiquetas.nombreDocumento"));
        listaEtiquetas.add(item);
