 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide85.i18n;
...
public class MeLanbide85I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE85");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide85I18n instance = null; 

    
    public static MeLanbide85I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide85I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide85I18n();
                }
            }
        }
        return instance;
