 ...
 * @author pablo.bugia
 */
public class Exception extends AxisFault implements Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://langaiVision360.services.langaiWS.es/", "Exception"));
