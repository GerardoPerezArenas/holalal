...
package es.altia.flexia.integracion.moduloexterno.melanbide41.vo.identificacionesp;
...
public class IdentificacionEspVO {
    ...
    private BigDecimal alumnosAut;        //IDE_ALUM
    ...
    public BigDecimal getAlumnosAut() {
        return alumnosAut;
    }
    
    public void setAlumnosAut(BigDecimal alumnosAut) {
        this.alumnosAut = alumnosAut;
    }
