 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide12.i18n;
...
public class MeLanbide12I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE12");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide12I18n instance = null; 

    
    public static MeLanbide12I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide12I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide12I18n();
                }
            }
        }
        return instance;
