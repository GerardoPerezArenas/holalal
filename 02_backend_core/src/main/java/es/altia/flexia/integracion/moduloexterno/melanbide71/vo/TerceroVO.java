package es.altia.flexia.integracion.moduloexterno.melanbide71.vo;
...
public class TerceroVO {
    ...
    private String rol;
    private int edad;//se calcula en base a la fecha de nacimiento y fecha resoluci�n inicio expdte
