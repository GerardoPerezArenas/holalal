...
public class ConstantesMeLanbide70 {
    //Fichero de propiedades del modulo.
    private static final String FICHERO_PROPIEDADES = "MELANBIDE70";
    ...
    private static final String COD_PROCEDIMIENTO = "APEI";
    ...
    private static final ResourceBundle PROPERTIES = ResourceBundle.getBundle("MELANBIDE70");
