package es.altia.flexia.integracion.moduloexterno.melanbide86.i18n;

import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide86I18n {

    private static final ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE86");

    private static final HashMap<Integer, ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();

    private static MeLanbide86I18n instance = null;

    public static MeLanbide86I18n getInstance() {
        if (instance == null) {
            synchronized (MeLanbide86I18n.class) {
                if (instance == null) {
                    instance = new MeLanbide86I18n();
                }
            }
        }
        return instance;
