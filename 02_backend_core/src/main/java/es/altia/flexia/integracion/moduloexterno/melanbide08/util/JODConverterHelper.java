...
public class JODConverterHelper {
    ...
    private static final Logger log = LogManager.getLogger(JODConverterHelper.class);
...
try {
    //DESA PRE
ExternalOfficeManagerConfiguration externalProcessOfficeManager =
new ExternalOfficeManagerConfiguration();
externalProcessOfficeManager.setConnectOnStart(true);
externalProcessOfficeManager.setPortNumber(ports[0]);
OfficeManager officeManager =
externalProcessOfficeManager.buildOfficeManager();
 ...
 {
     //LOCAL SI FALLA PONER EN EL TRY Y EL TRY EN EL CATCH
