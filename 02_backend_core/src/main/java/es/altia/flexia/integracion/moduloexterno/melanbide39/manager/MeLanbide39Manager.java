 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide39.manager;

import es.altia.flexia.integracion.moduloexterno.melanbide39.dao.MeLanbide39DAO;
 ...
 * @author santiagoc
 */
public class MeLanbide39Manager 
{
    //Logger
    private static Logger log = LogManager.getLogger(MeLanbide39Manager.class);
    
    //Instancia
    private static MeLanbide39Manager instance = null;
    
    private MeLanbide39Manager()
    {
        
    }
    
    public static MeLanbide39Manager getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide39Manager.class)
            {
                instance = new MeLanbide39Manager();
            }
        }
        return instance;
    }      
    ...
    public BigDecimal getValorCampoNumerico(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codCampo, con);
        }
        catch(BDException e)
        {
    ...
    public void guardaHistorico(String numExpediente, String codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide44DAO = MeLanbide39DAO.getInstance();
    ...
    public int guardarValorCampoNumerico(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, BigDecimal valor, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio, numExpediente, codCampo, valor, con);
        }
        catch(BDException e)
        {
    ...
    public String getValorCampoTexto(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getValorCampoTexto(codOrganizacion, numExpediente, ejercicio, codCampo, con);
        }
        catch(BDException e)
        {
    ...
    public int guardarValorCampoTexto(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, String valor, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.guardarValorCampoTexto(codOrganizacion, numExpediente, ejercicio, codCampo, valor, con);
        }
        catch(BDException e)
        {
    ...
    public String getValorCampoDesplegable(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getValorCampoDesplegable(codOrganizacion, numExpediente, ejercicio, codCampo, con);
        }
        catch(BDException e)
        {
    ...
    public int guardarValorCampoDesplegable(int codOrganizacion, String ejercicio, String numExpediente, String codCampo, String valor, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.guardarValorCampoDesplegable(codOrganizacion, numExpediente, ejercicio, codCampo, valor, con);
        }
        catch(BDException e)
        {
...
//            int res = 0;
//            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(gestor != null && !gestor.equals(""))
//            {
//                res += meLanbide39DAO.guardarValorCampoDesplegable(codOrganizacion, String.valueOf(ejercicio), numExpediente, campoActual, gestor, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(empresa != null && !empresa.equals(""))
//            {
//                res += meLanbide39DAO.guardarValorCampoTexto(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, empresa, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(impPagado != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, impPagado, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            else
//            {
//                res += meLanbide39DAO.eliminarValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, campoActual, con);
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(impPagado != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, impPagado2, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(otrasAyudasConce != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, otrasAyudasConce, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(otrasAyudasSolic != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, otrasAyudasSolic, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(minimisSolic != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, minimisSolic, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(minimisConce != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, minimisConce, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(importeConcedido != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, importeConcedido, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//            }
//
//            campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            if(importeReintegrar != null)
//            {
//                res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, importeReintegrar, con);
//                if(res <= 0)
//                {
//                    throw new Exception();
//                }
...
//    }
    ...
    public int guardarDatosCpe(int codOrganizacion, String ejercicio, String numExpediente, String gestor, String empresa, BigDecimal impPagado, BigDecimal impPagado2, BigDecimal otrasAyudasSolic, BigDecimal otrasAyudasConce, BigDecimal minimisSolic, BigDecimal minimisConce, BigDecimal importeConcedido,BigDecimal importeRenunciaRes, BigDecimal importeReintegrar, AdaptadorSQLBD adaptador) throws Exception
    {
        Connection con = null;
        String campoActual = "";
        BigDecimal cero = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
        try
        {
            con = adaptador.getConnection();
            adaptador.inicioTransaccion(con);
            ...
            Long codTramResModif = MeLanbide39Manager.getInstance().obtenerCodigoInternoTramite(codOrganizacion, ConstantesMeLanbide39.CODIGO_TRAMITE_RESOLUCION_MODIF, adaptador);
            if(codTramResModif != null)
            {
                ...
                {
                    campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
                }
                else
                {
                    campoActual = ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
            ...
            if(impPagado2 == null)
            {
                impPagado2 = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                impPagado2 = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            if(otrasAyudasConce == null)
            {
                otrasAyudasConce = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                otrasAyudasConce = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            if(otrasAyudasSolic == null)
            {
                otrasAyudasSolic = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                otrasAyudasSolic = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            if(minimisSolic == null)
            {
                minimisSolic = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                minimisSolic = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            if(minimisConce == null)
            {
                minimisConce = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                minimisConce = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            if(importeConcedido == null)
            {
                importeConcedido = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                importeConcedido = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            ...
            campoActual = es.altia.flexia.integracion.moduloexterno.melanbide59.util.ConfigurationParameter.getParameter(ConstantesMeLanbide59.CAMPO_SUPL_IMP_REN_RES, ConstantesMeLanbide59.FICHERO_PROPIEDADES);
            ...
            res += meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion,  String.valueOf(ejercicio), numExpediente, campoActual, importeRenunciaRes, con);
            if(res <= 0)
            {
                throw new Exception();
            }
            ...
            if(importeReintegrar == null)
            {
                importeReintegrar = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
            }
            else if(impPagado.compareTo(cero) < 0)
            {
                importeReintegrar = new BigDecimal(ConstantesMeLanbide39.CERO_CON_DECIMALES);
    ...
    public List<SelectItem> getListaPaises(AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaPaises(con);
        }
        catch(BDException e)
        {
    ...
    public Map<String, BigDecimal> cargarCalculosCpe(int codOrganizacion, Integer ejercicio, String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.cargarCalculosCpe(codOrganizacion, ejercicio, numExpediente, con);
        }
        catch(BDException e)
        {
    ...
    public CpePuestoVO getPuestoPorCodigoYExpediente(CpePuestoVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getPuestoPorCodigoYExpediente(p, con);
        }
        catch(BDException e)
        {
    ...
    public CpePuestoVO guardarCpePuestoVO(int codOrganizacion, CpePuestoVO puesto, BigDecimal impAnterior, String estadoAnterior, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            adaptador.inicioTransaccion(con);
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            puesto = meLanbide39DAO.guardarCpePuestoVO(puesto, con);
            if(puesto != null)
            {
                ...
                boolean puestoRenuncia = puesto.getCodResult() != null && puesto.getCodResult().equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_RENUNCIA);
                if(nuevo)
                {
                    ...
                    oferta = meLanbide39DAO.guardarCpeOfertaVO(oferta, con);
                    ...
                    meLanbide39DAO.guardarCpeJustificacionVO(justif, con);
                }
                if(puestoRenuncia)
                {
                    meLanbide39DAO.actualizarOfertasPuestoPorRenuncia(puesto, true, con);
                    meLanbide39DAO.actualizarJustificacionesPuestoPorRenuncia(puesto, true, con);
                }
                else if(estadoAnterior != null && estadoAnterior.equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_ESTADO_RENUNCIA))
                {
                    //Si se ha cambiado el resultado de RENUNCIA a otro cualquiera, borramos la fecha y causa de baja
                    meLanbide39DAO.actualizarOfertasPuestoPorRenuncia(puesto, false, con);
                    meLanbide39DAO.actualizarJustificacionesPuestoPorRenuncia(puesto, false, con);
                }
                adaptador.finTransaccion(con);
                return puesto;
            }
    ...
    public List<FilaPuestoVO> getListaPuestosPorExpediente(String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaPuestosPorExpediente(numExpediente, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaPuestoVO> getListaPuestosHistPorExpediente(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaPuestosHistPorExpediente(codOrganizacion, numExpediente, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    public int eliminarCpePuestoVO(int codOrganizacion, CpePuestoVO puesto, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            if(puesto != null)
            {
                meLanbide39DAO.eliminarJustificacionesPorPuestoYExpediente(puesto, con);
                meLanbide39DAO.eliminarOfertasPorPuestoYExpediente(puesto, con);
                int eliminados = meLanbide39DAO.eliminarCpePuesto(puesto, con);
                if(eliminados > 0)
                {
    ...
    public SalarioVO getSalarioAnexo1PorPaisGrupoCot(Integer codPais, String codGrCot, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            {
                return meLanbide39DAO.getSalarioAnexo1PorPaisGrupoCot(codPais, codGrCot, con);
            }
            else
            {
                return null;
...
//        Map<String, BigDecimal> calculos = meLanbide39DAO.cargarCalculosCpe(codOrganizacion, puesto.getEjercicio(), puesto.getNumExp(), con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_SOLICITADO;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
...
//        }
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_CONVOCATORIA;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(eliminar)
//        {
...
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_PREV_CON;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(eliminar)
//        {
...
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
...
//        }
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_JUS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(eliminar)
//        {
...
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(eliminar)
//        {
...
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
//        {
//            valor = calculos.get(claveCampo);
...
//        }
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_REI;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(eliminar)
//        {
...
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
//
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
//        {
//            valor = calculos.get(claveCampo);
...
//    }
    ...
    public void guardarCalculosCpe(int codOrganizacion, CpePuestoVO puesto, BigDecimal impAnterior, boolean eliminar, boolean nuevo, AdaptadorSQLBD adaptador, Connection con) throws Exception
    {
        ...
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        valor = calculos.get(claveCampo);
        if(valor == null)
        {
        ...
        //Importe por despido
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_DESP;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        valor = calculos.get(claveCampo);
        if(valor == null)
        {
        ...
        //Importe por baja
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_BAJA;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        valor = calculos.get(claveCampo);
        if(valor == null)
        {
        ...
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            ...
            log.debug("PRIMER PAGO: "+valor);
            meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, valor, con);
        }
        
        //Importe segundo pago
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            valor = calculos.get(claveCampo);
        ...
        //Otras ayudas solic
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            valor = calculos.get(claveCampo);
        ...
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_OTRAS_AYUDAS_CONCE;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            valor = calculos.get(claveCampo);
        ...
        //Minimis solic
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_SOLIC;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            valor = calculos.get(claveCampo);
        ...
        //Minimis concedido
        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_MINIMIS_CONCE;
        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        if(this.getValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, adaptador) == null)
        {
            valor = calculos.get(claveCampo);
...
//        String codCampo = null;
//        Integer valor = null;
//        Map<String, Integer> calculos = meLanbide39DAO.cargarCalculosPuestos(codOrganizacion, puesto.getEjercicio(), puesto.getNumExp(), con);
//        //Puestos solicitados
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_SOLICITADOS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor == null)
//        {
...
//            valor = 0;
//        }
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(puesto.getEjercicio()), puesto.getNumExp(), codCampo, new BigDecimal(String.valueOf(valor)), con);
//
//        //Puestos denegados
//        
//            claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DENEGADOS;
//            codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//            valor = calculos.get(claveCampo);
//            if(valor == null)
//            {
//                valor = 0;
//            }
//            if(puesto.getCodResult() != null && puesto.getCodResult().equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_DENEGADO))
//            {
//                if(eliminar)
//                {
//                    valor -= 1;
...
//        String codCampo = null;
//        Integer valor = null;
//        Map<String, Integer> calculos = meLanbide39DAO.cargarCalculosPuestos(codOrganizacion, ejercicio, numExpediente, con);
//        //Puestos solicitados
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_SOLICITADOS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
...
//            valor = 0;
//        }
//        meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, codCampo, new BigDecimal(String.valueOf(valor)), con);
//
//        //Puestos denegados
//        
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DENEGADOS;
...
//
//        //puestos contratados
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_CONTRATADAS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//
//        //puestos despido
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_DESPIDO;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//
//        //personas despido
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_DESPIDO;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//
//        //puestos baja
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_BAJA;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//
//        //personas baja
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PERSONAS_BAJA;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//        
//        //Puestos renunciados
//        claveCampo = ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_RENUNCIADOS;
//        codCampo = ConfigurationParameter.getParameter(claveCampo, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
//        valor = calculos.get(claveCampo);
//        if(valor != null)
//        {
...
//    }
    ...
    public List<FilaOfertaVO> getListaOfertasNoDenegadasPorExpediente(String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaOfertasNoDenegadasPorExpediente(numExpediente, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaOfertaVO> getListaOfertasHistNoDenegadasPorExpediente(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaOfertasHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    public CpeOfertaVO getOfertaPorCodigoPuestoYExpediente(CpeOfertaVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getOfertaPorCodigoPuestoYExpediente(p, con);
        }
        catch(BDException e)
        {
            ...
            if(oferta != null)
            {
                ...
                if(alta != null && alta.equals("1"))
                {
                    ...
                    if(copiar != null && copiar.equalsIgnoreCase("1"))
                    {
                        ...
                        ofertaNueva.setContratacionPresOferta(oferta.getContratacionPresOferta());
                        ofertaNueva.setCodCausaRenuncia(oferta.getCodCausaRenuncia());
                        ofertaNueva.setCodCausaRenunciaPresOferta(oferta.getCodCausaRenunciaPresOferta());
                    }
                    ofertaNueva = meLanbide39DAO.guardarCpeOfertaVO(ofertaNueva, con);
                ...
                puesto = meLanbide39DAO.getPuestoPorCodigoYExpediente(puesto, con);
                if(puesto != null)
                {
                    guardarCalculosCpe(codOrganizacion, puesto, null, true, false, adaptador, con);
    ...
    public List<SelectItem> getTiposDocumento(AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getTiposDocumento(con);
        }
        catch(BDException e)
        {
    ...
    public int eliminarCpeOfertaVO(int codOrganizacion, CpeOfertaVO oferta, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            if(oferta != null)
            {
                int eliminados = meLanbide39DAO.eliminarCpeOferta(oferta, con);
                if(eliminados > 0)
                {
                    guardarCalculosPuestos(codOrganizacion, oferta.getExpEje(), oferta.getNumExp(), adaptador, con);
                    adaptador.finTransaccion(con);   
    ...
    public HashMap<String, String> getDatosTercero(int codOrganizacion, String numExp, String ejercicio, String rol, AdaptadorSQLBD adaptador)throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getDatosTercero(codOrganizacion, numExp, ejercicio, rol, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaJustificacionVO> getListaJustificacionesNoDenegadasPorExpediente(String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaJustificacionesNoDenegadasPorExpediente(numExpediente, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaJustificacionVO> getListaJustificacionesHistNoDenegadasPorExpediente(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaJustificacionesHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    public CpeJustificacionVO getJustificacionPorCodigoPuestoYExpediente(CpeJustificacionVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getJustificacionPorCodigoPuestoYExpediente(p, con);
        }
        catch(BDException e)
        {
    ...
    public CpeJustificacionVO getJustificacionPorCodigoPuestoOfertaYExpediente(CpeJustificacionVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getJustificacionPorCodigoPuestoOfertaYExpediente(p, con);
        }
        catch(BDException e)
        {
            log.error("Se ha producido un error recuperando oferta "+(p != null ? p.getIdOferta() : "(oferta = null)")+" para puesto "+(p != null ? p.getCodPuesto() : "(oferta = null)")+" expediente "+(p != null ? p.getNumExpediente() : "(oferta = null)"), e);
     ...
     public String obtenerDiasTrabajados(String numExpediente, String codPuesto, Integer idOferta,  AdaptadorSQLBD adaptador)throws SQLException 
    {
        ...
        {
            con = adaptador.getConnection();
            //dias = MeLanbide39DAO.getInstance().obtenerDiasTrabajados(numExpediente, nif, con);
            dias = MeLanbide39DAO.getInstance().obtenerDiasTrabajados(numExpediente, codPuesto,idOferta, con);
        }
        catch (Exception ex)
        {
    ...
    public CpeJustificacionVO guardarCpeJustificacionVO(int codOrganizacion, CpeJustificacionVO justif, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            adaptador.inicioTransaccion(con);
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            justif = meLanbide39DAO.guardarCpeJustificacionVO(justif, con);
            if(justif != null)
            {
                adaptador.finTransaccion(con);
                return justif;
    ...
    public void actualizaImporteJusti(int codOrganizacion, String numExp, String eje, BigDecimal justif, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            adaptador.inicioTransaccion(con);
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            meLanbide39DAO.actualizaImporteJusti(codOrganizacion, numExp,eje, justif.toString(), con);
            if(justif != null)
            {
                adaptador.finTransaccion(con);
    ...
    public List<FilaInformeResumenPuestosContratadosVO> getDatosInformeResumenPuestosContratados(Integer ejercicio, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getDatosInformeResumenPuestosContratados(ejercicio, con);
        }
        catch(BDException e)
        {
    ...
    {
        log.error("ENTRA EN MANAGER:getDatosInformeResumenEconomico");
        Connection con = null;
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getDatosInformeResumenEconomico(ejercicio, con);
        }
        catch(BDException e)
        {
        ...
        finally
        {
            ...
            log.error("SALE DE MANAGER:getDatosInformeResumenEconomico");
        }
    ...
    public List<FilaInformeDatosPuestosVO> getDatosInformePuestos2016(Integer ejercicio, AdaptadorSQLBD adaptador) throws Exception
    {
        Connection con = null;
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getInformeDatosPuestos2016(ejercicio, con);
        }
        catch(BDException e)
        {
            log.error("Se ha producido una excepcion en la BBDD en getDatosInformePuestos", e);
    ...
    public List<String> getNumerosExpedientes(Integer ejercicio, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getNumerosExpedientes(ejercicio, con);
        }
        catch(BDException e)
        {
    ...
    public Integer getNumMeses( String fini, String ffin, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.obtenerNumMeses(fini, ffin, con);
        }
        catch(BDException e)
        {
    ...
    public CpeOfertaVO getUltimaOfertaPorPuestoYExpediente(CpeOfertaVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getUltimaOfertaPorPuestoYExpediente(p, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaPersonaContratadaVO> getListaContratacionesPuesto(CpePuestoVO p, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getListaContratacionesPuesto(p, con);
        }
        catch(BDException e)
        {
    ...
    public List<FilaResultadoBusqTitulaciones> buscarTitulaciones(String codigo, String descripcion, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.buscarTitulaciones(codigo, descripcion, con);
        }
        catch(BDException e)
        {
    ...
    public String getDescripcionCampoDesplegable(String codigoCampo, String valorDesplegable, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getDescripcionCampoDesplegable(codigoCampo, valorDesplegable, con);
        }
        catch(BDException e)
        {
    ...
    public Map<String, Integer> cargarCalculosPuestos(int codOrganizacion, Integer ejercicio, String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.cargarCalculosPuestos(codOrganizacion, ejercicio, numExpediente, con);
        }
        catch(BDException e)
        {
    ...
    public Long getTramiteActualExpediente(int codOrganizacion, int ejercicio, String numExp, AdaptadorSQLBD adaptador)throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.getTramiteActualExpediente(codOrganizacion, ejercicio, numExp, con);
        }
        catch(BDException e)
        {
    ...
    public Long obtenerCodigoInternoTramite(Integer codOrganizacion, String codTramite, AdaptadorSQLBD adaptador)throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.obtenerCodigoInternoTramite(codOrganizacion, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    public boolean tieneTramiteIniciado(int codOrganizacion, int ejercicio, String numExp, Long codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.tieneTramiteIniciado(codOrganizacion, ejercicio, numExp, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    public boolean tieneTramiteFinalizado(int codOrganizacion, int ejercicio, String numExp, Long codTramite, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            con = adaptador.getConnection();
            MeLanbide39DAO meLanbide39DAO = MeLanbide39DAO.getInstance();
            return meLanbide39DAO.tieneTramiteFinalizado(codOrganizacion, ejercicio, numExp, codTramite, con);
        }
        catch(BDException e)
        {
    ...
    private HashMap<String, Object> cargarImportesResolucionCD(int codOrganizacion, String ejercicio, String numExpediente, Connection con) throws Exception
    {
        ...
        //Fecha resolucion
        clave = ConstantesMeLanbide39.CAMPO_SUPL_FEC_RES;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
            retMap.put(clave, d);
        }
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_NOT_RES;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_PUESTOS_CONC;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
            retMap.put(clave, bd);
        }
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_CONC;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_PRIMER_PAG;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_SEG_PAGO;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_FEC_RESOL;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_NUM_PUESTO;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_RENUN;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
    ...
    private HashMap<String, Object> cargarImportesResolucionModif(int codOrganizacion, String ejercicio, String numExpediente, Connection con) throws Exception
    {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_FEC_RES;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_NOT_RES;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_PUES_CONC;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_CONC;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_PRI_PAG;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_SEG_PAG;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        //Fecha presentacion renuncua
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_FEC_RENUN;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(d != null)
        {
        ...
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_PUES_REN;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
        ...
        //Importe asociado al número de puestos renunciado
        clave = ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_REN;
        codigo_campo = ConfigurationParameter.getParameter(clave, ConstantesMeLanbide39.FICHERO_PROPIEDADES);
        bd = meLanbide39DAO.getValorCampoNumerico(codOrganizacion, numExpediente, ejercicio, codigo_campo, con);
        if(bd != null)
        {
    ...
    public void grabarImportesResolucion(int codOrganizacion, Integer ejercicio, String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            meLanbide39DAO.guardarValorCampoFecha(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_FEC_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new Date(), con);
            
            //Fecha notificación resolución inicial (¿Cuál?)
            Date d = meLanbide39DAO.getValorCampoFecha(codOrganizacion, numExpediente, ejercicio.toString(), ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_FE_AC_REN_RS, ConstantesMeLanbide39.FICHERO_PROPIEDADES), con);
            if(d != null)
            {
                meLanbide39DAO.guardarValorCampoFecha(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_NOT_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES), d, con);
            }
            
            //Puestos concedidos
            i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS);
            if(i != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_PUESTOS_CONC, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new BigDecimal(i.toString()), con);
            }
            
            //Importe concedido
            bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_CON);
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_CONC, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
            
            //Importe primer pago
            bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG);
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_PRIMER_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
            
            //Importe segundo pago
            bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_PAG_2);
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_SEG_PAGO, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
            
            //Numero de puestos renunciados tras resolucion
            i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_RES_NUM_PUESTO);
            if(i != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_NUM_PUESTO, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new BigDecimal(i.toString()), con);
            }
            ...
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, es.altia.flexia.integracion.moduloexterno.melanbide39.util.ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_IMP_RENUN, ConstantesMeLanbide59.FICHERO_PROPIEDADES), bd, con);
            }
    ...
    public void grabarImportesResolucionModif(int codOrganizacion, Integer ejercicio, String numExpediente, AdaptadorSQLBD adaptador) throws Exception
    {
        ...
        try
        {
            ...
            //Fecha resolución (la de hoy)
            meLanbide39DAO.guardarValorCampoFecha(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_FEC_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new Date(), con);
            
            //Fecha notificación resolución inicial (¿Cuál?)
            meLanbide39DAO.guardarValorCampoFecha(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_NOT_RES, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new Date(), con);
            
            //Puestos concedidos
            i = puestos.get(ConstantesMeLanbide39.CAMPO_SUPL_PUESTOS_CONTRATADOS);
            if(i != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_PUES_CONC, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new BigDecimal(i.toString()), con);
            }
            ...
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_CONC, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
            ...
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_PRI_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
            ...
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_SEG_PAG, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }  
            ...
            if(i != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_PUES_REN, ConstantesMeLanbide39.FICHERO_PROPIEDADES), new BigDecimal(i.toString()), con);
            }
            
            //importe asociado al numero de puestos renunciados
            bd = importes.get(ConstantesMeLanbide39.CAMPO_SUPL_IMP_REN_RES);
            if(bd != null)
            {
                meLanbide39DAO.guardarValorCampoNumerico(codOrganizacion, ejercicio.toString(), numExpediente, es.altia.flexia.integracion.moduloexterno.melanbide39.util.ConfigurationParameter.getParameter(ConstantesMeLanbide39.CAMPO_SUPL_RES_MOD_IMP_REN, ConstantesMeLanbide39.FICHERO_PROPIEDADES), bd, con);
            }
