package es.altia.flexia.integracion.moduloexterno.melanbide87.i18n;

import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide87I18n {

    private static final ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE87");

    private static final HashMap<Integer, ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();

    private static MeLanbide87I18n instance = null;

    public static MeLanbide87I18n getInstance() {
        if (instance == null) {
            synchronized (MeLanbide87I18n.class) {
                if (instance == null) {
                    instance = new MeLanbide87I18n();
                }
            }
        }
        return instance;
