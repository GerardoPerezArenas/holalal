...
public class AbrirListaExpedientesPlateaJob implements Job {
    ...
    private final Logger log = LogManager.getLogger(AbrirListaExpedientesPlateaJob.class);
                    ...
                    while(codOrg < 2){
                        ...
                        for(Iterator<String> i = expedientes.iterator(); i.hasNext(); ) {
                            ...
                            if(par.getTipoID() != 0){
                                ...
                                String codOperacion = MeLanbide43Manager.getInstance().generarMisGestiones(codOrg,codTramiteInicio.intValue(),1,numExpediente,"I",adaptador);
