...
package es.altia.flexia.integracion.moduloexterno.melanbide50.i18n;
 ...
 * @author davidg
 */
public class MeLanbide50I18n {
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide50.FICHERO_PROPIEDADES);
    private static MeLanbide50I18n instance = null;
    ...
    public static MeLanbide50I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide50I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide50I18n();
                }
            }
        }
        return instance;
