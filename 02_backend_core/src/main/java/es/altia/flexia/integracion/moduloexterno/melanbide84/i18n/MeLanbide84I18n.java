package es.altia.flexia.integracion.moduloexterno.melanbide84.i18n;

import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide84I18n {

    private static final ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE84");

    private static final HashMap<Integer, ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();

    private static MeLanbide84I18n instance = null;

    public static MeLanbide84I18n getInstance() {
        if (instance == null) {
            synchronized (MeLanbide84I18n.class) {
                if (instance == null) {
                    instance = new MeLanbide84I18n();
                }
            }
        }
        return instance;
