 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide17;
...
import es.altia.flexia.integracion.moduloexterno.melanbide17.manager.MeLanbide17Manager;
...
public class MELANBIDE17 extends ModuloIntegracionExterno {

    //Logger
    private static Logger log = LogManager.getLogger(MELANBIDE17.class);
    ...
    public String cargarPantallaSubSolic(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        String url = "/jsp/extension/melanbide17/subSolic.jsp";
        request.setAttribute("numExp", numExpediente);
        if (adapt != null) {
            try {
                List<FilaMinimisVO> listaMinimis = MeLanbide17Manager.getInstance().getDatosMinimis(numExpediente, codOrganizacion, adapt);
                ...
                log.error("Error al recuperar los datos de minimis - MELANBIDE17 - cargarPantallaSubvenciones", ex);
            }
        }
        return url;
    }
    ...
    public String cargarNuevoMinimis(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        String nuevo = "1";
        String numExp = "";
        String urlnuevoMinimis = "/jsp/extension/melanbide17/nuevoSubSolic.jsp?codOrganizacion=" + codOrganizacion;
        try {
    ...
    public String cargarModificarMinimis(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (id != null && !id.equals("")) {
                FilaMinimisVO datModif = MeLanbide17Manager.getInstance().getMinimisPorID(id, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                if (datModif != null) {
    ...
    public void crearNuevoMinimis(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            MeLanbide17Manager meLanbide17Manager = MeLanbide17Manager.getInstance();
            boolean insertOK = meLanbide17Manager.crearNuevoMinimis(nuevaMinimis, adapt);
            if (insertOK) {
                log.debug("minimis insertada correctamente");
                codigoOperacion = "0";
                lista = meLanbide17Manager.getDatosMinimis(numExp, codOrganizacion, adapt);
                if (!lista.isEmpty()) {
    ...
    public void modificarMinimis(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (id == null || id.equals("")) {
                ...
                MeLanbide17Manager meLanbide17Manager = MeLanbide17Manager.getInstance();
                boolean modOK = meLanbide17Manager.modificarMinimis(datModif, adapt);
                if (modOK) {
                    codigoOperacion = "0";
                    try {
                        lista = meLanbide17Manager.getDatosMinimis(numExp, codOrganizacion, adapt);
    ...
    public void eliminarMinimis(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (id == null || id.equals("")) {
                ...
                numExp = request.getParameter("numExp");
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                int result = MeLanbide17Manager.getInstance().eliminarMinimis(id, adapt);
                if (result <= 0) {
                    codigoOperacion = "6";
                } else {
                    codigoOperacion = "0";
                    try {
                        lista = MeLanbide17Manager.getInstance().getDatosMinimis(numExp, codOrganizacion, adapt);
                        if (!lista.isEmpty()) {
                            for (FilaMinimisVO lm : lista) {
                                lm.setDesEstado(getDescripcionDesplegable(request, lm.getDesEstado()));
                            }
        ...
        try {
            if (!descripcion.isEmpty()) {
                ...
                if (descripcionDobleIdioma != null && descripcionDobleIdioma.length > 1) {
                    if (getIdioma(request) == ConstantesMeLanbide17.CODIGO_IDIOMA_EUSKERA) {
    ...
    private int getIdioma(HttpServletRequest request) {
        ...
        int idioma = ConstantesMeLanbide17.CODIGO_IDIOMA_CASTELLANO;  // Por Defecto 1 Castellano
        try {
            ...
            idioma = ConstantesMeLanbide17.CODIGO_IDIOMA_CASTELLANO;
        }
        return idioma;
    }
    ...
    private void cargarDesplegablesSubvencion(int codOrganizacion, HttpServletRequest request) throws SQLException, Exception {
        List<DesplegableAdmonLocalVO> listaEstado = MeLanbide17Manager.getInstance().getValoresDesplegablesAdmonLocalxdes_cod(ConfigurationParameter.getParameter(ConstantesMeLanbide17.COD_DES_DTSV, ConstantesMeLanbide17.FICHERO_PROPIEDADES), this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
