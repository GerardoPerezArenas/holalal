 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide73.util;
...
public class ConfigurationParameter {
    ...
    /**
     * Metodo que recupera la propiedad que le indicamos como parametro. Ademas le enviamos el nombre del fichero de propoiedades.
     * 
     * @param property
