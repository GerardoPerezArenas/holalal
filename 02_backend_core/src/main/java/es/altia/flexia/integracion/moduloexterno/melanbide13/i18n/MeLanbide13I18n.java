 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide13.i18n;
...
public class MeLanbide13I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE13");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide13I18n instance = null; 

    
    public static MeLanbide13I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide13I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide13I18n();
                }
            }
        }
        return instance;
