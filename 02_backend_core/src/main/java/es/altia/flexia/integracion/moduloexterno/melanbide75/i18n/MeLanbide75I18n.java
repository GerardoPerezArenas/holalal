 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide75.i18n;
...
public class MeLanbide75I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE75");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide75I18n instance = null; 

    
    public static MeLanbide75I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide75I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide75I18n();
                }
            }
        }
        return instance;
