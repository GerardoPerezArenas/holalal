...
public class ColecEntidadCertCalidad {
    ...
    public ColecEntidadCertCalidad(Integer id, String numExp, Integer idEntidad, String idCertificado, Integer valorSNSolicitud, Integer valorSNValidado) {
        this.id = id;
        this.numExp = numExp;
    ...
    public ColecEntidadCertCalidad() {
    }
    ...
    public String toString() {
        return "ColecEntidadCertCalidad{" +
                "id=" + id +
                ", numExp='" + numExp + '\'' +
                ", idEntidad=" + idEntidad +
