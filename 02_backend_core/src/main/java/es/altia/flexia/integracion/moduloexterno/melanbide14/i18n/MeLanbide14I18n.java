 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide14.i18n;
...
public class MeLanbide14I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE14");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide14I18n instance = null; 

    
    public static MeLanbide14I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide14I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide14I18n();
                }
            }
        }
        return instance;
