...
package es.altia.flexia.integracion.moduloexterno.melanbide41.i18n;
 ...
 * @author davidg
 */
public class MeLanbide41I18n {
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide41.FICHERO_PROPIEDADES);
    private static MeLanbide41I18n instance = null;
    ...
    public static MeLanbide41I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide41I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide41I18n();
                }
            }
        }
        return instance;
