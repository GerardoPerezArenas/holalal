 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide40.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide40I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide40.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide40I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide40I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide40I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide40I18n();
                }
            }
        }
        return instance;
