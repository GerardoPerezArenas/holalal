...
public class MeLanbide71Util {
    ...
    */
    public static String doubleToFormattedString(Double num) {
        ...
        */
        ...
        NumberFormat formatter = new DecimalFormat(ConstantesMeLanbide71.getFORMATO_DECIMAL(), otherSymbols);
    ...
    */
    ...
    public static String dateToFormattedString(Date date) {
        SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide71.getFORMATO_FECHA());
        if (date != null) {
