 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide68.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide68.util.ConstantesMeLanbide68;
 ...
 * @author santiagoc
 */
public class MeLanbide68I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE68");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide68I18n instance = null; 

    
    public static MeLanbide68I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide68I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide68I18n();
                }
            }
        }
        return instance;
