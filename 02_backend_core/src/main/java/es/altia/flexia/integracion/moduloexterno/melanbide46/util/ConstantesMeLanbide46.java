 ...
 * @author santiagoc
 */
public class ConstantesMeLanbide46 
{
    //C√≥digo del procedimiento
    public static final String COD_PROCEDIMIENTO = "CME";
    
    //Fichero de propiedades del m√≥dulo.
    public static final String FICHERO_PROPIEDADES = "MELANBIDE46";
    ...
    public static final String TABLA_CME_PUESTO = "TABLA_CME_PUESTO";
    public static final String TABLA_CME_OFERTA = "TABLA_CME_OFERTA";
    public static final String TABLA_CME_JUSTIFICACION = "TABLA_CME_JUSTIFICACION";
    ...
    public static final String TABLA_CME_HIST_PUESTO = "TABLA_CME_HIST_PUESTO";
    public static final String TABLA_CME_HIST_OFERTA = "TABLA_CME_HIST_OFERTA";
    public static final String TABLA_CME_HIST_JUSTIFICACION = "TABLA_CME_HIST_JUSTIFICACION";
    public static final String TABLA_GEN_TITULACIONES = "TABLA_GEN_TITULACIONES";
    public static final String TABLA_GEN_NIVELES_FORMATIVOS = "TABLA_GEN_NIVELES_FORMATIVOS";
    
    //Nombres de las secuencias en el fichero de propiedades.  
    public static final String SEQ_CME_OFERTA = "SEQ_CME_OFERTA";
    ...
    public static final String CAMPO_SUPL_GRUPO_COTIZACION = "CAMPO_SUPL_GRUPO_COTIZACION";
    ...
    public static final double MAX_CONCE_PERMITIDO = 200000.0;
    
    //Rango fechas listados
    public static final String RANGO_EDAD_35="35-44 A—OS";
    public static final String RANGO_EDAD_45="MAYOR DE 45 A—OS";
}
