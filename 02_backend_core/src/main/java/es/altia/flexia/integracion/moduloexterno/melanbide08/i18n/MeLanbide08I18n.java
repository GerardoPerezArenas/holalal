...
package es.altia.flexia.integracion.moduloexterno.melanbide08.i18n;
 ...
 * @author davidg
 */
public class MeLanbide08I18n {
    
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide08.FICHERO_PROPIEDADES);
    private static MeLanbide08I18n instance = null;
    ...
    public static MeLanbide08I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide08I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide08I18n();
                }
            }
        }
        return instance;
