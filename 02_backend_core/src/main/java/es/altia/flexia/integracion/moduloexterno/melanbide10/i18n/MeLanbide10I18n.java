 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide10.i18n;
...
public class MeLanbide10I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE10");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide10I18n instance = null; 

    
    public static MeLanbide10I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide10I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide10I18n();
                }
            }
        }
        return instance;
