 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide58.i18n;
 ...
 * @author davidg
 */
public class MeLanbide58I18n {
    
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide58.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide58I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide58I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide58I18n.class){
                if(instance == null){
                    instance = new MeLanbide58I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide58I18n.class)
        }//if(instance == null)
        return instance;
