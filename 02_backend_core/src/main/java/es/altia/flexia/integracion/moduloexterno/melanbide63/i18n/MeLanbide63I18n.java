 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide63.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide63I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide63.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide63I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide63I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide63I18n.class){
                if(instance == null){
                    instance = new MeLanbide63I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide48I18n.class)
        }//if(instance == null)
        return instance;
    }//getInstance
