 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide76.i18n;
...
public class MeLanbide76I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE76");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide76I18n instance = null; 

    
    public static MeLanbide76I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide76I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide76I18n();
                }
            }
        }
        return instance;
