 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide39.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide39I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide39.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide39I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide39I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide39I18n.class){
                if(instance == null){
                    instance = new MeLanbide39I18n();
                }//if(instance == null)
