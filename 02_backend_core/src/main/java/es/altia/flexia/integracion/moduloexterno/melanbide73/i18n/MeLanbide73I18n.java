 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide73.i18n;
 ...
 * @author Kepa
 */
public class MeLanbide73I18n {

    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide73.FICHERO_PROPIEDADES);
    private static HashMap<Integer, ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();

    private static MeLanbide73I18n instance = null;

    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";

    public static MeLanbide73I18n getInstance() {
        if (instance == null) {
            synchronized (MeLanbide73I18n.class) {
                if (instance == null) {
                    instance = new MeLanbide73I18n();
                }// if (instance == null)
            }//synchronized
        }// if (instance == null)
        return instance;
