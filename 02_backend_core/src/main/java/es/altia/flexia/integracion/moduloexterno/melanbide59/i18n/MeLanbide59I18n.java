 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide59.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide59I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide59.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide59I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide59I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide59I18n.class){
                if(instance == null){
                    instance = new MeLanbide59I18n();
                }//if(instance == null)
