 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide52.i18n;
 ...
 * @author oscar
 */
public class MeLanbide52I18n {
    
     private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE52");
    private static MeLanbide52I18n instance = null;
    ...
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
     ...
     /**
     * Constructor privado
     * Recupera los ficheros de propiedades del moduloo y los carga para que solo se lean una vez.
     */
    private MeLanbide52I18n()
    {
    ...
    public static MeLanbide52I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide52I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide52I18n();
                }
            }
        }
        return instance;
