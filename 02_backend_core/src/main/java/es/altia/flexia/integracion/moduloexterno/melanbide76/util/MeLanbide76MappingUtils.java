...
package es.altia.flexia.integracion.moduloexterno.melanbide76.util;
...
public class MeLanbide76MappingUtils {

    private static MeLanbide76MappingUtils instance = null;

    private MeLanbide76MappingUtils() {
    }

    public static MeLanbide76MappingUtils getInstance() {
        if (instance == null) {
            synchronized (MeLanbide76MappingUtils.class) {
                instance = new MeLanbide76MappingUtils();
            }
        }
        return instance;
    }
    ...
    private Object mapearContratacionVO(ResultSet rs) throws SQLException {
        ...
        contratacion.setMayor45(rs.getString("MAY45CONT"));
