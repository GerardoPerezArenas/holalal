...
public class EjecutaImpresionOf implements Runnable{
    /**
    ...
    public void start( String result, String expP, int codOrg, String subreportNa,  
        ...
        comprobAdecAutThread = new Thread(this, "EjecutaImpresionOf");
        resultado = result; 
        expParam = expP;
    ...
    public void run() {
        ...
        try
        {
            ...
            if(resultado.equals(ConstantesMeLanbide03.OPERACION_CORRECTA))
            {
                ...
                int res = 0;
                m_Log.debug("Resultado antes de avanzarTramite: "+res);
                ...
                m_Log.debug("Resultado despues de avanzarTramite: "+res);
            }
