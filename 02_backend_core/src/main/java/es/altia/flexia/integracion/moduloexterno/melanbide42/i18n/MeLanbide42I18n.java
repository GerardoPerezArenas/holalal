 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide42.i18n;
 ...
 * @author davidg
 */
public class MeLanbide42I18n {
    
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide42.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide42I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide42I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide42I18n.class){
                if(instance == null){
                    instance = new MeLanbide42I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide58I18n.class)
        }//if(instance == null)
        return instance;
    }//getInstance
