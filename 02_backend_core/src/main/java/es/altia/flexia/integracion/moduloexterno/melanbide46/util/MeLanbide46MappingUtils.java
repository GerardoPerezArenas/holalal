 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide46.util;
 ...
 * @author santiagoc
 */
public class MeLanbide46MappingUtils 
{
    private static MeLanbide46MappingUtils instance = null;
    private static Logger log = LogManager.getLogger(MeLanbide46DAO.class);
    
    private MeLanbide46MappingUtils()
    {
        
    }
    
    public static MeLanbide46MappingUtils getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide46MappingUtils.class)
            {
                instance = new MeLanbide46MappingUtils();
            }
        }
        return instance;
    }
    ...
    private CmePuestoVO mapearCmePuestoVO(ResultSet rs) throws Exception
    {
        ...
        puesto.setCosteCont(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_COSTE_CONT"), 2));
        puesto.setDescPuesto(rs.getString("CME_PTO_DESC_PUESTO"));
        puesto.setDietasConv(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_DIETAS_CONV"), 2));
        ...
        puesto.setImpMaxSuv(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_IMP_MAX_SUBV"), 2));
        ...
        puesto.setSalBruto(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SAL_BRUTO"), 2));
        puesto.setSalarioAnex1(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SALARIO_ANEX1"), 2));
        puesto.setSalarioAnex2(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SALARIO_ANEX2"), 2));
        puesto.setSalarioAnex3(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SALARIO_ANEX3"), 2));
        puesto.setTramSeguros(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_TRAM_SEGUROS"), 2));
        ...
        puesto.setSalSolic(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SAL_SOLIC"), 2));
        puesto.setDietasSolic(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_DIETAS_SOLIC"), 2));
        puesto.setTramSolic(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_TRAM_SOLIC"), 2));
        puesto.setImpTotSolic(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_IMP_TOT_SOLIC"), 2));
        puesto.setSalarioAnexTot(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_PTO_SALARIO_ANEX_TOT"), 2));
    ...
    private FilaPuestoVO mapearFilaPuestoVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSubvAprob(rs.getBigDecimal("SUBV_APROB") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_APROB"), 2).replaceAll("\\.", ",") : "-");
        fila.setSubvSolic(rs.getBigDecimal("SUBV_SOLIC") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_SOLIC"), 2).replaceAll("\\.", ",") : "-");
        return fila;
    }
    ...
    private CmeOfertaVO mapearCmeOfertaVO(ResultSet rs) throws Exception
    {
        ...
        oferta.setDietasConvoc(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_OFE_DIETAS_CONVOC"), 2));
        oferta.setDietasConvenio(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_OFE_DIETAS_CONVENIO"), 2));
        ...
        oferta.setSalarioB(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_OFE_SALARIOB"), 2));
    ...
    private FilaOfertaVO mapearFilaOfertaVO(ResultSet rs) throws Exception
    {
        ...
        if (contratacionPresOferta!=null && !contratacionPresOferta.equals(ConstantesMeLanbide46.FALSO)){        
            ...
            else
            {
                ...
                fila.setCausaBaja(causaRen != null && !causaRen.equals("") ? "RENUNCIA("+causaRen.toUpperCase()+")" : (contratacion != null && contratacion.equals(ConstantesMeLanbide46.FALSO) ? "RENUNCIA" : "-"));
            }
        }else { //NO HAY OFERTA --causa renuncia(motivo)
            String causaRen = rs.getString("CAUSA_RENUNCIA");
            fila.setCausaBaja(causaRen != null && !causaRen.equals("") ? "RENUNCIA NO OFERTA("+causaRen.toUpperCase()+")" : (contratacionPresOferta != null && contratacionPresOferta.equals(ConstantesMeLanbide46.FALSO) ? "RENUNCIA NO OFERTA" : "-"));
        }
    ...
    private CmeJustificacionVO mapearCmeJustificacionVO(ResultSet rs) throws Exception
    {
        ...
        justif.setSalarioSub(rs.getBigDecimal("CME_JUS_SALARIOSUB"));//!= null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_SUB"), 2).replaceAll("\\.", ",") : "-");
        ...
        justif.setImpJustificado(MeLanbide46Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CME_JUS_IMP_JUSTIFICADO"), 2));
        return justif;
    }
    ...
    private FilaJustificacionVO mapearFilaJustificacionVO(ResultSet rs) throws Exception
    {
        ...
        fila.setImpJustif(rs.getBigDecimal("IMP_JUSTIF") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("IMP_JUSTIF"), 2).replaceAll("\\.", ",") : "-");
        fila.setSalarioSub(rs.getBigDecimal("SALARIO_SUB")!= null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_SUB"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasJusti(rs.getBigDecimal("DIETAS_JUSTI")!= null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_JUSTI"), 2).replaceAll("\\.", ",") : "-");
        fila.setGastosGestion(rs.getBigDecimal("GASTOS_GESION")!= null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("GASTOS_GESION"), 2).replaceAll("\\.", ",") : "-");
        fila.setBonif(rs.getBigDecimal("BONIF")!= null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("BONIF"), 2).replaceAll("\\.", ",") : "-");
        fila.setImpSolic(rs.getBigDecimal("IMP_SOLIC") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("IMP_SOLIC"), 2).replaceAll("\\.", ",") : "-");
    ...
    private FilaInformeResumenEconomicoVO mapearFilaInformeResumenEconomicoVO(ResultSet rs) throws Exception
    {
        ...
        fila.setNumRenuncias(rs.getInt("PUESTOS_REN_ANT_1PAGO"));
        ...
        fila.setGastosSeguroPto(rs.getBigDecimal("CME_PTO_GASTOS_SEG"));
        fila.setGastosVisadoPto(rs.getBigDecimal("CME_PTO_GASTOS_VIS"));
        fila.setGastosSeguroSub(rs.getBigDecimal("CME_JUS_GASTOS_SEG"));
        fila.setGastosVisadoSub(rs.getBigDecimal("CME_JUS_GASTOS_VIS"));
        fila.setGastosSeguroSol(rs.getBigDecimal("CME_PTO_GASTOS_SOL_SEG"));
        fila.setGastosVisadoSol(rs.getBigDecimal("CME_PTO_GASTOS_SOL_VIS"));
        fila.setGastosSeguroCon(rs.getBigDecimal("CME_PTO_GASTOS_CON_SEG"));
        fila.setGastosVisadoCon(rs.getBigDecimal("CME_PTO_GASTOS_CON_VIS"));
        return fila;
    }
    ...
    {       
        ...
        /*fila.setCodigoInterno(rs.getString("DES_VAL_COD"));
        fila.setCodigoVisible("-");
        fila.setDescripcion("-");
        
        String descCompleta = rs.getString("DES_NOM");
        String codigoVisible = "-";
        String descripcion = "-";
        String[] partes = null;
        
        if(descCompleta != null && !descCompleta.equals(""))
        {
            if(descCompleta.contains("-"))
            {
                partes = descCompleta.split("-");
                if(partes != null && partes.length >= 2)
                {
                    codigoVisible = partes[0];
                    descripcion = partes[1];
                    
                    fila.setCodigoVisible(codigoVisible);
    ...
    private FilaResumenVO mapearFilaResumenVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSalarioAnexo(rs.getBigDecimal("SALARIO_ANEXO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_ANEXO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setMinoracion(rs.getBigDecimal("MINORACION") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("MINORACION"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setCoeficienteTGSS(rs.getBigDecimal("COEFICIENTE_TGSS") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_TGSS"), 2).replaceAll("\\.", ",") : "-");
        fila.setSsEmpresa(rs.getBigDecimal("SS_EMPRESA") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SS_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setBcAT(rs.getBigDecimal("BC_AT") != null ? rs.getBigDecimal("BC_AT").toString().replaceAll("\\.", ",") : "-");
        fila.setCoeficienteFogasa(rs.getBigDecimal("COEFICIENTE_FOGASA") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_FOGASA"), 2).replaceAll("\\.", ",") : "-");
        fila.setCoefiecienteAT(rs.getBigDecimal("COEFICIENTE_AT") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_AT"), 2).replaceAll("\\.", ",") : "-");
        fila.setFogasaATEmpresa(rs.getBigDecimal("FOGASA_AT_EMPRESA") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("FOGASA_AT_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setPorcEPSV(rs.getBigDecimal("PORC_EPSV") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("PORC_EPSV"), 2).replaceAll("\\.", ",") : "0");
        fila.setAportEPSV(rs.getBigDecimal("APORTACIONES_EPSV_EMPRESA") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("APORTACIONES_EPSV_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setTotalEmpresa(rs.getBigDecimal("TOTAL_EMPRESA") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("TOTAL_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setTotalPeriodo(rs.getBigDecimal("TOTAL_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("TOTAL_PERIODO"), 2).replaceAll("\\.", ",") : "-");

        //------------------MAXIMOS SUBVENCIONABLES ----------        
        fila.setSubvMinorada(rs.getBigDecimal("SUBV_MINORADA_SALAR_SSOCIAL") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_MINORADA_SALAR_SSOCIAL"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setCostePeriodoSubv(rs.getBigDecimal("SALARIO_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setDietasPeriodoSubv(rs.getBigDecimal("DIETAS_ABONADAS_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_ABONADAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasConcedidas(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setMaximoDietas(rs.getBigDecimal("MAX_SUB_DIETAS") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("MAX_SUB_DIETAS"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setVisadoAbonado(rs.getBigDecimal("VIS_SEG_ABONADO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_ABONADO"), 2).replaceAll("\\.", ",") : "-");
        fila.setVisadoConcedido(rs.getBigDecimal("VIS_SEG_CONCEDIDO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_CONCEDIDO"), 2).replaceAll("\\.", ",") : "-");
        fila.setVisadoSubv(rs.getBigDecimal("VIS_SEG_SUBV") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_SUBV"), 2).replaceAll("\\.", ",") : "-");
        fila.setContratoBonif(rs.getBigDecimal("BONIFICACIONES") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("BONIFICACIONES"), 2).replaceAll("\\.", ",") : "-");
    ...
    private FilaInformeDatosPuestosVO mapearFilaInformeDatosPuestosVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSalarioAnualBruto(rs.getBigDecimal("SALARIO_ANEXO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_ANEXO"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasAloj(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setMaxSubvencion(rs.getBigDecimal("SALARIO_PERIODO") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setContratoBonif(rs.getBigDecimal("BONIFICACIONES") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("BONIFICACIONES"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasMaxSubv(rs.getBigDecimal("MAX_SUB_DIETAS") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("MAX_SUB_DIETAS"), 2).replaceAll("\\.", ",") : "-");
        fila.setSeguroMedico(rs.getBigDecimal("VIS_SEG_SUBV") != null ? MeLanbide46Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_SUBV"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setGastosVisadoSub(rs.getBigDecimal("CME_JUS_GASTOS_VIS"));
            ...
            log.error("Error en mapearFilaInformeDatosPuestosVO", ex);
        }
