 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide32.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide32I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide32.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide32I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide32I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide32I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide32I18n();
                }
            }
        }
        return instance;
