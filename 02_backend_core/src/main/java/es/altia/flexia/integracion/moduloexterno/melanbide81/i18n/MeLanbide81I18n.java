...
package es.altia.flexia.integracion.moduloexterno.melanbide81.i18n;

import java.util.HashMap;
import java.util.ResourceBundle;


public class MeLanbide81I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE81");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide81I18n instance = null; 

    
    public static MeLanbide81I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide81I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide81I18n();
                }
            }
        }
        return instance;
