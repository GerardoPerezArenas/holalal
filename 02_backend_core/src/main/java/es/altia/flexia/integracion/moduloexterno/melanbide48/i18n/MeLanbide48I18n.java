 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide48.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide48I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide48.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide48I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide48I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide48I18n.class){
                if(instance == null){
                    instance = new MeLanbide48I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide48I18n.class)
        }//if(instance == null)
        return instance;
