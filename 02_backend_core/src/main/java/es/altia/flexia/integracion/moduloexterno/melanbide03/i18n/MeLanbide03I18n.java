package es.altia.flexia.integracion.moduloexterno.melanbide03.i18n;
 ...
 * </ol> 
 */
public class MeLanbide03I18n {
   
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide03.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide03I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide03I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide03I18n.class){
                if(instance == null){
                    instance = new MeLanbide03I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide03I18n.class)
        }//if(instance == null)
        return instance;
