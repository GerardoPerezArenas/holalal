...
public class MeLanbideConvocatorias {
     ...
     *  ID	NUMBER
        ...
        COD_SERVICIO_CATGV	VARCHAR2(15 BYTE)
        COD_SERVICIO_LANB	VARCHAR2(15 BYTE)
     */
    private Integer id;
    ...
    private String codServicioLanbide;
    ...
    public String getCodServicioLanbide() {
        return codServicioLanbide;
    }

    public void setCodServicioLanbide(String codServicioLanbide) {
        this.codServicioLanbide = codServicioLanbide;
    }

    @Override
    public String toString() {
        return "MeLanbideConvocatoria{" + "id=" + id + ", proCod=" + proCod + ", proCodPlatea=" + proCodPlatea + ", numBOPV=" + numBOPV + ", fecConsLanbide=" + (fecConsLanbide!=null?formatFechaddMMyyyy.format(fecConsLanbide):"") + ", decretoCodigo=" + decretoCodigo + ", decretoDesripcion=" + decretoDesripcion + ", decretoDesripcionEu=" + decretoDesripcionEu + ", decretoFecPublicacion=" + (decretoFecPublicacion!=null?formatFechaddMMyyyy.format(decretoFecPublicacion):"") + ", decretoFecEntradaVigor=" + (decretoFecEntradaVigor!=null?formatFechaddMMyyyy.format(decretoFecEntradaVigor):"") + ", decretoFecFinAplicacion=" + (decretoFecFinAplicacion!=null?formatFechaddMMyyyy.format(decretoFecFinAplicacion):"") + ", codServicioCatGV=" + codServicioCatGV + ", codServicioLanbide=" + codServicioLanbide + '}';
    }
