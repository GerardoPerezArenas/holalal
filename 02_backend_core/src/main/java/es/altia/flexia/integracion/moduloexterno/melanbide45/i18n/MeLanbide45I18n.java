...
package es.altia.flexia.integracion.moduloexterno.melanbide45.i18n;
 ...
 * @author davidg
 */
public class MeLanbide45I18n {
    
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide45.FICHERO_PROPIEDADES);
    private static MeLanbide45I18n instance = null;
    ...
    public static MeLanbide45I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide45I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide45I18n();
                }
            }
        }
        return instance;
