 ...
 * @author Laura
 */
public class FilaSegPreparadoresVO 
{
   ...
   // private String persContacto;    
    ...
    public static int POS_CAMPO_FECHA_SEGUIMIENTO = -1;
    public static int POS_CAMPO_FECHA_NACIMIENTO = 3;
    public static int POS_CAMPO_SEXO = 4;
    public static int POS_CAMPO_TIPODISCAPACIDAD = 5;
    public static int POS_CAMPO_GRAVEDAD = 6;
    public static int POS_CAMPO_TIPOCONTRATO = 7;
    public static int POS_CAMPO_PORCJORN = 8;    
    public static int POS_CAMPO_FECHA_INICIO = 9;
    public static int POS_CAMPO_FECHA_FIN = 10;    
    public static int POS_CAMPO_NIF_PREPARADOR = 11;
    public static int POS_CAMPO_EMPRESA = 12;        
   // public static int POS_CAMPO_CONTACTO =13;
    public static int POS_CAMPO_HORAS_ANUALES = 13;
    public static int POS_CAMPO_OBSERVACIONES =14;
