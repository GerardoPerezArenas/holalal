 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide47.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide47I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide47.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide47I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide47I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide47I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide47I18n();
                }
            }
        }
        return instance;
