 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide72.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide72I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE72");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide72I18n instance = null; 

    
    public static MeLanbide72I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide72I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide72I18n();
                }
            }
        }
        return instance;
