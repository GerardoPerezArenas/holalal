package es.altia.flexia.integracion.moduloexterno.melanbide64.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide64.util.ConstantesMeLanbide64;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide64I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide64.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide64I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide64I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide64I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide64I18n();
                }
            }
        }
        return instance;
