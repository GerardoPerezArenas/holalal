 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide89.i18n;
...
public class MeLanbide89I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE89");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide89I18n instance = null; 

    
    public static MeLanbide89I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide89I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide89I18n();
                }
            }
        }
        return instance;
