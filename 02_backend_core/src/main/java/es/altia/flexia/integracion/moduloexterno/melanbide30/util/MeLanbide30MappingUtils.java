 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide30.util;
 ...
 * @author santiagoc
 */
public class MeLanbide30MappingUtils 
{
    private static MeLanbide30MappingUtils instance = null;
    
    private MeLanbide30MappingUtils()
    {
        
    }
    
    public static MeLanbide30MappingUtils getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide30MappingUtils.class)
            {
                instance = new MeLanbide30MappingUtils();
            }
        }
        return instance;
    }
    ...
    {
        if(clazz == FilaContratoSociosVO.class)
        {
            return mapearFilaContratoSociosVO(rs);
        }
        else if(clazz == ContratoSociosVO.class)
        {
            return mapearContratoSociosVO(rs);
        }
    ...
    private FilaContratoSociosVO mapearFilaContratoSociosVO(ResultSet rs) throws Exception
    {
        FilaContratoSociosVO fila = new FilaContratoSociosVO();
    ...
    private ContratoSociosVO mapearContratoSociosVO(ResultSet rs) throws Exception
    {
        ...
        if(inm != null)
        {
            ...
            {
                contrato.setInm(ConstantesMeLanbide30.SI);
            }
            else
            {
                contrato.setInm(ConstantesMeLanbide30.NO);
            }
        }
        else
        {
        ...
        if(min != null)
        {
            ...
            {
                contrato.setMin(ConstantesMeLanbide30.SI);
            }
            else
            {
                contrato.setMin(ConstantesMeLanbide30.NO);
            }
        }
        else
        {
        ...
        if(otr != null)
        {
            ...
            {
                contrato.setOtr(ConstantesMeLanbide30.SI);
            }
            else
            {
                contrato.setOtr(ConstantesMeLanbide30.NO);
            }
        }
        else
        {
        ...
        if(pld != null)
        {
            ...
            {
                contrato.setPld(ConstantesMeLanbide30.SI);
            }
            else
            {
                contrato.setPld(ConstantesMeLanbide30.NO);
            }
        }
        else
        {
        ...
        if(rml != null)
        {
            ...
            {
                contrato.setRml(ConstantesMeLanbide30.SI);
            }
            else
            {
                contrato.setRml(ConstantesMeLanbide30.NO);
            }
        }
        else
        {
