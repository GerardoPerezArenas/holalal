 ...
 */
package es.altia.flexia.integracion.moduloexterno.lanbide01.i18n;
 ...
 * @author santiagoc 
 */
public class MeLanbide01I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(MeLanbide01Constantes.FICHERO_CONFIGURACION);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide01I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide01I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide01I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide01I18n();
                }
            }
        }
        return instance;
