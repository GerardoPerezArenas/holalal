 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide54.i18n;

//import es.altia.flexia.integracion.moduloexterno.melanbide54.util.ConstantesMeLanbide39;
 ...
 * @author santiagoc
 */
public class MeLanbide54I18n 
{
   private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
   private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide54.FICHERO_PROPIEDADES);
    
    
    private static MeLanbide54I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide54I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide54I18n.class){
                if(instance == null){
                    instance = new MeLanbide54I18n();
                }//if(instance == null)
