 ...
 */
package es.altia.flexia.integracion.moduloexterno.meikus.i18n;
 ...
 * @author santiagoc
 */
public class MeIkus01I18n
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(MeIkus01Constantes.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeIkus01I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeIkus01I18n getInstance(){
        if(instance == null){
            synchronized(MeIkus01I18n.class){
                if(instance == null){
                    instance = new MeIkus01I18n();
                }//if(instance == null)
