package es.altia.flexia.integracion.moduloexterno.melanbide61.i18n;
 ...
 * </ol> 
 */
public class MeLanbide61I18n {
   
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide61.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide61I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide61I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide61I18n.class){
                if(instance == null){
                    instance = new MeLanbide61I18n();
                }//if(instance == null)
