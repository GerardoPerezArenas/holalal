...
@XmlRootElement(name = "IWACALAS")
public class IWACALAS {

    @XmlElement(name = "AREA-COMUNICACION", required = true)
    protected IWACALAS.AREACOMUNICACION areacomunicacion;
     ...
     * @return
     *     possible object is
     *     {@link IWACALAS.AREACOMUNICACION }
     *     
     */
    public IWACALAS.AREACOMUNICACION getAREACOMUNICACION() {
     ...
     *     
     */
    public void setAREACOMUNICACION(IWACALAS.AREACOMUNICACION value) {
    ...
    public static class AREACOMUNICACION {
        ...
        protected IWACALAS.AREACOMUNICACION.ADCAREACONTROL adcareacontrol;
        @XmlElement(name = "ADE-DATOS-ENTRADA", required = true)
        protected IWACALAS.AREACOMUNICACION.ADEDATOSENTRADA adedatosentrada;
        @XmlElement(name = "ADS-DATOS-SALIDA", required = true)
        protected IWACALAS.AREACOMUNICACION.ADSDATOSSALIDA adsdatossalida;
         ...
         * @return
         *     possible object is
         *     {@link IWACALAS.AREACOMUNICACION.ADCAREACONTROL }
         *     
         */
        public IWACALAS.AREACOMUNICACION.ADCAREACONTROL getADCAREACONTROL() {
         ...
         *     
         */
        public void setADCAREACONTROL(IWACALAS.AREACOMUNICACION.ADCAREACONTROL value) {
         ...
         * @return
         *     possible object is
         *     {@link IWACALAS.AREACOMUNICACION.ADEDATOSENTRADA }
         *     
         */
        public IWACALAS.AREACOMUNICACION.ADEDATOSENTRADA getADEDATOSENTRADA() {
         ...
         *     
         */
        public void setADEDATOSENTRADA(IWACALAS.AREACOMUNICACION.ADEDATOSENTRADA value) {
         ...
         * @return
         *     possible object is
         *     {@link IWACALAS.AREACOMUNICACION.ADSDATOSSALIDA }
         *     
         */
        public IWACALAS.AREACOMUNICACION.ADSDATOSSALIDA getADSDATOSSALIDA() {
         ...
         *     
         */
        public void setADSDATOSSALIDA(IWACALAS.AREACOMUNICACION.ADSDATOSSALIDA value) {
