...
public class MeLanbide69Util {
    ...
    */
    public static String integerToFormattedString(Integer num)
    {
        ...
        * Los 0 indican que si no hay valor se pondrï¿½ un cero
        */
        ...
        // Resultado: 12.345.678,00 ? (mï¿½s quisiera yo...)
    ...
    */
    public static String doubleToFormattedString(Double num)
    {
        ...
        */
        ...
        NumberFormat formatter = new DecimalFormat(ConstantesMeLanbide69.getFORMATO_DECIMAL(), otherSymbols);
    ...
    */
    ...
    public static String dateToFormattedString(Date date) {
        SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide69.getFORMATO_FECHA());
        if(date!=null) 
    ...
    public static Integer calcularEdad(Date fecInicio, Date fecFin) throws Exception
    {
     ...
     public String getDescripcionDesplegable(HttpServletRequest request, String descripcionCompleta) {
        ...
        String barraIdioma = "\\" + ConstantesMeLanbide69.PIPE;
        try {
            if (!descripcion.isEmpty()) {
                String[] descripcionDobleIdioma = descripcion.split(barraIdioma);
                if (descripcionDobleIdioma != null) {
                    if (getIdioma(request) == ConstantesMeLanbide69.CODIGO_IDIOMA_EUSKERA) {
