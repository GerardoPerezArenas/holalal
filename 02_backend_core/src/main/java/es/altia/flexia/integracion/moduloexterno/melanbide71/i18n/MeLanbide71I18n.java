package es.altia.flexia.integracion.moduloexterno.melanbide71.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide71.util.ConstantesMeLanbide71;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide71I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide71.getFICHERO_PROPIEDADES());
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide71I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide71I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide71I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide71I18n();
                }
            }
        }
        return instance;
