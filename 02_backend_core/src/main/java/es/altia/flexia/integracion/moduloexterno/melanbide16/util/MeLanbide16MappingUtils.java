 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide16.util;
 ...
 * @author santiagoc
 */
public class MeLanbide16MappingUtils {

    private final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    private static MeLanbide16MappingUtils instance = null;

    private MeLanbide16MappingUtils() {

    }

    public static MeLanbide16MappingUtils getInstance() {
        if (instance == null) {
            synchronized (MeLanbide16MappingUtils.class) {
                instance = new MeLanbide16MappingUtils();
            }
        }
        return instance;
    }
