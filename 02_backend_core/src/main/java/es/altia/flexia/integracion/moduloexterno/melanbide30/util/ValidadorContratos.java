...
public class ValidadorContratos 
{
    ...
    public boolean validarContrato(ContratoSociosVO contrato)
    {
    ...
    private boolean validarDatosTrabajador(ContratoSociosVO contrato)
    {
        //Datos obligatorios
    ...
    private boolean validarDatosContrato(ContratoSociosVO contrato)
    {
        //Fecha alta
    ...
    private boolean validarImporteSubvencion(ContratoSociosVO contrato)
    {
        //Concedido
