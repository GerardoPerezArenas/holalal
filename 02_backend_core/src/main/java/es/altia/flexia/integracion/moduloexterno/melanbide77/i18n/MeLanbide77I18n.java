 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide77.i18n;
 ...
 * @author Kepa
 */
public class MeLanbide77I18n {

    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide77.FICHERO_PROPIEDADES);
    private static HashMap<Integer, ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();

    private static MeLanbide77I18n instance = null;

    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";

    public static MeLanbide77I18n getInstance() {
        if (instance == null) {
            synchronized (MeLanbide77I18n.class) {
                if (instance == null) {
                    instance = new MeLanbide77I18n();
                }// if (instance == null)
            }//synchronized
        }// if (instance == null)
        return instance;
