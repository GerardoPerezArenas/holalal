package es.altia.flexia.integracion.moduloexterno.melanbide65.i18n;

import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide65I18n {
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE65");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide65I18n instance = null;
    
    public static MeLanbide65I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide65I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide65I18n();
                }
            }
        }
        return instance;
