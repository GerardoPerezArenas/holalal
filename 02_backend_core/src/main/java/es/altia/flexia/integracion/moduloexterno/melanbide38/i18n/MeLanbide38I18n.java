 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide38.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide38I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide38.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide38I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide38I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide38I18n.class){
                if(instance == null){
                    instance = new MeLanbide38I18n();
                }//if(instance == null)
