...
/*
    CONTRATACIÓN: DATOS SELECCIÓN														
                    NOFECONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Nº de oferta de Tipo1(excluyente): Selección mediante oferta (art. 6.1.a)	VARCHAR	10							
                    IDCONT1	MELANBIDE76_CONTRATACION	MELANBIDE76	Id. Contrato de Tipo1(excluyente): Selección mediante oferta (art. 6.1.a)	VARCHAR	10							
                    IDCONT2	MELANBIDE76_CONTRATACION	MELANBIDE76	Identificación de Contrato de Tipo2(excluyente): Selección directa de empresa (art. 6.1.b)	VARCHAR	10							

    CONTRATACIÓN: DATOS DE LA PERSONA CONTRATADA														
                    DNICONT	MELANBIDE76_CONTRATACION	MELANBIDE76	DNI/NIE	VARCHAR	15	OBLIGATORIO						
                    NOMCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Nombre	VARCHAR	100	OBLIGATORIO						
                    APE1CONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Apellido1	VARCHAR	50	OBLIGATORIO						
                    APE2CONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Apellido2	VARCHAR	50	OBLIGATORIO						
                    FECHNACCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Fecha nacimiento	DATE		OBLIGATORIO						
                    EDADCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Edad	NUMBER	2	OBLIGATORIO						
                    SEXOCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Sexo (Desplegable)	VARCHAR	1	OBLIGATORIO	DESPLEGABLE SEXO					Valores posibles: 1: Hombre, 2: Mujer
                    MAY45CONT	MELANBIDE76_CONTRATACION	MELANBIDE76	¿ Mayores de 45 años ? (Desplegable) SI=S, NO=N	VARCHAR	1	OBLIGATORIO	BOOLEANO (S/N)					Valores posibles: S N
                    ACCFORCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	¿ Ha finalizado en 2019 una acción formativa con compromiso de contratación ? )Desplegable SI=S, NO=N	VARCHAR	1	OBLIGATORIO	BOOLEANO (S/N)					Valores posibles: S N

    CONTRATACIÓN: DATOS DEL PUESTO DE TRABAJO														
                    PUESTOCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Nombre del puesto	VARCHAR	100	OBLIGATORIO						
                    OCUCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Nombre de ocupación	VARCHAR	150	OBLIGATORIO						
                    CODOCUCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Código de ocupación (Desplegable Intermediación)	VARCHAR	8	OBLIGATORIO	DESPLEGABLE EXTERNO OCIN					
                    TITULACION	MELANBIDE76_CONTRATACION	MELANBIDE76	Titulación (Desplegable Intermediación)	VARCHAR	12	OBLIGATORIO	DESPLEGABLE EXTERNO TIIN					
                    CPROFESIONALIDAD	MELANBIDE76_CONTRATACION	MELANBIDE76	Cert.Profesionalidad (Desplegable Intermediación)	VARCHAR	10	DESPLEGABLE EXTERNO CPIN
                    MODCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Modalidad de contrato	VARCHAR	100	OBLIGATORIO						
                    JORCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Jornada: Completa ó Parcial(mínimo 70%) (Desplegable)	VARCHAR	4	OBLIGATORIO	DESPLEGABLE JORN					
                    PORCJOR	MELANBIDE76_CONTRATACION	MELANBIDE76	Porcentaje de Jornada Parcial(mínimo 70%) (en caso de Jornada Parcial)	NUMBER	5,2							
                    FECHINICONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Fecha inicio del contrato	DATE		OBLIGATORIO						
                    FECHFINCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Fecha fin del contrato prevista(si procede)	DATE								
                    DURCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Duración del contrato: en meses(excepto indefinido)	VARCHAR	6							
                    GRSS	MELANBIDE76_CONTRATACION	MELANBIDE76	Grupo de cotización de la S.S. (Desplegable del 1 al 10)	VARCHAR	2	OBLIGATORIO	DESPLEGABLE GCOT					
                    DIRCENTRCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Dirección de centro de trabajo de destino	VARCHAR	100	OBLIGATORIO						
                    NSSCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Número de cuenta de cotización de la S.S.	VARCHAR	22	OBLIGATORIO						
                    CSTCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Coste contrato: salario bruto anual, pagas incluidas, excluidos los costes a la S.S.	NUMBER	8,2	OBLIGATORIO						

    CONTRATACIÓN: IMPORTE DE LA SUBVENCIÓN SOLICITADA PARA EL PUESTO														
                    IMPSUBVCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Importe de la Subvención solicitada para el puesto	NUMBER	8,2	OBLIGATORIO						
...
/*
  Se añaden campos convocatoria 2022
    CONTRATACIÓN: DATOS DE LA PERSONA CONTRATADA
        CODFORCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Código de la acción formativa finalizada	VARCHAR	20	NO
        DENFORCONT	MELANBIDE76_CONTRATACION	MELANBIDE76	Denominación de la acción formativa finalizada	VARCHAR	150	NO

    CONTRATACIÓN: DATOS DEL PUESTO DE TRABAJO
        HORASCONV	MELANBIDE76_CONTRATACION	MELANBIDE76	Horas convenio (en caso de Jornada Parcial)	        NUMBER	4	SI
        TIPRSB	        MELANBIDE76_CONTRATACION	MELANBIDE76	Tipo de retribución salarial bruta (coste contrato)	VARCHAR	10	NO	DESPLEGABLE DTRT 'A'(ANUAL), 'M'(MENSUAL)
...
/*
  Se añade nuevo campo DESTITULACION - Titulación solicitud
    CONTRATACIÓN: DATOS DEL PUESTO DE TRABAJO
        DESTITULACION	MELANBIDE76_CONTRATACION	MELANBIDE76	Titulación solicitud	VARCHAR	200	NO
*/
...
public class ContratacionVO {
    ...
    public String getMayor45() {
        return mayor45;
    }

    public void setMayor45(String mayor45) {
