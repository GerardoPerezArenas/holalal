...
public class ConstantesMeLanbide66 {

    //Fichero de propiedades del modulo.
    private static final String FICHERO_PROPIEDADES = "MELANBIDE66";
    ...
    private static final String COD_PROCEDIMIENTO = "APEC";
    ...
    private static final String COD_DESPL_CONCEPTO_DSD2018 = "COD_DESPL_CONCEPTO_DSD2018";
    private static final String COD_DESPL_DESGLOSE_CPTO_DSD2018 = "COD_DESPL_DESGLOSE_CPTO_DSD2018";
    ...
    private static final String CS_FECINIPERIODO = "FECINIPERIODO";
    private static final String CS_FECFINPERIODO = "FECFINPERIODO";
    private static final String CS_FECFINPRESENTACION = "FECFINPRESENTACION";
    private static final String CS_FECALTAIAE = "FECALTAIAE";

    //Motivo de reintegro
    private static final String COD_MOTIVOREINT = "6";
    private static final String VAL_MOTIVOREINT = "JUSTIFICACIÓN < AL PAGO";
    //Motivo de reintegro
    ...
    public static String getPropVal_COD_DESPL_CPTO(String codOrg, String codProc, Integer ejercicio) {
        if (ejercicio != null && ejercicio >= 2018) {
            return getPropVal_COD_DESPL_CPTO_DSD2018(codOrg, codProc);
        } else {
    ...
    public static String getPropVal_COD_DESPL_DESGLOSE_CPTO(String codOrg, String codProc, Integer ejercicio) {
        if (ejercicio != null && ejercicio >= 2018) {
            return getPropVal_COD_DESPL_DESGLOSE_CPTO_DSD2018(codOrg, codProc);
        } else {
            return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/DESPLEGABLES/" + COD_DESPL_DESGLOSE_CPTO);
        }
    }

    // Recuperamos el valor de la propiedad codigo de desplegable para el concepto para despues de  2018
    public static String getPropVal_COD_DESPL_CPTO_DSD2018(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/DESPLEGABLES/" + COD_DESPL_CONCEPTO_DSD2018);
    }

    // Recuperamos el valor de la propiedad codigo de desplegable para el desglose de conceptos despues de 2018
    public static String getPropVal_COD_DESPL_DESGLOSE_CPTO_DSD2018(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/DESPLEGABLES/" + COD_DESPL_DESGLOSE_CPTO_DSD2018);
    }
    ...
    private static final ResourceBundle PROPERTIES = ResourceBundle.getBundle("MELANBIDE66");
    ...
    private static final String NOMBRE_TABLA_SOCIOS = "MELANBIDE66_SOCIOS";
    private static final String NOMBRE_SEQ_SOCIOS = "SEQ_M66_SOCIOS";
    ...
    // Recuperamos el valor de la propiedad codigo de campo suplementario
    public static String getPropVal_CS_FECINIPERIODO(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/CODIGO/" + CS_FECINIPERIODO);
    }

    // Recuperamos el valor de la propiedad codigo de campo suplementario
    public static String getPropVal_CS_FECFINPERIODO(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/CODIGO/" + CS_FECFINPERIODO);
    }

    // Recuperamos el valor de la propiedad codigo de campo suplementario
    public static String getPropVal_CS_FECFINPRESENTACION(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/CODIGO/" + CS_FECFINPRESENTACION);
    }
    ...
    // Recuperamos el valor de la propiedad TIPO de campo suplementario
    public static String getPropVal_CS_FECINIPERIODO_TIPO(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/TIPO/" + CS_FECINIPERIODO);
    }

    // Recuperamos el valor de la propiedad TIPO de campo suplementario
    public static String getPropVal_CS_FECFINPERIODO_TIPO(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/TIPO/" + CS_FECFINPERIODO);
    }

    // Recuperamos el valor de la propiedad TIPO de campo suplementario
    public static String getPropVal_CS_FECFINPRESENTACION_TIPO(String codOrg, String codProc) {
        return getPROPERTIES().getString(codOrg + "/MODULO_INTEGRACION/" + getNOMBRE_MODULO() + "/" + codProc + "/CAMPO_SUP/TIPO/" + CS_FECFINPRESENTACION);
    }
    ...
    //Recuperamos todos los códigos de campos suplementarios
    ...
    private static final String CS_FECRESOLUCION = "CS_FECRESOLUCION";
    private static final String CS_FECPRESENTACION = "CS_FECPRESENTACION";
    private static final String CS_FECNOTIFICACION = "CS_FECNOTIFICACION";
    private static final String TIPOFECHA = "TIPOFECHA";
    ...
    private static final String OCU_TRAMITE_NOTIF = "OCU_TRAMITE_NOTIF";
    private static final String ESTADO_FIRMA = "ESTADO_FIRMA";

    // Recuperamos el valor de la propiedad codigo de campo suplementario
    public static String getPropVal_CS_FECRESOLUCION() {
        return getPROPERTIES().getString(CS_FECRESOLUCION);
    }

    public static String getPropVal_CS_FECPRESENTACION() {
        return getPROPERTIES().getString(CS_FECPRESENTACION);
    }

    public static String getPropVal_CS_FECNOTIFICACION() {
        return getPROPERTIES().getString(CS_FECNOTIFICACION);
    }
 ...
 public static String getPropVal_COD_TRAMITE_ACUSE() {
    ...
    public static String getPropVal_OCU_TRAMITE_NOTIF() {
        return getPROPERTIES().getString(OCU_TRAMITE_NOTIF);
    }
    ...
    // Recuperamos el valor de la propiedad TIPO de campo suplementario
    public static String getPropVal_CS_TIPOFECHA() {
        return getPROPERTIES().getString(TIPOFECHA);
    }
