 ...
 * @author santiagoc
 */
public class MeLanbide39MappingUtils 
{
    private static MeLanbide39MappingUtils instance = null;
    
    private MeLanbide39MappingUtils()
    {
        
    }
    
    public static MeLanbide39MappingUtils getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide39MappingUtils.class)
            {
                instance = new MeLanbide39MappingUtils();
            }
        }
        return instance;
    }
    ...
    private CpePuestoVO mapearCpePuestoVO(ResultSet rs) throws Exception
    {
        ...
        puesto.setCosteCont(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_COSTE_CONT"), 2));
        puesto.setDescPuesto(rs.getString("CPE_PTO_DESC_PUESTO"));
        puesto.setDietasConv(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_DIETAS_CONV"), 2));
        ...
        puesto.setImpMaxSuv(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_IMP_MAX_SUBV"), 2));
        ...
        puesto.setSalBruto(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SAL_BRUTO"), 2));
        puesto.setSalarioAnex1(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SALARIO_ANEX1"), 2));
        puesto.setSalarioAnex2(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SALARIO_ANEX2"), 2));
        puesto.setSalarioAnex3(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SALARIO_ANEX3"), 2));
        puesto.setTramSeguros(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_TRAM_SEGUROS"), 2));
        ...
        puesto.setSalSolic(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SAL_SOLIC"), 2));
        puesto.setDietasSolic(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_DIETAS_SOLIC"), 2));
        puesto.setTramSolic(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_TRAM_SOLIC"), 2));
        puesto.setImpTotSolic(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_IMP_TOT_SOLIC"), 2));
        puesto.setSalarioAnexTot(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_PTO_SALARIO_ANEX_TOT"), 2));
    ...
    private FilaPuestoVO mapearFilaPuestoVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSubvAprob(rs.getBigDecimal("SUBV_APROB") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_APROB"), 2).replaceAll("\\.", ",") : "-");
        fila.setSubvSolic(rs.getBigDecimal("SUBV_SOLIC") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_SOLIC"), 2).replaceAll("\\.", ",") : "-");
        return fila;
    }
    ...
    private CpeOfertaVO mapearCpeOfertaVO(ResultSet rs) throws Exception
    {
        ...
        oferta.setDietasConvoc(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_OFE_DIETAS_CONVOC"), 2));
        oferta.setDietasConvenio(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_OFE_DIETAS_CONVENIO"), 2));
        ...
        oferta.setSalarioB(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_OFE_SALARIOB"), 2));
    ...
    private FilaOfertaVO mapearFilaOfertaVO(ResultSet rs) throws Exception
    {
        ...
        if (contratacionPresOferta!=null && !contratacionPresOferta.equals(ConstantesMeLanbide39.FALSO)){
            ...
            else
            {
                ...
                fila.setCausaBaja(causaRen != null && !causaRen.equals("") ? "RENUNCIA("+causaRen.toUpperCase()+")" : (contratacion != null && contratacion.equals(ConstantesMeLanbide39.FALSO) ? "RENUNCIA" : "-"));
            }
        }else { //NO HAY OFERTA --causa renuncia(motivo)
            String causaRen = rs.getString("CAUSA_RENUNCIA");
            fila.setCausaBaja(causaRen != null && !causaRen.equals("") ? "RENUNCIA NO OFERTA("+causaRen.toUpperCase()+")" : (contratacionPresOferta != null && contratacionPresOferta.equals(ConstantesMeLanbide39.FALSO) ? "RENUNCIA NO OFERTA" : "-"));
        }
    ...
    private CpeJustificacionVO mapearCpeJustificacionVO(ResultSet rs) throws Exception
    {
        ...
        if(rs.getBigDecimal("CPE_JUS_SALARIOSUB")!=null){
            justif.setSalarioSub(rs.getBigDecimal("CPE_JUS_SALARIOSUB"));//!= null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_SUB"), 2).replaceAll("\\.", ",") : "-");
        }
        
        if(rs.getBigDecimal("CPE_JUS_DIETAS")!=null){
            justif.setDietasJusti(rs.getBigDecimal("CPE_JUS_DIETAS"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_GASTOSGES")!=null){
            justif.setGastosGestion(rs.getBigDecimal("CPE_JUS_GASTOSGES"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_BONIF")!=null){
            justif.setBonif(rs.getBigDecimal("CPE_JUS_BONIF"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_MINORACION")!=null){
            justif.setMinoracion(rs.getBigDecimal("CPE_JUS_MINORACION"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_BASCOT_CC")!=null){
            justif.setBaseCC(rs.getBigDecimal("CPE_JUS_BASCOT_CC"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_COEF_TGSS")!=null){
            justif.setCoeficienteApli(rs.getBigDecimal("CPE_JUS_COEF_TGSS"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_FOGASA")!=null){
            justif.setPorcFogasa(rs.getBigDecimal("CPE_JUS_FOGASA"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_AT")!=null){
            justif.setPorcCoeficiente(rs.getBigDecimal("CPE_JUS_AT"));
        }
        
        if(rs.getBigDecimal("CPE_JUS_EPSV")!=null){
        ...
        justif.setImpJustificado(MeLanbide39Utils.redondearDecimalesBigDecimal(rs.getBigDecimal("CPE_JUS_IMP_JUSTIFICADO"), 2));
        return justif;
    }
    ...
    private FilaJustificacionVO mapearFilaJustificacionVO(ResultSet rs) throws Exception
    {
        ...
        fila.setImpJustif(rs.getBigDecimal("IMP_JUSTIF") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("IMP_JUSTIF"), 2).replaceAll("\\.", ",") : "-");
        fila.setSalarioSub(rs.getBigDecimal("SALARIO_SUB")!= null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_SUB"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasJusti(rs.getBigDecimal("DIETAS_JUSTI")!= null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_JUSTI"), 2).replaceAll("\\.", ",") : "-");
        fila.setGastosGestion(rs.getBigDecimal("GASTOS_GESION")!= null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("GASTOS_GESION"), 2).replaceAll("\\.", ",") : "-");
        fila.setBonif(rs.getBigDecimal("BONIF")!= null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("BONIF"), 2).replaceAll("\\.", ",") : "-");
        fila.setImpSolic(rs.getBigDecimal("IMP_SOLIC") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("IMP_SOLIC"), 2).replaceAll("\\.", ",") : "-");
    ...
    private FilaResumenVO mapearFilaResumenVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSalarioAnexo(rs.getBigDecimal("SALARIO_ANEXO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_ANEXO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setMinoracion(rs.getBigDecimal("MINORACION") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("MINORACION"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setCoeficienteTGSS(rs.getBigDecimal("COEFICIENTE_TGSS") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_TGSS"), 2).replaceAll("\\.", ",") : "-");
        fila.setSsEmpresa(rs.getBigDecimal("SS_EMPRESA") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SS_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setBcAT(rs.getBigDecimal("BC_AT") != null ? rs.getBigDecimal("BC_AT").toString().replaceAll("\\.", ",") : "-");
        fila.setCoeficienteFogasa(rs.getBigDecimal("COEFICIENTE_FOGASA") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_FOGASA"), 2).replaceAll("\\.", ",") : "-");
        fila.setCoefiecienteAT(rs.getBigDecimal("COEFICIENTE_AT") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("COEFICIENTE_AT"), 2).replaceAll("\\.", ",") : "-");
        fila.setFogasaATEmpresa(rs.getBigDecimal("FOGASA_AT_EMPRESA") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("FOGASA_AT_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setPorcEPSV(rs.getBigDecimal("PORC_EPSV") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("PORC_EPSV"), 2).replaceAll("\\.", ",") : "-");
        fila.setAportEPSV(rs.getBigDecimal("APORTACIONES_EPSV_EMPRESA") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("APORTACIONES_EPSV_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setTotalEmpresa(rs.getBigDecimal("TOTAL_EMPRESA") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("TOTAL_EMPRESA"), 2).replaceAll("\\.", ",") : "-");
        fila.setTotalPeriodo(rs.getBigDecimal("TOTAL_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("TOTAL_PERIODO"), 2).replaceAll("\\.", ",") : "-");

        //------------------MAXIMOS SUBVENCIONABLES ----------        
        fila.setSubvMinorada(rs.getBigDecimal("SUBV_MINORADA_SALAR_SSOCIAL") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SUBV_MINORADA_SALAR_SSOCIAL"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setCostePeriodoSubv(rs.getBigDecimal("SALARIO_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setDietasPeriodoSubv(rs.getBigDecimal("DIETAS_ABONADAS_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_ABONADAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasConcedidas(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setMaximoDietas(rs.getBigDecimal("MAX_SUB_DIETAS") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("MAX_SUB_DIETAS"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setVisadoAbonado(rs.getBigDecimal("VIS_SEG_ABONADO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_ABONADO"), 2).replaceAll("\\.", ",") : "-");
        fila.setVisadoConcedido(rs.getBigDecimal("VIS_SEG_CONCEDIDO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_CONCEDIDO"), 2).replaceAll("\\.", ",") : "-");
        fila.setVisadoSubv(rs.getBigDecimal("VIS_SEG_SUBV") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_SUBV"), 2).replaceAll("\\.", ",") : "-");
        fila.setContratoBonif(rs.getBigDecimal("BONIFICACIONES") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("BONIFICACIONES"), 2).replaceAll("\\.", ",") : "-");
        ...
        private FilaInformeDatosPuestosVO mapearFilaInformeDatosPuestosVO(ResultSet rs) throws Exception
    {
        ...
        fila.setSalarioAnualBruto(rs.getBigDecimal("SALARIO_ANEXO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_ANEXO"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasAloj(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("DIETAS_CONCEDIDAS_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        ...
        fila.setMaxSubvencion(rs.getBigDecimal("SALARIO_PERIODO") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("SALARIO_PERIODO"), 2).replaceAll("\\.", ",") : "-");
        fila.setContratoBonif(rs.getBigDecimal("BONIFICACIONES") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("BONIFICACIONES"), 2).replaceAll("\\.", ",") : "-");
        fila.setDietasMaxSubv(rs.getBigDecimal("MAX_SUB_DIETAS") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("MAX_SUB_DIETAS"), 2).replaceAll("\\.", ",") : "-");
        fila.setSeguroMedico(rs.getBigDecimal("VIS_SEG_SUBV") != null ? MeLanbide39Utils.redondearDecimalesString(rs.getBigDecimal("VIS_SEG_SUBV"), 2).replaceAll("\\.", ",") : "-");
        
        fila.setGastosSeguroPto(rs.getBigDecimal("CPE_PTO_GASTOS_SEG"));
        fila.setGastosVisadoPto(rs.getBigDecimal("CPE_PTO_GASTOS_VIS"));
        fila.setGastosSeguroSub(rs.getBigDecimal("CPE_JUS_GASTOS_SEG"));
        fila.setGastosVisadoSub(rs.getBigDecimal("CPE_JUS_GASTOS_VIS"));
