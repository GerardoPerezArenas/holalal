 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide82.i18n;
...
public class MeLanbide82I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE82");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide82I18n instance = null; 

    
    public static MeLanbide82I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide82I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide82I18n();
                }
            }
        }
        return instance;
