...
package es.altia.flexia.integracion.moduloexterno.melanbide09.i18n;
 ...
 * @author davidg
 */
public class MeLanbide09I18n {
    
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide09.FICHERO_PROPIEDADES);
    private static MeLanbide09I18n instance = null;
    ...
    public static MeLanbide09I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide09I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide09I18n();
                }
            }
        }
        return instance;
