package es.altia.flexia.integracion.moduloexterno.melanbide69.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide69.util.ConstantesMeLanbide69;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide69I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide69.getFICHERO_PROPIEDADES());
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide69I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide69I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide69I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide69I18n();
                }
            }
        }
        return instance;
