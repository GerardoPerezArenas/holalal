 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide36.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide36I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide36.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide36I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide36I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide36I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide36I18n();
                }
            }
        }
        return instance;
