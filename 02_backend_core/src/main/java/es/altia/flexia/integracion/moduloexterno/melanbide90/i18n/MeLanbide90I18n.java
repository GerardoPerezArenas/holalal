 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide90.i18n;
...
public class MeLanbide90I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE90");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide90I18n instance = null; 

    
    public static MeLanbide90I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide90I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide90I18n();
                }
            }
        }
        return instance;
