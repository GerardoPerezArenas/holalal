 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide67.i18n;
 ...
 * @author santiagoc
 */
public class MeLanbide67I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide67.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide67I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide67I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide67I18n.class){
                if(instance == null){
                    instance = new MeLanbide67I18n();
                }//if(instance == null)
