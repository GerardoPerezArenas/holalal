...
import es.altia.flexia.integracion.moduloexterno.melanbide44.exception.ListaDatosExcelNoValidosException;
 ...
 * @author SantiagoC
 */
public class MeLanbide44MappingUtils {
    private static MeLanbide44MappingUtils instance = null;
    private static Logger log = LogManager.getLogger(MeLanbide44MappingUtils.class);
    
    private MeLanbide44MappingUtils()
    {
        
    }
    
    public static MeLanbide44MappingUtils getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide44MappingUtils.class)
            {
                instance = new MeLanbide44MappingUtils();
            }
        }
        return instance;
    }
    ...
    public Object map(ResultSet rs, Class clazz) throws Exception
    {
        ...
        else if(clazz == EcaSegPreparadores2016VO.class)
        {
        ...
        else if(clazz == EcaVisProspectores2016VO.class)
        {
            return mapearEcaVisProspectoresVO_2016(rs);
        }
    ...
    public Object map(HSSFRow row, Class clazz) throws Exception
    {
        ...
        else if(clazz == EcaInsPreparadores2016VO.class)
        {    
            return mapearEcaInsPreparadoresVO_2016(row);
        } 
         else if(clazz == EcaVisProspectoresVO.class)
        {
        ...
        {
            return mapearEcaVisProspectoresVO_2016(row);
        } 
        return null;
    }
    ...
    public FilaPreparadorSolicitudVO fromPreparadorVOToFilaPreparadorVO(EcaSolPreparadoresVO prep)
    {
        ...
        fila.setC4m(prep.getInsC4M() != null ? prep.getInsC4M().toPlainString().replaceAll("\\.", ",") : "");
         fila.setC5Total(prep.getInsC5() != null ? prep.getInsC5().toPlainString().replaceAll("\\.", ",") : "");
        fila.setC5h(prep.getInsC5H() != null ? prep.getInsC5H().toPlainString().replaceAll("\\.", ",") : "");
        fila.setC5m(prep.getInsC5M() != null ? prep.getInsC5M().toPlainString().replaceAll("\\.", ",") : "");
         fila.setC6Total(prep.getInsC6() != null ? prep.getInsC6().toPlainString().replaceAll("\\.", ",") : "");
        fila.setC6h(prep.getInsC6H() != null ? prep.getInsC6H().toPlainString().replaceAll("\\.", ",") : "");
        fila.setC6m(prep.getInsC6M() != null ? prep.getInsC6M().toPlainString().replaceAll("\\.", ",") : "");
    ...
    public EcaSolPreparadoresVO fromFilaPreparadorVOToPreparadorVO(FilaPreparadorSolicitudVO fila) throws Exception
    {
        ...
        prep.setInsC4M(fila.getC4m() != null && !fila.getC4m().equals("") && !fila.getC4m().equals("-") ? fromFormateadoToDecimal(fila.getC4m()) : null);
         ...
         prep.setInsC5(fila.getC5Total() != null && !fila.getC5Total().equals("") && !fila.getC5Total().equals("-") ? fromFormateadoToDecimal(fila.getC5Total()) : null);
        prep.setInsC5H(fila.getC5h() != null && !fila.getC5h().equals("") && !fila.getC5h().equals("-") ? fromFormateadoToDecimal(fila.getC5h()) : null);
        prep.setInsC5M(fila.getC5m() != null && !fila.getC5m().equals("") && !fila.getC5m().equals("-") ? fromFormateadoToDecimal(fila.getC5m()) : null);
       
         prep.setInsC6(fila.getC6Total() != null && !fila.getC6Total().equals("") && !fila.getC6Total().equals("-") ? fromFormateadoToDecimal(fila.getC6Total()) : null);
        prep.setInsC6H(fila.getC6h() != null && !fila.getC6h().equals("") && !fila.getC6h().equals("-") ? fromFormateadoToDecimal(fila.getC6h()) : null);
        prep.setInsC6M(fila.getC6m() != null && !fila.getC6m().equals("") && !fila.getC6m().equals("-") ? fromFormateadoToDecimal(fila.getC6m()) : null);
    ...
    private EcaSolicitudVO mapearEcaSolicitudVO(ResultSet rs) throws Exception
    {
        ...
        if(rs.wasNull())
        {
         ...
         sol.setInserC5H(rs.getFloat("ECA_INSER_C5_H"));
        if(rs.wasNull())
        {
            sol.setInserC5H(null);
        }
        sol.setInserC5M(rs.getFloat("ECA_INSER_C5_M"));
        if(rs.wasNull())
        {
            sol.setInserC5M(null);
        }
         sol.setInserC6H(rs.getFloat("ECA_INSER_C6_H"));
        if(rs.wasNull())
        {
            sol.setInserC6H(null);
        }
        sol.setInserC6M(rs.getFloat("ECA_INSER_C6_M"));
        if(rs.wasNull())
        {
            sol.setInserC6M(null);
        }
        ...
        sol.setSubPubCargaManual(rs.getBigDecimal("ECA_SUB_PUB_CARGAM"));
        sol.setSubPrivCargaManual(rs.getBigDecimal("ECA_SUB_PRIV_CARGAM"));
        //CONCEDIDO
        ...
        sol.setSubPubConcedidos(rs.getBigDecimal("ECA_SUB_PUB_CONCEDIDO"));
        sol.setSubPrivConcedidos(rs.getBigDecimal("ECA_SUB_PRIV_CONCEDIDO"));
        return sol;
    }
    ...
    private EcaSolPreparadoresVO mapearEcaSolPreparadoresVO(ResultSet rs) throws Exception
    {
        ...
        prep.setInsC5H(rs.getBigDecimal("ECA_PREP_INS_C5_H"));
        prep.setInsC5M(rs.getBigDecimal("ECA_PREP_INS_C5_M"));
        prep.setInsC5(rs.getBigDecimal("ECA_PREP_INS_C5"));
        prep.setInsC6H(rs.getBigDecimal("ECA_PREP_INS_C6_H"));
        prep.setInsC6M(rs.getBigDecimal("ECA_PREP_INS_C6_M"));
        prep.setInsC6(rs.getBigDecimal("ECA_PREP_INS_C6"));
        ...
        prep.setInsC4_Carga(rs.getBigDecimal("ECA_PREP_INS_C4_CARGA"));
                prep.setInsC5H_Carga(rs.getBigDecimal("ECA_PREP_INS_C5_H_CARGA"));
        prep.setInsC5M_Carga(rs.getBigDecimal("ECA_PREP_INS_C5_M_CARGA"));
        prep.setInsC5_Carga(rs.getBigDecimal("ECA_PREP_INS_C5_CARGA"));
                prep.setInsC6H_Carga(rs.getBigDecimal("ECA_PREP_INS_C6_H_CARGA"));
        prep.setInsC6M_Carga(rs.getBigDecimal("ECA_PREP_INS_C6_M_CARGA"));
        prep.setInsC6_Carga(rs.getBigDecimal("ECA_PREP_INS_C6_CARGA"));
    ...
    private FilaPreparadorSolicitudVO mapearFilaPreparadorSolicitudVO(ResultSet rs) throws Exception
    {
        ...
        //fila.setHorasAnuales(valorBD != null ? MeLanbide44Utils.redondearDecimalesString(valorBD, 2).replaceAll("\\.", ",") : "-");
        fila.setHorasAnuales(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_HORAS_CONT");
        //fila.setHorasContrato(valorBD != null ? MeLanbide44Utils.redondearDecimalesString(valorBD, 2).replaceAll("\\.", ",") : "-");
        fila.setHorasContrato(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_HORAS_ECA");
        fila.setHorasDedicacionECA(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_IMP_SS_JC");
        fila.setCostesSalarialesSSJor(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_IMP_SS_JR");
        fila.setCostesSalarialesSSPorJor(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_IMP_SS_ECA");
        fila.setCostesSalarialesSSEca(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setC1h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C1_M");
        fila.setC1m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setC2h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C2_M");
        fila.setC2m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setC3h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C3_M");
        fila.setC3m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setC4h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C4_M");
        fila.setC4m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C4");
        fila.setC4Total(valorBD != null ? formateador.format(valorBD) : "-");
        
        
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C5_H");
        fila.setC5h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C5_M");
        fila.setC5m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C5");
        fila.setC5Total(valorBD != null ? formateador.format(valorBD) : "-");
        
        
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C6_H");
        fila.setC6h(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C6_M");
        fila.setC6m(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C6");
        fila.setC6Total(valorBD != null ? formateador.format(valorBD) : "-");
        
        
        valorBD = rs.getBigDecimal("ECA_PREP_INS_SEG_IMPORTE");
        fila.setSeguimientosInserciones(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PREP_IMP_SEG_ANT");
        fila.setImporte(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setCostesSalarialesSS(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
         valorBD = rs.getBigDecimal("ECA_PREP_IMPTE_CONCEDIDO");
        fila.setImporteConcedido(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
    ...
    private FilaProspectorSolicitudVO mapearFilaProspectorSolicitudVO(ResultSet rs) throws Exception
    {
        ...
        fila.setVisitasImp(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        valorBD = rs.getBigDecimal("ECA_PROS_COSTE");
        fila.setCoste(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
    ...
    valorBD = rs.getBigDecimal("ECA_PREP_INS_C5_H");
        jvalorBD = rs.getBigDecimal("C5H_JUS")!=null?rs.getBigDecimal("C5H_JUS"):BigDecimal.ZERO;                 
        fila.setC5h(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C5_M");
        jvalorBD = rs.getBigDecimal("C5M_JUS")!=null?rs.getBigDecimal("C5M_JUS"):BigDecimal.ZERO;          
        fila.setC5m(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C5");
        jvalorBD = rs.getBigDecimal("C5_JUS")!=null?rs.getBigDecimal("C5_JUS"):BigDecimal.ZERO;          
        fila.setC5Total(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
        

    valorBD = rs.getBigDecimal("ECA_PREP_INS_C6_H");
        jvalorBD = rs.getBigDecimal("C6H_JUS")!=null?rs.getBigDecimal("C6H_JUS"):BigDecimal.ZERO;                 
        fila.setC6h(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C6_M");
        jvalorBD = rs.getBigDecimal("C6M_JUS")!=null?rs.getBigDecimal("C6M_JUS"):BigDecimal.ZERO;          
        fila.setC6m(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
        valorBD = rs.getBigDecimal("ECA_PREP_INS_C6");
        jvalorBD = rs.getBigDecimal("C6_JUS")!=null?rs.getBigDecimal("C6_JUS"):BigDecimal.ZERO;          
        fila.setC6Total(valorBD != null ? valorBD.toPlainString().replaceAll("\\.", ",")+" - "+formateadorInserciones.format(jvalorBD) : BigDecimal.ZERO.toPlainString()+"-"+formateadorInserciones.format(jvalorBD));
                

//valorBD = rs.getBigDecimal("ECA_PREP_INS_IMPORTE");
        valorBD = rs.getBigDecimal("IMPINSERCIONES")!=null?rs.getBigDecimal("IMPINSERCIONES"):BigDecimal.ZERO;  ;
        fila.setInserciones(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        //valorBD = rs.getBigDecimal("ECA_PREP_INS_SEG_IMPORTE");
        ...
        fila.setSeguimientosInserciones(formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(imptesegins, 2))) );
    ...
    private DatosAnexosVO mapearDatosAnexosVO(ResultSet rs) throws Exception
    {
        ...
        datos.setC5H(rs.getBigDecimal("C5_H"));
        datos.setC5M(rs.getBigDecimal("C5_M"));
        datos.setC5T(rs.getBigDecimal("C5_T"));
        datos.setC6H(rs.getBigDecimal("C6_H"));
        datos.setC6M(rs.getBigDecimal("C6_M"));
        datos.setC6T(rs.getBigDecimal("C6_T"));
    ...
    private EcaConfiguracionVO mapearEcaConfiguracionVO(ResultSet rs)throws Exception
    {
        ...
        conf.setImC5h(rs.getBigDecimal("IM_C5_H"));
        conf.setImC5m(rs.getBigDecimal("IM_C5_M"));
        conf.setImC6h(rs.getBigDecimal("IM_C6_H"));
        conf.setImC6m(rs.getBigDecimal("IM_C6_M"));
    ...
    private EcaSolPreparadoresVO mapearEcaSolPreparadoresVO(HSSFRow row) throws Exception
    {
        ...
        String campo = "";//N√∫mero del campo que se va a procesar
        String tipoRequerido = "";//Tipo de dato que tiene que haber en la celda.
        int longMax = -1;//Longitud m√°xima de campos STRING
        int pEntera = -1;//N√∫mero de d√≠gitos de la parte entera de los num√©ricos
        int pDecimal = -1;//N√∫mero de d√≠gitos de la parte decimal de los num√©ricos
        if(row != null && !MeLanbide44Utils.esFilaVacia(24, row))
        {
            try
            {
                HSSFCell cell = null;
                ...
                campo = "1";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.STRING_NIF;
                longMax = 10;
                pEntera = -1;
                pDecimal = -1;
                int celdaIni = row.getFirstCellNum();
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell, tipoRequerido);

                if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, false))
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    valorString=valorString.replaceAll("[^0-9a-zA-Z]","");
                ...
                campo = "2";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.STRING;
                longMax = 200;
                pEntera = -1;
                pDecimal = -1;
                celdaIni++;
                ...
                campo = "3";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.FECHA;
                longMax = -1;
                pEntera = -1;
                pDecimal = -1;
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
                ...
                campo = "5";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.NUMERICO_DECIMAL;
                longMax = -1;
                pEntera = 8;
                pDecimal = 2;
                celdaIni++;
                ...
                campo = "11";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.NUMERICO;
                longMax = -1;
                pEntera = 8;
                pDecimal = -1;
                celdaIni++;
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell);
                if(valorString != null)
                {
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
    ...
    private EcaSolProspectoresVO mapearEcaSolProspectoresVO(HSSFRow row) throws Exception
    {
        ...
        int pEntera = -1;//N√∫mero de d√≠gitos de la parte entera de los num√©ricos
        int pDecimal = -1;//N√∫mero de d√≠gitos de la parte decimal de los num√©ricos
        if(row != null && !MeLanbide44Utils.esFilaVacia(12, row))
        {
            try
            {
                HSSFCell cell = null;
    ...
    private FilaPreparadorSolicitudVO mapearFilaPreparadorSolicitudVO(HSSFRow row) throws Exception
    {
        ...
        if(row != null)
        {
            try
            {
                ...
                int celdaIni = row.getFirstCellNum();
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.STRING_NIF);
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.STRING);
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.FECHA);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.NUMERICO_DECIMAL);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.NUMERICO);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
   ...
   private EcaJusPreparadoresVO mapearEcaJusPreparadoresVO(ResultSet rs) throws Exception
    ...
    private EcaSegPreparadoresVO mapearEcaSegPreparadoresVO(HSSFRow row) throws Exception   
    {
        ...
        int pEntera = -1;
        int pDecimal = -1;
        if(row != null && !MeLanbide44Utils.esFilaVacia(16, row))
        {        
            try
            {
                SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide44.FORMATO_FECHA);
                ...
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                /*String tipo_hombre=ConstantesMeLanbide44.SEXO.SEXO_HOMBRE;
                String tipo_mujer=ConstantesMeLanbide44.SEXO.SEXO_MUJER;*/
                if(valorString != null)
                {
                    
                    /*if(valorString.equals(tipo_hombre)){
                        valorString=ConstantesMeLanbide44.SEXO_NUM.SEXO_NUM_HOMBRE;
                    }
                    if(valorString.equals(tipo_mujer)){
                        valorString=ConstantesMeLanbide44.SEXO_NUM.SEXO_NUM_MUJER;
                    }*/
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
                ...
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                /*String psiquico=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD.PSIQUICO;
                String fisico=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD.FISICO;
                String sensorial=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD.SENSORIAL;*/
                if(valorString != null)
                {
                    
                    /*if(valorString.equals(psiquico)){
                        valorString=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD_NUM.PSIQUICO;
                    }
                    
                    if(valorString.equals(fisico)){
                        valorString=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD_NUM.FISICO;
                    }
                    
                    if(valorString.equals(sensorial)){
                        valorString=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD_NUM.SENSORIAL;
                    }*/
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {             
                        //valorString = valorString.replaceAll("\\.", ",");
                ...
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                /*String menor_33=ConstantesMeLanbide44.GRAVEDAD_DISCAPACIDAD.MENOR_33;
                String entre_33_65=ConstantesMeLanbide44.GRAVEDAD_DISCAPACIDAD.ENTRE_33_65;
                String mayor_65=ConstantesMeLanbide44.GRAVEDAD_DISCAPACIDAD.MAYOR_65;*/
                if(valorString != null)
                {
                    
                    /*if(valorString.equals(menor_33)){
                        valorString=ConstantesMeLanbide44.CODIGOS_GRAVEDAD_DISCAPACIDAD.MENOR_33;
                    }
                    if(valorString.equals(entre_33_65)){
                        valorString=ConstantesMeLanbide44.CODIGOS_GRAVEDAD_DISCAPACIDAD.ENTRE_33_65;
                    }
                    if(valorString.equals(mayor_65)){
                        valorString=ConstantesMeLanbide44.CODIGOS_GRAVEDAD_DISCAPACIDAD.MAYOR_65;
                    }*/
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {            
                        //valorString = valorString.replaceAll("\\.", ",");
                ...
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                /*String indefinido=ConstantesMeLanbide44.CODIGOS_TIPO_CONTRATO.INDEFINIDO;
                String temporal=ConstantesMeLanbide44.CODIGOS_TIPO_CONTRATO.TEMPORAL;
                String indefinidoNum=ConstantesMeLanbide44.CODIGOS_TIPO_CONTRATO_NUM.INDEFINIDO;
                String temporalNum=ConstantesMeLanbide44.CODIGOS_TIPO_CONTRATO_NUM.TEMPORAL;*/
                if(valorString != null)
                {
                ...
                if(valorString != null)
                {
                    ...
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
                        seg.setPorcJornada(new BigDecimal(valorString.replaceAll(",", "\\.").trim()));
                    }
                    else
                    {
                        throw new DatoExcelNoValidoException();
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
   ...
   private EcaSegPreparadores2016VO mapearEcaInsPreparadoresVO_2016(HSSFRow row) throws Exception   
    {
        EcaSegPreparadores2016VO seg = null;
        String campo = "";
        String tipoRequerido = "";
        ...
        {        
            try
            {
                ...
                cell = row.getCell(celdaIni);
                //valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                valorString = MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.STRING);
                String tipo_hombre=ConstantesMeLanbide44.SEXO.SEXO_HOMBRE;
                String tipo_mujer=ConstantesMeLanbide44.SEXO.SEXO_MUJER;
                log.debug("campo 3 valor:"+valorString);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    ...
                    log.debug("campo 3 validar "+tipoRequerido+":"+valorString);
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
                        //valorString = valorString.replaceAll("\\.", ",");
                        //valorString = valorString.substring(0, valorString.indexOf(","));
                ...
                String fisico=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD.FISICO;
                String sensorial=ConstantesMeLanbide44.CODIGOS_TIPO_DISCAPACIDAD.SENSORIAL;
                log.debug("campo 5 valor:"+valorString);
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    if(valorString.equals(psiquico)){
                    ...
                    log.debug("campo 5 validar "+tipoRequerido+":"+valorString);
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {             
                        //valorString = valorString.replaceAll("\\.", ",");
                        //valorString = valorString.substring(0, valorString.indexOf(","));          
   ...
   private EcaSegPreparadoresVO mapearEcaInsPreparadoresVO(HSSFRow row) throws Exception   
    ...
    private FilaSegPreparadoresVO mapearFilaSegPreparadoresVO(ResultSet rs) throws Exception
    {
        ...
        if (valorNum != null){
            if (valorNum==0)    fila.setTipo("Seguimiento");
            else fila.setTipo("Insercion");
        }        
        ...
        fila.setHorasCont(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");   
        ...
        fila.setPorcJornada(valorBD != null ? formateador.format(new BigDecimal(MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");  
    ...
    public EcaJusProspectoresVO fromFilaProsJusVOToProsJusVO(FilaProspectorJustificacionVO fila) throws Exception
    {
        ...
        pros.setJusProspectoresCod(fila.getId()!=null?Integer.parseInt(fila.getId()):null);//#282130: Prospector justificaciÛn validaciÛn 50% Horas ECA
        return pros;
    }
	...
	//#279177: ECA - Carga masiva, listado de errores
   /*Se deja opciÛn de procesar excel y que devuelva error de uno en uno tambiÈn
	 Cuando se pruebe bien y funcione correctamente "procesarExcelVisitasPros" eliminar esta funciÛn */
    public Object mapearEcaVisProspectoresVO_old(HSSFRow row, Class clazz) throws Exception
    {
        if(clazz == EcaVisProspectores2016VO.class)
        {
            return mapearEcaVisProspectoresVO_2016_old(row);
        }
        return null;
    }
    //fin comentario #279177
        private es.altia.flexia.integracion.moduloexterno.melanbide44.vo.justificacion.EcaVisProspectoresVO mapearEcaVisProspectoresVO(HSSFRow row) throws Exception   
    {
        es.altia.flexia.integracion.moduloexterno.melanbide44.vo.justificacion.EcaVisProspectoresVO vis = null;
        String campo = "";
        String tipoRequerido = "";
        int longMax = -1;
        int pEntera = -1;
        int pDecimal = -1;
        if(row != null && !MeLanbide44Utils.esFilaVacia(19, row))
        {        
            try
            {
                SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide44.FORMATO_FECHA);
                HSSFCell cell = null;
                String valorString;
                vis = new es.altia.flexia.integracion.moduloexterno.melanbide44.vo.justificacion.EcaVisProspectoresVO();
                ...
                if(valorString != null)
                {
                    ...
                    {
                        throw new es.altia.flexia.integracion.moduloexterno.melanbide44.exception.DatoExcelNoValidoException();
                    }
                }
                ...
                celdaIni++;
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell, ConstantesMeLanbide44.TiposRequeridos.STRING_CIF);
            ...
            {
                es.altia.flexia.integracion.moduloexterno.melanbide44.exception.ExcelRowMappingException erme = new es.altia.flexia.integracion.moduloexterno.melanbide44.exception.ExcelRowMappingException(campo);
                erme.setLongMax(longMax);
                erme.setTipo(tipoRequerido);
                erme.setpEntera(pEntera);
                erme.setpDecimal(pDecimal);
    ...
    //#279177: ECA - Carga masiva, listado de errores
    private HashMap<EcaVisProspectores2016VO, List<ExcelRowMappingException>> mapearEcaVisProspectoresVO_2016(HSSFRow row) throws Exception   
    {
        List<ExcelRowMappingException> listaErrores = new ArrayList<ExcelRowMappingException>();
        ...
        {    
            try
            {
                ...
                HSSFCell cell = null;
                String valorString;
                vis = new EcaVisProspectores2016VO();
                ...
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");                   
                    //valorString = MeLanbide44Utils.quitarEspacios(valorString).replaceAll("-", ""); 
                    //valorString.trim();
                    valorString=valorString.replaceAll("[^0-9a-zA-Z]","");
                    if(MeLanbide44Utils.validarDatoExcel(valorString, tipoRequerido, longMax, pEntera, pDecimal, true))
                    {
                ...
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                valorString = reemplazarSaltosDeLinea(valorString, "");
                String ADMINISTRACION_OFICINAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.ADMINISTRACION_OFICINAS;
                String AGRARIO=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.AGRARIO;
                String ARTESANIA=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.ARTESANIA;
                String AUTOMOCION=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.AUTOMOCION;
                String COMERCIO=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.COMERCIO;
                String DOCENCIA_INVESTIGACION=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.DOCENCIA_INVESTIGACION;
                String EDIFICACION_OBRAS_PUBLICAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.EDIFICACION_OBRAS_PUBLICAS;
                String INDUSTRIA_PESADA_CONSTRUCCIONES_METALICAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIA_PESADA_CONSTRUCCIONES_METALICAS;
                String INDUSTRIAS_ALIMENTARIAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_ALIMENTARIAS;
                String INDUSTRIAS_FABRICACION_EQUIPOS_ELECTROMECANICOS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_FABRICACION_EQUIPOS_ELECTROMECANICOS;
                String INDUSTRIA_MADERA_CORCHO=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIA_MADERA_CORCHO;
                String INDUSTRIAS_GRAFICAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_GRAFICAS;
                String INDUSTRIAS_ANUFACTURERAS_DIVERSAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_ANUFACTURERAS_DIVERSAS;
                String INDUSTRIAS_QUIMICAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_QUIMICAS;
                String INDUSTRIAS_TEXTILES=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INDUSTRIAS_TEXTILES;
                String INFORMACION_MANIFESTACIONES_ARTISTICAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.INFORMACION_MANIFESTACIONES_ARTISTICAS;
                String MANTENIMIENTO_REPARACION=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.MANTENIMIENTO_REPARACION;
                String MINERIA_PRIMERAS_TRASFORMACIONES=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.MINERIA_PRIMERAS_TRASFORMACIONES;
                String MONTAJE_INSTALACION=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.MONTAJE_INSTALACION;
                String PESCA_ACUICULTURA=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.PESCA_ACUICULTURA;
                String PIEL_CUERO=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.PIEL_CUERO;
                String PRODUCCION_TRASFORMACION_ENERGIA_AGUA=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.PRODUCCION_TRASFORMACION_ENERGIA_AGUA;
                String SANIDAD=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.SANIDAD;
                String SEGUROS_FINANZAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.SEGUROS_FINANZAS;
                String SERVICIOS_COMUNIDAD_PERSONALES=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.SERVICIOS_COMUNIDAD_PERSONALES;
                String SERVICIOS_EMPRESAS=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.SERVICIOS_EMPRESAS;
                String TRANSPORTES_COMUNICACIONES=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.TRANSPORTES_COMUNICACIONES;
                String TURISMO_HOSTELERIA=ConstantesMeLanbide44.SECTOR_ACTIVIDAD.TURISMO_HOSTELERIA;
                
                if(valorString.equals(ADMINISTRACION_OFICINAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.ADMINISTRACION_OFICINAS;
                }
                
                if(valorString.equals(AGRARIO)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.AGRARIO;
                }
                
                if(valorString.equals(ARTESANIA)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.ARTESANIA;
                }
                
                if(valorString.equals(AUTOMOCION)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.AUTOMOCION;
                }
                
                if(valorString.equals(COMERCIO)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.COMERCIO;
                }
                
                if(valorString.equals(DOCENCIA_INVESTIGACION)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.DOCENCIA_INVESTIGACION;
                }
                
                if(valorString.equals(EDIFICACION_OBRAS_PUBLICAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.EDIFICACION_OBRAS_PUBLICAS;
                }
                
                if(valorString.equals(INDUSTRIA_PESADA_CONSTRUCCIONES_METALICAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIA_PESADA_CONSTRUCCIONES_METALICAS;
                }
                
                if(valorString.equals(INDUSTRIAS_ALIMENTARIAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_ALIMENTARIAS;
                }
                
                if(valorString.equals(INDUSTRIAS_FABRICACION_EQUIPOS_ELECTROMECANICOS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_FABRICACION_EQUIPOS_ELECTROMECANICOS;
                }
                
                if(valorString.equals(INDUSTRIA_MADERA_CORCHO)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIA_MADERA_CORCHO;
                }
                
                if(valorString.equals(INDUSTRIAS_GRAFICAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_GRAFICAS;
                }
                
                if(valorString.equals(INDUSTRIAS_ANUFACTURERAS_DIVERSAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_ANUFACTURERAS_DIVERSAS;
                }
                
                if(valorString.equals(INDUSTRIAS_QUIMICAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_QUIMICAS;
                }
                
                if(valorString.equals(INDUSTRIAS_TEXTILES)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INDUSTRIAS_TEXTILES;
                }
                
                if(valorString.equals(INFORMACION_MANIFESTACIONES_ARTISTICAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.INFORMACION_MANIFESTACIONES_ARTISTICAS;
                }
                
                if(valorString.equals(MANTENIMIENTO_REPARACION)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.MANTENIMIENTO_REPARACION;
                }
                
                if(valorString.equals(MINERIA_PRIMERAS_TRASFORMACIONES)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.MINERIA_PRIMERAS_TRASFORMACIONES;
                }
                
                if(valorString.equals(MONTAJE_INSTALACION)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.MONTAJE_INSTALACION;
                }
                
                if(valorString.equals(PESCA_ACUICULTURA)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.PESCA_ACUICULTURA;
                }
                
                if(valorString.equals(PIEL_CUERO)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.PIEL_CUERO;
                }
                
                if(valorString.equals(PRODUCCION_TRASFORMACION_ENERGIA_AGUA)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.PRODUCCION_TRASFORMACION_ENERGIA_AGUA;
                }
                
                if(valorString.equals(SANIDAD)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.SANIDAD;
                }
                
                if(valorString.equals(SEGUROS_FINANZAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.SEGUROS_FINANZAS;
                }
                
                if(valorString.equals(SERVICIOS_COMUNIDAD_PERSONALES)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.SERVICIOS_COMUNIDAD_PERSONALES;
                }
                
                if(valorString.equals(SERVICIOS_EMPRESAS)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.SERVICIOS_EMPRESAS;
                }
                
                if(valorString.equals(TRANSPORTES_COMUNICACIONES)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.TRANSPORTES_COMUNICACIONES;
                }
                
                if(valorString.equals(TURISMO_HOSTELERIA)){
                    valorString=ConstantesMeLanbide44.SECTOR_ACTIVIDAD_NUM.TURISMO_HOSTELERIA;
                }
                ...
                cell = row.getCell(celdaIni);
                valorString = (String)MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                String alaba=ConstantesMeLanbide44.PROVINCIA.ARABA;
                String bizkaia=ConstantesMeLanbide44.PROVINCIA.BIZKAIA;
                String gipuzkoa=ConstantesMeLanbide44.PROVINCIA.GIPUZKOA;
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    
                    if(valorString.equals(alaba)){
                        valorString=ConstantesMeLanbide44.PROVINCIA_NUM.ARABA;
                    }
                    
                    if(valorString.equals(bizkaia)){
                        valorString=ConstantesMeLanbide44.PROVINCIA_NUM.BIZKAIA;
                    }
                    
                    if(valorString.equals(gipuzkoa)){
                        valorString=ConstantesMeLanbide44.PROVINCIA_NUM.GIPUZKOA;
                    }
                ...
                log.debug("campo 14");//telefono se est·n perdiendo ˙ltimos ceros
                campo = "14";
                tipoRequerido = ConstantesMeLanbide44.TiposRequeridos.NUMERICO;
                longMax = -1;
                pEntera = 9;
                ...
                cell = row.getCell(celdaIni);
                valorString = MeLanbide44Utils.getValorCelda(cell, tipoRequerido);
                String si=ConstantesMeLanbide44.LISMI.SI;
                String no=ConstantesMeLanbide44.LISMI.NO;
                String certificado=ConstantesMeLanbide44.LISMI.CERTIFICADO;
                String no_procede=ConstantesMeLanbide44.LISMI.NO_PROCEDE;
                if(valorString != null)
                {
                    valorString = reemplazarSaltosDeLinea(valorString, "");
                    if(valorString.equals(si)){
                        valorString=ConstantesMeLanbide44.LISMI_NUM.SI;
                    }
                    if(valorString.equals(no)){
                        valorString=ConstantesMeLanbide44.LISMI_NUM.NO;
                    }
                    if(valorString.equals(certificado)){
                        valorString=ConstantesMeLanbide44.LISMI_NUM.CERTIFICADO;
                    }
                    if(valorString.equals(no_procede)){
                        valorString=ConstantesMeLanbide44.LISMI_NUM.NO_PROCEDE;
                    }
                ...
                valorString = reemplazarSaltosDeLinea(valorString, "");
                valorString = valorString.replaceAll(" ", "");
                String informada=ConstantesMeLanbide44.RESULTADO.INFORMADA;
                String interesada=ConstantesMeLanbide44.RESULTADO.INTERESADA;
                String vinculada=ConstantesMeLanbide44.RESULTADO.VINCULADA;
                
                if(valorString.equals(informada)){
                    valorString=ConstantesMeLanbide44.RESULTADO_NUM.INFORMADA;
                }
                
                if(valorString.equals(interesada)){
                    valorString=ConstantesMeLanbide44.RESULTADO_NUM.INTERESADA;
                }
                
                if(valorString.equals(vinculada)){
                    valorString=ConstantesMeLanbide44.RESULTADO_NUM.VINCULADA;
                }
                ...
                if (listaErrores.size() > 0){
                    throw new ListaDatosExcelNoValidosException(listaErrores);
                }
        ...
        }else log.debug("fila vacÌa");
        //map.put(vis, listaErrores);
        // populate hash map
        map.put("visita", vis);
        map.put("errores", listaErrores);
        return map; 
        //return vis;
    }
    
	//#279177: ECA - Carga masiva, listado de errores
   /*Se deja opciÛn de procesar excel y que devuelva error de uno en uno
	 Cuando se pruebe bien y funcione correctamente "procesarExcelVisitasPros" eliminar funciÛn mapearEcaVisProspectoresVO_2016_old*/
    private EcaVisProspectores2016VO mapearEcaVisProspectoresVO_2016_old(HSSFRow row) throws Exception   
    {
        log.debug("mapearEcaVisProspectoresVO_2016("+row+") begin ");
        EcaVisProspectores2016VO vis = null;
        String campo = "";
        String tipoRequerido = "";
        int longMax = -1;
    ...
    private EcaVisProspectoresVO mapearEcaVisProspectoresVO_2016(ResultSet rs) throws Exception   
    {
        EcaVisProspectoresVO vis = new EcaVisProspectoresVO();        
        vis.setJusProspectoresCod(rs.getInt("ECA_JUS_PROSPECTORES_COD"));
        if(rs.wasNull())
    ...
    private FilaEcaResPreparadoresVO mapearFilaEcaResPreparadoresVO(ResultSet rs) throws Exception
    {
        ...
        /*concedido=formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2)));
        concedido=concedido.replace(".", "");
        concedido=concedido.replace(",", ".");
        concedidoD=Double.parseDouble(concedido);*/
        fila.setGastosSalarialesConcedidos(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("GASTOS_SALARIALES_JUSTIFICADOS");
        /*justificado=formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2)));
        justificado=justificado.replace(".", "");
        justificado=justificado.replace(",", ".");
        justificadoD=Double.parseDouble(justificado);*/
        fila.setGastosSalarialesJustificados(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("GASTOS_SALARIALES_SOLICITADOS");
        fila.setGastosSalarialesSolicitados(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("IMPORTE_INS_CONCEDIDO");
        fila.setImporteInsConcedido(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("IMPORTE_INS_JUSTIFICADAS");
        fila.setImporteInsJustificadas(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("IMPORTE_INSERCIONES");
        /*inserciones=formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2)));
        inserciones=inserciones.replace(".", "");
        inserciones=inserciones.replace(",", ".");
        insercionesD=Double.parseDouble(inserciones);*/
        fila.setImporteInserciones(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("IMPORTE_SEG_INSERCIONES");
        fila.setImporteSegInserciones(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        
        valorBD = rs.getBigDecimal("IMPORTE_SEGUIMIENTOS");
        fila.setImporteSeguimientos(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setImpPagar(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        //fila.setImpPagar(pagoArealizarD != null ? String.valueOf(pagoArealizarD) : "-");
        
        fila.setTipoSust(rs.getString("ECA_PREP_TIPO_SUST"));
        
        valorBD = rs.getBigDecimal("IMPORTE_SEGUIMIENTOS_LIM");
        fila.setImporteSeguimientosLim(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        return fila;
    }
    ...
    {   
        ...
        fila.setImporteVisitas(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        ...
        fila.setImporteVisitasConc(valorBD != null ? formateador.format(new BigDecimal( MeLanbide44Utils.redondearDecimalesString(valorBD, 2))) : "-");
        return fila;
    }
    ...
    private EcaResumenVO mapearEcaResumenVO(ResultSet rs) throws Exception
    {
        ...
        res.setGastosGenerales_pag(rs.getBigDecimal("ECA_RES_SUB_GASTOSGEN"));
        return res;
    }
    ...
    private String eliminarCaracteresSeparacion(String text, String replacement)
    {
        if(text != null && !text.equals(""))
        {
