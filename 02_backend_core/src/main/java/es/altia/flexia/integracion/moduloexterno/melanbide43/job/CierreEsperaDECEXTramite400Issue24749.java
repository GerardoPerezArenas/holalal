...
public class CierreEsperaDECEXTramite400Issue24749 implements Job{

    private final Logger log = LogManager.getLogger(CierreEsperaDECEXTramite400Issue24749.class);
            ...
            if (servidor.equals(System.getProperty("weblogic.Name"))) {//PARA LOCAL QUITAR
                synchronized (jec) {
                    ...
                    try {
                        ...
                        log.error(CierreEsperaDECEXTramite400Issue24749.class.getName() 
                        ...
                        if (con != null) {
                            try {
                                ...
                                log.error(CierreEsperaDECEXTramite400Issue24749.class.getName()+" - Error cerrando BBDD", ex);
                            }
                        }
                        if (adaptador != null) {
                            try {
