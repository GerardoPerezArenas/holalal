...
package es.altia.flexia.integracion.moduloexterno.melanbide76.dao;
...
import es.altia.flexia.integracion.moduloexterno.melanbide76.util.MeLanbide76MappingUtils;
...
public class MeLanbide76DAO {

    //Logger
    private static Logger log = LogManager.getLogger(MeLanbide76DAO.class);
    //Instancia
    private static MeLanbide76DAO instance = null;

    // Constructor
    private MeLanbide76DAO() {

    }

    public static MeLanbide76DAO getInstance() {
        if (instance == null) {
            synchronized (MeLanbide76DAO.class) {
                instance = new MeLanbide76DAO();
            }
        }
        return instance;
    }
    ...
    public List<ContratacionVO> getDatosContratacion(String numExp, int codOrganizacion, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "SELECT * FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
            ...
            while (rs.next()) {
                contratacion = (ContratacionVO) MeLanbide76MappingUtils.getInstance().map(rs, ContratacionVO.class);
    ...
    public List<ContratacionVO> getContratacion(String numExp, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "Select * From " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES) + " A "
    ...
    public int eliminarContratacion(String id, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "DELETE FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
                    + " WHERE ID=" + (id != null && !id.equals("") ? id : "null");
            if (log.isDebugEnabled()) {
                log.debug("sql = " + query);
            }
    ...
    public boolean crearNuevaContratacion(ContratacionVO nuevaContratacion, Connection con) throws Exception {
        ...
        try {
            ...
            int id = recogerIDInsertar(ConfigurationParameter.getParameter(ConstantesMeLanbide76.SEQ_MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES), con);
            query = "INSERT INTO " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
                    + "(ID,NUM_EXP,NOFECONT,IDCONT1,IDCONT2,DNICONT,NOMCONT,"
                    + "APE1CONT,APE2CONT,FECHNACCONT,EDADCONT,SEXOCONT,MAY45CONT,ACCFORCONT,CODFORCONT,DENFORCONT,"
    ...
    public boolean modificarContratacion(ContratacionVO datModif, Connection con) throws Exception {
        ...
        try {
            query = "UPDATE " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_CONTRATACION, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
    ...
    public List<MinimisVO> getDatosMinimis(String numExp, int codOrganizacion, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "SELECT * FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
                    + " WHERE NUM_EXP ='" + numExp + "'"
                    + " ORDER BY ID";
            if (log.isDebugEnabled()) {
                log.debug("sql = " + query);
            ...
            rs = st.executeQuery(query);
            while (rs.next()) {
                minimis = (MinimisVO) MeLanbide76MappingUtils.getInstance().mapMin(rs, MinimisVO.class);
                //Cargamos en el request los valores de los desplegables
                lista.add(minimis);
    ...
    public List<MinimisVO> getMinimis(String numExp, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "Select * From " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES) + " A "
                    + "Where A.Num_Exp= '" + numExp + "' Order By A.Id";
            if (log.isDebugEnabled()) {
    ...
    public int eliminarMinimis(String id, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "DELETE FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
                    + " WHERE ID=" + (id != null && !id.equals("") ? id : "null");
            if (log.isDebugEnabled()) {
                log.debug("sql = " + query);
            }
    ...
    public boolean crearNuevaMinimis(MinimisVO nuevaMinimis, Connection con) throws Exception {
        ...
        try {
            ...
            int id = recogerIDInsertar(ConfigurationParameter.getParameter(ConstantesMeLanbide76.SEQ_MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES), con);
            query = "INSERT INTO " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
    ...
    public boolean modificarMinimis(MinimisVO datModif, Connection con) throws Exception {
        ...
        try {
            query = "UPDATE " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.MELANBIDE76_SUBSOLIC, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
    ...
    public List<DesplegableAdmonLocalVO> getValoresDesplegablesAdmonLocalxdes_cod(String des_cod, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "SELECT * FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.TABLA_VALORES_DESPLEGABLES, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
            ...
            rs = st.executeQuery(query);
            while (rs.next()) {
                valoresDesplegable = (DesplegableAdmonLocalVO) MeLanbide76MappingUtils.getInstance().map(rs, DesplegableAdmonLocalVO.class);
    ...
    public DatosTablaDesplegableExtVO getDatosMapeoDesplegableExterno(String codDes, Connection con) throws Exception {
        ...
        try {
            String query = null;
            query = "SELECT CODIGO,TABLA,CAMPO_CODIGO,CAMPO_VALOR FROM " + ConfigurationParameter.getParameter(ConstantesMeLanbide76.TABLA_CODIGOS_DESPLEGABLES_EXTERNOS, ConstantesMeLanbide76.FICHERO_PROPIEDADES)
            ...
            rs = st.executeQuery(query);
            while (rs.next()) {
                datosMapeoDesplegableExterno = (DatosTablaDesplegableExtVO) MeLanbide76MappingUtils.getInstance().map(rs, DatosTablaDesplegableExtVO.class);
            }
        } catch (Exception ex) {
    ...
    public List<DesplegableExternoVO> getValoresDesplegablesExternos(String tablaDesplegable, String campoCodigo, String campoValor, Connection con) throws Exception {
        ...
        try {
            ...
            rs = st.executeQuery(query);
            while (rs.next()) {
                valoresDesplegable = (DesplegableExternoVO) MeLanbide76MappingUtils.getInstance().map3(rs, campoCodigo, campoValor);
                lista.add(valoresDesplegable);
