package es.altia.flexia.integracion.moduloexterno.melanbide66.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide66.util.ConstantesMeLanbide66;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide66I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide66.getFICHERO_PROPIEDADES());
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide66I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide66I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide66I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide66I18n();
                }
            }
        }
        return instance;
