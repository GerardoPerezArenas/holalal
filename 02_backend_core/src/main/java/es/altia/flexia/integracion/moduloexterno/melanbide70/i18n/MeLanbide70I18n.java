package es.altia.flexia.integracion.moduloexterno.melanbide70.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide70.util.ConstantesMeLanbide70;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide70I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide70.getFICHERO_PROPIEDADES());
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide70I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide70I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide70I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide70I18n();
                }
            }
        }
        return instance;
     ...
     * @return String
     */
    public static String getMensaje(Integer codIdioma, String key)
    {
        String mensaje ="";
