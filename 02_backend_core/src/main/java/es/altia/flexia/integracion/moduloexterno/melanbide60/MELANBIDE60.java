 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide60;
...
import es.altia.flexia.integracion.moduloexterno.melanbide60.i18n.MeLanbide60I18n;
...
import es.altia.flexia.integracion.moduloexterno.melanbide60.util.MeLanbide60Validator;
 ...
 * @author santiagoc
 */
public class MELANBIDE60 extends ModuloIntegracionExterno 
{
    //Logger
    private static Logger log = LogManager.getLogger(MELANBIDE60.class);
        ...
        try{           
            if(numExpediente!=null && !"".equals(numExpediente)){
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                 ...
                 MeLanbide60Manager.getInstance().guardaHistorico(numExpediente, String.valueOf(codTramite), adapt);
            }
        }
        catch(Exception ex)
        {
    ...
    public String borrarHistoricoCme (int codOrganizacion,int codTramite,int ocurrenciaTramite, String numExpediente)
   {
        ...
        try{           
            if(numExpediente!=null && !"".equals(numExpediente)){
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                 ...
                 MeLanbide60Manager.getInstance().borraHistorico(numExpediente, String.valueOf(codTramite), adapt);
            }
        }
        catch(Exception ex)
        {
    ...
    public String cargarPantallaDatosCme(int codOrganizacion,  int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            datosCmeVO datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
        ...
        return "/jsp/extension/melanbide60/datosCme.jsp";
    }
    ...
    public void guardarDatosCme(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            if(validarDatosCme(request))
            {
                ...
                try
                {
                    ejercicio = MeLanbide60Utils.getEjercicioDeExpediente(numExpediente);
                }
                catch(Exception ex)
                {
                ...
                if(ejercicio != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            int res = 0;
                            res = MeLanbide60Manager.getInstance().guardarDatosCme(codOrganizacion, ejeStr, numExpediente, gestor, empresa, impPagadoNum, impPagadoNum2, otrasAyudasSolicNum, otrasAyudasConceNum, minimisSolicNum, minimisConceNum, importeConcedidoNum,importeRenunciaResNum, impReiNum, impJusNum, adaptador);
                            if(res > 0)
                            {
                                codigoOperacion = "0";
                            }
                    ...
                    calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
                    datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                }
                else
                {
                    codigoOperacion = "3";
...
//        }//try-catch
    ...
    public String cargarNuevoPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            log.error("cargarNuevoPuesto");
            cargarCombosNuevoPuesto(codOrganizacion, request);
        }
        catch(Exception ex)
        {
            log.error("error en cargarNuevoPuesto: ", ex);
        }
        return "/jsp/extension/melanbide60/nuevoPuesto.jsp?codOrganizacionModulo="+codOrganizacion;
    }
    ...
    public String cargarModificarPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            ...
            if(opcion != null)
            {
                ...
                log.error("codPuesto " + codPuesto);

                if(codPuesto != null && !codPuesto.equals(""))
                {
                    Integer ejercicio = MeLanbide60Utils.getEjercicioDeExpediente(numExpediente);
                    ...
                    puesto = MeLanbide60Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                    if(puesto != null)
                    {
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit1(), adapt);
                            if(desc != null)
                            {
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit2(), adapt);
                            if(desc != null)
                            {
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(puesto.getCodTit3(), adapt);
                            if(desc != null)
                            {
        ...
        {
            ex.printStackTrace();
            log.error("Error en cargarModificarPuesto", ex);
        }
        return "/jsp/extension/melanbide60/nuevoPuesto.jsp?codOrganizacionModulo="+codOrganizacion;
    }
    ...
    public void guardarPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                String gastosVisadoSol = (String)request.getParameter("gastosVisadoSolic");
                String gastosSeguroSol = (String)request.getParameter("gastosSeguroSolic");
                ...
                if(codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    puesto.setNumExp(numExpediente);
                    puesto.setEjercicio(ejercicio);
                    puesto = MeLanbide60Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, adaptador);
                }
                else
                {
                    puesto = new CmePuestoVO();
                ...
                else
                {
                    ...
                    if(resultado != null && (resultado.equalsIgnoreCase(ConstantesMeLanbide60.CODIGO_RESULTADO_DENEGADO) || resultado.equalsIgnoreCase(ConstantesMeLanbide60.CODIGO_RESULTADO_RENUNCIA)))
                    {
...
//                    puesto.setTramSolic(tramitacionSolicitud != null && !tramitacionSolicitud.equals("") ? new BigDecimal(tramitacionSolicitud.replaceAll(",", "\\.")) : null);
                    ...
                    puesto.setGastosSeguroSol(gastosSeguroSol != null && !gastosSeguroSol.equals("") ? new BigDecimal(gastosSeguroSol.replaceAll(",", "\\.")) : null);
                    puesto.setGastosVisadoSol(gastosVisadoSol != null && !gastosVisadoSol.equals("") ? new BigDecimal(gastosVisadoSol.replaceAll(",", "\\.")) : null);
                    
                    //TODO: se podria validar los datos del puesto
                    
                    
                    MeLanbide60Manager.getInstance().guardarCmePuestoVO(codOrganizacion, puesto, impAnterior, estadoAnterior, adaptador);
                }
                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
                
                datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adaptador);
                puestos = MeLanbide60Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adaptador);
            }
            else
            {
                codigoOperacion = "3";
    ...
    public void eliminarPuesto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                {
                    MeLanbide60Manager.getInstance().eliminarCmePuestoVO(codOrganizacion, puesto, adaptador);
                }
                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
                datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adaptador);
                puestos = MeLanbide60Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adaptador);
    ...
    public String cargarNuevaOferta(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide60/nuevaOferta.jsp?codOrganizacionModulo="+codOrganizacion;
    }
        ...
        try
        {
            ...
            if(opcion != null)
            {
                ...
                if(codOferta != null && !codOferta.equals(""))
                {
                    ...
                    oferta = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                    if(oferta != null)
                    {
                         //pruebas copiardatos
                       /* String copiardatos = (String)request.getParameter("copiardatos");
                        ...
                        origenpuesto = MeLanbide60Manager.getInstance().getPuestoPorCodigoYExpediente(origenpuesto, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                                              
                        if (copiardatos!=null)       
                                oferta = MeLanbide60Manager.getInstance().copiarDatosPuesto(codOrganizacion, origenpuesto, oferta, this.getAdaptSQLBD(String.valueOf(codOrganizacion))); 
                        //fin copiardatos
                        */
                        ...
                        if(oferta.getIdOfertaOrigen() != null)
                        {
                            ...
                            ofertaOrigen = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaOrigen, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit1(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit1", desc);
                            }
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit2(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit2", desc);
                            }
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit3(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit3", desc);
                            }
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTitulacion(), adapt);
                            if(desc != null)
                            {
    ...
    public void getListaOfertasNoDenegadasPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                ofertas = MeLanbide60Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adapt);
                
                datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adapt);
            }
        }
        catch(Exception ex)
        {
    ...
    public void getListaJustificacionesNoDenegadasPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                justificaciones = MeLanbide60Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adapt);
                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adapt);
                datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adapt);
            }
        }
    ...
    public String cargarNuevaJustificacion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return "/jsp/extension/melanbide60/nuevaJustificacion.jsp?codOrganizacionModulo="+codOrganizacion;
    }
...
//                    justif = MeLanbide60Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justif, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
//                    if(justif != null)
//                    {
...
//                            puesto.setEjercicio(ejercicio);
//                            puesto.setNumExp(numExpediente);
//                            puesto = MeLanbide60Manager.getInstance().getPuestoPorCodigoYExpediente(puesto, adapt);
//                            if(puesto != null)
//                            {
//                                request.setAttribute("puestoConsulta", puesto);
//                            }
...
//                                ofertaConsulta = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaConsulta, adapt);
...
//    }
            ...
            if(opcion != null)
            {
                ...
                if(codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    if(puesto != null)
                    {
                        ...
                        List<FilaPersonaContratadaVO> contrataciones = MeLanbide60Manager.getInstance().getListaContratacionesPuesto(puesto, adapt);
                    ...
                    ofertaConsulta.setNumExp(numExpediente);
                    ofertaConsulta = MeLanbide60Manager.getInstance().getUltimaOfertaPorPuestoYExpediente(ofertaConsulta, adapt);
                    if(ofertaConsulta != null)
                    {
                        request.setAttribute("ofertaConsulta", ofertaConsulta);
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion( ofertaConsulta.getCodTit1(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit1", desc);
                            }
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion( ofertaConsulta.getCodTit2(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit2", desc);
                            }
                        ...
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion( ofertaConsulta.getCodTit3(), adapt);
                            if(desc != null)
                            {
                                request.setAttribute("descTit3", desc);
                            }
    ...
    public void generarInformeResumenPuestosContratados(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            MeLanbide60Manager manager = MeLanbide60Manager.getInstance();
            SimpleDateFormat format = new SimpleDateFormat(ConstantesMeLanbide60.FORMATO_FECHA);
            ...
            try 
            {
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col1").toUpperCase());
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col2").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col31").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col3").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col4").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col5").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col6").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col7").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col8").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col9").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col10").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col11").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col12").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col13").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col14").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col15").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col16").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col29").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col30").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col17").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col18").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col19").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col20").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col21").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col22").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col23").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col24").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col25").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col26").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col27").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(27);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.col28").toUpperCase());
                celda.setCellStyle(estiloCelda);*/
                ...
                for(FilaInformeResumenPuestosContratadosVO filaI : listaPuestos)
                {
                    ...
                    {
                        datosTercero = MeLanbide60Manager.getInstance().getDatosTercero(codOrganizacion, numExp, String.valueOf(ano), ConstantesMeLanbide60.CODIGO_ROL_ENTIDAD_SOLICITANTE, adapt);
                    ...
                    //COLUMNA: EDAD
                    Integer edad = MeLanbide60Utils.calcularEdad2(filaI.getFecNac() != null ? format.parse(filaI.getFecNac()) : null, filaI.getFecIni() != null ? format.parse(filaI.getFecIni()) : null);
                ...
                //{                    
                    ...
                    hoja.getRow(numFila-p).getCell((short)2).setCellStyle(estiloCelda);*/
                //}
    ...
    {   
        ...
        celda = fila.createCell(2);
        celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informePuestosContratados.total").toUpperCase());
        celda.setCellStyle(estiloCelda);
    ...
    public void generarInformeResumenEconomico(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            try 
            {
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(0);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col1").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(1);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col2").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(2);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col30").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(3);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col3").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(4);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col4").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(5);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col5").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(6);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col6").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(7);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col7").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(8);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col8").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(9);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col9").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(10);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col10").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(11);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col11").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(12);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col12").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(13);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col13").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(14);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col14").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(15);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col15").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(16);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col16").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(17);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col17").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(18);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col18").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(19);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col19").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(20);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col20").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(21);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col21").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(22);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col22").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(23);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col23").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(24);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col24").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(25);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col25").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(26);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col26").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(27);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col27").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(28);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col28").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(29);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.col29").toUpperCase());
                celda.setCellStyle(estiloCelda);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    valor = valor.replaceAll("TOTAL", meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.total").toUpperCase());
                    if(valor.equals(meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.total").toUpperCase()) || nuevo)
                    {
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(12);
                    celda.setCellValue(filaI.getCostesContSalarioSS() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getCostesContSalarioSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(13);
                    celda.setCellValue(filaI.getCostesContDietasConve() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getCostesContDietasConve(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(14);
                    celda.setCellValue(filaI.getCostesCont() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getCostesCont(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(15);
                    celda.setCellValue(filaI.getSolSalarioSS() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getSolSalarioSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(16);
                    celda.setCellValue(filaI.getSolDietasConvSS() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getSolDietasConvSS(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(17);
                    celda.setCellValue(filaI.getSolGastosTra() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getSolGastosTra(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(18);
                    celda.setCellValue(filaI.getSolicitado() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getSolicitado(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(19);
                    celda.setCellValue(filaI.getDotacionAnualMaxima() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getDotacionAnualMaxima(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(21);
                    celda.setCellValue(filaI.getDietasSubv() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getDietasSubv(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(22);
                    celda.setCellValue(filaI.getGastosTram() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getGastosTram(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(23);
                    celda.setCellValue(filaI.getMinimisConcedidos() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getMinimisConcedidos(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(24);
                    celda.setCellValue(filaI.getImpMaxSubvencionable() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getImpMaxSubvencionable(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(25);
                    celda.setCellValue(filaI.getImporteConcedido() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getImporteConcedido(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(27);
                    celda.setCellValue(filaI.getImporteRenuncia() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getImporteRenuncia(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    ...
                    {
                        valor = valor.replaceAll("-OBSERVACIONES:", " - "+meLanbide60I18n.getMensaje(idioma, "doc.informeEconomico.observaciones").toUpperCase()+":");
                    }
                    celda.setCellValue(valor);
                    ...
                    estiloCelda.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
                    celda = fila.createCell(29);
                    celda.setCellValue(filaI.getImpConcedidoTrasResol() != null ? MeLanbide60Utils.redondearDecimalesBigDecimal(filaI.getImpConcedidoTrasResol(), 2).doubleValue() : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).doubleValue());
                    celda.setCellStyle(estiloCelda);
                    celda.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
                    
                    if(!"TOTAL".equals(filaI.getCnae09()))
                        crearDatosHoja2Economico(libro, fila2, celda2, estiloCelda2, idioma, filaI,numExp, numFila2, nuevo, listaPuestos, datosTercero,  normal, codOrganizacion, ano,  adapt, p);
                }
...
//                    hoja2.addMergedRegion(new Region(numFila2-p, (short)0, numFila2, (short)0));
//                    hoja2.addMergedRegion(new Region(numFila2-p, (short)1, numFila2, (short)1));
//                    hoja2.addMergedRegion(new Region(numFila2-p, (short)2, numFila2, (short)2));
//                    hoja2.addMergedRegion(new Region(numFila2-p, (short)3, numFila2-1, (short)3));
//                    
...
//                    
//                    hoja2.getRow(numFila2-p).getCell((short)0).setCellStyle(estiloCelda2);
//                    
//                    estiloCelda2 = libro.createCellStyle();
//                    estiloCelda2.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);
...
//                    estiloCelda2.setFont(normal);
//                    
//                    hoja2.getRow(numFila2-p).getCell((short)1).setCellStyle(estiloCelda2);
                }
...
//            estiloCelda.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);
            ...
            {
                datosTercero = MeLanbide60Manager.getInstance().getDatosTercero(codOrganizacion, numExpediente, String.valueOf(ano), ConstantesMeLanbide60.CODIGO_ROL_ENTIDAD_SOLICITANTE, adapt);
                if(datosTercero.containsKey("TER_NOC"))
                {
                    empresa = datosTercero.get("TER_NOC");
                }
...
//                        }
    ...
    private void crearEstiloInformeDatosPuestos(HSSFWorkbook libro, HSSFRow fila, HSSFCell celda, HSSFCellStyle estiloCelda, int idioma)
    {
        try
        {
            ...
            try 
            {
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(0);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col1").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(1);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col2").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(2);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col3").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(3);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col4").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(4);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col5").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(5);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col6").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(6);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col7").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(7);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col8").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(8);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col9").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(9);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col10").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(10);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col11").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(11);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col12").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(12);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col13").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(13);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col14").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(14);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col15").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(15);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col16").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(16);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col17").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(17);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col18").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(18);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col19").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(19);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col20").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(20);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col21").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(21);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col22").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(22);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col23").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(23);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col24").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(24);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col25").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(25);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col26").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(26);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col27").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(27);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col28").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(28);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestos.col29").toUpperCase());
                celda.setCellStyle(estiloCelda);
            }
            catch (Exception e) 
            {
    ...
    HSSFFont normal, int codOrganizacion, int ano, AdaptadorSQLBD adapt, SimpleDateFormat format)
    {
        try
        {
            ...
            celda = fila.createCell(20);
            celda.setCellValue(filaI.getSalarioSSBonif()!= null ? filaI.getSalarioSSBonif() : "");
            celda.setCellStyle(estiloCelda);
    ...
    private void crearEstiloInformeDatosPuestosHoja2(HSSFWorkbook libro, HSSFRow fila, HSSFCell celda, HSSFCellStyle estiloCelda, int idioma)
    {
        try
        {
            ...
            try 
            {
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(0);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col1").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(1);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col2").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(2);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col3").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(3);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col4").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(4);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col5").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(5);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col6").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(6);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col7").toUpperCase());
                celda.setCellStyle(estiloCelda);
                ...
                estiloCelda.setFont(negritaTitulo);
                celda = fila.createCell(7);
                celda.setCellValue(meLanbide60I18n.getMensaje(idioma, "doc.informeDatosPuestosHoja2.col8").toUpperCase());
                celda.setCellStyle(estiloCelda);
            }
            catch (Exception e) 
            {
    ...
    private String cargarSubpestanaSolicitud_DatosCme(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaPuestoVO> puestos = MeLanbide60Manager.getInstance().getListaPuestosPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide60/solicitud.jsp";
    }
    ...
    private String cargarSubpestanaOferta_DatosCme(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaOfertaVO> ofertas = MeLanbide60Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide60/oferta.jsp";
    }
    ...
    private String cargarSubpestanaJustificacion_DatosCme(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaJustificacionVO> justificaciones = MeLanbide60Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide60/justificacion.jsp";
    }
    ...
    private String cargarSubpestanaResumen_DatosCme(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaResumenVO> filasResumen = MeLanbide60Manager.getInstance().getListaResumenPorExpediente(numExpediente, adapt);
        ...
        return "/jsp/extension/melanbide60/resumen.jsp";
    }
    
    private String cargarSubpestanaResumenHist_DatosCme(String numExpediente, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaResumenVO> filasResumen = MeLanbide60Manager.getInstance().getListaResumenHistPorExpediente(numExpediente, adapt);
            log.error("antes de establecer el atributo resumen del request");
            request.setAttribute("resumen", filasResumen);
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
            log.error("Error en cargarSubpestanaResumenHist_DatosCpe: " + ex);
        }
        return "/jsp/extension/melanbide60/resumen.jsp";
    }
    ...
    private String cargarSubpestanaSolicitudHist_DatosCme(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaPuestoVO> puestos = MeLanbide60Manager.getInstance().getListaPuestosHistPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("puestos", puestos);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide60/solicitudHist.jsp";
    }
    ...
    private String cargarSubpestanaOfertaHist_DatosCme(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaOfertaVO> ofertas = MeLanbide60Manager.getInstance().getListaOfertasHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("ofertas", ofertas);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide60/ofertaHist.jsp";
    }
    ...
    private String cargarSubpestanaJustificacionHist_DatosCme(int codOrganizacion, String numExpediente, String codTramite, AdaptadorSQLBD adapt, HttpServletRequest request)
    {
        try
        {
            List<FilaJustificacionVO> justificaciones = MeLanbide60Manager.getInstance().getListaJustificacionesHistNoDenegadasPorExpediente(codOrganizacion, numExpediente, codTramite, adapt);
            request.setAttribute("justificaciones", justificaciones);
        }
        catch(Exception ex)
        {
        ...
        return "/jsp/extension/melanbide60/justificacionHist.jsp";
    }
    
    public void cargarDatosCme(int codOrganizacion, String numExpediente, HttpServletRequest request)
    {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
            ...
            listaGestores = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        if(ejercicio != null)
        {
            ...
            try
            {
                ...
                String gestor = MeLanbide60Manager.getInstance().getValorCampoDesplegable(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide60.FICHERO_PROPIEDADES), adaptador);
            ...
            try
            {
                String empresa = MeLanbide60Manager.getInstance().getValorCampoTexto(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide60.FICHERO_PROPIEDADES), adaptador);
                ...
                else
                {
                    ...
                    HashMap<String, String> datosTercero = MeLanbide60Manager.getInstance().getDatosTercero(codOrganizacion, numExpediente, String.valueOf(ejercicio), ConstantesMeLanbide60.CODIGO_ROL_ENTIDAD_SOLICITANTE, adaptador);
            ...
            if(calculos != null)
            {
                ...
                try
                {
                    impSolicitado = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_SOLICITADO);
                    ...
                    {
                        request.setAttribute("solicitado", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impConv = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CONVOCATORIA);
                    if(impConv != null)
                    {
                    ...
                    {
                        request.setAttribute("convocatoria", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPrevCon = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PREV_CON);
                    if(impPrevCon != null)
                    {
                    ...
                    {
                        request.setAttribute("previsto", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    concedido = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CON);
                    if(concedido != null)
                    {
                    ...
                    {
                        request.setAttribute("concedido", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    justificado = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_JUS);
                    if(justificado != null)
                    {
                    ...
                    {
                        request.setAttribute("justificado", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    noJustificado = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_NO_JUS);
                    ...
                    {
                        request.setAttribute("noJustificado", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    renunciado = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN);
                    if(renunciado != null)
                    {
                    ...
                    {
                        request.setAttribute("renunciado", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    renunciadoRes = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN_RES);
                    ...
                    {
                        request.setAttribute("renunciadoRes", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPag = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG);
                    if(impPag != null)
                    {
                    ...
                    {
                        request.setAttribute("pagado", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPagRes = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_RES);
                    if(impPagRes != null)
                    {
                    ...
                    {
                        request.setAttribute("pagadoRes", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impPag2 = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_2);
                    if(impPag2 != null)
                    {
                    ...
                    {
                        request.setAttribute("pagado2", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    reint = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REI);
                    if(reint != null)
                    {
                    ...
                    {
                        request.setAttribute("reintegrar", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    oayuS = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                    if(oayuS != null)
                    {
                    ...
                    {
                        request.setAttribute("otrasAyudasSolic", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    oayuC = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                    if(oayuC != null)
                    {
                    ...
                    {
                        request.setAttribute("otrasAyudasConce", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    minS = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_SOLIC);
                    if(minS != null)
                    {
                    ...
                    {
                        request.setAttribute("minimisSolic", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    minC = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_CONCE);
                    if(minC != null)
                    {
                    ...
                    {
                        request.setAttribute("minimisConce", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impDesp = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_DESP);
                    if(impDesp != null)
                    {
                    ...
                    {
                        request.setAttribute("importeDespido", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    impBaj = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BAJA);
                    if(impBaj != null)
                    {
                    ...
                    {
                        request.setAttribute("importeBajas", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("concedidoReal", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("pagadoReal", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
                ...
                try
                {
                    ...
                    {
                        request.setAttribute("pagadoReal2", new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES).toPlainString());
                    }
                }
                catch(Exception ex)
                {
        ...
        try
        {
            ...
            Long codTramRes = MeLanbide60Manager.getInstance().obtenerCodigoInternoTramite(codOrganizacion, ConstantesMeLanbide60.CODIGO_TRAMITE_RESOLUCION, adapt);
            if(codTramRes != null)
            {
                if(MeLanbide60Manager.getInstance().tieneTramiteFinalizado(codOrganizacion, ejercicio, numExpediente, codTramRes, this.getAdaptSQLBD(String.valueOf(codOrganizacion))))
                {
            ...
            {
                //Miro a ver si tiene iniciado el tramite de "Resolucion de concesion o denegacion"
                Long codTramResModif = MeLanbide60Manager.getInstance().obtenerCodigoInternoTramite(codOrganizacion, ConstantesMeLanbide60.CODIGO_TRAMITE_RESOLUCION_MODIF, adapt);
                if(codTramResModif != null)
                {
                    if(MeLanbide60Manager.getInstance().tieneTramiteFinalizado(codOrganizacion, ejercicio, numExpediente, codTramResModif, this.getAdaptSQLBD(String.valueOf(codOrganizacion))))
                    {
    ...
    public void getListaResumenPorExpediente(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            {
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                filasResumen = MeLanbide60Manager.getInstance().getListaResumenPorExpediente(numExpediente, adapt);
    ...
    private void escribirListaResumenRequest(String codigoOperacion, List<FilaResumenVO> filasResumen, HttpServletResponse response)
    {
        ...
        for(FilaResumenVO filaResumen : filasResumen)
        {
            xmlSalida.append("<FILA>");
                ...
                xmlSalida.append("</MESES_CONTRATO>");        
                //xmlSalida.append("<IMP_MAX_SUBV>");//SERGIO
                  //  xmlSalida.append(filaResumen.getImporteMaxSubv());//SERGIO
                //xmlSalida.append("</IMP_MAX_SUBV>");//SERGIO
                xmlSalida.append("<IMP_CONC>");//SERGIO
                    xmlSalida.append(filaResumen.getImporteConcedido());//SERGIO
                xmlSalida.append("</IMP_CONC>");//SERGIO  
...
//                xmlSalida.append("</CONTRATO_BONIF>");
                ...
                xmlSalida.append("</D>");
                xmlSalida.append("<GASTOS_SEG_SOL>");
                xmlSalida.append(filaResumen.getGastosSeguroSol());
                xmlSalida.append("</GASTOS_SEG_SOL>");
                xmlSalida.append("<GASTOS_SEG_JUS>");
                xmlSalida.append(filaResumen.getGastosSeguroJus());
                xmlSalida.append("</GASTOS_SEG_JUS>");
                xmlSalida.append("<GASTOS_SEG_SUB>");
                xmlSalida.append(filaResumen.getGastosSeguroSub());
                xmlSalida.append("</GASTOS_SEG_SUB>");
                xmlSalida.append("<GASTOS_VIS_SOL>");
                xmlSalida.append(filaResumen.getGastosVisadoSol());
                xmlSalida.append("</GASTOS_VIS_SOL>");
                xmlSalida.append("<GASTOS_VIS_JUS>");
                xmlSalida.append(filaResumen.getGastosVisadoJus());
                xmlSalida.append("</GASTOS_VIS_JUS>");
                xmlSalida.append("<GASTOS_VIS_SUB>");
                xmlSalida.append(filaResumen.getGastosVisadoSub());
                xmlSalida.append("</GASTOS_VIS_SUB>");
...
//                String obs = (String)request.getParameter("observaciones");
                ...
                if(codOferta != null && !codOferta.equals("") && codPuesto != null && !codPuesto.equals(""))
                {
                    ...
                    oferta.setExpEje(ejercicio);
                    oferta.setCodPuesto(codPuesto);
                    oferta = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, adaptador);
                }
                else
                {
                    oferta = new CmeOfertaVO();
                ...
                else
                {
                    ...
                    if(difu != null && difu.equalsIgnoreCase(ConstantesMeLanbide60.CIERTO))
                    {
                    ...
                    if(contratacion != null && contratacion.equalsIgnoreCase(ConstantesMeLanbide60.FALSO))
                    {
                    ...
                    if(contratacionPresOferta != null && contratacionPresOferta.equalsIgnoreCase(ConstantesMeLanbide60.FALSO))
                    {
                    ...
                    if(prec != null && prec.equalsIgnoreCase(ConstantesMeLanbide60.CIERTO))
                    {
                    ...
                    MeLanbide60Manager.getInstance().guardarCmeOfertaVO(codOrganizacion, oferta, alta, copiar, adaptador);
                    
                    
                    ////#241414--calcular dias contrato
                    ...
                    if ( oferta.getNif()!=null && !oferta.getNif().isEmpty() && oferta.getFecIni()!=null && oferta.getFecFin()!=null){
                        ...
                        justifModif.setEjercicio(oferta.getExpEje());                     
                        justifModif.setIdOferta(oferta.getIdOferta());
                        justifModif.setNumExpediente(oferta.getNumExp());
                        justifModif = MeLanbide60Manager.getInstance().getJustificacionPorCodigoPuestoOfertaYExpediente(justifModif, adaptador);                    
                        int dias=0;                        
                         String rdo = MeLanbide60Manager.getInstance().obtenerDiasTrabajados(oferta.getNumExp(), oferta.getCodPuesto(),oferta.getIdOferta(), adaptador);
                        ...
                        MeLanbide60Manager.getInstance().guardarCmeJustificacionVO(codOrganizacion,justifModif, adaptador) ;
                    }
                }
            }
            else
        ...
        return "/jsp/extension/melanbide60/recargarListaOfertas.jsp?numExp="+numExpediente;
    }
    ...
    public void descargarDocumentoOferta(int codOrganizacion,  int codTramite, int ocurrenciaTramite,String numExpediente,HttpServletRequest request,HttpServletResponse response)
    {
        try
        {
            ...
            if(idOferta != null && !idOferta.equals(""))
            {
                ...
                oferta.setCodPuesto(codPuesto);
                AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                oferta = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(oferta, adapt);
                if(oferta != null)
                {
    ...
    public void eliminarOferta(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                {
                    MeLanbide60Manager.getInstance().eliminarCmeOfertaVO(codOrganizacion, oferta, adaptador);
                }
                ofertas = MeLanbide60Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adaptador);
                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
                datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adaptador);
            }
            else
    ...
    public void altaSustituto(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(codigoOperacion.equals("0"))
            {
                ...
                ofertaOrigen = MeLanbide60Manager.getInstance().getOfertaPorCodigoPuestoYExpediente(ofertaOrigen, adapt);
                if(ofertaOrigen != null)
                {
                    ...
                    MeLanbide60Manager.getInstance().guardarCmeOfertaVO(codOrganizacion, ofertaNueva, "1", copiar, adapt);
                    ofertas = MeLanbide60Manager.getInstance().getListaOfertasNoDenegadasPorExpediente(numExpediente, adapt);
                    calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adapt);
                    datos = MeLanbide60Manager.getInstance().obtenerDatosCme(codOrganizacion,numExpediente,adapt);
                }
...
//                    justif.setNumExpediente(numExpediente);
//                    justif.setEjercicio(ejercicio);
//                    justif = MeLanbide60Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justif, adaptador);
//                }
//                else
//                {
//                    justif = new CmeJustificacionVO();
...
//                    MeLanbide60Manager.getInstance().guardarCmeJustificacionVO(codOrganizacion, justif, adaptador);
//                }
//                calculos = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
//                
//                CmePuestoVO puesto = new CmePuestoVO();
...
//                if(puesto != null)
//                {
//                    justificaciones = MeLanbide60Manager.getInstance().getListaJustificacionesNoDenegadasPorExpediente(numExpediente, adaptador);
//                }
//            }
//            else
//            {
...
//    }
    ...
    public void guardarDatosContratacion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                if(puesto != null)
                {
                    personasContratadas = MeLanbide60Manager.getInstance().getListaContratacionesPuesto(puesto, adaptador);
                }
            }
            else
            {
    ...
    private boolean validarDatosCme(HttpServletRequest request)
    {
        try
        {
            ...
            if(!MeLanbide60Validator.validarTexto(empresa, 500))
            {
                return false;
            }
            if(!MeLanbide60Validator.validarNumericoDecimal(impSubvAprobadaExp, 10, 2))
            {
                return false;
            }
            if(!MeLanbide60Validator.validarNumericoDecimal(impSubvAprobadaConv, 10, 2))
            {
                return false;
            }
            if(!MeLanbide60Validator.validarNumericoDecimal(otrasAyudas, 10, 2))
            {
                return false;
            }
            if(!MeLanbide60Validator.validarNumericoDecimal(impSubvFinal, 10, 2))
            {
                return false;
            }
            return true;
    ...
    private void cargarCombosNuevoPuesto(int codOrganizacion, HttpServletRequest request)
    {
        ...
        try
        {
            listaPaises = MeLanbide60Manager.getInstance().getListaPaises(this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_IDIOMA, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaIdiomas = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_NIVEL_IDIOMA, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaNivelIdiomas = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_NIVEL_FORMATIVO, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaNivelFormativo = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_GRUPO_COTIZACION, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaGrupoCotizacion = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list, SelectItem.ORDENAR_POR_CODIGO);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_RESULTADO, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaResultado = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_MOTIVO, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaMotivos = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
    ...
    private void cargarCombosNuevaOferta(int codOrganizacion, HttpServletRequest request)
    {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_OFICINAS_LANBIDE, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaOficinasLanbide = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            ...
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaGrupoCot = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list, SelectItem.ORDENAR_POR_CODIGO);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_CAUSA_BAJA, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaBaja = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            listaTipoDoc = MeLanbide60Manager.getInstance().getTiposDocumento(this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegable = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_CAUSA_RENUNCIA, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegable);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaRenuncia = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
        ...
        try
        {
            String campoDesplegablePresOferta = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_CAUSA_RENUNCIA, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
        
            SalidaIntegracionVO salidaIntegracion = el.getCampoDesplegable(String.valueOf(codOrganizacion), campoDesplegablePresOferta);
            list = salidaIntegracion.getCampoDesplegable().getValores();
            listaCausaRenunciaPresOferta = MeLanbide60MappingUtils.getInstance().fromCampoDesplegableToSelectItemVO(list);
        }
        catch(Exception ex)
        {
    ...
    private void cargarImportesJustificacion(String numExpediente, int codOrganizacion, CmePuestoVO puesto, HttpServletRequest request)
    {
            ...
            try
            {
                ...
                /*concedido = MeLanbide60Manager.getInstance().getValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, codigoCampo, adapt);
                if(concedido != null)
                {
                    request.setAttribute("concedido", concedido.toPlainString());
                }
                ...
                if(puesto != null)
                {
                    if(puesto.getCodResult() != null && puesto.getCodResult().equalsIgnoreCase(ConstantesMeLanbide60.CODIGO_RESULTADO_CONCEDIDO))
                    {
                        concedido = puesto.getImpMaxSuv() != null ? puesto.getImpMaxSuv().add(new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES)) : new BigDecimal(ConstantesMeLanbide60.CERO_CON_DECIMALES);
                    }
                }
                if(concedido == null)
                {
            ...
            try
            {
                codigoCampo = ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN, ConstantesMeLanbide60.FICHERO_PROPIEDADES);
                renunciado = MeLanbide60Manager.getInstance().getValorCampoNumerico(codOrganizacion, String.valueOf(ejercicio), numExpediente, codigoCampo, adapt);
                if(renunciado != null)
                {
                    request.setAttribute("renunciado", renunciado.toPlainString());
                }
    ...
    private void escribirListaPuestosRequest(String codigoOperacion, List<FilaPuestoVO> puestos, Map<String, BigDecimal> calculos, datosCmeVO datos,  HttpServletResponse response)
    {
        ...
        if(calculos != null && !calculos.isEmpty())
        {
            ...
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_SOLICITADO))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_SOLICITADO);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_SOL>");
            
            xmlSalida.append("<IMP_CONV>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CONVOCATORIA))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CONVOCATORIA);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_CONV>");
            
            xmlSalida.append("<IMP_PREV_CON>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PREV_CON))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PREV_CON);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PREV_CON>");
            
            xmlSalida.append("<IMP_CON>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CON))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CON);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_CON>");
            
            xmlSalida.append("<IMP_JUS>");
//            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_JUS))
//            {
//                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_JUS);
//                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
//            }
            ...
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_REN>");
            
            xmlSalida.append("<IMP_PAG>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG>");
            
            xmlSalida.append("<IMP_PAG_2>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_2))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_2);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG_2>");
            
            xmlSalida.append("<IMP_REI>");
//            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REI))
//            {
//                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REI);
//                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
//            }
            ...
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</OTRAS_AYUDAS_SOLIC>");
            
            xmlSalida.append("<OTRAS_AYUDAS_CONCE>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_CONCE))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</OTRAS_AYUDAS_CONCE>");
            
            xmlSalida.append("<MINIMIS_SOLIC>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_SOLIC))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_SOLIC);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</MINIMIS_SOLIC>");
            
            xmlSalida.append("<MINIMIS_CONCE>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_CONCE))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_CONCE);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</MINIMIS_CONCE>");
            ...
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_DESP);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_DESP>");
            
            xmlSalida.append("<IMP_BAJA>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BAJA))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BAJA);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_BAJA>");
...
//            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_NO_JUS))
//            {
//                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_NO_JUS);
//                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
//            }
            ...
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN_RES))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN_RES);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_REN_RES>");
            
            xmlSalida.append("<IMP_PAG_RES>");
            if(calculos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_RES))
            {
                BigDecimal bd = calculos.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_RES);
                xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
            }
            xmlSalida.append("</IMP_PAG_RES>");
            xmlSalida.append("</CALCULOS>");
...
//            }
     ...
     public void calcularMeses(int codOrganizacion, int codTramite, int ocurrenciaTramite,   String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            meses = MeLanbide60Manager.getInstance().getNumMeses(fini, ffin, adaptador);
        }catch(Exception e){
                e.printStackTrace();
        }
        ...
        try
        {
            ...
            if(ejercicio != null)
            {
                ...
                CmePuestoVO puesto = new CmePuestoVO();
                    ...
                    oferta = MeLanbide60Manager.getInstance().copiarDatosPuesto(codOrganizacion, puesto, oferta, adaptador);
                    StringBuffer xmlSalida = new StringBuffer();
                    xmlSalida.append("<RESPUESTA>");
                        ...
                        xmlSalida.append("<DESCTITU1>");                            
                             desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit1(), adaptador);
                             xmlSalida.append(oferta.getCodTit1()!=null?desc:"");
                        xmlSalida.append("</DESCTITU1>");
                        xmlSalida.append("<DESCTITU2>");
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit2(), adaptador);
                            xmlSalida.append(oferta.getCodTit2()!=null?desc:"");
                        xmlSalida.append("</DESCTITU2>");
                        xmlSalida.append("<DESCTITU3>"); 
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTit3(), adaptador);
    ...
    public String cargarDatosPersonaContratada(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
            ...
            if(opcion != null)
            {
                ...
                if(idOferta != null && !idOferta.equals("") && idPuesto != null && !idPuesto.equals(""))
                {
                    ...
                    if(oferta != null)
                    {
                        ...
                        if(oferta.getCodTitulacion() != null && !oferta.getCodTitulacion().equals(""))
                        {
                            desc = MeLanbide60Manager.getInstance().getDescripcionTitulacion(oferta.getCodTitulacion(), adaptador);
                            if(desc != null)
                            {
                                request.setAttribute("descTitContratado", desc);
                            }
                    ...
                    justifModif = MeLanbide60Manager.getInstance().getJustificacionPorCodigoPuestoYExpediente(justifModif, adaptador);
                    
                    int dias=0;
                    //Leire, cálculo de días
                    //String rdo = MeLanbide60Manager.getInstance().obtenerDiasTrabajados(numExpediente, oferta.getNif(), adaptador);
                     String rdo = MeLanbide60Manager.getInstance().obtenerDiasTrabajados(numExpediente, idPuesto, Integer.parseInt(idOferta), adaptador);
                    if(rdo != null && !rdo.equals(""))
                        dias = Integer.parseInt(rdo);
                    else
                        dias = 0;
        ...
        return "/jsp/extension/melanbide60/datosPersonaContratada.jsp";
    }
    ...
    public void buscarTitulaciones(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
            listaTitulaciones = MeLanbide60Manager.getInstance().buscarTitulaciones(codigo, desc, adapt);
        }
        catch(Exception ex)
        {
            codigoOperacion = "2";
    ...
    public void getTodosCamposSuplementarios(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        {
            AdaptadorSQLBD adaptador = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
            importes = MeLanbide60Manager.getInstance().cargarCalculosCme(codOrganizacion, ejercicio, numExpediente, adaptador);
        
            puestos = MeLanbide60Manager.getInstance().cargarCalculosPuestos(codOrganizacion, ejercicio, numExpediente, adaptador);
        
            //Cargo el gestor tramitador, empresa e importes de la subvencion (camposSuplementarios)
            gestor = MeLanbide60Manager.getInstance().getValorCampoDesplegable(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_GESTOR_TRAMITADOR, ConstantesMeLanbide60.FICHERO_PROPIEDADES), adaptador);
        
            empresa = MeLanbide60Manager.getInstance().getValorCampoTexto(codOrganizacion, String.valueOf(ejercicio), numExpediente, ConfigurationParameter.getParameter(ConstantesMeLanbide60.CAMPO_SUPL_EMPRESA, ConstantesMeLanbide60.FICHERO_PROPIEDADES), adaptador);
            ...
            if(importes != null && !importes.isEmpty())
            {
                ...
                xmlSalida.append("<IMP_SOL>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_SOLICITADO))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_SOLICITADO);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_SOL>");

                xmlSalida.append("<IMP_CONV>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CONVOCATORIA))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CONVOCATORIA);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_CONV>");

                xmlSalida.append("<IMP_PREV_CON>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PREV_CON))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PREV_CON);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PREV_CON>");

                xmlSalida.append("<IMP_CON>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CON))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_CON);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_CON>");

                xmlSalida.append("<IMP_JUS>");
//                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_JUS))
//                {
//                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_JUS);
//                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
//                }
                xmlSalida.append(datos.getImpJustificado().replaceAll("\\.", ","));
                xmlSalida.append("</IMP_JUS>");
                ...
                xmlSalida.append("<IMP_REN_RES>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN_RES))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN_RES);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_REN_RES>");
                
                xmlSalida.append("<IMP_REN>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_REN>");

                xmlSalida.append("<IMP_PAG>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PAG>");

                xmlSalida.append("<IMP_PAG_2>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_2))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_PAG_2);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_PAG_2>");

                xmlSalida.append("<IMP_REI>");
//                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REI))
//                {
//                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REI);
//                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
//                }
                xmlSalida.append(datos.getReintegro().replaceAll("\\.", ","));
                xmlSalida.append("</IMP_REI>");
                ...
                xmlSalida.append("<OTRAS_AYUDAS_SOLIC>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_SOLIC);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</OTRAS_AYUDAS_SOLIC>");

                xmlSalida.append("<OTRAS_AYUDAS_CONCE>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_CONCE))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_OTRAS_AYUDAS_CONCE);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</OTRAS_AYUDAS_CONCE>");

                xmlSalida.append("<MINIMIS_SOLIC>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_SOLIC))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_SOLIC);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</MINIMIS_SOLIC>");

                xmlSalida.append("<MINIMIS_CONCE>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_CONCE))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_MINIMIS_CONCE);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</MINIMIS_CONCE>");
                ...
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_REN))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_DESP);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_DESP>");

                xmlSalida.append("<IMP_BAJA>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BAJA))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BAJA);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_BAJA>");

                xmlSalida.append("<IMP_BONIF>");
                if(importes.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BONIF))
                {
                    BigDecimal bd = importes.get(ConstantesMeLanbide60.CAMPO_SUPL_IMP_BONIF);
                    xmlSalida.append(bd.toPlainString().replaceAll("\\.", ","));
                }
                xmlSalida.append("</IMP_BONIF>");
                xmlSalida.append("</IMPORTES>");
                ...
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_SOLICITADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_SOLICITADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_SOLICITADOS>");
            
                xmlSalida.append("<PUESTOS_DENEGADOS>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_DENEGADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_DENEGADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_DENEGADOS>");
            
                xmlSalida.append("<PUESTOS_CONTRATADOS>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_CONTRATADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_CONTRATADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_CONTRATADOS>");
            
                xmlSalida.append("<PERSONAS_CONTRATADAS>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_CONTRATADAS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_CONTRATADAS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_CONTRATADAS>");
            
                xmlSalida.append("<PUESTOS_DESPIDO>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_DESPIDO))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_DESPIDO);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_DESPIDO>");
            
                xmlSalida.append("<PERSONAS_DESPIDO>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_DESPIDO))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_DESPIDO);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_DESPIDO>");
            
                xmlSalida.append("<PUESTOS_BAJA>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_BAJA))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_BAJA);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_BAJA>");
            
                xmlSalida.append("<PERSONAS_BAJA>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_BAJA))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PERSONAS_BAJA);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PERSONAS_BAJA>");
            
                xmlSalida.append("<PUESTOS_RENUNCIADOS>");
                if(puestos.containsKey(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_RENUNCIADOS))
                {
                    Integer i = puestos.get(ConstantesMeLanbide60.CAMPO_SUPL_PUESTOS_RENUNCIADOS);
                    xmlSalida.append(i.toString());
                }
                xmlSalida.append("</PUESTOS_RENUNCIADOS>");
     ...
     {
        Integer ejercicio = MeLanbide60Utils.getEjercicioDeExpediente(numExpediente);
        MeLanbide60Manager.getInstance().grabarImportesResolucion(codOrganizacion, ejercicio, numExpediente, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
     }
     ...
     {
        Integer ejercicio = MeLanbide60Utils.getEjercicioDeExpediente(numExpediente);
        MeLanbide60Manager.getInstance().grabarImportesResolucionModif(codOrganizacion, ejercicio, numExpediente, this.getAdaptSQLBD(String.valueOf(codOrganizacion)));
     }
     ...
     public String cargarImportesResolucion(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
     {
         ...
         try
         {
            ...
            if(ejercicio != null)
            {
                if(res != null && !res.equals(""))
                {
                    ...
                    AdaptadorSQLBD adapt = this.getAdaptSQLBD(String.valueOf(codOrganizacion));
                    HashMap<String, Object> valores = MeLanbide60Manager.getInstance().cargarImportesResolucion(codOrganizacion, ejercicio, numExpediente, res, adapt);
                    ...
                    while(it.hasNext())
                    {
                        ...
                        {
                            str = MeLanbide60Utils.redondearDecimalesString((BigDecimal)valor, 2);
                        }
                ...
                {
                    request.setAttribute("error", MeLanbide60I18n.getInstance().getMensaje(codIdioma, "error.datosRes.resNoDeterminada"));
                }
            }
            else
            {
                request.setAttribute("error", MeLanbide60I18n.getInstance().getMensaje(codIdioma, "error.datosRes.ejercicioNoDeterminado"));
            }
         }
         catch(Exception ex)
         {
         ...
         return "/jsp/extension/melanbide60/datosResolucion.jsp";
     }
     ...
     public String cargarHistorico(int codOrganizacion, int codTramite, int ocurrenciaTramite, String numExpediente, HttpServletRequest request, HttpServletResponse response)
     {
        ...
        try
        {
            ...
            if (request != null) {
                ...
                log.debug("resumen1");
                log.debug("resumen2");
                url = cargarSubpestanaResumenHist_DatosCme(numExpediente, adapt, request);
                log.debug("resumen3");
                if(url != null)
                {
                    request.setAttribute("urlPestanaDatos_resumen", url);
        ...
        return "/jsp/extension/melanbide60/datosCmeHist.jsp";
     }
