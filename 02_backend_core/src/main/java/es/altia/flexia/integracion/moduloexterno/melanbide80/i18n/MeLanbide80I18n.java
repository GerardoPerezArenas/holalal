...
package es.altia.flexia.integracion.moduloexterno.melanbide80.i18n;
...
public class MeLanbide80I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle("MELANBIDE80");
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide80I18n instance = null; 

    
    public static MeLanbide80I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide80I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide80I18n();
                }
            }
        }
        return instance;
