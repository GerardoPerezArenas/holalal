package es.altia.flexia.integracion.moduloexterno.melanbide83.i18n;

import es.altia.flexia.integracion.moduloexterno.melanbide83.util.ConstantesMeLanbide83;
import java.util.HashMap;
import java.util.ResourceBundle;

public class MeLanbide83I18n 
{
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide83.getFICHERO_PROPIEDADES());
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide83I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide83I18n getInstance()
    {
        if(instance == null)
        {
            synchronized(MeLanbide83I18n.class)
            {
                if(instance == null)
                {
                    instance = new MeLanbide83I18n();
                }
            }
        }
        return instance;
