 ...
 */
package es.altia.flexia.integracion.moduloexterno.melanbide53.i18n;
 ...
 * @author davidg
 */
public class MeLanbide53I18n {
    
    private static ResourceBundle bundlePropiedades = ResourceBundle.getBundle(ConstantesMeLanbide53.FICHERO_PROPIEDADES);
    
    private static HashMap<Integer,ResourceBundle> arrayBundleMensajes = new HashMap<Integer, ResourceBundle>();
    
    private static MeLanbide53I18n instance = null;
    
    public static String LATIN_DATE_FORMAT = "dd/MM/yyyy";
    public static String DESC_DATE_FORMAT_SLASH = "yyyy/MM/dd";
    
    public static MeLanbide53I18n getInstance(){
        if(instance == null){
            synchronized(MeLanbide53I18n.class){
                if(instance == null){
                    instance = new MeLanbide53I18n();
                }//if(instance == null)
            }//synchronized(MeLanbide53I18n.class)
        }//if(instance == null)
        return instance;
