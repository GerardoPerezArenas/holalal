...
public class ConstantesMeLanbide67 {
    ...
    public static final String BARRA_SEPARADORA_IDIOMA = "BARRA_SEPARADORA_IDIOMA";
    // pipe
    ...
    public static final String TABLA_TIPO_DATO_DESPLEGABLE_EXTERNO = "TABLA_TIPO_DATO_DESPLEGABLE_EXTERNO";
    public static final String TABLA_TIPO_DATO_FECHA = "TABLA_TIPO_DATO_FECHA";
    public static final String TABLA_TIPO_DATO_FICHERO = "TABLA_TIPO_DATO_FICHERO";
 ...
 /*public static final String TABLA_CPE_PUESTO = "TABLA_CPE_PUESTO";
    ...
    public static final String TABLA_TIPO_DATO_SUPL = "TABLA_TIPO_DATO_SUPL";
    ...
    public static final String CAMPO_SUPL_DNI_PER_CON = "CAMPO_SUPL_DNI_PER_CON";
    public static final String CAMPO_SUPL_NOM_PER_CON = "CAMPO_SUPL_NOM_PER_CON";
    public static final String CAMPO_SUPL_APE1_PER_CON = "CAMPO_SUPL_APE1_PER_CON";
    public static final String CAMPO_SUPL_APE2_PER_CON = "CAMPO_SUPL_APE2_PER_CON";
    public static final String CAMPO_SUPL_FECNAC_PER_CON = "CAMPO_SUPL_FECNAC_PER_CON";
    public static final String CAMPO_SUPL_EDAD_PER_CON = "CAMPO_SUPL_EDAD_PER_CON";
    public static final String CAMPO_SUPL_SEXO_PER_CON = "CAMPO_SUPL_SEXO_PER_CON";
    public static final String CAMPO_SUPL_MUN_PER_CON = "CAMPO_SUPL_MUN_PER_CON";
    public static final String CAMPO_SUPL_EXP6M_PER_CON = "CAMPO_SUPL_EXP6M_PER_CON";
    public static final String CAMPO_SUPL_DESEMP_ANT = "CAMPO_SUPL_DESEMP_ANT";
    public static final String CAMPO_SUPL_SIST_GARANT_JUVE = "CAMPO_SUPL_SIST_GARANT_JUVE";
    public static final String CAMPO_SUPL_DOC_CV_INTER = "CAMPO_SUPL_DOC_CV_INTER";
    public static final String CAMPO_SUPL_DOC_DEMANDA_INTER = "CAMPO_SUPL_DOC_DEMANDA_INTER";
    public static final String CAMPO_SUPL_FEC_DEMANDA_INTER = "CAMPO_SUPL_FEC_DEMANDA_INTER";
    public static final String CAMPO_SUPL_FEC_CV_INTER = "CAMPO_SUPL_FEC_CV_INTER";
    public static final String CAMPO_SUPL_DESEMPLEADO = "CAMPO_SUPL_DESEMPLEADO";
    public static final String CAMPO_SUPL_FEC_INI_CONTR = "CAMPO_SUPL_FEC_INI_CONTR";
    public static final String CAMPO_SUPL_MUJ_SUBREPRE = "CAMPO_SUPL_MUJ_SUBREPRE";
    public static final String CAMPO_SUPL_NUM_CTA_COTSS = "CAMPO_SUPL_NUM_CTA_COTSS";
    public static final String CAMPO_SUPL_DIR_CENT_TRAB = "CAMPO_SUPL_DIR_CENT_TRAB";
    public static final String CAMPO_SUPL_GRUP_COTSS = "CAMPO_SUPL_GRUP_COTSS";
    public static final String CAMPO_SUPL_JOR_PUESTA = "CAMPO_SUPL_JOR_PUESTA";
    public static final String CAMPO_SUPL_MOD_CONTRATO = "CAMPO_SUPL_MOD_CONTRATO";
    public static final String CAMPO_SUPL_TIT_PUESTRA = "CAMPO_SUPL_TIT_PUESTRA";
    public static final String CAMPO_SUPL_MOD_CODOCU = "CAMPO_SUPL_MOD_CODOCU";
    public static final String CAMPO_SUPL_MON_PUESTO_TRA = "CAMPO_SUPL_MON_PUESTO_TRA";
    public static final String CAMPO_SUPL_FEC_REAL_FIN_CONTR = "CAMPO_SUPL_FEC_REAL_FIN_CONTR";
    public static final String CAMPO_SUPL_FEC_FIN_CONTR = "CAMPO_SUPL_FEC_FIN_CONTR";
    public static final String CAMPO_SUPL_SALARIO_MIN = "CAMPO_SUPL_SALARIO_MIN";
    public static final String CAMPO_SUPL_TIT_ESP = "CAMPO_SUPL_TIT_ESP";
    public static final String CAMPO_SUPL_SAL_BRUT_CONT = "CAMPO_SUPL_SAL_BRUT_CONT";
    public static final String CAMPO_SUPL_PORC_JORN = "CAMPO_SUPL_PORC_JORN";
    public static final String CAMPO_SUPL_DUR_CONTRA = "CAMPO_SUPL_DUR_CONTRA";
    public static final String TIPO_SUPL_NUMERICO = "TIPO_SUPL_NUMERICO";
    public static final String TIPO_SUPL_TEXTO = "TIPO_SUPL_TEXTO";
    public static final String TIPO_SUPL_FECHA = "TIPO_SUPL_FECHA";
    public static final String TIPO_SUPL_FICHERO = "TIPO_SUPL_FICHERO";
    public static final String TIPO_SUPL_DESPLEGABLE = "TIPO_SUPL_DESPLEGABLE";
    public static final String TIPO_SUPL_DESPLEGABLE_EXTERNO = "TIPO_SUPL_DESPLEGABLE_EXTERNO";
    public static final String CAMPO_SUPL_MUNIPERCON = "CAMPO_SUPL_MUNIPERCON";
    public static final String VISTA_MUNIPERSON = "VISTA_MUNIPERSON";
    public static final String CODIGO_MUNIPERCON = "CODIGO_MUNIPERCON";
    public static final String DESCRIPCION_MUNIPERCON = "DESCRIPCION_MUNIPERCON";
 
    
    public static final String TABLA_E_TDEXT = "TABLA_E_TDEXT";
    public static final String TABLA_IAE_EPIGRAFES = "TABLA_IAE_EPIGRAFES";
    ...
    // Vista de municipios
    public static final String VISTA_MUNICIPIO = "VISTA_MUNICIPIO";
    ...
    public static final String DOCUMENTO_DEMANDA = "DOCUMENTO_DEMANDA";
