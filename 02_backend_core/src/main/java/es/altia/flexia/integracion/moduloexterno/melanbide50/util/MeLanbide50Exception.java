 ...
 * @author mikel
 */
public class MeLanbide50Exception extends Exception{
     ...
     */
    public MeLanbide50Exception(String message) {
        super(message);
    }
     ...
     */
    public MeLanbide50Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
