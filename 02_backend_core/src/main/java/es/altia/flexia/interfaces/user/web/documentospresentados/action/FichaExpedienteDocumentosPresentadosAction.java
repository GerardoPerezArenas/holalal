...
public class FichaExpedienteDocumentosPresentadosAction extends ActionSession {
    ...
    private Logger log = LogManager.getLogger(FichaExpedienteDocumentosPresentadosAction.class);
    ...
    private ArrayList<FirmasDocumentoProcedimientoVO> crearListadoFirmasGuardar(String listaFirmasStr) {
        ...
        //String[] firmas = listaFirmasStr.split(ConstantesDatos.SEPARADORSUBLISTAS);
        String[] firmas = listaFirmasStr.split(ConstantesDatos.SEPARADOR);
        
        
        //for (int i=0;i<firmas.length;i=i+5) {
        for (int i=0;i<firmas.length;i++) {
            
            String[] datosFirma = firmas[i].split(ConstantesDatos.SEPARADORSUBLISTAS);
