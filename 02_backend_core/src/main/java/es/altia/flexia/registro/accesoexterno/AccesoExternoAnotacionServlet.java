...
public class AccesoExternoAnotacionServlet extends HttpServlet {
    ...
    private static final Logger LOG = LogManager.getLogger(AccesoExternoAnotacionServlet.class);
                        ...
                        try {
                            if (params != null) {
                                ...
                                if((session.getAttribute("usuario") == null)) {
                                    LOG.debug("No hay usuario en la session. Lo creamos");
                                    //Seteamos el UsuarioValueObject
                                    ...
                                    // añadimos el objeto al session
                                    session.setAttribute("usuario", usuarioVO);
                                } else {
                                    LOG.debug("Hay usuario en la session. Lo recuperamos");
