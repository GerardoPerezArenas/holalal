...
public class MigracionSolicitudesAyudaManager {
    ...
    private static Logger log = LogManager.getLogger(MigracionSolicitudesAyudaManager.class.getName());
    ...
    public List<String> insercionRegistroFlexia(List<SolicitudVO> solicitudes, String[] params, String codProc) throws MigracionSolicitudesAyudaException {
        ...
        try {
            ...
            binding = (WSRegistroESBindingStub) new WSRegistroESServiceLocator().getWSRegistroESPort(urlCienteWS);
