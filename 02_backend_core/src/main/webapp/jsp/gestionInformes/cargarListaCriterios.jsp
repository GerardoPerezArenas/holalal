...
<%
    ...
    Logger m_Log = LogManager.getLogger(FichaInformeForm.class.getName());
        ...
        if (validar()) { 
            if (validarFechas() && validaNumericoAnterior()) { 
                for (k=0;k<listaCriteriosCampo.length;k++) {
                    ...
                    listaCamposCriterio += (criteriosCampo[k]!='') ? criteriosCampo[k] + '<%=separador%>' : 'null' + '<%=separador%>';
                    listaValorOperCriterio += (criteriosCond[k]!='') ? criteriosCond[k] + '<%=separador%>' : 'null' + '<%=separador%>';
                    listaValor1Criterio += (criteriosValor1[k]!='') ? criteriosValor1[k] + '<%=separador%>' : 'null' + '<%=separador%>';
                    listaValor2Criterio += (criteriosValor2[k]!='') ? criteriosValor2[k] + '<%=separador%>' : 'null' + '<%=separador%>';
                    listaTiposCriterio += (criteriosValor2[k]!='') ? criteriosValor2[k] + '<%=separador%>' : 'null' + '<%=separador%>';
                }
