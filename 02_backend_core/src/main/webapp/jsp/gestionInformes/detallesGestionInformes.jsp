...
<script type="text/javascript">
    ...
    function pulsarModificar() {
        if (validarCampos()){
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaCriInfCodigo += listaCriInfArray[item][0] + '<%=separador%>';
                listaCriInfTitulo += (listaCriInfArray[item][1]!='') ? listaCriInfArray[item][1] + '<%=separador%>' : 'null' + '<%=separador%>';
                listaCriInfCondCri += (listaCriInfArray[item][2]!='') ? listaCriInfArray[item][2] + '<%=separador%>' : 'null' + '<%=separador%>';
                listaCriInfValor1 += (listaCriInfArray[item][3]!='') ? listaCriInfArray[item][3] + '<%=separador%>' : 'null' + '<%=separador%>';
                listaCriInfValor2 += (listaCriInfArray[item][4]!='') ? listaCriInfArray[item][4] + '<%=separador%>' : 'null' + '<%=separador%>';
                listaCriInfOrigen += (listaCriInfArray[item][5]!='') ? listaCriInfArray[item][5] + '<%=separador%>' : 'null' + '<%=separador%>';
                listaCriInfTabla += (listaCriInfArray[item][6]!='') ? listaCriInfArray[item][6] + '<%=separador%>' : 'null' + '<%=separador%>';
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaCabInfCodigo += listaCabInfArray[item][0] + '<%=separador%>';
                listaCabInfPosx += listaCabInfArray[item][2] + '<%=separador%>';
                listaCabInfPosy += listaCabInfArray[item][3] + '<%=separador%>';
            }
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaPieInfCodigo += listaPieInfArray[item][0] + '<%=separador%>';
            }
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaCabPagCodigo += listaCabPagArray[item][0] + '<%=separador%>';
                listaCabPagPosx += listaCabPagArray[item][2] + '<%=separador%>';
                listaCabPagPosy += listaCabPagArray[item][3] + '<%=separador%>';
            }
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaPiePagCodigo += listaPiePagArray[item][0] + '<%=separador%>';
            }
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaPermisosCodigo += listaPermisosArray[item][0] + '<%=separador%>';
            }
            ...
            for(var x=0; x<lis2.length; x++){
                var item = lis2[x].id;
                listaCamposCodigo += listaCamposArray[item][0] + '<%=separador%>';
                listaCamposNombre += listaCamposArray[item][1] + '<%=separador%>';
                listaCamposTabla += listaCamposArray[item][2] + '<%=separador%>';
                listaCamposPosx += listaCamposArray[item][3] + '<%=separador%>';
                listaCamposPosy += listaCamposArray[item][4] + '<%=separador%>';
                listaCamposAlign += listaCamposArray[item][5] + '<%=separador%>';
                listaCamposAncho += listaCamposArray[item][6] + '<%=separador%>';
                listaCamposElipsis += listaCamposArray[item][7] + '<%=separador%>';
                listaCamposOrden += listaCamposArray[item][9] + '<%=separador%>';
            }
    ...
    <div class="tableContainerComboCampos" style="text-align:left">
        ...
        <div class="tableContainerBloque">
            ...
            <div class="tableContainerComboCamposParametro">
             ...
             <div class="tableContainerComboCamposParametro">
                <span class="etiq">Ordenación</span>
