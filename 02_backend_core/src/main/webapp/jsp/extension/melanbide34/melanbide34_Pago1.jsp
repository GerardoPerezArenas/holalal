...
<script type="text/javascript">
   function pruebaDavid(){alert("prueba");}
   ...
   function mostrarCalFechaPrimerPago(evento) {
	...
	function validarImportePago(mostrarMensaje, recalcular){
        try{
            ...
            var concedida = parseFloat(convertirANumero(document.getElementById('impPago1').value));
	...
	function recalcularDescuento(){
	 ...
	 function actualizarCamposSuplementarios(){
             var campoFecPago= 'T_<%=codTram%>_1_FECHAPAGO1';
    ...
    <div class="tab-page" id="tabPage341" style=" width: 100%;">
        <h2 class="tab" id="pestana341"><%=meLanbide34I18n.getMensaje(idiomaUsuario,"label.tituloPestanaPago1")%></h2>
        <script type="text/javascript">tp1_p341 = tp1.addTabPage( document.getElementById( "tabPage341" ) );</script>
        <div style="clear: both;">
            <div id="divGeneral" class="contenidoPestanha">
                <div class="lineaFormulario">
                    <div style="width: 170px; float: left; text-align: left;">
                        <%=meLanbide34I18n.getMensaje(idiomaUsuario,"label.fecPrimerPago")%>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="float: left">
                         ...
                         <div style="width: 150px; float: left;">
                             <div style="float: left;">
                                 <input id="impPago1" name="impPago1" type="text" class="inputTexto deshabilitado" style="text-align: right;" size="20" maxlength="2" value="<%=valoresPago != null && valoresPago.getImporteConcedidoPago() != null ? formateador.format(Float.valueOf(valoresPago.getImporteConcedidoPago())) : ""%>" readOnly/>
                             </div>
                         </div>
                     </div>
                </div>             
                <div class="lineaFormulario" >
                  <div style="float: left;">
                    <div style="width: 170px; float: left; text-align: left;">
                        <%=meLanbide34I18n.getMensaje(idiomaUsuario,"label.impPagar1")%>
                    </div>
                    <div style="width: 150px; float: left;">
                        <div style="float: left;">
