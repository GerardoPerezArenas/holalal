...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide44.vo.resumen.EcaResDetalleInsercionesVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            String tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.tituloPagina");
        ...
        <form>
            <div style="width: 95%; padding: 10px; text-align: left;">
                <div class="lineaFormulario" style="padding-bottom: 10px;">
                    <span>
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.preparador")%>: 
                ...
                <div style="text-align: center;">
                    <table style="border-collapse: collapse; width: 80%; margin: 0 auto;" cellpadding="2px">
                        ...
                        <tr class="negrita">
                            ...
                            <td colspan="2" class="sub3titulo" style="border: 2px solid #ffffff; border-left: 2px solid #666; border-top: 2px solid #666; text-align: center;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.hombres")%></td>
                            <td colspan="2" class="sub3titulo" style="border: 2px solid #ffffff; text-align: center; border-top: 2px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.mujeres")%></td>
                        </tr>
                        <tr>
                            <td class="sub3titulo" style=" text-align: center; border-bottom: 2px solid #666; border-left: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.justificado")%></td>
                            <td class="sub3titulo" style=" text-align: center; border-bottom: 2px solid #666; border-right: 2px solid #ffffff;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.coste")%></td>
                            <td class="sub3titulo" style=" text-align: center; border-bottom: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.justificado")%></td>
                            <td class="sub3titulo" style=" text-align: center; border-bottom: 2px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.coste")%></td>
                        </tr>
                        <tr>
                            <td style="border-left: 2px solid #666; border-bottom: 1px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.c1")%></td>
                        ...
                        <tr>
                            <td style="border-left: 2px solid #666; border-bottom: 1px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.c2")%></td>
                        ...
                        <tr>
                            <td style="border-left: 2px solid #666; border-bottom: 1px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.c3")%></td>
                        ...
                        <tr>
                            <td style="border-left: 2px solid #666; border-bottom: 1px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.c4")%></td>
                        ...
                        <tr>
                            <td style="border-left: 2px solid #666; border-bottom: 2px solid #666; border-right: 2px solid #666;"><%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.totalIns")%></td>
                        ...
                        <tr style="height: 100px;">
                            <td colspan="7" style="text-align: right;">
                                <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.totalFinal")%>:&nbsp;<label id="total"></label>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="botonera" style="margin-top: 10px;">
                    <input type="button" id="btnCerrarDetalleIns" name="btnCerrarDetalleIns" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.cerrar")%>" onclick="cerrarVentana();">
                </div>
            </div>
        </form>
    </body>
