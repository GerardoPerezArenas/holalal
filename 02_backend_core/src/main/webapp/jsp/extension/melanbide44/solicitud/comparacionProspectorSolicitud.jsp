...
<%
 ...
 String css = "";
    ...
    String tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.comparacionProspector.tituloPagina");
        ...
        <div style="width: 100%; padding: 10px; text-align: left;">
            ...
            <div class="lineaFormulario">
                <div style="width: 36px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.nif")%>
                </div>
            ...
            <div class="lineaFormulario">     
                <div style="width: 140px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.nomApel")%>
                </div>
            ...
            <div class="lineaFormulario">
                <div style="width: 350px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.visitas")%>
                </div>
                <div style="width: 108px; float: left;">
