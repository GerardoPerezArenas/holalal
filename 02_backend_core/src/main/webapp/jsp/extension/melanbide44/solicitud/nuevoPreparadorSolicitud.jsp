...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide44.vo.solicitud.EcaSolPreparadoresVO" %>
...
<%
 ...
 String css = "";
    ...
    if(consulta)
    {
        tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.consultaPreparador.tituloPagina");
    }
    else
    {
        if(preparadorModif != null)
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.modifPreparador.tituloPagina");
        }
        else
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.nuevoPreparador.tituloPagina");
        }
    }
...
<script type="text/javascript">
    ...
    function inicio(){
        try{        
            ...
            %>
                ...
                document.getElementById('c5h').value = '<%=preparadorModif.getInsC5H() != null ? preparadorModif.getInsC5H().toPlainString() : "" %>';
                document.getElementById('c5m').value = '<%=preparadorModif.getInsC5M() != null ? preparadorModif.getInsC5M().toPlainString() : "" %>';
                document.getElementById('c5total').value = '<%=preparadorModif.getInsC5() != null ? preparadorModif.getInsC5().toPlainString() : "" %>';
                
                
                document.getElementById('c6h').value = '<%=preparadorModif.getInsC6H() != null ? preparadorModif.getInsC6H().toPlainString() : "" %>';
                document.getElementById('c6m').value = '<%=preparadorModif.getInsC6M() != null ? preparadorModif.getInsC6M().toPlainString() : "" %>';
                document.getElementById('c6total').value = '<%=preparadorModif.getInsC6() != null ? preparadorModif.getInsC6().toPlainString() : "" %>';
            ...
            reemplazarPuntosEca(document.getElementById('c5h'));
            reemplazarPuntosEca(document.getElementById('c5m'));
            reemplazarPuntosEca(document.getElementById('c5total'));
            reemplazarPuntosEca(document.getElementById('c6h'));
            reemplazarPuntosEca(document.getElementById('c6m'));
            reemplazarPuntosEca(document.getElementById('c6total'));
            ...
            FormatNumber(document.getElementById('c5h').value, 8, 2, document.getElementById('c4h').id)//entero 
            FormatNumber(document.getElementById('c5m').value, 8, 2, document.getElementById('c4m').id)//entero 
            FormatNumber(document.getElementById('c5total').value, 8, 2, document.getElementById('c4total').id)//entero
            FormatNumber(document.getElementById('c6h').value, 8, 2, document.getElementById('c4h').id)//entero 
            FormatNumber(document.getElementById('c6m').value, 8, 2, document.getElementById('c4m').id)//entero 
            FormatNumber(document.getElementById('c6total').value, 8, 2, document.getElementById('c4total').id)//entero
            ...
            %>
                ...
                document.getElementById('c5h').disabled = true;
                document.getElementById('c5m').disabled = true;
                document.getElementById('c5total').disabled = true;
                document.getElementById('c6h').disabled = true;
                document.getElementById('c6m').disabled = true;
                document.getElementById('c6total').disabled = true;
    ...
    function guardar(){
        if(validarDatos()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=guardarPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>'
                ...
                +'&c5h='+convertirANumero(document.getElementById('c5h').value)
                +'&c5m='+convertirANumero(document.getElementById('c5m').value)
                +'&c5total='+convertirANumero(document.getElementById('c5total').value)
                +'&c6h='+convertirANumero(document.getElementById('c6h').value)
                +'&c6m='+convertirANumero(document.getElementById('c6m').value)
                +'&c6total='+convertirANumero(document.getElementById('c6total').value)
            ...
            for(j=0;hijos!=null && j<hijos.length;j++){
                ...
                if(codigoOperacion=="0"){                    
                    ...
                    jsp_alerta("A",'<%=meLanbide44I18n.getMensaje(idiomaUsuario,"error.nifPreparadorRepetido")%>');
                }else{
                    jsp_alerta("A",'<%=meLanbide44I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                }//if(
            }
    ...
    function validarDatos(){
        ...
        if(nif == null || nif == ''){
            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.nifVacio")%>';
            return false;
        }
        var nomApel = document.getElementById('nomApel').value;
        if(nomApel == null || nomApel == ''){
            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.nomApelVacio")%>';
            return false;
        }
        ...
        if(nuevo){
            if(!validarNIFEca(document.getElementById('nif'))){
                ...
                if(mensajeValidacion == ''){
                    ...
                    if(letra != ''){
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.nifIncorrecto")%>'+' '+'<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.letraNifDeberiaSer")%>'+letra;
                    }else{
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.nifIncorrecto")%>';
                    }
                }
                correcto = false;
            }else{
        ...
        if(!comprobarCaracteresEspecialesEca(nomApel)){
            ...
            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.nomApelCaracteresEspeciales")%>';
            return false;
        }else{
        ...
        if(nuevo){
            if(!validarFechaEca(document.forms[0], document.getElementById('fechaInicio'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.fechaIniIncorrecto")%>';
                correcto = false;
            }else{
            ...
            if(!validarFechaEca(document.forms[0], document.getElementById('fechaFin'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.fechaFinIncorrecto")%>';
                correcto = false;
            }else{
            ...
            if(correcto){
                ...
                if(feIni != '' && feFin != ''){
                    ...
                    if(result < 0){
                        ...
                        document.getElementById('fechaFin').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.fechaIniPosteriorFin")%>';
                        correcto = false;
                    }
                    else{
                        if(anoIni != '<%=anoExpediente%>'){
                            ...
                            document.getElementById('fechaInicio').style.border = '1px solid red';
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=String.format(meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.fechasAno"), anoExpediente)%>';
                        }else{
                            document.getElementById('fechaInicio').removeAttribute('style');
                        }
        ...
        if(document.getElementById('horasAnualesJC').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('horasAnualesJC'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.horasAnualesJCIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            if(hajc < hc){
                ...
                document.getElementById('horasAnualesJC').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.horasAnualesJCMenorHorasContrato")%>';
            }
            else{
                document.getElementById('horasAnualesJC').removeAttribute('style');
            }
            if(hc < hdECA){
                ...
                document.getElementById('horasContrato').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.horasContratoMenorHorasDedicacionEca")%>';
            }else{
                document.getElementById('horasContrato').removeAttribute('style');
            }
        }
        ...
        if(document.getElementById('costesSalarialesSSJor').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSJor'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costesSSJorIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('costesSalarialesSSPorJor').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSPorJor'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costesSSPorJorIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('costesSalarialesSSEca').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSEca'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costesSSEcaIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            if(cssJC < cssPorJor){
                ...
                document.getElementById('costesSalarialesSSJor').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costesSalarialesJorMenorCostesSalarialesPorJor")%>';
            }
            else{
                document.getElementById('costesSalarialesSSJor').removeAttribute('style');
            }
            if(cssPorJor < cssECA){
                ...
                document.getElementById('costesSalarialesSSPorJor').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costesSalarialesPorJorMenorCostesSalarialesEca")%>';
            }else{
                document.getElementById('costesSalarialesSSPorJor').removeAttribute('style');
            }
        }
        ...
        if(document.getElementById('numSegAnt').value != ''){
            try{
                if(!validarNumericoEca(document.getElementById('numSegAnt'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=String.format(meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.numSegAntIncorrecto"), anoExpediente)%>';
                }else{
       ...
       <%-- if(document.getElementById('importeSegAnt').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('importeSegAnt'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.importeSegAntIncorrecto")%>';
                }else{
                    ...
                    if(document.getElementById('numSegAnt').value != ''){
                        ...
                        if(imSeg != ''){
                            ...
                            if(res != importe){
                                ...
                                document.getElementById('importeSegAnt').style.border = '1px solid red';
                                if(mensajeValidacion == '')
                                    mensajeValidacion = '<%=String.format(meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.importeSegAntIncorrecto"), anoExpediente)%>';
                            }else{
                                document.getElementById('importeSegAnt').removeAttribute('style');
                            }
                        }
        ...
        if(document.getElementById('c1h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c1h'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c1hIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c1m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c1m'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c1mIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c1total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c1total'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c1totalIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c2h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c2h'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c2hIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c2m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c2m'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c2mIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c2total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c2total'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c2totalIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c3h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c3h'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c3hIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c3m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c3m'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c3mIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c3total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c3total'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c3totalIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c4h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c4h'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c4hIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c4m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c4m'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c4mIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('c4total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c4total'),8,2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c4totalIncorrecto")%>';
                }else{
         ...
         if(document.getElementById('c5h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c5h'),8,2)){
                    correcto = false;
                    document.getElementById('c5h').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c5hIncorrecto")%>';
                }else{
                    document.getElementById('c5h').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c5h').style.border = '1px solid red';
        ...
        if(document.getElementById('c5m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c5m'),8,2)){
                    correcto = false;
                    document.getElementById('c5m').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c5mIncorrecto")%>';
                }else{
                    document.getElementById('c5m').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c5m').style.border = '1px solid red';
        ...
        if(document.getElementById('c5total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c5total'),8,2)){
                    correcto = false;
                    document.getElementById('c5total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c5totalIncorrecto")%>';
                }else{
                    document.getElementById('c5total').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c5total').style.border = '1px solid red';
         ...
         if(document.getElementById('c6h').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c6h'),8,2)){
                    correcto = false;
                    document.getElementById('c6h').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c6hIncorrecto")%>';
                }else{
                    document.getElementById('c6h').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c6h').style.border = '1px solid red';
        ...
        if(document.getElementById('c6m').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c6m'),8,2)){
                    correcto = false;
                    document.getElementById('c6m').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c6mIncorrecto")%>';
                }else{
                    document.getElementById('c6m').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c6m').style.border = '1px solid red';
        ...
        if(document.getElementById('c6total').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('c6total'),8,2)){
                    correcto = false;
                    document.getElementById('c6total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.c6totalIncorrecto")%>';
                }else{
                    document.getElementById('c6total').removeAttribute('style');
                }
            }catch(err){
                correcto = false;
                document.getElementById('c6total').style.border = '1px solid red';
        ...
        if(document.getElementById('inserciones').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('inserciones'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.insercionesIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('insercionesSeg').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('insercionesSeg'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.insercionesSegIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('costesSalarialesSS').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSS'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.costeSSIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            try
            {
                ...
                if(suma1 != c1tot){
                    ...
                    document.getElementById('c1total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC1Incorrecto")%>';
                }else{
                    document.getElementById('c1total').removeAttribute('style');
                }
            }catch(err){
            ...
            try
            {
                ...
                if(suma2 != c2tot){
                    ...
                    document.getElementById('c2total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC2Incorrecto")%>';
                }else{
                    document.getElementById('c2total').removeAttribute('style');
                }
            }catch(err){
            ...
            try
            {
                ...
                if(suma3 != c3tot){
                    ...
                    document.getElementById('c3total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC3Incorrecto")%>';
                }else{
                    document.getElementById('c3total').removeAttribute('style');
                }
            }catch(err){
            ...
            try
            {
                ...
                if(suma4 != c4tot){
                    ...
                    document.getElementById('c4total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC4Incorrecto")%>';
                }else{
                    document.getElementById('c4total').removeAttribute('style');
                }
            }catch(err){
            ...
            try
            {
                var c5h = document.getElementById('c5h').value != '' ? parseFloat(convertirANumero(document.getElementById('c5h').value)) : 0.0;
                var c5m = document.getElementById('c5m').value != '' ? parseFloat(convertirANumero(document.getElementById('c5m').value)) : 0.0;
                var c5tot = document.getElementById('c5total').value != '' ? parseFloat(convertirANumero(document.getElementById('c5total').value)) : 0.0;
                var suma5 = c5h + c5m;
                if(suma5 != c5tot){
                    correcto = false;
                    document.getElementById('c5total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC5Incorrecto")%>';
                }else{
                    document.getElementById('c5total').removeAttribute('style');
                }
            }catch(err){
            ...
            try
            {
                var c6h = document.getElementById('c6h').value != '' ? parseFloat(convertirANumero(document.getElementById('c6h').value)) : 0.0;
                var c6m = document.getElementById('c6m').value != '' ? parseFloat(convertirANumero(document.getElementById('c6m').value)) : 0.0;
                var c6tot = document.getElementById('c6total').value != '' ? parseFloat(convertirANumero(document.getElementById('c6total').value)) : 0.0;
                var suma6 = c6h + c6m;
                if(suma6 != c6tot){
                    correcto = false;
                    document.getElementById('c6total').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insC6Incorrecto")%>';
                }else{
                    document.getElementById('c6total').removeAttribute('style');
                }
            }catch(err){
            ...
            if(document.getElementById('inserciones').value != ''){
                ...
                if(document.getElementById('c5h').value != ''){
                    importeCalculado += parseFloat(convertirANumero(document.getElementById('c5h').value)) * <%=ecaConfig != null && ecaConfig.getImC4h() != null ? ecaConfig.getImC4h().doubleValue() : 1.0%>;
                }

                if(document.getElementById('c5m').value != ''){
                    importeCalculado += parseFloat(convertirANumero(document.getElementById('c5m').value)) * <%=ecaConfig != null && ecaConfig.getImC4m() != null ? ecaConfig.getImC4m().doubleValue() : 1.0%>;
                }
                
                if(document.getElementById('c6h').value != ''){
                    importeCalculado += parseFloat(convertirANumero(document.getElementById('c6h').value)) * <%=ecaConfig != null && ecaConfig.getImC4h() != null ? ecaConfig.getImC4h().doubleValue() : 1.0%>;
                }

                if(document.getElementById('c6m').value != ''){
                    importeCalculado += parseFloat(convertirANumero(document.getElementById('c6m').value)) * <%=ecaConfig != null && ecaConfig.getImC4m() != null ? ecaConfig.getImC4m().doubleValue() : 1.0%>;
                }
                ...
                if(importeCalculado != importe){
                    ...
                    document.getElementById('inserciones').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.insImporteIncorrecto")%>';
                }else{
                    document.getElementById('inserciones').removeAttribute('style');
                }
            }
            ...
            if(document.getElementById('insercionesSeg').value != ''){
                if(document.getElementById('importeSegAnt').value != '' || document.getElementById('inserciones').value != ''){
                    ...
                    if(insSegImporte != suma){
                        ...
                        document.getElementById('insercionesSeg').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.segInsNoSumaImpIns")%>';
                    }else{
                        document.getElementById('insercionesSeg').removeAttribute('style');
                    }
                    ...
                    if(document.getElementById('costesSalarialesSS').value != ''){
                        ...
                        if(coste > minimo){
                            ...
                            document.getElementById('costesSalarialesSS').style.border = '1px solid red';
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.costesSalarialesSSIncorrecto")%>';
                        }else{
                            document.getElementById('costesSalarialesSS').removeAttribute('style');
                        }
                    }
    ...
    function calcularTotalC5(){
        var c5h;
        var c5m;
        var tot;
        var hayValor = false;
        var valor5h = document.getElementById('c5h').value;
        valor5h = convertirANumero(valor5h);
        var valor5m = document.getElementById('c5m').value;
        valor5m = convertirANumero(valor5m);
        //reemplazarPuntosEca(document.getElementById('c4h'));
        //reemplazarPuntosEca(document.getElementById('c4m'));
        //FormatNumber(document.getElementById('c4h').value, 6, 0, document.getElementById('c4h').id);
        //FormatNumber(document.getElementById('c4m').value, 6, 0, document.getElementById('c4m').id);
        try{
            c5h = parseFloat(valor5h);
            if(valor5h == '' || isNaN(valor5h)){
                c5h = 0.0;
            }else{
                hayValor = true;
            }
        ...
        try{
            c5m = parseFloat(valor5m);
            if(valor5m == '' || isNaN(valor5m)){
                c5m = 0.0;
            }else{
                hayValor = true;
            }
        ...
        document.getElementById('c5total').value = tot;
        reemplazarPuntosEca(document.getElementById('c5total'));
        //FormatNumber(document.getElementById('c4total').value, 6, 0, document.getElementById('c4total').id);
        calcularInserciones();
    }
    ...
    function calcularTotalC6(){
        var c6h;
        var c6m;
        var tot;
        var hayValor = false;
        var valor6h = document.getElementById('c6h').value;
        valor6h = convertirANumero(valor6h);
        var valor6m = document.getElementById('c6m').value;
        valor6m = convertirANumero(valor6m);
        //reemplazarPuntosEca(document.getElementById('c4h'));
        //reemplazarPuntosEca(document.getElementById('c4m'));
        //FormatNumber(document.getElementById('c4h').value, 6, 0, document.getElementById('c4h').id);
        //FormatNumber(document.getElementById('c4m').value, 6, 0, document.getElementById('c4m').id);
        try{
            c6h = parseFloat(valor6h);
            if(valor6h == '' || isNaN(valor6h)){
                c6h = 0.0;
            }else{
                hayValor = true;
            }
        ...
        try{
            c6m = parseFloat(valor6m);
            if(valor6m == '' || isNaN(valor6m)){
                c6m = 0.0;
            }else{
                hayValor = true;
            }
        ...
        document.getElementById('c6total').value = tot;
        reemplazarPuntosEca(document.getElementById('c6total'));
        //FormatNumber(document.getElementById('c4total').value, 6, 0, document.getElementById('c4total').id);
        calcularInserciones();
    }
    ...
    function calcularInserciones(){
        ...
        if(document.getElementById('c5h').value != '' && validarNumericoDecimalEca(document.getElementById('c5h'),8,2)){
            hayValor = true;
            valor = document.getElementById('c5h').value;
            valor = convertirANumero(valor);
            importeCalculado += parseFloat(valor) * <%=ecaConfig != null && ecaConfig.getImC5h() != null ? ecaConfig.getImC5h().doubleValue() : 1.0%>;
        }

        if(document.getElementById('c5m').value != '' && validarNumericoDecimalEca(document.getElementById('c5m'),8,2)){
            hayValor = true;
            valor = document.getElementById('c5m').value;
            valor = convertirANumero(valor);
            importeCalculado += parseFloat(valor) * <%=ecaConfig != null && ecaConfig.getImC5m() != null ? ecaConfig.getImC5m().doubleValue() : 1.0%>;
        }
        
        if(document.getElementById('c6h').value != '' && validarNumericoDecimalEca(document.getElementById('c6h'),8,2)){
            hayValor = true;
            valor = document.getElementById('c6h').value;
            valor = convertirANumero(valor);
            importeCalculado += parseFloat(valor) * <%=ecaConfig != null && ecaConfig.getImC6h() != null ? ecaConfig.getImC6h().doubleValue() : 1.0%>;
        }

        if(document.getElementById('c6m').value != '' && validarNumericoDecimalEca(document.getElementById('c6m'),8,2)){
            hayValor = true;
            valor = document.getElementById('c6m').value;
            valor = convertirANumero(valor);
            importeCalculado += parseFloat(valor) * <%=ecaConfig != null && ecaConfig.getImC6m() != null ? ecaConfig.getImC6m().doubleValue() : 1.0%>;
        }
        if(hayValor){
    ...
    function ajustarDecimalesImportes(){
        ...
        ajustarDecimalesCampo(campo, 2);
                ...
                campo = document.getElementById('c5h');
        ajustarDecimalesCampo(campo, 2);
        campo = document.getElementById('c5m');
        ajustarDecimalesCampo(campo, 2);
        campo = document.getElementById('c5total');
        ajustarDecimalesCampo(campo, 2);
        
        
                campo = document.getElementById('c6h');
        ajustarDecimalesCampo(campo, 2);
        campo = document.getElementById('c6m');
        ajustarDecimalesCampo(campo, 2);
        campo = document.getElementById('c6total');
        ajustarDecimalesCampo(campo, 2);
    ...
    function verComparacion(){        
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=compararDatosPrepSol&tipo=0&numero=<%=numExpediente%>&idPrep=<%=preparadorModif != null && preparadorModif.getSolPreparadoresCod() != null ? preparadorModif.getSolPreparadoresCod() : ""%>&control='+control.getTime(),760,850,'no','no', function(){
		});
            }else{
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE44&operacion=compararDatosPrepSol&tipo=0&numero=<%=numExpediente%>&idPrep=<%=preparadorModif != null && preparadorModif.getSolPreparadoresCod() != null ? preparadorModif.getSolPreparadoresCod() : ""%>&control='+control.getTime(),780,870,'no','no', function(){
		});
            }
            /*if (result != undefined){
        ...
        <div style="width: 100%; padding: 10px; text-align: left;">
            ...
            <div class="lineaFormulario" id="divPrepOrigen" style="height: 30px; margin-top: 10px; margin-bottom: 10px;">
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.preparadorOrigen")%>
                </div>
            ...
            <fieldset style="width: 94%;">    
                ...
                <div class="lineaFormulario">
                    <div style="width: 36px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.nif")%><font color="red">*</font>
                    </div>
                    <div style="width: 101px; float: left;">
                        <input type="text" id="nif" name="nif" size="10" maxlength="10" class="inputTexto"/>
                    </div>
                    <div style="width: 140px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.nomApel")%><font color="red">*</font>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 169px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.fechaInicio")%>
                    </div>
                    <div style="width: 131px; float: left;">
                        ...
                        <A id="btnFechaInicio" href="javascript:calClick(event);" onclick="mostrarCalFechaInicio(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaInicio" name="calFechaInicio" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.fechaInicio")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                    <div style="width: 155px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.fechaFin")%>
                    </div>
                    <div style="width: 131px; float: left;">
                        <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaFin" name="fechaFin" onkeyup="javascript: return SoloCaracteresFecha(this);" onblur="javascript:return comprobarFechaEca(this, '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();"/>
                        <A id="btnFechaFin" href="javascript:calClick(event);" onclick="mostrarCalFechaFin(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaFin" name="calFechaFin" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.fechaFin")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 155px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.horasAnualesJC")%>
                    </div>
                    ...
                    <div style="width: 117px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.horasContrato")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 157px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.horasDedicacionEca")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 155px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.costesSalarialesSSJor")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 117px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.costesSalarialesSSPorJor")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 157px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.costesSalarialesSSEca")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 246px; float: left;">
                        <%=String.format(meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.numSegAnt"), anoExpediente)%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 70px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.importeSegAnt")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c1h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c1m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c1total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c2h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c2m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c2total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c3h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c3m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c3total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c4h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c4m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c4total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c5h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c5h" name="c5h" size="11" maxlength="9" class="inputTexto textoNumerico" 
                               onkeyup="calcularTotalC5();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularTotalC5();ajustarDecimalesImportes();"/>
                    </div>
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c5m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c5m" name="c5m" size="11" maxlength="9" class="inputTexto textoNumerico" 
                               onkeyup="calcularTotalC5();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularTotalC5();ajustarDecimalesImportes();"/>
                    </div>
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c5total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c5total" name="c5total" size="11" maxlength="9" class="inputTexto textoNumerico readOnly" disabled="disabled"/>
                    </div>
                </div>
                    ...
                    <div class="lineaFormulario">
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c6h")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c6h" name="c6h" size="11" maxlength="9" class="inputTexto textoNumerico" 
                               onkeyup="calcularTotalC6();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularTotalC6();ajustarDecimalesImportes();"/>
                    </div>
                    <div style="width: 51px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c6m")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c6m" name="c6m" size="11" maxlength="9" class="inputTexto textoNumerico" 
                               onkeyup="calcularTotalC6();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularTotalC6();ajustarDecimalesImportes();"/>
                    </div>
                    <div style="width: 72px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.c6total")%>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="c6total" name="c6total" size="11" maxlength="9" class="inputTexto textoNumerico readOnly" disabled="disabled"/>
                    </div>
                </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 92px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.inserciones")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 190px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.insercionesSeg")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 150px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.costesSalarialesSS")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 162px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.impteConcedido")%>
                    </div>
                    <div style="width: 108px; float: left;">
            ...
            <div class="lineaFormulario" id="divPrepSustituto" style="height: 30px; margin-top: 10px; margin-bottom: 10px;">
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.preparadorSustituto")%>
                </div>
                <div style="width: 85px; float: left;">
            ...
            <div class="botonera" style="padding-top: 20px;">
                ...
                <input type="button" id="btnComparacion" name="btnAceptar" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.comparacion")%>" onclick="verComparacion();">
            </div>
