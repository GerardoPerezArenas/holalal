...
<%
 ...
 String css = "";
    ...
    String tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.comparacionPreparador.tituloPagina");
    ...
    function validarDatos(){
        ...
        if(correcto && nuevo){
            ...
            if(hdECA < hc){
                ...
                document.getElementById('horasDedicacionEca').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.horasDedicacionEca50HorasContrato")%>';
            }else{
                document.getElementById('horasDedicacionEca').removeAttribute('style');
            }
        }
        ...
        <div style="width: 100%; padding: 10px; text-align: left;">
            ...
            <div class="lineaFormulario">
                <div style="width: 36px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.nif")%>
                </div>
            ...
            <div class="lineaFormulario">     
                <div style="width: 140px; float: left;">
                   <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.nomApel")%>
                </div>
