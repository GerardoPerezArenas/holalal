 ...
 String css = "";
	 ...
	 css = usuario.getCss();
        ...
        if(consulta)
        {
            ...
            {
                tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.consultaInsPrep.tituloPagina");
            }
        }
        else
        {
            if(segModif != null)
            {
                ...
                {
                    tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.modifInsPrep.tituloPagina");
                }
            }
            else
            {
                ...
                {
                    tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.nuevoInsPrep.tituloPagina");
                }
            }
        }
        ...
        function inicio(){
            try{          
                ...
                %> nuevo = false;                        
                    ...
                    var finContratoDespidoTemp = '<%=segModif.getFinContratoDespido() != null ? segModif.getFinContratoDespido() : "" %>';
                    document.getElementById('finContratoDespido').checked = finContratoDespidoTemp!=null && finContratoDespidoTemp=="1" ? true : false;               
                        ...
                        if(hijos[j].nodeName=="CODIGO_OPERACION"){                            
                            ...
                            for(var cont = 0; cont < hijosFila.length; cont++){
                               ...
                               /* else if(hijosFila[cont].nodeName=="PERS_CONTACTO"){
                                ...
                                else if(hijosFila[cont].nodeName=="ECA_SEG_FINCONTRATO"){
                                    nodoCampo = hijosFila[cont];
                                    if(nodoCampo.childNodes.length > 0){
                                        fila[18] = nodoCampo.childNodes[0].childNodes[0].nodeValue;
                                    }
                                    else{
                                        fila[18] = '-';
                                    } 
