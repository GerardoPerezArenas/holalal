...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide44.vo.justificacion.EcaSegPreparadoresVO" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide44.vo.justificacion.FilaSegPreparadoresVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
        ...
        if(consulta)
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.consultaSegPrep.tituloPagina");
        }
        else
        {
            if(segModif != null)
            {
                tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.modifSegPrep.tituloPagina");
            }
            else
            {
                tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.nuevoSegPrep.tituloPagina");
            }
        }
    ...
    <script type="text/javascript">
        ...
        function inicio(){
            try{          
                ...
                %> nuevo = false;                        
                    ...
                    <%
                    if(segModif.getSexo() != null && segModif.getSexo().equals(ConstantesMeLanbide44.CODIGOS_SEXO.MUJER))
                    {
                    %>
                        document.getElementById('sexo1').checked = true;
                    <%
                    }
                    else if(segModif.getSexo() != null && segModif.getSexo().equals(ConstantesMeLanbide44.CODIGOS_SEXO.HOMBRE))
                    {
                    %>
                    ...
                    document.getElementById('finContratoDespido').checked = '<%=segModif.getFinContratoDespido() != null && segModif.getFinContratoDespido() == 1 ? true : false %>';               
                    ...
                    <% } %>
                    document.getElementById('observaciones').value = '<%=segModif.getObservaciones() != null ? segModif.getObservaciones().toUpperCase() : "" %>';
                    ...
                    document.getElementById('nifPreparador').className = 'inputTexto readOnly';
        ...
        function guardarSeguimiento(){
            if(validarDatosSeg()){
                ...
                var resultado = 1;
                if(!encontrado){
                    resultado = jsp_alerta('', '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.colectivoNoDefinido")%>');
                }
                ...
                if(resultado == 1){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=guardarSeguimientoPreparador&tipo=0&numero=<%=numExpediente%>'
                        ...
                        +'&horasCont='+document.getElementById('horasContrato').value               
                        ...
                        +'&finContratoDespido='+(document.getElementById('finContratoDespido')!=null && document.getElementById('finContratoDespido').checked ? "1" : "0")
                    ...
                    for(j=0;hijos!=null && j<hijos.length;j++){
                        ...
                        if(codigoOperacion=="0"){
                            ...
                            if(mensajeValidacion != undefined && mensajeValidacion != ''){
                                jsp_alerta("A",mensajeValidacion);
                            }else{
                                jsp_alerta("A",'<%=meLanbide44I18n.getMensaje(idiomaUsuario,"error.datosNoValidos")%>');
                            }
                        }else if(codigoOperacion=="5"){
                            jsp_alerta("A",'<%=meLanbide44I18n.getMensaje(idiomaUsuario,"error.NifPreparadorNoEncontrado")%>');
                        }else{
                            jsp_alerta("A",'<%=meLanbide44I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        }//if(
                    }
        ...
        function validarDatosSeg(){
            ...
            if(nif == null || nif == ''){
                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.nifVacio")%>';
                return false;
            }
            var nomApel = document.getElementById('nomApel').value;
            if(nomApel == null || nomApel == ''){
                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.nomApelVacio")%>';
                return false;
            }
            ...
            if(nuevo){
                if(!validarNIFEca(document.getElementById('nif'))){
                    ...
                    if(mensajeValidacion == ''){
                        ...
                        if(letra != ''){
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.nifIncorrecto")%>'+' '+'<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.letraNifDeberiaSer")%>'+letra;
                        }else{
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.nifIncorrecto")%>';
                        }
                    }
                    correcto = false;
                }else{
            ...
            if(!comprobarCaracteresEspecialesEca(nomApel)){
                ...
                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.nomApelCaracteresEspeciales")%>';
                return false;
            }else{
            ...
            if(nuevo){
                if(document.getElementById('fechaInicio').value == ''){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.fechaIniIncorrecto")%>';
                    correcto = false;
                }
                /*if(document.getElementById('fechaFin').value == ''){
                    document.getElementById('fechaFin').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.fechaFinIncorrecto")%>';
                    correcto = false;
                }*/
                ...
                if(correcto){
                    ...
                    if(feIni != '' && feFin != ''){
                        ...
                        if(result < 0){
                            ...
                            document.getElementById('fechaFin').style.border = '1px solid red';
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.fechaIniPosteriorFin")%>';
                            correcto = false;
                        }
                        else{ //fecinicio contrato anterior al año del expediente
                            var ejercicio ='<%=MeLanbide44Utils.getEjercicioDeExpediente(numExpediente)%>';
                            <% if (tiposeg.equals("0")) { %>
                                if(anoIni >= ejercicio){
                                    correcto = false;
                                    document.getElementById('fechaInicio').style.border = '1px solid red';
                                    if(mensajeValidacion == '')
                                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.preparadores.fechaIniAnoIncorrecto")%>';
                                }else{
                                    document.getElementById('fechaInicio').removeAttribute('style');
                                }  
                            <% }else { %>
                                if(anoIni != ejercicio){
                                    ...
                                    document.getElementById('fechaInicio').style.border = '1px solid red';
                                    if(mensajeValidacion == '')
                                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.preparadores.fechaIniAnoIncorrectoIns")%>';
                                }else{
                                    document.getElementById('fechaInicio').removeAttribute('style');
                                }  
                            <% } %>
                ...
                if(document.getElementById('fecSeguimiento').value == ''){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.fechaSeguimientoIncorrecto")%>';
                    correcto = false;
                }
                <% } %>
                if(document.getElementById('fecNacimiento').value == ''){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.fechaNacimientoIncorrecto")%>';
                    correcto = false;
                }
            }
            //porcentaje jornada 
            ...
            if(document.getElementById('porcJorn').value != ''){
                try{
                    if(!validarNumericoDecimalEca(document.getElementById('porcJorn'), 5, 2)){
                        ...
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.porcJornadaIncorrecto")%>';
                        }
                    }else{
                        document.getElementById('porcJorn').removeAttribute('style');
                        porc = parseFloat(document.getElementById('porcJorn').value);
                    }
                }catch(err){
                    correcto = false;
                    document.getElementById('porcJorn').style.border = '1px solid red';
            ...
            if(document.getElementById('horasContrato').value != ''){
                try{
                    ...
                    correcto = false;
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.horasContratoIncorrecto")%>';
            }
            ...
            if (document.getElementById('sexo0').checked == false && document.getElementById('sexo1').checked == false){
                 ...
                 if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.sexoIncorrecto")%>';
            }
            ...
            if (nuevo){
                if(document.getElementById('codTipoDisc').value == ''){
                     ...
                     if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.tipoDiscapacidadVacio")%>';
            ...
            if (nuevo){
                if(document.getElementById('codGravedad').value == ''){
                     ...
                     if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.tipoGravedadVacio")%>';
            ...
            if (nuevo){
                if(document.getElementById('codTipoContrato').value == ''){
                     ...
                     if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.tipoContratoVacio")%>';
            ...
            if (nuevo){
                if(document.getElementById('empresa').value == null || document.getElementById('empresa').value == ''){
                    ...
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.empresaVacio")%>';
                    correcto = false;
                }
                if(!comprobarCaracteresEspecialesEca(document.getElementById('empresa').value)){
                    document.getElementById('empresa').style.border = '1px solid red';
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.seguimiento.empresaCaracteresEspeciales")%>';
                    correcto = false;
                }else{
        ...
        <form>
            ...
            <div style="width: 100%; padding: 10px; text-align: left;">
                ...
                <div class="sub3titulo" style="clear: both; text-align: left;height:18px;">
                    <span>
                        <%=tiposeg.equals("0")?meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.datosSeguimiento"):meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.datosInsercion")%>
                    </span>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 36px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.nif")%><font color="red">*</font>
                    </div>
                    <div style="width: 101px; float: left;">
                        <input type="text" id="nif" name="nif" size="10" maxlength="10" class="inputTexto"/>
                    </div>
                    <div style="width: 140px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.nomApel")%><font color="red">*</font>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 94px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fecnacimiento")%><font color="red">*</font>
                    </div>
                    <div style="width: 131px; float: left;">
                        <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fecNacimiento" name="fecNacimiento" onkeyup="return SoloCaracteresFecha(this);" onblur=" javascript:return comprobarFechaEca(this, '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();"/>
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacimiento(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFecNacimiento" name="calFecNacimiento" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fecnacimiento")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                    <div style="width: 90px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.sexo")%><font color="red">*</font>
                    </div>
                    <div style="width: 140px; float: left;">
                        <input type="radio" id="sexo0" name="sexo" value="0" class="inputTexto"/> <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimiento.sexo0")%>
                        <input type="radio" id="sexo1" name="sexo" value="1" class="inputTexto"/> <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimiento.sexo1")%>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.tipoDiscapacidad")%><font color="red">*</font>
                    </div>
                    <div style="width: 130px; float: left;">   
                        ...
                        <input id="descTipoDisc" name="descTipoDisc" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorTipoDisc" name="anchorTipoDisc" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonTipoDisc" name="botonTipoDisc" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                     <div style="width: 130px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.gravedad")%><font color="red">*</font>
                    </div>
                    <div style="width: 130px; float: left;">
                        ...
                        <input id="descGravedad" name="descGravedad" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorGravedad" name="anchorGravedad" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGravedad" name="botonGravedad" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.tipoContrato")%><font color="red">*</font>
                    </div>
                    <div style="width: 130px; float: left;">
                        ...
                        <input id="descTipoContrato" name="descTipoContrato" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorTipoContrato" name="anchorTipoContrato" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonTipoContrato" name="botonTipoContrato" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.porcjornada")%><font color="red">*</font>
                    </div>
                    <div style="width: 130px; float: left;">
                        <input type="text" id="porcJorn" name="porcJorn" size="5" maxlength="5" class="inputTexto textoNumerico" onchange="reemplazarPuntosEca(this);" onblur="reemplazarPuntosEca(this); ajustarDecimalesImportes();"/>
                    </div>
                    <div style="width: 200px; float: left; margin-left: 5px">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.finContratoDespido")%>
                    </div>
                    <div style="width: 100px; float: left; margin-left: 5px;">
                        <input type="checkbox" id="finContratoDespido" name="finContratoDespido"/>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 94px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fechaInicio")%><font color="red">*</font>
                    </div>
                    <div style="width: 131px; float: left;">
                    ...
                    <div style="width: 94px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fechaFin")%><font color="red">*</font>
                    </div>
                    <div style="width: 131px; float: left;">
                ...
                <div class="lineaFormulario">                         
                    <div style="width: 117px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.horas")%><font color="red">*</font>
                    </div>
                    <div style="width: 108px; float: left;">
                        <input type="text" id="horasContrato" name="horasContrato" size="11" maxlength="11" class="inputTexto textoNumerico" onblur="reemplazarPuntosEca(this); ajustarDecimalesImportes();"/>
                    </div>                
                </div>     
                <div class="lineaFormulario">                         
                    <div style="width: 90px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.empresa")%><font color="red">*</font>
                    </div>
                    <div style="width: 240px; float: left;">
                        <input type="text" id="empresa" name="empresa" size="35" maxlength="200" class="inputTexto" />
                    </div>   
                     <!--div style="width: 80px; float: left;">
                        <%//=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.persContacto")%>
                    </div>
                    <div style="width: 100px; float: left;">
                        <input type="text" id="persContacto" name="persContacto" size="60" maxlength="200" class="inputTexto" />
                    </div-->    
                </div>
                <div class="lineaFormulario">                         
                     <% if (tiposeg.equals("0")) { %>
                    <div style="width: 90px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fecseguimiento")%><font color="red">*</font>
                    </div>                    
                    <div style="width: 240px; float: left;">
                         <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fecSeguimiento" name="fecSeguimiento" onkeyup="return SoloCaracteresFecha(this);" onblur=" javascript:return comprobarFechaEca(this, '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();"/>
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaSeguimiento(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFecSeguimiento" name="calFechaFin" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.fecseguimiento")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>  
                         <% } %>
                     <div style="width: 100px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.observaciones")%>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                        <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.nifPreparador")%><font color="red">*</font>
                    </div>
                    <div style="width: 101px; float: left;">
                        <input type="text" id="nifPreparador" name="nifPreparador" size="10" maxlength="10" class="inputTexto readOnly" />
                    </div>
                </div> 
               <div class="botonera" style="padding-top: 20px;">
                    <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "btn.general.aceptar")%>" onclick="guardarSeguimiento();">
