                    ...
                    <div style="width: 130px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descSector" name="descSector" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorSector" name="anchorSector" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonSector" name="botonSector" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </div>
                <div class="lineaFormulario">
                    ...
                    <div style="width: 100px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descProvincia" name="descProvincia" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorProvincia" name="anchorProvincia" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonProvincia" name="botonProvincia" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>                
                </div>
               <div class="lineaFormulario">
                    ...
                    <div style="width: 240px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descLismi" name="descLismi" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorLismi" name="anchorLismi" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonLismi" name="botonLismi" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div> 
                    <div style="width: 100px; float: left;">
                    ...
                    <div style="width: 240px; float: left;">                      
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descResultado" name="descResultado" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorResultado" name="anchorResultado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonResultado" name="botonResultado" style="cursor:hand;" alt="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide44I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                       </div> 
                </div>
