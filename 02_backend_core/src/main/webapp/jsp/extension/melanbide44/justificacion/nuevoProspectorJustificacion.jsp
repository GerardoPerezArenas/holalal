...
<%
 ...
 String css = "";
    ...
    //Clase para internacionalizar los mensajes de la aplicaci贸n.
    ...
    if(consulta)
    {
        tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.consultaProspector.tituloPagina");
    }
    else
    {
        if(prospectorModif != null)
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.modifProspector.tituloPagina");
        }
        else
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.nuevoProspector.tituloPagina");
        }
    }
%>
...
<script type="text/javascript">
    ...
    function guardar(){
        if(validarDatos()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=guardarProspectorJustificacion&tipo=0&numero=<%=numExpediente%>'
    ...
    function validarDatos(){
        ...
        if(nuevo){
            ...
            if(fecIni == null || fecIni == ''){
                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.fechaIniVacio")%>';
                return false;
            }
            /*var fecFin = document.getElementById('fechaFin').value;
            if(fecFin == null || fecFin == ''){
                mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.solicitud.preparadores.fechaFinVacio")%>';
                return false;
            }*/
        }
        ...
        if(correcto && nuevo){
            ...
            if(feIni != undefined && feIni != ''){
                ...
                if(anoIni != '<%=anoExpediente%>'){
                    ...
                    document.getElementById('fechaInicio').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=String.format(meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.preparadores.fechasAnoExpediente"), anoExpediente)%>';
                }else{
                    document.getElementById('fechaInicio').removeAttribute('style');
                }
            }
            ...
            if(hayFeIni && hayFeFin && correcto){
                ...
                <% if (prospectorOrigen != null){ %>
                    ...
                    //alert('fechas origen:'+finiOrigen+' - '+ffinOrigen);
                        ...
                        //document.getElementById('fechaFin').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.preparadores.fechaIniAnteriorAOrigen")%>';
                        correcto = false;
                    }*/
                <% } %>
        ...
        //TODO: Fecha de inicio o fin en el a帽o del expediente ???
        
        //Horas Anuales Jornada Completa >= Horas contrato >= Horas dedicaci贸n ECA
        var hajc = 0.0;
        var hc = 0.0;
        var hdECA = 0.0;
        ...
        //Horas dedicaci贸n ECA >= 50% Horas contrato
        hc = 0.0;
        hdECA = 0.0;
        if(document.getElementById('horasContrato').value != ''){
            try{
        ...
        //Aunque las horas de ECA sean menor del 50% de las horas anuales, dejar guardar, pero marcar como err髇eo (rojo)
        /*if(correcto && nuevo){
            hc *= 0.5;
            if(hdECA < hc){
                correcto = false;
                document.getElementById('horasDedicacionEca').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.prospectores.horasDedicacionEca50HorasContrato")%>';
            }else{
                document.getElementById('horasDedicacionEca').removeAttribute('style');
            }
        }*/
        ...
        //Costes salariales + Seg social JC >= Costes salariales + Seg social Contrato >= Costes salariales + Seg social dedicaci贸n ECA
        var cssJC = 0.0;
        var cssPorJor = 0.0;
        var cssECA = 0.0;
        ...
        //TODO: Los totales finales: 驴Calculados o insertados?
    ...
    <form>
        ...
        <div style="width: 100%;  text-align: left;">
            ...
            <div class="sub3titulo" style="clear: both; text-align: left;height:18px;">
                <span>
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.datosProspector")%>
                </span>
            </div>
            <div class="lineaFormulario" >
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.prospectorOrigen")%>
                </div>
            ...
            <div class="lineaFormulario">
                <div style="width: 36px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.nif")%><font color="red">*</font>
                </div>
                <div style="width: 101px; float: left;">
                    <input type="text" id="nif" name="nif" size="10" maxlength="10" class="inputTexto"/>
                </div>
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.nomApel")%><font color="red">*</font>
                </div>
            ...
            <div class="lineaFormulario">
                <div style="width: 94px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.fechaInicio")%><font color="red">*</font>
                </div>
                ...
                <div style="width: 94px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.fechaFin")%>
                </div>
                <div style="width: 140px; float: left;">
            ...
            <div class="lineaFormulario">
                <div style="width: 150px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.horasAnualesJC")%>
                </div>
                ...
                <div style="width: 117px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.horasContrato")%>
                </div>
                ...
                <div style="width: 157px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.horasDedicacionEca")%>
                </div>
                <div style="width: 108px; float: left;">
            ...
            <div class="lineaFormulario">
                <div style="width: 150px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.costesSalarialesSSJor")%>
                </div>
                <div style="width: 112px; float: left;">
                ...
                <div style="width: 117px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.costesSalarialesSSPorJor")%>
                </div>
                <div style="width: 108px; float: left;">
                ...
                <div style="width: 157px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.costesSalarialesSSEca")%>
                </div>
                <div style="width: 108px; float: left;">
            ...
            <div class="lineaFormulario" >
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.prospectorSustituto")%>
                </div>
                <div style="width: 85px; float: left;">
