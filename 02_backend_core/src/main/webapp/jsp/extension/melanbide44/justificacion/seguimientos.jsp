...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            String tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.tituloPagina");
        %>
        ...
        <script type="text/javascript">
            ...
            function pulsarEliminarSegPreparador(){
                    if(tabSeguimientos_prep.selectedIndex != -1) {
                        ...
                        if (resultado == 1){
                            ...
                            parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=eliminarSegPreparador&tipo=0&numero=<%=numExpediente%>&idSegPrep='+listaSeguimientos_prep[tabSeguimientos_prep.selectedIndex][0]+'&tipoSeg=<%=ConstantesMeLanbide44.TIPO_SEGUIMIENTO_MELANBIDE44%>&colectivo=<%=colectivo%>&sexo=<%=sexo%>&filtrar=<%=preparador != null ? "1" : "0"%>&control='+control.getTime();
                            try{
           ...
           // var camposErrores = new Array();
                ...
                for(var i = 1;i< result.length; i++){
                    ...
                    listaSeguimientos_prepTabla[i-1] = [fila[17] != undefined && fila[17].length > 0 ? '<div style=\"width:30;\"><img src="<%=request.getContextPath()%>/images/extension/melanbide44/alert.png"/>' : ''+'</div>', '<div style=\"width:80;\">'+fila[1]+'</div>', fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9], fila[10], fila[11], fila[12], fila[13], fila[14], fila[15]];
                ...
                tabSeguimientos_prep.addColumna('30','center','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col0")%>','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0.title")%>');    
                tabSeguimientos_prep.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col2")%>');
                tabSeguimientos_prep.addColumna('150','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col3")%>');
                //tabSeguimientos_prep.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col1")%>');
                tabSeguimientos_prep.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col4")%>');
                tabSeguimientos_prep.addColumna('60','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col5")%>');
                tabSeguimientos_prep.addColumna('90','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col6")%>');
                tabSeguimientos_prep.addColumna('100','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col7")%>');
                tabSeguimientos_prep.addColumna('100','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col8")%>');
                tabSeguimientos_prep.addColumna('70','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col9")%>');
                tabSeguimientos_prep.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col10")%>');
                tabSeguimientos_prep.addColumna('80','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col11")%>');
                tabSeguimientos_prep.addColumna('100','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col12")%>');
                tabSeguimientos_prep.addColumna('130','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col13")%>');
                //tabSeguimientos_prep.addColumna('150','left','<%//=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col14")%>');
                tabSeguimientos_prep.addColumna('90','right','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col15")%>');
                tabSeguimientos_prep.addColumna('250','left','<%=meLanbide44I18n.getMensaje(idiomaUsuario, "label.justificacion.seguimiento.tabla.col16")%>');
    ...
    <body onload="inicio();" class="contenidoPantalla etiqueta" style="margin:0" >
        ...
        <script type="text/javascript">
            ...
            %>
                ...
                listaSeguimientos_prepTabla[<%=i%>] = ['<%=act.getErrores() != null && act.getErrores().size() > 0 ? "<img src=\""+request.getContextPath()+"/images/extension/melanbide44/alert.png\" />" : ""%>', '<%=act.getNif()%>', '<%=act.getNombreApe()%>', '<%=act.getFecSeguimiento()%>', '<%=act.getFecNacimiento()%>',
               ...
               listaSeguimientos_prepTabla_titulos[<%=i%>] = [erroresStr,'<%=act.getNif()%>', '<%=act.getNombreApe()%>'/*,'<%=act.getFecSeguimiento()%>'*/, '<%=act.getFecNacimiento()%>',
                ...
                listaSeguimientos_prepTabla[<%=i%>] = ['<div style=\"width:30;\"><%=act.getErrores() != null && act.getErrores().size() > 0 ? "<img src=\""+request.getContextPath()+"/images/extension/melanbide44/alert.png\" />" : ""%></div>','<div style=\'width:80\'>'+'<%=act.getNif()%></div>', '<%=act.getNombreApe()%>'/*,'<%=act.getFecSeguimiento()%>'*/, '<%=act.getFecNacimiento()%>',
