...
<%
 ...
 String css = "";
    ...
    if(consulta)
    {
        tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.consultaPreparador.tituloPagina");
    }
    else
    {
        if(preparadorModif != null)
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.modifPreparador.tituloPagina");
        }
        else
        {
            tituloPagina = meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.nuevoPreparador.tituloPagina");
        }
    }
%>
...
<script type="text/javascript">
    ...
    function guardar(){
        if(validarDatos()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE44&operacion=guardarPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>'
       ...
       if(nuevo){
        ...
        if (nuevo){
            ...
            if(document.getElementById('codTipoContrato').value == ''){
                 ...
                 if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.justificacion.preparadores.tipoContratoOblig")%>';
        ...
        //COMPROBACION FECHAS ORIGEN Y SUSTITUTO
               ...
               var array_fecha_ini = feIni.split('/');
                ...
                var n2 = dIni.getTime();
                    ...
                    //alert('fechas origen:'+finiOrigen+' - '+ffinOrigen);
                        ...
                        //document.getElementById('fechaFin').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validaciones.justificacion.preparadores.fechaIniAnteriorAOrigen")%>';
                        correcto = false;
                    }*/
            <% } %>
            ...
            <% if (sustituto != null){ %>
                    ...
                    if (resultFcontrato <= 0){                   
                        document.getElementById('fechaFin').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "validacion.justificacion.preparadores.fechaIniAnteriorAOrigen")%>';
                        correcto = false;
                    }*/
            <% } %>
        ...
        if(correcto && nuevo){
            ...
            if(hdECA < hc){
                ...
                document.getElementById('horasDedicacionEca').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide44I18n.getMensaje(idiomaUsuario, "msg.justificacion.preparadores.horasDedicacionEca50HorasContrato")%>';
            }else{
                document.getElementById('horasDedicacionEca').removeAttribute('style');
            }
        }
        ...
        <div style="width: 100%; text-align: left;">
            ...
            <div class="lineaFormulario" id="divOrigen">
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.preparadorOrigen")%>
                </div>
            ...
            <div class="lineaFormulario">
                <div style="width: 100px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.tipocontrato")%><font color="red">*</font>
                </div>
            ...
            <div class="lineaFormulario">
                <div style="width: 94px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.solicitud.preparadores.fechaInicio")%><%if(preparadorModif == null){%><font color="red">*</font><%}%>
                </div>
            ...
            <div class="lineaFormulario" id="divSustituto">
                <div style="width: 120px; float: left;">
                    <%=meLanbide44I18n.getMensaje(idiomaUsuario,"label.justificacion.preparadores.preparadorSustituto")%>
                </div>
                <div style="width: 85px; float: left;">
