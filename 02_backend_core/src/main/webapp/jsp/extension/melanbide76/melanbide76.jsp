...
<script type="text/javascript">
    function pulsarNuevaContratacion() {
        lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE76&operacion=cargarNuevaContratacion&tipo=0&numExp=<%=numExpediente%>&nuevo=1', 750, 1200, 'no', 'no', function (result) {
            if (result != undefined) {
                if (result[0] == '0') {
    ...
    function pulsarModificarContratacion() {
        if (tabaAccesos.selectedIndex != -1) {
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE76&operacion=cargarModificarContratacion&tipo=0&nuevo=0&numExp=<%=numExpediente%>&id=' + listaAccesos[tabaAccesos.selectedIndex][0], 750, 1200, 'no', 'no', function (result) {
                if (result != undefined) {
                    if (result[0] == '0') {
                        recargarTablaContrataciones(result);
                    }
            ...
            jsp_alerta('A', '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.msjNoSelecFila")%>');
        }
    }

    function pulsarEliminarContratacion() {
        if (tabaAccesos.selectedIndex != -1) {
            var resultado = jsp_alerta('', '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminar")%>');
            if (resultado == 1) {
                ...
                var parametros = "";
                parametros = 'tarea=preparar&modulo=MELANBIDE76&operacion=eliminarContratacion&tipo=0&numExp=<%=numExpediente%>&id=' + listaAccesos[tabaAccesos.selectedIndex][0];
                try {
    ...
    function inicializarTabla() {
        ...
        tabaAccesos.addColumna('50', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.id")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.nOferta")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.idContratoOferta")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.idContratoDirecto")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.dni_nie")%>");
        tabaAccesos.addColumna('200', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.nombre")%>");
        tabaAccesos.addColumna('200', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.apellido1")%>");
        tabaAccesos.addColumna('200', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.apellido2")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.fechaNacimiento")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.edad")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.sexo")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.may45")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.finFormativa")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.codFormativa")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.denFormativa")%>");
        tabaAccesos.addColumna('200', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.puesto")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.codOcupacion")%>");
        tabaAccesos.addColumna('330', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.ocupacion")%>");
        tabaAccesos.addColumna('330', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.desTitulacion")%>");
        tabaAccesos.addColumna('330', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.titulacion")%>");
        tabaAccesos.addColumna('330', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.cProfesionalidad")%>");
        tabaAccesos.addColumna('150', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.modalidadContrato")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.jornada")%>");
        tabaAccesos.addColumna('50', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.porcJornada")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.horasConv")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.fechaInicio")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.fechaFin")%>");
        tabaAccesos.addColumna('50', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.mesesContrato")%>");
        tabaAccesos.addColumna('350', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.grupoCotizacion")%>");
        tabaAccesos.addColumna('250', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.direccionCT")%>");
        tabaAccesos.addColumna('100', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.nSS")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.costeContrato")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.tipRetribucion")%>");
        tabaAccesos.addColumna('70', 'center', "<%=meLanbide76I18n.getMensaje(idiomaUsuario,"contratacion.tablaContrataciones.importeSub")%>");
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide76/FixedColumnsTable.js"></script>
...
<div class="tab-page" id="tabPage761" style="height:520px; width: 100%;">
    <h2 class="tab" id="pestana761"><%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.titulo.pestana")%></h2> 
    <script type="text/javascript">tp1.addTabPage(document.getElementById("tabPage761"));</script>
    <br/>
    <h2 class="legendAzul" id="pestanaPrinc"><%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.tituloPrincipal")%></h2>
    <div>    
        <br>
        <div id="divGeneral">     
        ...
        <div class="botonera" style="text-align: center;">
            <input type="button" id="btnNuevoAcceso" name="btnNuevoAcceso" class="botonGeneral"  value="<%=meLanbide76I18n.getMensaje(idiomaUsuario, "btn.nuevo")%>" onclick="pulsarNuevaContratacion();">
            <input type="button" id="btnModificarAcceso" name="btnModificarAcceso" class="botonGeneral" value="<%=meLanbide76I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarContratacion();">
            <input type="button" id="btnEliminarAcceso" name="btnEliminarAcceso"   class="botonGeneral" value="<%=meLanbide76I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarContratacion();">
        </div>
    </div>  
</div>
<script  type="text/javascript">
                ...
                for (int indice=0;indice<List.size();indice++)
                {
                    ...
                    if(objectVO.getDesSexo()!=null){
                        ...
                        if(descripcionDobleIdioma!=null && descripcionDobleIdioma.length>1){
                            if(idiomaUsuario==ConstantesMeLanbide76.CODIGO_IDIOMA_EUSKERA){
                    ...
                    String mayor45="";
                    if(objectVO.getMayor45()!=null){
                        mayor45=objectVO.getMayor45();
                    }else{
                        mayor45="-";
                    }
                    String finFormativa="";
    ...
    listaAccesos[<%=indice%>] = ['<%=objectVO.getId()%>', '<%=oferta%>', '<%=idContrato1%>', '<%=idContrato2%>', '<%=dni%>',
        '<%=nombre%>', '<%=apellido1%>', '<%=apellido2%>', '<%=fechaNacimiento%>', '<%=edad%>', '<%=sexo%>', '<%=mayor45%>',
