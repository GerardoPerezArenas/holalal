            ...
            function guardarDatos() {
                ...
                if (validarDatosNumericosVacios() && validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE76&operacion=crearNuevaMinimis&tipo=0"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE76&operacion=modificarMinimis&tipo=0"
            ...
            function validarDatosNumericosVacios() {
                ...
                if (document.getElementById('importe').value == null || document.getElementById('importe').value == '') {
                    ...
                    if (!validarNumericoDecimalPrecision(document.getElementById('importe').value, 8, 2)) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.importe.errNumerico")%>';
                        return false;
                    }
                }
                return correcto;
            ...
            <form><!--    action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.nuevaSubvencion")%>
                        </span>
                    </div> 
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.estado")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.organismo")%>
                        </div>
                        <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.objeto")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.importe")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.fecha")%>
                        </div>
                        <div>
                            <div style="float: left;">
