...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide76.i18n.MeLanbide76I18n" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide76.vo.ContratacionVO" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide76.vo.DesplegableAdmonLocalVO" %>
<%@page import="es.altia.agora.business.escritorio.UsuarioValueObject" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide76.util.ConstantesMeLanbide76" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide76.util.ConfigurationParameter" %>
...
<html>
    <head>
        ...
        <%
            ...
            MeLanbide76I18n meLanbide76I18n = MeLanbide76I18n.getInstance();
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/extension/melanbide76/melanbide76.css"/>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/general.js"></script>
        <script type="text/javascript" src="<c:url value='/scripts/listaComboBox.js'/>"></script>
        <script type="text/javascript" src="<c:url value='/scripts/calendario.js'/>"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/validaciones.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/popup.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/meLanbide76/JavaScriptUtil.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/meLanbide76/Parsers.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/meLanbide76/InputMask.js"></script>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        <script type="text/javascript">
            ...
            var comboListaMayor45;
            var listaCodigosMayor45 = new Array();
            var listaDescripcionesMayor45 = new Array();
            function buscaCodigoMayor45(codMayor45) {
                comboListaMayor45.buscaCodigo(codMayor45);
            }
            function cargarDatosMayor45() {
                var codMayor45Seleccionado = document.getElementById("codListaMayor45").value;
                buscaCodigoMayor45(codMayor45Seleccionado);
            }
            ...
            function rellenardatModificar() {
                if ('<%=datModif%>' != null) {
                    ...
                    buscaCodigoMayor45('<%=datModif.getMayor45() != null ? datModif.getMayor45() : ""%>');
            ...
            function guardarDatos() {
                ...
                if (validarDatosNumericosVacios() && validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE76&operacion=crearNuevaContratacion&tipo=0"
                                ...
                                + "&mayor45=" + document.getElementById('codListaMayor45').value
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE76&operacion=modificarContratacion&tipo=0"
                    ...
                    try {
                        ...
                        for (j = 0; hijos != null && j < hijos.length; j++) {
                            if (hijos[j].nodeName == "CODIGO_OPERACION") {
                                ...
                                for (var cont = 0; cont < hijosFila.length; cont++) {
                                    ...
                                    } else if (hijosFila[cont].nodeName == "MAY45CONT") {
                                        if (hijosFila[cont].childNodes[0].nodeValue != "null") {
                        ...
                        if (codigoOperacion == "0") {
                            ...
                            jsp_alerta("A", '<%=meLanbide76I18n.getMensaje(idiomaUsuario,"error.errorBD")%>');
                        } else if (codigoOperacion == "2") {
                            jsp_alerta("A", '<%=meLanbide76I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        } else if (codigoOperacion == "3") {
                            jsp_alerta("A", '<%=meLanbide76I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                        } else {
                            jsp_alerta("A", '<%=meLanbide76I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        }
                    } catch (Err) {
            ...
            function cancelar() {
                var resultado = jsp_alerta('', '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.preguntaCancelar")%>');
                if (resultado == 1) {
                    cerrarVentana();
                }
            }
            ...
            function validarDatosNumericosVacios() {
                ...
                if (document.getElementById('porcJornada').value == null || document.getElementById('porcJornada').value == '') {
                    ...
                    if (!validarNumericoDecimalPrecision(document.getElementById('porcJornada').value, 5, 2) || !validarNumericoPorcentaje70(document.getElementById('porcJornada').value)) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.porcJornada.errNumerico")%>';
                        return false;
                    }
                }
                ...
                if (document.getElementById('mesesContrato').value == null || document.getElementById('mesesContrato').value == '') {
                    ...
                    if (!validarNumerico(document.getElementById('mesesContrato'))) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.mesesContrato.errNumerico")%>';
                        return false;
                    }
                }
                ...
                if (document.getElementById('costeContrato').value == null || document.getElementById('costeContrato').value == '') {
                    ...
                    if (!validarNumericoDecimalPrecision(document.getElementById('costeContrato').value, 8, 2)) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.costeContrato.errNumerico")%>';
                        return false;
                    }
                }
                ...
                if (document.getElementById('importeSub').value == null || document.getElementById('importeSub').value == '') {
                    ...
                    if (!validarNumericoDecimalPrecision(document.getElementById('importeSub').value, 8, 2)) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.importeSub.errNumerico")%>';
                        return false;
                    }
                }
            ...
            function validarDatos() {
                ...
                {
                    mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.datosSeleccion")%>';
                    //return false;
                }

                var dni = document.getElementById('dni').value;
                /*if (dni == null || dni == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.dni")%>';
                 return false;
                 }*/
                var nombre = document.getElementById('nombre').value;
                /*if (nombre == null || nombre == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.nombre")%>';
                 return false;
                 }*/
                var apellido1 = document.getElementById('apellido1').value;
                /*if (apellido1 == null || apellido1 == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.apellido1")%>';
                 return false;
                 }*/
                var apellido2 = document.getElementById('apellido2').value;
                /*if (apellido2 == null || apellido2 == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.apellido2")%>';
                 return false;
                 }*/
                var fechaNacimiento = document.getElementById('fechaNacimiento').value;
                /*if (fechaNacimiento == null || fechaNacimiento == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.fecNac")%>';
                 return false;
                 }*/
                var edad = document.getElementById('edad').value;
                if (edad == null || edad == '') {
                    /*  mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.edad")%>';
                     return false;*/
                } else {
                    if (!validarNumerico(document.getElementById('edad'))) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.edad.errNumerico")%>';
                        return false;
                    }
                }
                var sexo = document.getElementById('codListaSexo').value;
                /*if (sexo == null || sexo == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.sexo")%>';
                 return false;
                 }*/
                var mayor45 = document.getElementById('codListaMayor45').value;
                /*if (mayor45 == null || mayor45 == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.may45")%>';
                 return false;
                 }*/
                var finFormativa = document.getElementById('codListaFinFormativa').value;
                /*if (finFormativa == null || finFormativa == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.finFormativa")%>';
                 return false;
                 }*/

                var puesto = document.getElementById('puesto').value;
                /*if (puesto == null || puesto == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.puesto")%>';
                 return false;
                 }*/
                ...
                /*if ((ocupacion == null || ocupacion == '') && (desOcupacionLibre == null || desOcupacionLibre == '')) {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.ocupacion")%>';
                 return false;
                 }*/
                var modalidadContrato = document.getElementById('modalidadContrato').value;
                /*if (modalidadContrato == null || modalidadContrato == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.modalidad")%>';
                 return false;
                 }*/
                var jornada = document.getElementById('codListaJornada').value;
                /*if (jornada == null || jornada == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.jornada")%>';
                 return false;
                 }*/
                ...
                {
                    mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.porcJornada")%>';
                    return false;
                }
                ...
                if (horasConv == null || horasConv == '') {
                    ...
                    if (!validarNumerico(document.getElementById('horasConv'))) {
                        mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.horasConv.errNumerico")%>';
                        return false;
                    }
                }
                var fechaInicio = document.getElementById('fechaInicio').value;
                /*if (fechaInicio == null || fechaInicio == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.fechInicio")%>';
                 return false;
                 }*/
                var grupoCotizacion = document.getElementById('codListaGrupoCotizacion').value;
                /*if (grupoCotizacion == null || grupoCotizacion == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.grupoCotizacion")%>';
                 return false;
                 }*/
                var direccionCT = document.getElementById('direccionCT').value;
                /*if (direccionCT == null || direccionCT == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.direccionCT")%>';
                 return false;
                 }*/
                var numSS = document.getElementById('numSS').value;
                /*if (numSS == null || numSS == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.nSS")%>';
                 return false;
                 }*/
                var costeContrato = document.getElementById('costeContrato').value;
                /*if (costeContrato == null || costeContrato == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.costeContrato")%>';
                 return false;
                 }*/
                var importeSub = document.getElementById('importeSub').value;
                /*if (importeSub == null || importeSub == '') {
                 mensajeValidacion = '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.importeSub")%>';
                 return false;
                 }*/
            ...
            function comprobarFechaLanbide(inputFecha) {
                ...
                if (Trim(inputFecha.value) != '') {
                    ...
                    if (!D[0]) {
                        jsp_alerta("A", "<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>");
            ...
            function compruebaTamanoCampo(elemento, maxTex) {
                ...
                if (texto.length > maxTex) {
                    jsp_alerta("A", '<%=meLanbide76I18n.getMensaje(idiomaUsuario, "msg.errExcdTexto")%>');
                    elemento.focus();
                    return false;
                }
                return true;
    ...
    <body>
        <div class="contenidoPantalla">
            <form><!--    action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.nuevaContratacion")%>
                        </span>
                    </div> 
                    ...
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 12px;">
                        <span>
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.datosSeleccion")%>
                        </span>
                    </div> 

                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.nOferta")%>
                        </div>
                        <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.idContratoOferta")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.idContratoDirecto")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 12px;">
                        <span>
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.datosPersonaContratada")%>
                        </span>
                    </div>        
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.dni_nie")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.nombre")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.apellido1")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.apellido2")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.fechaNacimiento")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.edad")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.sexo")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.may45")%>
                        </div>
                        <div>
                            <div>
                                <input type="text" name="codListaMayor45" id="codListaMayor45" size="12" class="inputTexto" value="" onkeyup="xAMayusculas(this);" />
                                <input type="text" name="descListaMayor45"  id="descListaMayor45" size="60" class="inputTexto" readonly="true" value="" />
                                <a href="" id="anchorListaMayor45" name="anchorListaMayor45">
                                    <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonAplicacion"
                                          name="botonAplicacion" style="cursor:pointer;"></span>
                                </a>
                            </div>
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.finFormativa")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.codFormativa")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.denFormativa")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 12px;">
                        <span>
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.datosPuestoTrabajo")%>
                        </span>
                    </div>    

                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.puesto")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.ocupacion")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.desOcupacionLibre")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.desTitulacionLibre")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.titulacion")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.cProfesionalidad")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.modalidadContrato")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.jornada")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.porcJornada")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.horasConv")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.fechaInicio")%>
                        </div>
                        <div>
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.fechaFin")%>
                        </div>
                        <div>
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.mesesContrato")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.grupoCotizacion")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.direccionCT")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.nSS")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.costeContrato")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.tipoRetribucion")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide76I18n.getMensaje(idiomaUsuario,"label.importeSub")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario" style="margin-top: 25px;">
                        <div class="botonera" style="text-align: center;">
                            <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide76I18n.getMensaje(idiomaUsuario, "btn.aceptar")%>" onclick="guardarDatos();"/>
                            <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide76I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();"/>
                        </div>
                    </div>
                </div>
            ...
            <script type="text/javascript">
                ...
                /*desplegable mayor45*/
                listaCodigosMayor45[0] = "";
                listaDescripcionesMayor45[0] = "";
                contador = 0;
                <logic:iterate id="mayor45" name="listaMayor45" scope="request">
                listaCodigosMayor45[contador] = ['<bean:write name="mayor45" property="des_val_cod" />'];
                listaDescripcionesMayor45[contador] = ['<bean:write name="mayor45" property="des_nom" />'];
                contador++;
                </logic:iterate>
                comboListaMayor45 = new Combo("ListaMayor45");
                comboListaMayor45.addItems(listaCodigosMayor45, listaDescripcionesMayor45);
                comboListaMayor45.change = cargarDatosMayor45;
