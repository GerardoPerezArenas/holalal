...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide66.vo.InfoDesplegableVO" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide66.vo.InfoCampoSuplementarioVO" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide66.vo.ElementoDesplegableVO" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide66.vo.FacturaVO" %>
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide66/lanbide.js"></script>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>

        <script type="text/javascript">
    var COD_FECSUBS = '<%=ConstantesMeLanbide66.getPropVal_CS_FECSUBSANAR(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_FECPRIMERPAGO = '<%=ConstantesMeLanbide66.getPropVal_CS_FECPRIMERPAGO(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_SUBS = '<%=ConstantesMeLanbide66.getPropVal_CS_SUBSANAR(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_PRIMPAGO = '<%=ConstantesMeLanbide66.getPropVal_CS_PRIMERPAGO(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_PRIMPAGOCB = '<%=ConstantesMeLanbide66.getPropVal_CS_PRIMERPAGOCB(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_IMPREINTEGRO = '<%=ConstantesMeLanbide66.getPropVal_CS_IMPREINTEGRO(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_REINTEGRAR = '<%=ConstantesMeLanbide66.getPropVal_CS_REINTEGRAR(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_SEGPAGO = '<%=ConstantesMeLanbide66.getPropVal_CS_SEGPAGO2(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_FECACUSE = '<%=ConstantesMeLanbide66.getPropVal_CS_FECACUSERECIBO(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_SUBV = '<%=ConstantesMeLanbide66.getPropVal_CS_SUBV(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_SUBVCB = '<%=ConstantesMeLanbide66.getPropVal_CS_SUBVCB(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_CAUSAREINT = '<%=ConstantesMeLanbide66.getPropVal_CS_CAUSAREINT(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_CANTMIN = '<%=ConstantesMeLanbide66.getPropVal_CS_CANTMIN(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    var COD_FECIAE = '<%=ConstantesMeLanbide66.getPropVal_CS_FECALTAIAE(codOrganizacion,ConstantesMeLanbide66.getCOD_PROCEDIMIENTO())%>';
    ...
    var valActualFechaIAE;
    var ejercicioExpJS = <%=ejercicio%>;
    ...
    function rellenarDatos(tableName, rowID) {
        if (tablaFacturas == tableName) {
            if (rowID >= 0) {
                ...
                if (ejercicioExpJS >= 2018) {
                    if (listaFacturas[rowID][5] == '2'
                            || listaFacturas[rowID][5] == '3'
                            || listaFacturas[rowID][5] == '4') {
    ...
    function cargarDesgloseConcepto() {
        if (comboConcepto.selectedIndex > 0) {
            var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=cargarDesgloseConcepto&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
    ...
    function guardarDatosFactura() {
        if (validaFormulario()) {
            ...
            var parametros = 'tarea=preparar&modulo=MELANBIDE66&operacion=guardarFactura&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>'
                    + '&estado=' + estado + '&fecha=' + fecha + '&codConcepto=' + codConcepto + '&codSubcpto=' + codSubcpto + '&importe=' + importe + '&entreg=' + entregada
                    + '&justif=' + justificada + '&observ=' + escape(observ) + '&identFact=' + escape(identFact);
    ...
    function modificarDatosFactura() {
        if (tablaFacturas.selectedIndex != -1) {
            if (validaFormulario()) {
                ...
                var parametros = 'tarea=preparar&modulo=MELANBIDE66&operacion=guardarFactura&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>'
                        + '&estado=' + estado + '&fecha=' + fecha + '&codConcepto=' + codConcepto + '&codSubcpto=' + codSubcpto + '&importe=' + importe + '&entreg=' + entregada
                        + '&justif=' + justificada + '&observ=' + escape(observ) + '&identFact=' + escape(identFact) + '&id=' + id;
    ...
    function eliminarFactura() {
        if (tablaFacturas.selectedIndex != -1) {
            var id = listaFacturas[tablaFacturas.selectedIndex][0];
            var parametros = 'tarea=preparar&modulo=MELANBIDE66&operacion=eliminarFactura&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>'
                    + '&id=' + id;
            if (jsp_alerta("C", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.preguntaEliminar")%>') == 1) {
                realizarPeticionAjax(parametros);
            }
        } else
            mostrarMensajeAviso(1);
    ...
    function recuperarValoresCS() {
        var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=recuperarValoresCS&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
        pleaseWait('on');
        try {
            $.ajax({
                url: url,
    ...
    function recargarFechasCalculadas() {
        var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=recargarFechasCalculadas&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
        pleaseWait('on');
        try {
            $.ajax({
                url: url,
    ...
    function guardarValoresCS(tipo, valor) {
        var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=guardarValoresCS&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
    ...
    function guardarImportePagoReintegro(tipo, campo1, valor1, campo2, cantminorada) {
        var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=guardarImportePago&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
                ...
                if ($('#capaDatosSuplementarios_DEF')) {
                    ...
                    if (datos.tabla.tipoCalculo == "pago") {
                        ...
                        if (datos.tabla.tipoCalculo == "reintegro") {
                            // Indico causa 6
                            var codMotivo = '<%=ConstantesMeLanbide66.getCOD_MOTIVOREINT()%>';
                            var descMotivo = '<%=ConstantesMeLanbide66.getVAL_MOTIVOREINT()%>';
                            ...
                            var marca = '<%=ConstantesMeLanbide66.getCOD_AREINTEGRAR()%>';
    ...
    function procesarRespuestaCargarDesgloseConcepto(result) {
        ...
        if (result) {
            ...
            if (ejercicioExpJS >= 2018) {
                if (datos.concepto > "1" && datos.concepto < "5") {
                    comboDesglose.activate();
                } else {
                    comboDesglose.deactivate();
                    comboDesglose.selectItem(1);
    ...
    function procesarRespuestaRecargarFechasCalculadas(result) {
        ...
        if (result) {
            ...
            if (datos.error == "0") {
                ...
                $('#fechaAltaIAE').val(datos.csFechaIAE.valor);
            } else
    ...
    function copyToClipboard() {
        var url = baseUrl + 'tarea=preparar&modulo=MELANBIDE66&operacion=copiarTextoAPortapapeles&tipo=0&numExp=<%=numExpediente%>&codOrg=<%=codOrganizacion%>';
    ...
    function procesarRespuestaCopiarTextoAPortapapeles(result) {
        ...
        if (result) {
            ...
            if (datos.error == "0") {
                ...
                mostrarVentana(str, '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFactASubsanar")%>');
            } else
                mostrarMensajeError(datos.error);
        } else
            mostrarMensajeError();
    ...
    function recargarTabla(datos) {
        ...
        datos[datos.length] = [
            '', '', '', '', '<b>' + '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.filaTotal.col5")%>' + '</b>',
    ...
    function inicializarDesplegables() {
        ...
        //rellenar campo suplementario fecha IAE
        valActualFechaIAE = '';
            <%
                if(request.getAttribute("csFechaIAE")!=null){
                    InfoCampoSuplementarioVO campo = (InfoCampoSuplementarioVO) request.getAttribute("csFechaIAE");
                    String valFecIAE = (String) campo.getValor();
            %>
        valActualFechaIAE = '<%=valFecIAE%>';
        if (valActualFechaIAE == "null")
            valActualFechaIAE = '';
            <% } %>

        $('#fechaAltaIAE').val(valActualFechaIAE);
    ...
    function mostrarMensajeError(codigo) {
        ...
        if (codigo == "1") {
            ...
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorParsearDatos")%>');
        } else if (codigo == "4") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.falloOperacionIns")%>');
        } else if (codigo == "5") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.falloOperacionMod")%>');
        } else if (codigo == "6") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorModDatos")%>');
        } else if (codigo == "7") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.falloOperacionElim")%>');
        } else if (codigo == "8") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorElimDatos")%>');
        } else if (codigo == "9") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorCargarLista")%>');
        } else if (codigo == "10") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorRecuperarValores")%>');
        } else if (codigo == "11") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorGuardarValores")%>');
        } else if (codigo == "12") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.falloOperacionCalcular")%>');
        } else if (codigo == "13") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.errorCopyToClipboard")%>');
        } else if (codigo == "14") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"error.falloOperacionGrabarCS")%>');
        } else if (codigo == "20") {
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"aviso.noHayFactASubs")%>');
        } else {
    ...
    function mostrarMensajeAviso(codigo) {
        var mensaje = "";
        if (codigo == "1") {
            mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"aviso.noFilaSeleccionada")%>';
        } else if (codigo == "2") {
            mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"aviso.exitoOperacionCalcular")%>';
        } else if (codigo == "3") {
            mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"aviso.sinValoresParaCalcular")%>';
        } else if (codigo == "4") {
            mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"aviso.noHayFacturas")%>';
        }
    ...
    function realizarCalculo() {
        ...
        if (validarCSparaCalculo(campos) || validarCSparaCalculo(camposCB)) {
            ...
            if (valSubs == "X" && (valFec == undefined || valFec == "" || valFec == null)) {
                pleaseWait('off');
                $("#msgSubsanar").html('<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.subsPendienteNoCalc")%>');
            } else {
                $("#msgSubsanar").html('');
                ...
                if (preguntar > 0) {
                    ...
                    var valor = "";
                    if (preguntar == 1) {
                        mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.existeImporteSegPago")%>';
                        valor = valSegPago;
                    } else if (preguntar == 2) {
                        mensaje = '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.existeImporteReintegro")%>';
                        valor = valReintegro;
                    }
                    mensaje += " " + doubleToFormattedString(valor) + "<br/>" + '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.preguntaSustituirValor")%>';
    ...
    function validaFormulario() {
        ...
        if (codEstado == null || codEstado == '' || estado == null || estado == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.estadoObligatorio")%>';
            return false;
        }

        if (fecha == null || fecha == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.fechaObligatorio")%>';
            return false;
        } else if (!ValidarFechaConFormatoLanbide(fecha)) {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.fechaIncorrecta")%>';
            return false;
        }
        if (codConcepto == null || codConcepto == '' || concepto == null || concepto == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.conceptoObligatorio")%>';
            return false;
        }
        // Validaciones en funcion de la fecha de la factura, periodo subvencion, fecha de publicaicon BOE y tipo de concepto

        if (ejercicioExpJS >= 2018) {
            // #360267 - Conceptos a), d) y f) (1,4,6) 6 meses, contados desde el día siguiente a aquel en el que se notifique la resolución estimatoria de la subvención. Estos 6 meses son los que se entenderán por periodo subvencionado.
            // b), c) y e) (2,3,5) = Día siguiente al de la publicación de la presente convocatoria en el Boletín Oficial del País Vasco(o sea 5 de octubre de 2018) y hasta los 6 meses contados a partir del día siguiente al de notificación de la resolución estimatoria de la subvención
            // 1,4,6 = Periodo Subvencionado
            // 2,3,5 = Dia siguiente Fecha BOE hasta Fin Periodo Subvencionado. 2018 y 2019
            //       = Dia siguiente al día de alta en el IAE de la persona solicitante FECALTAIAE

            //codigo concepto
            //fecha
            var fechaBOEArray = ($('#fecPubBOE').val() != null && $('#fecPubBOE').val() != '' ? $('#fecPubBOE').val().split("/") : '');
            var fechaInicioPeriSubvArray = ($('#fecIniPeriodo').val() != null && $('#fecIniPeriodo').val() != '' ? $('#fecIniPeriodo').val().split("/") : '');
            var fechaFinPeriSubvArray = ($('#fecFinPeriodo').val() != null && $('#fecFinPeriodo').val() != '' ? $('#fecFinPeriodo').val().split("/") : '');
            var fechaFactArray = fecha.split("/");
            var fechaAltaIaeArray = ($('#fechaAltaIAE').val() != null && $('#fechaAltaIAE').val() != '' ? $('#fechaAltaIAE').val().split("/") : '');

            var fechBoe = (fechaBOEArray != null && fechaBOEArray.length == 3 ? new Date(fechaBOEArray[2], new Number(fechaBOEArray[1]) - 1, fechaBOEArray[0]) : null);
            var fechaInicioPeriSubv = (fechaInicioPeriSubvArray != null && fechaInicioPeriSubvArray.length == 3 ? new Date(fechaInicioPeriSubvArray[2], new Number(fechaInicioPeriSubvArray[1]) - 1, fechaInicioPeriSubvArray[0]) : null);
            var fechaFinPeriSubv = (fechaFinPeriSubvArray != null && fechaFinPeriSubvArray.length == 3 ? new Date(fechaFinPeriSubvArray[2], new Number(fechaFinPeriSubvArray[1]) - 1, fechaFinPeriSubvArray[0]) : null);
            ...
            var fechIae = (fechaAltaIaeArray != null && fechaAltaIaeArray.length == 3 ? new Date(fechaAltaIaeArray[2], new Number(fechaAltaIaeArray[1]) - 1, fechaAltaIaeArray[0]) : null);
            // Sumamos un Dia a las fechas de publicacion del BOE y Alta IAE. es A partir del dia siguiente
            if (fechBoe != null) {
                var fechBoeNew = new Date(fechBoe.getFullYear(), fechBoe.getMonth(), fechBoe.getDate() + 1);
                fechBoe = fechBoeNew;
            }
//            if (fechIae != null) {
//                var fechIaeNew = new Date(fechIae.getFullYear(), fechIae.getMonth(), fechIae.getDate() + 1);
//                fechIae = fechIaeNew;
//            }
            var fechaInicio235;
            if (ejercicioExpJS >= 2020) {
                fechaInicio235 = fechIae;
            } else {
                fechaInicio235 = fechBoe;
            }
            ...
            switch (codConcepto) {
                ...
                case "4":
                case "6":
                    if (fechaInicioPeriSubv != null && fechaFinPeriSubv != null) {
                        if (fechaFact < fechaInicioPeriSubv || fechaFact > fechaFinPeriSubv) {
                            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.fueraRangoPeriodos")%>';
                            if (codEstado === "N") {
                        ...
                        mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.noFechaInicioFinPeriodo")%>';
                        if (codEstado === "N") {
                            mostrarValidacionInformativa = true;
                            return correcto;
                        } else {
                ...
                case "3" :
                case "5" :
                    if (fechaInicio235 != null && fechaFinPeriSubv != null) {
                        if (fechaFact < fechaInicio235 || fechaFact > fechaFinPeriSubv) {
                            if (ejercicioExpJS >= 2020) {
                                mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.fueraRangoIAEFinPeriodo")%>';
                            } else {
                                mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.fueraRangoBOEFinPeriodo")%>';
                            }
                        ...
                        if (ejercicioExpJS >= 2020) {
                            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.noFechaIAEFinPeriodo")%>';
                        } else {
                            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.validaFechaFactura.noFechaBoeFinPeriodo")%>';
                        }
        ...
        if (importe == null || importe == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.importeObligatorio")%>';
            return false;
        } else {
            if (!validarNumericoDecimal(importe)) {
                mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.importeIncorrecto")%>';
                return false;
            }
        }

        if (codSubcpto == null || codSubcpto == '' || subcpto == null || subcpto == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.desgloseObligatorio")%>';
            return false;
        }

        if (codEntregada == null || codEntregada == '' || entregada == null || entregada == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.entregaFactObligatorio")%>';
            return false;
        }

        if (codJustificada == null || codJustificada == '' || justificada == null || justificada == '') {
            mensajeValidacion = '<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "msg.entregaJustifObligatorio")%>';
            return false;
        }
    ...
    function pulsarInformeInterno() {
        ...
        var parametros = "?tarea=preparar&modulo=MELANBIDE66&operacion=descargarInformeInterno&tipo=0";
    ...
    function pulsarCargarXML() {
        ...
        if (hayFicheroSeleccionado) {
            ...
            if (extension != 'zip') {
                var resultado = jsp_alerta('A', '<%=meLanbide66I18n.getMensaje(idiomaUsuario, "msg.extensionIncorrecta")%>');
                return false;
            }
            var resultado = jsp_alerta('', '<%=meLanbide66I18n.getMensaje(idiomaUsuario, "msg.preguntaImportar")%>');
            if (resultado == 1) {
                ...
                var parametros = 'tarea=preparar&modulo=MELANBIDE66&operacion=procesarXMLCarga&tipo=0&numero=<%=numExpediente%>&control=' + control.getTime();
                document.forms[0].action = url + '?' + parametros;
            ...
            jsp_alerta("A", '<%=meLanbide66I18n.getMensaje(idiomaUsuario,"msg.ficheroNoSeleccionado")%>');
            return false;
        }
    }//pulsarCargarXML
    ...
    function getListaFacturas() {
        ...
        var parametros = '';
        var control = new Date();
        parametros = 'tarea=preparar&modulo=MELANBIDE66&operacion=getListaFacturas&tipo=0&numero=<%=numExpediente%>&control=' + control.getTime();
        realizarPeticionAjax(parametros);
    }
    ...
    <body>
        <div class="tab-page" id="tabPage661" style="height:520px; width: 100%;">
            <h2 class="tab" id="pestana661"><%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tituloPestana")%></h2>
                                ...
                                <tr>
                                    <td>
                                        <table width="349px" height="100%">
                                            <tr>
                                                <td colspan="3" style="height:70%;text-align:center;vertical-align:middle;">
                                                    <span id="msgImportando">
                                                        <%=meLanbide66I18n.getMensaje(idiomaUsuario, "msg.cargandoDatos")%>
                                                    </span>                                                                                                
                                                </td>
                                            </tr>
                                            <tr>
                ...
                <div id="divGeneral" style="overflow-y: auto; overflow-x: hidden; padding: 20px;">
                        ...
                        <FIELDSET>
                            <div class="lineaFormulario" style="float: left; width: 100%">
                                ...
                                <div id="capaFecIniPeriodo" style="margin-right: 150px">
                                    <div class="etiqueta" style="float:left;">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecIniPeriodo")%>:
                                    </div>
                                ...
                                <div id="capaSubsanarFact">
                                    <div class="etiqueta" style="float:left; margin-right: 30px">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqASubsanar")%>:
                                    </div>
                                ...
                                <div id="capaFechaSubsFact">
                                    <div class="etiqueta" style="float: left;margin-left: 30px; margin-right: 30px">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecSubsanar")%>:
                                    </div>
                                    <div class="columnP" style="float:left; width: 18%">
                                        ...
                                        <A href="javascript:calClick();return false;" onClick="mostrarCalFechaSubsFactura(event);return false;" style="text-decoration:none;" >
                            ...
                            <div class="lineaFormulario" style="width: 100%">                        
                                ...
                                <div id="capaFecFinPeriodo" style="margin-right: 150px">
                                    <div class="etiqueta" style="float:left;">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecFinPeriodo")%>:
                                    </div>
                                ...
                                <div id="capaFecFinPres"style="margin-right: 150px">    
                                    <div class="etiqueta" style="float:left;">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecFinPresentacion")%>:
                                    </div>
                                ...
                                <div id="capaFecAltaIAE">    
                                    <div class="etiqueta" style="float:left;">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecAltaIAE")%>:
                                    </div>
                                    <div class="columnP" style="float:left; margin-left: 10px">
                                        <input type="text" class="inputTxtFecha" id="fechaAltaIAE" name="fechaAltaIAE" maxlength="10" value="<%=request.getAttribute("csFechaIAE")%>" style="border: 0px" readonly="true"/>
                                    </div>
                                </div>
                                <%--Fecha Publicacion BOE Convocatoria Leida de MELANBIDE66_DATOSPLANTILLAS de acuerdo al ano del expediente --%>
                                <div id="capaFecPubBOE">    
                                    <div class="etiqueta" style="float:left;">
                                        <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFecPubBOE")%>:
                                    </div>
                                    <div class="columnP" style="float:left; margin-left: 10px">
                                        <input type="text" class="inputTxtFecha" id="fecPubBOE" name="fecPubBOE" maxlength="10" value="<%=request.getAttribute("fecPubBOE")%>" style="border: 0px" readonly="true"/>
                                    </div>
                                </div>
                                <div id="capaBtnGrabarCSFact" style="float: right">
                                    <input type="button" id="btnGrabarCSFact" name="btnGrabarCSFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqGrabarSubsanar")%>" onclick="guardarValoresCS();">
                                </div>  
                            </div> 
                        </FIELDSET>
                    </div>
                    <div class="lineaFormulario" style="width: 100%">
                        ...
                        <div class="etiqueta" style="margin-right: 71px; float:left;;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqEstado")%>:
                        </div>
                        <div class="columnP" style="float:left; width: 26%">
                        ...
                        <div class="etiqueta" style="float: left;margin-left: 30px; margin-right: 10px" >
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqFechaFact")%>:
                        </div>
                        <div class="columnP" style="float:left; width: 18%">
                        ...
                        <%--Importe--%>
                        <div class="etiqueta" style="float: left;margin-left: 30px; margin-right: 10px" >
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqImporte")%>:
                        </div>
                    ...
                    <div class="lineaFormulario" style="float: left; width: 100%">
                        <div class="etiqueta" style="margin-right: 11px;float:left;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqIdentFact")%>:
                        </div>
                    ...
                    <div class="lineaFormulario" style="float: left; width: 100%">
                        <div class="etiqueta" style="margin-right: 45px;float:left;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqConcepto")%>:
                        </div>
                    ...
                    <div class="lineaFormulario" style="float: left; width: 100%">
                        <div class="etiqueta" style="margin-right: 19px;float:left;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqDesglose")%>:
                        </div>
                        <div class="columnP" style="float:left; width: 85%">
                    ...
                    <div class="lineaFormulario" style="float: left; width: 100%">
                        ...
                        <div class="etiqueta" style="margin-right: 30px;float:left;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqEntregaFact")%>:
                        </div>
                        ...
                        <div class="etiqueta" style="margin-left: 84px; margin-right: 9px;float:left;">
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqEntregaJustif")%>:
                        </div>
                        <div class="columnP" style="float:left; width: 29%">
                    ...
                    <div class="lineaFormulario" style="float: left; width: 100%">
                        <div class="etiqueta" style="margin-right: 41px;float: left;" >
                            <%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.etiqObservaciones")%>:
                        </div>
                        <div class="columnP" style="float:left; width: 85%">
                            <textarea style="width: 100%" name="observFact" id="observFact" rows="5" class="melanbide66_txtSinMayusculas"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="botonera" style="text-align: right; margin-bottom: 5px;">
                        <input type="button" id="btnRegistrarFact" name="btnRegistrarFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqGrabar")%>" onclick="guardarDatosFactura();">
                        <input type="button" id="btnModificarFact" name="btnModificarFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqModificar")%>" onclick="modificarDatosFactura();">
                        <input type="button" id="btnEliminarFact" name="btnEliminarFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqEliminar")%>" onclick="eliminarFactura();">
                        <input type="button" id="btnLimpiarFact" name="btnLimpiarFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqLimpiar")%>" onclick="limpiarFormulario();">
                        <input type="button" id="btnCalcularFact" name="btnCalcularFact" class="botonGeneral" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqCalcular")%>" onclick="recuperarValoresCS();">
                    </div>
                    ...
                    <div class="botonera" style="text-align: right;">
                        ...
                        <input type="button" id="btnCargarFacturas" name="btnCargarFacturas" class="botonMasLargo" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqCargarXML")%>" onclick=" pulsarCargarXML();">

                    </div><br/>
                    <div class="botonera" style="text-align: right;">

                        <input type="button" id="btnFactASubsanar" name="btnFactASubsanar" class="botonMasLargo" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqInformeApec")%>" onclick=" pulsarInformeInterno();">
                        <input type="button" id="btnFactASubsanar" name="btnFactASubsanar" class="botonMasLargo" value="<%=MeLanbide66I18n.getMensaje(idiomaUsuario, "button.etiqFactASubsanar")%>" onclick="copiarFacturasSubsanar();">
                    </div>
        ...
        <script type="text/javascript">
            ...
            tablaFacturas.addColumna('30', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col1")%>');
            tablaFacturas.addColumna('65', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col2")%>');
            tablaFacturas.addColumna('85', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col8")%>');
            tablaFacturas.addColumna('280', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col3")%>');
            tablaFacturas.addColumna('300', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col4")%>');
            tablaFacturas.addColumna('60', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col5")%>');
            tablaFacturas.addColumna('35', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col6")%>');
            tablaFacturas.addColumna('35', 'left', '<%=MeLanbide66I18n.getMensaje(idiomaUsuario,"label.tablaFacturas.col7")%>');
