...
<script type="text/javascript">
    ...
    function crearTabla() {
        ...
        tablaExpedientes.addColumna('100', 'center', "<%=meLanbide65I18n.getMensaje(idiomaUsuario,"recalculoImporte.tablaExpedientes.col2")%>");
        tablaExpedientes.addColumna('300', 'center', "<%=meLanbide65I18n.getMensaje(idiomaUsuario,"recalculoImporte.tablaExpedientes.col3")%>");
        tablaExpedientes.addColumna('300', 'center', "<%=meLanbide65I18n.getMensaje(idiomaUsuario,"recalculoImporte.tablaExpedientes.col4")%>");
    ...
    <div id="divRecalculoImportes" style="height: 100%; width: 100%;overflow-y: scroll;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select id="tipoProcedimiento" name="tipoProcedimiento" onchange="ShowSelected();">
                                            ...
                                            <option value="CEESA">CEESA</option>
                                        </select>
                                    </td>   
                                    ...
                                    <td>
                                        ...
                                        <input id="ejercicio" name="ejercicio" type="text" class="inputTextoM65" size="15" maxlength="4">
                                    </td>
                                    <td style="text-align: center;" colspan="2">
                                        <label class="etiqueta"><%=meLanbide65I18n.getMensaje(idiomaUsuario,"label.titulo.importeMaximo")%></label>
                                        <input id="importeMaximo" name="importeMaximo" type="text" class="inputTextoM65" size="15" maxlength="15">
                                         <input type="button" id="btnRecalcularImporte" name="btnRecalcularImporte" class="botonGeneral" value="<%=meLanbide65I18n.getMensaje(idiomaUsuario, "btn.marcar")%>" onclick="pulsarBusquedaFiltrando(); pulsarRecalcularImporte();">
                                        <input type="button" id="btnExportarExcel" name="btnExportarExcel" class="botonGrande"
                                            disabled="true"
                                            value="<%=meLanbide65I18n.getMensaje(idiomaUsuario, "btn.exportar")%>"
            ...
            <script type="text/javascript">  
                ...
                function recargarTablaExpedientes(result) {
                    ...
                    habilitarBoton('#btnExportarExcel');
                }
                 ...
                 function pulsarBusquedaFiltrando() {
                        ...
                        if (! validarFiltrosBusqueda()) {
                           ...
                           // var control = new Date();
                            parametros = "tarea=preparar&modulo=MELANBIDE65&operacion=busquedaFiltrandoListaExpedientes&tipo=0" 
                            ...
                            if (codigoOperacion == "0") {  
                                ...
                                prepararListaParaExportacionExcel(listaNueva);
                        ...
                        if (resultado == 1) {
                            ...
                            try {
                                ...
                                if (codigoOperacion == "0") {
                                    ...
                                    jsp_alerta("A", '<%=meLanbide65I18n.getMensaje(idiomaUsuario,"error.errorNoSeleccionados")%>');
                                } else if (codigoOperacion == "3") {
                                    jsp_alerta("A", '<%=meLanbide65I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                                } else {
                                    jsp_alerta("A", '<%=meLanbide65I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
            ...
            function prepararListaParaExportacionExcel(lista) {
                lista.shift();
                for (var i = 0; i < lista.length; i++) {
                    lista[i].shift();
                    listaExportar[i] = lista[i];
                }
            }
            ...
            function exportarExcel() {
                ...
                // FIXME -- Pasar los datos ya procesados, para evitar otra llamada a BBDD.
                //parametros = "tarea=preparar&modulo=MELANBIDE65&operacion=generarExcelRecalculoImportes&tipo=0"
                //    + "&listadoExpedientes=" + listaExportar.toString();

                parametros = "?tarea=preparar&modulo=MELANBIDE65&operacion=exportarExcelRecalculoImportes&tipo=0"
                    + "&tipoProcedimiento=" + document.getElementById("tipoProcedimiento").value
                    + "&ejercicio=" + document.getElementById('ejercicio').value
                    + "&periodoSubvencionable=" + document.getElementById('periodoSubvencionable').value;
                try {
