     ...
     String css = "";
        ...
        <script type="text/javascript">
            ...
            function guardarDatosTrabajador() {
                ...
                if (validarDatosTrabajador()) {
                    ...
                    parametros += "&expediente=<%=expediente%>"
                            + "&nombre=" + document.getElementById('nombreAnexoA').value
                            + "&apellido1=" + document.getElementById('apellido1AnexoA').value
                            + "&apellido2=" + document.getElementById('apellido2AnexoA').value
                            + "&sexo=" + document.getElementById('codListaSexo').value
                            + "&dni=" + document.getElementById('dniAnexoA').value
                            + "&tipoContrato=" + document.getElementById('codListaContrato').value
                            + "&tipoJornada=" + document.getElementById('codListaJornada').value
                            + "&porcJornadaParcial=" + document.getElementById('porcentajeJornadaParcialAnexoA').value
                            + "&discPsiquica=" + document.getElementById('discPsiquicaAnexoA').value
                            + "&discFisica=" + document.getElementById('discFisicaAnexoA').value
                            + "&discSensorial=" + document.getElementById('discSensorialAnexoA').value
                    ...
                    try {
                        ...
                        //document.getElementById("IMPTOTRECAL").value= valorSubvencion;
            ...
            function validarDatosTrabajador() {
                ...
                var valor = document.getElementById('nombreAnexoA').value;
                if (valor == null || valor == '') {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.nombreObligatorio")%>';
                    return false;
                }

                valor = document.getElementById('apellido1AnexoA').value;
                if (valor == null || valor == '') {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.apellido1Obligatorio")%>';
                    return false;
                }
                ...
                if (valor == null || valor == '') {
                    ...
                    return false;
                } else if (!validarDniNie(document.getElementById('dniAnexoA'))) {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.dniIncorrecto")%>';
                    return false;
                }

                valor = document.getElementById('codListaContrato').value;
                if (valor == '') {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoContratoObligatorio")%>';
                    return false;
                }

                var jornada = document.getElementById('codListaJornada').value;
                if (jornada == null || jornada == '') {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoJornadaObligatorio")%>';
                    return false;
                }
                
                var pensionista = document.getElementById('codListaTipoPensionista').value;
                if (pensionista == null || pensionista == '') {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoPensionistaObligatorio")%>';
                    return false;
                }
                 ...
                 if (pensionista == 'S') {
                    ...
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoPensionistaTipoObligatorio")%>';
                    return false;
                }}

                var porjorpar = document.getElementById('porcentajeJornadaParcialAnexoA').value;
                if ((jornada == 'PARC' && (porjorpar == null || porjorpar == ''))) {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentajeJornadaParcialObligatorio")%>';
                    return false;
                } else if (!validarNumericoDecimalPrecision(porjorpar, 5, 2)) {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porNumericoDecimal")%>';
                    return false;
                } else if (!validarNumericoPorcentajeCien(porjorpar)) {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentajeJornadaParcialErrorRango")%>';
                    return false;
                }

                var valorPsi = document.getElementById('discPsiquicaAnexoA').value;
                var valorSen = document.getElementById('discSensorialAnexoA').value;
                var valorFis = document.getElementById('discFisicaAnexoA').value;
                if ((valorPsi == null || valorPsi == '') && (valorFis == null || valorFis == '') && (valorSen == null || valorSen == '')) {
                    mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoDiscapacidad")%>';
                    return false;
                }

                if (valorPsi != null && valorPsi != '') {
                    
                    if (!validarNumerico(valorPsi)) {
                        mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.numPaginaNumerico")%>';
                        return false;
                    }
                    if (valorPsi<33){
                       mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentageDiscPsiquica")%>';
                        return false;  
                    }
                }
                if (valorFis != null && valorFis != '') {
                    if (!validarNumerico(valorFis)) {
                        mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.numPaginaNumerico")%>';
                        return false;
                    }
                    if (valorFis<33){
                       mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentageDiscFisica")%>';
                        return false;  
                    }
                }
                if (valorSen != null && valorSen != '') {
                    if (!validarNumerico(valorSen)) {
                        mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.numPaginaNumerico")%>';
                        return false;
                    }
                     if (valorSen<65){
                       mensajeValidacionA = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentageDiscSensorial")%>';
                        return false;  
                    }
                }
            ...
            function comprobarJornada() {
                if (document.getElementById("codListaJornada").value == "PARC") {
                    document.getElementById('porcentajeJornadaParcialAnexoA').disabled = false;
                } else {
                    document.getElementById('porcentajeJornadaParcialAnexoA').disabled = true;
                    document.getElementById('porcentajeJornadaParcialAnexoA').value = '';
                }
            }
        </script>
    </head>
    <body>
        <div class="contenidoPantalla">
            <div style="width: 100%; padding: 10px; text-align: left;">
                ...
                <div style="margin-left: 10px">
                    <div class="lineaFormulario">
                        <div style="width: 300px; float: left;" class="etiqueta">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="apellido1AnexoA" name="apellido1AnexoA" type="text" class="inputTexto" size="30" maxlength="50"
                                       value="<%=objTrMod != null && objTrMod.getApellido1() != null ? objTrMod.getApellido1() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="apellido2AnexoA" name="apellido2AnexoA" type="text" class="inputTexto" size="30" maxlength="50"
                                       value="<%=objTrMod != null && objTrMod.getApellido2() != null ? objTrMod.getApellido2() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 500px; float: left;">
                            <div style="float: left;">
                                <input type="text" name="codListaSexo" id="codListaSexo" size="5" class="inputCombo" value="" maxlength="5" onkeyup="xAMayusculas(this);"/>
                                <input type="text" name="descListaSexo"  id="descListaSexo" size="40" class="inputCombo" readonly value="" />
                                <a href="" id="anchorListaSexo" name="anchorListaSexo" title="">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="dniAnexoA" name="dniAnexoA" type="text" class="inputTexto" size="15" maxlength="10" onkeyup="xAMayusculas(this);" 
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 500px; float: left;">
                            <div style="float: left;">
                                <input type="text" name="codListaContrato" id="codListaContrato" size="5" class="inputCombo" value="" maxlength="2" onkeyup="xAMayusculas(this);"/>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 300px; float: left;" class="etiqueta">
                            <%=meLanbide65I18n.getMensaje(idiomaUsuario,"label.tipoPorcentajeJornadaParcial")%>
                        </div>
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="porcentajeJornadaParcialAnexoA" name="porcentajeJornadaParcialAnexoA" type="text" class="inputTexto" size="10" maxlength="6"
                                       value="<%=objTrMod != null && objTrMod.getJorParcPorc() != -1.0 ? String.valueOf(objTrMod.getJorParcPorc()).replace(".",",") : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="discPsiquicaAnexoA" name="discPsiquicaAnexoA" type="text" class="inputTexto" size="10" maxlength="5" onkeyup="SoloDigitos(this);"
                                       value="<%=objTrMod != null && objTrMod.getTipoDiscPsiquica()!=-1 ? objTrMod.getTipoDiscPsiquica() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="discFisicaAnexoA" name="discFisicaAnexoA" type="text" class="inputTexto" size="10" maxlength="5" onkeyup="SoloDigitos(this);"
                                       value="<%=objTrMod != null && objTrMod.getTipoDiscFisica()!=-1 ? objTrMod.getTipoDiscFisica() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        <div style="width: 300px; float: left;" class="etiqueta">
                            <%=meLanbide65I18n.getMensaje(idiomaUsuario,"label.tipoYGradoDisSensorial")%>
                        </div>
                        <div style="width: 300px; float: left;">
                            <div style="float: left;">
                                <input id="discSensorialAnexoA" name="discSensorialAnexoA" type="text" class="inputTexto" size="10" maxlength="5" onkeyup="SoloDigitos(this);"
                                       value="<%=objTrMod != null && objTrMod.getTipoDiscSensorial()!=-1 ? objTrMod.getTipoDiscSensorial() : ""%>"/>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                ...
                listaCodigosSexo[contador1] = ['<bean:write name="sexo" property="des_val_cod" />'];
                listaDescripcionesSexo[contador1] = ['<bean:write name="sexo" property="des_nom" />'];
                contador1++;
                </logic:iterate>
                ...
                function rellenarDatModificar() {
                    buscaCodigoJornada('<%=objTrMod != null && objTrMod.getTipoJornada() != null ? objTrMod.getTipoJornada() : ""%>');
                    buscaCodigoContrato('<%=objTrMod != null && objTrMod.getTipoContrato() != null ? objTrMod.getTipoContrato() : ""%>');
                    buscaCodigoSexo('<%=objTrMod != null && objTrMod.getSexo() != 0 ? objTrMod.getSexo() : ""%>');
                   if ('<%=objTrMod != null && objTrMod.getTipoPensionista() != null ? objTrMod.getTipoPensionista() : ""%>'!='0'){
                    buscaCodigoPensionista('<%=objTrMod != null && objTrMod.getTipoPensionista() != null ? objTrMod.getTipoPensionista() : ""%>');
                }
                    buscaCodigoTipoPensionista('<%=objTrMod != null && objTrMod.getPensionista() != null ? objTrMod.getPensionista() : ""%>');
