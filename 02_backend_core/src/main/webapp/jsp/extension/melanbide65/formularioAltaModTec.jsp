    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function guardarDatosTecnico() {
                if (validarDatosTecnico()) {
                    ...
                    parametros += "&expediente=<%=expediente%>"
                            + "&nombre=" + document.getElementById('nombreAnexoB').value
                            + "&apellido1=" + document.getElementById('apellido1AnexoB').value
                            + "&apellido2=" + document.getElementById('apellido2AnexoB').value
                            + "&tipoContrato=" + document.getElementById('codListaContrato').value
                            + "&tipoJornada=" + document.getElementById('codListaJornada').value
                            + "&dni=" + document.getElementById('dniAnexoB').value
            ...
            function validarDatosTecnico() {
                ...
                var valor = document.getElementById('nombreAnexoB').value;
                if (valor == null || valor == '') {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.nombreObligatorio")%>';
                    return false;
                }

                valor = document.getElementById('apellido1AnexoB').value;
                if (valor == null || valor == '') {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.apellido1Obligatorio")%>';
                    return false;
                }
                ...
                if (valor == null || valor == '') {
                    ...
                    return false;
                } else if (!validarDniNie(document.getElementById('dniAnexoB'))) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.dniIncorrecto")%>';
                    return false;
                }
                ...
                if (contrato == '') {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoContratoObligatorio")%>';
                    return false;
                }
                ...
                if (contrato == 'T' && (valor == null || valor == '')) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.fechaAltaTemporalObligatorio")%>';
                    return false;
                }

                valor = document.getElementById('fechaBajaTemporal').value;
                if (contrato == 'T' && (valor == null || valor == '')) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.fechaBajaTemporalObligatorio")%>';
                    return false;
                }

                var jornada = document.getElementById('codListaJornada').value;
                if (jornada == null || jornada == '') {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.tipoJornadaObligatorio")%>';
                    return false;
                }

                var porjorpar = document.getElementById('jornadaParcialPorAnexoB').value;
                if (jornada == 'PARC' && (porjorpar == null || porjorpar == '')) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentajeJornadaParcialObligatorio")%>';
                    return false;
                } else if (!validarNumericoDecimalPrecision(porjorpar, 5, 2)) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porNumericoDecimal")%>';
                    return false;
                } else if (!validarNumericoPorcentajeCien(porjorpar)) {
                    mensajeValidacionB = '<%=meLanbide65I18n.getMensaje(idiomaUsuario, "msg.porcentajeJornadaParcialErrorRango")%>';
                    return false;
                }
                ...
                <div style="width: 100%; padding: 10px; text-align: left;">
                    ...
                    <div style="margin-left: 10px">
                        ...
                        <div class="lineaFormulario">
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input id="apellido1AnexoB" name="apellido1AnexoB" type="text" class="inputTexto" size="30" maxlength="50"
                                           value="<%=objTecMod != null && objTecMod.getApellido1() != null ? objTecMod.getApellido1() : ""%>"/>
                                </div>
                            </div>
                        </div>
                        <br><br>
                        <div class="lineaFormulario">
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input id="apellido2AnexoB" name="apellido2AnexoB" type="text" class="inputTexto" size="30" maxlength="50"
                                           value="<%=objTecMod != null && objTecMod.getApellido2() != null ? objTecMod.getApellido2() : ""%>"/>
                                </div>
                            </div>
                        </div>
                        <br><br>
                        <div class="lineaFormulario">
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input id="dniAnexoB" name="dniAnexoB" type="text" class="inputTexto" size="15" maxlength="10" onkeyup="xAMayusculas(this);" 
                    ...
                    <br><br>
                     <div class="lineaFormulario">
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input type="text" class="inputTxtFecha" 
                                           ...
                                           maxlength="10"  size="10"
                                           value="<%=objTecMod != null && objTecMod.getFecAltaContrTempAsStr()!= null ? objTecMod.getFecAltaContrTempAsStr(): ""%>"
                                           onkeyup = "return SoloCaracteresFechaLanbide(this);"                                       
                                           onfocus="javascript:this.select();"/>
                                    <A id="afechaAltaTemporal" href="javascript:calClick(event);return false;" onClick="mostrarCalFechaABTemp(event);
                                            return false;" style="text-decoration:none;">
                                        <IMG style="border: 0px solid" height="17" id="calFechaAltaTemporal" name="calFechaAltaTemporal" border="0" 
                                             src="<c:url value='/images/calendario/icono.gif'/>" > <!--width="25"-->
                                    </A>
                                </div>
                            </div>
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input type="text" class="inputTxtFecha" 
                                           ...
                                           maxlength="10"  size="10"
                                           value="<%=objTecMod != null && objTecMod.getFecBajaContrTempAsStr()!= null ? objTecMod.getFecBajaContrTempAsStr(): ""%>"
                                           onkeyup = "return SoloCaracteresFechaLanbide(this);"                                       
                                           onfocus="javascript:this.select();"/>
                                    <A id="afechaBajaTemporal" href="javascript:calClick(event);return false;" onClick="mostrarCalFechaBTemporal(event);return false;" style="text-decoration:none;">
                                        <IMG style="border: 0px solid" height="17" id="calFechaBajaTemporal" name="calFechaBajaTemporal" border="0" 
                                             src="<c:url value='/images/calendario/icono.gif'/>" > <!--width="25"-->
                                    </A>
                                </div>
                            </div>
                        ...
                        <div class="lineaFormulario">
                            ...
                            <div style="width: 300px; float: left;">
                                <div style="float: left;">
                                    <input id="jornadaParcialPorAnexoB" name="jornadaParcialPorAnexoB" type="text" class="inputTexto" size="15" maxlength="5" onchange="reemplazarPuntos(this);"
                                           value="<%=objTecMod != null && objTecMod.getJornadaParcialPor()!=-1.0 ? String.valueOf(objTecMod.getJornadaParcialPor()).replace(".",",") : ""%>"/>
                                </div>
                            </div>
                        </div>
                        <br><br>
            ...
            <script type="text/javascript">
                ...
                function comprobarJornada() {
                    if (document.getElementById("codListaJornada").value == "PARC") {
                        document.getElementById('jornadaParcialPorAnexoB').disabled = false;
                    } else {
                        document.getElementById('jornadaParcialPorAnexoB').disabled = true;
                        document.getElementById('jornadaParcialPorAnexoB').value = '';
                    }
                }
                ...
                function rellenarDatModificar() {
                    buscaCodigoJornada('<%=objTecMod != null && objTecMod.getTipoJornada() != null ? objTecMod.getTipoJornada() : ""%>');
                    buscaCodigoContrato('<%=objTecMod != null && objTecMod.getTipoContrato() != null ? objTecMod.getTipoContrato() : ""%>');
                    if ('<%=objTecMod != null && objTecMod.getTipoPensionista() != null ? objTecMod.getTipoPensionista() : ""%>'!='0'){
                    buscaCodigoPensionista('<%=objTecMod != null && objTecMod.getTipoPensionista() != null ? objTecMod.getTipoPensionista() : ""%>');
                }
                    buscaCodigoTipoPensionista('<%=objTecMod != null && objTecMod.getPensionista() != null ? objTecMod.getPensionista() : ""%>');
