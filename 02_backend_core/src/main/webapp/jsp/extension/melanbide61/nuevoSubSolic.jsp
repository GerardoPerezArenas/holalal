<%-- 
    Document   : subSolic
    Created on : 27-dic-2022, 11:01:24
    Author     : gerardo
--%>
...
<html>
    <head>
        ...
        <% 
            ...
            try {
                ...
                if(nuevo=="1") {
                    tituloPagina = meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.alta");
                } else {
                    tituloPagina=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.edicion");
                }
            } catch(Exception ex){}
        %>
        ...
        <script type="text/javascript">
            ...
            function comprobarFecha(inputFecha) {
                ...
                if (Trim(inputFecha.value) != '') {
                    ...
                    if (!D[0]) {
                        jsp_alerta("A", "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>");
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    var parametros = "tarea=preparar&modulo=MELANBIDE61&tipo=0"
                            ...
                            + '&objeto=' + document.getElementById('objeto').value.replace(/\r?\n|\r/g, " ").trim()
            ...
            function validarDatos() {
                ...
                if (campo.value == null || campo.value == '') {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.estado")%>';
                    return false;
                }
                campo = document.getElementById('organismo');
                if (campo.value == null || campo.value == '') {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.organismo")%>';
                    return false;
                } else if (!compruebaTamanoCampo(campo, 200)) {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.organismo.tamano")%>';
                    return false;
                }
                campo = document.getElementById('objeto');
                if (campo.value == null || campo.value == '') {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.objeto")%>';
                    return false;
                } else if (!compruebaTamanoCampo(campo, 200)) {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.objeto.tamano")%>';
                    return false;
                }
                campo = document.getElementById('importe');
                if (campo.value == null || campo.value == '') {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.importe")%>';
                    return false;
                } else if (!validarNumericoDecimalReple(campo, 8, 2)) {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.importe.errNumerico")%>';
                    return false;
                }
                campo = document.getElementById('fecha');
                if (campo.value == null || campo.value == '') {
                    mensajeValidacion = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.subSolic.fecha")%>';
                    return false;
                }
                return true;
            }
            ...
            function cancelar() {
                var resultado = jsp_alerta('', '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.preguntaCancelar")%>');
                if (resultado == 1) {
                    cerrarVentana();
                }
            }
            ...
            function mostrarError(codigo) {
                ...
                if (codigo == "1") {
                    ...
                    jsp_alerta("A", '<%=meLanbide61I18n.getMensaje(idiomaUsuario,"error.generico")%>');
                } else if (codigo == "3") {
                    jsp_alerta("A", '<%=meLanbide61I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                } else if (codigo == "4") {
                    jsp_alerta("A", '<%=meLanbide61I18n.getMensaje(idiomaUsuario,"error.listaVacia")%>');
                } else if (codigo == "5") {
                    jsp_alerta("A", '<%=meLanbide61I18n.getMensaje(idiomaUsuario,"error.errorObtenerDatos")%>');
                } else if (codigo == "6") {
    ...
    <body class="bandaBody" onload="javascript:{
        ...
        <div class="contenidoPantalla">
            <div id="barraProgresoREPLE" style="visibility: hidden;">
                <div class="contenedorHidepage">
                    <div class="textoHide">
                        <span>
                            <%=meLanbide61I18n.getMensaje(idiomaUsuario, "msg.procesando")%>
                        </span>
                    </div>
                ...
                <div style="width: 100%; padding: 10px; text-align: left;">
                    ...
                    <fieldset id="Subenciones" name="Subenciones">
                        <div class="lineaFormulario">
                            <div class="barraProgresoREPLE">
                                <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.estado")%>
                            </div>
                            <div>
                        ...
                        <div class="lineaFormulario">
                            <div class="barraProgresoREPLE">
                                <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.organismo")%>
                            </div>
                        ...
                        <div class="lineaFormulario">
                            <div class="etiquetaReple">
                                <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.objeto")%>
                            </div>
                            <div style="float: left;">
                        ...
                        <div class="lineaFormulario">
                            <div class="etiquetaReple">
                                <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.importe")%>
                            </div>
                            <div style="float: left;">
                                <input id="importe" name="importe" type="text" class="inputTextoObligatorio" size="9" maxlength="9" onchange="reemplazarPuntosReple(this);"
                        ...
                        <div class="lineaFormulario">
                            <div class="etiquetaReple">
                                <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.subSolic.fecha")%>
                            </div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="botonera" style="padding-top: 15px; text-align: center;">
                            <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "btn.aceptar")%>" onclick="guardarDatos();"/>
                            <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();"/>
                        </div>
                    </div>
                </div>
            </form>
            <script type="text/javascript">
                ...
                if (<%=nuevo%> != null && <%=nuevo%> == 0) {
                    ...
                    document.getElementById('tituloVentana').innerHTML = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "label.subSolic.modifSubvencion")%>';
                } else {
                    document.getElementById('tituloVentana').innerHTML = '<%=meLanbide61I18n.getMensaje(idiomaUsuario, "label.subSolic.nuevaSubvencion")%>';
                }
            </script>
        </div>
    </body>
