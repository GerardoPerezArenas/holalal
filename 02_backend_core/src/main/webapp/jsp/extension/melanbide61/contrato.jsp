...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide61.vo.ValorCampoDesplegableEstadoVO"%>
...
<html>
    <head> 
        ...
        <%
            ...
            Integer ejercicio = (Integer)request.getAttribute("ejercicio");

            //LISTAS PARA LOS COMBOS
            List<ValorCampoDesplegableEstadoVO> listaEstudios = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaEstudios") != null)
                listaEstudios = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaEstudios");
            List<ValorCampoDesplegableEstadoVO> listaColectivos = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaColectivos") != null)
                listaColectivos = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaColectivos");
            List<ValorCampoDesplegableEstadoVO> listaTipConDur = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaTipConDur") != null)
                listaTipConDur = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaTipConDur");
            List<ValorCampoDesplegableEstadoVO> listaTipoJornada = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaTipoJornada") != null)
                listaTipoJornada = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaTipoJornada");
            List<ValorCampoDesplegableEstadoVO> listaCNOE = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaCNOE") != null)
                listaCNOE = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaCNOE");
            List<ValorCampoDesplegableEstadoVO> listaTipoCon = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaTipoCon") != null)
                listaTipoCon = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaTipoCon");
            List<ValorCampoDesplegableEstadoVO> listaColec2 = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaColec2") != null)
                listaColec2 = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaColec2");
            List<ValorCampoDesplegableEstadoVO> listaSitPrevia = new ArrayList<ValorCampoDesplegableEstadoVO>();
            if(request.getAttribute("listaSitPrevia") != null)
                listaSitPrevia = (List<ValorCampoDesplegableEstadoVO>)request.getAttribute("listaSitPrevia");

            String mensajeProgreso = "";
            
            String lcodEstudios = "";
            String ldescEstudios = "";
            String lcodEstudiosAct = "";
            String ldescEstudiosAct = "";
            
            String lcodColectivos = "";
            String ldescColectivos = "";
            String lcodColectivosAct = "";
            String ldescColectivosAct = "";
            
            String lcodTipConDur = "";
            String ldescTipConDur = "";
            String lcodTipConDurAct = "";
            String ldescTipConDurAct = "";
            
            String lcodTipoJornada = "";
            String ldescTipoJornada = "";
            String lcodTipoJornadaAct = "";
            String ldescTipoJornadaAct = "";
            ...
            String lcodTipoCon ="";
            String ldescTipoCon ="";
            String lcodTipoConAct ="";
            String ldescTipoConAct ="";
            
            String lcodColec2 = "";
            String ldescColec2 = "";
            String lcodColec2Act = "";
            String ldescColec2Act = "";
            
            String lcodSitPrevia ="";
            String ldescSitPrevia ="";
            String lcodSitPreviaAct ="";
            String ldescSitPreviaAct ="";
            
            String lcodSitPrevia2 ="";
            String ldescSitPrevia2 ="";
            String lcodSitPrevia2Act ="";
            String ldescSitPrevia2Act ="";
            ...
            if (listaEstudios != null && listaEstudios.size() > 0) 
            {
                ...
                ValorCampoDesplegableEstadoVO est = null;
                for (i = 0; i < listaEstudios.size() - 1; i++) 
                {
                    est = (ValorCampoDesplegableEstadoVO) listaEstudios.get(i);
                    lcodEstudios += "\"" + est.getCodigo() + "\",";
                    ldescEstudios += "\"" + escape(est.getDescripcion()) + "\",";
                    if (est.getEstado().equals("A")){
                        lcodEstudiosAct += "\"" + est.getCodigo() + "\",";
                        ldescEstudiosAct += "\"" + escape(est.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                est = (ValorCampoDesplegableEstadoVO) listaEstudios.get(i);
                ...
                if(est.getEstado().equals("A")){
                    ...
                    lcodEstudiosAct = lcodEstudiosAct.substring(0, lcodEstudiosAct.length()-1);
                }
            }
            ...
            if (listaTipoCon != null && listaTipoCon.size() > 0) 
            {
                ...
                {
                    est = (ValorCampoDesplegableEstadoVO) listaTipoCon.get(i);
                    lcodTipoCon += "\"" + est.getCodigo() + "\",";
                    ldescTipoCon += "\"" + escape(est.getDescripcion()) + "\",";
                    if (est.getEstado().equals("A")){
                        lcodTipoConAct += "\"" + est.getCodigo() + "\",";
                        ldescTipoConAct += "\"" + escape(est.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                est = (ValorCampoDesplegableEstadoVO) listaTipoCon.get(i);
                ...
                if(est.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodTipoConAct = lcodTipoConAct.substring(0, lcodTipoConAct.length()-1);
                }
            }
            ...
            if(listaColectivos != null && listaColectivos.size() > 0)
            {
                int i;
                boolean hayActivos = false;
                ValorCampoDesplegableEstadoVO col = null;
                for(i = 0; i < listaColectivos.size() - 1; i++)
                {
                    col = (ValorCampoDesplegableEstadoVO) listaColectivos.get(i);
                    lcodColectivos += "\"" + col.getCodigo() + "\",";
                    ldescColectivos += "\"" + escape(col.getDescripcion()) + "\",";
                    if (col.getEstado().equals("A")){
                        lcodColectivosAct += "\"" + col.getCodigo() + "\",";
                        ldescColectivosAct += "\"" + escape(col.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                col = (ValorCampoDesplegableEstadoVO) listaColectivos.get(i);
                ...
                if(col.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodColectivosAct = lcodColectivosAct.substring(0, lcodColectivosAct.length()-1);
                }
            }
            ...
            if(listaColec2 != null && listaColec2.size() > 0)
            {
                ...
                {
                    col = (ValorCampoDesplegableEstadoVO) listaColec2.get(i);
                    lcodColec2 += "\"" + col.getCodigo() + "\",";
                    ldescColec2 += "\"" + escape(col.getDescripcion()) + "\",";
                    if (col.getEstado().equals("A")){
                        lcodColec2Act += "\"" + col.getCodigo() + "\",";
                        ldescColec2Act += "\"" + escape(col.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                col = (ValorCampoDesplegableEstadoVO) listaColec2.get(i);
                ...
                if(col.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodColec2Act = lcodColec2Act.substring(0, lcodColec2Act.length()-1);
                }
            }
            ...
            if(listaSitPrevia != null && listaSitPrevia.size() > 0)
            {
                ...
                {
                    col = (ValorCampoDesplegableEstadoVO) listaSitPrevia.get(i);
                    lcodSitPrevia += "\"" + col.getCodigo() + "\",";
                    ldescSitPrevia += "\"" + escape(col.getDescripcion()) + "\",";
                    if (col.getEstado().equals("A")){
                        lcodSitPreviaAct += "\"" + col.getCodigo() + "\",";
                        ldescSitPreviaAct += "\"" + escape(col.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                col = (ValorCampoDesplegableEstadoVO) listaSitPrevia.get(i);
                ...
                if(col.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodSitPreviaAct = lcodSitPreviaAct.substring(0, lcodSitPreviaAct.length()-1);
                }
            }
            ...
            if(listaTipConDur != null && listaTipConDur.size() > 0)
            {
                int i;
                boolean hayActivos = false;
                ValorCampoDesplegableEstadoVO tip = null;
                for(i = 0; i < listaTipConDur.size() - 1; i++)
                {
                    tip = (ValorCampoDesplegableEstadoVO) listaTipConDur.get(i);
                    lcodTipConDur += "\"" + tip.getCodigo() + "\",";
                    ldescTipConDur += "\"" + escape(tip.getDescripcion()) + "\",";
                    if (tip.getEstado().equals("A")){
                        lcodTipConDurAct += "\"" + tip.getCodigo() + "\",";
                        ldescTipConDurAct += "\"" + escape(tip.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                tip = (ValorCampoDesplegableEstadoVO) listaTipConDur.get(i);
                ...
                if(tip.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodTipConDurAct = lcodTipConDurAct.substring(0, lcodTipConDurAct.length()-1);
                }
            }
            ...
            if(listaTipoJornada != null && listaTipoJornada.size() > 0)
            {
                int i;
                boolean hayActivos = false;
                ValorCampoDesplegableEstadoVO jor = null;
                for(i = 0; i < listaTipoJornada.size() - 1; i++)
                {
                    jor = (ValorCampoDesplegableEstadoVO) listaTipoJornada.get(i);
                    lcodTipoJornada += "\"" + jor.getCodigo() + "\",";
                    ldescTipoJornada += "\"" + escape(jor.getDescripcion()) + "\",";
                    if (jor.getEstado().equals("A")){
                        lcodTipoJornadaAct += "\"" + jor.getCodigo() + "\",";
                        ldescTipoJornadaAct += "\"" + escape(jor.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                jor = (ValorCampoDesplegableEstadoVO) listaTipoJornada.get(i);
                ...
                if(jor.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodTipoJornadaAct = lcodTipoJornadaAct.substring(0, lcodTipoJornadaAct.length()-1);
                }
            }
            ...
            if(listaCNOE != null && listaCNOE.size() > 0)
            {
                int i;
                boolean hayActivos = false;
                ValorCampoDesplegableEstadoVO cnoe = null;
                for(i = 0; i < listaCNOE.size() - 1; i++)
                {
                    cnoe = (ValorCampoDesplegableEstadoVO) listaCNOE.get(i);
                    lcodCNOE += "\"" + cnoe.getCodigo() + "\",";
                    ldescCNOE += "\"" + escape(cnoe.getDescripcion()) + "\",";
                    if (cnoe.getEstado().equals("A")){
                        lcodCNOEAct += "\"" + cnoe.getCodigo() + "\",";
                        ldescCNOEAct += "\"" + escape(cnoe.getDescripcion()) + "\",";
                        hayActivos = true;
                    }
                }
                cnoe = (ValorCampoDesplegableEstadoVO) listaCNOE.get(i);
                ...
                if(cnoe.getEstado().equals("A")){
                    ...
                    //quitar coma del final
                    lcodCNOEAct = lcodCNOEAct.substring(0, lcodCNOEAct.length()-1);
                }
            }
        ...
        <script type="text/javascript">
            ...
            var codEstudiosAct = [<%=lcodEstudiosAct%>];
            var descEstudiosAct = [<%=ldescEstudiosAct%>];

            var codColectivos = [<%=lcodColectivos%>];
            var descColectivos = [<%=ldescColectivos%>];
            var codColectivosAct = [<%=lcodColectivosAct%>];
            var descColectivosAct = [<%=ldescColectivosAct%>];

            var codTipConDur = [<%=lcodTipConDur%>];
            var descTipConDur = [<%=ldescTipConDur%>];
            var codTipConDurAct = [<%=lcodTipConDurAct%>];
            var descTipConDurAct = [<%=ldescTipConDurAct%>];

            var codTipoJornada = [<%=lcodTipoJornada%>];
            var descTipoJornada = [<%=ldescTipoJornada%>];
            var codTipoJornadaAct = [<%=lcodTipoJornadaAct%>];
            var descTipoJornadaAct = [<%=ldescTipoJornadaAct%>];

            var codCNOE = [<%=lcodCNOE%>];
            var descCNOE = [<%=ldescCNOE%>];
            var codCNOEAct = [<%=lcodCNOEAct%>];
            var descCNOEAct = [<%=ldescCNOEAct%>];

            var codTipoCon = [<%=lcodTipoCon%>];
            var descTipoCon = [<%=ldescTipoCon%>];
            var codTipoConAct = [<%=lcodTipoConAct%>];
            var descTipoConAct = [<%=ldescTipoConAct%>];

            var codColec2 = [<%=lcodColec2%>];
            var descColec2 = [<%=ldescColec2%>];
            var codColec2Act = [<%=lcodColec2Act%>];
            var descColec2Act = [<%=ldescColec2Act%>];

            var codSitPrevia = [<%=lcodSitPrevia%>];
            var descSitPrevia = [<%=ldescSitPrevia%>];
            var codSitPreviaAct = [<%=lcodSitPreviaAct%>];
            var descSitPreviaAct = [<%=ldescSitPreviaAct%>];

            var codSitPrevia2 = [<%=lcodSitPrevia%>];
            var descSitPrevia2 = [<%=ldescSitPrevia%>];
            var codSitPrevia2Act = [<%=lcodSitPreviaAct%>];
            var descSitPrevia2Act = [<%=ldescSitPreviaAct%>];
            ...
            function mostrarBusqueda(tipo) {
                ...
                lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide61/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control=' + control.getTime(), 500, 600, 'no', 'no', function (result) {
                    if (result != undefined) {
                        if (tipo == 'PC') {
            ...
            //calcula Nº días para fin de contrato
            //modificación para convocatoria 2019:
            //NO SE CALCULA !!, si la persona relevista ha tenido CONTRATO DE PRÁCTICAS previo (situación previa), 
            function calcularDiasF() {
                var codigoSitPrevia = document.getElementById('codSitPrevia').value;
                var ejercicio = '<%=ejercicio%>';
                //el valor 1 corresponde a CONTRATO EN PRÁCTICAS en el desplegable TCON (se comprueba en todos los entornos DESA, PRE, PRO)
                if (ejercicio < 2019 || (ejercicio > 2018 && codigoSitPrevia != 1)) {
                    var fecha1 = "";
                    var fecha2 = "";
                    ...
                    if (diasF != "" && diasC != "")
                    {
                        ...
                        if (c < f)
                            jsp_alerta("A", "El numero de dias del contrato adicional es menor que el numero de dias para fin contrato");
                    }
                }
            }

            //Nº días para fin de contrato sólo visible si NO CONTRATO DE PRÁCTICAS
            function checkSitPrevia() {
                var ejercicio = '<%=ejercicio%>';
                var codigoSitPrevia = document.getElementById('codSitPrevia').value;
                var itemDiasFinContrato = document.getElementById('diasFinContrato');
                if (ejercicio > 2018 && codigoSitPrevia == 1) {
                    itemDiasFinContrato.style.visibility = "hidden";
                } else {
                    itemDiasFinContrato.style.visibility = "visible";
                }
            }
            ...
            function calcularDias(fechaInicial, fechaFinal, output)
            {
                ...
                if (dateStart <= dateEnd)
                {
                    ...
                    //alert("La diferencia es de "+(((dateEnd-dateStart)/86400)/1000)+" dï¿½as");
                } else {
                    jsp_alerta("A", "La fecha inicial es posterior a la fecha final");
                }
            ...
            function cargarCombos() {
                ...
                comboEstudiosPC.addItems(codEstudiosAct, descEstudiosAct);
                comboColectivoPC.addItems(codColectivosAct, descColectivosAct);
                comboColectivoPS.addItems(codColec2Act, descColec2Act);
                comboTipoCon.addItems(codTipoConAct, descTipoConAct);
                comboEstudiosPS.addItems(codEstudiosAct, descEstudiosAct);
                comboSitPrevia.addItems(codSitPreviaAct, descSitPreviaAct);
                comboSitPrevia2.addItems(codSitPreviaAct, descSitPreviaAct);
            }
            ...
            function validarDatos() {
                ...
                if (ejercicio < 2019 && colecPC == "1" && (dias == "" || dias == "0")) {
                ...
                if (colecPS == "2") {//Obligatorio si cï¿½digo de 5.1 es 2
                ...
                if (ejercicio < 2019 && colecPS == "1" && diasI == "") {
                    mensajeError = "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "campoDias")%>";
                    return false;
                }
                ...
                if (diasF != "" && diasC != "")
                {
                    ...
                    var c = parseInt(diasC);
                    if (c < f) {
                        mensajeError = "El numero de dias del contrato adicional es menor que el numero de dias para fin contrato";
                        return false;
                    }
                }
                return correcto;
                ...
                if ((longitud >= 8) && (longitud < 10)) {
                    if (isNaN(aux)) {
                        ...
                        if (dni.substring(0, 1) == 'X' || dni.substring(0, 1) == 'Y' || dni.substring(0, 1) == 'Z') {
                             ...
                             */
                            //dejar nie --> validaciï¿½n mal hecha
                            return true;
                        } else {
            ...
            function validarDatosPersonaRelevista() {
                ...
                //Sexo 
                var s = document.getElementById("txtSexoPC").value;
                if (s != null && s != undefined && s != "") {
                    if (s != "H" && s != "M") {
                        if (mensajeError == "")
                            mensajeError = "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "sexoNoVal")%>" + " '" + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "legend.personaContratada")%>" + "'";
                        correcto = false;
                    }
                } else {
                    var mens = "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "camposRojosOblig")%>" + " \n " + " '" + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "legend.personaContratada")%>" + "' : " + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "label.sexo")%>";
                    if (mensajeError == "")
                        mensajeError = mens;
                    //else
                    //    mensajeError += " \n " + mens;
                ...
                //situaciï¿½n previa obligatoria si codigo=2
                if (col == "2") {
                    var encontrado = false;
                    var i = 0;
            ...
            function validarDatosPersonaAdicional() {
                ...
                //Sexo
                var s = document.getElementById("txtSexoPA").value;
                if (s != null && s != undefined && s != "") {
                    if (s != "H" && s != "M") {
                        if (mensajeError == "")
                            mensajeError = "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "sexoNoVal")%>" + " '" + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "legend.personaContratoAdicional")%>" + "'";
                        correcto = false;
                    }
                } else {
                    var mens = "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "camposRojosOblig")%>" + " \n " + " '" + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "legend.personaContratoAdicional")%>" + "' : " + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "label.sexo")%>";
                    if (mensajeError == "")
                        mensajeError = mens;
                    //else
                    //    mensajeError += " \n " + mens;
            ...
            function validarDatosPersonaContratada() {
                ...
                if (s != null && s != undefined && s != "") {
                    ...
                    var mens = "En este caso, el campo es Obligatorio. " + " \n " + " '" + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "legend.personaSustituida")%>" + "' : " + "<%=meLanbide61I18n.getMensaje(idiomaUsuario, "label.sexo")%>";
                    if (mensajeError == "")
                        mensajeError = mens;
            ...
            <%mensajeProgreso = meLanbide61I18n.getMensaje(idiomaUsuario, "msg.guardandoDatos");%>
                ...
                //GRABAR SIEMPRE, AUNQUE HAYA ERRORES DE VALIDACION
                var errores = false;
                if (!validarDatos()) {
                    barraProgresoContrato('off', 'barraProgresoContratoGuardar');
                    jsp_alerta_Mediana("A", mensajeError, "Flexia");
                    errores = true;
                }
                ...
                if (nuevo != null && nuevo == "1") {
                    parametros = "tarea=preparar&modulo=MELANBIDE61&operacion=crearContrato&tipo=0&numero=<%=numExpediente%>"
                            + "&idTerPS=" + document.getElementById('idTerPS').value + "&txtDniPS=" + document.getElementById('txtDniPS').value + "&txtNomPS=" + document.getElementById('txtNomPS').value + "&txtApe1PS=" + document.getElementById('txtApe1PS').value
                            + "&txtApe2PS=" + document.getElementById('txtApe2PS').value + "&fechaNacimientoPS=" + document.getElementById('fechaNacimientoPS').value
                            ...
                            + "&idTerPC=" + document.getElementById('idTerPC').value + "&txtDniPC=" + document.getElementById('txtDniPC').value + "&txtNomPC=" + document.getElementById('txtNomPC').value + "&txtApe1PC=" + document.getElementById('txtApe1PC').value
                            + "&txtApe2PC=" + document.getElementById('txtApe2PC').value + "&fechaNacimientoPC=" + document.getElementById('fechaNacimientoPC').value + "&txtSexoPC=" + document.getElementById('txtSexoPC').value
                            + "&codEstudiosPC=" + document.getElementById('codEstudiosPC').value + "&codColectivoPC=" + document.getElementById('codColectivoPC').value
                            + "&idTerPA=" + document.getElementById('idTerPA').value + "&txtDniPA=" + document.getElementById('txtDniPA').value + "&txtNomPA=" + document.getElementById('txtNomPA').value + "&txtApe1PA=" + document.getElementById('txtApe1PA').value + "&txtApe2PA=" + document.getElementById('txtApe2PA').value + "&fechaNacimientoPA="
                    ...
                    parametros = "tarea=preparar&modulo=MELANBIDE61&operacion=guardarContrato&tipo=0&numero=<%=numExpediente%>&idCon=<%=contrato.getNumContrato()%>"
                            ...
                            + "&txtNomPS=" + document.getElementById('txtNomPS').value + "&txtApe1PS=" + document.getElementById('txtApe1PS').value
                            + "&txtApe2PS=" + document.getElementById('txtApe2PS').value + "&fechaNacimientoPS=" + document.getElementById('fechaNacimientoPS').value
                            + "&txtSexoPS=" + document.getElementById('txtSexoPS').value + "&txtReduJorPA=" + document.getElementById('txtReduJorPA').value
                            ...
                            + "&txtNomPC=" + document.getElementById('txtNomPC').value + "&txtApe1PC=" + document.getElementById('txtApe1PC').value
                            + "&txtApe2PC=" + document.getElementById('txtApe2PC').value + "&fechaNacimientoPC=" + document.getElementById('fechaNacimientoPC').value + "&txtSexoPC=" + document.getElementById('txtSexoPC').value
                            + "&codEstudiosPC=" + document.getElementById('codEstudiosPC').value + "&codColectivoPC=" + document.getElementById('codColectivoPC').value
                            + "&txtDniPA=" + document.getElementById('txtDniPA').value
                            + "&txtNomPA=" + document.getElementById('txtNomPA').value + "&txtApe1PA=" + document.getElementById('txtApe1PA').value + "&txtApe2PA=" + document.getElementById('txtApe2PA').value + "&fechaNacimientoPA="
                            + document.getElementById('fechaNacimientoPA').value + "&txtSexoPA=" + document.getElementById('txtSexoPA').value
                            + "&codTipoCon=" + document.getElementById('codTipoCon').value
                            + "&fechaConPC=" + document.getElementById('fechaConPC').value
                            + "&txtRetribucionPC=" + convertirANumero(document.getElementById('txtRetribucionPC').value)
                    ...
                    for (var j = 0; hijos != null && j < hijos.length; j++) {
                        if (hijos[j].nodeName == "CODIGO_OPERACION") {
                            ...
                            if (hijosValores[0].nodeValue != "")
                                jsp_alerta("A", hijosValores[0].nodeValue);
    ...
    <body class="bandaBody" onload="inicio();" id="cuerpoNuevoContratoRenovacion">
        <div class="txttitblanco"><%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.listadoContratos.title")%></div>
                ...
                <div style="clear: both;">
                    <div>
                        <fieldset style="border:1px solid grey">
                            ...
                            <!-- DATOS PERSONA TRABAJADORA ACOJIDA A LA JUBILIDACIï¿½N -->
                            ...
                            <div class="lineaFormulario">
                                ...
                                <div style="float: left; padding-right: 10px;">
                                    ...
                                    <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacimientoPA(event);
                                ...
                                <div style="float: left; padding-right: 10px;">
                                    ...
                                    <A href="javascript:calClick(event);" onclick="mostrarCalFechaBajaPA(event);
                                            return false;" style="text-decoration:none;" >
                            ...
                            <fieldset style="border:1px solid #C0C0C0"><legend class="legendAzul"><%=meLanbide61I18n.getMensaje(idiomaUsuario,"legend.personaContratada")%></legend>
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left;padding-right: 20px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacimientoPC(event);
                                                return false;" style="text-decoration:none;" >
                                    ...
                                    <div  style="float: left;padding-right: 10px;">
                                        ...
                                        <a id="anchorEstudiosPC" name="anchorEstudiosPC" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEstudiosPC" name="botonEstudiosPC" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                </div>
                                <div class="lineaFormulario">
                                    <div style="float: left;padding-right: 10px;"  class="etiqueta obligatorio">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <a id="anchorColectivosPC" name="anchorColectivoPC" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonColectivoPC" name="botonColectivoPC" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                </div>
                                <div class="lineaFormulario">
                                ...
                                <div  style="float: left;padding-right: 10px;">
                                    ...
                                    <a id="anchorSitPrevia" name="anchorSitPrevia" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonSitPrevia" name="botonSitPrevia" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                </div>
                            </fieldset>
                            <fieldset style="border:1px solid #C0C0C0"><legend class="legendAzul"><%=meLanbide61I18n.getMensaje(idiomaUsuario,"legend.datosContratoRelevo")%></legend>
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <a id="anchorTipoCon" name="anchorTipoCon" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonColectivoPC" name="botonColectivoPC" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                    <div style="float: left;padding-right: 10px;" class="etiqueta obligatorio">
                                        <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.fecInicioContrato")%>*
                                    </div>
                                    <div style="float: left; padding-right: 10px;">
                                        <input type="text" class="inputTxtFecha" size="10" maxlength="10" class="inputTexto" id="fechaConPC" name="fechaConPC" onblur="calcularDiasF();
                                                calcularEdadPC();
                                                calcularEdadPA();
                                               " onkeyup="return SoloCaracteresFecha(this);"  onfocus="this.select();" value="<%=p2 != null && p2.getFeAlta() != null ? formatter.format(p2.getFeAlta()) : ""%>"/>
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaConPC(event);
                                                return false;" style="text-decoration:none;" >
                                            <IMG style="border: 0" height="17" id="calFechaConPC" name="calFechaConPC" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.fecInicioContrato")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                                        </A>
                                    </div>
                                    <div style="float: left; padding-right: 10px;"  class="etiqueta obligatorio">
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaPublica(event);
                                                return false;" style="text-decoration:none;" >
                                ...
                                <div class="lineaFormulario">
                                    <!-- se elimina nº días inscrito para convocatoria 2019_____________________________________________________________________________ -->
                                    <div style="float: left;padding-right: 10px;<%=ejercicio > 2018 ? "display:none;" : ""%>"  class="etiqueta">
                                        <%=meLanbide61I18n.getMensaje(idiomaUsuario,"label.dias")%>
                                    </div>
                                    <div style="float: left; padding-right: 10px;<%=ejercicio > 2018 ? "display:none;" : ""%>">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContrato(event);
                                                return false;" style="text-decoration:none;" >
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContrato(event);
                                                return false;" style="text-decoration:none;" >
                                ...
                                <div id="diasFinContrato" class="lineaFormulario">
                                    <div style="float: left;padding-right: 10px;"  class="etiqueta">
                        ...
                        <fieldset style="border:1px solid grey"><legend class="legendAzul"><%=meLanbide61I18n.getMensaje(idiomaUsuario,"legend.contratacionAd")%></legend>
                            <fieldset style="border:1px solid #C0C0C0"> <!-- DATOS PERSONA CONTRATADA -->
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacimientoPS(event);
                                                return false;" style="text-decoration:none;" >
                                    ...
                                    <div  style="float: left;padding-right: 10px;">
                                        ...
                                        <a id="anchorEstudiosPS" name="anchorEstudiosPS" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEstudiosPC" name="botonEstudiosPS" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                </div>
                                <div class="lineaFormulario">                                    
                                    <div style="float: left; padding-right: 10px;" class="etiqueta">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <a id="anchorColectivosPS" name="anchorColectivoPS" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonColectivoPS" name="botonColectivoPS" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                </div>
                                <div class="lineaFormulario">                                   
                                    ...
                                    <div  style="float: left;padding-right: 10px;">
                                        ...
                                        <a id="anchorSitPrevia2" name="anchorSitPrevia2" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonSitPrevia2" name="botonSitPrevia2" style="cursor:pointer;" alt="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide61I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                                    </div>
                                </div>
                            ...
                            <fieldset style="border:1px solid #C0C0C0"><legend class="legendAzul"><%=meLanbide61I18n.getMensaje(idiomaUsuario,"legend.datosContratoAd")%></legend>                               
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaInConAd" name="fechaInConAd" onkeyup="return SoloCaracteresFecha(this);" onblur="calcularDiasContrato();
                                                calcularEdadPS();" onfocus="this.select();" onchange="calcularDuracionContrato();" value="<%=p1 != null && p1.getFecInConAd() != null ? formatter.format(p1.getFecInConAd()) : ""%>"/>
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaInConAd(event);
                                                return false;" style="text-decoration:none;" >
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinConAd(event);
                                                return false;" style="text-decoration:none;" >
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaInConPre2(event);
                                                return false;" style="text-decoration:none;" >
                                    ...
                                    <div style="float: left; padding-right: 10px;">
                                        ...
                                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinConPre2(event);
                                                return false;" style="text-decoration:none;" >
                                ...
                                <div class="lineaFormulario">
                                    ...
                                    <!-- se elimina nº días inscrito para convocatoria 2019______________________________________________________________________________ -->
                                    <div style="float: left;padding-right: 10px;"  class="etiqueta">
