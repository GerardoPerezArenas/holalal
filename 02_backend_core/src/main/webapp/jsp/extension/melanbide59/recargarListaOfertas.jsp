...
<script type="text/javascript" src="<c:url value='/scripts/extension/melanbide59/cpeUtils.js'/>"></script>

<script type="text/javascript">    
    
    function actualizarOfertasCpe(){
        try{
            var codigoOperacion = '<%=request.getSession().getAttribute("codOperacionGuardarOfertaCpe") != null ? request.getSession().getAttribute("codOperacionGuardarOfertaCpe") : ""%>';
            if(codigoOperacion=="0"){
                parent.self.parent.opener.retornoXanelaAuxiliar(  getListaOfertasCpe());
                parent.barraProgresoCpe('off', 'barraProgresoNuevaOferta');
...
<body onload="actualizarOfertasCpe();">
</body>
