...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
                <input type="button" id="btnModificarPuestoCpe" name="btnModificarPuestoCpe" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "btn.consultar")%>" onclick="pulsarModificarPuestoCpe();">
            </div>
    </div>
</body>
