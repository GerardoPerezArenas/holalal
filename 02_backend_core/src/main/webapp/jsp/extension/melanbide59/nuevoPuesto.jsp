...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            if(consulta)
            {
                tituloPagina = meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.titulo.consultaPuesto");
            }
            else
            {
                if(puestoModif != null)
                {
                    tituloPagina = meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.titulo.modifPuesto");
                }
                else
                {
                    tituloPagina = meLanbide59I18n.getMensaje(idiomaUsuario, "label.puesto.titulo.nuevoPuesto");
                }
            }
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    document.getElementById('txtDietasSolicitables').value = '<%=puestoModif.getGastosVisado() != null ? puestoModif.getGastosVisado().toPlainString() : "" %>';
                    document.getElementById('txtMesesSolicitables').value = '<%=puestoModif.getMesesManut() != null ? puestoModif.getMesesManut().toString() : "" %>';
                    document.getElementById('txtSegurosSolicitables').value = '<%=puestoModif.getGastosSeguro() != null ? puestoModif.getGastosSeguro().toPlainString() : "" %>';
                    ...
                    document.getElementById('txtDietasContrato').value = '<%=puestoModif.getGastosSeguroCon() != null ? puestoModif.getGastosSeguroCon().toPlainString() : "" %>';
                    document.getElementById('txtTramitacionContrato').value = '<%=puestoModif.getGastosVisadoCon() != null ? puestoModif.getGastosVisadoCon().toPlainString() : "" %>';
                <%
                }
                else
                {
                %>
                    //document.getElementById('codResultadoResumen').value = '<%=ConstantesMeLanbide59.CODIGO_RESULTADO_NO_EVALUADO%>';
                ...
                document.getElementById('txtSegurosSolicitables').readOnly = true;
                document.getElementById('txtSegurosSolicitables').className = 'inputTexto readOnly';
            ...
            function cargarDescripcionesCombos(){
                ...
                //Resultado
                codigo = '<%=puestoModif != null ? puestoModif.getCodResult() != null ? puestoModif.getCodResult() : "" : ""/*ConstantesMeLanbide59.CODIGO_RESULTADO_NO_EVALUADO*/%>';
                desc = '';
                encontrado = false;
                i = 0; 
                if(codigo != null && codigo != '')
            ...
            function guardar(){
                ...
                if(document.getElementById('codResultadoResumen').value=='002' || document.getElementById('codResultadoResumen').value=='003'){
                     resultado= jsp_alerta('', '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.preguntaEliminarCambioRenuncia")%>');  
                }
                if (resultado == 1 || resultado==9){
                    if(validarDatos()){
                        ...
                        parametros = 'tarea=preparar&modulo=MELANBIDE59&operacion=guardarPuesto&tipo=0&numero=<%=numExpediente%>'
                            ...
                            +'&gastosVisado='+document.getElementById('txtDietasSolicitables').value
                            +'&mesesManutencion='+document.getElementById('txtMesesSolicitables').value
                            +'&gastosSeguro='+document.getElementById('txtSegurosSolicitables').value
                            ...
                            +'&gastosSeguroCon='+document.getElementById('txtDietasContrato').value
                            +'&gastosVisadoCon='+document.getElementById('txtTramitacionContrato').value
                        ...
                        for(j=0;hijos!=null && j<hijos.length;j++){
                            ...
                            if(codigoOperacion=="0"){
                                ...
                                jsp_alerta("A",'<%=meLanbide59I18n.getMensaje(idiomaUsuario,"msg.puestoGuardadoOK")%>');
                                cerrarVentana();
                ...
                if(document.getElementById('txtSalarioSolicitables1').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioSolicitables1'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.salarioAnexoIncorrecto1")%>';
                        }else{
                ...
                if(document.getElementById('txtSalarioSolicitables2').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioSolicitables2'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.salarioAnexoIncorrecto2")%>';
                        }else{
                ...
                if(document.getElementById('txtSalarioSolicitables3').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioSolicitables3'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.salarioAnexoIncorrecto3")%>';
                        }else{
                ...
                if(document.getElementById('txtTotSalarioSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtTotSalarioSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.salarioAnexoTotIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtDietasSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.dietasManutIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtMesesSolicitables').value != ''){
                    try{
                        if(!validarNumericoCpe(document.getElementById('txtMesesSolicitables'), 4)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.mesesManutIncorrecto2")%>';
                        }else{
                ...
                if(document.getElementById('txtSegurosSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSegurosSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.tramSegurosIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtImporteSolicitables').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtImporteSolicitables'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitables.impSolicIncorrecto")%>';
                        }else{
            ...
            function validarDatosContrato(){
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaIniContrato'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaIniIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(!validarFechaCpe(document.forms[0], document.getElementById('fechaFinContrato'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaFinIncorrecto")%>';
                    correcto = false;
                }else{
                ...
                if(correcto){
                    ...
                    if(array_fecha_ini.length == 3 && array_fecha_fin.length == 3)
                    {
                        ...
                        if(result < 0){
                            ...
                            document.getElementById('fechaFinContrato').style.border = '1px solid red';
                            if(mensajeValidacion == ''){
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.fechaIniPosteriorFechaFin")%>';
                            }
                        }else{
                            document.getElementById('fechaIniContrato').removeAttribute('style');
                            document.getElementById('fechaFinContrato').removeAttribute('style');
                ...
                if(!existeCodigoCombo(gCot, codGrupoCot)){
                    ...
                    document.getElementById('descGrupoSolicitables').style.border = '1px solid red';*/
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.grupoCotIncorrecto")%>';
                    }
                }else{
                ...
                if(!comprobarCaracteresEspecialesCpe(convenio)){
                    ...
                    mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.convenioCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(convenio.length > 500){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.convenioColDemasiadoLargo")%>';
                        }
                        document.getElementById('txtConvenioContrato').style.border = '1px solid red';
                        correcto = false;
                    }else{
                ...
                if(document.getElementById('txtSalarioContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.salarioContratoIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtDietasContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.dietasConvenioIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtCosteContrato').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtCosteContrato'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.costeContratacionIncorrecto")%>';
                        }else{
                ...
                if(!comprobarCaracteresEspecialesCpe(benef)){
                    ...
                    mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosContrato.otrosBenefCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(benef.length > 1000){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.otrosBenefDemasiadoLargo")%>';
                        }
                        document.getElementById('otrosBeneficiosContrato').style.border = '1px solid red';
                        correcto = false;
                    }else{
            ...
            function validarDatosResumen() {
                ...
                if(!existeCodigoCombo(gCot, codResultado)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.resultadoNoExiste")%>';
                    }
                    ...
                    document.getElementById('descResultadoResumen').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.estado")%>';
                }else{
                ...
                if(!existeCodigoCombo(gCot, codMotivo)){
                    ...
                    if(mensajeValidacion == ''){
                        mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.motivoNoExiste")%>';
                    }
                }else{
                ...
                if(!comprobarCaracteresEspecialesCpe(obs)){
                    ...
                    mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosResumenPuesto.observacionesCaracteresNoValidos")%>';
                    return false;
                }else{
                    if(obs.length > 1000){
                        if(mensajeValidacion == ''){
                            mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosPuesto.observacionesDemasiadoLargo")%>';
                        }
                        document.getElementById('observacionesResumen').style.border = '1px solid red';
                        correcto = false;
                    }else{
                ...
                if(document.getElementById('txtSalarioSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtSalarioSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.salarioIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtDietasSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtDietasSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.dietasIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtTramitacionSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtTramitacionSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.tramitacionIncorrecto")%>';
                        }else{
                ...
                if(document.getElementById('txtImpTotalSolicitud').value != ''){
                    try{
                        if(!validarNumericoDecimalCpe(document.getElementById('txtImpTotalSolicitud'), 10, 2)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.puesto.datosSolicitud.impTotIncorrecto")%>';
                        }else{
            ...
            function cambioResultado(){
                ...
                if(codigo != null && codigo != '')
                {
                    if(codigo == '<%=ConstantesMeLanbide59.CODIGO_RESULTADO_RENUNCIA%>' || codigo == '<%=ConstantesMeLanbide59.CODIGO_RESULTADO_DENEGADO%>'){
            ...
            function calcularDietasManutencion(){
                ...
                if(correcto){
                   // var mStr = document.getElementById('txtTotSalarioSolicitables').value;
                     var gastosVisSoli = reemplazarTextoCpe(document.getElementById('txtTramitacionSolicitud').value, /,/g, '.');
                     var gastosSegSoli = reemplazarTextoCpe(document.getElementById('txtDietasSolicitud').value, /,/g, '.');
                    //var gastosVisSoli = document.getElementById('txtTramitacionSolicitud').value;
                    var maxSubvencionable = reemplazarTextoCpe(document.getElementById('txtTotSalarioSolicitables').value, /,/g, '.');
                    // if(mStr != ''){
                    if(maxSubvencionable != ''){
                        //calculamos gastos visado
                        //Se coge el menor valor entre solicitado y subvencionable *0.04
                        if (gastosVisSoli==''){
                            document.getElementById('txtDietasSolicitables').value = '0,00';
                        }else {
                           // var salario = parseInt(mStr);
                            var salario = parseInt(maxSubvencionable);
                            salario = salario*0.04;
                            salario = salario.toFixed(2);
                            
                            if (parseFloat(gastosVisSoli)<salario)
                            {
                                salario=document.getElementById('txtTramitacionSolicitud').value;
                            }
                            document.getElementById('txtDietasSolicitables').value = salario;
                        }
                        if (gastosSegSoli==''){
                            document.getElementById('txtSegurosSolicitables').value = '0,00';
                        }else {
                             var salario = parseInt(maxSubvencionable);
                            salario = salario*0.03;
                            salario = salario.toFixed(2);                            
                            if (parseFloat(gastosSegSoli)<salario)
                            {
                                salario=document.getElementById('txtDietasSolicitud').value;
                            }
                            document.getElementById('txtSegurosSolicitables').value = salario;
                        }
                        
                        
                        /*if(gastosVisSoli!='' && gastosVisSoli!='0,00' && gastosVisSoli!='0.00'){// si los gastos de visado solicitados son 0 --> no se calculan los subvencionados                           
                          var salario = parseInt(mStr);
                            salario = salario*0.04;
                            salario = salario.toFixed(2);
                            document.getElementById('txtDietasSolicitables').value = salario;
                        ...
                        //calculamos gastos seguro
                        //salario = parseInt(mStr);
                        salario = parseInt(maxSubvencionable);
                        salario = salario*0.03;
                        salario = salario.toFixed(2);
                        document.getElementById('txtSegurosSolicitables').value = salario;    */                    
                    }else{
            ...
            function calcularCosteContratacion(campo){
                ...
                var tStr = document.getElementById('txtTramitacionContrato').value;
                ...
                if(dStr != '' || sStr != '' || tStr != ''){
                    ...
                    if(correcto){
                        ...
                        if(tStr != ''){
                            gasto = parseFloat(tStr);
                        }

                        var coste = dietas + salario + gasto;
            ...
            function cargarSalarioAnexo1Cpe1(){
                var codNivel = document.getElementById('codNivelFormativo').value;
                var codPais = document.getElementById('codPaisSolicitables1').value;
                var salarioSolicitado = reemplazarTextoCpe(document.getElementById('txtSalarioSolicitud').value, /,/g, '.');
                
                if(codPais != null && codPais != '' && codNivel != null && codNivel != ''){
                    var importe = '';
                    if(codNivel == '1' || codNivel == '01' || codNivel == '001' || codNivel == '0001')
                        importe = '26200';
                    else if(codNivel == '2' || codNivel == '02' || codNivel == '002' || codNivel == '0002')
                        importe = '23600';
                    else
                        importe = '0';
                    
                    if ( parseFloat(salarioSolicitado) < parseFloat(importe))
                        importe=salarioSolicitado;
                ...
                try{
                   ...
                   var ajax = getXMLHttpRequest();
                    ...
                    if(!isNaN(numMeses) && numMeses != null && numMeses >= 0 && numMeses <= 99999){
                        ...
                        //document.getElementById('txtMesesSolicitables').value = numMeses;
                    }
                    else
            ...
            function ajustarDecimalesImportes(){
                ...
                //Tramitacion Seguro Contrato
                v = document.getElementById('txtTramitacionContrato').value;
                v = reemplazarTextoCpe(v, /,/g, '.');
                f = parseFloat(v);
                f = ajustarDecimalesCpe(f, 2);
                if(!isNaN(f)){
                    document.getElementById('txtTramitacionContrato').value = f;
                    reemplazarPuntosCpe(document.getElementById('txtTramitacionContrato'));
                    document.getElementById('txtTramitacionContrato').removeAttribute("style");
                }
        ...
        <form  id="formNuevoPuesto">
                ...
                <fieldset id="fieldsetDatosContrato" name="fieldsetDatosContrato" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.puesto.datosContrato")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecIni")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 107px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaIniContrato" name="fechaIniContrato" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCpe(this, '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaIniContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaIniContrato" name="calfechaIniContrato" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecIni")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecFin")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fechaFinContrato" name="fechaFinContrato" onkeyup="return SoloCaracteresFecha(this);" onblur="if(comprobarFechaCpe(this, '<%=meLanbide59I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>')){calcularMesesContratado();}" onfocus="this.select();" value=""/>
                            <A href="javascript:calClick(event);" onclick="mostrarCalFechaFinContrato(event);return false;" style="text-decoration:none;" >
                                <IMG style="border: 0" height="17" id="calfechaFinContrato" name="calfechaFinContrato" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.fecFin")%>" src="<c:url value='/images/calendario/icono.gif'/>"/>
                            </A>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.grupoCot")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 20px;">
                            ...
                            <input id="descGrupoContrato" name="descGrupoContrato" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoContrato" name="anchorGrupoContrato" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGrupoContrato" name="botonGrupoContrato" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.convenio")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 128px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.salario")%>
                        </div>
                        ...
                        <div style="float: left; width: 100px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasContrato" name="txtDietasContrato" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularCosteContratacion(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 130px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.tramSeguros")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtTramitacionContrato" name="txtTramitacionContrato" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularCosteContratacion(this); ajustarDecimalesImportes();" />
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px; margin-right: 2px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.coste")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosContrato.otrosBeneficios")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <fieldset id="fieldsetDatosSolicitud" name="fieldsetDatosSolicitud" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.puesto.datosSolicitud")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.salario")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtSalarioSolicitud" name="txtSalarioSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);cargarSalarioAnexo1Cpe1();cargarSalarioAnexo1Cpe2();cargarSalarioAnexo1Cpe3();" onblur="calcularImpTotalSolicitado(this); cargarSalarioAnexo1Cpe1();ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 100px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasSolicitud" name="txtDietasSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();calcularDietasManutencion();"/>
                        </div>
                        <div style="float: left; width: 130px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.tramSeguros")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtTramitacionSolicitud" name="txtTramitacionSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this); ajustarDecimalesImportes();calcularDietasManutencion();"/>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.impTotal")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                ...
                <!-- datos subvencionables -->
                <fieldset id="fieldsetDatosSolicitables" name="fieldsetDatosSolicitables" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.puesto.datosSubvencionables")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.nivelFormativo")%>
                        </div>
                        ...
                        <div style="float: left; width: 42px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais1")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                        ...
                        <div style="float: left; width: 150px; margin-right: 2px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.salario")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px; margin-left: 312px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais2")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px; margin-left: 312px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.pais3")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 150px; margin-right: 2px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.totSalario")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.meses")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                            <input type="text" maxlength="4" size="8" id="txtMesesSolicitables" name="txtMesesSolicitables" value="" class="inputTexto textoNumerico" onblur=" ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 182px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 9px; margin-right: 42px;">
                            <input type="text" maxlength="15" size="8" id="txtSegurosSolicitables" name="txtSegurosSolicitables" value="" class="inputTexto textoNumerico" onblur="ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 152px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.tramSeguros")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="15" size="8" id="txtDietasSolicitables" name="txtDietasSolicitables" value="" class="inputTexto textoNumerico" onkeyup="calcularImporteMaxSubv();" onblur="calcularImporteMaxSubv(); ajustarDecimalesImportes();"/>
                        </div>
                    </div>
                    <div class="lineaFormulario" style="text-align: right;">
                        <div style="float: left; width: 180px; text-align: left;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitables.impMaxSubv")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                ...
                <!-- fin datos subvencionables -->
                <fieldset id="fieldsetResumenPuesto" name="fieldsetResumenPuesto" style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide59I18n.getMensaje(idiomaUsuario,"legend.puesto.datosResumenPuesto")%></legend>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.resultado")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px; margin-right: 20px;">
                            ...
                            <input id="descResultadoResumen" name="descResultadoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorResultadoResumen" name="anchorResultadoResumen" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonResultadoResumen" name="botonResultadoResumen" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div id="divLabelMotivoResumen" style="float: left; width: 40px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.motivo")%>
                        </div>
                        <div id="divComboMotivoResumen" style="width: auto; float: left; margin-left: 10px; margin-right: 65px;">
                            ...
                            <input id="descMotivoResumen" name="descMotivoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorMotivoResumen" name="anchorMotivoResumen" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonMotivoResumen" name="botonMotivoResumen" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosResumenPuesto.observaciones")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
