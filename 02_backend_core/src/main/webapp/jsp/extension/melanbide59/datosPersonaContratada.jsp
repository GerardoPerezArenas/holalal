...
<div style="clear:both;"><br /></div>
                    ...
                    <div class="lineaFormulario" style="display: none;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <a id="anchorEstado" name="anchorEstado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEstado" name="botonEstado" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </fieldset>
                <div class="botonera">
