    ...
    function pulsarModificarOfertaCpe(){
        ...
        if(tabOfertasCpe.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarModificarOferta&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idOferta='+listaOfertasCpe[fila][0]+'&idPuesto='+listaOfertasCpe[fila][1]+'&control='+control.getTime(),560,980,'yes','no',function(nodos){
                        if (nodos != undefined){
...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
            <input type="button" id="btnModificarOfertaCpe" name="btnModificarOfertaCpe" class="botonGeneral" value="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "btn.consultar")%>" onclick="pulsarModificarOfertaCpe();">
        </div>
    </div>
</body>
