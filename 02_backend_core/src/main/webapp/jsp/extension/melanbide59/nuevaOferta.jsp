...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
           ...
           function cambioPais2(){
            ...
            function buscarTitulacion(id){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide59/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),520,960,'yes','no',function(result){
                    ...
                    lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide59/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),580,960,'yes','no',function(result){
						if (result != undefined && result.length == 3){
							document.getElementById('cod'+id).value = result[0];
							var desc = result[1] != undefined && result[1] != '' ? result[1] : '';
							desc += desc != '' && result[2] != undefined && result[2] != '' ? '-' : '';
        ...
        <div id="divCuerpo" class="contenidoPantalla" style="">
                    ...
                    <div class="lineaFormulario">    
                        ...
                        <div style="width: auto; float: left; margin-left: 12px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto1" name="descPaisPuesto1" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto1" name="anchorPaisPuesto1" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPaisPuesto1" name="botonPaisPuesto1" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descPaisPuesto2" name="descPaisPuesto2" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto2" name="anchorPaisPuesto2" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPaisPuesto2" name="botonPaisPuesto2" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div style="float: left; width: 42px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descPaisPuesto3" name="descPaisPuesto3" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorPaisPuesto3" name="anchorPaisPuesto3" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPaisPuesto3" name="botonPaisPuesto3" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 42px;">
                    ...
                    <div class="lineaFormulario">        
                        ...
                        <div style="width: auto; float: left; margin-left: 2px;">
                            ...
                            <input id="descNivelFormativo" name="descNivelFormativo" type="text" class="inputTexto" size="1" readonly >
                             <a id="anchorNivelFormativo" name="anchorNivelFormativo" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNivelFormativo" name="botonNivelFormativo" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto1" name="descIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto1" name="anchorIdiomaPuesto1" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonIdiomaPuesto1" name="botonIdiomaPuesto1" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto1" name="descNivelIdiomaPuesto1" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto1" name="anchorNivelIdiomaPuesto1" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNivelIdiomaPuesto1" name="botonNivelIdiomaPuesto1" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto2" name="descIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto2" name="anchorIdiomaPuesto2" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonIdiomaPuesto2" name="botonIdiomaPuesto2" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                            ...
                            <input id="descNivelIdiomaPuesto2" name="descNivelIdiomaPuesto2" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto2" name="anchorNivelIdiomaPuesto2" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNivelIdiomaPuesto2" name="botonNivelIdiomaPuesto2" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 78px;">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descIdiomaPuesto3" name="descIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorIdiomaPuesto3" name="anchorIdiomaPuesto3" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonIdiomaPuesto3" name="botonIdiomaPuesto3" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        <div style="float: left; width: 78px;">
                            <%=meLanbide59I18n.getMensaje(idiomaUsuario,"label.puesto.datosPuesto.nivelIdioma")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 7px;">
                           <input id="codNivelIdiomaPuesto3" name="codNivelIdiomaPuesto3" type="text" class="inputTexto" size="2" maxlength="8" 
                            ...
                            <input id="descNivelIdiomaPuesto3" name="descNivelIdiomaPuesto3" type="text" class="inputTexto" size="17" readonly >
                             <a id="anchorNivelIdiomaPuesto3" name="anchorNivelIdiomaPuesto3" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNivelIdiomaPuesto3" name="botonNivelIdiomaPuesto3" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        ...
                        <div style="float: left;" id="divTxtCausaRenunciaPresOferta" name="divTxtCausaRenunciaPresOferta">    
                            ...
                            <div style="float: left;">
                                ...
                                <input id="descCausaRenunciaPresOferta" name="descCausaRenunciaPresOferta" type="text" class="inputTexto" size="20" readonly >
                                 <a id="anchorCausaRenunciaPresOferta" name="anchorCausaRenunciaPresOferta" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonCausaRenunciaPresOferta" name="botonCausaRenunciaPresOferta" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                            </div>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descOfiGestionOferta" name="descOfiGestionOferta" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorOfiGestionOferta" name="anchorOfiGestionOferta" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonOfiGestionOferta" name="botonOfiGestionOferta" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    ...
                    <div class="lineaFormulario" id="divRenuncia" name="divRenuncia">
                        ...
                        <div style="float: left;">
                            ...
                            <input id="descCausaRenuncia" name="descCausaRenuncia" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorCausaRenuncia" name="anchorCausaRenuncia" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonCausaRenuncia" name="botonCausaRenuncia" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </fieldset>
                </div>
                    ...
                    <div class="lineaFormulario">     
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <input id="descNifContratado" name="descNifContratado" type="text" class="inputTexto" size="19" readonly >
                             <a id="anchorNifContratado" name="anchorNifContratado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNifContratado" name="botonNifContratado" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 22px;">
                            ...
                            <input id="descGrupoCotContratado" name="descGrupoCotContratado" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoCotContratado" name="anchorGrupoCotContratado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGrupoCotContratado" name="botonGrupoCotContratado" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                            ...
                            <input id="descCausaBaja" name="descCausaBaja" type="text" class="inputTexto" size="20" readonly onchange="checkDescSustituto();" >
                             <a id="anchorCausaBaja" name="anchorCausaBaja" href="" ><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonCausaBaja" name="botonCausaBaja" style="cursor:hand;" alt="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide59I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" ></span></a>
                        </div>
                    </div>
