...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide59.vo.FilaOfertaVO" %>
...
<script type="text/javascript">   
    function pulsarAltaOfertaCpe(){
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarNuevaOferta&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),560,980,'no','no', function(nodos){
							if (nodos != undefined){
            ...
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarNuevaOferta&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),620,980,'no','no', function(nodos){
        if (nodos != undefined){
            result = extraerListadoOfertasCpe(nodos);
                if(result[0] == '0'){
                    recargarTablaOfertasCpe(result);
    ...
    function pulsarModificarOfertaCpe(){
        ...
        if(tabOfertasCpe.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarModificarOferta&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idOferta='+listaOfertasCpe[fila][0]+'&idPuesto='+listaOfertasCpe[fila][1]+'&control='+control.getTime(),650,980,'yes','no', function(nodos){
							if (nodos != undefined){
								result = extraerListadoOfertasCpe(nodos);
								if(result[0] == '0'){
									recargarTablaOfertasCpe(result);								
                 ...
                 lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE59&operacion=cargarModificarOferta&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idOferta='+listaOfertasCpe[fila][0]+'&idPuesto='+listaOfertasCpe[fila][1]+'&control='+control.getTime(),620,980,'yes','no', function(nodos){
            if (nodos != undefined){
                result = extraerListadoOfertasCpe(nodos);
                    if(result[0] == '0'){
                        recargarTablaOfertasCpe(result);
    ...
    function pulsarEliminarOfertaCpe(){
            ...
            if(tabOfertasCpe.selectedIndex != -1) {
                ...
                if (resultado == 1){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE59&operacion=eliminarOferta&tipo=0&numero=<%=numExpediente%>&idOferta='+listaOfertasCpe[tabOfertasCpe.selectedIndex][0]+'&idPuesto='+listaOfertasCpe[fila][1]+'&control='+control.getTime();
                    try{
    ...
    function recargarTablaOfertasCpe(result){
        ...
        for(var i = 2;i< result.length; i++){
			...
			listaOfertasCpe[i-2] = [fila[0],fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7], fila[8], fila[9]];
        ...
        tabOfertasCpe.addColumna('140','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col1")%>");
        tabOfertasCpe.addColumna('140','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col2")%>");    
        tabOfertasCpe.addColumna('250','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col3")%>");   
        tabOfertasCpe.addColumna('80','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col4")%>");   
        tabOfertasCpe.addColumna('60','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col5")%>");   
        tabOfertasCpe.addColumna('60','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col6")%>");   
        tabOfertasCpe.addColumna('60','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col7")%>");   
        tabOfertasCpe.addColumna('250','left',"<%= meLanbide59I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col8")%>");     
        ...
        tabOfertasCpe.scrollWidth = 1080;
...
<body>
    ...
    <div style="clear: both;">
        <div id="ofertasCpe" style="padding: 5px; width:67.7%; height: 159px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
        <div class="botonera">
