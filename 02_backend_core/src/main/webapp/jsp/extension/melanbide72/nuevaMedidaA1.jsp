            ...
            function guardarDatos() {
                ...
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=crearNuevaMedidaA1&tipo=0"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=modificarMedidaA1&tipo=0"
