...
<html>
    <head>
        ...
        <%
            MedidaA2VO datModif = new MedidaA2VO();
            ...
            try
            {
                ...
                {
                    datModif = (MedidaA2VO)request.getAttribute("datModif");
                }
            }
            catch(Exception ex)
            {
        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                ...
                if (validarDatos()) {
                    ...
                    var provincia = "";
                    if (document.getElementById('provincia').value == null || document.getElementById('provincia').value == '') {
                        provincia = "";
                    } else {
                        provincia = document.getElementById('provincia').value.replace(/\'/g, "''");
                    }
                    var municipio = "";
                    if (document.getElementById('municipio').value == null || document.getElementById('municipio').value == '') {
                        municipio = "";
                    } else {
                        municipio = document.getElementById('municipio').value.replace(/\'/g, "''");
                    }
                    var localidad = "";
                    if (document.getElementById('localidad').value == null || document.getElementById('localidad').value == '') {
                        localidad = "";
                    } else {
                        localidad = document.getElementById('localidad').value.replace(/\'/g, "''");
                    }
                    var direccion = "";
                    if (document.getElementById('direccion').value == null || document.getElementById('direccion').value == '') {
                        direccion = "";
                    } else {
                        direccion = document.getElementById('direccion').value.replace(/\'/g, "''");
                    }
                    var objetoContrato = "";
                    if (document.getElementById('objetoContrato').value == null || document.getElementById('objetoContrato').value == '') {
                        objetoContrato = "";
                    } else {
                        objetoContrato = document.getElementById('objetoContrato').value.replace(/\'/g, "''");
                    }

                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=crearNuevaMedidaA2&tipo=0"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=modificarMedidaA2&tipo=0"
            ...
            function validarDatos() {
                ...
                if (document.getElementById('apellido1').value == null || document.getElementById('apellido1').value == '') {
                    mensajeValidacion = '<%=meLanbide72I18n.getMensaje(idiomaUsuario, "msg.apellido1Obligatorio")%>';
                    return false;
                }

                if (document.getElementById('dni').value == null || document.getElementById('dni').value == '') {
                    mensajeValidacion = '<%=meLanbide72I18n.getMensaje(idiomaUsuario, "msg.dniObligatorio")%>';
                    return false;
                }
                ...
                if (document.getElementById('objetoContrato').value == null || document.getElementById('objetoContrato').value == '') {
                    mensajeValidacion = '<%=meLanbide72I18n.getMensaje(idiomaUsuario, "msg.objetoContratoObligatorio")%>';
                    return false;
                }
        ...
        <div class="contenidoPantalla">
            <form><!--    action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.apellido1")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.apellido2")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.tipoDocumento")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="tipoDocumento" name="tipoDocumento" type="text" class="inputTexto" size="100" maxlength="50" 
                                       value="<%=datModif != null && datModif.getTipoDocumento() != null ? datModif.getTipoDocumento() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.dni")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="dni" name="dni" type="text" class="inputTexto" size="100" maxlength="25" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.tfno")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="tfno" name="tfno" type="text" class="inputTexto" size="100" maxlength="25" 
                                       value="<%=datModif != null && datModif.getTfno() != null ? datModif.getTfno() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.email")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="email" name="email" type="text" class="inputTexto" size="100" maxlength="100" 
                                       value="<%=datModif != null && datModif.getEmail() != null ? datModif.getEmail() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.provincia")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="provincia" name="provincia" type="text" class="inputTexto" size="100" maxlength="50" 
                                       value="<%=datModif != null && datModif.getProvincia() != null ? datModif.getProvincia() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.municipio")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="municipio" name="municipio" type="text" class="inputTexto" size="100" maxlength="100" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.localidad")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="localidad" name="localidad" type="text" class="inputTexto" size="100" maxlength="100" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.direccion")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="direccion" name="direccion" type="text" class="inputTexto" size="100" maxlength="300" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.portal")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="portal" name="portal" type="text" class="inputTexto" size="10" maxlength="4" 
                                       value="<%=datModif != null && datModif.getPortal() != null ? datModif.getPortal() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.piso")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="piso" name="piso" type="text" class="inputTexto" size="10" maxlength="4" 
                                       value="<%=datModif != null && datModif.getPiso() != null ? datModif.getPiso() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.letra")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="letra" name="letra" type="text" class="inputTexto" size="10" maxlength="4" 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"medidasAlt.tablaMedidas.cPostal")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="cPostal" name="cPostal" type="text" class="inputTexto" size="10" maxlength="8" 
                                       value="<%=datModif != null && datModif.getC_postal() != null ? datModif.getC_postal() : ""%>"/>
                            </div>
                        </div>
                    </div>    
                    <br><br> 
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide72I18n.getMensaje(idiomaUsuario,"label.objetoContrato")%>
                        </div>
                        <div style="width: 450px;">
                            <div>
                                <!-- <input id="objetoContrato" name="objetoContrato" type="text" class="inputTexto" 
                                       value="<%=datModif != null && datModif.getObjetoContrato() != null ? datModif.getObjetoContrato() : ""%>"/> -->
                                <textarea id="objetoContrato" name="objetoContrato" rows="7" cols="80" class="inputTexto" ><%=datModif != null && datModif.getObjetoContrato() != null ? datModif.getObjetoContrato().replaceAll("nnn", "\n") : ""%></textarea>
                            </div>
                        </div>
                    </div>
