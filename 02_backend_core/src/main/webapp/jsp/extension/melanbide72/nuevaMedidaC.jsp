            ...
            function guardarDatos() {
                ...
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=crearNuevaMedidaC&tipo=0"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE72&operacion=modificarMedidaC&tipo=0"
