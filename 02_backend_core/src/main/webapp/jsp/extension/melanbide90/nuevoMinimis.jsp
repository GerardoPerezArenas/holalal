...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide90.vo.DesplegableAdmonLocalVO" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if ('<%=nuevo%>' != null && '<%=nuevo%>' == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE90&operacion=crearNuevoMinimis&tipo=0";
                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE90&operacion=modificarMinimis&tipo=0"
            ...
            function validarDatos() {
                ...
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.estado")%>';
                    return false;
                }
                campo = document.getElementById('organismo').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.organismo")%>';
                    return false;
                }
                campo = document.getElementById('objeto').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.objeto")%>';
                    return false;
                }
                campo = document.getElementById('importe').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.importe")%>';
                    return false;
                } else if (!validarNumericoDecimalPrecision(campo, 10, 2)) {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.importe.errNumerico")%>';
                    return false;
                }
                campo = document.getElementById('fecha').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide90I18n.getMensaje(idiomaUsuario, "msg.fechaSub")%>';
                    return false;
                }
            ...
            function mostrarError(codigo) {
                pleaseWaitSinFrame('off');
                if (codigo == "1") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorBD")%>');
                } else if (codigo == "2") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                } else if (codigo == "3") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                } else if (codigo == "4") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.listaVacia")%>');
                } else if (codigo == "5") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorObtenerDatos")%>');
                } else if (codigo == "6") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorBorrarDatos")%>');
                } else if (codigo == "7") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorInsertarDatos")%>');
                } else if (codigo == "8") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorActualizarDatos")%>');
                } else if (codigo == "-1") {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.operacionIncorrecta")%>');
                } else {
                    jsp_alerta("A", '<%=meLanbide90I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                }
            }
            ...
            <form>
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.nuevaSubvencion")%>
                        </span>
                    </div> 
                    <div class="lineaFormulario">
                        <div class="etiquetaInin"><%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.estado")%></div>
                        <div>
                            <div>
                                <input type="text" name="codListaEstado" id="codListaEstado" size="2" class="inputTexto" value="" onkeyup="xAMayusculas(this);" />
                                <input type="text" name="descListaEstado"  id="descListaEstado" size="30" class="inputTexto" readonly="true" value="" />
                    ...
                    <div class="lineaFormulario">
                        <div class="etiquetaInin"><%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.organismo")%></div>
                        <div>
                            <div style="float: left;">
                                <input id="organismo" name="organismo" type="text" class="inputTexto" size="100" maxlength="200" 
                                       value="<%=datModif != null && datModif.getOrganismo() != null ? datModif.getOrganismo() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div class="etiquetaInin"><%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.objeto")%></div>
                        <div>
                            <div style="float: left;">
                                <input id="objeto" name="objeto" type="text" class="inputTexto" size="100" maxlength="200" 
                                       value="<%=datModif != null && datModif.getObjeto() != null ? datModif.getObjeto() : ""%>"/>
                            </div>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div class="etiquetaInin"><%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.importe")%></div>
                        <div>
                            <div style="float: left;">
                                <input id="importe" name="importe" type="text" class="inputTexto" size="9" maxlength="9" 
                    ...
                    <div class="lineaFormulario">
                        <div class="etiquetaInin"><%=meLanbide90I18n.getMensaje(idiomaUsuario,"label.fecha")%></div>
                        <div>
                            <div style="float: left;">
