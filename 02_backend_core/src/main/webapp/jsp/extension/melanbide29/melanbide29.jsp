	...
	var nombreModuloLicitacion = "<%=nombreModulo%>";
        ...
        function pulsarAltaContrato(){
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE29&operacion=cargarNuevoContrato&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),680,980,'no','no',function(result){
                    if (result != undefined){
                        if(result[0] == '0'){
                ...
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE29&operacion=cargarNuevoContrato&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),722,990,'no','no',function (result){
                    if (result != undefined){
                        if(result[0] == '0'){
                            recargarTabla(result);
                        }
        ...
        function pulsarModificarContrato(event){
            ...
            if(fila >= 0 && fila < listaContratos.length) {
                ...
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE29&operacion=cargarModificarContrato&tipo=0&numero=<%=numExpediente%>&idCon='+listaContratos[fila][0]+'&cerrado='+cerrado+'&control='+control.getTime(),650,980,'no','no',function(result){
                        if (result != undefined){
                            if(result[0] == '0'){
                                recargarTabla(result);
                            }
                    ...
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE29&operacion=cargarModificarContrato&tipo=0&numero=<%=numExpediente%>&idCon='+listaContratos[fila][0]+'&cerrado='+cerrado+'&control='+control.getTime(),692,990,'no','no',function(result){
                         if (result != undefined){
                            if(result[0] == '0'){
                                recargarTabla(result);
                            }
            ...
            <div style="clear: both;">
                <div>
                    <fieldset style="width: 97.5%; padding-top: 10px; margin-top: 10px;">
                        ...
                        <div id="contratos" align="center"></div>
