...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                <%
                if(consulta == true || (puestoConsulta != null && puestoConsulta.getCodResult() != null && puestoConsulta.getCodResult().equalsIgnoreCase(ConstantesMeLanbide39.CODIGO_RESULTADO_RENUNCIA)))
                {
                %>
            ...
            function guardar(){
                if(validarDatos()){
                    ...
                    var parametros = 'tarea=preparar&modulo=MELANBIDE39&operacion=guardarDatosContratacion&tipo=0&numero=<%=numExpediente%>'
        ...
        <div id="divCuerpo" class="contenidoPantalla" style="overflow-y: auto; padding: 10px;">
            <form  id="formNuevaOferta">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.fecha")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 90px; margin-left: 20px;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.causa")%>
                        </div>
                ...
                <fieldset  style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide39I18n.getMensaje(idiomaUsuario,"legend.justif.datosJustificacion")%></legend>
                    ...
                    <div class="lineaFormulario">   
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.minoracion")%>
                        </div>                             
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasTrabajados")%>
                        </div>                         
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasSegSoc")%>
                        </div>  
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionCC")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.coeficienteAplicado")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.segSocialEmpresa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salario")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionATEP")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcFogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcCoeficiente")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.fogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <!--div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.pocAportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;"><!--30%-->
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.aportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeSS")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 29%;">&nbsp;</div>
                        <div style="float: left; width: 30%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeTotal")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.dietasAbonadas")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.mesesExterior")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.gastosAbonados")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeBonificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 10%;">&nbsp;</div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeJustificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 13%;display: none;">
                            <%=meLanbide39I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salarioSub")%>
                        </div>                        
                ...
                <div class="botonera">
                        <input type="button" id="btnGuardar" name="btnGuardar" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="guardar();">
                        <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide39I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelar();">
