...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide39/FixedColumnsTable2.js"></script>
...
<script type="text/javascript">   
    ...
    function recargarTablaJustificacionesCpe(result){
        ...
        tabJustifCpe.addColumna('200','left',"<%= meLanbide39I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col1")%>");
        tabJustifCpe.addColumna('150','right',"<%= meLanbide39I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col2")%>");    
        tabJustifCpe.addColumna('150','right',"<%= meLanbide39I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col3")%>");   
        tabJustifCpe.addColumna('150','right',"<%= meLanbide39I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col4")%>");   
