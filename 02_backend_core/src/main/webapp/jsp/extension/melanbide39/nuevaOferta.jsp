        ...
        <script type="text/javascript">
           ...
           function cambioPais2(){
            ...
            function buscarTitulacion(id){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide39/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),520,960,'yes','no',function(result){
                    ...
                    lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide39/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),580,960,'yes','no',function(result){
                         if (result != undefined && result.length == 3){
                            document.getElementById('cod'+id).value = result[0];
                            var desc = result[1] != undefined && result[1] != '' ? result[1] : '';
                            desc += desc != '' && result[2] != undefined && result[2] != '' ? '-' : '';
