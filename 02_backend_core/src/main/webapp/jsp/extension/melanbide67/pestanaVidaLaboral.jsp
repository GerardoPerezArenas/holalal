...
<script type="text/javascript">
    ...
    function obtenerDatosVidaLaboralIntermediacion() {
        ...
        dataParameter.ejercicioHHFF = document.forms[0].numero.value.split("/")[0]; // N�mero de expediente
        dataParameter.procedimientoHHFF = document.forms[0].numero.value.split("/")[1]; // N�mero de expediente
