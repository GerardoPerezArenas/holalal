            ...
            function recargarTablaSubSolic(subSolic) {
              ...
              //  listaSubSolicTabla_titulos = new Array();
                ...
                for (var i = 0; i < subSolic.length; i++) {
                    fila = subSolic[i];
                    var fechaForma = new Date(fila.fecha);
                    listaSubSolic[i] = [fila.id, fila.estado, fila.desEstado, fila.organismo, fila.objeto, fila.importe.toString().replace(".",","), fila.fecha, fila.fechaStr];
                    listaSubSolicTabla[i] = [fila.id, fila.desEstado, fila.organismo, fila.objeto, fila.importe.toString().replace(".",","), fila.fechaStr];
                   // listaSubSolicTabla_titulos[i] = [fila.id, fila.desEstado, fila.organismo, fila.objeto, fila.importe.toString().replace(".",","), fila.fechaStr];
                }
                crearTablaSubSolic();
