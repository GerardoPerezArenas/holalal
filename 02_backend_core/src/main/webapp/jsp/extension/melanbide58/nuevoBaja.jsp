...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function desbloquearCamposBaja() {
            ...
            <form>
                <div style="width: 100%; padding: 10px; text-align: left;">
                    ...
                    <div class="lineaFormulario" style="width: 100%; float: left; margin-bottom: 10px">
                        ...
                        <div>
                            <div>
                                <input type="text" name="codListaCausas" id="codListaCausas" size="4"  maxlength="3" class="inputTextoObligatorio" value="" onkeyup="xAMayusculas(this);" />
                                <input type="text" name="descListaCausas"  id="descListaCausas" size="40" class="inputTexto" readonly="true" value="" />
