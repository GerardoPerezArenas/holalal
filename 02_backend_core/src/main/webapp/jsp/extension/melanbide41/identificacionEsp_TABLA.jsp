...
<div class="tab-page" id="tabPage411" style="width: 98%;">
    <div style="clear: both;">
        ...
        <div id="divGeneral" >     
            <div id="listaIdentificacionEsp" align="center"></div>
            <div>
...
<script type="text/javascript">
    ...
    tabIdentificacionEsp = new Tabla(true, '<%=descriptor.getDescripcion("buscar")%>', '<%=descriptor.getDescripcion("anterior")%>', '<%=descriptor.getDescripcion("siguiente")%>', '<%=descriptor.getDescripcion("mosFilasPag")%>', '<%=descriptor.getDescripcion("msgNoResultBusq")%>', '<%=descriptor.getDescripcion("mosPagDePags")%>', '<%=descriptor.getDescripcion("noRegDisp")%>', '<%=descriptor.getDescripcion("filtrDeTotal")%>', '<%=descriptor.getDescripcion("primero")%>', '<%=descriptor.getDescripcion("ultimo")%>', document.getElementById('listaIdentificacionEsp'), 870);
    tabIdentificacionEsp.addColumna('150', 'center', "<%=meLanbide41I18n.getMensaje(idiomaUsuario,"identificacionesp.tablaIdentificacionEsp.col1")%>");
