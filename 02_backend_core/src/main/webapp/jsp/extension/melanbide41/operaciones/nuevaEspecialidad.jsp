                ...
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=crearEspecialidad&tipo=0&numero=<%=numExpediente%>"
                                ...
                                + "&denominacion=" + document.getElementById('descListaCertificados').value.replace(/\r?\n|\r/g, " ").trim()
            ...
            <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta"  style="width: 220px; float: left;" >
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.especialidades.certificado")%>
                        </div>
                        <div style="float: left;">
                            <input type="text" name="codListaCertificados" id="codListaCertificados" size="12" maxlength="12" class="inputTexto" value="" onkeyup="xAMayusculas(this);" />
                        ...
                        <div style="width: 450px; float: left;">
                            ...
                            <div>
                                ...
                                <a href="" id="anchorPresencial" name="anchorPresencial" onclick="return false;">
                                    <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPresencial"
                                          name="botonPresencial" style="cursor:pointer;"></span>
                                </a>
                            </div>
                        </div>
                        <br>                
                        <div style="width: 450px; float: left;">
                            ...
                            <div>
                                ...
                                <a href="" id="anchorTeleformacion" name="anchorTeleformacion" onclick="return false;">
                                    <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonTeleformacion"
                                          name="botonTeleformacion" style="cursor:pointer;"></span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 450px;float: left;">
                            ...
                            <a href="" id="anchorAcreditado" name="anchorAcreditado" onclick="return false;">
                                <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonAcreditado"
                                      name="botonAcreditado" style="cursor:pointer;"></span>
                            </a>
                        </div>
                    </div>
                </div>
