            ...
            function guardarDatos() {
                ...
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=crearMaterial&tipo=0&numero=<%=numExpediente%>"
                                + "&cantidad=" + document.getElementById('cantidad').value
                                + "&denominacionET=" + document.getElementById('denominacionET').value.replace(/\r?\n|\r/g, " ").trim()
                                + "&idEpsol=<%=datoEspecialidad.getId()%>";

                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=modificarMaterial&tipo=0&numero=<%=numExpediente%>"
                    ...
                    try {
                        ...
                        if (codigoOperacion == "0") {
                            self.parent.opener.retornoXanelaAuxiliar(listaMaterial);
                            cerrarVentana();
            ...
            function validarDatos() {
                ...
                } else
                {
                    if (!validarNumerico(document.getElementById('cantidad'))) {
                        mensajeValidacion = '<%=meLanbide41I18n.getMensaje(idiomaUsuario, "material.msg.cantidad.errInteger")%>';
                        return false;
                    }
                }
            ...
            <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.material.nuevoMaterial")%>
                        </span>
                    </div>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.material.cantidad")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.material.denominacionET")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
