            ...
            function guardarDatos() {
                ...
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE41&operacion=modificarDisponibilidad&tipo=0&numero=<%=numExpediente%>"
                                ...
                                + "&propiedadce=" + document.getElementById('propiedadce').value.replace(/\r?\n|\r/g, " ").trim()
                                + "&situados=" + document.getElementById('situados').value.replace(/\r?\n|\r/g, " ").trim()
            ...
            <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.modifDisponibilidad")%>
                        </span>
                    </div>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.cpespecialidad")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.propiedadce")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.situados")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.supaulas")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="supaulas" name="supaulas" type="text" class="inputTexto" size="30" maxlength="200" 
                                       value="<%=datModif != null && datModif.getSupAulas() != null ? datModif.getSupAulas()  : ""%>" onblur="compruebaTamanoCampo(this, 200)"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.suptaller")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="suptaller" name="suptaller" type="text" class="inputTexto" size="30" maxlength="200" 
                                       value="<%=datModif != null && datModif.getSupTaller() != null ? datModif.getSupTaller()  : ""%>" onblur="compruebaTamanoCampo(this, 200)"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.supaulastaller")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="supaulastaller" name="supaulastaller" type="text" class="inputTexto" size="30" maxlength="200" 
                                       value="<%=datModif != null && datModif.getSupAulaTaller() != null ? datModif.getSupAulaTaller().toString()  : ""%>" onchange="compruebaTamanoCampo(this, 200);"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide41I18n.getMensaje(idiomaUsuario,"label.disponibilidad.supcampoprac")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input id="supcampoprac" name="supcampoprac" type="text" class="inputTexto" size="30" maxlength="200" 
                                       value="<%=datModif != null && datModif.getSupCampoPract() != null ? datModif.getSupCampoPract().toString()  : ""%>" onchange="compruebaTamanoCampo(this, 200);"/>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="botonera">
                        <input type="button" id="btnAceptarDisp" name="btnAceptar" class="botonGeneral" value="<%=meLanbide41I18n.getMensaje(idiomaUsuario, "btn.aceptar")%>" onclick="guardarDatos();">
                        <input type="button" id="btnCancelarDisp" name="btnCancelar" class="botonGeneral" value="<%=meLanbide41I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();">
                    </div>
                </div>
            </form>
        </div>
