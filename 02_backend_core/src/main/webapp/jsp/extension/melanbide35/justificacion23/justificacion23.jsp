...
<head>
    ...
    //Clase para internacionalizar los mensajes de la aplicación.
        ...
        String urlPestanaJustInsercionECA23 = (String)request.getAttribute("urlPestanaInserciones_JustificacionECA23");
        String urlPestanaJustPreparadoresECA23 = (String)request.getAttribute("urlPestanaPreparadores_JustificacionECA23");
        JustificacionECA23VO justificacion =(JustificacionECA23VO)request.getAttribute("justificacion");
        int numInsercionesJ = (Integer)request.getAttribute("numInsercionesJus");
        int numPreparadoresJ = (Integer)request.getAttribute("numPreparadoresJus");
        int numSeguimientosJ = (Integer)request.getAttribute("numSeguimientosJus");
            ...
            <fieldset id="totalesJus23" name="totalesJus23" style="margin-top: 15px; border-color: black;">
                ...
                <div class="lineaFormulario" style="padding-top: 15px;">
                    <div style="width: 30%; float: left; padding-left: 5%;">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="numInsercionesJus" name="numInsercionesJus" size="3" maxlength="3" style="text-align: center;" value="" class="inputTexto total"/>
                        </div>
                    </div> 
                    <div style="width: 30%; float: left;">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="numPreparadoresJus" name="numPreparadoresJus" size="3" maxlength="3" style="text-align: center;" value="" class="inputTexto total"/>
                        </div>
                    </div> 
                    <div style="width: 30%; float: left;">
                        <div style="width: 50%; float: left; text-align: center; text-transform: uppercase" class="etiqueta">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="numSeguimientosJus" name="numSeguimientosJus" size="3" maxlength="3" style="text-align: center;" value="" class="inputTexto total"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="lineaFormulario" style="padding-top: 15px;">
                    <div style="width: 30%; float: left; padding-left: 17%;">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="totInsercionesJus" name="totInsercionesJus" size="10" maxlength="10" style="text-align: right;" value="" class="inputTexto total"/>
                        </div>
                    </div> 
                    <div style="width: 30%; float: left;">
                        <div style="width: 50%; float: left; text-align: center; text-transform: uppercase" class="etiqueta">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="totSeguimientosJus" name="totSeguimientosJus" size="10" maxlength="10" style="text-align: right;" value="" class="inputTexto total"/>
                        </div>
                    </div>                    
                </div>
                ...
                <div class="lineaFormulario" style="padding-top: 15px;">
                    <div style="width: 30%; float: left; padding-left: 17%;">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="importeEcaJus" name="importeEcaJus" size="10" maxlength="10" style="text-align: right;" value="" class="inputTexto total"/>
                        </div>
                    </div> 
                    <div style="width: 30%; float: left;">
                        <div style="width: 50%; float: left; text-align: center; text-transform: uppercase" class="etiqueta">
                        ...
                        <div style="width: 50%;  float: left;">
                            <input disabled type="text" id="importeValidadoJus" name="importeValidadoJus" size="10" maxlength="10" style="text-align: right;" value="" class="inputTexto total"/>
                        </div>		
                    </div>                     
                </div>

            </fieldset>
            <div id="tab-panel-35_jus" class="tab-pane" style="margin-top: 15px; float: left;" align="center"></div>
            <script type="text/javascript">
                tp35_jus = new WebFXTabPane(document.getElementById("tab-panel-35_jus"));
                tp35_jus.selectedIndex = 0;
            </script>
            <div class="tab-page" id="tabPage35_jus_2" style="height: 480px; width: 98%;">
                <h2 class="tab" id="pestana35_jus_2" style="margin-left:10px;"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion23.inserciones.tituloPestana")%></h2>
                ...
                <div style="clear: both; padding-top: 14px;">
                    <jsp:include page="<%=urlPestanaJustInsercionECA23%>" flush="true"/>
                </div>
            </div>
            <div class="tab-page" id="tabPage35_jus_3" style="height: 480px; width: 98%;">
                <h2 class="tab" id="pestana35_jus_3"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion23.preparadores.tituloPestana")%></h2>
                <script type="text/javascript">tp35_jus.addTabPage(document.getElementById("tabPage35_jus_3"));</script>
                <div style="clear: both; padding-top: 14px;">
                    <jsp:include page="<%=urlPestanaJustPreparadoresECA23%>" flush="true"/>
                </div>
            </div>
        </div>
    </div>
    <script  type="text/javascript">
        document.getElementById('numInsercionesJus').value = numInsercionesJ.toString();
        document.getElementById('numPreparadoresJus').value = numPreparadoresJ.toString();
        document.getElementById('numSeguimientosJus').value = numSeguimientosJ.toString();

        document.getElementById('totInsercionesJus').value = totInserciones.toString() + ' \u20ac';
        document.getElementById('totSeguimientosJus').value = totSeguimientos.toString() + ' \u20ac';
        document.getElementById('importeEcaJus').value = impEca.toString() + ' \u20ac';
        document.getElementById('importeValidadoJus').value = impValidado.toString() + ' \u20ac';
        <%                            
