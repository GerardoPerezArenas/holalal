...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide35.vo.justificacion.EcaVisProspectoresVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            if(consulta)
            {
                tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.consultaVisita.tituloPagina");
            }
            else
            {
                if(visModif != null)
                {
                    tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.modifVisita.tituloPagina");
                }
                else
                {
                    tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.prospectores.nuevaVisita.tituloPagina");
                }
            }
        ...
        <script type="text/javascript">
           ...
           function guardarVisita(){
                if(validarDatosVisita()){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=guardarVisitaProspector&tipo=0&numero=<%=numExpediente%>'
                    ...
                    for(j=0;hijos!=null && j<hijos.length;j++){
                        ...
                        if(codigoOperacion=="0"){
                            self.parent.opener.retornoXanelaAuxiliar(listaProspectores);
                            ...
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.NifProspectoIncorrecto")%>');
                        }else{
                            jsp_alerta("A",'<%=meLanbide35I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        }//if(
                    }
            ...
            function validarDatosVisita(){
                ...
                if(empresa == null || empresa == ''){
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.todosCamposAsteriscoOblig")%>';
                    return false;
                }  
                        ...
                        //no es cif miramos si nif (autonomo)
                         if(!validarNIFEca(document.getElementById('cif'))){
                             ...
                             if(mensajeValidacion == '')
                                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.cifIncorrecto")%>';
                             correcto = false;
                         }else{
                ...
                if(!comprobarCaracteresEspecialesEca(empresa)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.empresaCaracteresEspeciales")%>';
                    correcto = false;
                }else{
                ...
                if(!existeCodigoCombo(sector, codSector)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.codigoSectorNoExiste")%>';
                }else{
                ...
                if(direccion != null && direccion != ''){
                    if(!comprobarCaracteresEspecialesEca(direccion)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.direccionCaracteresEspeciales")%>';
                    }else{
                ...
                if(cp != null && cp != ''){
                    try{
                        if(!validarNumericoEca(document.getElementById('cpostal'))){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.cpostalIncorrecto")%>';
                        }else{
                ...
                if(localidad != null && localidad != ''){
                    if(!comprobarCaracteresEspecialesEca(localidad)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.localidadCaracteresEspeciales")%>';
                    }else{
                ...
                if(provincia != null && provincia != ''){
                    if(!existeCodigoCombo(provincia, codProvincia)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.codigoProvinciaNoExiste")%>';
                    }else{
                ...
                if(personaContacto != null && personaContacto != ''){
                    if(!comprobarCaracteresEspecialesEca(personaContacto)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.perscontCaracteresEspeciales")%>';
                    }else{
                ...
                if(puesto != null && puesto != ''){
                    if(!comprobarCaracteresEspecialesEca(puesto)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.puestoCaracteresEspeciales")%>';
                    }else{
                ...
                if(email != null && email != ''){
                    try{
                        if(!comprobarCaracteresEspecialesEca(email)){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.emailCaracteresEspeciales")%>';
                        }else{
                            if(!validarEmailEca(email)){
                                correcto = false;
                                document.getElementById('email').style.border = '1px solid red';
                                if(mensajeValidacion == '')
                                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.emailIncorrecto")%>';
                            }else{
                ...
                if(telefono != null && telefono != ''){
                    try{
                        if(!validarNumericoEca(document.getElementById('telefono'))){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.telefonoIncorrecto")%>';
                        }else{
                ...
                if(numTrab != null && numTrab != ''){
                    try{
                        if(!validarNumericoEca(document.getElementById('numTrab'))){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.numtrabIncorrecto")%>';
                        }else{
                ...
                if(numTrabDisc != null && numTrabDisc != ''){
                    try{
                        if(!validarNumericoEca(document.getElementById('numTrabDisc'))){
                            ...
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.numtrabdiscIncorrecto")%>';
                        }else{
                ...
                if(lismi != null && lismi != ''){
                    if(!existeCodigoCombo(lismi, codLismi)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.codigoLismiNoExiste")%>';
                    }else{
                ...
                if(!existeCodigoCombo(result, codResultado)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.codigoResultadoNoExiste")%>';
                }else{
                ...
                if(!validarFechaEca(document.forms[0], document.getElementById('fecVisita'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.justificacion.visita.fechaVisitaIncorrecto")%>';
                    correcto = false;
                }else{ 
                    ...
                    if(feVisita != null && feVisita != ''){
                        ...
                        if(anoVisita != anoExp){
                            correcto = false;
                            document.getElementById('fecVisita').style.border = '1px solid red';
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.justificacion.visita.fechaVisita")%>';
                        }else{
                ...
                if(obs != null && obs != ''){
                    if(!comprobarCaracteresEspecialesEca(obs)){
                        ...
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.observacionesCaracteresEspeciales")%>';
                    }else{
                        if(obs.length > 200){
                            correcto = false;
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.justificacion.visita.observacionesDemasiadoLargo")%>';
                        }else{
                ...
                if(!validarCif(document.getElementById('nifProspector'))){
                    //no es cif miramos si nif (autonomo)
                     if(!validarNIFEca(document.getElementById('nifProspector'))){
                         ...
                         if(mensajeValidacion == '')
                                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.justificacion.visita.nifIncorrectoPros")%>';
                         correcto = false;
                     }else{
            ...
            <div style="width: 98%; padding: 10px; text-align: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 36px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.cif")%>
                    </div>
                    <div style="width: 125px; float: left;">
                        <input type="text" id="cif" name="cif" size="10" maxlength="10" class="inputTexto"/>
                    </div>
                    <div style="width: 100px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.empresa")%><font color="red">*</font>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 94px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.sector")%><font color="red">*</font>
                    </div>
                    <div style="width: 130px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descSector" name="descSector" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorSector" name="anchorSector" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonSector" name="botonSector" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.direccion")%>
                    </div>
                    <div style="width: 540px; float: left;">
                        <input type="text" id="direccion" name="direccion" size="83" maxlength="200" class="inputTexto"/>
                    </div>
                    <div style="width: 90px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.cPostal")%>
                    </div>
                    <div style="width: 80px; float: left;">
                ...
                <div class="lineaFormulario">
                     ...
                     <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.localidad")%>
                    </div>
                    <div style="width: 350px; float: left;">
                        <input type="text" id="localidad" name="localidad" size="50" maxlength="100" class="inputTexto"/>
                    </div>
                    <div style="width: 90px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.provincia")%>
                    </div>
                    <div style="width: 100px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descProvincia" name="descProvincia" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorProvincia" name="anchorProvincia" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonProvincia" name="botonProvincia" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>                
                </div>
               <div class="lineaFormulario">
                    <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.personaContacto")%>
                    </div>
                    <div style="width: 350px; float: left;">
                        <input type="text" id="personaContacto" name="personaContacto" size="50" maxlength="100" class="inputTexto"/>
                    </div>
                    <div style="width: 90px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.cargo")%>
                    </div>
                    <div style="width: 80px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.email")%>
                    </div>
                    <div style="width: 540px; float: left;">
                        <input type="text" id="email" name="email" size="83" maxlength="100" class="inputTexto"/>
                    </div>
                    <div style="width: 74px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.telefono")%>
                    </div>
                    <div style="width: 80px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.numtrab")%>
                    </div>
                    ...
                    <div style="width: 180px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.numtrabdisc")%>
                    </div>
                    <div style="width: 80px; float: left;">
                ...
                <div class="lineaFormulario"> 
                     <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.cumple")%>
                    </div>
                    <div style="width: 240px; float: left;">                    
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descLismi" name="descLismi" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorLismi" name="anchorLismi" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonLismi" name="botonLismi" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div> 
                    <div style="width: 100px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.resultado")%><font color="red">*</font>
                    </div>
                    <div style="width: 240px; float: left;">                      
                        <div style="width: 220px; float: left;">
                            ...
                            <input id="descResultado" name="descResultado" type="text" class="inputTexto" size="22" readonly >
                             <a id="anchorResultado" name="anchorResultado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonResultado" name="botonResultado" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                       </div> 
                </div>
                ...
                <div class="lineaFormulario">                         
                    <div style="width: 80px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.fecvisita")%><font color="red">*</font>
                    </div>
                    <div style="width: 240px; float: left;">
                         <input type="text" class="inputTxtFecha" size="10" maxlength="10" id="fecVisita" name="fecVisita" onkeyup="return SoloCaracteresFecha(this);" onblur=" javascript:return comprobarFechaEca(this, '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>');" onfocus="this.select();"/>
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaVisita(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFecVisita" name="calFecVisita" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.fecvisita")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>   
                     <div style="width: 100px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.observaciones")%>
                    </div>
                ...
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.visita.nifProspector")%><font color="red">*</font>
                    </div>
               ...
               <div class="botonera" style="padding-top: 20px;">
                    <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.aceptar")%>" onclick="guardarVisita();">
