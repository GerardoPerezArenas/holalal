            ...
            <div style="width: 98%; padding: 10px; text-align: left;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 130px; float: left;">   
                        ...
                        <input id="descTipoDisc" name="descTipoDisc" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorTipoDisc" name="anchorTipoDisc" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonTipoDisc" name="botonTipoDisc" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                     <div style="width: 130px; float: left;">
                    ...
                    <div style="width: 130px; float: left;">
                        ...
                        <input id="descGravedad" name="descGravedad" type="text" class="inputTexto" size="22" readonly >
                         <a id="anchorGravedad" name="anchorGravedad" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGravedad" name="botonGravedad" style="cursor:hand;" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="width: 130px; float: left;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 200px; float: left; margin-left: 5px">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.justificacion.seguimientos.finContratoDespido")%>
                    </div>
