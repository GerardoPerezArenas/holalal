...
<script type="text/javascript">
    ...
    function recargarTablaPreparadoresJustificacionEca(result, actualizarOtrasPestanas){
        ...
        for(var i = 1;i< result.length; i++){
            ...
            listaPreparadores_jus[i-1] = [fila[0],fila[1],fila[2],fila[3],fila[4],fila[5],fila[6],fila[7],fila[8],fila[9],
                                            ...
                                            fila[20],fila[21],fila[22],fila[23],fila[24],fila[25],fila[26],fila[27],fila[28],fila[29],fila[30],fila[31]];
    ...
    //}
    tabPreparadores_jus.addColumna('250','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>');
    ...
    function pulsarNuevoPreparadorJustificacionEca(){
        if(tabPreparadores_jus.selectedIndex != -1) {
            if(listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] == undefined || listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] == null || listaPreparadores_jus[tabPreparadores_jus.selectedIndex][31] != '1')
            {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&idPrepSustituir='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),400,950,'no','no', function(result){
					if (result != undefined){
                    				if(result[0] == '0'){								
    ...
    function pulsarModifPreparadorJustificacionEca(){                
        if(tabPreparadores_jus.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){                
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorJustificacion&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModificar='+listaPreparadores_jus[tabPreparadores_jus.selectedIndex][0]+'&control='+control.getTime(),400,950,'no','no', function(result){
					if (result != undefined){
                    				if(result[0] == '0'){								
							recargarTablaPreparadoresJustificacionEca(result,true);
						}
    ...
    function cargarSeguimientosPrepEca(preparador){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),605,950,'no','no', function(result){
    ...
    if (sexo==null) sexo="";
        ...
        var result = null;       
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&idPrep='+preparador+'&colectivo='+colectivo+'&sexo='+sexo+'&tiposeg=1&control='+control.getTime(),605,950,'no','no', function(result){
					if(result != undefined && result == true){								
						var lista = getListaPreparadoresJustificacionEca();
            					recargarTablaPreparadoresJustificacionEca(lista, true)
					}
    ...
    function cargarTodosSeguimientosPrep(){        
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=0&opcion='+opcion+'&control='+control.getTime(),580,920,'no','no', function(result){
					if(result != undefined && result == true){								
						var lista = getListaPreparadoresJustificacionEca();
            					recargarTablaPreparadoresJustificacionEca(lista, true)
					}
    ...
    function cargarTodasInsercionesPrep(){   
       var control = new Date();
        ...
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSeguimientos&tipo=0&numero=<%=numExpediente%>&tiposeg=1&opcion='+opcion+'&control='+control.getTime(),590,900,'no','no', function(result){
					if(result != undefined && result == true){								
						var lista = getListaPreparadoresJustificacionEca();
            					recargarTablaPreparadoresJustificacionEca(lista, true)
					}
