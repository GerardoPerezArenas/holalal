...
<%
 ...
 String css = "";
    ...
    if(consulta)
    {
        tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.consultaProspector.tituloPagina");
    }
    else
    {
        if(prospectorModif != null)
        {
            tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.modifProspector.tituloPagina");
        }
        else
        {
            tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.nuevoProspector.tituloPagina");
        }
    }
...
<script type="text/javascript">
    ...
    function guardar(){
        if(validarDatos()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=guardarProspectorSolicitud&tipo=0&numero=<%=numExpediente%>'
            ...
            for(j=0;hijos!=null && j<hijos.length;j++){
                ...
                if(codigoOperacion=="0"){
                    ...
                    hc *= 0.5;
                    if(hdECA < hc){                                                
                            msj50 = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasDedicacionEca50HorasContratoTexto")%>';
                            //msj50 = 'El número de Horas Dedicación ECA debe ser al menos el 50 por ciento del número de Horas Contrato.';
                    }
                    msj50+='<%=meLanbide35I18n.getMensaje(idiomaUsuario,"msg.datosGuardadosOK")%>';
                    //alert(msj50);
                    jsp_alerta("A",msj50);
    ...
    function validarDatos(){
        ...
        if(nif == null || nif == ''){
            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nifVacio")%>';
            return false;
        }
        var nomApel = document.getElementById('nomApel').value;
        if(nomApel == null || nomApel == ''){
            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nomApelVacio")%>';
            return false;
        }
        ...
        if(nuevo){
            if(!validarNIFEca(document.getElementById('nif'))){
                ...
                if(mensajeValidacion == ''){
                    ...
                    if(letra != ''){
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nifIncorrecto")%>'+' '+'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.letraNifDeberiaSer")%>'+letra;
                    }else{
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nifIncorrecto")%>';
                    }
                }
                correcto = false;
            }else{
        ...
        if(!comprobarCaracteresEspecialesEca(nomApel)){
            ...
            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nomApelCaracteresEspeciales")%>';
            return false;
        }else{
        ...
        if(nuevo){
            if(!validarFechaEca(document.forms[0], document.getElementById('fechaInicio'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.fechaIniIncorrecto")%>';
                correcto = false;
            }else{
            ...
            if(!validarFechaEca(document.forms[0], document.getElementById('fechaFin'))){
                ...
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.fechaFinIncorrecto")%>';
                correcto = false;
            }else{
            ...
            if(correcto){
                ...
                if(feIni != '' && feFin != ''){
                    ...
                    if(result < 0){
                        ...
                        document.getElementById('fechaFin').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.fechaIniPosteriorFin")%>';
                        correcto = false;
                    }
                    else{
                        if(anoIni != '<%=anoExpediente%>'){
                            ...
                            document.getElementById('fechaInicio').style.border = '1px solid red';
                            if(mensajeValidacion == '')
                                mensajeValidacion = '<%=String.format(meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.prospectores.fechasAno"), anoExpediente)%>';
                        }else{
                            document.getElementById('fechaInicio').removeAttribute('style');
                        }
        ...
        if(document.getElementById('horasAnualesJC').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('horasAnualesJC'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasAnualesJCIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('horasContrato').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('horasContrato'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasContratoIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('horasDedicacionEca').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('horasDedicacionEca'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasDedicacionEcaIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            if(hajc < hc){
                ...
                document.getElementById('horasAnualesJC').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasAnualesJCMenorHorasContrato")%>';
            }
            else{
                document.getElementById('horasAnualesJC').removeAttribute('style');
            }
            if(hc < hdECA){
                ...
                document.getElementById('horasContrato').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasContratoMenorHorasDedicacionEca")%>';
            }else{
                document.getElementById('horasContrato').removeAttribute('style');
            }
        }
        ...
        /*if(correcto && nuevo){
            ...
            if(hdECA < hc){
                ...
                document.getElementById('horasDedicacionEca').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%//=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.horasDedicacionEca50HorasContrato")%>';
            }else{
                document.getElementById('horasDedicacionEca').removeAttribute('style');
            }
        }*/
        ...
        if(document.getElementById('costesSalarialesSSJor').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSJor'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costesSSJorIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('costesSalarialesSSPorJor').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSPorJor'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costesSSPorJorIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('costesSalarialesSSEca').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('costesSalarialesSSEca'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costesSSEcaIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            if(cssJC < cssPorJor){
                ...
                document.getElementById('costesSalarialesSSJor').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costesSalarialesJorMenorCostesSalarialesPorJor")%>';
            }
            else{
                document.getElementById('costesSalarialesSSJor').removeAttribute('style');
            }
            if(cssPorJor < cssECA){
                ...
                document.getElementById('costesSalarialesSSPorJor').style.border = '1px solid red';
                if(mensajeValidacion == '')
                    mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costesSalarialesPorJorMenorCostesSalarialesEca")%>';
            }else{
                document.getElementById('costesSalarialesSSPorJor').removeAttribute('style');
            }
        }
        ...
        if(document.getElementById('visitas').value != ''){
            try{
                if(!validarNumericoEca(document.getElementById('visitas'))){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.visitasIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('visitasImp').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('visitasImp'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.visitasImpIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('coste').value != ''){
            try{
                if(!validarNumericoDecimalEca(document.getElementById('coste'), 8, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.costeIncorrecto")%>';
                }else{
        ...
        if(correcto && nuevo){
            if(document.getElementById('visitas').value != ''){
                ...
                try
                {
                    ...
                    if(numVisitas < minVisitas || numVisitas > maxVisitas){
                        ...
                        document.getElementById('visitas').style.border = '1px solid red';
                        if(mensajeValidacion == ''){
                            var texto = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.prospectores.visitasFueraRangoJS")%>';
            ...
            if(document.getElementById('visitasImp').value != ''){
                ...
                if(visitasImp != importeCalculado){
                    ...
                    document.getElementById('visitasImp').style.border = '1px solid red';
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.prospectores.importeTotalVisitasIncorrecto")%>';
                }else{
                    document.getElementById('visitasImp').removeAttribute('style');
                }
                ...
                if(document.getElementById('coste').value != ''){
                    ...
                    if(coste > minimo){
                        ...
                        document.getElementById('coste').style.border = '1px solid red';
                        if(mensajeValidacion == '')
                            mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "validaciones.solicitud.prospectores.importeSolicitadoIncorrecto")%>';
                    }else{
                        document.getElementById('coste').removeAttribute('style');
                    }
                }
    ...
    function actualizarMinimoVisitas(){
        try{
            var minVisitas = getMinVisitas();
            var texto = '<%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.visitasJS")%>';
            texto = reemplazarTextoEca(texto, /XX/g, ''+minVisitas);
    ...
    function verComparacionProspector(){        
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=compararDatosProsSol&tipo=0&numero=<%=numExpediente%>&idPros=<%=prospectorModif != null && prospectorModif.getSolProspectoresCod() != null ? prospectorModif.getSolProspectoresCod() : ""%>&control='+control.getTime(),580,850,'no','no', function(){
		});
            }else{
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=compararDatosProsSol&tipo=0&numero=<%=numExpediente%>&idPros=<%=prospectorModif != null && prospectorModif.getSolProspectoresCod() != null ? prospectorModif.getSolProspectoresCod() : ""%>&control='+control.getTime(),580,870,'no','no', function(){
		});
            }                   
    }
        ...
        <div style="width: 100%; padding: 10px; text-align: left;">
            ...
            <div class="lineaFormulario" id="divProsOrigen" style="height: 30px; margin-top: 10px; margin-bottom: 10px;">
                <div style="width: 120px; float: left;">
                    <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.prospectorOrigen")%>
                </div>
            ...
            <fieldset style="width: 94%;">    
                ...
                <div class="lineaFormulario">
                    <div style="width: 36px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.nif")%><font color="red">*</font>
                    </div>
                    <div style="width: 101px; float: left;">
                        <input type="text" id="nif" name="nif" size="10" maxlength="10" class="inputTexto"/>
                    </div>
                    <div style="width: 140px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.nomApel")%><font color="red">*</font>
                    </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 131px; float: left;">
                        ...
                        <A id="btnFechaInicio" href="javascript:calClick(event);" onclick="mostrarCalFechaInicio(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaInicio" name="calFechaInicio" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.fechaInicio")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                    ...
                    <div style="width: 131px; float: left;">
                        ...
                        <A id="btnFechaFin" href="javascript:calClick(event);" onclick="mostrarCalFechaFin(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaFin" name="calFechaFin" alt="<%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.fechaFin")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                </div>
                <div class="lineaFormulario">
                    ...
                    <div style="width: 108px; float: left;">
                        <input type="text" id="horasAnualesJC" name="horasAnualesJC" size="11" maxlength="9" class="inputTexto textoNumerico"                            
                               onkeyup="calcularCostesSalarialesSSJC();actualizarMinimoVisitas();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularCostesSalarialesSSJC();actualizarMinimoVisitas();ajustarDecimalesImportes();"/>
                    </div>
                    ...
                    <div style="width: 108px; float: left;">
                        <input type="text" id="horasContrato" name="horasContrato" size="11" maxlength="9" class="inputTexto textoNumerico" 
                               onkeyup="calcularCostesSalarialesPorJor();actualizarMinimoVisitas();FormatNumber(this.value, 8, 2, this.id);"
                               onblur="calcularCostesSalarialesPorJor();actualizarMinimoVisitas();ajustarDecimalesImportes();"/>
                    </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 117px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.costesSalarialesSSPorJor")%>
                    </div>
                    <div style="width: 108px; float: left;">
                    ...
                    <div style="width: 157px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.costesSalarialesSSEca")%>
                    </div>
                    <div style="width: 108px; float: left;">
                ...
                <div class="lineaFormulario">
                    <div style="width: 229px; float: left;">
                        <label id="lblVisitas"><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.visitas")%></label>
                    </div>
                    <div style="width: 108px; float: left;">
                 ...
                 <div class="lineaFormulario">
                    <div style="width: 162px; float: left;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.impteConcedido")%>
                    </div>
                    <div style="width: 108px; float: left;">
            ...
            <div class="lineaFormulario" id="divProsSustituto" style="height: 30px; margin-top: 10px; margin-bottom: 10px;">
                <div style="width: 120px; float: left;">
                    <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.solicitud.prospectores.prospectorSustituto")%>
                </div>
                <div style="width: 85px; float: left;">
            ...
            <div class="botonera" style="padding-top: 20px;">
                ...
                <input type="button" id="btnComparacion" name="btnAceptar" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.comparacion")%>" onclick="verComparacionProspector();">
            </div>
        </div>
    </form>
