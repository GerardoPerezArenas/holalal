...
<script type="text/javascript">
    ...
    function verComparacion(){        
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=compararDatosPrepSol&tipo=0&numero=<%=numExpediente%>&idPrep=<%=preparadorModif != null && preparadorModif.getSolPreparadoresCod() != null ? preparadorModif.getSolPreparadoresCod() : ""%>&control='+control.getTime(),760,850,'no','no', function(){
		});
            }else{
