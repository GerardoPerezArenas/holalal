...
<script type="text/javascript">
    ...
    function recargarTablaPreparadoresSolicitudEca(result, actualizarOtrasPestanas){
        ...
        //}
        tabPreparadores_sol.addColumna('250','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2.title")%>');
        tabPreparadores_sol.addColumna('50','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4.title")%>');
        tabPreparadores_sol.addColumna('50','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5.title")%>');
        tabPreparadores_sol.addColumna('60','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col6")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col6.title")%>');
        tabPreparadores_sol.addColumna('60','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col7")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col7.title")%>');
        tabPreparadores_sol.addColumna('60','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col8")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col8.title")%>');
        tabPreparadores_sol.addColumna('70','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9.title")%>');
        tabPreparadores_sol.addColumna('70','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col10")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0.title")%>');
        tabPreparadores_sol.addColumna('70','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11.title")%>');
        ...
        tabPreparadores_sol.addColumna('60','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col28")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col28.title")%>');
        ...
        tabPreparadores_sol.scrollWidth = 2250;
    ...
    function pulsarNuevoPreparadorSolicitudEca(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion=nuevo&control='+control.getTime(),600,850,'no','no', function(result){
					if (result != undefined){								
    ...
    function pulsarSustituirPreparadorSolicitudEca(){
        if(tabPreparadores_sol.selectedIndex != -1) {
            if(listaPreparadores_sol[tabPreparadores_sol.selectedIndex][31] == undefined || listaPreparadores_sol[tabPreparadores_sol.selectedIndex][31] == null || listaPreparadores_sol[tabPreparadores_sol.selectedIndex][31] != '1')
            {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarSustituirPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&idPrepSustituir='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),600,850,'no','no', function(result){
					if (result != undefined){
                    				if(result[0] == '0'){								
							recargarTablaPreparadoresSolicitudEca(result,true);
						}
    ...
    function pulsarModifPreparadorSolicitudEca(){
        if(tabPreparadores_sol.selectedIndex != -1) {
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE35&operacion=cargarNuevoPreparadorSolicitud&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idPrepModif='+listaPreparadores_sol[tabPreparadores_sol.selectedIndex][0]+'&control='+control.getTime(),630,850,'no','no', function(result){
					if (result != undefined){                    											
						recargarTablaPreparadoresSolicitudEca(result,true);
					}
				});
...
<script type="text/javascript">
    ...
    %>
        ...
        listaPreparadores_sol[<%=i%>][31] = '<%=act.getSolPreparadorOrigen() != null ? "1" : "0"%>';
    ...
    //}
    tabPreparadores_sol.addColumna('250','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col2.title")%>');
    tabPreparadores_sol.addColumna('80','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col4.title")%>');
    tabPreparadores_sol.addColumna('80','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col5.title")%>');
    ...
    tabPreparadores_sol.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col9.title")%>');
    tabPreparadores_sol.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col10")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col0.title")%>');
    tabPreparadores_sol.addColumna('100','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col11.title")%>');
    tabPreparadores_sol.addColumna('70','right','<%=String.format(meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col12"), anoExpediente)%>','<%=String.format(meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col12.title"), anoExpediente)%>');
    tabPreparadores_sol.addColumna('80','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col13")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col13.title")%>');
    tabPreparadores_sol.addColumna('40','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col14")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col14.title")%>');
    tabPreparadores_sol.addColumna('40','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col15")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col15.title")%>');
    tabPreparadores_sol.addColumna('50','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col16")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col16.title")%>');
    tabPreparadores_sol.addColumna('40','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col17")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.solicitud.preparadores.tabla.col17.title")%>');
    ...
    /*if(haySustitutos){
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            tabPreparadores_sol.scrollWidth = 2130;
        }else{
            tabPreparadores_sol.scrollWidth = 2430;
        }
    }else{
        if(navigator.appName.indexOf("Internet Explorer")!=-1){
            tabPreparadores_sol.scrollWidth = 2030;
        }else{
            tabPreparadores_sol.scrollWidth = 2330;
        }
    }*/
    tabPreparadores_sol.scrollWidth = 2250;
    tabPreparadores_sol.dblClkFunction = 'dblClckTablaPreparadoresSolicitud';
