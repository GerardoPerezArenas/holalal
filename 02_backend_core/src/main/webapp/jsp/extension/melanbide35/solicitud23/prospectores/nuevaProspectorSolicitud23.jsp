...
<script type="text/javascript">
    ...
    function guardar() {
        if (validarDatos()) {
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE35&operacion=guardarProspectorSolicitud23&tipo=0&numero=<%=numExpediente%>'
    ...
    function validarDatos() {
        ...
        if (document.getElementById('nombre').value != '') {
            ...
            if (mensajeValidacion == '')
                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.nombre")%>';
        }
        if (document.getElementById('dni').value != '') {
            ...
            if (mensajeValidacion == '')
                mensajeValidacion = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "msg.solicitud.prospectores.dni")%>';
        }
        return correcto;
    }
</script>
    ...
    <form>
        ...
        <div style="width: 100%; padding: 10px; text-align: left;">
            ...
            <fieldset style="width: 94%;">    
                            <legend><%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.inserciones.prospector")%></legend>
