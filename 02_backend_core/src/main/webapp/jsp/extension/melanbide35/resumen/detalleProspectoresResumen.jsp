...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide35.vo.resumen.FilaEcaResProspectoresVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            String tituloPagina = meLanbide35I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.prospectores.tituloPagina");
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <form>
            <div style="width: 95%; padding: 0px; text-align: left;">
                ...
                <div class="sub3titulo" style="clear: both; text-align: left;height:18px;">
                    <span>
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.prospectores.detalleProspectores")%>
                    </span>
                </div>
                ...
                <div class="lineaFormulario" style="height: 50px;">
                    ...
                    <div style="width: auto; display: inline; float: right;">
                        <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.prospectores.totalPagar")%>
                        <input id="totalPagar" name="totalPagar" type="text" size="10" class="inputTexto textoNumerico readOnly" disabled="true" maxlength="11">
                    </div>
                </div>
                <div class="botonera">
                    <input type="button" id="btnCerrarDetallePros" name="btnCerrarDetallePros" class="botonGeneral" value="<%=meLanbide35I18n.getMensaje(idiomaUsuario, "btn.general.cerrar")%>" onclick="cerrarVentana();">
                </div>
            </div>
        </form>
    </body>
    ...
    <script type="text/javascript">
        ...
        tabDetalle_pros.addColumna('115','left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col0")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col0.title")%>');
        ...
        tabDetalle_pros.addColumna(anchoColumnaNombre,'left','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col1")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col1.title")%>');
        ...
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col2")%>'
        +       '</td>'
        +   '</tr>'
        +   '<tr>'
        ...
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col2.subcol0")%>'
        +       '</td>'
        +       '<td style="text-align: center; border-top: none; border-right: 1px solid #ffffff; border-left: none; border-bottom: none;" class="inner scrollCol xCabecera">'
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col2.subcol1")%>'
        +       '</td>'
        ...
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col2.subcol2")%>'
        +       '</td>'
        +   '</tr>'
        +'</table>';
        
        tabDetalle_pros.addColumna('210','right',col2,'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col2.title")%>');
        ...
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3")%>'
        +       '</td>'
        +   '</tr>'
        +   '<tr>'
        +       '<td style="text-align: center; border-top: none; border-right: 1px solid #ffffff; border-left: none; border-bottom: none;" class="inner scrollCol xCabecera">'
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.subcol0")%>'
        +       '</td>'
        +       '<td style="text-align: center; border-top: none; border-right: 1px solid #ffffff; border-left: none; border-bottom: none;" class="inner scrollCol xCabecera">'
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.subcol1")%>'
        +       '</td>'
        +       '<td style="text-align: center; border-top: none; border-right: 1px solid #ffffff; border-left: none; border-bottom: none;" class="inner scrollCol xCabecera">'
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.subcol2")%>'
        +       '</td>'
        +       '<td style="text-align: center; border-top: none; border-right: none; border-left: none; border-bottom: none;" class="inner scrollCol xCabecera">'
        +           '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.subcol3")%>'
        +       '</td>'
        +   '</tr>'
        +'</table>';
        tabDetalle_pros.addColumna('250','right',col3,'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col3.title")%>');
        tabDetalle_pros.addColumna('127','right','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col4")%>','<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.tabla.col4.title")%>');
        ...
        %>
            ...
            titulosCol2 = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.cSal")%>:\r\n\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.cSal.solic")%>: <%=act.getGastosSalarialesSolicitados()%>\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.cSal.conc")%>: <%=act.getGastosSalarialesConcedidos()%>\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.cSal.justif")%>: <%=act.getGastosSalarialesJustificados()%>\r\n';
                                          
            titulosCol3 = '<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.visitas")%>:\r\n\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.visitas.conc")%>: <%=act.getVisitasConcedidas()%>\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.visitas.justif")%>: <%=act.getVisitasJustificadas()%>\r\n'
                         +'<%=meLanbide35I18n.getMensaje(idiomaUsuario, "label.resumen.detalle.prospectores.titulos.visitas.coste")%>: <%=act.getImporteVisitas()%>\r\n';
        ...
        document.getElementById('lblNumProspectores').innerText = numProspectores+' <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.resumen.detalle.prospectores.numProspectores")%>';
        if(!pagarError){
