...
<html>
    <head>
        ...
        <%
            JusSeguimientosECA23VO datModif = new JusSeguimientosECA23VO();
            ...
            nifPreparador = (String)request.getParameter("nifPreparador");
            int idiomaUsuario = 1;
            int apl = 5;
            String css = "";
            try
            {
                ...
                {
                    datModif = (JusSeguimientosECA23VO)request.getAttribute("datModif");
					...
					importeSegui = datModif.getImporteSegui() != null ? datModif.getImporteSegui().toString() : "";
                }
        ...
        <script type="text/javascript">
            ...
            function mostrarCalFechaNacimiento(evento) {
                ...
                if (document.getElementById("calFechaNacimiento").src.indexOf("icono.gif") != -1)
                    showCalendar('forms[0]', 'fecNacimiento', null, null, null, '', 'calFechaNacimiento', '', null, null, null, null, null, null, null, 'doNothing()', evento);
			...
			function validarDatos() {
                ...
                campo = document.getElementById('importeSegui').value;
                if (campo == null || campo == '') {
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if ('<%=nuevo%>' != null && '<%=nuevo%>' == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE35&operacion=guardarValSeguimientos23&tipo=0";
                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE35&operacion=modificarValSeguimiento23&tipo=0"
                    ...
                    parametros += '&numExpediente=<%=numExpediente%>'
                            ...
                            + "&nifPreparador=<%=nifPreparador%>"
                            + "&importeSegui=" + document.getElementById('importeSegui').value;
                    console.log("guardarDatos " + parametros);
                    try {
                        $.ajax({
                            url: url,
                            type: 'POST',
                ...
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span id="tituloVentana" style="width: 98%;">
                            <%=nuevo != null && nuevo=="1" ? meLanbide35I18n.getMensaje(idiomaUsuario,"label.validacion.seguimiento.alta"):meLanbide35I18n.getMensaje(idiomaUsuario,"label.validacion.seguimiento.modificar")%>
                        </span>
                    </div>
                    <fieldset id="insercion" name="insercion">
                        ...
                        <div class="lineaFormulario">
                            ...
                            <div class="etiquetaEca">
                                <%=meLanbide35I18n.getMensaje(idiomaUsuario,"label.validacion23.mantenimiento.importeSegui")%>
                            </div>
                            <div style="width:350px; float: left;">
                                <input id="importeSegui" name="importeSegui" type="text" class="inputTextoObligatorio" size="30" maxlength="30"
                                       value="<%=importeSegui%>" />
                            </div>
                        </div>
                    </fieldset>
