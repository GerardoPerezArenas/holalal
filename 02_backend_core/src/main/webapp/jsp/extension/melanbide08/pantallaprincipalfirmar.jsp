...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide08/gestionEnviarFirmar.js"></script>
...
<div class="contenidoPantalla">
    ...
    <div style="padding-left: 15px; text-align: center;" class="txttitblanco"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.titulo.principalfirmar")%></div>
    <div  class="container align-self-center" style="width: 40%; margin-top:30px;">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="4" max="4" width="6em" class="form-control" id="ejercicio" value="2022" title="<%=meLanbide08I18n.getMensaje(idiomaUsuario, "label.ejercicio")%>"  placeholder="<%=meLanbide08I18n.getMensaje(idiomaUsuario, "label.ejercicio.placeholder")%>" 
            ...
            <button hidden type="button" id="reiniciarFiltro" class="btn btn-primary" onclick="reiniciarFiltros();"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.button.reiniciar")%></button>
    ...
    <div>
        ...
        <div id="tablaLog" style="margin-top: 30px; margin-bottom: 100px; margin-left: 30px; margin-right: 30px; height: 250px;">
         ...
         <button type="button" id="lanzarProceso" class="btn btn-primary" onclick="lanzarProcesoFiltrado();"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "label.boton.lanzar.proceso")%></button>
