...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide08/gestionconsultarlog.js"></script>
...
<div class="contenidoPantalla">
    ...
    <div style="padding-left: 15px; text-align: center;" class="txttitblanco"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.titulo.logprincipalfirmar")%></div>
    <div  class="container align-self-center" style="width: 40%; margin-top:30px;">
            ...
            <div class="form-group">
                <label style="width: 200px;" for="fechahoraenviopeticion"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.label.fechatramitacion")%></label>
                 <!--<input type="text" maxlength="10" size="45" class="form-control" id="fechahoraenviopeticion" title="<%=meLanbide08I18n.getMensaje(idiomaUsuario, "tabla.titulo.fechatramitado")%>"  placeholder="<%=meLanbide08I18n.getMensaje(idiomaUsuario, "tabla.titulo.fechatramitado")%>" >-->
                <form>
            ...
            <!--ESTADOFIRMA-->
            <div class="form-group">
                <label style="width: 140px;" for="estadoFirma"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.label.estado")%></label>
            ...
            <!--BOTON FILTRAR-->
            <button type="button" id="filtrar" class="btn btn-primary" onclick="lanzarProcesoConsultarTablaLogJob();"><%=meLanbide08I18n.getMensaje(idiomaUsuario, "resultado.button.consultarlog")%></button>
            ...
            <table class="xTabla compact tablaDatos" id="tableLogJob">
                <thead>
                    <tr role="row">
                        ...
                        <th field="fechaFirmado" datatype="String" class="selectedUp" rowspan="1" colspna="1" ><%=meLanbide08I18n.getMensaje(idiomaUsuario, "tabla.titulo.fechatramitado")%></th>
                        ...
                        <th field="mensajeErrorJob" datatype="String" class="selectedUp" rowspan="1" colspna="1" ><%=meLanbide08I18n.getMensaje(idiomaUsuario, "tabla.titulo.mensajeerror")%></th>
                        </tr>
                </thead>
                <tbody>
