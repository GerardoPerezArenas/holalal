...
<%
    ...
    ColecTrayOtroProgramaVO trayecEspModif = (ColecTrayOtroProgramaVO)request.getAttribute("trayecModif");
...
<!--<script type="text/javascript" src="https://ajax.googlea //pis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>-->
...
<script type="text/javascript">
    ...
    $( function() {
    //$( "#fechaInicioOP" ).datepicker();
    $( "#fechaInicioOP" ).datepicker( $.datepicker.regional['es' ] );
   // $( "#fechaInicioOP" ).datepicker( "option", "dateFormat", "dd/mm/yy");
    //$( "#fechaFinOP" ).datepicker();
    $( "#fechaFinOP" ).datepicker( $.datepicker.regional[ 'es' ] );
    //$( "#fechaFinOP" ).datepicker( "option", "dateFormat", "dd/mm/yy");
  } );
</script>
...
<script type="text/javascript">                
    ...
    function guardarTrayectoriaGeneralOtrosProg(){
        //TODO
        if(validarTrayectoriaGenOtrosPro()){
            var idTray = '<%=trayecEspModif!=null && trayecEspModif.getCodIdOtroPrograma()!=null?trayecEspModif.getCodIdOtroPrograma():""%>';
            ...
            var fechaInicioOP = document.getElementById('fechaInicioOP').value;
            var fechaFinOP = document.getElementById('fechaFinOP').value;
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE48&operacion=guardarTrayectoriaGeneralOtrosProgramas&tipo=0&modoDatos=<%=modoDatos%>&numero=<%=numExpediente%>'
                        +'&idTray='+idTray
                        +'&codEntidad='+codEntidad
                        +'&programa='+programa
                        +'&fechaInicio='+fechaInicioOP
                        +'&fechaFin='+fechaFinOP
    ...
    function validarTrayectoriaGenOtrosPro(){
        mensajeValidacion = '';
        var codigo = '';
        ...
        variable = document.getElementById('fechaInicioOP').value;
        if(variable == ''){
            mensajeValidacion = '<%=meLanbide48I18n.getMensaje(idiomaUsuario,"msg.generico.campos.obligatorios")%>';
            return false;
        }else{
            if(!comprobarFormatoFechaColec(variable)){
                ...
                document.getElementById('fechaInicioOP').focus();
                document.getElementById('fechaInicioOP').select();
                return false;
            }
        }
        variable = document.getElementById('fechaFinOP').value;
        if(variable == ''){
            mensajeValidacion = '<%=meLanbide48I18n.getMensaje(idiomaUsuario,"msg.generico.campos.obligatorios")%>';
            return false;
        }else{
            if(!comprobarFormatoFechaColec(variable)){
                mensajeValidacion = '<%= meLanbide48I18n.getMensaje(idiomaUsuario,"msg.generico.campos.formato.fecha")%>';
                document.getElementById('fechaFinOP').focus();
                document.getElementById('fechaFinOP').select();
                return false;
            }
        }
        return true;
    ...
    function limpiarFormulario(){
        ...
        document.getElementById('fechaInicioOP').value = '';
...
<!--    <form  id="formTrayGenOP" style="margin-top: 1px;">-->
        <div align="center">
            <div style="clear: both; overflow-x: hidden; overflow-y: auto; height: 650px;">
                 <fieldset id="fieldsetOtrosProgramas" name="fieldsetOtrosProgramas" style="width: 935px;">
                    <legend class="legendAzul"><%=meLanbide48I18n.getMensaje(idiomaUsuario,"label.trayectoria.general.otros.programas")%></legend>
                    ...
                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left;">    
                        <!-- PROGRAMA -->
                        <label for="programa" style="vertical-align: top;"><%=meLanbide48I18n.getMensaje(idiomaUsuario,"label.solicitud.trayectoria.general.otrosProgramas.programa")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                        <textarea id="programa" name="programa" class="inputTexto" rows="8" cols="124" maxlength="500"><%=trayecEspModif != null && trayecEspModif.getPrograma()!=null ? trayecEspModif.getPrograma() : ""%></textarea>
                    </div>
                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left;">    
                        <table>
                            <tr>
                                 <!-- FECHA INICIO -->
                                <td>
                                    <label for="fechaInicioOP" style="vertical-align: top;"><%=meLanbide48I18n.getMensaje(idiomaUsuario,"label.solicitud.trayectoria.general.otrosProgramas.fechaInicio")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                                </td>
                                <td>
                                    <input type="text"  id="fechaInicioOP" name="fechaInicioOP" class="inputTexto" maxlength="10" style="text-align: right;" value="<%=trayecEspModif != null ? MeLanbide48Utils.formatearFecha_ddmmyyyy(trayecEspModif.getFechaInicio()): ""%>">
                                </td>
                            </tr>
                            <tr>
                                <!-- FECHA FIN -->
                                <td>
                                    <label for="fechaFinOP" style="vertical-align: top;"><%=meLanbide48I18n.getMensaje(idiomaUsuario,"label.solicitud.trayectoria.general.otrosProgramas.fechaFin")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                                </td>
                                <td>
                                    <input type="text"  id="fechaFinOP" name="fechaFinOP" class="inputTexto" maxlength="10" style="text-align: right;" value="<%=trayecEspModif != null ? MeLanbide48Utils.formatearFecha_ddmmyyyy(trayecEspModif.getFechaFin()): ""%>">
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="botonera">
                        <input type="button" id="btnAnadir" name="btnAnadir" class="botonGeneral" value="<%=meLanbide48I18n.getMensaje(idiomaUsuario,"btn.guardar")%>" onclick="guardarTrayectoriaGeneralOtrosProg()"/>
                    </div>
                 </fieldset>
            </div>
        </div>
