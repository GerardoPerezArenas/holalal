...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide60/FixedColumnsTable2.js"></script>
...
<script type="text/javascript">   
    ...
    function recargarTablaJustificacionesCme(result){
        ...
        tabJustifCme = new FixedColumnTable2(document.getElementById('justificacionesCme'), 670, 876, 'justificacionesCme');
        tabJustifCme.addColumna('200','left',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col1")%>");
        tabJustifCme.addColumna('150','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col2")%>");    
        tabJustifCme.addColumna('150','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col3")%>");   
        tabJustifCme.addColumna('150','right',"<%= meLanbide60I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.justif.col4")%>");   
    ...
    function getListaJustificacionesCme(){
        ...
        var parametros = '';
        var control = new Date();
        parametros = 'tarea=preparar&modulo=MELANBIDE60&operacion=getListaJustificacionesNoDenegadasPorExpediente&tipo=0&numero=<%=numExpediente%>&control='+control.getTime();
        try{
...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
            <!--<input type="button" id="btnNuevaJustificacionCme" name="btnNuevaJustificacionCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.alta")%>" onclick="pulsarAltaJustifCme();">-->
            <input type="button" id="btnModificarJustifCme" name="btnModificarJustifCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarJustifCme();">
            <!--<input type="button" id="btnEliminaJustifCme" name="btnEliminaJustifCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarJustifCme();">-->
        </div>
    </div>
</body>
<script type="text/javascript">
