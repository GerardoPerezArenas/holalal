...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide60.vo.datosCmeVO" %>
...
<script type="text/javascript">   
        ...
        <%--if(document.getElementById('impDespido').value != ''){
            try{
                if(!validarNumericoDecimalCme(document.getElementById('impDespido'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impDespidosIncorrecto")%>';
                }else{
        ...
        if(document.getElementById('impBaja').value != ''){
            try{
                if(!validarNumericoDecimalCme(document.getElementById('impBaja'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impBajasIncorrecto")%>';
                }else{
   ...
   /*     var impSubvFinalCorrecto = true;
        if(document.getElementById('impSubvFinal').value != ''){
            try{
                if(!validarNumericoDecimalCme(document.getElementById('impSubvFinal'), 10, 2)){
                    ...
                    if(mensajeValidacion == '')
                        mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impSubvFinalIncorrecto")%>';
                }else{
        ...
        if(correcto && !impSubvFinalCorrecto){
            var resultado = jsp_alerta('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaimpSubvFinalIncorrecto")%>');
            if (resultado != 1){
                correcto = false;
                mensajeValidacion = '';
            }
    ...
    function mostrarImpConCalculado(event){
        ...
        var strEuros = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros").toLowerCase()%>';
        
        var msg = '';
        
        msg += '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPrevConEs")%>: '+impPrevCon+' '+strEuros;
        if(valorMinimis > 0.0){
            msg += '<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+minimis+' '+strEuros;
            
            if(valorMinimis + valorImpPrevCon > parseFloat('<%=ConstantesMeLanbide60.MAX_CONCE_PERMITIDO%>')){
                msg += '<br/><br/>'+'<%=String.format(meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConMasMinimisSuperaMaxPermitido"), df.format(ConstantesMeLanbide60.MAX_CONCE_PERMITIDO))%>'+' '+conce+' '+strEuros;
            }else{
                msg += '<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+conce+' '+strEuros;
            }
        }else{
            if(valorImpPrevCon > parseFloat('<%=ConstantesMeLanbide60.MAX_CONCE_PERMITIDO%>')){
                msg += '<br/><br/>'+'<%=String.format(meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConSuperaMaxPermitido"), df.format(ConstantesMeLanbide60.MAX_CONCE_PERMITIDO))%>'+' '+conce+' '+strEuros;
            }else{
                msg += '<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+conce+' '+strEuros;
            }
        }
        ...
        if(document.forms[0].modoConsulta.value != "si"){
            msg += '<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>';
        }
        
        
        /*if(document.forms[0].modoConsulta.value == "si"){
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta_grande('A','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPrevConEs")%>: '+document.getElementById('impPrevistoConcesion').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>', '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "titulo.aceptarImporte")%>');
            }else{
                resultado = jsp_alerta_grande('A','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPrevConEs")%>: '+document.getElementById('impPrevistoConcesion').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>', '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "titulo.aceptarImporte")%>');
            }
        }else{
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta_grande('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPrevConEs")%>: '+document.getElementById('impPrevistoConcesion').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>', '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "titulo.aceptarImporte")%>');
            }else{
                resultado = jsp_alerta_grande('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPrevConEs")%>: '+document.getElementById('impPrevistoConcesion').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>'+' '+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>', '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "titulo.aceptarImporte")%>');
            }
        }*/
                
        resultado = jsp_alerta_grande('P', msg, '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "titulo.aceptarImporte")%>');
    ...
    function mostrarImpPag2Calculado(event){
        ...
        if(document.forms[0].modoConsulta.value == "si"){    
            resultado = jsp_alerta('A','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPag2CalculadoEs")%>: <br/>'+fPag2+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>');
        }else{
            resultado = jsp_alerta('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impPag2CalculadoEs")%>: <br/>'+fPag2+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>');
        }
        if (resultado == 1){
    ...
    function actualizarPestanaDatosSuplementarios(){
     ...
     function consultarHistoricos(res){
        try{
            var control = new Date();
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),380,950,'yes','no');
            }else{            
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),400,950,'yes','no');
            }
        }catch(err){
...
<body>
    ...
    <div class="tab-page" id="tabPage391" style="height:480px; width: 100%;">
        <h2 class="tab" id="pestana391"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.tituloPestana")%></h2>
                ...
                <div style="clear: both; width: 100%; text-align: left; padding-left: 12px;" class="textoAzul">
                    <div class="lineaFormulario">
                        <div style="width: 97px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.gestorTramitador")%>
                        </div>
                        <div style="width: 259px; float: left;">
                            ...
                            <a id="anchorGestorTramitador" name="anchorGestorTramitador" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonGestorTramitador" name="botonGestorTramitador" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                        </div>
                        <div style="width: 51px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.empresa")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impSolicitado")%>
                        </div>
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impPrevistoConcesion")%>
                        </div>
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impConcedido")%>
                        </div>
                        <div style="width: 80px; float: left;">
                            <input type="text" class="inputTexto" size="9" maxlength="11" id="impConcedido" name="impConcedido" value="" style="text-align: right;" onchange="reemplazarPuntosCme(this);" onblur="comprobarImporteConcedido();importeModificado();"/>
                        </div>
                        <div style="width: 30px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpConCalculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpCon" name="calcularImpCon" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.calcularImporteConcedido")%>" src="<c:url value='/images/extension/melanbide60/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impRenunciadoSol")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.primerPago")%>
                        </div>
                        <div style="width: 80px; float: left;">
                        ...
                        <div style="width: 23px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpPagCalculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpPag" name="calcularImpPag" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.calcularImportePagado")%>" src="<c:url value='/images/extension/melanbide60/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.segundoPago")%>
                        </div>
                        <div style="width: 80px; float: left;">
                        ...
                        <div style="width: 30px; float: left; padding-top: 2px;">
                            <a href="#" onclick="mostrarImpPag2Calculado(event);return false;" style="text-decoration:none;" >
                                <img style="border: 0" height="17" id="calcularImpPag2" name="calcularImpPag2" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.calcularImportePagado2")%>" src="<c:url value='/images/extension/melanbide60/calculadora.png'/>"/>
                            </a>
                        </div>
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impJustificado")%>
                        </div>
                        <div style="width: 110px; float: left;">
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impRenunciadoRes")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 100px; float: left; margin-right: 5px; margin-left: 423px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impNoJustif")%>
                        </div>
                        <div style="width: 110px; float: left;">
                        ...
                        <div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impReintegrar")%>
                        </div>
                        <div style="width: 110px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 208px; float: left; padding-bottom: 10px;">
                            <input type="checkBox" id="checkOtrasAyudas" name="checkOtrasAyudas" onclick="mostrarOtrasAyudas();"/><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.mostrarOtrasAyudas")%>
                        </div>
                        <div style="float: right; width: 492px;">
                            <div style="width: 105px; float: left;">
                                <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.minimisSolic")%>
                            </div>
                            <div style="width: 110px; float: left;">
                            ...
                            <div style="width: 105px; float: left;">
                                <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.minimisConce")%>
                            </div>
                            <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario" style="height: 42px;">
                        <div id="divLabelOtrasAyudasSolic" style="width: 105px; float: rigth;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.otrasAyudasSolic")%>
                        </div>
                        ...
                        <div id="divLabelOtrasAyudasConce" style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.otrasAyudasConce")%>
                        </div>
                        ...
                        <div style="float: right; width: 80%; text-align: right; margin-right: 5%">
                            <a href="#" id="linkImpRes" name="linkImpRes" onclick="consultarImportesResolucion('I');"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.consulImpRes")%></a>
                            &nbsp;&nbsp;
                            <a href="#" id="linkImpResModif" name="linkImpResModif" onclick="consultarImportesResolucion('M');"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.consulImpResModif")%></a>
<BR />
                            <a href="#" id="linkImpHist" name="linkImpHist" onclick="consultarHistoricos('3');"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.consultaHist")%></a>                        
&nbsp;&nbsp;&nbsp;
                            <a href="#" id="linkImpHist2" name="linkImpHist" onclick="consultarHistoricos('44');"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.consultaHist2")%></a>                        
                        </div>
                    </div>
                    <!--<div class="lineaFormulario">-->
                        <!--<div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impDespido")%>
                        </div>
                        <div style="width: 103px; float: left;">
                        ...
                        <!--<div style="width: 105px; float: left;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impBaja")%>
                        </div>
                        <div style="width: 103px; float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 520px; float: left; text-align: right;">
                            <input type="button" id="btnGuardarDatosCme" name="btnGuardarDatosCme" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"btn.guardar")%>" onclick="guardarDatosCme();">
                        </div>
                        <div style="width: 390px; text-align: right; float: left;">
                            <span style="width: 110px; text-align: left; color: red;">
                                <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosCme.impConvocatoria")%>
                            </span>
                ...
                <div style="clear: both; width: 100%; text-align: left; padding-top: 10px;">
                    ...
                    <div class="tab-page" id="tabPage3914" style="height: 194px;">
                        <h2 class="tab" id="pestana3914"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.resumen.tituloPestana")%></h2>
