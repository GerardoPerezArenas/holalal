	 ...
	 css = usuario.getCss();
            ...
            if(res != null && !res.equals(""))
            {
                if(res.equals("I"))
                {
                    ...
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.titulo.resInicial");
                    
                    fecRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_FEC_RES);
                    fecNotifRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_NOT_RES);
                    pConRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_PUESTOS_CONC);
                    impConRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_IMP_CONC);
                    impPPagRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_IMP_PRIMER_PAG);
                    impSPagRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_IMP_SEG_PAGO);
                    fecPresRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_FEC_RESOL);
                    numPRen = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_NUM_PUESTO);
                    impPueRen = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_IMP_RENUN);
                }
                else if(res.equals("M"))
                {
                    //Es resolucion modificatoria
                    
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.titulo.resModif");
                    
                    fecRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_FEC_RES);
                    fecNotifRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_NOT_RES);
                    pConRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_PUES_CONC);
                    impConRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_IMP_CONC);
                    impPPagRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_IMP_PRI_PAG);
                    impSPagRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_SEG_PAG);
                    fecPresRes = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_FEC_RENUN);
                    numPRen = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_PUES_REN);
                    impPueRen = (String)request.getAttribute(ConstantesMeLanbide60.CAMPO_SUPL_RES_MOD_IMP_REN);
                }
            }
        %>
                ...
                <fieldset  style="padding: 10px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.fechaRes")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.fechaNotifRes")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.pConceRes")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.impConceRes")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.impPPagRes")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.impSPagRes")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.fechaPresRen")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.numPRen")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
                    ...
                    <div class="lineaFormulario">
                        <div style="float: left; width: 200px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.datosRes.impPRen")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 11px;">
