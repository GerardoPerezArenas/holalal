...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
            ...
            function calcularImporteMaxSubv(){                
                ...
                //alert(gastosVisSoli);
                if (gastosVisSoli==''){
                            //visado =document.getElementById('txtTramitacionSolicitud').value = '0,00';
                            visado = '0,00';
                }else {
                ...
                if (gastosSegSoli==''){
                            //seguro =document.getElementById('txtDietasSolicitud').value = '0,00';
                            seguro ='0,00';
                }else {
            ...
            function buscarTitulacion(id){
                var control = new Date();
                lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide60/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),520,960,'yes','no', function(result){
        ...
        <form  id="formNuevoPuesto">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 20px;">
                            ...
                            <input id="descGrupoContrato" name="descGrupoContrato" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorGrupoContrato" name="anchorGrupoContrato" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGrupoContrato" name="botonGrupoContrato" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                ...
                <fieldset id="fieldsetDatosSolicitud" name="fieldsetDatosSolicitud" style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtSalarioSolicitud" name="txtSalarioSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this); calcularImporteMaxSubv(); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 100px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.dietas")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasSolicitud" name="txtDietasSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this); calcularImporteMaxSubv(); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 130px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.puesto.datosSolicitud.tramitacion")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px; margin-right: 42px;">
                            <input type="text" maxlength="11" size="8" id="txtTramitacionSolicitud" name="txtTramitacionSolicitud" value="" class="inputTexto textoNumerico" onkeyup="calcularImpTotalSolicitado(this);" onblur="calcularImpTotalSolicitado(this);calcularImporteMaxSubv(); ajustarDecimalesImportes();" />
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 180px;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 11px; margin-right: 20px;">
                            ...
                            <input id="descResultadoResumen" name="descResultadoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorResultadoResumen" name="anchorResultadoResumen" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonResultadoResumen" name="botonResultadoResumen" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                        ...
                        <div id="divComboMotivoResumen" style="width: auto; float: left; margin-left: 10px; margin-right: 65px;">
                            ...
                            <input id="descMotivoResumen" name="descMotivoResumen" type="text" class="inputTexto" size="20" readonly >
                             <a id="anchorMotivoResumen" name="anchorMotivoResumen" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonMotivoResumen" name="botonMotivoResumen" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                    <div class="lineaFormulario">      
                        <div style="float: left; width: 90px;">
