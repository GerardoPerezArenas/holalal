    ...
    function mostrarImpConCalculado(event){
        ...
        if(document.forms[0].modoConsulta.value == "si"){
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta_grande('A','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen);
            }else{
                resultado = jsp_alerta_grande('A','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen);
            }
        }else{
            if(minimis != undefined && minimis != ''){
                resultado = jsp_alerta_grande('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoMinimis")%>'+' '+document.getElementById('minimisConce').value+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>');
            }else{
                resultado = jsp_alerta_grande('','<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.impConCalculadoEs")%>: <br/>'+document.getElementById('concedidoReal').value+' '+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.euros")%>'+'<br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.avisoImporteRenunciado")%>'+' '+impRen+'<br/><br/>'+'<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.datosCme.preguntaAceptarImporte")%>');
            }
        }
        if (resultado == 1){
    ...
    function actualizarPestanaDatosSuplementarios(){
     ...
     function consultarImportesResolucion(res){
        try{
            if(res != undefined && res != ''){
                var control = new Date();
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarImportesResolucion&res='+res+'&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),380,395,'yes','no', function(result){});
                }else{
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarImportesResolucion&res='+res+'&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),400,440,'yes','no', function(result){});
                }
            }else{
     ...
     function consultarHistoricos(res){
        try{
            var control = new Date();
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),380,950,'yes','no', function(result){});
            }else{            
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE60&operacion=cargarHistorico&tipo=0&tram='+res+'&numero=<%=numExpediente%>&control='+control.getTime(),400,950,'yes','no', function(result){});
            }
        }catch(err){
                ...
                <div style="clear: both; width: 100%; text-align: left; padding-left: 12px;" class="textoAzul">
                    <div class="lineaFormulario">
                        ...
                        <div style="width: 259px; float: left;">
                            ...
                            <a id="anchorGestorTramitador" name="anchorGestorTramitador" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGestorTramitador" name="botonGestorTramitador" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
