...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide60.vo.CmeJustificacionVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            if(consulta)
            {
                tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.justif.titulo.consultaJustif");
            }
            else
            {
                if(justifModif != null)
                {
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario,"label.justif.titulo.modifJustif");
                }
                else
                {
                    tituloPagina = meLanbide60I18n.getMensaje(idiomaUsuario, "label.justif.titulo.nuevaJustif");
                }
            }
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide60/cmeUtils.js"></script>
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                if(justifModif != null)
                {
                    if(justifModif.getFlVariosTrab() != null && justifModif.getFlVariosTrab().equalsIgnoreCase(ConstantesMeLanbide60.FALSO))
                    {
                %>
                ...
                <%
                    ...
                    {
                        if(justifModif.getFlVariosTrab() != null && justifModif.getFlVariosTrab().equalsIgnoreCase(ConstantesMeLanbide60.CIERTO))
                        {
                %>
                ...
                document.getElementById('txtDietasJusti').value = '<%=justifModif != null && justifModif.getGastosSeguro() != null ? justifModif.getGastosSeguro() : concedido != null ? concedido.toUpperCase() : "" %>';
                
                if(<%=justifModif.getMesesExt()%> != null)
                    document.getElementById('txtMeses').value = '<%=justifModif.getMesesExt()%>';
                document.getElementById('txtGastosGestion').value = '<%=justifModif != null && justifModif.getGastosVisado() != null ? justifModif.getGastosVisado() : concedido != null ? concedido.toUpperCase() : "" %>';
                ...
                <%
                if(consulta == true || (puestoConsulta != null && puestoConsulta.getCodResult() != null && puestoConsulta.getCodResult().equalsIgnoreCase(ConstantesMeLanbide60.CODIGO_RESULTADO_RENUNCIA)))
                {
                %>
            ...
            function suma(){
                ...
                try{
                    ...
                    reemplazarPuntosCme(document.getElementById('txtImpJustificado'));                    //alert(document.getElementById('txtImpJustificado').value);
                }catch(err){
            ...
            function guardar(){
                if(validarDatos()){ 
                    ...
                    var parametros = 'tarea=preparar&modulo=MELANBIDE60&operacion=guardarDatosContratacion&tipo=0&numero=<%=numExpediente%>'
                        ...
                        //+'&radioVariosTrab='+(document.getElementById('radioVariosTrabS').checked ? '<%=ConstantesMeLanbide60.CIERTO%>' : document.getElementById('radioVariosTrabN').checked ? '<%=ConstantesMeLanbide60.FALSO%>' : '')
                        +'&impJustificado='+document.getElementById('txtImpJustificado').value +'&salarioSub='+document.getElementById('txtSalarioSub').value
                        +'&gastosSeguro='+document.getElementById('txtDietasJusti').value +'&gastosVisado='+document.getElementById('txtGastosGestion').value
                        ...
                        try{
                            if(!validarNumericoDecimalCme(document.getElementById('txtImpJustificado'), 10, 2)){
                                ...
                                if(mensajeValidacion == '')
                                    mensajeValidacion = '<%=meLanbide60I18n.getMensaje(idiomaUsuario, "msg.justificacion.resumen.impJustificadoIncorrecto")%>';
                            }else{
            ...
            function mostrarImporteRenuncia(){
                ...
                if(estadoSelec != undefined && estadoSelec != ''){
                    var codigoEstRenuncia = '<%=ConstantesMeLanbide60.CODIGO_ESTADO_RENUNCIA%>';
            ...
            <form  id="formNuevaOferta">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasConv" name="txtDietasConv" value="" class="inputTexto readOnly textoNumerico" readonly="true"  style="display:none"/>
                        </div>
                        <div style="float: left; width: 150px; margin-left: 20px;">
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasConvoc" name="txtDietasConvoc" value="" class="inputTexto readOnly textoNumerico" readonly="true" style="display:none"/>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.fecha")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 90px; margin-left: 20px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.causa")%>
                        </div>
                ...
                <fieldset  style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide60I18n.getMensaje(idiomaUsuario,"legend.oferta.resumenJustif")%></legend>
                    <!-- En teoria desaparece, pero por si acaso, en lugar de quitarlo se oculta -->
                    <div class="lineaFormulario" style="display: none;">
                        <div style="float: left; width: 245px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.variosTrab")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioVariosTrab" id="radioVariosTrabS" value="S"><%=meLanbide60I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioVariosTrab" id="radioVariosTrabN" value="N"><%=meLanbide60I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                    </div>
                    <!-- En teoria desaparece, pero por si acaso, en lugar de quitarlo se oculta -->
                    ...
                    <div class="lineaFormulario">   
                        ...
                        <div style="float: left; width: 150px; display: none;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.impConcedido")%>
                        </div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.minoracion")%>
                        </div>                             
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasTrabajados")%>
                        </div>                         
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasSegSoc")%>
                        </div>  
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionCC")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.coeficienteAplicado")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.segSocialEmpresa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salario")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionATEP")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcFogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcCoeficiente")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 30%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.fogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <!--div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.pocAportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;"><!--30%-->
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.aportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeSS")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 29%;">&nbsp;</div>
                        <div style="float: left; width: 30%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeTotal")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.dietasAbonadas")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.mesesExterior")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.gastosAbonados")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeBonificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                        ...
                        <div style="float: left; width: 10%;">&nbsp;</div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeJustificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
...
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 13%;display: none;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salarioSub")%>
                        </div>                        
                        ...
                        <div id="divImporteRenuncia" style="display: none;">
                            <div style="float: left; width: 150px; margin-left: 20px;">
                                <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.impRenuncia")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario" style="display: none;">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide60I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.estado")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <a id="anchorEstado" name="anchorEstado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEstado" name="botonEstado" style="cursor:hand;" alt="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide60I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </fieldset>
                <div class="botonera">
                        <input type="button" id="btnGuardar" name="btnGuardar" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="guardar();">
                        <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide60I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelar();">
