...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
            ...
            function recargarTablaContratacionesCme(result){
                ...
                tabPersonasJustifCme = new FixedColumnTable(document.getElementById('justificacionesCme'), 880, 880, 'justificacionesCme');
    ...
    <body id="cuerpoNuevaJustificacion" style="text-align: left;" >
            ...
            <form  id="formNuevaOferta">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <fieldset  style="width: 100%;">
                        ...
                        <div id="justificacionesCme" style="padding: 5px; width:906px; height: 269px; text-align: center; margin:0px;margin-top:0px;" align="center"></div>
                        <div class="lineaFormulario">
        ...
        <script type="text/javascript">            
            ...
            %>
                ...
                var impjus = reemplazarTextoCme(txtimpJust, /,/g, '.');                
