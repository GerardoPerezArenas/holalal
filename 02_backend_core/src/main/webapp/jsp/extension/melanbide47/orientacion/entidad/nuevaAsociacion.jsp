...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            String[] datosExpAso = numExpediente!=null ? numExpediente.split("/") : null;
            Integer ejercicioExpedienteAso    = datosExpAso != null ? Integer.valueOf(datosExpAso[0]) : 2018 ;
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/DataTables/datatables.min.css"/>
        ...
        <script type="text/javascript">
            ...
            var nuevo = true;
            var ejercicioExpedienteAsoJS = <%=ejercicioExpedienteAso%>;
            ...
            function inicio(){
                ...
                %>
                    ...
                    <%
                    if(asociacionModif.getAgenciaColocacion() != null && asociacionModif.getAgenciaColocacion().equals(1))
                    {
                    %>
                        document.getElementById('agenciaColocacionS').checked = 'true';                                
                    <%
                    }
                    else if(asociacionModif.getAgenciaColocacion() != null && asociacionModif.getAgenciaColocacion().equals(0))
                    {
                    %>
                    ...
                    <%
                    if(asociacionModif.getOriExpSinAnimoLucro() != null && asociacionModif.getOriExpSinAnimoLucro().equals(1))
                    {
                    %>
                        if(ejercicioExpedienteAsoJS>=2018) document.getElementById('centrofpPrivS').checked = 'true';                                
                    <%
                    }
                    else if(asociacionModif.getOriExpSinAnimoLucro() != null && asociacionModif.getOriExpSinAnimoLucro().equals(0))
                    {
                    %>
                        if(ejercicioExpedienteAsoJS>=2018) document.getElementById('centrofpPrivN').checked = 'true'; 
                    <%
                    }
                    %>
                ...
                %>
                    ...
                    document.getElementById('agenciaColocacionS').readOnly = true;
                    document.getElementById('agenciaColocacionN').readOnly = true;
                    if(ejercicioExpedienteAsoJS>=2018){
                        document.getElementById('centrofpPrivS').readOnly = true;
                        document.getElementById('centrofpPrivN').readOnly = true;
                    }
            ...
            function guardar(){
                if(validarDatos()){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE47&operacion=guardarAsociacion&tipo=0&numero=<%=numExpediente%>'
                        ...
                        +'&agenciaColocacion='+(document.getElementById('agenciaColocacionS').checked ? 1 : document.getElementById('agenciaColocacionN').checked ? 0 : null)
                        +'&sinAnimoLucro='+(document.getElementById('sinAnimoLucroS')!=null && document.getElementById('sinAnimoLucroS').checked ? 1 : document.getElementById('sinAnimoLucroN')!=null && document.getElementById('sinAnimoLucroN').checked ? 0 : null)
                    ...
                    for(j=0;hijos!=null && j<hijos.length;j++){
                        ...
                        if(codigoOperacion=="0"){
                            self.parent.opener.retornoXanelaAuxiliar(listaAsociaciones);
            ...
            function validarDatos(){
                ...
                if (!document.getElementById('centrofpPrivS').checked && !document.getElementById('centrofpPrivN').checked) {
                        mensajeValidacion = '<%=meLanbide47I18n.getMensaje(idiomaUsuario, "msg.asociacion.agenciaColocacion.obligatorio")%>';
                        return false;
                }
                
                if (!document.getElementById('agenciaColocacionS').checked && !document.getElementById('agenciaColocacionN').checked) {
                        mensajeValidacion = '<%=meLanbide47I18n.getMensaje(idiomaUsuario, "msg.asociacion.agenciaColocacion.obligatorio")%>';
                        return false;
                }
                
                if(ejercicioExpedienteAsoJS>=2018){
                    if (!document.getElementById('sinAnimoLucroN').checked && !document.getElementById('sinAnimoLucroN').checked) {
                            mensajeValidacion = '<%=meLanbide47I18n.getMensaje(idiomaUsuario, "msg.asociacion.sinanimolucro.obligatorio")%>';
                            return false;
                    }
                    if (!document.getElementById('sinAnimoLucroS').checked && !document.getElementById('sinAnimoLucroS').checked) {
                            mensajeValidacion = '<%=meLanbide47I18n.getMensaje(idiomaUsuario, "msg.asociacion.sinanimolucro.obligatorio")%>';
                            return false;
                    }
                }
        ...
        <form  id="formNuevaAsociacion">
                ...
                <fieldset id="fieldsetDatosAsociacion" name="fieldsetDatosAsociacion" style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="agenciaColocacion" id="agenciaColocacionS" value="S"><%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="agenciaColocacion" id="agenciaColocacionN" value="N"><%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                    </div>
                    <% if(ejercicioExpedienteAso>=2018){%>
                        <div class="lineaFormulario">
                            <div style="float: left; width: 310px;">
                            ...
                            <div style="width: auto; float: left; margin-left: 10px;">
                                <div style="float: left;">
                                    <input type="radio" name="sinAnimoLucro" id="sinAnimoLucroS" value="S" onclick="cambioCentrofpEntidadOri14(this.id);"><%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.si")%>
