...
<script type="text/javascript"> 
        ...
        if(validarTrayectoriaGeneral()){
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE47&operacion=guardarTrayectoriaORI&tipo=0&numero=<%=numExpediente%>'
                        ...
                        for(var i = 0; i < numAsociaciones; i++){
                            ...
                            +'&chk_min94_2011_'+i+'='+(document.getElementById('chk_min94_2011_'+i).checked ? 1 : 0)
                            +'&chk_min94_2012_'+i+'='+(document.getElementById('chk_min94_2012_'+i).checked ? 1 : 0)
                            +'&chk_min94_2013_'+i+'='+(document.getElementById('chk_min94_2013_'+i).checked ? 1 : 0)
                            +'&chk_min94_2014_'+i+'='+(document.getElementById('chk_min94_2014_'+i).checked ? 1 : 0)
                            +'&chk_min94_2015_'+i+'='+(document.getElementById('chk_min94_2015_'+i).checked ? 1 : 0)
                            +'&chk_min94_2016_'+i+'='+(document.getElementById('chk_min94_2016_'+i).checked ? 1 : 0)
                            ...
                            +'&chk_min98_2011_'+i+'='+(document.getElementById('chk_min98_2011_'+i).checked ? 1 : 0)
                            +'&chk_min98_2012_'+i+'='+(document.getElementById('chk_min98_2012_'+i).checked ? 1 : 0)
                            +'&chk_min98_2013_'+i+'='+(document.getElementById('chk_min98_2013_'+i).checked ? 1 : 0)
                            +'&chk_min98_2014_'+i+'='+(document.getElementById('chk_min98_2014_'+i).checked ? 1 : 0)
                            +'&chk_min98_2015_'+i+'='+(document.getElementById('chk_min98_2015_'+i).checked ? 1 : 0)
                            +'&chk_min98_2016_'+i+'='+(document.getElementById('chk_min98_2016_'+i).checked ? 1 : 0)
                            ...
                            +'&chk_tas03_2011_'+i+'='+(document.getElementById('chk_tas03_2011_'+i).checked ? 1 : 0)
                            +'&chk_tas03_2012_'+i+'='+(document.getElementById('chk_tas03_2012_'+i).checked ? 1 : 0)
                            +'&chk_tas03_2013_'+i+'='+(document.getElementById('chk_tas03_2013_'+i).checked ? 1 : 0)
                            +'&chk_tas03_2014_'+i+'='+(document.getElementById('chk_tas03_2014_'+i).checked ? 1 : 0)
                            +'&chk_tas03_2015_'+i+'='+(document.getElementById('chk_tas03_2015_'+i).checked ? 1 : 0)
                            +'&chk_tas03_2016_'+i+'='+(document.getElementById('chk_tas03_2016_'+i).checked ? 1 : 0)
                            ...
                            +'&chk_lan_2015_'+i+'='+(document.getElementById('chk_lan_2015_'+i).checked ? 1 : 0)
    ...
    function recargarTrayectoriasORI14(listaTrayectorias){
        ...
        var html = '<table style="height: 434px;" onmousewheel="propagarEvento(event, \'trayectoriaGen\');">'
                  ...
                  +'                      <table style="font-size: 10px; border-collapse: collapse; width: 300px;">'
                  +'                          <tr>'
                  ...
                  +'                      <table width="'+(numAsociaciones * 180)+'" class="content" style="border-collapse: collapse; font-size: 10px;">'
                  +'                          <tr>';
