...
<%
    ...
    String tituloPagina = meLanbide47I18n.getMensaje(idiomaUsuario, "label.trayectoria.pagina.actividades");
    OriTrayActividadVO trayecModif =(OriTrayActividadVO)request.getAttribute("trayecModif");
...
<script type="text/javascript">
    ...
    function guardarTrayectoriaActividades() {
        if (validarTrayectoriaActividades()) {
            ...
            var actividad = escape(document.getElementById('descActividad').value);
            var anio = document.getElementById('anio').value;
            var duracion = document.getElementById('duracion').value;
            var anioVal = document.getElementById('anioVal').value;
            var duracionVal = document.getElementById('duracionVal').value;
            ...
            parametros = 'tarea=preparar&modulo=MELANBIDE47&operacion=guardarTrayectoriaActividades&tipo=0&modoDatos=<%=modoDatos%>&numero=<%=numExpediente%>'
                    + '&idTray=' + idTray
    ...
    function validarTrayectoriaActividades() {
        mensajeValidacion = '';
        var codigo = '';
    ...
    <div align="center">
        <div style="clear: both; overflow-x: hidden; overflow-y: auto; height: 650px;">
            <fieldset id="fieldsetActividades" name="fieldsetActividades" style="width: 935px">
                <legend class="legendAzul"><%=meLanbide47I18n.getMensaje(idiomaUsuario,"label.trayectoria.tituloPestana.actividades")%></legend>
                <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left;">
                    <!-- ENTIDAD -->
                    <label for="codEntidad" style="vertical-align: bottom;"><%=meLanbide47I18n.getMensaje(idiomaUsuario,"label.trayectoria.actividades.entidad")%></label><font color="red">*</font>                        
                ...
                <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left;">
                    <!-- ACTIVIDAD -->
                    <label for="descActividad" style="vertical-align: top;"><%=meLanbide47I18n.getMensaje(idiomaUsuario,"label.trayectoria.actividades.tabla.actividad")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                    <textarea id="descActividad" style="vertical-align: top;" class="inputTexto" rows="8" cols="124" maxlength="500"><%=trayecModif != null && trayecModif.getDescActividad()!=null ? trayecModif.getDescActividad():""%></textarea>
                </div>
                <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left;">
                    <table>
                        <tbody>
                            <tr>
                                <td style="width: 50%">
                                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left; position: relative;">
                                        <!-- ANIO -->
                                        <label for="anio" style="vertical-align: top;"><%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.trayectoria.actividades.anio")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                                        <input id="anio" name="anio" type="text" class="inputTexto" size="5" maxlength="4" style="position: absolute;right: 5px;" value="<%=(trayecModif !=null && trayecModif.getEjerActividad()!=null ? trayecModif.getEjerActividad():"")%>">                                   
                                    </div>
                                </td>
                                <td align="right">
                                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: right; position: relative;">
                                        <!-- ANIO VAL-->
                                        <label for="anioVal" style="vertical-align: top;"><%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.trayectoria.actividades.anio.validado")%></label><font color="red" style="margin-right: 55px; vertical-align: top;"></font>
                                        <input id="anioVal" name="anioVal" type="text" class="inputTexto" style="position: absolute; right: 5px;" size="5" maxlength="4" value="<%=(trayecModif !=null && trayecModif.getEjerActividadVal()!=null ? trayecModif.getEjerActividadVal():"")%>">                                   
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 50%">
                                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: left; position: relative;">
                                        <!-- DURACION -->
                                        <label for="duracion" style="vertical-align: top;"><%=meLanbide47I18n.getMensaje(idiomaUsuario,"label.trayectoria.actividades.duracion")%></label><font color="red" style="margin-right: 44px; vertical-align: top;">*</font>
                                ...
                                <td align="right">
                                    <div class="lineaFormulario" style="padding-left: 5px; padding-right: 5px; text-align: right; position: relative;">
                                        <!-- DURACION VAL-->
                                        <label for="duracionVal" style="vertical-align: top;"><%=meLanbide47I18n.getMensaje(idiomaUsuario,"label.trayectoria.actividades.duracion.validada")%></label><font color="red" style="margin-right: 55px; vertical-align: top;"></font>
                ...
                <div class="botonera" style="text-align: right; margin-bottom: 10px">
                    <input type="button" id="btnAnadir" name="btnAnadir" class="botonGeneral" value="<%=meLanbide47I18n.getMensaje(idiomaUsuario,"btn.guardar")%>" onclick="guardarTrayectoriaActividades()"/>
                </div>
            </fieldset>
        </div> 
    </div>
