...
<script type="text/javascript">
    ...
    function ejecutarResolucionProvisionalHoras(){
        ...
        lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide47/procesos/solicitarAno.jsp?idioma=<%=idiomaUsuario%>&control='+control.getTime(),250,300,'no','no', function(ano){
    ...
    <form id="formProcesos">
        <div class="tab-page" id="tabPage323" style="height:500px; width: 100%;">
            <table width="100%" style="height: 500px;" cellpadding="0px" cellspacing="0px" border="0px">
                <tr>
                       <td style="width:100%;  height:30px; padding-left: 15px" class="txttitblanco">ORI14 <%=meLanbide47I18n.getMensaje(idiomaUsuario, "label.procesos.tit_procesos")%></td>
					</tr>							
					<tr>
											...
											<table style="width: 100%; font-size: 12px;">
												...
												<tr>
													<td>
														...
														<a id="anchorProceso" name="anchorProceso" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonProceso" name="botonProceso" style="cursor:hand;" alt="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide47I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
													</td>
												</tr>
												<tr>
													<td>
