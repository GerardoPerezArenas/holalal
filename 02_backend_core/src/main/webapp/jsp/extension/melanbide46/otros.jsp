                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <input id="descPaisPuesto" name="descPaisPuesto" type="text" class="inputTexto" size="25" readonly >
                         <a id="anchorPaisPuesto" name="anchorPaisPuesto" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPaisPuesto" name="botonPaisPuesto" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descPaisSolicitables" name="descPaisSolicitables" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorPaisSolicitables" name="anchorPaisSolicitables" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonPaisSolicitables" name="botonPaisSolicitables" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                    ...
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descGrupoSolicitables" name="descGrupoSolicitables" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorGrupoSolicitables" name="anchorGrupoSolicitables" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonGrupoSolicitables" name="botonGrupoSolicitables" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <input id="descOfiGestionOferta" name="descOfiGestionOferta" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorOfiGestionOferta" name="anchorOfiGestionOferta" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonOfiGestionOferta" name="botonOfiGestionOferta" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
                ...
                <div class="lineaFormulario">     
                    ...
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descNifContratado" name="descNifContratado" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorNifContratado" name="anchorNifContratado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonNifContratado" name="botonNifContratado" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 150px;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descCausaBaja" name="descCausaBaja" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorCausaBaja" name="anchorCausaBaja" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonCausaBaja" name="botonCausaBaja" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                    <div style="float: left; width: 90px;">
                    ...
                    <div style="width: auto; float: left; margin-left: 10px; margin-right: 25px;">
                        ...
                        <input id="descFechaBaja" name="descFechaBaja" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorFechaBaja" name="anchorFechaBaja" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonFechaBaja" name="botonFechaBaja" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                    </div>
                </div>
                <div class="lineaFormulario">
                    <div style="float: left; width: 90px;">
