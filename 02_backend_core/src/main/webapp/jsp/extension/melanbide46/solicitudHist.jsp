...
<script type="text/javascript">   
  function dblClckTablaPuestosCme(rowID,tableName){
    ...
    function recargarTablaPuestosCme(result){
        ...
        tabPuestosCme.addColumna('80','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4")%>", "<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.puestos.col4.title")%>");   
...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
                <input type="button" id="btnModificarPuestoCme" name="btnModificarPuestoCme" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.consultar")%>" onclick="pulsarModificarPuestoCme();">
            </div>
    </div>
</body>
