        ...
        <script type="text/javascript">
           ...
           function cambioPais2(){
            ...
            function buscarTitulacion(id){
                var control = new Date();
                lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide46/buscadorTitulaciones.jsp?codOrganizacionModulo=<%=codOrganizacion%>&control='+control.getTime(),450,980,'yes','no', function(result){
