...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide46.vo.CmeJustificacionVO" %>
...
<html>
 ...
 String css = "";
	 ...
	 css = usuario.getCss();
            ...
            CmeOfertaVO ofertaConsulta = (CmeOfertaVO)request.getAttribute("ofertaConsulta");
            CmeJustificacionVO justifModif = (CmeJustificacionVO)request.getAttribute("justifModif");
            ...
            if(consulta)
            {
                tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario,"label.justif.titulo.consultaJustif");
            }
            else
            {
                if(justifModif != null)
                {
                    tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario,"label.justif.titulo.modifJustif");
                }
                else
                {
                    tituloPagina = meLanbide46I18n.getMensaje(idiomaUsuario, "label.justif.titulo.nuevaJustif");
                }
            }
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                %>
                    ...
                    document.getElementById('txtAportacion').value = '<%=justifModif.getAportEpsv() != null ? justifModif.getAportEpsv().toPlainString() : "" %>';
                    ...
                    reemplazarPuntosCme(document.getElementById('txtAportacion'));
                ...
                if(justifModif != null)
                {
                    if(justifModif.getFlVariosTrab() != null && justifModif.getFlVariosTrab().equalsIgnoreCase(ConstantesMeLanbide46.FALSO))
                    {
                %>
                ...
                <%
                    ...
                    {
                        if(justifModif.getFlVariosTrab() != null && justifModif.getFlVariosTrab().equalsIgnoreCase(ConstantesMeLanbide46.CIERTO))
                        {
                %>
                ...
                document.getElementById('txtDietasJusti').value = '<%=justifModif != null && justifModif.getDietasJusti() != null ? justifModif.getDietasJusti() : concedido != null ? concedido.toUpperCase() : "" %>';
                
                if(<%=justifModif.getMesesExt()%> != null)
                    document.getElementById('txtMeses').value = '<%=justifModif.getMesesExt()%>';
                document.getElementById('txtGastosGestion').value = '<%=justifModif != null && justifModif.getGastosGestion() != null ? justifModif.getGastosGestion() : concedido != null ? concedido.toUpperCase() : "" %>';
                ...
                if(<%=justifModif.getSalario()%> == null)
                    document.getElementById('txtSalario').value =  document.getElementById('txtBaseCC').value;
                reemplazarPuntosCme(document.getElementById('txtImpConcedido'));
                reemplazarPuntosCme(document.getElementById('txtImpRenuncia'));
                

                <%--MCG--%>
                reemplazarPuntosCme(document.getElementById('txtMinoracion'));
                reemplazarPuntosCme(document.getElementById('txtBaseCC'));
                reemplazarPuntosCme(document.getElementById('txtCoeficienteApli'));
                reemplazarPuntosCme(document.getElementById('txtBaseAETP'));
                reemplazarPuntosCme(document.getElementById('txtPorcFogasa'));
                reemplazarPuntosCme(document.getElementById('txtPorcCoeficiente'));
                reemplazarPuntosCme(document.getElementById('txtPorcAportacion'));
                <%--MCG--%>
                    
                reemplazarPuntosCme(document.getElementById('txtSalarioSub'));
                reemplazarPuntosCme(document.getElementById('txtDietasJusti'));
                reemplazarPuntosCme(document.getElementById('txtMeses'));
                reemplazarPuntosCme(document.getElementById('txtGastosGestion'));
                reemplazarPuntosCme(document.getElementById('txtBonif'));
                reemplazarPuntosCme(document.getElementById('txtImpJustificado'));
                
                suma();
                        
                        
                <%
                if(consulta == true || (puestoConsulta != null && puestoConsulta.getCodResult() != null && puestoConsulta.getCodResult().equalsIgnoreCase(ConstantesMeLanbide46.CODIGO_RESULTADO_RENUNCIA)))
                {
                %>
            ...
            function suma(){
                ...
                var valor = 0.0;
                try{
                    if(a1.value != '' && validarNumericoDecimalCme(a1, 50, 25)){
                        a1 = convertirANumero(a1.value);
                    } else {
                        a1=0;
                    }
                    if(a2.value != '' && validarNumericoDecimalCme(a2, 50, 25)){
                        a2 = convertirANumero(a2.value);
                    } else {
                        a2=0;
                    }
                    if(a3.value != '' && validarNumericoDecimalCme(a3, 50, 25)){
                        a3 = convertirANumero(a3.value);
                    } else {
                        a3=0;
                    }
                    if(a4.value != '' && validarNumericoDecimalCme(a4, 50, 25)){
                    ...
                    if(a10.value != '' && validarNumericoDecimalCme(a10, 50, 25)){
                        a10 = convertirANumero(a10.value);
                    } else {
                        a10=0;
                    }
                    if(a11.value != '' && validarNumericoDecimalCme(a11, 50, 25)){
                        a11 = convertirANumero(a11.value);
                    } else {
                        a11=0;
                    }
                    if(a12.value != '' && validarNumericoDecimalCme(a12, 50, 25)){
                        a12 = convertirANumero(a12.value);
                    } else {
                        a12=0;
                    }
                    if(a13.value != '' && validarNumericoDecimalCme(a13, 50, 25)){
                    ...
                    reemplazarPuntosCme(document.getElementById('txtSegSocial'));
                    var a8 = document.getElementById('txtSegSocial');
                    if(a8.value != '' && validarNumericoDecimalCme(a8, 50, 25)){
                    ...
                    reemplazarPuntosCme(document.getElementById('txtFogasa'));
                    var a6 = document.getElementById('txtFogasa');
                    if(a6.value != '' && validarNumericoDecimalCme(a6, 50, 25)){
                    ...
                    if(a7.value != '' && validarNumericoDecimalCme(a7, 50, 25)){
                    ...
                    reemplazarPuntosCme(document.getElementById('txtCosteCC'));
                    ...
                    reemplazarPuntosCme(document.getElementById('txtCosteTotal'));
                    ...
                    alert("paso 3");
                    reemplazarPuntosCme(document.getElementById('txtCosteCC'));*/
                    reemplazarPuntosCme(document.getElementById('txtSalario'));
                    //COSTE TOTAL
            ...
            function guardar(){
                if(validarDatos()){ 
                    ...
                    barraProgresoCme('on', 'barraProgresoNuevaJustificacion');
                    ...
                    var parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=guardarDatosContratacion&tipo=0&numero=<%=numExpediente%>'
                        ...
                        //+'&radioVariosTrab='+(document.getElementById('radioVariosTrabS').checked ? '<%=ConstantesMeLanbide46.CIERTO%>' : document.getElementById('radioVariosTrabN').checked ? '<%=ConstantesMeLanbide46.FALSO%>' : '')
                        +'&impJustificado='+document.getElementById('txtImpJustificado').value +'&salarioSub='+document.getElementById('txtSalarioSub').value
                        +'&dietasJusti='+document.getElementById('txtDietasJusti').value +'&gastosGestion='+document.getElementById('txtGastosGestion').value
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){                            
                            self.parent.opener.retornoXanelaAuxiliar(listaContrataciones);
                            barraProgresoCme('on', 'barraProgresoNuevaJustificacion');
                    ...
                    barraProgresoCme('off', 'barraProgresoNuevaJustificacion');
                }else{
            ...
            function validarDatos(){
                ...
                try
                {
                    ...
                    if(document.getElementById('txtImpJustificado').value != ''){
                        try{
                            if(!validarNumericoDecimalCme(document.getElementById('txtImpJustificado'), 10, 2)){
                                correcto = false;
                                document.getElementById('txtImpJustificado').style.border = '1px solid red';
                                if(mensajeValidacion == '')
                                    mensajeValidacion = '<%=meLanbide46I18n.getMensaje(idiomaUsuario, "msg.justificacion.resumen.impJustificadoIncorrecto")%>';
                            }else{
            ...
            function mostrarImporteRenuncia(){
                ...
                if(estadoSelec != undefined && estadoSelec != ''){
                    var codigoEstRenuncia = '<%=ConstantesMeLanbide46.CODIGO_ESTADO_RENUNCIA%>';
            ...
            <form  id="formNuevaOferta">
                ...
                <fieldset  style="width: 100%;">
                    ...
                    <div class="lineaFormulario">
                        ...
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasConv" name="txtDietasConv" value="" class="inputTexto readOnly textoNumerico" readonly="true"/>
                        </div>
                        <div style="float: left; width: 150px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.oferta.datosContratado.dietasConvoc")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasConvoc" name="txtDietasConvoc" value="" class="inputTexto readOnly textoNumerico" readonly="true"/>
                        </div>
                    </div>
                    <div class="lineaFormulario">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.fecha")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                        ...
                        <div style="float: left; width: 90px; margin-left: 20px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justif.personaContratada.datosBaja.causa")%>
                        </div>
                ...
                <fieldset  style="width: 100%;">
                    <legend class="legendAzul"><%=meLanbide46I18n.getMensaje(idiomaUsuario,"legend.oferta.resumenJustif")%></legend>
                    <!-- En teoria desaparece, pero por si acaso, en lugar de quitarlo se oculta -->
                    <div class="lineaFormulario" style="display: none;">
                        <div style="float: left; width: 245px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.variosTrab")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            <div style="float: left;">
                                <input type="radio" name="radioVariosTrab" id="radioVariosTrabS" value="S"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.si")%>
                                <input type="radio" name="radioVariosTrab" id="radioVariosTrabN" value="N"><%=meLanbide46I18n.getMensaje(idiomaUsuario, "label.no")%>
                            </div>
                        </div>
                    </div>
                    <!-- En teoria desaparece, pero por si acaso, en lugar de quitarlo se oculta -->
                    ...
                    <div class="lineaFormulario">   
                        ...
                        <div style="float: left; width: 150px; display: none;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.impConcedido")%>
                        </div>
                        ...
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.minoracion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtMinoracion" name="txtMinoracion" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>  
                        
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasTrabajados")%>
                        </div>                         
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="3" size="8" id="txtNumDiasTrab" name="txtNumDiasTrab" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);;" onblur="reemplazarPuntosCme(this);"/>
                        </div>  
                        
                        <div style="float: left; width: 30%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.diasSegSoc")%>
                        </div>  
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="3" size="8" id="txtNumDiasSeg" name="txtNumDiasSeg" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);;" onblur="reemplazarPuntosCme(this); "/>
                        </div>
                        <div style="clear:both;"><br /></div>
                        
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionCC")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtBaseCC" name="txtBaseCC" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.coeficienteAplicado")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtCoeficienteApli" name="txtCoeficienteApli" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 30%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.segSocialEmpresa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtSegSocial" name="txtSegSocial" value="" class="inputTexto readOnly" readonly="true" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salario")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtSalario" name="txtSalario" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="clear:both;"><br /></div>

                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.baseCotizacionATEP")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtBaseAETP" name="txtBaseAETP" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcFogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtPorcFogasa" name="txtPorcFogasa" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.porcCoeficiente")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtPorcCoeficiente" name="txtPorcCoeficiente" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 29%;">&nbsp;</div>
                        <div style="float: left; width: 30%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.fogasa")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtFogasa" name="txtFogasa" value="" class="inputTexto readOnly" readonly="true" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        <!--div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.pocAportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtPorcAportacion" name="txtPorcAportacion" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 29%;">&nbsp;</div-->
                        <div style="float: left; width: 20%;"><!--30%-->
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.aportacion")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtAportacion" name="txtAportacion" value="" class="inputTexto " onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeSS")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtCosteCC" name="txtCosteCC" value="" class="inputTexto readOnly" readonly="true" onchange="reemplazarPuntosCme(this);" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 29%;">&nbsp;</div>
                        <div style="float: left; width: 30%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.costeTotal")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtCosteTotal" name="txtCosteTotal" value="" class="inputTexto readOnly" readonly="true" onchange="reemplazarPuntosCme(this);" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.dietasAbonadas")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtDietasJusti" name="txtDietasJusti" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 10%;">&nbsp;</div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.mesesExterior")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtMeses" name="txtMeses" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.gastosAbonados")%>
                        </div>                             
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtGastosGestion" name="txtGastosGestion" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        
                        
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeBonificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtBonif" name="txtBonif" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <div style="float: left; width: 10%;">&nbsp;</div>
                        <div style="float: left; width: 20%;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.importeJustificado")%>
                        </div>     
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;">
                            <input type="text" maxlength="11" size="8" id="txtImpJustificado" name="txtImpJustificado" value="" class="inputTexto readOnly" readonly="true" onchange="reemplazarPuntosCme(this);" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
<div style="clear:both;"><br /></div>
                        ...
                        <div style="float: left; width: 13%;display: none;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.salarioSub")%>
                        </div>                        
                        <div style="width: auto; float: left; margin-left: 5px; margin-right: 7px;display: none;">
                            <input type="text" maxlength="11" size="8" id="txtSalarioSub" name="txtSalarioSub" value="" class="inputTexto textoNumerico" onchange="reemplazarPuntosCme(this);suma();" onblur="reemplazarPuntosCme(this); ajustarDecimalesImportes();"/>
                        </div>
                        <!-- En teoria desaparece, pero por si acaso, en lugar de quitarlo se oculta -->
                        <div id="divImporteRenuncia" style="display: none;">
                            <div style="float: left; width: 150px; margin-left: 20px;">
                                <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.impRenuncia")%>
                            </div>
                            <div style="width: auto; float: left; margin-left: 10px;">
                    ...
                    <div class="lineaFormulario" style="display: none;">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide46I18n.getMensaje(idiomaUsuario,"label.justificacion.datosResumen.estado")%>
                        </div>
                        <div style="width: auto; float: left; margin-left: 10px;">
                            ...
                            <a id="anchorEstado" name="anchorEstado" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEstado" name="botonEstado" style="cursor:hand;" alt="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></span></a>
                        </div>
                    </div>
                </fieldset>
                <div class="botonera">
                        <input type="button" id="btnGuardar" name="btnGuardar" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="guardar();">
