...
<script type="text/javascript">  
    ...
    tabResumenCpe.addColumna('150','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col12")%>");     
    ...
    tabResumenCpe.addColumna('150','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col18")%>");
    ...
    tabResumenCpe.addColumna('150','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col21")%>");     
    ...
    tabResumenCpe.addColumna('250','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col24")%>");    
    ...
    tabResumenCpe.addColumna('140','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col31")%>");     
    ...
    tabResumenCpe.addColumna('220','right',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.resumen.col34")%>");   
    ...
    tabResumenCpe.scrollWidth = 5200;
