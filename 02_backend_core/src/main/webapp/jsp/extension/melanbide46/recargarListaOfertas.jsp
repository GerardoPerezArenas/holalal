...
<script type="text/javascript" src="<c:url value='/scripts/extension/melanbide46/cmeUtils.js'/>"></script>
    ...
    function actualizarOfertasCme(){
        try{
            ...
            if(codigoOperacion=="0"){
                parent.self.parent.opener.retornoXanelaAuxiliar(  getListaOfertasCme());
