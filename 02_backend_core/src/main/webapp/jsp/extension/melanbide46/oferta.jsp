...
<script type="text/javascript">   
    function pulsarAltaOfertaCme(){
        ...
        var result = null;        
        lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE46&operacion=cargarNuevaOferta&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),600,980,'no','no', function(nodos){
			if (nodos != undefined){
    ...
    function pulsarModificarOfertaCme(){
        ...
        if(tabOfertasCme.selectedIndex != -1) {
            ...
            lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE46&operacion=cargarModificarOferta&tipo=0&numero=<%=numExpediente%>&opcion='+opcion+'&idOferta='+listaOfertasCme[fila][0]+'&idPuesto='+listaOfertasCme[fila][1]+'&control='+control.getTime(),600,980,'yes','no', function(nodos){
				if (nodos != undefined){
					result = extraerListadoOfertasCme(nodos);
					if(result != undefined){
						if(result[0] == '0'){
    ...
    function pulsarEliminarOfertaCme(){
            ...
            if(tabOfertasCme.selectedIndex != -1) {
                ...
                if (resultado == 1){
                    ...
                    parametros = 'tarea=preparar&modulo=MELANBIDE46&operacion=eliminarOferta&tipo=0&numero=<%=numExpediente%>&idOferta='+listaOfertasCme[tabOfertasCme.selectedIndex][0]+'&idPuesto='+listaOfertasCme[fila][1]+'&control='+control.getTime();
                    try{
    ...
    function recargarTablaOfertasCme(result){
        ...
        tabOfertasCme.addColumna('200','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col1")%>");
        tabOfertasCme.addColumna('150','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col2")%>");    
        tabOfertasCme.addColumna('300','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col3")%>");   
        tabOfertasCme.addColumna('100','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col4")%>");   
        tabOfertasCme.addColumna('80','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col5")%>");   
        tabOfertasCme.addColumna('80','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col6")%>");   
        tabOfertasCme.addColumna('80','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col7")%>");   
        tabOfertasCme.addColumna('350','left',"<%= meLanbide46I18n.getMensaje(idiomaUsuario,"label.solicitud.tabla.ofertas.col8")%>");     
...
<body>
    ...
    <div style="clear: both;">
        ...
        <div class="botonera">
            <!--<input type="button" id="btnNuevaOfertaCme" name="btnNuevaOfertaCme" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.alta")%>" onclick="pulsarAltaOfertaCme();">-->
            <input type="button" id="btnModificarOfertaCme" name="btnModificarOfertaCme" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.modificar")%>" onclick="pulsarModificarOfertaCme();">
            <!--<input type="button" id="btnEliminaOfertaCme" name="btnEliminaOfertaCme" class="botonGeneral" value="<%=meLanbide46I18n.getMensaje(idiomaUsuario, "btn.eliminar")%>" onclick="pulsarEliminarOfertaCme();">-->
        </div>
    </div>
</body>
