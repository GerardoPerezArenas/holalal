    ...
    <head> 
        ...
        function buscar(){
            if(validarCriteriosBusqueda()){
                ...
                var parametros = "tarea=preparar&modulo=MELANBIDE30&operacion=busquedaTerceros&tipo=0"
                ...
                tabResultados.addColumna('100','left',"<%= meLanbide30I18n.getMensaje(idiomaUsuario,"busqTerceros.tabla.col1")%>");
                tabResultados.addColumna('417','left',"<%= meLanbide30I18n.getMensaje(idiomaUsuario,"busqTerceros.tabla.col2")%>");
                ...
                jsp_alerta('A', '<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.critBusquedaInsuficientes")%>');
            }
        }
        ...
        <form>
                                        ...
                                        <table width="349px" height="100%">
                                            <tr>
                                                <td colspan="3" style="height:70%;text-align:center;valign:middle;">
                                                    <span><%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.realizandoBusq")%></span>
                                                </td>
                                            </tr>
                                            <tr>
            ...
            <div style="clear: both;">
                <fieldset style="text-align: left; margin: 10px;">
                    <legend><font color="red"><%=meLanbide30I18n.getMensaje(idiomaUsuario,"legend.trabajador")%></font></legend>
                    <div style="width: 100%; clear: both;">
                        <div style="width: 60px; float: left;">
                            <span> <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.dni")%></span>
                        </div>
                    ...
                    <div style="width: 100%; clear: both;">
                        <div style="width: 60px; float: left;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.nombre")%>
                        </div>
                        <div style="width: 480px; float: left;">
                    ...
                    <div style="width: 100%; clear: both;">
                        <div style="width: 60px; float: left;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.ape1")%>
                        </div>
                        <div style="width: 480px; float: left;">
                    ...
                    <div style="width: 100%; clear: both;">
                        <div style="width: 60px; float: left;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.ape2")%>
                        </div>
                        <div style="width: 480px; float: left;">
                    ...
                    <div style="width: 100%; text-align: center; padding-top: 5px;">
                        <input type="button" id="btnBuscar" name="btnBuscar" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.buscar")%>" onclick="buscar();">
                        <input type="button" id="btnLimpiar" name="btnLimpiar" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.limpiar")%>" onclick="limpiar();">
                    </div>
                </fieldset>
                ...
                <div style="width: 100%; text-align: center; padding-top: 5px;">
                    <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="aceptar();">
                    <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cerrarVentana();">
                </div>
            </div>
        </form>
    </body>
