...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide30.i18n.MeLanbide30I18n" %>
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide30.util.ConstantesMeLanbide30" %>
...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide30.vo.ContratoSociosVO"%>
...
<html>
    <head> 
        <%
            ...
            MeLanbide30I18n meLanbide30I18n = MeLanbide30I18n.getInstance();
            ...
            ContratoSociosVO contratoModif = (ContratoSociosVO)request.getAttribute("contratoModif");

            Boolean cerrado = request.getAttribute("cerrado") != null ? (Boolean)request.getAttribute("cerrado") : false;
            String tituloPagina = "";
            if(cerrado)
            {
                tituloPagina = meLanbide30I18n.getMensaje(idiomaUsuario,"label.tituloPagina.consultaContrato");
            }
            else
            {
                if(contratoModif != null)
                {
                    tituloPagina = meLanbide30I18n.getMensaje(idiomaUsuario,"label.tituloPagina.modifContrato");
                }
                else
                {
                    tituloPagina = meLanbide30I18n.getMensaje(idiomaUsuario,"label.tituloPagina.nuevoContrato");
                }
            }
        %>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/extension/melanbide30/melanbide30.css"/>
        ...
        <script type="text/javascript">
            ...
            function inicio(){
                ...
                cargarDatosContratoSocioModif();
                calcularEdadTrabajador();
                //calcularDuracContrato();
                if(navigator.appName.indexOf("Internet Explorer")==-1){
                    document.getElementById('cuerpoNuevoContratoSocio').style.width = '98%';
                }
                ...
                %>
                        ...
                        //Botones
                        document.getElementById('btnGuardarContratoSocio').style.display = 'none';
                        document.getElementById('btnCancelarContratoSocio').style.display = 'none';
            ...
            function cargarDatosContratoSocioModif(){
                //Trabajador
                ...
                document.getElementById('txtSexo').value = '<%=contratoModif != null && contratoModif.getSex() != null ? (contratoModif.getSex() == 1 ? ConstantesMeLanbide30.SEXO_H : ConstantesMeLanbide30.SEXO_M) : ""%>';
                ...
                document.getElementById('checkMinusvalido').checked = '<%=contratoModif != null && contratoModif.getMin() != null && contratoModif.getMin().equalsIgnoreCase(ConstantesMeLanbide30.SI) ? "true" : ""%>';
                document.getElementById('checkInmig').value = '<%=contratoModif != null && contratoModif.getInm() != null ? contratoModif.getInm() : "N"%>';
                document.getElementById('checkInmig').checked = '<%=contratoModif != null && contratoModif.getInm() != null && contratoModif.getInm().equalsIgnoreCase(ConstantesMeLanbide30.SI) ? "true" : ""%>';
                document.getElementById('checkPLD').value = '<%=contratoModif != null && contratoModif.getPld() != null ? contratoModif.getPld() : "N"%>';
                document.getElementById('checkPLD').checked = '<%=contratoModif != null && contratoModif.getPld() != null && contratoModif.getPld().equalsIgnoreCase(ConstantesMeLanbide30.SI) ? "true" : ""%>';
                document.getElementById('checkRML').value = '<%=contratoModif != null && contratoModif.getRml() != null ? contratoModif.getRml() : "N"%>';
                document.getElementById('checkRML').checked = '<%=contratoModif != null && contratoModif.getRml() != null && contratoModif.getRml().equalsIgnoreCase(ConstantesMeLanbide30.SI) ? "true" : ""%>';
                document.getElementById('checkOtro').value = '<%=contratoModif != null && contratoModif.getOtr() != null ? contratoModif.getOtr() : "N"%>';
                document.getElementById('checkOtro').checked = '<%=contratoModif != null && contratoModif.getOtr() != null && contratoModif.getOtr().equalsIgnoreCase(ConstantesMeLanbide30.SI) ? "true" : ""%>';
                ...
                document.getElementById('txtPorJornada').value = '<%=contratoModif != null && contratoModif.getPjt() != null ? contratoModif.getPjt().toString() : ""%>';
                document.getElementById('codTipConDur').value = '<%=contratoModif != null && contratoModif.getTco() != null ? contratoModif.getTco().toString() : ""%>';
                document.getElementById('salarioBruto').value = '<%=contratoModif != null && contratoModif.getSal() != null ? contratoModif.getSal().toString() : ""%>';
                document.getElementById('codCNOE').value = '<%=contratoModif != null && contratoModif.getCnoe() != null ? contratoModif.getCnoe() : ""%>';
                document.getElementById('segSocial').value = '<%=contratoModif != null && contratoModif.getCss() != null ? contratoModif.getCss().toString() : ""%>';
                document.getElementById('codColectivo').value = '<%=contratoModif != null && contratoModif.getCol() != null ? contratoModif.getCol().toString() : ""%>';
                
                //Importe Subvención
                document.getElementById('concedido').value = '<%=contratoModif != null && contratoModif.getImp() != null ? contratoModif.getImp() : ""%>';
                document.getElementById('modifRes').value = '<%=contratoModif != null && contratoModif.getImr() != null ? contratoModif.getImr() : ""%>';
                document.getElementById('recurso').value = '<%=contratoModif != null && contratoModif.getIre() != null ? contratoModif.getIre() : ""%>';
            ...
            function mostrarBusqueda(){
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide30/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),500,600,'no','no');
                }else{
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/jsp/extension/melanbide30/buscadorTerceros.jsp?tipo=<%=codOrganizacion%>&control='+control.getTime(),550,600,'no','no');
                }
                if (result != undefined){
            ...
            function comprobarFechaNac(inputFecha) {
                if (Trim(inputFecha.value)!='') {
                    if (!ValidarFechaConFormato(document.forms[0],inputFecha)){
                        jsp_alerta("A","<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>");
                        return false;
                    }
                    else{
                        ...
                        if(array_fecha.length == 3)
                        {
                            ...
                            var result = n1 - n2;
                            /*if(n2 <= 0){
                                jsp_alerta("A","<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fechaNacPosterior")%>");
                                return false;
                            }*/
                            if(result < 0){
                                jsp_alerta("A","<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fechaNacPosterior")%>");
            ...
            /*function calcularDuracContrato(){
                //Se calcula restando la fecha de alta  y la fecha de baja
                var feAlta = document.getElementById('fechaAlta').value;
                var feBaja = document.getElementById('fechaBaja').value;
                if(feAlta != null && feAlta != '' && feBaja != null && feBaja != ''){
                    ...
                    if(diferencia < 0){
                        jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fAltaAntFBaja")%>');
                    }
                    ...
                    if(!isNaN(numMeses) && numMeses != null && numMeses >= 0 && numMeses <= 99999)
                        document.getElementById('txtDuracionContrato').value = numMeses;
                    else
                        document.getElementById('txtDuracionContrato').value = '';
                }
                else{
                    document.getElementById('txtDuracionContrato').value = '';
                }
            ...
            function crearContratoSocio(){
                if(validarDatos()){
                    ...
                    var nuevo = '<%=nuevo%>';
                    if(nuevo != null && nuevo == '1'){
                        parametros = "tarea=preparar&modulo=MELANBIDE30&operacion=crearContrato&tipo=0&numero=<%=numExpediente%>"
                        ...
                        parametros = "tarea=preparar&modulo=MELANBIDE30&operacion=modificarContrato&tipo=0&numero=<%=numExpediente%>"
                    ...
                    try{
                        ...
                        if(codigoOperacion=="0"){
                            jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario,"msg.datosGuardadosOK")%>');
                            window.returnValue =  listaContratos;
                            cerrarVentana();
                        }else if(codigoOperacion=="1"){
                            jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario,"error.errorBD")%>');
                        }else if(codigoOperacion=="2"){
                            jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        }else if(codigoOperacion=="3"){
                            jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                        }else{
                                jsp_alerta("A",'<%=meLanbide30I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                        }//if(
                    }
            ...
            function validarDatosTrabajador(){
                ...
                if(dni == null || dni == ''){
                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.camposRojosOblig")%>";
                    return false;
                }
                ...
                if(!validarNIF(document.getElementById('txtDni'))){
                    ...
                    if(msgValidacion == '')
                        msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.dniNoVal")%>";
                    correcto = false;
                }else{
                    if(!comprobarCaracteresEspeciales(document.getElementById('txtDni').value)){
                        document.getElementById('txtDni').style.border = '1px solid red';
                        if(msgValidacion == "")
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "dniCaracteresNoPermitidos")%>";
                        correcto = false;
                    }else{
                        document.getElementById('txtDni').removeAttribute("style");
                    }
                ...
                if(!comprobarCaracteresEspeciales(document.getElementById('txtNom').value)){
                    ...
                    if(msgValidacion == "")
                        msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "nomApelCaracteresNoPermitidos")%>";
                    correcto = false;
                }else{
                ...
                if(!validarFecha(document.getElementById('fechaNacimiento'))){
                    ...
                    if(msgValidacion == '')
                        msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fechaNacNoVal")%>";
                    correcto = false;
                }
                else{
                    var feNac = document.getElementById('fechaNacimiento').value;
                ...
                if(document.getElementById('txtMesesDesempleo').value != null && document.getElementById('txtMesesDesempleo').value != ''){
                    if(!validarNumerico(document.getElementById('txtMesesDesempleo'))){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.mesesDesempleoNoVal")%>";
                        correcto = false;
                    }
                    else{
                        try{
                            ...
                            if(meses < 0 || meses > 999){
                                document.getElementById('txtMesesDesempleo').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.mesesDesempleoFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('txtMesesDesempleo').removeAttribute("style");
                            }
                ...
                if(nivel != null && nivel != ''){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.nivelEstudiosNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codEstudios').removeAttribute("style");
            ...
            var correcto = true;
                ...
                if(!validarFecha(document.getElementById('fechaAlta'))){
                    ...
                    if(msgValidacion == '')
                        msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.fechaAltaNoVal")%>";
                    correcto = false;
                }
                else{
                    document.getElementById('fechaAlta').removeAttribute("style");
                ...
                if(document.getElementById('txtDuracionContrato').value != null && document.getElementById('txtDuracionContrato').value != ''){
                    if(!validarNumerico(document.getElementById('txtDuracionContrato'))){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.durContratoNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(meses > 99999 || meses < 0){
                                document.getElementById('txtDuracionContrato').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.durContratoFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('txtDuracionContrato').removeAttribute("style");
                            }
                ...
                if(tipoContrato != null && tipoContrato != ""){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.tipoContratoNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codTipoContrato').removeAttribute("style");
                ...
                if(tipoJor != null && tipoJor != ""){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.tipoJorNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codTipoJornada').removeAttribute("style");
                ...
                if(document.getElementById('txtPorJornada').value != null && document.getElementById('txtPorJornada').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('txtPorJornada'), 5, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.porJornadaNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(porcentaje > 100 || porcentaje < 0){
                                document.getElementById('txtPorJornada').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.porJornadaFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('txtPorJornada').removeAttribute("style");
                            }
                ...
                if(tipo != null && tipo != ""){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.tipConDurNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codTipConDur').removeAttribute("style");
                ...
                if(document.getElementById('salarioBruto').value != null && document.getElementById('salarioBruto').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('salarioBruto'), 12, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.salarioNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(retrib >= 10000000000 || retrib < 0){
                                document.getElementById('salarioBruto').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.salarioFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('salarioBruto').removeAttribute("style");
                            }
                ...
                if(cnoe != null && cnoe != ""){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.cnoeNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codCNOE').removeAttribute("style");
                ...
                if(document.getElementById('segSocial').value != null && document.getElementById('segSocial').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('segSocial'), 12, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.segSocialNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(retrib >= 10000000000 || retrib < 0){
                                document.getElementById('segSocial').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.segSocialFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('segSocial').removeAttribute("style");
                            }
                ...
                if(col != null && col != ""){
                    ...
                    if(!encontrado){
                        ...
                        if(msgValidacion == "")
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.colectivoNoVal")%>";
                        correcto = false;
                    }
                    else{
                        document.getElementById('codColectivo').removeAttribute("style");
            ...
            function validarImporteSubvencion(){
                ...
                if(document.getElementById('concedido').value != null && document.getElementById('concedido').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('concedido'), 12, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.concedidoNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(retrib >= 10000000000 || retrib < 0){
                                document.getElementById('concedido').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.concedidoFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('concedido').removeAttribute("style");
                            }
                ...
                if(document.getElementById('modifRes').value != null && document.getElementById('modifRes').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('modifRes'), 12, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.modifResNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(retrib >= 10000000000 || retrib < 0){
                                document.getElementById('modifRes').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.modifResFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('modifRes').removeAttribute("style");
                            }
                ...
                if(document.getElementById('recurso').value != null && document.getElementById('recurso').value != ''){
                    if(!validarNumericoDecimal(document.getElementById('recurso'), 12, 2)){
                        ...
                        if(msgValidacion == '')
                            msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.recursoResNoVal")%>";
                        correcto = false;
                    }else{
                        try
                        {
                            ...
                            if(retrib >= 10000000000 || retrib < 0){
                                document.getElementById('recurso').style.border = '1px solid red';
                                if(msgValidacion == '')
                                    msgValidacion = "<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.recursoResFueraRango")%>";
                                correcto = false;
                            }else{
                                document.getElementById('recurso').removeAttribute("style");
                            }
            ...
            function cancelar(){
                var resultado = jsp_alerta("","<%=meLanbide30I18n.getMensaje(idiomaUsuario, "msg.preguntaCancelar")%>");
                if (resultado == 1){
                    cerrarVentana();
                }
            }
    ...
    <body id="cuerpoNuevoContratoSocio" style="margin: 10px; text-align: left;" class="contenidoPantalla">
        <form  id="formNuevoContratoSocio">
            <fieldset  style="width: 96.5%;">
                <legend><%=meLanbide30I18n.getMensaje(idiomaUsuario,"legend.trabajador")%></legend>
                <div style="width: 100%; clear: both;">
                    <div style="float: left; width: 170px;">
                        <font color="red"><%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.dni")%></font>
                        <input type="text" size="16" maxlength="25" id="txtDni" name="txtDni" disabled="disabled" value=""/>
                    </div>
                    <div style="float: left; width: 740px;">
                        <font color="red"><%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.nombreApel")%></font>
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;" id="divBtnBuscar">
                    <input type="button" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.buscar")%>..." onclick="mostrarBusqueda();"/>
                </div>
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 170px;">
                        <font color="red"><%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.fNac")%></font>
                        ...
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaNacimiento(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaNac" name="calFechaNac" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.fNac")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                    <div style="float: left; width: 170px;">
                       <font color="red"><%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.sexo")%></font>
                        <input type="text" maxlength="1" size="2" id="txtSexo" name="txtSexo" value="" onkeyup="comprobarSexo(this);" style="margin-left: 27px;"/>
                    </div>
                    <div style="float: left; width: 245px;">
                       <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.mesesDesempleo")%>
                    ...
                    <div style="float: left; width: 322px;">
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.nEstudios")%>
                        ...
                        <input id="descEstudios"	name="descEstudios" type="text" class="inputTexto" size="28" readonly >
                         <a id="anchorEstudios" name="anchorEstudios" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonEstudios" name="botonEstudios" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                </div>
                <div style="width: 100%; clear: both; padding-top: 5px; text-align: center;">
                    <div style="float: left; width: 20%; text-align: center;">
                        ...
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.minusvalido")%>
                    </div>
                    <div style="float: left; width: 20%; text-align: center;">
                        ...
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.inmig")%>
                    </div>
                    <div style="float: left; width: 20%; text-align: center;">
                        ...
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.PLD")%>
                    </div>
                    <div style="float: left; width: 20%; text-align: center;">
                        ...
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.RML")%>
                    </div>
                    <div style="float: left; width: 20%; text-align: center;">
                        ...
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.otro")%>
                    </div>
                </div>
            </fieldset>
            <fieldset  style="width: 96.5%;">
                <legend><%=meLanbide30I18n.getMensaje(idiomaUsuario,"legend.datosContrato")%></legend>
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 330px;">
                        <div style="float: left; width: 120px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.fAlta")%>
                        </div>
                        ...
                        <A href="javascript:calClick(event);" onclick="mostrarCalFechaAlta(event);return false;" style="text-decoration:none;" >
                            <IMG style="border: 0" height="17" id="calFechaAlta" name="calFechaAlta" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.fAlta")%>" src="<c:url value='/images/calendario/icono.gif'/>">
                        </A>
                    </div>
                    <div style="float: left; width: 300px;">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.edad")%>
                        </div>
                        <input type="text" disabled size="3" id="txtEdad" name="txtEdad"/>
                    </div>
                    <div style="float: left; width: 280px;" class="oculto">
                        <div style="float: left; width: 185px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.duracionContrato")%>
                        </div>
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;" class="oculto">
                    <div style="float: left; width: 330px;">
                        <div style="float: left; width: 120px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.tipoContrato")%>
                        </div>
                        ...
                        <input id="descTipoContrato" name="descTipoContrato" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipoContrato" name="anchorTipoContrato" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoContrato" name="botonTipoContrato" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 300px;">
                        <div style="float: left; width: 90px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.tipoJornada")%>
                        </div>
                        ...
                        <input id="descTipoJornada" name="descTipoJornada" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipoJornada" name="anchorTipoJornada" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipoJornada" name="botonTipoJornada" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.porJornada")%>
                        </div>
                        <input type="text" maxlength="6" size="6" id="txtPorJornada" name="txtPorJornada" style="padding-left: 1px;" onchange="reemplazarPuntos(this);" value=""/>
                    </div>
                </div>
                <div style="width: 100%; clear: both; padding-top: 5px;" class="oculto">
                    <div style="float: left; width: 630px;">
                        <div style="float: left; width: 120px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.tipConDurAbrev")%>
                        </div>
                        ...
                        <input id="descTipConDur" name="descTipConDur" type="text" class="inputTexto" size="20" readonly >
                         <a id="anchorTipConDur" name="anchorTipConDur" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonTipConDur" name="botonTipConDur" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.salarioBruto")%>
                        </div>
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;" class="oculto">
                    <div style="float: left; width: 630px;">
                        <div style="float: left; width: 120px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.cnoe")%>
                        </div>
                        ...
                        <input id="descCNOE" name="descCNOE" type="text" class="inputTexto" size="70" readonly >
                         <a id="anchorCNOE" name="anchorCNOE" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonCNOE" name="botonCNOE" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;">
                        <div style="float: left; width: 185px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.segSocial")%>
                        </div>
                ...
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 630px;">
                        <div style="float: left; width: 120px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.colectivo")%>
                        </div>
                        ...
                        <input id="descColectivo" name="descColectivo" type="text" class="inputTexto" size="70" readonly >
                         <a id="anchorColectivo" name="anchorColectivo" href=""><img src="<%=request.getContextPath()%>/images/listas/botondesplegable.gif" id="botonColectivo" name="botonColectivo" border="0" width="14" height="14" style="cursor:hand;" alt="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>" title="<%=meLanbide30I18n.getMensaje(idiomaUsuario, "altDesplegable")%>"></a>
                    </div>
                    <div style="float: left; width: 280px;" class="oculto">
                        <div style="float: left; width: 185px;">
                            <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.costeSalarial")%>
                        </div>
            ...
            <fieldset  style="width: 96.5%;">
                <legend><%=meLanbide30I18n.getMensaje(idiomaUsuario,"legend.importe")%></legend>
                <div style="width: 100%; clear: both; padding-top: 5px;">
                    <div style="float: left; width: 33%; text-align: center;">
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.concedido")%>
                    ...
                    <div style="float: left; width: 33%; text-align: center;">
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.modifRes")%>
                    ...
                    <div style="float: left; width: 33%; text-align: center;">
                        <%=meLanbide30I18n.getMensaje(idiomaUsuario,"label.recurso")%>
            ...
            <div style="width: 100%; text-align: center; padding-top: 5px;">
                <input type="button" id="btnGuardarContratoSocio" name="btnGuardarContratoSocio" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.aceptar")%>" onclick="crearContratoSocio();">
                <input type="button" id="btnCancelarContratoSocio" name="btnCancelarContratoSocio" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.cancelar")%>" onclick="cancelar();">
                <input type="button" id="btnCerrar" name="btnCerrar" class="botonGeneral" value="<%=meLanbide30I18n.getMensaje(idiomaUsuario,"btn.cerrar")%>" onclick="cerrarVentana();">
            </div>
        </form>
