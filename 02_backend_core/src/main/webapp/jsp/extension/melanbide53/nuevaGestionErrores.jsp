...
<head>
    ...
    <%
        ...
        try
        {
            ...
            if(request.getAttribute("datModif") != null)
            {
                ...
                fechaError = datModif.getFechaError()!=null ? datModif.getFechaError().substring(0,19):"";
    ...
    <script type="text/javascript">
        ...
        function  cargarDatosCheck() {
            ...
            var impactoE = '<%=datModif.getImpacto()!=null ? datModif.getImpacto() : ""%>';
            var tratadoE = '<%=datModif.getTratado()!= null ? datModif.getTratado() : ""%>';
            ...
            if (impactoE != null && impactoE == '<%=ConstantesMeLanbide53.STANDFOR_SI_S%>') {
                document.getElementById("ck_impacto").checked = true;
            } else {
                document.getElementById("ck_impacto").checked = false;
            }
            if (tratadoE != null && tratadoE == '<%=ConstantesMeLanbide53.STANDFOR_SI_S%>') {
                document.getElementById("ck_tratado").checked = true;
            } else {
                document.getElementById("ck_tratado").checked = false;
            }
        }
            ...
            if (validarDatos()) {
                ...
                if (nuevo != null && nuevo == "1") {
                    parametros = "tarea=preparar&modulo=MELANBIDE53&operacion=crearNuevaGestionError&tipo=0"
                            ...
                            + "&ck_impacto=" + prepararFiltroChecked('ck_impacto')
                            + "&ck_tratado=" + prepararFiltroChecked('ck_tratado')
                            ;
...
//                            + "&ck_notificado=" + prepararFiltroChecked('ck_notificado')
        ...
        function validarDatos() {
            ...
            if (observaciones != null && observaciones != '') {
                if (!compruebaTamanoCampo(document.getElementById('observaciones_revision'), 400000)) {
                    mensajeValidacion = '<%=meLanbide53I18n.getMensaje(idiomaUsuario, "msg.errExcdTexto")%>' + ' 40000 Caracteres.';
                    return false;
                }
            }
            return correcto;
        ...
        function pulsarLinkDetalleError() {
            var id_error = document.getElementById("identificador_error").value;
            if (id_error != null && id_error != "") {
                var control = new Date();
                var result = null;
                if (navigator.appName.indexOf("Internet Explorer") != -1) {
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE53&operacion=cargarPantallaDetallesIDError&tipo=0&visible=false&nuevo=0&idError=' + id_error + '&control=' + control.getTime(), 750, 750, 'no', 'yes');
                } else {
                    result = lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE53&operacion=cargarPantallaDetallesIDError&tipo=0&visible=false&nuevo=0&idError=' + id_error + '&control=' + control.getTime(), 750, 750, 'no', 'yes');
                }
//                        if (result != undefined) {
...
//                        }
                ...
                jsp_alerta('A', '<%=meLanbide53I18n.getMensaje(idiomaUsuario, "msg.detalleError")%>');
            }
        }
            ...
            <div style="width: 100%; padding: 10px; text-align: left;">
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            ...
                            <A href="javascript:calClick(event);return false;"  onClick="mostrarCalFechaError(event);
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <div style="width: 450px; float: left;">
                                <div style="float: left;">
                                    <textarea readonly class="inputTextoM53" rows="3" cols="100" id="mensaje_error" name="mensaje_error" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getMensajeError() != null ? datModif.getMensajeError()  : ""%></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <div style="width: 450px; float: left;">
                                <div style="float: left;">
                                    <textarea readonly class="inputTextoM53" rows="3" cols="100" id="causa_error" name="causa_error" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getCausaException() != null ? datModif.getCausaException()  : ""%></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <textarea readonly class="inputTextoM53" rows="3" cols="100" id="mensaje_exception" name="mensaje_exception" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getMensajeException() != null ? datModif.getMensajeException()  : ""%></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <textarea readonly class="inputTextoM53" rows="5" cols="100" id="traza" name="traza" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getTrazaError() != null ? datModif.getTrazaError()  : ""%></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        ...
                        <div class="botonera" style="float:right;">
                            <input type="button" id="btnDetalle" name="btnDetalle" class="botonMasLargo" value="<%=meLanbide53I18n.getMensaje(idiomaUsuario, "btn.detalle")%>" onclick="pulsarLinkDetalleError();"/>
                        </div>                      
                        <div>
                        </div>                    
                    </div>
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input readonly id="numero_expediente" name="numero_expediente" type="text" class="inputTextoM53" size="50" maxlength="100" 
                                   value="<%=datModif != null && datModif.getNumeroExpediente() != null ? datModif.getNumeroExpediente() : ""%>"/>
                        </div>
                    </div>
                </div>
                <br><br>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.fretramitacion")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input readonly id="fechaRetramitacion" name="fechaRetramitacion" type="text" class="inputTextoM53" size="30" maxlength="25" 
                                   value="<%=datModif != null && datModif.getFechaRetramitacion() != null ? datModif.getFechaRetramitacion() : ""%>"/>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.rRetramitacion")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input readonly id="idprocedimiento" name="idprocedimiento" type="text" class="inputTextoM53" size="30" maxlength="25" 
                                   value="<%=datModif.getResultadoRetramitacion()!=null?datModif.getResultadoRetramitacion():""%>"/>
                        </div>
                    </div>
                </div>
                <br><br>
                ...
                <div class="lineaFormulario">
                    <div style="width: 190px; float: left;" class="etiqueta">
                        <%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.retramitadoxml")%>
                    </div>
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <textarea readonly class="inputTextoM53"  rows="3" cols="100" id="mensaje_error" name="mensaje_error" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getXmlReglasSolicitud() != null ? datModif.getXmlReglasSolicitud() : "" %></textarea>
                ...
                <br><br>
                <!--Fin campo 3-->
                <fieldset style="border: 1px darkgrey solid; margin-top: 30px;">
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha" 
                                       ...
                                       onblur = "javascript:return comprobarFechaLanbide(this);"
                                       onfocus="javascript:this.select();"/>
                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaRevision(event);
                    ...
                    <div class="lineaFormulario" style="margin: 2px">
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <div style="width: 450px; float: left;">
                                    <div style="float: left;">
                                        <textarea class="inputTextoM53" rows="5" cols="100" id="observaciones_revision" name="observaciones_revision" maxlength="4000" onblur="compruebaTamanoCampo(this, 4000)"><%=datModif != null && datModif.getObservacionesError() != null ? datModif.getObservacionesError()  : ""%></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lineaFormulario" style="margin: 2px">
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <label class="etiqueta"><%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.impacto")%></label>
                                <input id="ck_impacto" name="ck_impacto" type="checkbox" value="<%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.impacto")%>">
                            </div>
                        </div>
                    ...
                    <div class="lineaFormulario" style="margin: 2px">
                        ...
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <label class="etiqueta"><%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.tratado")%></label>
                                <input id="ck_tratado" name="ck_tratado" type="checkbox" value="<%=meLanbide53I18n.getMensaje(idiomaUsuario,"label.error.tratado")%>">
                            </div>
                        </div>
                    </div>
                    <br>
