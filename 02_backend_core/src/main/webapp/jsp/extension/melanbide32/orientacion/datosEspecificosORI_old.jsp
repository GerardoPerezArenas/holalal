...
<script type="text/javascript">
        ...
        function pulsarAltaUbicacionORI(){
            ...
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                	lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaSolicitudORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),600,820,'no','no', function(result){
							if (result != undefined){
								if(result[0] == '0'){
        ...
        function pulsarModificarUbicacionORI(){
            if(tabUbicacionesOri.selectedIndex != -1) {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifSolicitudORI&tipo=0&numero=<%=numExpediente%>&idUbic='+listaUbicacionesOri[tabUbicacionesOri.selectedIndex][0]+'&control='+control.getTime(),600,820,'no','no', function(result){
							if (result != undefined){
								if(result[0] == '0'){
									recargarTablaUbicaciones(result);								
								}
        ...
        function pulsarValorarUbicacionORI(){
            if(tabUbicacionesOri.selectedIndex != -1) {
                var control = new Date();
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarValorarSolicitudORI&tipo=0&numero=<%=numExpediente%>&idUbic='+listaUbicacionesOri[tabUbicacionesOri.selectedIndex][0]+'&control='+control.getTime(),600,820,'no','no', function(result){
							if (result != undefined){
								if(result[0] == '0'){
									recargarTablaUbicaciones(result);								
								}
        ...
        function pulsarAltaTrayectoriaORI(){
            ...
            var result = null;
            if(navigator.appName.indexOf("Internet Explorer")!=-1){
                lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarNuevaTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&control='+control.getTime(),600,800,'no','no', function(result){
							if (result != undefined){
								if(result[0] == '0'){
        ...
        function pulsarModificarTrayectoriaORI(){
            if(tabTrayectoriaOri.selectedIndex != -1) {
                ...
                var result = null;
                if(navigator.appName.indexOf("Internet Explorer")!=-1){
                    lanzarPopUpModal('<%=request.getContextPath()%>/PeticionModuloIntegracion.do?tarea=preparar&modulo=MELANBIDE32&operacion=cargarModifTrayectoriaORI&tipo=0&numero=<%=numExpediente%>&idTray='+listaTrayectoriaOri[tabTrayectoriaOri.selectedIndex][0]+'&control='+control.getTime(),600,800,'no','no', function(result){
							if (result != undefined){
								if(result[0] == '0'){
									recargarTablaTrayectoria(result);								
								}
