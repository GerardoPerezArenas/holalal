    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function validarDatos() {
                ...
                if (horas != null && horas != '') {
                    if (!validarNumericoDecimalPrecisionRgcfm(horas, 8, 2)) {
                ...
                if (alumnos != null && alumnos.value != '') {
                    if (!validarNumericoRgcfm(alumnos)) {
                ...
                <div class="lineaFormulario">
                    ...
                    <div style="width: 450px; float: left;">
                        <div style="float: left;">
                            <input id="codcp" name="codcp" type="text" class="inputTexto" size="15" maxlength="12" readonly="true"
