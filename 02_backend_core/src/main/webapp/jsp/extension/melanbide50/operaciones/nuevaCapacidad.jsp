        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE50&operacion=crearCapacidad&tipo=0&numero=<%=numExpediente%>"
                                + "&identificacionespfor=" + document.getElementById('identificacionespfor').value
                                + "&ubicacion=" + document.getElementById('ubicacion').value
                                + "&superficie=" + document.getElementById('superficie').value
                                + "&idEpsol=<%=datoEspecialidad.getId()%>";

                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE50&operacion=modificarCapacidad&tipo=0&numero=<%=numExpediente%>"
                    ...
                    try {
                        ...
                        if (codigoOperacion == "0") {
                            self.parent.opener.retornoXanelaAuxiliar(listaCapacidad);
                            cerrarVentana();
            ...
            function validarDatos() {
                ...
                if (ubicacion == null || ubicacion == '') {
                    mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "capacidad.msg.ubicacion")%>';
                    return false;
                } else {
                ...
                if (superficie == null || superficie == '') {
                    mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "capacidad.msg.superficie")%>';
                    return false;
                } else
                {
                    if (!validarNumericoDecimalPrecisionRgcfm(document.getElementById('superficie'), 6, 2)) {
                        mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "capacidad.msg.superficie.errDecimal")%>';
                        return false;
                    }
                }
                return correcto;
            ...
            <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.capacidad.nuevaCapacidad")%>
                        </span>
                    </div>
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.capacidad.identificacionespfor")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.capacidad.ubicacionPlano")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 190px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.capacidad.superficie")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
