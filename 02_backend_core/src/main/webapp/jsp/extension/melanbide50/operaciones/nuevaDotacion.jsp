    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if (nuevo != null && nuevo == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE50&operacion=crearDotacion&tipo=0&numero=<%=numExpediente%>"
                                + "&cantidad=" + document.getElementById('cantidad').value
                                + "&denominacionET=" + document.getElementById('denominacionET').value
                                + "&meLanbide50FechaAdqui=" + document.getElementById('meLanbide50FechaAdqui').value
                                + "&idEpsol=<%=datoEspecialidad.getId()%>";

                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE50&operacion=modificarDotacion&tipo=0&numero=<%=numExpediente%>"
                    ...
                    try {
                        ...
                        if (codigoOperacion == "0") {
                            self.parent.opener.retornoXanelaAuxiliar(listaDotacion);
                            cerrarVentana();
            ...
            function validarDatos() {
                ...
                {
                    if (!validarNumericoRgcfm(document.getElementById('cantidad'))) {
                        mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "dotacion.msg.cantidad.errInteger")%>';
                        return false;
                    }
                }
                ...
                var meLanbide50FechaAdqui = document.getElementById('meLanbide50FechaAdqui').value;
                if (meLanbide50FechaAdqui == null || meLanbide50FechaAdqui == '') {
                    mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "dotacion.msg.superficie")%>';
                    return false;
                } else
                {
                    if (!comprobarFechaLanbide(document.getElementById('meLanbide50FechaAdqui'))) {
                        mensajeValidacion = '<%=meLanbide50I18n.getMensaje(idiomaUsuario, "dotacion.msg.meLanbide50FechaAdqui.errFormatoFec")%>';
                        return false;
                    }
                }
                return correcto;
            ...
            function comprobarFechaLanbide(inputFecha) {
                ...
                if (Trim(inputFecha.value) != '') {
                    ...
                    if (!D[0]) {
                        jsp_alerta("A", "<%=meLanbide50I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>");
            ...
            function mostrarCalFechaAdqui(evento) {
                if (window.event)
                    evento = window.event;
                if (document.getElementById("calMeLanbide50FechaAdqui").src.indexOf("icono.gif") != -1)
                    showCalendar('forms[0]', 'meLanbide50FechaAdqui', null, null, null, '', 'calMeLanbide50FechaAdqui', '', null, null, null, null, null, null, null, null, evento);
            ...
            <form>  <!-- action="/PeticionModuloIntegracion.do" method="POST" -->
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.dotacion.nuevaDotacion")%>
                        </span>
                    </div>
                    <div class="lineaFormulario">
                        <div style="width: 200px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.dotacion.cantidad")%>
                        </div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 200px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.dotacion.denominacionET")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 200px; float: left;" class="etiqueta">
                            <%=meLanbide50I18n.getMensaje(idiomaUsuario,"label.dotacion.fechaAdqui")%>
                        </div>
                        <div style="width: 450px; float: left;">
                            <div style="float: left;">
                                <input type="text" class="inputTxtFecha" 
                                       id="meLanbide50FechaAdqui" name="meLanbide50FechaAdqui"
                                       maxlength="10"  size="10"
                                       value="<%=fechaAdqui%>"
                                       onkeyup = "return SoloCaracteresFechaLanbide(this);"
                                       onblur = "javascript:return comprobarFechaLanbide(this);"
                                       onfocus="javascript:this.select();"/>
                                <A href="javascript:calClick(event);return false;" onClick="mostrarCalFechaAdqui(event);
                                        return false;" style="text-decoration:none;">  
                                    <IMG style="border: 0px solid" height="17" id="calMeLanbide50FechaAdqui" name="calMeLanbide50FechaAdqui" border="0" 
