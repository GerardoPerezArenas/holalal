...
<div class="contenidoPantalla">
    ...
    <TABLE id ="tablaDatosGral" style="display: none;">
        <tr>
            <td style="width: 13.6%" class="etiqueta"><%=descriptor.getDescripcion("gEtiq_Organizacion")%>:</td>
            <td class="columnP">
            ...
            <td class="columnP">
                ...
                <input type="text" id="obligatorio" class="inputTextoObligatorio" name="descEntidades" style="width:301px;height:17px" readonly/>
        ...
        <TABLE id ="tablaDatosGral">
            <tr>    
            <td style="width: 13.5%" class="etiqueta"><%=meLanbide06I18n.getMensaje(idioma,"label.formularioGestionAvisos.asuntoRegistro")%>:</td>
            <td class="columnP">
        ...
        <TABLE id ="tablaDatosGral">
            <tr>
                <td style="width: 13.5%" class="etiqueta"><%=descriptor.getDescripcion("gEtiqProc")%>:</td>
                <td class="columnP">
        ...
        <TABLE id ="tablaDatosGral">
         <tr>
            <td style="width: 13.6%" class="etiqueta"><%=descriptor.getDescripcion("gEtiq_unidOrg")%>:</td>
            <td class="columnP">
        ...
        <TABLE id ="tablaDatosGral">    
            <tr>
                <td style="width: 13.5%" class="etiqueta"><%=descriptor.getDescripcion("etiq_evento")%>:</td>
                <td class="columnP">
        ...
        <TABLE id ="tablaDatosGral">    
            <tr>
                <td style="width: 13.9%;" class="etiqueta"><%=meLanbide06I18n.getMensaje(idioma,"label.formularioGestionAvisos.direccionEmail")%>:</td>
                <td class="columnP">
                    <input style="width:859px;height:17px;text-transform:none;" type="text" id="desEmail" maxlength="150" class="inputTextoObligatorio" name="desEmail" size="2"/>
                </td>
            </tr>  
        </table>            
        <TABLE id ="tablaDatosGral">    
            <tr> 
                <td style="width: 13.9%;padding-top: 0.5%;" class="etiqueta"><%=meLanbide06I18n.getMensaje(idioma,"label.formularioGestionAvisos.asuntoEmail")%>:</td>
                <td class="columnP" style="width: 86.6%;">
                    <input style="width:859px;height:17px;text-transform:none;" type="text" id="desAsunto" maxlength="150" class="inputTextoObligatorio" name="desAsunto" size="2"/>
                </td>
            </tr>  
        </table>
        <TABLE id ="tablaDatosGral">    
            <tr> 
                <td style="width: 14%" class="etiqueta"><%=meLanbide06I18n.getMensaje(idioma,"label.formularioGestionAvisos.contenidoEmail")%>:</td>
                <td class="columnP">
                    <textarea style="width:858px;resize:none;text-transform:none;" rows="6" type="text" id="desContenido" maxlength="500" class="inputTextoObligatorio" name="desContenido"></textarea>
                </td>
            </tr>  
        </table>    
        <TABLE id ="tablaDatosGral" style="padding-bottom: 1%;">    
            <tr> 
