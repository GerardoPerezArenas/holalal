...
<html>
    <head>
        <title>Mantenimiento de Socios</title>
	<meta http-equiv="X-UA-Compatible" content="IE=Edge" />
        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if ('<%=nuevo%>' != null && '<%=nuevo%>' == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE69&operacion=crearNuevoSocio&tipo=0";
                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE69&operacion=modificarSocio&tipo=0"
            ...
            function validarDatos() {
                ...
                if (campo.value != null && campo.value != '') {
                    if (!validarDniNie(campo)) {
                        mensajeValidacion = '<%=meLanbide69I18n.getMensaje(idiomaUsuario, "msg.documentoIncorrecto")%>';
                        return false;
                    }
                } else {
                    mensajeValidacion = '<%=meLanbide69I18n.getMensaje(idiomaUsuario, "msg.documentoObligatorio")%>';
                    return false;
                }
                campo = document.getElementById('nombre').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide69I18n.getMensaje(idiomaUsuario, "msg.nombre")%>';
                    return false;
                }
                campo = document.getElementById('apellido1').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide69I18n.getMensaje(idiomaUsuario, "msg.apellido1")%>';
                    return false;
                }
                return true;
            }
            ...
            function cancelar() {
                var resultado = jsp_alerta('', '<%=meLanbide69I18n.getMensaje(idiomaUsuario, "msg.preguntaCancelar")%>');
                if (resultado == 1) {
                    cerrarVentana();
                }
            }
            ...
            function mostrarError(codigo) {
                ...
                if (codigo == "1") {
                    ...
                    jsp_alerta("A", '<%=meLanbide69I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                } else if (codigo == "4") {
                    jsp_alerta("A", '<%=meLanbide69I18n.getMensaje(idiomaUsuario,"error.listaVacia")%>');
                } else if (codigo == "5") {
                    jsp_alerta("A", '<%=meLanbide69I18n.getMensaje(idiomaUsuario,"error.errorObtenerDatos")%>');
                } else if (codigo == "6") {
                    ...
                    jsp_alerta("A", '<%=meLanbide69I18n.getMensaje(idiomaUsuario,"error.operacionIncorrecta")%>');
                } else {
                    jsp_alerta("A", '<%=meLanbide69I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                }
            }
                ...
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px; width: 95%">
                        <span id="tituloVentana">      
                            <%=nuevo != null && nuevo=="1" ? meLanbide69I18n.getMensaje(idiomaUsuario,"label.nuevo"):meLanbide69I18n.getMensaje(idiomaUsuario,"label.modif")%>
                        </span>
                    </div>
                    <fieldset id="socio" name="socio"style="width: 95%;">
                        <legend class="legendAzul" id="titPuesto"><%=meLanbide69I18n.getMensaje(idiomaUsuario,"label.socio")%></legend>
                        <div class="lineaFormulario">
                            <div  style="width: 190px; float: left;" class="etiqueta">
                                <%=meLanbide69I18n.getMensaje(idiomaUsuario,"socio.dni")%>
                            </div>
                            <div style="width: 450px;float: left;">
                                <input id="dninie" name="dninie" type="text" class="inputTextoObligatorio" size="10" maxlength="9" onkeyup="xAMayusculas(this);"
                        ...
                        <div class="lineaFormulario">
                            <div  style="width: 190px; float: left;" class="etiqueta">
                                <%=meLanbide69I18n.getMensaje(idiomaUsuario,"socio.nombre")%>
                            </div>
                            <div style="width: 450px;float: left;">
                                <input id="nombre" name="nombre" type="text" class="inputTextoObligatorio" size="30" maxlength="100"
                        ...
                        <div class="lineaFormulario">
                            <div  style="width: 190px; float: left;" class="etiqueta">
                                <%=meLanbide69I18n.getMensaje(idiomaUsuario,"socio.apellido1")%>
                            </div>
                            <div style="width: 450px;float: left;">
                        ...
                        <div class="lineaFormulario"> 
                            <div  style="width: 190px; float: left;" class="etiqueta">
                                <%=meLanbide69I18n.getMensaje(idiomaUsuario,"socio.apellido2")%>
                            </div>
                            <div style="width: 450px;float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="botonera" style="width: 100%; float: left; text-align: center;">
                            <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide69I18n.getMensaje(idiomaUsuario, "btn.aceptar")%>" onclick="guardarDatos();"/>
                            <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide69I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();"/>
                        </div>
                    </div>
                </div>
            </form>
