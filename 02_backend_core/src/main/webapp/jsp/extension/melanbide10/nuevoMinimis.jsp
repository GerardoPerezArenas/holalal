...
<%@page import="es.altia.flexia.integracion.moduloexterno.melanbide10.vo.DesplegableAdmonLocalVO" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function guardarDatos() {
                if (validarDatos()) {
                    ...
                    if ('<%=nuevo%>' != null && '<%=nuevo%>' == "1") {
                        parametros = "tarea=preparar&modulo=MELANBIDE10&operacion=crearNuevoMinimis&tipo=0";
                    } else {
                        parametros = "tarea=preparar&modulo=MELANBIDE10&operacion=modificarMinimis&tipo=0"
            ...
            function validarDatos() {
                ...
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.estado")%>';
                    return false;
                }
                campo = document.getElementById('organismo').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.organismo")%>';
                    return false;
                }
                campo = document.getElementById('objeto').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.objeto")%>';
                    return false;
                }
                campo = document.getElementById('importe').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.importe")%>';
                    return false;
                } else if (!validarNumericoDecimalPrecision(campo, 10, 2)) {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.importe.errNumerico")%>';
                    return false;
                }
                campo = document.getElementById('fecha').value;
                if (campo == null || campo == '') {
                    mensajeValidacion = '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.fecha")%>';
                    return false;
                }
            ...
            function cancelar() {
                var resultado = jsp_alerta('', '<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.preguntaCancelar")%>');
                if (resultado == 1) {
                    cerrarVentana();
                }
            }
            ...
            function mostrarError(codigo) {
                elementoVisible('off', 'barraProgresoDISCP');
                if (codigo == "1") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorBD")%>');
                } else if (codigo == "2") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                } else if (codigo == "3") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>');
                } else if (codigo == "4") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.listaVacia")%>');
                } else if (codigo == "5") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorObtenerDatos")%>');
                } else if (codigo == "6") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorBorrarDatos")%>');
                } else if (codigo == "7") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorInsertarDatos")%>');
                } else if (codigo == "8") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorActualizarDatos")%>');
                } else if (codigo == "-1") {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.operacionIncorrecta")%>');
                } else {
                    jsp_alerta("A", '<%=meLanbide10I18n.getMensaje(idiomaUsuario,"error.errorGen")%>');
                }
            }
            ...
            function comprobarFecha(inputFecha) {
                ...
                if (Trim(inputFecha.value) != '') {
                    ...
                    if (!D[0]) {
                        jsp_alerta("A", "<%=meLanbide10I18n.getMensaje(idiomaUsuario, "msg.fechaNoVal")%>");
            ...
            <form>
                <div style="width: 100%; padding: 10px; text-align: left;">
                    <div  class="sub3titulo" style="clear: both; text-align: center; font-size: 14px;">
                        <span>
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.nuevaSubvencion")%>
                        </span>
                    </div> 
                    ...
                    <div class="lineaFormulario">
                        <div class="etiqueta" style="width: 250px; float: left;">
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.estado")%>
                        </div>
                        <div>
                            <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.organismo")%>
                        </div>
                        <div>
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.objeto")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.importe")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div style="width: 250px; float: left;" class="etiqueta">
                            <%=meLanbide10I18n.getMensaje(idiomaUsuario,"label.fecha")%>
                        </div>
                        <div>
                            <div style="float: left;">
                    ...
                    <div class="lineaFormulario">
                        <div class="botonera" style="width: 100%; float: left; text-align: center;">
                            <input type="button" id="btnAceptar" name="btnAceptar" class="botonGeneral" value="<%=meLanbide10I18n.getMensaje(idiomaUsuario, "btn.aceptar")%>" onclick="guardarDatos();"/>
                            <input type="button" id="btnCancelar" name="btnCancelar" class="botonGeneral" value="<%=meLanbide10I18n.getMensaje(idiomaUsuario, "btn.cancelar")%>" onclick="cancelar();"/>
                        </div>
                    </div>
                </div>
            </form>
