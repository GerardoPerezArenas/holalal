...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide09/gestionResultados.js"></script>
...
<div class="contenidoPantalla">
    ...
    <div style="padding-left: 15px; text-align: center;" class="txttitblanco"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.titulo.principal")%></div>
