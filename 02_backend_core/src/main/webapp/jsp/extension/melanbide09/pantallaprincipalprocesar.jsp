...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/extension/melanbide09/gestionProcesar.js"></script>
...
<div class="contenidoPantalla">
    ...
    <div style="padding-left: 15px; text-align: center;" class="txttitblanco"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.titulo.principalnotificar")%></div>
    <div  class="container align-self-center" style="width: 40%; margin-top:30px;">
            ...
            <div class="form-group">
                <label style="width: 200px;" for="fechahoraenviopeticion"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.fechaenviopeticiondocumento")%></label>
                 <!--<input type="text" maxlength="10" size="45" class="form-control" id="fechahoraenviopeticion" title="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.fechaenviopeticion")%>"  placeholder="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.fechaenviopeticion.placeholder")%>" >-->
                <form>
            ...
            <button hidden="true" type="button" id="reiniciarFiltro" class="btn btn-primary" onclick="reiniciarFiltros();"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.button.reiniciar")%></button>
            ...
            <table class="xTabla compact tablaDatos" id="tableLog">
                <thead>
                    <tr role="row">
                        ...
                        <th field="desTramite" datatype="String" class="selectedUp" rowspan="1" colspna="1" ><%=meLanbide09I18n.getMensaje(idiomaUsuario, "tabla.titulo.tramite")%></th>
                           </tr>
                </thead>
                <tbody>
                ...
                <div class="form-group">
                <label style="width: 140px;" for="actoNotificado"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.actoNotificado")%></label>
                <input required type="text" size="45" class="form-control" id="actoNotificado" title="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.actoNotificado")%>"  placeholder="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.actoNotificado.placeholder")%>" >
            </div>
            <div class="form-group">
                <label style="width: 140px;" for="textoNotificacion"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.textoNotificacion")%></label>
                <input required type="text" size="45" class="form-control" id="textoNotificacion" title="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.textoNotificacion")%>"  placeholder="<%=meLanbide09I18n.getMensaje(idiomaUsuario, "resultado.label.textoNotificacion.placeholder")%>" >
            </div>
            <button type="button" id="lanzarProceso" class="btn btn-primary" onclick="lanzarProcesoFiltrado();"><%=meLanbide09I18n.getMensaje(idiomaUsuario, "label.boton.lanzar.proceso")%></button>
