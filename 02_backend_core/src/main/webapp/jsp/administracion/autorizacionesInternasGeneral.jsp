                    ...
                    function pulsarBuscar(){
                        ...
                        function construirPermisos(){
                            ...
                            for (var ii=0; ii<elementosMenu.length; ii++){
                                ...
                                cadena += proceso+'<%=separador%>' +nodoPtoMenu.getRadio()+'<%=separador%>';
                            }
                            return cadena;
                        }
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="3">
                <tr>
                    ...
                    <td class="etiqueta" style="width: 55%">
                        ...
                        <input type="text" name="descOrganizacion"  id="descOrganizacion" size="63" class="inputTextoObligatorio" style="width:400px" readonly="true" value="">
                ...
                <tr>
                    ...
                    <td class="etiqueta" style="width: 55%">
                        <input type="text" name="codEntidad" id="codEntidad" size="3" class="inputTextoObligatorio" value="">
                        <input type="text" name="descEntidad"  id="descEntidad" size="63" class="inputTextoObligatorio" style="width:400px" readonly="true" value="">
                        <A href="" id="anchorEntidad" name="anchorEntidad"> 
                            <span class="fa fa-chevron-circle-down" aria-hidden="true" id="botonEntidad"
                                 name="botonEntidad" style="cursor:hand;"></span>
                        </A>
                    </td>
                    <td align="right" style="width: 30%"></td>
                </tr>	
                <tr>
                    ...
                    <td class="etiqueta" style="width: 55%">
                        ...
                        <input type="text" name="descAplicacion"  id="descAplicacion" size="63" class="inputTextoObligatorio" style="width:400px" readonly="true" value="">
    ...
    <table style="width: 100%">
        <tr>
            <td style="width:35%;vertical-align:top" class="subsubtitulo"><!-- Arbol -->
                <div class="webfx-tree-div" style="min-height:100px;width:100%">
                    <script type="text/javascript">                                  
            ...
            <td style="width: 65%;height:100%;vertical-align:top" class="subsubtitulo" rowspan="2">
                <div class="webfx-tree-div" style="min-height:396px;width:100%">
                    <script type="text/javascript">                                  
        ...
        <tr>
            <td class="subsubtitulo" style="vertical-align:top">
                <div class="webfx-tree-div" style="min-height:292px;width:100%">
    ...
    function checkKeysLocal(evento,tecla) {
        ...
        teclaAuxiliar = evento.keyCode;
            ...
            if (teclaAuxiliar == 1){
                ...
                if (comboEntidad.base.style.visibility == "visible" && isClickOutCombo(comboEntidad,coordx,coordy)) setTimeout('comboEntidad.ocultar()',20);
            ...
            if (teclaAuxiliar == 9){
                ...
                if (comboEntidad.base.style.visibility == "visible") comboEntidad.ocultar();
