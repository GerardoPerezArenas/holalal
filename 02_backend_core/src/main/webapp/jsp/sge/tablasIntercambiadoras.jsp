 ...
 <head><jsp:include page="/jsp/sge/tpls/app-constants.jsp" />
    ...
    function crearListasFlujoSalida() {
      ...
      for (i=0; i < datosSegundaTabla.length; i++) {
        listaCodTramitesFlujoSalida += datosSegundaTablaOriginal[i][0]+'<%=separador%>';
        listaNombresTramitesFlujoSalida += datosSegundaTablaOriginal[i][1]+'<%=separador%>';
        listaDescTramitesFlujoSalida += datosSegundaTablaOriginal[i][2]+'<%=separador%>';
        listaNumerosSecuenciaFlujoSalida += (i+1)+'<%=separador%>';
      }
