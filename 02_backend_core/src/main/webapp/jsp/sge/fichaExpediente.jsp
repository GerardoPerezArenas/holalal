        ...
        <%}
            ...
            document.forms[0].permiteMantenerDocExt.value = "<%=(String) expedienteVO.getAtributo("permiteMantenerDocExt")%>";
                    ...
                    var domicilio = "<str:escape><c:out value="${tercero.domicilio}" escapeXml = "false"/></str:escape>" + ' - ' + '<c:out value="${tercero.municipio}"/>' + ' - ' + '<c:out value="${tercero.provincia}"/>';
                        ...
                        listaMostrar += "<c:out value='${tercero.mostrar}'/>" + "<%=separador%>";
...
function inicioOculto(ocuTram,codTram,codUnidTram,postNotificacion){
        ...
        if(postNotificacion) postNotificacionEnviada = true;
...
function cubrirListaMostrar() {
    ...
    if(document.forms[0].listaMostrar.value==null || document.forms[0].listaMostrar.value.length==0){
        document.forms[0].listaMostrar.value = codRol + "<%=separador%>";
    }
    else{
        document.forms[0].listaMostrar.value = document.forms[0].listaMostrar.value + "<%=separador%>";
    }
}
        ...
        { 
            if(prepararValidarUbicacionDocumentacion()) {      // #253692  
                if( validarObligatorios("<%=descriptor.getDescripcion("msjObligTodos")%>"))         
                {
					...
					if (continuar == 1) { // #30018 - Validacion de documento no repetido
						var arrayDocumentos = [];
						terceros.forEach((tercero) => {
							if (!arrayDocumentos.includes(tercero[15])) {
								arrayDocumentos.push(tercero[15]);
								continuar = 1;
							} else {
								continuar = 0;
							}
						...
						if (continuar == 0) {
							jsp_alerta("A",'<%=descriptor.getDescripcion("msgErrorTresValRolGrabarExp")%>');
						}
					}
                    if(continuar ==1)
                    {     
            ...
            if(listaTramitesOriginal[i][18]=="SI" || listaTramitesOriginal[i][18]=="si"){
                jsp_alerta("A",'<%=descriptor.getDescripcion("msgTareasPendientesIniAlert")%>');
                    ...
                    if(accion == "F") { 
                        ...
                        consultarTramites(0,obli,"finalizarConTramites");
                    } else if(accion == "R") {
                    ...
                    abrirXanelaAuxiliar('<%=request.getContextPath()%>/jsp/sge/mainVentana.jsp?source='+source,
                        ...
                        if(datosConsulta!=undefined){
                            if(datosConsulta[0] =="siFavorable") {
                                if(accionAfirmativa == "T") {
                                    consultarTramites(1,obli,"finalizarConResolucionFavorableConTramites");
                                } else {
                                if(jsp_alerta("C","<%=descriptor.getDescripcion("msjCondFinal")%>") == 1) {
                        ...
                        if(AccionNegativa == "T") {
                            consultarTramites(2,obligatorioDesf,"finalizarConResolucionDesfavorableConTramites");
                        } else { 
                        if(jsp_alerta("C","<%=descriptor.getDescripcion("msjCondFinal")%>") == 1) {
            ...
            abrirXanelaAuxiliar('<%=request.getContextPath()%>/jsp/sge/mainVentana.jsp?source='+source,
                ...
                function(datosConsulta){
                    if(datosConsulta!=undefined){
                        if(datosConsulta[0] =="siFavorable") {
                             if(accionAfirmativa == "T") {
                                consultarTramites(1,obli,"finalizarConPreguntaFavorableConTramites");
                            } else { 
                            if(jsp_alerta("C","<%=descriptor.getDescripcion("msjCondFinal")%>") == 1) {
                        ...
                        if(AccionNegativa == "T") { 
                            consultarTramites(2,obligatorioDesf,"finalizarConPreguntaDesfavorableConTramites");
                        } else { 
                        if(jsp_alerta("C","<%=descriptor.getDescripcion("msjCondFinal")%>") == 1) {
            ...
            if(document.forms[0].listaCodTercero.value!="undefined"){
                ...
                if(codTercero==terceroActual){
                    ...
                    modificarListaInteresados(tercero[4],tercero[5],tercero[6],domicilio,posActualTercero);
                     ...
                     if(document.forms[0].listaVersionTercero.value!="undefined"){
                        if( document.forms[0].listaVersionTercero.value==null ||  document.forms[0].listaVersionTercero.value.length==0){
                            document.forms[0].listaVersionTercero.value = tercero[1] + '<%=separador%>';
                        }
                        else{
                            var listaVerAux = document.forms[0].listaVersionTercero.value.split('<%=separador%>');
                            listaVerAux[pos] = tercero[1];
                            var contador = 0;
                            document.forms[0].listaVersionTercero.value = '';
                            while (contador<listaVerAux.length-1) {
                                document.forms[0].listaVersionTercero.value +=  listaVerAux[contador]+ '<%=separador%>';
                                contador++;
                            }
                    ...
                    if(document.forms[0].listaCodDomicilio.value!="undefined"){
                        ...
                        if( document.forms[0].listaCodDomicilio.value==null ||  document.forms[0].listaCodDomicilio.value.length==0){
                            document.forms[0].listaCodDomicilio.value = tercero[13] + '<%=separador%>';
                        }
                        else{
                            var listaVerAux = document.forms[0].listaCodDomicilio.value.split('<%=separador%>');
                            listaVerAux[pos] = tercero[13];
                            var contador = 0;
                            document.forms[0].listaCodDomicilio.value = '';
                            while (contador<listaVerAux.length-1) {
                                document.forms[0].listaCodDomicilio.value +=  listaVerAux[contador]+ '<%=separador%>';
                                contador++;
                            }
                    ...
                    if(document.forms[0].listaCodTercero.value!="undefined"){
                        if(document.forms[0].listaCodTercero.value==null || document.forms[0].listaCodTercero.value.length==0){
                            document.forms[0].listaCodTercero.value = tercero[2] + '<%=separador%>';
                        }
                        else{
                            document.forms[0].listaCodTercero.value += tercero[2] + '<%=separador%>';
                        }
                ...
                if(document.forms[0].listaRol.value!="undefined"){
                    if( document.forms[0].listaRol.value==null ||  document.forms[0].listaRol.value.length==0){
                            document.forms[0].listaRol.value = codRols[pD] + '<%=separador%>';
                    }
                    else{
                            document.forms[0].listaRol.value +=  codRols[pD] + '<%=separador%>';
                    }
                ...
                if(document.forms[0].listaMostrar.value!="undefined"){
                    if( document.forms[0].listaMostrar.value==null ||  document.forms[0].listaMostrar.value.length==0){
                            document.forms[0].listaMostrar.value = "true" + '<%=separador%>';
                    }
                    else{
                            document.forms[0].listaMostrar.value +=  "true" + '<%=separador%>';
                    }
...
function buildRequestInsercionDirectaTercero(datos) {
    ...
    for(i=0;i<datos[22].length;i++){
        ...
        valoresCamposSuplementarios = valoresCamposSuplementarios + codigoCampo + ";" + valorCampo + '<%=separador%>';
    }
...
function recuperaBusquedaTerceros(datos){ 
	...
	if (datos[0][0] == '0') { // Se trata de un tercero externo
        ...
        if(document.forms[0].listaCodTercero.value!="undefined"){
            if(document.forms[0].listaCodTercero.value==null || document.forms[0].listaCodTercero.value.length==0){
                document.forms[0].listaCodTercero.value = codTercero + '<%=separador%>';
            }
            else{
                document.forms[0].listaCodTercero.value += codTercero + '<%=separador%>';
            }
        ...
        if(document.forms[0].listaCodDomicilio.value!="undefined"){
            if( document.forms[0].listaCodDomicilio.value==null ||  document.forms[0].listaCodDomicilio.value.length==0){
                document.forms[0].listaCodDomicilio.value = codDomicilio + '<%=separador%>';
            }
            else{
                document.forms[0].listaCodDomicilio.value +=  codDomicilio  + '<%=separador%>';
            }
        ...
        if(document.forms[0].listaVersionTercero.value!="undefined"){
            if( document.forms[0].listaVersionTercero.value==null ||  document.forms[0].listaVersionTercero.value.length==0){
                document.forms[0].listaVersionTercero.value = version + '<%=separador%>';
            }
            else{
                document.forms[0].listaVersionTercero.value +=  version + '<%=separador%>';
            }
        ...
        if(jsp_alerta("",'<%=descriptor.getDescripcion("msjAltaTercero")%>')) {
            ...
            abrirXanelaAuxiliar('<%=request.getContextPath()%>/jsp/terceros/mainVentana.jsp?source='+source,
                ...
                if(datos!=undefined) {
                   ...
                   if(document.forms[0].listaCodTercero.value!="undefined"){
                        if(document.forms[0].listaCodTercero.value==null || document.forms[0].listaCodTercero.value.length==0){
                            document.forms[0].listaCodTercero.value = datos[2] + '<%=separador%>';
                        } else{
                            document.forms[0].listaCodTercero.value += datos[2] + '<%=separador%>';
                        }
                    }
                    if(document.forms[0].listaCodDomicilio.value!="undefined"){
                        if( document.forms[0].listaCodDomicilio.value==null ||  document.forms[0].listaCodDomicilio.value.length==0){
                            document.forms[0].listaCodDomicilio.value = datos[13] + '<%=separador%>';
                        } else{
                            document.forms[0].listaCodDomicilio.value +=  datos[13] + '<%=separador%>';
                        }
                    }
                    ...
                    if(document.forms[0].listaVersionTercero.value!="undefined"){
                        if( document.forms[0].listaVersionTercero.value==null ||  document.forms[0].listaVersionTercero.value.length==0){
                            document.forms[0].listaVersionTercero.value = datos[1] + '<%=separador%>';
                        } else{
                            document.forms[0].listaVersionTercero.value +=  datos[1]+ '<%=separador%>';
                        }
                    }
...
function agregaListaNotif(){
    ...
    while (contador<listaNotificacionesElectronicas.length) {
            document.forms[0].listaNotificacionesElectronicas.value +=  listaNotificacionesElectronicas[contador]+ '<%=separador%>';
            contador++;
    }
}
...
<body class="bandaBody" onload="pleaseWait('on');inicializar();">
