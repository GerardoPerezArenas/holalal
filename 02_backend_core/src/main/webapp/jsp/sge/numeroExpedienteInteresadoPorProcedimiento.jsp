...
<BODY class="bandaBody" onload="javascript:{inicializar();}">
	...
	<div id="listaProcedimientos" class="txttitblanco" style="font-size: 16px;">&nbsp;&nbsp;<%=descriptor.getDescripcion("titExpRelacionado")%>: <%=(String)session.getAttribute("listaProcedimientos")%></div>
