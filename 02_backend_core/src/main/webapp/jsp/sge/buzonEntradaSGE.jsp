            ...
            if(chequeadosIniciados.length == 0){
                ...
                if(chequeadosNoIniciados_res.length != 0){
                    for(i=0; i<chequeadosNoIniciados_res.length; i++){
                        listaDepartamentoRes = listaDepartamentoRes + chequeadosNoIniciados_res[i][0]+'<%=separador%>';
                        listaUnidadOrgRes = listaUnidadOrgRes + chequeadosNoIniciados_res[i][1]+'<%=separador%>';
                        listaEjercicioRes = listaEjercicioRes + chequeadosNoIniciados_res[i][2]+'<%=separador%>';
                        listaNumeroRes = listaNumeroRes + chequeadosNoIniciados_res[i][3]+'<%=separador%>';
                        listaTipoRes = listaTipoRes + chequeadosNoIniciados_res[i][4]+'<%=separador%>';
                    }
                }
