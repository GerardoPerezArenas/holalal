            ...
            */
            function mostrarErrorCatalogar(codError){
                if(codError=="1"){
                    ...
                    jsp_alerta("A",'<%=descriptor.getDescripcion("msjFormatoSelecIncoCat")%>');
                } else if(codError=="4"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("msgErrConexionBD")%>');
                } else if(codError=="5"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("msgFalloGrabCata")%>');
                } else if(codError=="6"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("msgFalloRecuCata")%>');
                } else if(codError=="7"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("errorTipDoc")%>');
                } else if(codError=="-1"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("errorOper")%>');
                } else if(codError=="-2"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("msjFormatoDatosIn")%>');
                } else if(codError=="9"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("errorRecargarDocu")%>')
                } else if(codError=="10"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("errorCataloDocu")%>')
                } else if(codError =="11"){
                    jsp_alerta("A",'<%=descriptor.getDescripcion("errorRegistro")%>')
                }
            }                                
