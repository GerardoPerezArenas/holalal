...
<html>
    <head><jsp:include page="/jsp/sge/tpls/app-constants.jsp" />
        ...
        <%
            ...
            String separadorSubListas = ConstantesDatos.SEPARADORSUBLISTAS;
        %>
	...
	function crearListaParaGuardar() {
            ...
            for (var i=0;i<listaFirmasCompleta.length;i++) {
                    ...
                    resultado += listaFirmasCompleta[i][6]+"<%=separadorSubListas%>"+listaFirmasCompleta[i][5]+"<%=separadorSubListas%>"+listaFirmasCompleta[i][2]+"<%=separadorSubListas%>"+
                            listaFirmasCompleta[i][1]+"<%=separadorSubListas%>"+ listaFirmasCompleta[i][7] + "<%=separadorSubListas%>" + auxFinalizar+"<%=separadorSubListas%>" + listaFirmasCompleta[i][8] + '<%=separador%>';
            }            
            return resultado;
        }
