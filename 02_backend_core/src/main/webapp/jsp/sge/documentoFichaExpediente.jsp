  ...
  function validarCampos(){
    ...
    function pulsarAceptar() { 
      ...
      if (validarCampos()){
          ...
          document.forms[0].action = "<html:rewrite page='/sge/FichaExpedienteDocumento.do'/>";
...
<html:form action="/sge/FichaExpedienteDocumento.do" target="_self" enctype="multipart/form-data" >
    ...
    <div class="contenidoPantalla">
        <table class="contenidoPestanha">
            ...
            <tr>
                <td colspan="2">
                    <input type="text" name="tituloFichero" style="width: 356px" id="tituloFichero" class="inputTexto" onkeypress="javascript:PasaAMayusculas(event);"/>
                </td>
            </tr>
 ...
 <c:if test="${requestScope.EXTENSION_FILE_INCORRECT eq 'si' and requestScope.TAM_MAX_FILE_EXCEED eq 'si'}">
    ...
    <c:if test="${requestScope.DOCUMENT_TITLE_REPEATED eq 'si'}">
     ...
     document.forms[0].tituloFichero.value =
      "<str:escape><bean:write name="FichaExpedienteDocumentoForm" property="tituloFichero" filter="false"/></str:escape>";
