...
function mostrarListaProcedimientos(){
 if ( Trim(document.forms[0].codDepartamento.value) != '') {
  ...
  condiciones[0]='PRO_DEP'+'<%=separador%>';
...
if(!(Trim(document.forms[0].codProvincia.value)=='')){
  var condiciones = new Array();
  condiciones[0]='MUN_PAI'+'<%=separador%>';
  condiciones[1]= 108 + '<%=separador%>';
  condiciones[2]='MUN_PRV'+'<%=separador%>';
  condiciones[3]= document.forms[0].codProvincia.value+'<%=separador%>';
