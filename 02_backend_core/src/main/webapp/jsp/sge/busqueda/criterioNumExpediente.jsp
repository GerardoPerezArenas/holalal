...
<tr>
    ...
    <td>
        <input type="text" name="valorBusqueda1" id="valorBusqueda1" class="inputTextoObligatorio" style="width:350px" maxlength="100"
               onkeyup="javascript:return SoloCaracterNumeroExpediente(this);">
    </td>
</tr>
</table>
</form>
