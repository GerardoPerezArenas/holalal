...
function pulsarExcel() {
    var CONTEXT_PATH = '<%=request.getContextPath()%>';
    var url = CONTEXT_PATH + "/sge/FichaExpediente.do";
    var parametros = "?opcion=generarExcelExpediente";
        ...
        <div class="contenidoPantalla scrollable-x scrollable-y">
            ...
            <div class="row">
                <div class="botoneraPrincipal col-sm-12">
                    <input type="button" class="botonGeneral" value="<%=descriptor.getDescripcion("gbExportarExcel")%>" name="cmdSalir" onclick="pulsarExcel()" accesskey="C">
