...
<jsp:include page="/jsp/plantillas/Metas.jsp" />
    ...
    function crearListasFlujoSalida(datosTabla) {
      ...
      for (i=0; i < datosTabla.length; i++) {
        listaCodTramitesFlujoSalida += datosTabla[i][0]+'<%=separador%>';
        listaNombresTramitesFlujoSalida += datosTabla[i][1]+'<%=separador%>';
        listaDescTramitesFlujoSalida += datosTabla[i][2]+'<%=separador%>';
