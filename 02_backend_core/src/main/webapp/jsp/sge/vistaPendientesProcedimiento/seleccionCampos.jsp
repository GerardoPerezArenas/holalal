...
function crearListas() { 
    ...
    for (i=0; i < lista2.length; i++) {              
       ...
       if(lista2[i][3]!="" && lista2[i][1]!="" && lista2[i][1].length>0 && lista2[i][3]=="SI"){           
            listaCodCampo +=lista2[i][0]+'<%=separador%>';
            listaNomCampo +=lista2[i][1]+'<%=separador%>';
            if(lista2[i][3]=='NO'){
            ...
            listaTamano += lista2[i][2]+ '<%=separador%>';
            listaActCampo += lista2[i][3]+'<%=separador%>';
            listaCampoSuplementario += lista2[i][4]+'<%=separador%>';
       }
    }
...
function calcularTamano(listTamanoCampoAnt) { 
    ...
    for (i=0; i < listTamanoCampoAnt.length; i++) {
        listTamanoCampo+=(100*parseInt(listTamanoCampoAnt[i]))/suma+'<%=separador%>';
    }
