...
function crearListaPrecargas() {
  ...
  for (i=0; i < nombres_precargas.length; i++) {
    ...
    if(eval("document.forms[0]." + caja + ".checked") == true) {
	  listaXml +=nombres_precargas[i][1]+'<%=separador%>';
	}
  }
...
function crearListasTramites() {
  ...
  for (i=0; i < tramites.length; i++) {
    listaTramProc +=tramitesOriginal[i][0]+'<%=separador%>';
    listaTramCod +=tramitesOriginal[i][1]+'<%=separador%>';
    listaTramRel +=tramitesOriginal[i][2]+'<%=separador%>';
    listaTramEst +=tramitesOriginal[i][3]+'<%=separador%>';
  }
...
function crearListasRestricciones() {
  ...
  for (i=0; i < restricciones.length; i++) {
    listaRestriccionesUOR +=restriccionesOriginal[i][0]+'<%=separador%>';
    if (restriccionesOriginal[i][1]=="") {listaRestriccionesCargo += '0'+'<%=separador%>';}  //Sin cargo --> Cargo = 0
    else {listaRestriccionesCargo += restriccionesOriginal[i][1]+'<%=separador%>';}
  }
