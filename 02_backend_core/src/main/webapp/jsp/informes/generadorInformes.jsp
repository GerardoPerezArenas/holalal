...
<head>
    ...
    function crearListas() {
      ...
      for (i=0; i < listaCamposElegidos.length; i++) {
        listaCodCampos += listaCamposElegidosOriginal[i][0]+'<%=separador%>';
        listaCampoCampos += listaCamposElegidosOriginal[i][4]+'<%=separador%>';
        listaNombreAs += listaCamposElegidosOriginal[i][5]+'<%=separador%>';
      }
