   ...
   function pulsarModificar() {
        ...
        function crearListas() {
            ...
            for (i=0; i < listaTabla.length; i++) {
                listaCodTercero += listaInteresados[i][0]+separador;
                listaVersionTercero += listaInteresados[i][1]+separador;
                listaRol += listaInteresados[i][7]+ separador;
                listaCodDomicilios += listaInteresados[i][4]+separador;
                listaPDefecto += listaInteresados[i][6]+separador;
                listaTlf += listaInteresados[i][8]+separador;
                listaEmail += listaInteresados[i][9]+separador;
                listaPais += listaInteresados[i][10]+separador;
                listaProvincia += listaInteresados[i][11]+separador;
                listaMunicipio += listaInteresados[i][12]+separador;
            }
