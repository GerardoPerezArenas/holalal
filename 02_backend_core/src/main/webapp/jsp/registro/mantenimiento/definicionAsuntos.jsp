...
<html:html>
    <head>
        <TITLE>Definición de Asunto</TITLE>
        ...
        <style type="text/css">
            ...
            /** Este estilo es sólo válido para navegador que no sean IE .
...
<script type="text/javascript">
    ...
    // son obligatorios y los combos añaden una posicion vacia al principio por lo
  ...
  function Inicio() {
    ...
    // la unidad de registro actual y estará deshabilitado. A no ser que estemos en modo
    ...
    if (validarObligatorios()) {
      if (existeCodigoAsunto(document.forms[0].codigo.value, 
	    ...
	    for (i=0; i<listaDocs.length; i++) {
	        txtListaDocs += listaDocs[i][0] + '<%=separador%>';
	    } 
  ...
  /* Abre un dialogo para introducir los datos de un nuevo documento y lo añade a la lista */
  ...
  function pulsarSalir() {    
   ...
   function pulsarNotificar(){      
       ...
       //de destino y sólo añadimos las que tengan correo.
       var j=0;
  ...
  /* Se llama al seleccionar/deseleccionar un procedimiento para ocultar/mostrar la pestaña de otros datos */
...
function onChangeComboUnidadTram() {
    ...
    if (utr > 0 && email!=null && email!='') {
        ...
        // Actualizamos la lista de unidades a notificar (si esta activada esta opción).
  ...
  // #234108: Según se ha marcado o no el check da un valor al input
...
<html:hidden property="txtListaUorsCorreo"/>
    ...
    <div class="contenidoPantalla">
        ...
        <div class="tab-pane" id="tab-pane-1" >
            ...
            <!-- FIN DE PESTAÑA 1: DATOS GENERALES -->
...
// Foco por defecto en cada pestaña
...
function cargarCombos() {
	...
	var cont=0;
	// Si no es la aplicación de registro, añadimos la opción 'PARA TODOS LOS REGISTROS'
	var apl = '<bean:write name="MantAsuntosForm" property="apl"/>';
	if (apl == 'admin') {
