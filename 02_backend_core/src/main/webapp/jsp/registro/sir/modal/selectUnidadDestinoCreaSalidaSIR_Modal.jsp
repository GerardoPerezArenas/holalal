<%-- 
    Document   : selectUnidadDestinoCreaSalidaSIR_Modal.jsp
    Author     : INGDGC
--%>
<!DOCTYPE html>
...
<html>
    ...
    <body>
        ...
        <!--Modales-->
        <div class="modal fade" id="modalSelectDestinoSalidaSIR" tabindex="-1" role="dialog" aria-labelledby="modalMensajeLabel" aria-hidden="true">
