...
if (consultando!=true) modificaVariableCambiosCamposSupl();
  ...
  <input type="text" name="<%= name %>" value=""
    ...
    onkeypress="javascript:if (consultando) return SoloDigitosConsultaCampoNumericoCal(event); else return SoloDigitosNumericosCampoNumericoCal(event);"
    onBlur="javascript:validarLongitudNumeroCal(this);if (!longitudValida) {document.getElementById('<%=name%>').value = '';focus(this);}" <% if (consulta==null || "".equals(consulta)){ %> readonly <% } %>>    
    <input type="button" class="botonGeneral" value="Ver.." name="cmdVerOpe_<%=name%>" style="display:none" onclick="pulsarVerExpre('<%=name%>');">
