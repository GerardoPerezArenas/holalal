...
if (consultando!=true) modificaVariableCambiosCamposSupl();
  ...
  <input type="text" name="<%= name %>" value=""
    ...
    onkeypress="javascript:if (consultando) return SoloDigitosConsultaCampoNumerico(event); else return SoloDigitosNumericosCampoNumerico(event);"   
    onBlur="javascript:validarLongitudNumero(this,'<%=name%>');if(!consultando) recargarCamposCalculados();">
