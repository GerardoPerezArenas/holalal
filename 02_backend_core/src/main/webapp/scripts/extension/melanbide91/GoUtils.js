...
function mostrarCalfecha(event) { 
if(window.event) event = window.event;
if (document.getElementById("calfecha").src.indexOf("icono.gif") != -1 )
showCalendar('forms[0]','fecha',null,null,null,'','calfecha','',null,null,null,null,null,null,null, '',event);   
}       
function mostrarCalfecIni(event) { 
if(window.event) event = window.event;
