...
function FixedColumnTable(par,anchoTabla,pWidth,nomT){
  ...
  this.addColumna = function(ancho, align, nombre, titulo, tipoDato){
    ...
    this.displayTabla = function(){
            ...
            var str = '';
            str += '<table border="0" id="tbl_'+this.nombreTabla+'" cellpadding="0" cellspacing="0" class="main" height="'+this.height+'" width="'+this.anchoTabla+'+80" onmousewheel="forwardEvent(event, \''+this.nombreTabla+'\');"  onselectstart="return false;" onclick="fctb_selectRow(event, \''+this.nombreTabla+'\');" '+(this.dblClkFunction != '' ? 'ondblclick="'+this.dblClkFunction+'();"' : '')+'>';
            ...
            if(navigator.appName.indexOf("Internet Explorer") != -1){
				...
				str += '<div id="vScroll_'+this.nombreTabla+'" class="vertical-scroll" style="height: '+(parseInt(this.height)+2)+'px; width: '+(this.parentWidth + 100)+'; display: inline-flex; position: relative;" onscroll="reposVertical(this, \''+this.nombreTabla+'\');">';
            }else{
                str += '<div id="vScroll_'+this.nombreTabla+'" class="vertical-scroll" style="height: '+(parseInt(this.height)+2)+'px; width: '+(this.parentWidth + 100)+';" onscroll="reposVertical(this, \''+this.nombreTabla+'\');">';
            }
                    str += '<div style="height: '+this.scrollHeight+'px;">';
                    str += '</div>';
                str += '</div>';
            ...
            str += '<tr class="horizontal-scroll">';
                ...
                if(navigator.appName.indexOf("Internet Explorer") != -1){
					...
					str += '<div id="hScroll_'+this.nombreTabla+'" class="horizontal-scroll" style="display: inline-flex; position: relative; width: '+anchoTabla+'+80; margin-top: -17px;" onscroll="reposHorizontal(this, \''+this.nombreTabla+'\');">';
                }else{
                    str += '<div id="hScroll_'+this.nombreTabla+'" class="horizontal-scroll" onscroll="reposHorizontal(this, \''+this.nombreTabla+'\');">';
                }
                        str += '<div style="width: '+this.scrollWidth+'px;">';
