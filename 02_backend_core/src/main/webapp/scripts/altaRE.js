...
function mostrarListaEntidadOrigen(){
	if ( Trim(document.forms[0].cod_orgOrigen.value) != ''){
		  var condiciones = new Array();
		  condiciones[0]='ENT_ORG'+separador;
		  condiciones[1]= document.forms[0].cod_orgOrigen.value+separador;
...
function mostrarListaUnidRegOrigen(){
	if ( (Trim(document.forms[0].cod_orgOrigen.value) != '') ) {
		var condiciones = new Array();
		condiciones[0]='UOR_TIP'+separador;
		condiciones[1]='1'+separador;
                                    condiciones[2]='UOR_OCULTA'+separador;
                                    condiciones[3]='N';
...
function mostrarListaUnidRegDestinoORD(){
    ...
    condiciones[1]='0';
        ...
        condiciones[0]='UOR_OCULTA'+separador;
        condiciones[1]='N';
    }
...
function crearListasRelacionesTxt() {
   ...
   for(i=0; i<relaciones.length; i++) {
       listaTipos += relaciones[i][0] + separador;
       listaEjercicios += relaciones[i][1] + separador;
       listaNumeros += relaciones[i][2] + separador;
   }
     ...
     */
     function crearListas() {
         ...
         for (i=0; i < terceros.length; i++) {
             ...
             listaDescRol        += terceros[i][3] + separador;
         }
...
function tratarDocumentosPresentadosAlta()
{
    ...
    for(i=0; i<listaDoc.length; i++) {
		...
		if("SI"==listaDoc[i][0])
		{
			txtListaDocEntregados=txtListaDocEntregados+'S'+separador;
			
		}
		else if("NO"==listaDoc[i][0])
		{
			txtListaDocEntregados=txtListaDocEntregados+'N'+separador;
		}
		else 
		{
			txtListaDocEntregados=txtListaDocEntregados+listaDocEntregados[i]+separador;
