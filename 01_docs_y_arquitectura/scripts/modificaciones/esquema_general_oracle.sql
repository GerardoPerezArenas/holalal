...
-- Tarea #853512 REGEXLAN - [39190] - Inicio automático de expedientes - Definición procedimientos
-- 28/03/2025
-- Pablo Bugia
-- Se anhaden etiquetas para multilenguaje tanto en castellano como en euskera
-- INI
...
---Euskera
INSERT INTO A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values (4,'etiqExpInicioAutomatico',4,'Espedientearen hasiera automatikoa',null,null);
--Castellano
INSERT INTO A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values (4,'etiqExpInicioAutomatico',1,'Inicio automático de expediente',null,null);

COMMIT;

-- FIN

-- Tarea #418627: Flexia - [39459] - Registro de operaciones expediente - Exportación a Excel
-- 30/04/2025
-- Martin Joost
-- Se anhaden etiquetas para multilenguaje tanto en castellano como en euskera
-- INI
...
---Euskera
INSERT INTO FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) VALUES (4,'gbExportarExcel',4,'Esportatu Excel',NULL,NULL);
--Castellano
INSERT INTO FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) VALUES (4,'gbExportarExcel',1,'Exportar Excel',NULL,NULL);

COMMIT;

-- FIN

-- Tarea #299369: REGEXLAN - [26513] -Traducción literales Flexia y literales extensión
-- 19/09/2024
-- Gerardo Pérez
-- Se anhaden etiquetas para mostrar avisos de catalogación en multilenguaje 
-- INI

--Euskera
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoSelecIncoCat','4','Orain ezin da erregistroa kudeatu, erregistro horretako dokumentuak grabatzeko prozesua oraindik ez delako amaitu',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_IDI,TEX_COD,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoSelecIncoCa','4','Hautatutako dokumentuak ez du katalogaziorik onartzen',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_IDI,TEX_COD,TEX_DES,TEX_USO,TEX_FEC) values ('4','msgFalloGrabCata','4','Errorea gertatu da dokumentuaren katalogazioa grabatzean',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msgFalloRecuCata','4','Errorea gertatu da dokumentuaren katalogazioa berreskuratzean',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorTipDoc','4','dokumentu-motak eskuratzean errorea',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorOper','4','Eragiketak huts egin du',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoDatosIn','4','Sarrera-datuen formatua ez da zuzena',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorRecargarDocu','4','Errorea gertatu da dokumentuen taula kargatzean',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorCataloDocu','4','Erregistro hori kudeatu aurretik, lotutako dokumentu digitalizatu guztiak katalogatu behar dituzu',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorRegistro','4','Orain ezin da erregistroa kudeatu, erregistro horretako dokumentuak grabatzeko prozesua oraindik ez delako amaitu',null,null);

--Castellano

Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoSelecIncoCat','1','El documento seleccionado no admite catalogaci?n',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_IDI,TEX_COD,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoSelecIncoCa','1','El documento seleccionado no admite catalogaci?n',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_IDI,TEX_COD,TEX_DES,TEX_USO,TEX_FEC) values ('4','msgFalloGrabCata','1','Ha ocurrido un error al grabar la catalogaci?n del documento',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msgFalloRecuCata','1','Ha ocurrido un error al recuperar la catalogaci?n del documento',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorTipDoc','1','Ha ocurrido un error al recuperar los tipos documentales',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorOper','1','La operaci?n ha fallado',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','msjFormatoDatosIn','1','El formato de los datos de entrada es incorrecto',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorRecargarDocu','1','Ha ocurrido un error al recargar la tabla de documentos',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorCataloDocu','1','Antes de gestionar este registro, debe catalogar todos los documentos digitalizados que tiene asociados',null,null);
Insert into FLBGEN.A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values ('4','errorRegistro','1','No se puede gestionar ahora el registro porque el proceso de grabaci?n de documentos de este registro a?n no ha terminado',null,null);
