...
-- 28/03/2025
-- Pablo Bugia
-- Se anhade un nuevo campo a la tabla E_PRO
-- INI

ALTER TABLE E_PRO
  ADD PRO_INIAUTOEXP NUMBER(1,0) DEFAULT 0 NOT NULL;T INTO A_TEX (TEX_APL,TEX_COD,TEX_IDI,TEX_DES,TEX_USO,TEX_FEC) values (4,'etiqExpInicioAutomatico',1,'Inicio automático de expediente',null,null);
COMMIT;

-- FIN

-- Tarea #880000: HORIZONTAL - [40501] - Desplegables externos no cargan en expedientes
-- 19/05/2025
-- José Ignacio Delgado
-- Se aumenta el tamanho del campo url_jdbc en desplegables externos para poder indicar la jdbc personalizada correcta
-- INI

ALTER TABLE desplegable_externo MODIFY url_jdbc VARCHAR2(600 BYTE);
COMMIT;
...
-- 20/09/2024
-- Gerardo Pérez
-- Faltan puntos de menú  en el Administrador Local en alguno de los idiomas permitidos en Flexia
-- INI

-- Euskera
-- Añadimos el menú en el idioma
Insert into FLBGEN.A_PID (PID_APL,PID_PRO,PID_IDI,PID_DES) values ('9','21','4','Dokumentu mota');
Insert into FLBGEN.A_PID (PID_APL,PID_PRO,PID_IDI,PID_DES) values ('9','22','4','Goitibeherako eremuak');

COMMIT;

-- Actualizamos la traducción del menú en el idioma
UPDATE FLBGEN.A_PID
SET PID_DES = 'Prozedurak biltegiratzea'
WHERE PID_APL = '9' AND PID_PRO = '23' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Erregistroa biltegiratzea'
WHERE PID_APL = '9' AND PID_PRO = '24' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Erabiltzaileen zerrenda'
WHERE PID_APL = '9' AND PID_PRO = '25' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Nire kudea Fase mant.'
WHERE PID_APL = '9' AND PID_PRO = '26' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Jakin. telemat. kudeaketa'
WHERE PID_APL = '9' AND PID_PRO = '27' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Lanbide dokumentu-moten mantentze-lanak'
WHERE PID_APL = '9' AND PID_PRO = '28' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Lanbide dokumentu-mota'
WHERE PID_APL = '9' AND PID_PRO = '29' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'DOKUSI dokumentu-mota'
WHERE PID_APL = '9' AND PID_PRO = '30' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Lanbide Metadatuen taularen mantentze-lanak'
WHERE PID_APL = '9' AND PID_PRO = '31' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Nire kudeaketak deitzea'
WHERE PID_APL = '9' AND PID_PRO = '33' AND PID_IDI = '4';

UPDATE FLBGEN.A_PID
SET PID_DES = 'Prozedura historikoak'
WHERE PID_APL = '9' AND PID_PRO = '36' AND PID_IDI = '4';
...
-- Actualizamos la traducción del menú en el idioma
UPDATE FLBGEN.A_PID
SET PID_DES = 'Tipos Doc. Lanbide por procedimiento'
WHERE PID_APL = '9' AND PID_PRO = '32' AND PID_IDI = '1';
