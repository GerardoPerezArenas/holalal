  ...
  SELECT ECA14_RES_PREPARADORES_SQ.NEXTVAL ECA14_RES_PREPARADORES_COD ,
   ...
   c.ECA_PREP_IMP_SS_ECA gastos_salariales_solicitados,
    ...
    IM_SEGUIMIENTO* NVL(d.seg,0) importe_seguimientos,
       case when 
    (CASE WHEN c.ECA_PREP_INS_SEG_IMPORTE<= B.ECA_PREP_IMP_SS_ECA then c.ECA_PREP_INS_SEG_IMPORTE else B.ECA_PREP_IMP_SS_ECA end)*PO_MAX_SEGUIMIENTOS <= IM_SEGUIMIENTO* NVL(d.seg,0)then (CASE WHEN c.ECA_PREP_INS_SEG_IMPORTE<= B.ECA_PREP_IMP_SS_ECA then c.ECA_PREP_INS_SEG_IMPORTE else B.ECA_PREP_IMP_SS_ECA end)*PO_MAX_SEGUIMIENTOS 
...
-- SI ES MENOR IMP_SEG_INSERCIONES.
  ...
  case when 
    ...
    end ) >= (CASE WHEN c.ECA_PREP_INS_SEG_IMPORTE<= B.ECA_PREP_IMP_SS_ECA then c.ECA_PREP_INS_SEG_IMPORTE else B.ECA_PREP_IMP_SS_ECA end) 
    ...
    THEN (CASE WHEN c.ECA_PREP_INS_SEG_IMPORTE<= B.ECA_PREP_IMP_SS_ECA then c.ECA_PREP_INS_SEG_IMPORTE else B.ECA_PREP_IMP_SS_ECA end)
