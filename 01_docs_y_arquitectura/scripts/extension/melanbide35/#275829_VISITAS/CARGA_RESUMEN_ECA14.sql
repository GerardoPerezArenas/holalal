      ...
      WHEN
        CASE
		 ...
		 when COALESCE(c.ECA_PROS_IMP_SS_ECA,0)=0
          ...
          THEN d.visitas*importe.imp_visita
          ELSE 0
        END > imp_visita*MAX_EMP_VISIT *  CASE WHEN B.ECA_PROS_HORAS_ECA IS NOT NULL AND B.ECA_PROS_HORAS_JC IS NOT NULL THEN B.ECA_PROS_HORAS_ECA/B.ECA_PROS_HORAS_JC
            ELSE 1 END
      THEN imp_visita   *MAX_EMP_VISIT *  CASE WHEN B.ECA_PROS_HORAS_ECA IS NOT NULL AND B.ECA_PROS_HORAS_JC IS NOT NULL THEN B.ECA_PROS_HORAS_ECA/B.ECA_PROS_HORAS_JC
            ELSE 1 END
      ELSE
          CASE
          WHEN COALESCE(c.ECA_PROS_IMP_SS_ECA,0)<>0
