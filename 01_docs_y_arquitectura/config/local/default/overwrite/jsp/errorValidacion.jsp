...
<html:html locale="true">
    ...
    <head><jsp:include page="/jsp/escritorio/tpls/app-constants.jsp" />
        ...
        <%
            ...
            //Config m_Config = ConfigServiceHelper.getConfig("version");
            //String version = m_Config.getString("version.aplicacion");
    ...
    if(ajax!=null){
        ...
        //Todo ben ok
         if (ajax.readyState==4 && ajax.status==200){
            ...
            function inicializar() {document.all.tlogon.style.marginTop = calcularPosTabla(document.all.tlogon);}
            function escritorio(){
                pleaseWait('off');
                ...
                <table width="350px" height="240px" border="0" id="tlogon">
                    ...
                    <!-- Datos de usuario y clave. -->
                            ...
                            <div STYLE=" height:0px;" class="botoneraPrincipal">
                                <html:submit property="submit" value="Reintentar" styleClass="botonGeneral" onclick="pleaseWait('on')"/>
                                <html:button property="reset" value="Cancelar" styleClass="botonGeneral" onclick="Cancelar()"/>
                               <%     if(botonSalir!=null){
